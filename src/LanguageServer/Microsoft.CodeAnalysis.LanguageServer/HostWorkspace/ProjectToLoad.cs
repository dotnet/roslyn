...
/// </summary>
internal sealed record ProjectToLoad(string Path, string? ProjectGuid, bool ReportTelemetry, LanguageServerProjectLoader.ProjectLoadProgressTracker? ProgressTracker = null)
{
