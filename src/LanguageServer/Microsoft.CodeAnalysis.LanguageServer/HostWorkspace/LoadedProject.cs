...
internal sealed class LoadedProject : IDisposable
{
    ...
    public async ValueTask<(OutputKind OutputKind, ImmutableArray<CommandLineReference> MetadataReferences, bool NeedsRestore)> UpdateWithNewProjectInfoAsync(ProjectFileInfo newProjectInfo, bool isMiscellaneousFile, bool hasAllInformation, bool isFileBasedApp, ILogger logger)
    {
        ...
        _projectSystemProject.IsFileBasedApp = isFileBasedApp;
