...
internal sealed class FileBasedProgramsProjectSystem : LanguageServerProjectLoader, ILspMiscellaneousFilesWorkspaceProvider
{
    ...
    public async ValueTask<bool> IsProvidedDocumentAsync(TextDocument document)
    {
        return document.Project.FilePath is not null && await IsProjectLoadedAsync(document.Project.FilePath);
    }
