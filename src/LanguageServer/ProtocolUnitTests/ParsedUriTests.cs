...
public sealed class ParsedUriTests
{
    ...
    public static TheoryData<UriCase> FileCases => new()
    {
        ...
        new("C:/win/path")
        {
            ...
            WindowsFsPath = @"C:\win\path",
            UnixFsPath = "C:/win/path",
            // ParsedUri.File(...) preserves the uppercase drive in Path, but Parse(ToString()) canonicalizes the drive letter to lowercase.
            SkipParseRoundTrip = true,
        },
        new("c:/win/path/")
        {
            Scheme = "file",
    ...
    private static void AssertCase(ParsedUri value, UriCase testCase)
    {
        ...
        if (!testCase.SkipParseRoundTrip)
        {
    ...
    public sealed class UriCase : IXunitSerializable
    {
        ...
        public bool SkipParseRoundTrip { get; set; }
        ...
        public void Serialize(IXunitSerializationInfo info)
        {
            ...
            info.AddValue(nameof(SkipParseRoundTrip), SkipParseRoundTrip);
        ...
        public void Deserialize(IXunitSerializationInfo info)
        {
            ...
            SkipParseRoundTrip = info.GetValue<bool>(nameof(SkipParseRoundTrip));
