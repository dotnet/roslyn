...
/// <summary>
/// Defines a catch-all workspace for LSP files that cannot be handled by other providers.
/// This provider handles files that cannot run design time builds, such as Razor files.
/// </summary>
internal sealed class LspMiscFilesProvider(ILspServices lspServices, HostServices hostServices)
    : Workspace(hostServices, WorkspaceKind.MiscellaneousFiles), ILspMiscellaneousFilesWorkspaceProvider, ILspWorkspace
{
    ...
    {
        // This is a catch-all provider that can handle any file.
        return true;
    }
