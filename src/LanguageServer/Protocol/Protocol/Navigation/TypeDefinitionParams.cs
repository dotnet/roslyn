...
/// </para>
/// </summary>
internal sealed class TypeDefinitionParams : TextDocumentPositionParams, IWorkDoneProgressParams, IPartialResultParams<SumType<Location[], LocationLink[]>>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// <see cref="LocationLink"/> may only be used if the client opts in via <see cref="TypeDefinitionClientCapabilities.LinkSupport"/>
    /// </remarks>
