...
/// <summary>
/// Server registration options for the 'workspace/textDocumentContent' request
/// <para>
...
internal class TextDocumentContentRegistrationOptions : TextDocumentContentOptions, IStaticRegistrationOptions
{
    /// <inheritdoc/>
    [JsonPropertyName("id")]
