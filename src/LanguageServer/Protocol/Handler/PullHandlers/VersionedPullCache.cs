...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler
{
    ...
    /// </summary>
    internal abstract partial class VersionedPullCache<TCheapVersion, TExpensiveVersion, TState, TComputedData>(string uniqueKey) where TComputedData : notnull
    {
        ...
        /// 
        /// Note - this will run under the semaphore in <see cref="CacheItem._semaphore"/>.
        /// </summary>
