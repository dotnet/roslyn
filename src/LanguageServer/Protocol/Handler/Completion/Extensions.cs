...
{
    extension(IGlobalOptionService globalOptionService)
    {
        public CompletionOptions GetCompletionOptionsForLsp(string language, CompletionCapabilityHelper capabilityHelper)
        {
    ...
    extension(CompletionListCache completionListCache)
    {
        public bool TryGetCompletionListCacheEntry(
