...
internal static partial class Extensions
{
    extension(TextDocument document)
    {
        ...
        /// </summary>
        public DocumentUri GetUriForRenamedDocument()
        {
            Contract.ThrowIfNull(document.FilePath);
        ...
        public DocumentUri CreateUriForDocumentWithoutFilePath()
        {
            Contract.ThrowIfNull(document.Name);
        ...
        public async Task<int> GetPositionFromLinePositionAsync(LinePosition linePosition, CancellationToken cancellationToken)
        {
    ...
    {
        public Uri GetRequiredParsedUri()
        {
    ...
    extension(Solution solution)
    {
        ...
        /// </summary>
        public ImmutableArray<TextDocument> GetTextDocuments(DocumentUri documentUri)
        {
        ...
        public ImmutableArray<DocumentId> GetDocumentIds(DocumentUri documentUri)
        {
        ...
        /// </summary>
        public async ValueTask<Document?> GetDocumentAsync(TextDocumentIdentifier documentIdentifier, CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        public async ValueTask<TextDocument?> GetTextDocumentAsync(TextDocumentIdentifier documentIdentifier, CancellationToken cancellationToken)
        {
        ...
        public Project? GetProject(TextDocumentIdentifier projectIdentifier)
        {
        ...
        public TextDocument? GetAdditionalDocument(TextDocumentIdentifier documentIdentifier)
        {
    ...
    extension<T>(ImmutableArray<T> documents) where T : TextDocument
    {
        public T FindDocumentInProjectContext(TextDocumentIdentifier documentIdentifier, Func<Solution, DocumentId, T> documentGetter)
        {
    ...
    extension(ClientCapabilities? clientCapabilities)
    {
        public bool HasVisualStudioLspCapability()
        {
    ...
    extension(ClientCapabilities clientCapabilities)
    {
        public bool HasCompletionListDataCapability()
        {
        ...
        public bool HasCompletionListCommitCharactersCapability()
        {
            if (!TryGetVSCompletionListSetting(clientCapabilities, out var completionListSetting))
            {
                return false;
    ...
    {
        public string GetMarkdownLanguageName()
        {
    ...
    extension(DefinitionItem definition)
    {
        public ClassifiedTextElement GetClassifiedText()
    ...
    extension(Glyph glyph)
    {
        ...
        public (Guid guid, int id) GetVsImageData()
        {
            return glyph switch
            {
                Glyph.None => default,
    ...
    {
        public ClassifiedTextElement ToLSPElement()
        => new(element.Runs.Select(ToLSPRun));
    }

    extension(QuickInfoContainerElement element)
    {
        public ContainerElement ToLSPElement()
