...
{
    extension(DiagnosticData diagnosticData)
    {
        internal bool TryGetUnnecessaryDataLocations([NotNullWhen(true)] out ImmutableArray<DiagnosticDataLocation>? unnecessaryLocations)
        {
        ...
        internal bool TryGetUnnecessaryLocationIndices(
