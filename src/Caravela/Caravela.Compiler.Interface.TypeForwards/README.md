If tests fail on missing `Caravela.Compiler.Interface.dll` assembly, add a project reference to this project wherever `Microsoft.CodeAnalysis.CSharp.csproj` project is referenced.
