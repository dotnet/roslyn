...
namespace Microsoft.CodeAnalysis.ExternalAccess.UnitTesting.Api
{
        ...
        where TService : class
    {
        ...
        public ValueTask<bool> TryInvokeAsync(Solution solution, Func<TService, object, UnitTestingRemoteServiceCallbackIdWrapper, CancellationToken, ValueTask> invocation, CancellationToken cancellationToken)
            => UnderlyingObject.TryInvokeAsync(
                solution,
        ...
        public ValueTask<Optional<TResult>> TryInvokeAsync<TResult>(Solution solution, Func<TService, object, UnitTestingRemoteServiceCallbackIdWrapper, CancellationToken, ValueTask<TResult>> invocation, CancellationToken cancellationToken)
            => UnderlyingObject.TryInvokeAsync(
                solution,
                (service, solutionInfo, callbackId, cancellationToken) => invocation(service, solutionInfo, new UnitTestingRemoteServiceCallbackIdWrapper(callbackId), cancellationToken),
                cancellationToken);
