    ...
    internal class SolutionService
    {
        ...
        public async Task UpdatePrimaryWorkspaceAsync(Checksum checksum, CancellationToken cancellationToken)
        {
            ...
            using (await s_gate.DisposableWaitAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                if (await updater.IsUpdateAsync(checksum).ConfigureAwait(false))
                {
                ...
                // workspace has moved to new solution
        ...
        private class SolutionCreator
        {
            ...
            public async Task<bool> IsUpdateAsync(Checksum newSolutionChecksum)
            {
