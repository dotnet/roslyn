...
namespace Microsoft.CodeAnalysis.Remote
{
    ...
    {
        ValueTask<ImmutableArray<(Checksum, object)>> GetAssetsAsync(RemoteAssetScopeId scopeId, ISet<Checksum> checksums, ISerializerService serializerService, CancellationToken cancellationToken);
