...
namespace Microsoft.CodeAnalysis.Remote
{
    ...
    /// </remarks>
    internal sealed class RemoteSemanticClassificationCacheAnalyzerProvider : IIncrementalAnalyzerProvider
    {
        public RemoteSemanticClassificationCacheAnalyzerProvider(RemoteEndPoint _)
        {
        }

        public IIncrementalAnalyzer CreateIncrementalAnalyzer(Workspace _)
            => new RemoteSemanticClassificationCacheAnalyzer();
    }
}
