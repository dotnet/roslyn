    ...
    internal abstract partial class BrokeredServiceBase
    {
            ...
            where TService : class
        {
            ...
            internal TService Create(
               ...
               IServiceBroker serviceBroker)
            {
                var descriptor = ServiceDescriptors.Instance.GetServiceDescriptor(typeof(TService), isRemoteHost64Bit: IntPtr.Size == 8, isRemoteHostServerGC: GCSettings.IsServerGC);
