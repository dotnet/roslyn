...
namespace Microsoft.CodeAnalysis.Editing
{
    ...
    public abstract class SyntaxGenerator : ILanguageService
    {
        ...
        /// <summary>
        /// Creates an attribute using <see cref="TypeExpression(ITypeSymbol)"/> if the type can be found in the given
        /// compilation by its metadata name, or <see cref="DottedName(string)"/> if not.
        /// </summary>
        internal SyntaxNode Attribute(string name, Compilation compilation, params SyntaxNode[] attributeArguments)
        {
            ...
            return Attribute(
                compilation.GetTypeByMetadataName(name) is { } typeSymbol
