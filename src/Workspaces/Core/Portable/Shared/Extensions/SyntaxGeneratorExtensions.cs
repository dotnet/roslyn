...
internal static partial class SyntaxGeneratorExtensions
{
    ...
    {
        public IMethodSymbol CreateBaseDelegatingConstructor(
    ...
    extension(SyntaxGenerator codeFactory)
    {
        public async Task<IPropertySymbol> OverridePropertyAsync(
        ...
        private async Task<IMethodSymbol> OverrideMethodAsync(
    ...
    {
        public async Task<ISymbol> OverrideAsync(
        ISymbol symbol,
        INamedTypeSymbol containingType,
        Document document,
