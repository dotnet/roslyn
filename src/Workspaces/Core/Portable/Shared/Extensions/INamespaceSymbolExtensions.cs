...
internal static partial class INamespaceSymbolExtensions
{
    ...
    extension(INamespaceSymbol n1)
    {
        public int CompareTo(INamespaceSymbol n2)
        {
    ...
    {
        public IEnumerable<INamespaceOrTypeSymbol> GetAllNamespacesAndTypes(
        ...
        public IEnumerable<INamespaceSymbol> GetAllNamespaces(
            CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        public IEnumerable<INamespaceSymbol> FindNamespaces(
        ...
        public bool ContainsAccessibleTypesOrNamespaces(
        ...
        private bool ContainsAccessibleTypesOrNamespacesWorker(
            IAssemblySymbol assembly,
    ...
    extension(IEnumerable<INamespaceSymbol> namespaceSymbols)
    {
    ...
    extension(INamespaceSymbol globalNamespace)
    {
        public INamespaceSymbol? GetQualifiedNamespace(
        string namespaceName)
        {
