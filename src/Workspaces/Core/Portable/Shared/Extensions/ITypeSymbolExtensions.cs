...
internal static partial class ITypeSymbolExtensions
{
    extension(ITypeSymbol typeSymbol)
    {
        ...
        /// interfaceMember).
        /// </summary>
        public ImmutableArray<ISymbol> FindImplementationsForInterfaceMember(
        ...
        public ISymbol? FindImplementations(ISymbol constructedInterfaceMember, SolutionServices services)
        ...
        private ISymbol? FindImplementations<TSymbol>(
    ...
    extension(ITypeSymbol type)
    {
        ...
        public bool CanBeAsynchronouslyEnumerated(Compilation compilation)
        {
