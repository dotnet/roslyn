...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    internal interface IConfigurationFixProvider
    {
        ...
        Task<ImmutableArray<CodeFix>> GetFixesAsync(TextDocument document, TextSpan span, IEnumerable<Diagnostic> diagnostics, ICodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <returns>A list of zero or more potential <see cref="CodeFix"/>'es. It is also safe to return null if there are none.</returns>
        Task<ImmutableArray<CodeFix>> GetFixesAsync(Project project, IEnumerable<Diagnostic> diagnostics, ICodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken);
