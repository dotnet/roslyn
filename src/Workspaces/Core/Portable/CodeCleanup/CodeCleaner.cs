...
namespace Microsoft.CodeAnalysis.CodeCleanup
{
    ...
    internal static class CodeCleaner
    {
        ...
        /// </summary>
        public static async Task<Document> CleanupAsync(Document document, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// Optionally you can provide your own options and code cleaners. Otherwise, the default will be used.
        /// </summary>
        public static async Task<Document> CleanupAsync(Document document, SyntaxAnnotation annotation, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// Optionally you can provide your own options and code cleaners. Otherwise, the default will be used.
        /// </summary>
        public static Task<Document> CleanupAsync(Document document, TextSpan span, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        ...
        /// Optionally you can provide your own options and code cleaners. Otherwise, the default will be used.
        /// </summary>
        public static Task<Document> CleanupAsync(Document document, ImmutableArray<TextSpan> spans, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// </summary>
        public static Task<SyntaxNode> CleanupAsync(SyntaxNode root, TextSpan span, Workspace workspace, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        ...
        /// This will only cleanup stuff that doesn't require semantic information.
        /// </summary>
        public static Task<SyntaxNode> CleanupAsync(SyntaxNode root, ImmutableArray<TextSpan> spans, Workspace workspace, ImmutableArray<ICodeCleanupProvider> providers = default(ImmutableArray<ICodeCleanupProvider>), CancellationToken cancellationToken = default(CancellationToken))
        {
