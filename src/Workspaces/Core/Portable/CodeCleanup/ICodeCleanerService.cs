...
namespace Microsoft.CodeAnalysis.CodeCleanup
{
    ...
    internal interface ICodeCleanerService : ILanguageService
    {
        ...
        /// </summary>
        Task<SyntaxNode> CleanupAsync(SyntaxNode root, ImmutableArray<TextSpan> spans, SyntaxFormattingOptions options, HostSolutionServices services, ImmutableArray<ICodeCleanupProvider> providers, CancellationToken cancellationToken);
    }
}
