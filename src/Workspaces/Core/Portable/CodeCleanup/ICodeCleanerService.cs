...
namespace Microsoft.CodeAnalysis.CodeCleanup
{
    ...
    internal interface ICodeCleanerService : ILanguageService
    {
        ...
        /// </summary>
        Task<SyntaxNode> CleanupAsync(SyntaxNode root, ImmutableArray<TextSpan> spans, Workspace workspace, ImmutableArray<ICodeCleanupProvider> providers, CancellationToken cancellationToken = default(CancellationToken));
    }
}