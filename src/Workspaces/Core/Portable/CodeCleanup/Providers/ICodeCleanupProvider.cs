...
namespace Microsoft.CodeAnalysis.CodeCleanup.Providers
{
    ...
    internal interface ICodeCleanupProvider
    {
        ...
        /// </summary>
        Task<SyntaxNode> CleanupAsync(SyntaxNode root, ImmutableArray<TextSpan> spans, SyntaxFormattingOptions options, HostSolutionServices services, CancellationToken cancellationToken);
    }
}
