...
namespace Microsoft.CodeAnalysis.CodeCleanup.Providers
{
    ...
    internal interface ICodeCleanupProvider
    {
        ...
        /// </summary>
        Task<Document> CleanupAsync(Document document, ImmutableArray<TextSpan> spans, OptionSet options, CancellationToken cancellationToken);
        ...
        /// </summary>
        Task<SyntaxNode> CleanupAsync(SyntaxNode root, ImmutableArray<TextSpan> spans, OptionSet options, HostWorkspaceServices services, CancellationToken cancellationToken);
    }
}
