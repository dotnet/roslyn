...
namespace Microsoft.CodeAnalysis.FindSymbols.Finders
{
    internal class OrdinaryMethodReferenceFinder : AbstractMethodOrPropertyOrEventSymbolReferenceFinder<IMethodSymbol>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var ordinaryDocuments = await FindDocumentsAsync(project, documents, SupportsGlobalSuppression(methodSymbol), cancellationToken, methodSymbol.Name).ConfigureAwait(false);
