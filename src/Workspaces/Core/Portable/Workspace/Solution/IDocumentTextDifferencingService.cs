...
namespace Microsoft.CodeAnalysis
{
    internal interface IDocumentTextDifferencingService : IWorkspaceService
    {
        ...
        Task<ImmutableArray<TextChange>> GetTextChangesAsync(Document oldDocument, Document newDocument, TextDifferenceTypes preferredDifferenceType = TextDifferenceTypes.Word, CancellationToken cancellationToken = default);
    }
}
