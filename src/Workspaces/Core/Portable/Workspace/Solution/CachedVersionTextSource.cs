...
{
    /// <summary>
    /// A text source that keeps the text version cached.
    /// </summary>
    internal class CachedVersionTextSource : ValueSource<TextAndVersion>, ITextVersionable
    {
        private readonly ValueSource<TextAndVersion> _lazyTextAndVersion;
        private readonly VersionStamp _textVersion;

        public CachedVersionTextSource(ValueSource<TextAndVersion> textAndVersion, VersionStamp textVersion)
        {
