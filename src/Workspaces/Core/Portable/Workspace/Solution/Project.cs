...
namespace Microsoft.CodeAnalysis
{
    ...
    public partial class Project
    {
        ...
        /// <summary>
        /// True if project information is complete. <see cref="ProjectInfo.IsComplete"/> for more info.
        /// 
        /// this is for internal usage only. for public usage, use <see cref="IsCompleteAsync(CancellationToken)"/>
        /// </summary>
        internal bool IsComplete => _projectState.ProjectInfo.IsComplete;
