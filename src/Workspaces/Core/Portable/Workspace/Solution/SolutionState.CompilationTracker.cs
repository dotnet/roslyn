        ...
        private partial class CompilationTracker : ICompilationTracker
        {
                ...
                CancellationToken cancellationToken)
            {
                try
                {
                    ...
                    var (compilationWithGeneratedFiles, nextGeneratorInfo) = await RunGeneratorsAsync(
            ...
            private async Task<(Compilation compilationWithGeneratedFiles, CompilationTrackerGeneratorInfo generatorInfo)> RunGeneratorsAsync(
                Compilation compilationWithoutGeneratedFiles,
                CompilationTrackerGeneratorInfo generatorInfo,
                Compilation? compilationWithStaleGeneratedTrees,
