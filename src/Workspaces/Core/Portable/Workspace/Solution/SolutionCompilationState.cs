...
internal partial class SolutionCompilationState
{
    ...
    public SolutionCompilationState WithProjectFilePath(
        (SolutionState newSolutionState, ProjectState newProject) tuple, string? filePath)
    {
        return ForkProject(
            tuple,
            translate: null,
    ...
    public SolutionCompilationState AddMetadataReferences(
        (SolutionState newSolutionState, ProjectState newProject) tuple, IReadOnlyCollection<MetadataReference> metadataReferences)
    {
        return ForkProject(
            tuple,
            translate: null,
    ...
    public SolutionCompilationState WithDocumentFolders(
        (SolutionState newSolutionState, ProjectState oldProject, ProjectState newProject) tuple, DocumentId documentId, IReadOnlyList<string> folders)
    {
        return UpdateDocumentState(
            tuple, documentId, contentChanged: false);
    }
    ...
    public SolutionCompilationState WithAnalyzerConfigDocumentText(
        (SolutionState newSolutionState, ProjectState newProject) tuple, DocumentId documentId, TextAndVersion textAndVersion, PreservationMode mode)
    {
    ...
    public SolutionCompilationState UpdateAnalyzerConfigDocumentTextLoader(
        (SolutionState newSolutionState, ProjectState newProject) tuple, DocumentId documentId, TextLoader loader, PreservationMode mode)
    {
