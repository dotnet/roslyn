    ...
    public abstract partial class Workspace
    {
            ...
            bool wait)
        {
            ...
            try
            {
                ...
                var oldText = wait
                    ? oldDocument.GetTextAsync(CancellationToken.None).WaitAndGetResult(CancellationToken.None)
                ...
                if (oldText == newText || oldText.ContentEquals(newText))
                {
                    ...
                    var version = wait
                        ? oldDocument.GetTextVersionAsync(CancellationToken.None).WaitAndGetResult(CancellationToken.None)
