...
namespace Microsoft.CodeAnalysis.Host
{
    ...
    internal interface ITextFactoryService : IWorkspaceService
    {
        ...
        SourceText CreateText(Stream stream, Encoding? defaultEncoding, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        SourceText CreateText(TextReader reader, Encoding? encoding, CancellationToken cancellationToken);
    }
}
