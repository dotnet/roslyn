...
namespace Microsoft.CodeAnalysis.Host
{
    ...
    internal interface ISyntaxTreeFactoryService : ILanguageService
    {
        ...
        SyntaxTree CreateRecoverableTree(ProjectId cacheKey, string? filePath, ParseOptions options, ValueSource<TextAndVersion> text, Encoding? encoding, SourceHashAlgorithm checksumAlgorithm, SyntaxNode root);
