...
namespace Microsoft.CodeAnalysis.Host
{
    internal sealed class NoOpPersistentStorageService : IChecksummedPersistentStorageService
    {
        ...
        public ValueTask<IChecksummedPersistentStorage> GetStorageAsync(IPersistentStorageConfiguration configuration, SolutionKey solutionKey, bool checkBranchId, CancellationToken cancellationToken)
