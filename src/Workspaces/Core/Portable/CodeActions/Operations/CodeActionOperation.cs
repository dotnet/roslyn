...
namespace Microsoft.CodeAnalysis.CodeActions
{
    ...
    public abstract class CodeActionOperation
    {
        ...
        /// This method is guaranteed to be called on the UI thread.
        /// </summary>
        internal virtual Task<bool> TryApplyAsync(Workspace workspace, Solution originalSolution, IProgress<CodeAnalysisProgress> progress, CancellationToken cancellationToken)
        {
