...
namespace Microsoft.CodeAnalysis.EmbeddedLanguages.RegularExpressions
{
    ...
    internal static class RegexHelpers
    {
        ...
        public static RegexTrivia CreateTrivia(RegexKind kind, SubSequenceVirtualCharSequence virtualChars)
            => CreateTrivia(kind, virtualChars, ImmutableArray<EmbeddedDiagnostic>.Empty);

        public static RegexTrivia CreateTrivia(RegexKind kind, SubSequenceVirtualCharSequence virtualChars, ImmutableArray<EmbeddedDiagnostic> diagnostics)
