...
namespace Microsoft.CodeAnalysis.EmbeddedLanguages.Common
{
    ...
    internal struct EmbeddedSyntaxTrivia<TSyntaxKind> where TSyntaxKind : struct
    {
        ...
        public readonly SubSequenceVirtualCharSequence VirtualChars;
        ...
        public EmbeddedSyntaxTrivia(TSyntaxKind kind, SubSequenceVirtualCharSequence virtualChars, ImmutableArray<EmbeddedDiagnostic> diagnostics)
        {
