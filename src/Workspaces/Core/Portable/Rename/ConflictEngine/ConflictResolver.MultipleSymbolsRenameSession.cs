    ...
    internal static partial class ConflictResolver
    {
        private sealed class MultipleSymbolsRenameSessions : Session
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                using var _2 = PooledDictionary<ISymbol, bool>.GetInstance(out var symbolToReplacementTextValidMapBuilder);
                using var _3 = PooledDictionary<ISymbol, string>.GetInstance(out var symbolToReplacementTextBuilder);
                using var _4 = PooledDictionary<ISymbol, (DocumentId declarationDocumentId, Location symbolDeclarationLocation)>.GetInstance(out var symbolToDeclarationInfoBuilder);
