...
namespace Microsoft.CodeAnalysis
{
    ...
    internal partial class SymbolKey
    {
        ...
        private string _symbolKeyDataWithoutAssemblies;
        ...
        private string GetSymbolKeyDataWithoutAssemblies()
        {
            return LazyInitialization.EnsureInitialized(
                ref _symbolKeyDataWithoutAssemblies, s_removeAssemblyKeys, _symbolKeyData);
        }
