...
namespace Microsoft.CodeAnalysis.CodeGeneration
{
    ...
    internal static class CodeGenerator
    {
        ...
        /// </summary>
        public static TDeclarationNode AddAttributes<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, IEnumerable<AttributeData> attributes, SyntaxToken? target = null, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).AddAttributes(destination, attributes, target, options ?? CodeGenerationOptions.Default, cancellationToken);

        /// <summary>
        /// Removes the specified attribute node from the given declaration node.
        /// </summary>
        public static TDeclarationNode RemoveAttribute<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, AttributeData attributeToRemove, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).RemoveAttribute(destination, attributeToRemove, options ?? CodeGenerationOptions.Default, cancellationToken);

        /// <summary>
        /// Removes the specified attribute node from the given declaration node.
        /// </summary>
        public static TDeclarationNode RemoveAttribute<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, SyntaxNode attributeToRemove, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).RemoveAttribute(destination, attributeToRemove, options ?? CodeGenerationOptions.Default, cancellationToken);

        public static TDeclarationNode UpdateDeclarationModifiers<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, IEnumerable<SyntaxToken> newModifiers, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).UpdateDeclarationModifiers(destination, newModifiers, options ?? new CodeGenerationOptions(reuseSyntax: true), cancellationToken);

        public static TDeclarationNode UpdateDeclarationAccessibility<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, Accessibility newAccessibility, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).UpdateDeclarationAccessibility(destination, newAccessibility, options ?? new CodeGenerationOptions(reuseSyntax: true), cancellationToken);

        public static TDeclarationNode UpdateDeclarationType<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, ITypeSymbol newType, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).UpdateDeclarationType(destination, newType, options ?? new CodeGenerationOptions(reuseSyntax: true), cancellationToken);

        public static TDeclarationNode UpdateDeclarationMembers<TDeclarationNode>(TDeclarationNode destination, HostWorkspaceServices services, IList<ISymbol> newMembers, CodeGenerationOptions? options = null, CancellationToken cancellationToken = default) where TDeclarationNode : SyntaxNode
            => GetCodeGenerationService(services, destination.Language).UpdateDeclarationMembers(destination, newMembers, options ?? new CodeGenerationOptions(reuseSyntax: true), cancellationToken);
