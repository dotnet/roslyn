...
internal static class ExtractMethodGenerationOptionsProviders
{
    ...
    public static ValueTask<ExtractMethodGenerationOptions> GetExtractMethodGenerationOptionsAsync(this Document document, ICodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken)
