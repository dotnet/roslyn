        ...
        private static Solution GetSolution(params string[] sources)
        {
            ...
            var docs = sources.Select((s, i) =>
                DocumentInfo.Create(
                    ...
                    name: "code" + i,
                    loader: TextLoader.From(TextAndVersion.Create(SourceText.From(s, encoding: null, SourceHashAlgorithms.Default), VersionStamp.Default)),
                    loadTextOptions: new LoadTextOptions(SourceHashAlgorithms.Default))).ToList();
