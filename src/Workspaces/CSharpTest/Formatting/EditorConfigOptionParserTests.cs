...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Formatting
{
    public class EditorConfigOptionParserTests
    {
        ...
        InlineData(",  ,  , control_flow_statements", SpacingWithinParenthesesOption.ControlFlowStatements)]
        internal static void TestParseParenthesesSpaceOptionsTrue(string value, SpacingWithinParenthesesOption parenthesesSpacingOption)
        {
        ...
        InlineData(",,,", SpacingWithinParenthesesOption.Expressions),
        InlineData("*", SpacingWithinParenthesesOption.Expressions)]
        internal static void TestParseParenthesesSpaceOptionsFalse(string value, SpacingWithinParenthesesOption parenthesesSpacingOption)
        {
        ...
        internal static void TestParseEditorConfigSpacingAroundBinaryOperatorTrue(string value, BinaryOperatorSpacingOptions expectedResult)
        {
        ...
        internal static void TestParseEditorConfigSpacingAroundBinaryOperatorFalse(string value)
        {
        ...
        internal static void TestParseEditorConfigLabelPositioningTrue(string value, LabelPositionOptions expectedValue)
        {
        ...
        internal static void TestParseEditorConfigLabelPositioningFalse(string value)
        {
        ...
        internal static void TestParseNewLineOptionTrue(string value, NewLineOption option)
        {
        ...
        internal static void TestParseNewLineOptionFalse(string value, NewLineOption option)
        {
        ...
        InlineData(" ignore"),
        InlineData(" ignore ")]
        internal static void TestDetermineIfIgnoreSpacesAroundVariableDeclarationIsSetTrue(string value)
        {
        ...
        InlineData(", "),
        InlineData(" ignor ")]
        internal static void TestDetermineIfIgnoreSpacesAroundVariableDeclarationIsSetFalse(string value)
        {
