...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Formatting
{
    public class EditorConfigOptionParserTests
    {
        ...
        InlineData(",  ,  , control_flow_statements", SpacingWithinParenthesesOption.ControlFlowStatements)]
        private static void TestParseParenthesesSpaceOptionsTrue(string value, SpacingWithinParenthesesOption parenthesesSpacingOption)
        {
        ...
        InlineData(",,,", SpacingWithinParenthesesOption.Expressions),
        InlineData("*", SpacingWithinParenthesesOption.Expressions)]
        private static void TestParseParenthesesSpaceOptionsFalse(string value, SpacingWithinParenthesesOption parenthesesSpacingOption)
        {
        ...
        private static void TestParseEditorConfigSpacingAroundBinaryOperatorTrue(string value, BinaryOperatorSpacingOptions expectedResult)
        {
        ...
        private static void TestParseEditorConfigSpacingAroundBinaryOperatorFalse(string value)
        {
        ...
        private static void TestParseEditorConfigLabelPositioningTrue(string value, LabelPositionOptions expectedValue)
        {
        ...
        private static void TestParseEditorConfigLabelPositioningFalse(string value)
        {
        ...
        private static void TestParseNewLineOptionTrue(string value, NewLineOption option)
        {
        ...
        private static void TestParseNewLineOptionFalse(string value, NewLineOption option)
        {
        ...
        InlineData(" ignore"),
        InlineData(" ignore ")]
        private static void TestDetermineIfIgnoreSpacesAroundVariableDeclarationIsSetTrue(string value)
        {
        ...
        InlineData(", "),
        InlineData(" ignor ")]
        private static void TestDetermineIfIgnoreSpacesAroundVariableDeclarationIsSetFalse(string value)
        {
