...
Namespace Microsoft.CodeAnalysis.VisualBasic.Indentation
    Friend Class SpecialFormattingRule
        ...
        Private Overloads Shared Sub AddIndentBlockOperations(Of T As SyntaxNode)(list As SegmentedList(Of IndentBlockOperation), node As SyntaxNode, predicate As Func(Of T, Boolean), Optional indentationDelta As Integer = 0)
        ...
        Private Overloads Shared Sub AddIndentBlockOperations(list As SegmentedList(Of IndentBlockOperation), parameterOrArgumentList As SyntaxNode, indentationDelta As Integer)
        ...
        Private Shared Sub AddArgumentListIndentBlockOperations(operations As SegmentedList(Of IndentBlockOperation), node As SyntaxNode)
        ...
        Private Shared Sub AddCaseClauseAlignTokensOperations(operations As SegmentedList(Of AlignTokensOperation), node As SyntaxNode)
        ...
        Private Overloads Shared Sub AddAlignTokensOperations(Of T As SyntaxNode)(operations As SegmentedList(Of AlignTokensOperation), node As SyntaxNode, baseTokenGetter As Func(Of T, SyntaxToken))
        ...
        Private Overloads Shared Sub AddAlignTokensOperations(operations As SegmentedList(Of AlignTokensOperation), baseToken As SyntaxToken)
            operations.Add(FormattingOperations.CreateAlignTokensOperation(
                           baseToken,
