...
Namespace Microsoft.CodeAnalysis.VisualBasic.Simplification
    Partial Friend Class VisualBasicMiscellaneousReducer
        ...
        Private Shared ReadOnly s_simplifyParameter As Func(Of ParameterSyntax, SemanticModel, ISimplifierOptions, CancellationToken, ParameterSyntax) = AddressOf SimplifyParameter
        ...
        Private Shared ReadOnly s_simplifyInvocationExpression As Func(Of InvocationExpressionSyntax, SemanticModel, ISimplifierOptions, CancellationToken, SyntaxNode) = AddressOf SimplifyInvocationExpression
        ...
        Private Shared ReadOnly s_simplifyObjectCreationExpression As Func(Of ObjectCreationExpressionSyntax, SemanticModel, ISimplifierOptions, CancellationToken, SyntaxNode) = AddressOf SimplifyObjectCreationExpression
