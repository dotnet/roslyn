...
#Disable Warning IDE0060 ' Remove unused parameter - False positive, used as a delegate in a nested type.
        ...
        Private Shared Function TryUnescapeToken(identifier As SyntaxToken, semanticModel As SemanticModel, options As IVisualBasicSimplifierOptions, cancellationToken As CancellationToken) As SyntaxToken
