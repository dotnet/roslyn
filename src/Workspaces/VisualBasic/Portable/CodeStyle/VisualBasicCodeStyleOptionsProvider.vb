...
Namespace Microsoft.CodeAnalysis.VisualBasic.CodeStyle
    <ExportEditorConfigOptionProvider(LanguageNames.VisualBasic), [Shared]>
    Friend NotInheritable Class VisualBasicCodeStyleOptionsProvider
        ...
        Public ReadOnly Property Options As ImmutableArray(Of IOption2) Implements IOptionProvider.Options
            Get
