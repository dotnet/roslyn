...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Class VisualBasicSyntaxFactsService
        ...
        Public Function GetSelectedMembers(root As SyntaxNode, textSpan As TextSpan, allowPartialSelection As Boolean) As ImmutableArray(Of SyntaxNode) Implements ISyntaxFactsService.GetSelectedMembers
            Return ImmutableArray(Of SyntaxNode).CastUp(root.GetMembersInSpan(textSpan, allowPartialSelection))
        End Function
