...
namespace Microsoft.CodeAnalysis.CSharp.Utilities
{
    internal class CSharpTypeStyleContext
    {
        ...
        private CSharpTypeStyleContext(bool isVariableDeclarationContext)
        {
        ...
        public static CSharpTypeStyleContext Generate(SyntaxNode declaration, SemanticModel semanticModel, OptionSet optionSet, bool isVariableDeclarationContext, CancellationToken cancellationToken)
        {
            var state = new CSharpTypeStyleContext(isVariableDeclarationContext);
