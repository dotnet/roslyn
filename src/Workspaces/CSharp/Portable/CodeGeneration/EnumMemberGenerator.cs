...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    ...
    {
        internal static EnumDeclarationSyntax AddEnumMemberTo(EnumDeclarationSyntax destination, IFieldSymbol enumMember, CodeGenerationOptions options, CancellationToken cancellationToken)
        {
