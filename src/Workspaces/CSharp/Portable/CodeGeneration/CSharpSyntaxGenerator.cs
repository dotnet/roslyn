...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    ...
    internal class CSharpSyntaxGenerator : SyntaxGenerator
    {
        ...
        {
            if (CSharp.Extensions.ITypeSymbolExtensions.TryCreateTypeExpression(specialType, out var result))
                return result;

            throw new NotSupportedException($"Unsupported SpecialType: {specialType}");
        }
