...
internal static partial class SyntaxTreeExtensions
{
    ...
    {
        public bool IsAttributeNameContext(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsGlobalMemberDeclarationContext(
            int position,
    ...
    int position, SyntaxToken tokenOnLeftOfPosition)
        ...
        public bool IsLambdaDeclarationContext(
            int position,
        ...
        public bool IsLocalFunctionDeclarationContext(int position, CancellationToken cancellationToken)
    ...
    int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        {
            // cases:
            // root: |
        ...
        public bool IsNamespaceDeclarationNameContext(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsPartialTypeDeclarationNameContext(int position, CancellationToken cancellationToken, [NotNullWhen(true)] out TypeDeclarationSyntax? declarationSyntax)
        {
            if (!syntaxTree.IsInNonUserCode(position, cancellationToken))
            {
                var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken)
        ...
        public bool IsDefinitelyNotTypeContext(int position, CancellationToken cancellationToken)
        {
    ...
    int position, CancellationToken cancellationToken, SemanticModel? semanticModel = null)
        {
            // first do quick exit check
        ...
        public bool IsBaseClassOrInterfaceContext(int position, CancellationToken cancellationToken)
        {
            // class C : |
            // class C : Bar, |
            // NOT enum E : |
        ...
        public bool IsUsingAliasTypeContext(int position, CancellationToken cancellationToken)
        {
            // using Goo = |
        ...
        public bool IsUsingStaticContext(int position, CancellationToken cancellationToken)
        {
            // using static |
            // using static unsafe |
        ...
        public bool IsTypeArgumentOfConstraintClause(
    int position, CancellationToken cancellationToken)
        ...
        public bool IsTypeParameterConstraintStartContext(
    int position, SyntaxToken tokenOnLeftOfPosition)
        {
            // cases:
            //   where T : |
        ...
        public bool IsTypeParameterConstraintContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
        ...
        public bool IsTypeOfExpressionContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsDefaultExpressionContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsSizeOfExpressionContext(
    int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsGenericConstraintContext(SyntaxToken targetToken)
        ...
        public bool IsParameterModifierContext(
            int position,
            SyntaxToken tokenOnLeftOfPosition,
        ...
        public bool IsParamsModifierContext(
            int position,
            SyntaxToken tokenOnLeftOfPosition,
            CancellationToken cancellationToken)
        {
    ...
    int position, SyntaxToken tokenOnLeftOfPosition)
        ...
        public bool IsParameterTypeContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsPossibleExtensionMethodContext(SyntaxToken tokenOnLeftOfPosition)
        {
        ...
        public bool IsPossibleLambdaParameterModifierContext(
    int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        {
            var token = tokenOnLeftOfPosition;
            token = token.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsAnonymousMethodParameterModifierContext(
    int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition;
            token = token.GetPreviousTokenIfTouchingWord(position);
    ...
    int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        ...
        /// </summary>
        public bool IsPossibleTupleContext(SyntaxToken leftToken, int position)
        {
        ...
        public bool IsAtStartOfPattern(SyntaxToken leftToken, int position)
        {
            leftToken = leftToken.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsAtEndOfPattern(SyntaxToken leftToken, int position)
        {
        ...
        /// </summary>
        public bool IsPossibleDeconstructionDesignation(int position, CancellationToken cancellationToken)
        {
            var leftToken = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
            leftToken = leftToken.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsValidContextForFromClause(
            int position,
            SyntaxToken tokenOnLeftOfPosition,
            CancellationToken cancellationToken,
            SemanticModel? semanticModelOpt = null)
        ...
        public bool IsValidContextForJoinClause(
    int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition;
            token = token.GetPreviousTokenIfTouchingWord(position);
    ...
    int position, SyntaxToken tokenOnLeftOfPosition)
        ...
        public bool IsCatchVariableDeclarationContext(int position, CancellationToken cancellationToken)
        {
            // cases:
            //  catch (var
        ...
        public bool IsIsOrAsTypeContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition;
            token = token.GetPreviousTokenIfTouchingWord(position);
    ...
    int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        ...
        public bool IsPreProcessorDirectiveContext(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsStatementContext(int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        {
#if false
        ...
        public bool IsGlobalStatementContext(int position, CancellationToken cancellationToken)
        {
            if (syntaxTree.IsPreProcessorDirectiveContext(position, cancellationToken))
                return false;
        ...
        public bool IsInstanceContext(SyntaxToken targetToken, SemanticModel semanticModel, CancellationToken cancellationToken)
        {
#if false
        if (syntaxTree.IsInPreprocessorDirectiveContext(position, cancellationToken))
        {
        ...
        public bool IsPossibleCastTypeContext(
    int position, SyntaxToken tokenOnLeftOfPosition, CancellationToken cancellationToken)
        {
            var token = tokenOnLeftOfPosition.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsDefiniteCastTypeContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            var token = tokenOnLeftOfPosition;
            token = token.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsConstantExpressionContext(int position,
            SyntaxToken tokenOnLeftOfPosition)
        {
        ...
        public bool IsLabelContext(int position, CancellationToken cancellationToken)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
        ...
        public bool IsNameOfContext(int position, SemanticModel? semanticModelOpt = null, CancellationToken cancellationToken = default)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
            token = token.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsCatchOrFinallyContext(
    int position, SyntaxToken tokenOnLeftOfPosition)
        {
            // cases:
            // try { 
        ...
        public bool IsCatchFilterContext(int position, SyntaxToken tokenOnLeftOfPosition)
        {
            // cases:
            //  catch |
            //  catch i|
        ...
        public bool IsBaseListContext(SyntaxToken targetToken)
        {
            // Options:
            //  class E : |
            //  class E : i|
        ...
        public bool IsEnumBaseListContext(SyntaxToken targetToken)
        {
            // Options:
            //  enum E : |
            //  enum E : i|
        ...
        public bool IsEnumTypeMemberAccessContext(SemanticModel semanticModel, int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsFunctionPointerCallingConventionContext(SyntaxToken targetToken)
        {
    ...
    extension(SyntaxToken possibleCommaOrParen)
    {
        public bool IsPossibleTupleOpenParenOrComma()
        {
    ...
    extension(TupleExpressionSyntax tuple)
    {
    ...
    {
        public bool IsInvocationOfVarExpression()
