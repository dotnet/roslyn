...
namespace Microsoft.CodeAnalysis.CSharp.Extensions.ContextQuery
{
    internal static partial class SyntaxTokenExtensions
    {
        ...
        public static bool IsBeginningOfStatementContext(this SyntaxToken token)
        {
            ...
            switch (token.Kind())
            {
                ...
                case SyntaxKind.ColonToken:
                    return token.Parent.Kind() is SyntaxKind.CaseSwitchLabel or SyntaxKind.DefaultSwitchLabel or SyntaxKind.CasePatternSwitchLabel or SyntaxKind.LabeledStatement;
        ...
        public static bool IsSwitchLabelContext(this SyntaxToken targetToken)
        {
            ...
            {
                if (targetToken.Parent.Kind(
) is SyntaxKind.CaseSwitchLabel or SyntaxKind.DefaultSwitchLabel or SyntaxKind.CasePatternSwitchLabel)
                {
                    return true;
                }
            }
        ...
        {
            return targetToken.Kind() is SyntaxKind.CommaToken or SyntaxKind.OpenParenToken                && targetToken.Parent.Kind() is SyntaxKind.CrefBracketedParameterList or SyntaxKind.CrefParameterList;
        }
