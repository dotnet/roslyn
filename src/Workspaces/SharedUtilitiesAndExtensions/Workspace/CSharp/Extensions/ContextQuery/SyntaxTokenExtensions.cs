...
internal static partial class SyntaxTokenExtensions
{
    ...
    {
        public bool IsUsingOrExternKeyword()
        {
            return
        ...
        public bool IsUsingKeywordInUsingDirective()
        {
        ...
        public bool IsStaticKeywordContextInUsingDirective()
        {
            // using static |
        ...
        public bool IsBeginningOfStatementContext()
        {
            // cases:
            //    {
            //      |
        ...
        public bool IsBeginningOfGlobalStatementContext()
        {
            // cases:
            // }
            // |
        ...
        public bool IsAfterPossibleCast()
        {
        ...
        public bool IsLastTokenOfQueryClause()
        {
        ...
        public bool IsMandatoryNamedParameterPosition()
        {
        ...
        public bool IsNumericTypeContext(SemanticModel semanticModel, CancellationToken cancellationToken)
        {
    ...
    extension(SyntaxToken targetToken)
    {
        ...
        public bool IsOrderByDirectionContext()
        {
            // cases:
            //   orderby a |
            //   orderby a a|
        ...
        public bool IsSwitchLabelContext()
        {
            // cases:
            //   case X: |
            //   default: |
        ...
        public bool IsXmlCrefParameterModifierContext()
        {
        ...
        public bool IsConstructorOrMethodParameterArgumentContext()
        {
            // cases:
            //   Goo( |
            //   Goo(expr, |
        ...
        public bool IsUnaryOperatorContext()
        {
        ...
        public bool IsAfterYieldKeyword()
        {
            // yield |
            // yield r|
        ...
        public bool IsAnyAccessorDeclarationContext(int position, SyntaxKind kind = SyntaxKind.None)
        {
        ...
        public bool IsAccessorDeclarationContext<TMemberNode>(int position, SyntaxKind kind = SyntaxKind.None)
        ...
        public bool IsTypeParameterVarianceContext()
        {
            // cases:
            // interface IGoo<|
            // interface IGoo<A,|
