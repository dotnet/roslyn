...
internal static partial class ExpressionSyntaxExtensions
{
    ...
    {
        public ExpressionSyntax Parenthesize(
bool includeElasticTrivia = true, bool addSimplifierAnnotation = true)
        {
        ...
        private ExpressionSyntax ParenthesizeWorker(
    bool includeElasticTrivia)
        ...
        public CastExpressionSyntax Cast(
        ...
        /// </summary>
        public ExpressionSyntax CastIfPossible(
            ITypeSymbol targetType,
            int position,
    ...
    extension(PatternSyntax pattern)
    {
        public PatternSyntax Parenthesize(
bool includeElasticTrivia = true, bool addSimplifierAnnotation = true)
        {
    ...
    extension(ExpressionSyntax name)
    {
        ...
        /// </summary>
        public bool ShouldNameExpressionBeTreatedAsExpressionInsteadOfType(
            SemanticModel semanticModel,
