...
/// <summary>
/// This interface provides a subset of <see cref="INamespaceOrTypeSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationNamespaceOrTypeSymbol : ICodeGenerationSymbol
{
    /// <summary>
