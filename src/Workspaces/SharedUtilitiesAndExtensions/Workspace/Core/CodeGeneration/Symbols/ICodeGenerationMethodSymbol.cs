...
/// <summary>
/// This interface provides a subset of <see cref="IMethodSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationMethodSymbol : ICodeGenerationSymbol
{
    /// <summary>
