...
/// <summary>
/// This interface provides a subset of <see cref="INamespaceSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationNamespaceSymbol : ICodeGenerationNamespaceOrTypeSymbol
{
    /// <summary>
