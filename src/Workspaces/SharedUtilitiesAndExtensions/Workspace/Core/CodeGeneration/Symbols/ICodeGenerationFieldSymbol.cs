...
/// <summary>
/// This interface provides a subset of <see cref="IFieldSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationFieldSymbol : ICodeGenerationSymbol
{
    /// <summary>
