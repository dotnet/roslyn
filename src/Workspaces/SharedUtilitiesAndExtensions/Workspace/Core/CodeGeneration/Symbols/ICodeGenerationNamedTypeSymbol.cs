...
/// <summary>
/// This interface provides a subset of <see cref="INamedTypeSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationNamedTypeSymbol : ICodeGenerationTypeSymbol
{
    /// <summary>
