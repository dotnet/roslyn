...
/// <summary>
/// This interface provides a subset of <see cref="ITypeParameterSymbol"/> for use in code generation scenarios.
/// </summary>
internal interface ICodeGenerationTypeParameterSymbol : ICodeGenerationTypeSymbol
{
    /// <summary>
