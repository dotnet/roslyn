...
internal static partial class IMethodSymbolExtensions
{
    ...
    {
        public IMethodSymbol EnsureNonConflictingNames(
INamedTypeSymbol containingType, ISyntaxFactsService syntaxFacts)
        {
        ...
        public IMethodSymbol RenameTypeParameters(ImmutableArray<string> newNames)
        {
        ...
        public IMethodSymbol RenameParameters(
    ImmutableArray<string> parameterNames)
        ...
        public IMethodSymbol RemoveInaccessibleAttributesAndAttributesOfTypes(
