...
internal static class SyntaxEditorExtensions
{
    extension(SyntaxEditor editor)
    {
        ...
        /// </summary>
        public Task ApplyExpressionLevelSemanticEditsAsync<TType, TNode>(
    Document document,
    ...
    Document document,
        ...
        /// so that further edits can see if they're still safe to apply.
        /// </summary>
        public Task ApplyExpressionLevelSemanticEditsAsync<TNode>(
    Document document,
        ...
        /// </summary>
        public Task ApplyMethodBodySemanticEditsAsync<TType, TNode>(
    Document document,
            ImmutableArray<TType> originalNodes,
            Func<TType, (TNode semanticNode, IEnumerable<TNode> additionalNodes)> selector,
            Func<SemanticModel, TType, TNode, bool> canReplace,
        ...
        /// edits can see if they're still safe to apply.
        /// </summary>
        public Task ApplyMethodBodySemanticEditsAsync<TNode>(
    Document document,
            ImmutableArray<TNode> originalNodes,
            Func<SemanticModel, TNode, bool> canReplace,
            Func<SemanticModel, SyntaxNode, TNode, SyntaxNode> updateRoot,
        ...
        /// can be made or not.
        /// </summary>
        private async Task ApplySemanticEditsAsync<TType, TNode>(
    Document document,
            ImmutableArray<TType> originalNodes,
            Func<TType, (TNode semanticNode, IEnumerable<TNode> additionalNodes)> selector,
