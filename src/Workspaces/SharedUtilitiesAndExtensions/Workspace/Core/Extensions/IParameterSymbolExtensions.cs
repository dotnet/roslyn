...
{
    extension(IList<IParameterSymbol> parameters)
    {
        public ImmutableArray<IParameterSymbol> RenameParameters(ImmutableArray<string> parameterNames)
        {
    ...
    {
        public IParameterSymbol RenameParameter(string parameterName)
        {
        ...
        public IParameterSymbol WithAttributes(ImmutableArray<AttributeData> attributes)
        {
