...
internal static partial class SyntaxGeneratorExtensions
{
    ...
    {
        public ImmutableArray<SyntaxNode> GetGetHashCodeComponents(
        ...
        public ImmutableArray<SyntaxNode> CreateGetHashCodeStatementsUsingSystemHashCode(
    SyntaxGeneratorInternal generatorInternal,
        ...
        /// </summary>
        public ImmutableArray<SyntaxNode> CreateGetHashCodeMethodStatements(
            SyntaxGeneratorInternal generatorInternal,
            Compilation compilation,
            INamedTypeSymbol containingType,
            ImmutableArray<ISymbol> members,
    ...
    extension(SyntaxGenerator generator)
    {
        ...
        /// </summary>
        private SyntaxNode SimpleLocalDeclarationStatement(
    SyntaxGeneratorInternal generatorInternal, INamedTypeSymbol namedTypeSymbol,
