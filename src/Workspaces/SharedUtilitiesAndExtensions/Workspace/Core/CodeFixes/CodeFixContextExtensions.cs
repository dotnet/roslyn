...
internal static class CodeFixContextExtensions
{
    extension(CodeFixContext context)
    {
        ...
        /// </summary>
        internal void RegisterFixes(IEnumerable<CodeAction> actions, Diagnostic diagnostic)
        {
        ...
        /// </summary>
        internal void RegisterFixes(IEnumerable<CodeAction> actions, ImmutableArray<Diagnostic> diagnostics)
        {
            if (actions != null)
            {
                foreach (var action in actions)
