...
Namespace Microsoft.CodeAnalysis.VisualBasic.CodeStyle
    Friend NotInheritable Class VisualBasicCodeStyleOptions
        ...
        Private Shared Function CreateOption(group As OptionGroup, name As String, defaultValue As CodeStyleOption2(Of String), editorconfigKeyName As String, roamingProfileStorageKeyName As String) As SingleValuedOption2(Of CodeStyleOption2(Of String))
            Return CreateOption(
        ...
        Public Shared ReadOnly PreferredModifierOrder As SingleValuedOption2(Of CodeStyleOption2(Of String)) = CreateOption(
        ...
        Public Shared ReadOnly PreferIsNotExpression As SingleValuedOption2(Of CodeStyleOption2(Of Boolean)) = CreateOption(
        ...
        Public Shared ReadOnly PreferSimplifiedObjectCreation As SingleValuedOption2(Of CodeStyleOption2(Of Boolean)) = CreateOption(
        ...
        Public Shared ReadOnly UnusedValueExpressionStatement As SingleValuedOption2(Of CodeStyleOption2(Of UnusedValuePreference)) =
