...
public
#endif
enum BracePlacementPreferences
{
    /// <summary>
...
internal enum PreferBracesPreference
{
    ...
    /// </remarks>
    None = BracePlacementPreferences.None,
    ...
    /// </remarks>
    Always = BracePlacementPreferences.Always,

    WhenMultiline = BracePlacementPreferences.WhenMultiline,
}
