...
namespace Microsoft.CodeAnalysis.CSharp.CodeStyle
{
    internal static partial class CSharpCodeStyleOptions
    {
        ...
        private static SingleValuedOption2<T> CreateOption<T>(
        ...
        private static SingleValuedOption2<CodeStyleOption2<bool>> CreateOption(
        ...
        private static SingleValuedOption2<CodeStyleOption2<string>> CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> VarForBuiltInTypes = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> VarWhenTypeIsApparent = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> VarElsewhere = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferConditionalDelegateCall = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferSwitchExpression = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferPatternMatching = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferPatternMatchingOverAsWithNullCheck = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferPatternMatchingOverIsWithCastCheck = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferNotPattern = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferExtendedPropertyPattern = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferThrowExpression = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferInlinedVariableDeclaration = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferDeconstructedVariableDeclaration = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferIndexOperator = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferRangeOperator = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferUtf8StringLiterals = CreateOption(
        ...
        private static SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> CreatePreferExpressionBodyOption(
            string optionName,
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedConstructors = CreatePreferExpressionBodyOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedMethods = CreatePreferExpressionBodyOption(
            nameof(PreferExpressionBodiedMethods), defaultValue: NeverWithSilentEnforcement, "csharp_style_expression_bodied_methods");

        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedOperators = CreatePreferExpressionBodyOption(
            nameof(PreferExpressionBodiedOperators), defaultValue: NeverWithSilentEnforcement, "csharp_style_expression_bodied_operators");

        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedProperties = CreatePreferExpressionBodyOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedIndexers = CreatePreferExpressionBodyOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedAccessors = CreatePreferExpressionBodyOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedLambdas = CreatePreferExpressionBodyOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>> PreferExpressionBodiedLocalFunctions = CreatePreferExpressionBodyOption(
        ...
        private static SingleValuedOption2<CodeStyleOption2<PreferBracesPreference>> CreatePreferBracesOption(
            string optionName,
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<PreferBracesPreference>> PreferBraces = CreatePreferBracesOption(
            nameof(PreferBraces), CSharpSimplifierOptions.Default.PreferBraces, "csharp_prefer_braces");

        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferSimpleDefaultExpression = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<string>> PreferredModifierOrder = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferStaticLocalFunction = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferSimpleUsingStatement = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferLocalOverAnonymousFunction = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferTupleSwap = CreateOption(
        ...
        private static SingleValuedOption2<CodeStyleOption2<AddImportPlacement>> CreateUsingDirectivePlacementOption(string optionName, CodeStyleOption2<AddImportPlacement> defaultValue, string editorconfigKeyName)
            => CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<AddImportPlacement>> PreferredUsingDirectivePlacement = CreateUsingDirectivePlacementOption(
        ...
        internal static readonly SingleValuedOption2<CodeStyleOption2<UnusedValuePreference>> UnusedValueExpressionStatement =
        ...
        internal static readonly SingleValuedOption2<CodeStyleOption2<UnusedValuePreference>> UnusedValueAssignment =
            CodeStyleHelpers.CreateUnusedExpressionAssignmentOption(
                CSharpCodeStyleOptionGroups.ExpressionLevelPreferences,
                feature: nameof(CSharpCodeStyleOptions),
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> ImplicitObjectCreationWhenTypeIsApparent = CreateOption(
        ...
        internal static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferNullCheckOverTypeCheck = CreateOption(
        ...
        public static SingleValuedOption2<CodeStyleOption2<bool>> AllowEmbeddedStatementsOnSameLine { get; } = CreateOption(
        ...
        public static SingleValuedOption2<CodeStyleOption2<bool>> AllowBlankLinesBetweenConsecutiveBraces { get; } = CreateOption(
        ...
        public static SingleValuedOption2<CodeStyleOption2<bool>> AllowBlankLineAfterColonInConstructorInitializer { get; } = CreateOption(
        ...
        private static SingleValuedOption2<CodeStyleOption2<NamespaceDeclarationPreference>> CreateNamespaceDeclarationOption(string optionName, CodeStyleOption2<NamespaceDeclarationPreference> defaultValue, string editorconfigKeyName)
            => CreateOption(
                CSharpCodeStyleOptionGroups.CodeBlockPreferences, optionName,
                defaultValue,
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<NamespaceDeclarationPreference>> NamespaceDeclarations = CreateNamespaceDeclarationOption(
            "NamespaceDeclarations",
            CSharpSyntaxFormattingOptions.Default.NamespaceDeclarations,
            "csharp_style_namespace_declarations");

        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferMethodGroupConversion = CreateOption(
        ...
        public static readonly SingleValuedOption2<CodeStyleOption2<bool>> PreferTopLevelStatements = CreateOption(
        ...
        public static IEnumerable<SingleValuedOption2<CodeStyleOption2<bool>>> GetCodeStyleOptions()
        {
        ...
        public static IEnumerable<SingleValuedOption2<CodeStyleOption2<ExpressionBodyPreference>>> GetExpressionBodyOptions()
        {
