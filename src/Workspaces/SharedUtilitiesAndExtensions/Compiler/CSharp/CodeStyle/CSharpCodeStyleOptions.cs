...
internal static partial class CSharpCodeStyleOptions
{
    ...
    public static readonly Option2<CodeStyleOption2<bool>> PreferUnboundTypeInNameOf = CreateOption(
        CodeStyleOptionGroups.ExpressionLevelPreferences, "csharp_style_prefer_unbound_type_in_nameof",
        defaultValue: CodeStyleOption2.TrueWithSuggestionEnforcement);
