...
internal static partial class ExpressionSyntaxExtensions
{
    extension(ExpressionSyntax? expression)
    {
        ...
        public ExpressionSyntax? WalkUpParentheses()
        {
    ...
    extension(ExpressionSyntax expression)
    {
        public ExpressionSyntax WalkDownParentheses()
        {
        ...
        public ExpressionSyntax WalkDownSuppressions()
        {
        ...
        public bool IsLeftSideOfSimpleMemberAccessExpression()
        ...
        public bool IsLeftSideOfDotOrArrow()
        ...
        public bool TryGetNameParts(List<string> parts)
        {
        ...
        public bool IsNamedArgumentIdentifier()
            => expression is IdentifierNameSyntax { Parent: NameColonSyntax };

        public bool CanReplaceWithLValue(
    SemanticModel semanticModel, CancellationToken cancellationToken)
        ...
        public bool IsNameOfArgumentExpression()
        ...
        public bool TryConvertToStatement(
        ...
        public bool IsDirectChildOfMemberAccessExpression()
            => expression?.Parent is MemberAccessExpressionSyntax;

        public bool InsideCrefReference()
            => expression.FirstAncestorOrSelf<XmlCrefAttributeSyntax>() != null;

        public ITypeSymbol? GetTargetType(
    ...
    extension([NotNullWhen(true)] ExpressionSyntax? expression)
    {
        public bool IsSimpleMemberAccessExpressionName()
        ...
        public bool IsAnyMemberAccessExpressionName()
        {
            if (expression == null)
                return false;
        ...
        /// </summary>
        public bool IsInRefContext([NotNullWhen(true)] out SyntaxNode? refParent)
        {
    ...
    extension(ExpressionSyntax name)
    {
        public bool IsRightSideOfDot()
        ...
        public bool IsRightSideOfDotOrColonColon()
            => IsRightSideOfDot(name) || IsRightSideOfColonColon(name);
    }

    extension([NotNullWhen(true)] ExpressionSyntax? name)
    {
        public bool IsRightSideOfDotOrArrow()
        => IsAnyMemberAccessExpressionName(name) || IsRightSideOfQualifiedName(name);
    }

    extension([NotNullWhen(true)] ExpressionSyntax name)
    {
        public bool IsRightSideOfDotOrArrowOrColonColon()
        => IsRightSideOfDotOrArrow(name) || IsRightSideOfColonColon(name);
    }

    extension([NotNullWhen(true)] NameSyntax? name)
    {
    ...
    {
        public bool IsNameOfInvocation()
        {
