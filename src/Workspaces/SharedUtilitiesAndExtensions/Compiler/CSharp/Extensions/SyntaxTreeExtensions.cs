...
internal static partial class SyntaxTreeExtensions
{
    ...
    {
        public ISet<SyntaxKind> GetPrecedingModifiers(int position, CancellationToken cancellationToken)
        => syntaxTree.GetPrecedingModifiers(position, cancellationToken, out _);

        public ISet<SyntaxKind> GetPrecedingModifiers(
            int position,
        ...
        public TypeDeclarationSyntax? GetContainingTypeDeclaration(
    int position, CancellationToken cancellationToken)
        ...
        public BaseTypeDeclarationSyntax? GetContainingTypeOrEnumDeclaration(
    int position, CancellationToken cancellationToken)
        {
            return syntaxTree.GetContainingTypeOrEnumDeclarations(position, cancellationToken).FirstOrDefault();
        }

        public IEnumerable<TypeDeclarationSyntax> GetContainingTypeDeclarations(
    int position, CancellationToken cancellationToken)
        {
        ...
        public IEnumerable<BaseTypeDeclarationSyntax> GetContainingTypeOrEnumDeclarations(
    int position, CancellationToken cancellationToken)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
        ...
        public bool IsRightOfDotOrArrowOrColonColon(int position, SyntaxToken targetToken, CancellationToken cancellationToken)
        {
            return
        ...
        public bool IsRightOfDotOrArrow(int position, CancellationToken cancellationToken)
            => syntaxTree.IsRightOf(position, s_isDotOrArrow, cancellationToken);

        public bool IsRightOfDot(int position, CancellationToken cancellationToken)
            => syntaxTree.IsRightOf(position, s_isDot, cancellationToken);

        private bool IsRightOf(
    int position, Func<SyntaxKind, bool> predicate, CancellationToken cancellationToken)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
        ...
        public bool IsRightOfNumericLiteral(int position, CancellationToken cancellationToken)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
            return token.Kind() == SyntaxKind.NumericLiteralToken;
        }

        public bool IsAfterKeyword(int position, SyntaxKind kind, CancellationToken cancellationToken)
        {
            var token = syntaxTree.FindTokenOnLeftOfPosition(position, cancellationToken);
            token = token.GetPreviousTokenIfTouchingWord(position);
        ...
        public bool IsEntirelyWithinNonUserCodeComment(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinComment(int position, CancellationToken cancellationToken)
        {
            return
                syntaxTree.IsEntirelyWithinTopLevelSingleLineComment(position, cancellationToken) ||
                syntaxTree.IsEntirelyWithinPreProcessorSingleLineComment(position, cancellationToken) ||
        ...
        public bool IsCrefContext(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinCrefSyntax(int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinSingleLineDocComment(
    int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinMultiLineDocComment(
    int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinMultiLineComment(
    int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinConflictMarker(
    int position, CancellationToken cancellationToken)
        {
            var trivia = syntaxTree.FindTriviaAndAdjustForEndOfFile(position, cancellationToken);
        ...
        public bool IsEntirelyWithinTopLevelSingleLineComment(
    int position, CancellationToken cancellationToken)
        {
            var trivia = syntaxTree.FindTriviaAndAdjustForEndOfFile(position, cancellationToken);
        ...
        public bool IsEntirelyWithinPreProcessorSingleLineComment(
    int position, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinStringOrCharLiteral(
    int position, CancellationToken cancellationToken)
        {
            return
        ...
        public bool IsEntirelyWithinStringLiteral(int position, CancellationToken cancellationToken)
            => IsEntirelyWithinStringLiteral(syntaxTree, position, out _, cancellationToken);

        public bool IsEntirelyWithinStringLiteral(
    int position, out SyntaxToken stringLiteral, CancellationToken cancellationToken)
        {
        ...
        public bool IsEntirelyWithinCharLiteral(
    int position, CancellationToken cancellationToken)
        {
            var root = (CompilationUnitSyntax)syntaxTree.GetRoot(cancellationToken);
    ...
    int position, CancellationToken cancellationToken)
        ...
        public bool IsPreProcessorKeywordContext(int position, CancellationToken cancellationToken)
        {
...
#pragma warning disable IDE0060 // Remove unused parameter
        public bool IsPreProcessorKeywordContext(int position, SyntaxToken preProcessorTokenOnLeftOfPosition)
