...
internal static class IAssemblySymbolExtensions
{
    ...
    extension(List<IAssemblySymbol> assemblies)
    {
        public bool ContainsNamespaceName(
        ...
        public bool ContainsTypeName(string typeName, bool tryWithAttributeSuffix = false)
        {
    ...
    {
        public bool IsSameAssemblyOrHasFriendAccessTo(IAssemblySymbol toAssembly)
        {
            return
