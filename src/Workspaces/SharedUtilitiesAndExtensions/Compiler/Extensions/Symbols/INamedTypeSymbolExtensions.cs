...
internal static partial class INamedTypeSymbolExtensions
{
    ...
    {
        public bool IsContainedWithin(INamedTypeSymbol outer)
        {
    ...
    {
        public ISymbol? FindImplementationForAbstractMember(ISymbol symbol)
        {
    ...
    extension(INamedTypeSymbol classOrStructType)
    {
        ...
        private bool IsExplicitlyImplemented(
            ISymbol member,
        ...
        public ImmutableArray<(INamedTypeSymbol type, ImmutableArray<ISymbol> members)> GetAllUnimplementedMembers(
        ...
        public ImmutableArray<(INamedTypeSymbol type, ImmutableArray<ISymbol> members)> GetAllUnimplementedMembersInThis(
        ...
        public ImmutableArray<(INamedTypeSymbol type, ImmutableArray<ISymbol> members)> GetAllUnimplementedExplicitMembers(
            IEnumerable<INamedTypeSymbol> interfaces,
            CancellationToken cancellationToken)
        {
            return classOrStructType.GetAllUnimplementedMembers(
        ...
        private ImmutableArray<(INamedTypeSymbol type, ImmutableArray<ISymbol> members)> GetAllUnimplementedMembers(
            IEnumerable<INamedTypeSymbol> interfacesOrAbstractClasses,
        ...
        private ImmutableArray<ISymbol> GetUnimplementedMembers(
    ...
    extension(INamedTypeSymbol attributeSymbol)
    {
        public IEnumerable<ISymbol> GetAttributeNamedParameters(
    ...
    extension(INamedTypeSymbol containingType)
    {
        ...
        /// </summary>
        public ImmutableArray<ISymbol> GetOverridableMembers(
    CancellationToken cancellationToken)
        {
    ...
    extension(INamedTypeSymbol type)
    {
        public INamedTypeSymbol TryConstruct(ITypeSymbol[] typeArguments)
        => typeArguments.Length > 0 ? type.Construct(typeArguments) : type;
    }

    extension([NotNullWhen(true)] INamedTypeSymbol? type)
    {
        public bool IsCollectionBuilderAttribute()
        => type is
        {
