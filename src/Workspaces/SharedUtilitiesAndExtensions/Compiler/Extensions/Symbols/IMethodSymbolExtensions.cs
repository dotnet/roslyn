...
internal static partial class IMethodSymbolExtensions
{
    extension(IMethodSymbol method)
    {
        ...
        /// </summary>
        public ImmutableArray<IMethodSymbol> GetAllMethodSymbolsOfPartialParts()
        {
        ...
        /// </summary>
        public bool HasEventHandlerSignature([NotNullWhen(returnValue: true)] INamedTypeSymbol? eventArgsType)
            => eventArgsType != null &&
        ...
        /// </summary>
        public bool IsAsyncReturningVoidTask(Compilation compilation)
        {
            if (!method.IsAsync)
                return false;
    ...
    {
        public bool TryGetPredefinedComparisonOperator(out PredefinedOperator op)
        {
    ...
    {
        public bool IsEntryPoint(INamedTypeSymbol? taskType, INamedTypeSymbol? genericTaskType)
