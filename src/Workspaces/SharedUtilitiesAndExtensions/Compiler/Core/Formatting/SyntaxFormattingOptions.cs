...
#if !CODE_STYLE
    public static SyntaxFormattingOptions GetSyntaxFormattingOptions(this AnalyzerConfigOptions options, SyntaxFormattingOptions? fallbackOptions, Host.LanguageServices languageServices)
