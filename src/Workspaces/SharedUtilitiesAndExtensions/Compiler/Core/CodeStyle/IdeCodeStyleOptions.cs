...
internal record class IdeCodeStyleOptions
{
    ...
    [DataMember] public CodeStyleOption2<bool> PreferCollectionExpressionForArray { get; init; } = CodeStyleOption2.TrueWithSuggestionEnforcement;
    ...
    private protected IdeCodeStyleOptions(IOptionsReader options, IdeCodeStyleOptions fallbackOptions, string language)
    {
        ...
        PreferCollectionExpressionForArray = options.GetOption(CodeStyleOptions2.PreferCollectionExpressionForArray, language, fallbackOptions.PreferCollectionInitializer);
