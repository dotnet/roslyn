...
internal sealed record class VisualBasicIdeCodeStyleOptions : IdeCodeStyleOptions, IEquatable<VisualBasicIdeCodeStyleOptions>
{
    ...
    [DataMember] public CodeStyleOption2<bool> PreferIsNotExpression { get; init; } = s_trueWithSuggestionEnforcement;
    [DataMember] public CodeStyleOption2<bool> PreferSimplifiedObjectCreation { get; init; } = s_trueWithSuggestionEnforcement;
