...
internal static partial class SourceTextExtensions
{
    extension(SourceText text)
    {
        ...
        public bool OverlapsHiddenPosition(
    TextSpan span, Func<int, CancellationToken, bool> isPositionHidden, CancellationToken cancellationToken)
        {
        ...
        /// in that case.
        /// </summary>
        public bool TryOverlapsHiddenPosition(
    TextSpan span, Func<int, CancellationToken, bool> isPositionHidden,
...
'#line default
        ...
        public bool AreOnSameLine(SyntaxToken token1, SyntaxToken token2)
            => token1.RawKind != 0 &&
               token2.RawKind != 0 &&
               text.AreOnSameLine(token1.Span.End, token2.SpanStart);

        public bool AreOnSameLine(int pos1, int pos2)
