...
internal static class AnalysisContextExtensions
{
    ...
    extension(SyntaxTreeAnalysisContext context)
    {
        ...
        /// </summary>
        public bool ShouldAnalyzeSpan(TextSpan span)
            => ShouldAnalyze(context.FilterSpan, span);

        /// <summary>
        /// Gets the root node in the analysis span for the given <paramref name="context"/>.
        /// </summary>
        public SyntaxNode GetAnalysisRoot(bool findInTrivia, bool getInnermostNodeForTie = false)
    ...
    extension(SymbolStartAnalysisContext context)
    {
        ...
        /// </summary>
        public bool ShouldAnalyzeSpan(TextSpan span, SyntaxTree tree)
        ...
        /// </summary>
        public bool ShouldAnalyzeLocation(Location location)
    ...
    extension(SymbolAnalysisContext context)
    {
        /// <summary>
        /// Returns true if the given <paramref name="span"/> should be analyzed for the given <paramref name="context"/>,
        /// i.e. either of the following is true:
    ...
    extension(OperationBlockStartAnalysisContext context)
    {
        /// <summary>
        /// Returns true if the given <paramref name="span"/> should be analyzed for the given <paramref name="context"/>,
        /// i.e. either of the following is true:
        ...
        /// Gets the root node in the analysis span for the given <paramref name="context"/>.
        /// </summary>
        public SyntaxNode GetAnalysisRoot(IOperation operationBlock, bool findInTrivia, bool getInnermostNodeForTie = false)
            => operationBlock.Syntax.FindNode(context.FilterSpan, findInTrivia, getInnermostNodeForTie);
    }

    extension(OperationBlockAnalysisContext context)
    {
        /// <summary>
        /// Returns true if the given <paramref name="span"/> should be analyzed for the given <paramref name="context"/>,
        /// i.e. either of the following is true:
    ...
    extension<TSytnaxKind>(CodeBlockStartAnalysisContext<TSytnaxKind> context) where TSytnaxKind : struct
    {
        /// <summary>
        /// Returns true if the given <paramref name="span"/> should be analyzed for the given <paramref name="context"/>,
        /// i.e. either of the following is true:
        ...
        /// </summary>
        public bool ShouldAnalyzeSpan(TextSpan span) => ShouldAnalyze(context.FilterSpan, span);
    }
    ...
    extension<TSyntaxKind>(CodeBlockStartAnalysisContext<TSyntaxKind> context) where TSyntaxKind : struct
    {
        /// <summary>
        /// Gets the root node in the analysis span for the given <paramref name="context"/>.
        /// </summary>
        public SyntaxNode GetAnalysisRoot(bool findInTrivia, bool getInnermostNodeForTie = false) => context.CodeBlock.FindNode(context.FilterSpan, findInTrivia, getInnermostNodeForTie);
    }
}
