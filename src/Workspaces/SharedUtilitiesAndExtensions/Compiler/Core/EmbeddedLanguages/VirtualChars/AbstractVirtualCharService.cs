...
namespace Microsoft.CodeAnalysis.EmbeddedLanguages.VirtualChars
{
    internal abstract class AbstractVirtualCharService : IVirtualCharService
    {
        ...
        protected static int ConvertTextAtIndexToRune(
            string tokenText, int index, ImmutableSegmentedList<VirtualChar>.Builder result, int offset)
        {
            ...
            ImmutableSegmentedList<VirtualChar>.Builder result)
        {
            ...
            return VirtualCharSequence.Create(result.ToImmutableSegmentedList());
        }
    }
}
