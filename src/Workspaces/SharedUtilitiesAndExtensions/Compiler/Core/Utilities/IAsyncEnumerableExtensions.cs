...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
    ...
    extension<T>(ImmutableArray<IAsyncEnumerable<T>> streams)
    {
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        public IAsyncEnumerable<T> MergeAsync(CancellationToken cancellationToken)
        {
    ...
    extension(Task task)
    {
        ...
        /// </summary>
        public void CompletesChannel<T>(Channel<T> channel)
        {
