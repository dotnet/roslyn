...
namespace Microsoft.CodeAnalysis.UnitTests.CodeCleanup
{
    ...
    {
        public Func<Document, ImmutableArray<TextSpan>, OptionSet, CancellationToken, Task<Document>>? CleanupDocumentAsyncImpl { get; set; }
        public Func<SyntaxNode, ImmutableArray<TextSpan>, OptionSet, HostWorkspaceServices, SyntaxNode>? CleanupNodeImpl { get; set; }
