...
#nullable disable
    ...
    public async Task TestDocumentFileAccessFailureMissingFile()
    {
        ...
        solution = solution
            ...
            .AddDocument(did, "x", new WorkspaceFileTextLoader(solution.Services, TestPathUtil.GetRootedPath("doesnotexist.cs"), Encoding.UTF8))
    ...
    public async Task TestAddingEditorConfigFileWithDiagnosticSeverity([CombinatorialValues(LanguageNames.CSharp, LanguageNames.VisualBasic)] string languageName)
    {
        ...
        solution = solution.AddDocument(sourceDocumentId, "Test" + extension, "", filePath: TestPathUtil.GetRootedPath("Test" + extension));
        ...
        solution = solution.AddAnalyzerConfigDocuments(ImmutableArray.Create(
            DocumentInfo.Create(
                ...
                ".editorconfig",
                filePath: TestPathUtil.GetRootedPath(".editorconfig"),
    ...
    public void TestAddingAndRemovingGlobalEditorConfigFileWithDiagnosticSeverity()
    {
        ...
        solution = solution.AddDocument(sourceDocumentId, "Test.cs", "", filePath: TestPathUtil.GetRootedPath("Test.cs"));
        ...
        solution = solution.AddAnalyzerConfigDocuments(ImmutableArray.Create(
            DocumentInfo.Create(
                editorConfigDocumentId,
                ".globalconfig",
                filePath: TestPathUtil.GetRootedPath(".globalconfig"),
    ...
    public async Task TestAddingEditorConfigFileWithIsGeneratedCodeOption()
    {
        ...
        solution = solution.AddDocument(sourceDocumentId, "Test.cs", """
            ...
            """, filePath: TestPathUtil.GetRootedPath("Test.cs"));
