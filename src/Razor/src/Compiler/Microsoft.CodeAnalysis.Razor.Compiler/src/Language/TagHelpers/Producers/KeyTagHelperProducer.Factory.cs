...
internal sealed partial class KeyTagHelperProducer
{
    public sealed class Factory : FactoryBase
    {
        ...
        {
            if (!compilation.TryGetTypeByMetadataName(ComponentsApi.RenderTreeBuilder.FullTypeName, out var renderTreeBuilderType))
            {
            ...
            result = new KeyTagHelperProducer(renderTreeBuilderType);
            return true;
        }
    }
}
