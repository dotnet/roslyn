...
internal partial class RazorMetaCodeSyntax : ILegacySyntax
{
    public RazorMetaCodeSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
        => Update(MetaCode, chunkGenerator, editHandler);
