...
internal partial class MarkupTagHelperStartTagSyntax : ILegacySyntax
{
    public MarkupTagHelperStartTagSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
