...
internal partial class MarkupTransitionSyntax : ILegacySyntax
{
    public MarkupTransitionSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
        => Update(TransitionTokens, chunkGenerator, editHandler);
