...
internal sealed class RazorTranslateDiagnosticsService(IDocumentMappingService documentMappingService, ILoggerFactory loggerFactory)
{
    ...
    {
        return d.Range is { } range &&
            sourceText.IsValidPosition(range.Start.Line, range.Start.Character) &&
        ...
        RazorSyntaxTree syntaxTree)
    {
        ...
        return syntaxTree.Root.FindNode(sourceText.GetTextSpan(d.Range), getInnermostNodeForTie: true) is RazorCommentBlockSyntax;
    }
