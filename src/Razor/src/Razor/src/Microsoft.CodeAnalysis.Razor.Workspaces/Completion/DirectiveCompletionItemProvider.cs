...
{
    internal static readonly ImmutableArray<RazorCommitCharacter> SingleLineDirectiveCommitCharacters = DefaultCommitCharacters.GetDirectiveCommitCharacters(isBlock: false);
    internal static readonly ImmutableArray<RazorCommitCharacter> BlockDirectiveCommitCharacters = DefaultCommitCharacters.GetDirectiveCommitCharacters(isBlock: true);
