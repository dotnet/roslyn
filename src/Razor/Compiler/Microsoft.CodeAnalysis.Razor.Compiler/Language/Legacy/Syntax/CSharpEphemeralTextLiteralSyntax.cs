...
internal partial class CSharpEphemeralTextLiteralSyntax : ILegacySyntax
{
    public CSharpEphemeralTextLiteralSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
