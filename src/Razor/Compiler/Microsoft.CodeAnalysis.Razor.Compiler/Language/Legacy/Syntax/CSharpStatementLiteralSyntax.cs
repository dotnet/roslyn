...
internal partial class CSharpStatementLiteralSyntax : ILegacySyntax
{
    public CSharpStatementLiteralSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
