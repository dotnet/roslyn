...
namespace Analyzer.Utilities
{
    ...
    internal static partial class EditorConfigOptionNames
    {
        ...
        ///   3. Fully qualified type or namespace name with an optional "T:" prefix for type or "N:" prefix for namespace (includes all types with the exact type match or the exact containing namespace match)
