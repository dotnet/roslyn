...
public static class TestReferences
{
    ...
    public static class NetFx
    {
        ...
        public static class v3_5_30729
        {
            private static readonly Lazy<PortableExecutableReference> s_systemCore = new Lazy<PortableExecutableReference>(
                () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.v3_5_30729.System_Core_v3_5_30729).GetReference(display: "System.Core, v3.5.30729"),
                LazyThreadSafetyMode.PublicationOnly);
    ...
    public static class NetStandard20
    {
        ...
        private static readonly Lazy<PortableExecutableReference> s_system_Threading_Tasks_Extensions = new Lazy<PortableExecutableReference>(
            () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.netstandard20.System_Threading_Tasks_Extensions).GetReference(display: "System.Threading.Tasks.Extensions.dll (netstandard 2.0 ref)"),
            LazyThreadSafetyMode.PublicationOnly);
        ...
        private static readonly Lazy<PortableExecutableReference> s_system_Runtime_CompilerServices_Unsafe = new Lazy<PortableExecutableReference>(
            () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.netstandard20.System_Runtime_CompilerServices_Unsafe).GetReference(display: "System.Runtime.CompilerServices.Unsafe.dll (netstandard 2.0 ref)"),
            LazyThreadSafetyMode.PublicationOnly);
    ...
    public static class NetCoreApp30
    {
        ...
        private static readonly Lazy<PortableExecutableReference> s_system_Threading_Tasks = new Lazy<PortableExecutableReference>(
            () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.netcoreapp30.System_Threading_Tasks).GetReference(display: "System.Threading.Tasks.dll (netcoreapp 3.0 ref)"),
            LazyThreadSafetyMode.PublicationOnly);
        public static PortableExecutableReference SystemThreadingTasksRef => s_system_Threading_Tasks.Value;

        private static readonly Lazy<PortableExecutableReference> s_microsoftCSharp = new Lazy<PortableExecutableReference>(
            () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.netcoreapp30.Microsoft_CSharp).GetReference(display: "Microsoft.CSharp.dll (netcoreapp 3.0 ref)"),
            LazyThreadSafetyMode.PublicationOnly);
        public static PortableExecutableReference MicrosoftCSharpRef => s_microsoftCSharp.Value;

        private static readonly Lazy<PortableExecutableReference> s_microsoftVisualBasicCore = new Lazy<PortableExecutableReference>(
            () => AssemblyMetadata.CreateFromImage(TestResources.NetFX.netcoreapp30.Microsoft_VisualBasic_Core).GetReference(display: "Microsoft.VisualBasic.Core.dll (netcoreapp 3.0 ref)"),
            LazyThreadSafetyMode.PublicationOnly);
        public static PortableExecutableReference MicrosoftVisualBasicCoreRef => s_microsoftVisualBasicCore.Value;
    }
