...
{
    [CollectionDefinition(nameof(SharedIntegrationHostFixture2))]
    public sealed class SharedIntegrationHostFixture2 : ICollectionFixture<VisualStudioInstanceFactory>
    {
