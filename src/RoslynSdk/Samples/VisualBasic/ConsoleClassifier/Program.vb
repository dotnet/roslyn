...
Friend Module Program
    ...
    Public Sub Main(args As String())
        TestFormatterAndClassifierAsync().GetAwaiter.GetResult()
    End Sub
...
End Module")
        ...
        Dim text As SourceText = Await document.GetTextAsync().ConfigureAwait(False)

        Dim classifiedSpans As IEnumerable(Of ClassifiedSpan) = Await Classifier.GetClassifiedSpansAsync(document, TextSpan.FromBounds(0, text.Length)).ConfigureAwait(False)
