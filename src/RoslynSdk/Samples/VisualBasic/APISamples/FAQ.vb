...
End Module
            ...
            Dim identifier As ModifiedIdentifierSyntax = tree.GetRoot() _
                                                             .DescendantNodes _
                                                             .OfType(Of VariableDeclaratorSyntax) _
                                                             .Single _
                                                             .Names _
                                                             .Single
...
End Module
            ...
            Assert.Equal(Of ITypeSymbol)(variableType.OriginalDefinition, structType) ' OriginalDefinition for a closed generic type points to corresponding open generic type.
...
i (position 0)</text>.Value, results)
        ...
        Public Class MyAnnotation
            ...
            Public Shared Function GetPosition(annotation As SyntaxAnnotation) As Integer
                Return Integer.Parse(annotation.Data)
            End Function
        End Class
