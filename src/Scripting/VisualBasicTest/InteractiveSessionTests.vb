...
")
            ...
            Dim c2C2 = DirectCast(lookupMember(compilation2, "Submission_1", "C2"), INamedTypeSymbol)
            Dim c2C1 = c2C2.BaseType
            Dim c2X = lookupMember(compilation1, "Submission_0", "X")
...
")
            ...
            Dim c3C3 = DirectCast(lookupMember(compilation3, "Submission_2", "C3"), INamedTypeSymbol)
