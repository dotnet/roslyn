...
Namespace Microsoft.VisualStudio.Editors.AppDesInterop
    ...
    Friend NotInheritable Class NativeMethods
        ...
        Public Shared ReadOnly VBCompilerGuid As System.Guid = New System.Guid(VB_COMPILER_GUID)
...
#End If
            ...
            Public Sub New(ByVal [source] As Object, ByVal sink As Object, ByVal eventInterface As Type, ByVal throwException As Boolean)
                ...
                If throwException AndAlso ((connectionPoint Is Nothing AndAlso connectionPoint2 Is Nothing) OrElse cookie = 0) Then
