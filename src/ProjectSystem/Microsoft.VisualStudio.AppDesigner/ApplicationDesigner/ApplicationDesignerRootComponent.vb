'******************************************************************************
'* ApplicationDesignerRootComponent.vb
'*
...
Namespace Microsoft.VisualStudio.Editors.ApplicationDesigner
    ...
    Public NotInheritable Class ApplicationDesignerRootComponent
        ...
        Private m_RootDesigner As ApplicationDesignerRootDesigner
        ...
        Public ReadOnly Property RootDesigner() As ApplicationDesignerRootDesigner
            Get
                If m_RootDesigner Is Nothing Then
                    ...
                    m_RootDesigner = CType(Host.GetDesigner(Me), ApplicationDesignerRootDesigner)
                End If
