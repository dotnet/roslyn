...
", HangMitigatingCancellationToken);
            await TestServices.Editor.InvokeCodeActionListAsync(HangMitigatingCancellationToken);
            await TestServices.EditorVerifier.CodeActionAsync("using System.Xml.Linq;", cancellationToken: HangMitigatingCancellationToken);
        }
...
public class P2 { }", HangMitigatingCancellationToken);
            ...
            await TestServices.Input.SendAsync(VirtualKeyCode.BACK, VirtualKeyCode.BACK, "XElement");
            await TestServices.Workspace.WaitForAllAsyncOperationsAsync(
                new[]
                {
                    FeatureAttribute.Workspace,
            ...
            await using (var fileChangeRestorer = await TestServices.Shell.PauseFileChangesAsync(HangMitigatingCancellationToken))
            {
                ...
                {
                    "using System.Xml.Linq;",
                    "Rename 'P2' to 'XElement'",
                    "System.Xml.Linq.XElement",
                    "Generate class 'XElement' in new file",
                    "Generate class 'XElement'",
                    "Generate nested class 'XElement'",
                    "Generate new type...",
            ...
            await TestServices.EditorVerifier.TextContainsAsync("using System.Xml.Linq;", cancellationToken: HangMitigatingCancellationToken);
        }
