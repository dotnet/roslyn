...
{
    internal class UIAutomationOrCondition : AutomationRetryWrapper<IUIAutomationOrCondition>, IUIAutomationOrCondition
    {
        public UIAutomationOrCondition(IUIAutomationOrCondition automationObject)
