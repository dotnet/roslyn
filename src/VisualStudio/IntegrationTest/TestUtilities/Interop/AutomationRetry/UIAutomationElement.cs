...
{
    internal class UIAutomationElement : AutomationRetryWrapper<IUIAutomationElement>, IUIAutomationElement
    {
        public UIAutomationElement(IUIAutomationElement automationObject)
