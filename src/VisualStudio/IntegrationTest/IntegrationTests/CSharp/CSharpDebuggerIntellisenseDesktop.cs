...
namespace Roslyn.VisualStudio.IntegrationTests.CSharp
{
    ...
    public class CSharpDebuggerIntellisenseDesktop : CSharpDebuggerIntellisenseCommon
    {
        public CSharpDebuggerIntellisenseDesktop(VisualStudioInstanceFactory instanceFactory)
            : base(instanceFactory, WellKnownProjectTemplates.ConsoleApplication)
        {
        }
