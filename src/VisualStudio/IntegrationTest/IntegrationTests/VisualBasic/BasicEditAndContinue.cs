...
");
            ...
            await VisualStudio.Dialog.VerifyOpenAsync(editAndContinueDialogName, HangMitigatingCancellationToken);
            await VisualStudio.Dialog.ClickOKAsync(editAndContinueDialogName);
            await VisualStudio.Dialog.VerifyClosedAsync(editAndContinueDialogName, HangMitigatingCancellationToken);
            ...
            await VisualStudio.Dialog.VerifyOpenAsync(microsoftVisualStudionDialogName, HangMitigatingCancellationToken);
            await VisualStudio.Dialog.ClickOKAsync(microsoftVisualStudionDialogName);
            await VisualStudio.Dialog.VerifyClosedAsync(microsoftVisualStudionDialogName, HangMitigatingCancellationToken);
            await VisualStudio.Editor.Verify.IsProjectItemDirtyAsync(expectedValue: false);
        }
