...
namespace Roslyn.VisualStudio.IntegrationTests.VisualBasic
{
    ...
    public class BasicDebuggerIntellisenseDesktop : BasicDebuggerIntellisenseCommon
    {
        public BasicDebuggerIntellisenseDesktop(VisualStudioInstanceFactory instanceFactory)
