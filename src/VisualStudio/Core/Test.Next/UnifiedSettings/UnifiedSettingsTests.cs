...
public sealed class UnifiedSettingsTests
{
    ...
    [
        ...
        (CompletionOptionsStorage.ImportCompletionCommitBehavior, CreateEnumOption(
            ...
            title: "Commit behavior for items from unimported namespaces",
            order: 81,
            enableWhenOptionAndValue: (enableWhenOption: CompletionOptionsStorage.ShowItemsFromUnimportedNamespaces, whenValue: true),
            customDefaultValue: ImportCompletionCommitBehavior.AlwaysAddImportWhenCommitted,
            enumLabels: ["Always add using when committed", "Never add using when committed", "Only add using when committed explicitly (via TAB or double-click)"],
            enumValues: [ImportCompletionCommitBehavior.AlwaysAddImportWhenCommitted, ImportCompletionCommitBehavior.NeverAddImportWhenCommitted, ImportCompletionCommitBehavior.OnlyAddImportWhenCommittedExplicitly],
            customMaps: [new Map { Result = "alwaysAddImportWhenCommitted", Match = 0 }, new Map { Result = "neverAddImportWhenCommitted", Match = 1 }, new Map { Result = "onlyAddImportWhenCommittedExplicitly", Match = 2}],
            languageName: LanguageNames.CSharp)),
    ...
    [
        ...
        (CompletionOptionsStorage.ImportCompletionCommitBehavior, CreateEnumOption(
            ...
            enableWhenOptionAndValue: (enableWhenOption: CompletionOptionsStorage.ShowItemsFromUnimportedNamespaces, whenValue: true),
            customDefaultValue: ImportCompletionCommitBehavior.AlwaysAddImportWhenCommitted,
            enumLabels: ["Always add import when committed", "Never add import when committed", "Only add import when committed explicitly (via TAB or double-click)"],
            enumValues: [ImportCompletionCommitBehavior.AlwaysAddImportWhenCommitted, ImportCompletionCommitBehavior.NeverAddImportWhenCommitted, ImportCompletionCommitBehavior.OnlyAddImportWhenCommittedExplicitly],
            customMaps: [new Map { Result = "alwaysAddImportWhenCommitted", Match = 0 }, new Map { Result = "neverAddImportWhenCommitted", Match = 1 }, new Map { Result = "onlyAddImportWhenCommittedExplicitly", Match = 2}],
            languageName: LanguageNames.VisualBasic)),
        (CompletionViewOptionsStorage.EnableArgumentCompletionSnippets, CreateBooleanOption(
