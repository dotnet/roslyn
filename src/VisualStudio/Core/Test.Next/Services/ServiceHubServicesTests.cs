...
// TODO: Test";
        ...
        private static async Task<AssetProvider> GetAssetProviderAsync(Workspace workspace, Workspace remoteWorkspace, Solution solution, ConcurrentDictionary<Checksum, object> map = null)
        {
