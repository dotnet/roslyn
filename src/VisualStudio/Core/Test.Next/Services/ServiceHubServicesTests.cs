...
namespace Roslyn.VisualStudio.Next.UnitTests.Remote
{
    ...
    public class ServiceHubServicesTests
    {
        ...
        public async Task TestRemoteHostTextSynchronize()
        {
            ...
            Assert.True(client.TestData.WorkspaceManager.SolutionAssetCache.TryGetAsset<SourceText>(newState.Text, out var sourceText));
            Assert.Equal(newText.ToString(), sourceText.ToString());
        }
