...
internal sealed class CommonWhitespaceSettingsWorkspaceServiceFactory(
    IThreadingContext threadingContext,
    IGlobalOptionService globalOptions) : IWorkspaceServiceFactory
{
    public IWorkspaceService CreateService(HostWorkspaceServices workspaceServices)
        => new CommonWhitespaceSettingsProviderFactory(threadingContext, workspaceServices.Workspace, globalOptions);
}
