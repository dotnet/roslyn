...
internal static class GlyphExtensions
{
    ...
    {
        public StandardGlyphGroup GetStandardGlyphGroup()
        {
            switch (glyph)
            {
                case Glyph.Assembly:
        ...
        public ImageSource GetImageSource(IGlyphService glyphService)
            => glyphService.GetGlyph(glyph.GetStandardGlyphGroup(), glyph.GetStandardGlyphItem());

        public ushort GetGlyphIndex()
        {
    ...
    extension(Glyph icon)
    {
        public StandardGlyphItem GetStandardGlyphItem()
        {
            switch (icon)
            {
                case Glyph.ClassProtected:
