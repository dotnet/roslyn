    ...
    internal sealed class VisualStudioRemoteHostClientProvider : IRemoteHostClientProvider
    {
        ...
        internal sealed class Factory : IWorkspaceServiceFactory
        {
            ...
            public IWorkspaceService CreateService(HostWorkspaceServices workspaceServices)
            {
                ...
                var isCloudEnvironmentClient = workspaceServices.GetRequiredService<IWorkspaceContextService>().IsCloudEnvironmentClient();
                if (!RemoteHostOptions.IsUsingServiceHubOutOfProcess(workspaceServices)
                    || workspaceServices.Workspace is not VisualStudioWorkspace || isCloudEnvironmentClient)
                {
