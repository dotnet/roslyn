...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.LanguageClient
{
    ...
    {
        public async Task<TraceSource?> CreateTraceSourceAsync(string name, CancellationToken cancellationToken)
        {
            if (_asyncServiceProvider == null)
                return null;

            var logId = new LogId(name, new ServiceMoniker("Microsoft.VisualStudio.LanguageServices.Implementation.LanguageClient"));
