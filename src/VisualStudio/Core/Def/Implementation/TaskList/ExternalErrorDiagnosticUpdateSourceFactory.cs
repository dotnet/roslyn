...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.TaskList
{
    ...
    internal sealed class ExternalErrorDiagnosticUpdateSourceFactory : IWorkspaceServiceFactory
    {
        ...
        {
            return new ExternalErrorDiagnosticUpdateSource(workspaceServices.Workspace, _diagnosticService, _registrationService, _listenerProvider, _threadingContext);
        }
    }
}
