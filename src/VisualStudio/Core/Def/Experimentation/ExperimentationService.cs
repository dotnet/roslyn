...
{
    [Export(typeof(ExperimentationService)), Shared]
    internal class ExperimentationService : ForegroundThreadAffinitizedObject, IExperimentationService
    {
        ...
        public ExperimentationService(IThreadingContext threadingContext, SVsServiceProvider serviceProvider)
