...
internal static class Extensions
{
    ...
    extension(ISymbol memberSymbol)
    {
        public string GetMemberNavInfoNameOrEmpty()
        {
    ...
    {
        public string GetNamespaceNavInfoNameOrEmpty()
        {
    ...
    {
        public string GetTypeNavInfoNameOrEmpty()
        {
    ...
    extension(Project project)
    {
        ...
        /// </summary>
        public string GetProjectNavInfoName()
        {
