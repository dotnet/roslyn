        ...
        IAsynchronousOperationListener asyncListener)
    {
        ...
        if (context.Direction == GraphContextDirection.Custom)
        {
            ...
            if (searchParameters != null)
            {
                ...
                // results immediately.
                graphQueries.Add(new SearchGraphQuery(searchParameters.SearchQuery.SearchString, NavigateToDocumentScope.RegularDocuments, asyncListener));
                graphQueries.Add(new SearchGraphQuery(searchParameters.SearchQuery.SearchString, NavigateToDocumentScope.GeneratedDocuments, asyncListener));
            }
        }
