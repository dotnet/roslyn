...
{
    extension(IVsRunningDocumentTable4 runningDocumentTable)
    {
        public bool TryGetBufferFromMoniker(IVsEditorAdaptersFactoryService editorAdaptersFactoryService,
        ...
        public bool TryGetBuffer(IVsEditorAdaptersFactoryService editorAdaptersFactoryService,
