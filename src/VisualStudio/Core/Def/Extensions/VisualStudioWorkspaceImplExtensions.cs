...
internal static class VisualStudioWorkspaceImplExtensions
{
    ...
    {
        private bool TryGetImageListAndIndex(IVsImageService2 imageService, uint itemId, out IntPtr imageList, out ushort index)
        {
    ...
    extension(VisualStudioWorkspaceImpl workspace)
    {
        public bool TryGetImageListAndIndex(IVsImageService2 imageService, DocumentId id, out IntPtr imageList, out ushort index)
        {
