...
{
    extension(VsTextSpan spanInSecondaryBuffer)
    {
        public async Task<VsTextSpan?> MapSpanFromSecondaryBufferToPrimaryBufferAsync(
        ...
        /// </summary>
        public VsTextSpan? MapSpanFromSecondaryBufferToPrimaryBuffer(
            IThreadingContext threadingContext,
            DocumentId documentId,
