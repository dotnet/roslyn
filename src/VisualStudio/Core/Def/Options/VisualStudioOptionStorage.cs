...
internal abstract class VisualStudioOptionStorage
{
    ...
    public static readonly IReadOnlyDictionary<string, VisualStudioOptionStorage> Storages = new Dictionary<string, VisualStudioOptionStorage>()
    {
        ...
        {"dotnet_brace_completion_options_auto_formatting_on_close_brace", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Close Brace")},
        ...
        {"dotnet_completion_options_block_for_completion_items", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.BlockForCompletionItems")},
...
#pragma warning restore
        ...
        {"dotnet_completion_options_show_name_suggestions", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.ShowNameSuggestions")},
        {"dotnet_completion_options_show_new_snippet_experience_Feature_Flag", new FeatureFlagStorage(@"Roslyn.SnippetCompletion")},
        {"dotnet_completion_options_show_new_snippet_experience_user_option", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.ShowNewSnippetExperience")},
...
#pragma warning restore
        ...
        {"dotnet_completion_options_unnamed_symbol_completion_disabled_feature_flag", new FeatureFlagStorage(@"Roslyn.UnnamedSymbolCompletionDisabled")},
        ...
        {"csharp_diagnostic_options_log_telemetry_for_background_analyzer_execution", new FeatureFlagStorage(@"Roslyn.LogTelemetryForBackgroundAnalyzerExecution")},
        {"csharp_diagnostic_options_lsp_pull_diagnostics_feature_flag", new FeatureFlagStorage(@"Lsp.PullDiagnostics")},
        {"csharp_diagnostic_tagging_options_pull_diagnostic_tagging", new FeatureFlagStorage(@"Roslyn.PullDiagnosticTagging")},
#pragma warning disable CS0612 // Type or member is obsolete
...
#pragma warning restore
        ...
        {"dotnet_formatting_options_auto_formatting_on_return", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Return")},
        {"dotnet_formatting_options_auto_formatting_on_semicolon", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Semicolon")},
        {"dotnet_formatting_options_auto_formatting_on_typing", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Typing")},
...
#pragma warning restore
        ...
        {"dotnet_inline_hints_options_enabled_for_types", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.InlineTypeHints")},
        {"dotnet_inline_hints_options_for_implicit_object_creation", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.InlineTypeHints.ForImplicitObjectCreation")},
        {"dotnet_inline_hints_options_for_implicit_variable_types", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.InlineTypeHints.ForImplicitVariableTypes")},
        ...
        {"dotnet_inline_hints_options_for_lambda_parameter_types", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.InlineTypeHints.ForLambdaParameterTypes")},
        ...
        {"dotnet_inline_rename_useInline_adornment", new RoamingProfileStorage("TextEditor.RenameUseInlineAdornment")},
...
#pragma warning restore
        ...
        {"dotnet_split_string_literal_options_enabled", new RoamingProfileStorage("TextEditor.CSharp.Specific.SplitStringLiterals")},
        {"dotnet_stack_trace_explorer_options_open_on_focus", new RoamingProfileStorage("StackTraceExplorer.Options.OpenOnFocus")},
...
#pragma warning restore
        ...
        {"dotnet_visual_studio_navigation_options_navigate_to_object_browser", new RoamingProfileStorage("TextEditor.%LANGUAGE%.Specific.NavigateToObjectBrowser")},
