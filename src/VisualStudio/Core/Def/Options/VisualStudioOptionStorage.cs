...
#pragma warning restore
        ...
        {"dotnet_semantic_colorizer_enabled", new LocalUserProfileStorage(@"Roslyn\Internal\OnOff\Features", "Semantic Colorizer")},
        ...
        {"dotnet_syntactic_colorizer_enabled", new LocalUserProfileStorage(@"Roslyn\Internal\OnOff\Features", "Syntactic Colorizer")},
        ...
        {"dotnet_language_server_protocol_editor_enabled", new FeatureFlagStorage(@"Roslyn.LSP.Editor")},
        {"dotnet_language_server_protocol_semantic_tokens_enabled", new FeatureFlagStorage(@"Roslyn.LSP.SemanticTokens")},
...
#pragma warning restore
        ...
        {"dotnet_visual_studio_workspace_partial_load_mode", new FeatureFlagStorage(@"Roslyn.PartialLoadMode")},
        ...
        {"dotnet_enable_language_server_protocol_intellisense_in_xaml", new FeatureFlagStorage(@"Xaml.EnableLspIntelliSense")},
    };
}
