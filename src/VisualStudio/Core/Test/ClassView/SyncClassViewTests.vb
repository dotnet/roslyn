...
#End Region
        ...
        Private Sub Test(
            ...
            Using workspace = TestWorkspace.Create(workspaceDefinition, exportProvider:=ExportProviderCache.CreateExportProvider(VisualStudioTestExportProvider.PartCatalog))
