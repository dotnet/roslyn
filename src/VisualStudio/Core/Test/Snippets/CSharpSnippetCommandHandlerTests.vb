    ...
    void M()
    {
        ...
        Public Sub SnippetCommandHandler_Interactive_InsertSnippetCommand()
            ...
            Using testState
                ...
                testState.SendInsertSnippetCommand(AddressOf handler.ExecuteCommand)
                Assert.True(delegatedToNext)
        ...
        Public Sub SnippetCommandHandler_Interactive_SurroundWithCommand()
            ...
            Using testState
                ...
                Dim state = handler.GetCommandState(New Text.UI.Commanding.Commands.SurroundWithCommandArgs(testState.TextView, testState.SubjectBuffer))
                Assert.False(state.IsAvailable)
