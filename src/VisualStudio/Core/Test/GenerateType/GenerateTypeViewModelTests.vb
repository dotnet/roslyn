...
namespace A
{
    namespace B
    {
        ...
        <Fact, WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/858815")>
...
End Class]]></Text>
        ...
        <Fact, WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/861544")>
...
End Namespace                                       </Document>
        ...
        <Fact, WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/858826")>
...
class Program
{
    static void Main(string[] args)
    {
        ...
        <Fact, WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/898452")>
