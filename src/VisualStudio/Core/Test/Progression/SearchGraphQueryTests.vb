    ...
    Public Class SearchGraphQueryTests
        ...
        Public Async Function SearchForType() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="C", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
        ...
        Public Async Function SearchForNestedType() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="F", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
        ...
        Public Async Function SearchForMember() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="M", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
...
End Namespace
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="Goo", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
...
End Namespace
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="Z", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
        ...
        Public Async Function SearchForDottedName1() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="D.B", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
        ...
        Public Async Function SearchForDottedName2() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="C.B", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
        ...
        Public Async Function SearchForDottedName4() As Task
            Using testState = ProgressionTestState.Create(
                ...
                Dim threadingContext = testState.Workspace.ExportProvider.GetExportedValue(Of IThreadingContext)
                Dim outputContext = Await testState.GetGraphContextAfterQuery(
                    New Graph(), New SearchGraphQuery(searchPattern:="A.D.B", threadingContext, AsynchronousOperationListenerProvider.NullListener, useNavigateToEngine:=False), GraphContextDirection.Custom)
