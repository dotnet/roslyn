...
Namespace Microsoft.VisualStudio.LanguageServices.UnitTests.Progression
    Public Class GraphNodeIdTests
        ...
        <Fact, Trait(Traits.Feature, Traits.Features.Progression)>
        Sub MemberWithGenericTypeParameters()
            AssertMarkedNodeIdIs(
        ...
        Sub MemberWithParameterTypeConstructedWithMemberTypeParameter()
            AssertMarkedNodeIdIs(
        ...
        <Fact, Trait(Traits.Feature, Traits.Features.Progression)>
        Sub MemberWithArraysOfGenericTypeParameters()
            AssertMarkedNodeIdIs(
                "namespace N { class C<T> { void $$M<U>(T[] t, U[] u) { } } }",
        ...
        <Fact, Trait(Traits.Feature, Traits.Features.Progression)>
        Sub MemberWithArraysOfGenericTypeParameters2()
            AssertMarkedNodeIdIs(
                "namespace N { class C<T> { void $$M<U>(T[][,] t, U[][,] u) { } } }",
        ...
        <Fact, Trait(Traits.Feature, Traits.Features.Progression), WorkItem(616549)>
        Sub MemberWithGenericTypeOfDynamicType()
            AssertMarkedNodeIdIs(
        ...
        <Fact, Trait(Traits.Feature, Traits.Features.Progression), WorkItem(616549)>
        Sub MemberWithArrayOfDynamicType()
            AssertMarkedNodeIdIs(
                "namespace N { class C { void $$M(dynamic[] d) { } } }",
