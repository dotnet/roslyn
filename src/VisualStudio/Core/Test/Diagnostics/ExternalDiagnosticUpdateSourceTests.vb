...
Namespace Microsoft.VisualStudio.LanguageServices.UnitTests.Diagnostics
    ...
    Public Class ExternalDiagnosticUpdateSourceTests
        ...
        Private Class TestDiagnosticAnalyzerService
            ...
            Public Function GetSpecificCachedDiagnosticsAsync(workspace As Workspace, projectId As ProjectId, documentId As DocumentId, id As Object, Optional includeSuppressedDiagnostics As Boolean = False, Optional cancellationToken As CancellationToken = Nothing) As Task(Of ImmutableArray(Of DiagnosticData)) Implements IDiagnosticAnalyzerService.GetSpecificCachedDiagnosticsAsync
