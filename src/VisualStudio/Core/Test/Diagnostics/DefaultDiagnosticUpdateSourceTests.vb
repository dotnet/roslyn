        ...
        M m = null
            ...
            Using workspace = TestWorkspace.CreateCSharp(code.Value, openDocuments:=True)
                ...
                Dim diagnostics = diagnosticService.GetPushDiagnostics(
                    workspace, document.Project.Id, document.Id, Nothing, includeSuppressedDiagnostics:=False, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None)
