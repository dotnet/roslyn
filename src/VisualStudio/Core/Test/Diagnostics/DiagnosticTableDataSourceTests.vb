    ...
    Public Class DiagnosticTableDataSourceTests
        ...
        Public Sub TestMultipleWorkspace()
            Using workspace1 = TestWorkspace.CreateCSharp(String.Empty)
                Using workspace2 = TestWorkspace.CreateCSharp(String.Empty)
                    ...
                    Dim table = VisualStudioDiagnosticListTableWorkspaceEventListener.VisualStudioDiagnosticListTable.TestAccessor.Create(workspace1, threadingContext, globalOptions, provider, tableManagerProvider)
        ...
        Public Async Function TestAggregatedDiagnostic() As Task
            ...
            Using workspace = TestWorkspace.Create(markup)
                ...
                Dim tableManagerProvider = New TestTableManagerProvider()
                Dim table = VisualStudioDiagnosticListTableWorkspaceEventListener.VisualStudioDiagnosticListTable.TestAccessor.Create(workspace, threadingContext, globalOptions, service, tableManagerProvider)
        ...
        Public Async Function TestAggregatedDiagnosticCSErrorWithFileLocationButNoDocumentId() As Task
            ...
            Using workspace = TestWorkspace.Create(markup)
                ...
                Using updateSource = New ExternalErrorDiagnosticUpdateSource(workspace.GlobalOptions, workspace, analyzerService, listener, CancellationToken.None)
