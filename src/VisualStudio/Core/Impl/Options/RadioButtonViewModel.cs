...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.Options
{
    ...
    {
        private readonly SingleValuedOption2<TOption> _option;
        private readonly TOption _value;

        public RadioButtonViewModel(string description, string preview, string group, TOption value, SingleValuedOption2<TOption> option, AbstractOptionPreviewViewModel info, OptionStore optionStore)
