...
namespace Microsoft.VisualStudio.LanguageServices.Xaml.Implementation.LanguageServer.Handler.Diagnostics
{
    ...
    internal class DocumentPullDiagnosticHandlerProvider : AbstractRequestHandlerProvider
    {
        ...
        public DocumentPullDiagnosticHandlerProvider(IXamlPullDiagnosticService xamlPullDiagnosticService)
        {
        ...
        {
            return ImmutableArray.Create(new DocumentPullDiagnosticHandler(_xamlPullDiagnosticService));
        }
    }
}
