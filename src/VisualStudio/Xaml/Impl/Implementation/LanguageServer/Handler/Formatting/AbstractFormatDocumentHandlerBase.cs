...
{
    internal abstract class AbstractFormatDocumentHandlerBase<RequestType, ResponseType> : AbstractStatelessRequestHandlerAndProvider<RequestType, ResponseType>
    {
