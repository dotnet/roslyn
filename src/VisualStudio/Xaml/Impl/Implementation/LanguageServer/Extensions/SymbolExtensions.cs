...
internal static class SymbolExtensions
{
    ...
    {
        public async Task<IEnumerable<TaggedText>> GetDescriptionAsync(TextDocument document, SymbolDescriptionOptions options, CancellationToken cancellationToken)
        {
            if (symbol == null)
            {
                return [];
