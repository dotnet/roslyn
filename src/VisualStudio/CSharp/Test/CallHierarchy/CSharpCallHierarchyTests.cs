...
namespace N
{
    ...
    class G
    {
        ...
        void Main2()
        {
            ...
            testState.VerifyRoot(root, "N.C.Goo()",
            [
                string.Format(EditorFeaturesResources.Calls_To_0, "Goo"), string.Format(EditorFeaturesResources.Calls_To_Interface_Implementation_0, "N.I.Goo()")
            ]);
...
namespace N
{
    ...
    class D : C
    {
        ...
        void Baz()
        {
            ...
            using var testState = CallHierarchyTestState.Create(text);
            var root = await testState.GetRootAsync();
            testState.VerifyRoot(root, "N.D.Goo()",
            [
                string.Format(EditorFeaturesResources.Calls_To_0, "Goo"), string.Format(EditorFeaturesResources.Calls_To_Base_Member_0, "N.C.Goo()")
            ]);
...
class Derived : Base
{
    public override void M()
    {
        throw new NotImplementedException();
            ...
            using var testState = CallHierarchyTestState.Create(text);
            var root = await testState.GetRootAsync();
            testState.VerifyRoot(root, "Base.M()",
            [
                string.Format(EditorFeaturesResources.Calls_To_0, "M"), EditorFeaturesResources.Overrides_, EditorFeaturesResources.Calls_To_Overrides
            ]);
