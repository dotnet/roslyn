...
internal sealed class CSharpWhitespaceSettingsLanguageServiceFactory(
    ...
    IGlobalOptionService globalOptions) : ILanguageServiceFactory
{
    public ILanguageService CreateLanguageService(HostLanguageServices languageServices)
    {
        ...
        return new CSharpWhitespaceSettingsProviderFactory(threadingContext, workspace, globalOptions);
    }
}
