...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    internal static class AdvancedOptionPageStrings
    {
        ...
        public static string Option_Always_use_Microsoft_and_Nuget_symbol_servers_for_navigation
            => ServicesVSResources.Always_use_Microsoft_and_Nuget_symbol_servers_for_navigation;
