...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    internal static class AdvancedOptionPageStrings
    {
        ...
        public static string Option_Suppress_hints_when_parameter_names_match_argument_names
            => ServicesVSResources.Suppress_hints_when_parameter_names_match_argument_names;
