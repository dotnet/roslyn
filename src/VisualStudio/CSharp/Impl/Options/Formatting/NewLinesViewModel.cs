...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options.Formatting
{
    ...
    {
        private static readonly string s_previewText = @"//[
class C {
}
//]";

        private static readonly string s_methodPreview = @"class c {
//[
    void Goo(){
        Console.WriteLine();
...
//]
        ...
        private static readonly string s_propertyPreview = @"class c {
//[
    public int Property {
        get {
            return 42;
