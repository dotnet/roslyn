...
";
        ...
        private static readonly string s_allow_bank_line_after_token_in_conditional_expression_false = $@"
namespace NS1
{{
    class Class
    {{
...
";
        ...
        internal StyleViewModel(OptionStore optionStore, IServiceProvider serviceProvider) : base(optionStore, serviceProvider, LanguageNames.CSharp)
        {
            ...
            CodeStyleItems.Add(new BooleanCodeStyleOptionViewModel(CSharpCodeStyleOptions.AllowBlankLineAfterTokenInConditionalExpression, CSharpVSResources.Allow_bank_line_after_token_in_conditional_expression, s_allow_bank_line_after_token_in_conditional_expression_true, s_allow_bank_line_after_token_in_conditional_expression_false, this, optionStore, newLinePreferencesGroupTitle));
        }
