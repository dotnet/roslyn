...
";
        ...
        internal StyleViewModel(OptionStore optionStore, IServiceProvider serviceProvider) : base(optionStore, serviceProvider, LanguageNames.CSharp)
        {
            ...
            CodeStyleItems.Add(new BooleanCodeStyleOptionViewModel(CSharpCodeStyleOptions.VarWhenTypeIsExplicit, CSharpVSResources.When_variable_type_is_explicit, s_varWhereExplicitPreviewTrue, s_varWhereExplicitPreviewFalse, this, optionStore, varGroupTitle, typeStylePreferences));
