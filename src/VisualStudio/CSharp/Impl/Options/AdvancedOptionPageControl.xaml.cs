...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    internal partial class AdvancedOptionPageControl : AbstractOptionPageControl
    {
        ...
        public AdvancedOptionPageControl(OptionStore optionStore, IComponentModel componentModel) : base(optionStore)
        {
            ...
            BindToOption(AddUsingsOnPaste, AddImportOnPasteOptions.AddImportsOnPaste, LanguageNames.CSharp);
            ...
            BindToOption(DisplayLineSeparators, LineSeparatorsOptions.LineSeparator, LanguageNames.CSharp);
            ...
            BindToOption(RenameTrackingPreview, RenameTrackingOptions.RenameTrackingPreview, LanguageNames.CSharp);
            BindToOption(Split_string_literals_on_enter, SplitStringLiteralOptions.Enabled);
            BindToOption(Fix_text_pasted_into_string_literals_experimental, StringCopyPasteOptions.AutomaticallyFixStringContentsOnPaste, LanguageNames.CSharp);
