...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.LanguageService
{
    ...
    [ProvideOptionPage(typeof(Options.IntelliSenseOptionPage), categoryName: @"TextEditor\C#\IntelliSense", pageName: "IntelliSense", pageNameResourceID: 103, categoryResourceID: 0, supportsAutomation: true, IsInUnifiedSettings = true)]
