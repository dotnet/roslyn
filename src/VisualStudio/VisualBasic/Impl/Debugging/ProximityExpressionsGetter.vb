...
Namespace Microsoft.VisualStudio.LanguageServices.VisualBasic.Debugging
    ...
    Friend Partial Class VisualBasicProximityExpressionsService
        ...
        Public Async Function GetProximityExpressionsAsync(
                                                          ...
                                                          ) As Task(Of IList(Of String)) Implements IProximityExpressionsService.GetProximityExpressionsAsync
        ...
        Public Async Function IsValidAsync(
                                            ...
                                            cancellationToken As CancellationToken
                                          ) As Task(Of Boolean) Implements IProximityExpressionsService.IsValidAsync
            ...
            If parentEndBlock IsNot Nothing Then token = parentEndBlock.EndKeyword.GetPreviousToken()
            ...
            If info.Symbol Is Nothing Then Return False
            ...
            If info.Symbol.Kind <> SymbolKind.Local Then Return True
