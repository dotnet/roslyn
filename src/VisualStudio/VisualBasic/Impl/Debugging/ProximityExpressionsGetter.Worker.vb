    ...
    Friend Partial Class VisualBasicProximityExpressionsService
        Public Class Worker
            ...
            Friend Function [Do](cancellationToken As CancellationToken) As IList(Of String)
                ...
                If _parentStatement Is Nothing Then Return Nothing
            ...
            Private Sub AddPrecedingRelevantExpressions()
                ...
                If previousStatement Is Nothing Then Exit Sub
            ...
            Private Sub AddMethodParameters()
                If TypeOf _parentStatement.Parent IsNot MethodBlockBaseSyntax Then Exit Sub
                ...
                If methodBlock.BlockStatement Is _parentStatement OrElse
                   ...
                   methodBlock.EndBlockStatement Is _parentStatement Then
                    ...
                    If methodBlock.BlockStatement.ParameterList Is Nothing Then Exit Sub
            ...
            Private Sub AddCatchParameters()
                If TypeOf _parentStatement.Parent IsNot CatchBlockSyntax Then Exit Sub
            ...
            Private Sub AddMeExpression()
                If Not InSharedContext() Then _additionalTerms.Add("Me")
            End Sub

            Private Function InSharedContext() As Boolean
                Dim methodBlock = _parentStatement.GetAncestorOrThis(Of MethodBlockBaseSyntax)()
                ...
                Dim propertyBlock = _parentStatement.GetAncestorOrThis(Of PropertyBlockSyntax)()
                ...
                Dim typeBlock = _parentStatement.GetAncestorOrThis(Of TypeBlockSyntax)()
