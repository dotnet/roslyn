...
Namespace Microsoft.VisualStudio.LanguageServices.VisualBasic.Options
    Friend Class AdvancedOptionPageControl
        ...
        Public Sub New(optionStore As OptionStore, componentModel As IComponentModel, experimentationService As IExperimentationService)
            ...
            BindToOption(place_at_end_of_line_of_code, InlineDiagnosticsOptions.LocationOption, InlineDiagnosticsLocations.PlacedAtEndOfCode, LanguageNames.VisualBasic)
            BindToOption(place_at_end_of_editor_window, InlineDiagnosticsOptions.LocationOption, InlineDiagnosticsLocations.PlacedAtEndOfCode, LanguageNames.VisualBasic)
