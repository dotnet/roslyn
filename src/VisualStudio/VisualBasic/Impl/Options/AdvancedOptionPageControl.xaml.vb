...
Namespace Microsoft.VisualStudio.LanguageServices.VisualBasic.Options
    Friend Class AdvancedOptionPageControl
        ...
        Public Sub New(optionStore As OptionStore, componentModel As IComponentModel)
            ...
            BindToOption(AddMissingImportsOnPaste, AddImportOnPasteOptions.AddImportsOnPaste, LanguageNames.VisualBasic)
            ...
            BindToOption(DisplayLineSeparators, LineSeparatorsOptions.LineSeparator, LanguageNames.VisualBasic)
            ...
            BindToOption(EnableLineCommit, LineCommitOptions.PrettyListing, LanguageNames.VisualBasic)
            ...
            BindToOption(RenameTrackingPreview, RenameTrackingOptions.RenameTrackingPreview, LanguageNames.VisualBasic)
