...
Namespace Microsoft.VisualStudio.Editors.Common
    ...
    Friend NotInheritable Class ShellUtil
        ...
        ''' <remarks></remarks>
        Friend Shared Function IsVenusProject(ByVal hierarchy As IVsHierarchy) As [Boolean]
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Friend Shared Function IsSilverLightProject(ByVal hierarchy As IVsHierarchy) As [Boolean]
...
#End Region
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function IsDefaultNamespaceRename(ByVal pHier As IVsHierarchy, ByVal itemId As UInteger) As Boolean
            ' result <<== out
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function GetVSColor(ByVal VsSysColorIndex As __VSSYSCOLOREX3, ByVal DefaultColor As Color, Optional ByVal UseVSTheme As Boolean = True) As Color
