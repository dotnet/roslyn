...
namespace Roslyn.VisualStudio.DiagnosticsWindow.OptionsPages
{
    internal sealed class ForceLowMemoryMode
    {
        ...
        public static readonly SingleValuedOption2<bool> Enabled = new(FeatureName, "Enabled", defaultValue: false,
            storageLocation: new LocalUserProfileStorageLocation(@"Roslyn\ForceLowMemoryMode\Enabled"));

        public static readonly SingleValuedOption2<int> SizeInMegabytes = new(FeatureName, "SizeInMegabytes", defaultValue: 500,
