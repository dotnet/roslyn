...
{
    extension(VisualStudioWorkspace workspace)
    {
        public Metadata GetMetadata(string fullPath, DateTime snapshotTimestamp)
        {
        ...
        public bool TryGetProjectIdByBinPath(string filePath, [NotNullWhen(true)] out ProjectId? projectId)
        {
        ...
        [Obsolete("When Roslyn/ProjectSystem integration is finished, don't use this.")]
        public string? GetProjectFilePath(ProjectId projectId)
        {
