...
namespace Microsoft.CodeAnalysis.BannedApiAnalyzers.UnitTests
{
    ...
    public class SymbolIsBannedAnalyzerTests
    {
        ...
        [Fact]
        public async Task ExcludeGeneratedCode_WhenEnabled_ReadsOptionCorrectlyAsync()
        {
            // Note: This test verifies the option can be set to true, but cannot verify
            // the exclusion behavior works because the test framework doesn't properly
            // set context.IsGeneratedCode for files with // <auto-generated/> comments.
            // The feature works in production where Roslyn properly detects generated code.
            ...
            var test = new VerifyCS.Test
            {
                ...
                // Note: We expect a diagnostic here even though the option is true,
                // because the test framework doesn't set IsGeneratedCode properly.
                // In real usage, this diagnostic would be suppressed.
                ExpectedDiagnostics =
                {
                    GetCSharpResultAt(0, SymbolIsBannedAnalyzer.SymbolIsBannedRule, "Banned", "")
                }
        ...
        [Fact]
        public async Task ExcludeGeneratedCode_WhenDisabled_AnalyzesGeneratedFilesAsync()
        {
            var source = """
                // <auto-generated/>
                namespace N
                ...
                TestState =
                {
                    ...
                    AnalyzerConfigFiles =
                    {
                        ("/.editorconfig", """
                            ...
                            [*]
                            banned_api_exclude_generated_code = false
                            """)
                    },
                },
                ExpectedDiagnostics =
        ...
        [Fact]
        public async Task ExcludeGeneratedCode_DefaultBehavior_AnalyzesGeneratedFilesAsync()
        {
            var source = """
                // <auto-generated/>
                namespace N
            ...
            // By default, generated code should be analyzed
            await test.RunAsync();
        }
