...
namespace Microsoft.CodeAnalysis.BannedApiAnalyzers.UnitTests
{
    ...
    public class SymbolIsBannedAnalyzerTests
    {
        ...
        [Fact]
        public async Task ExcludeGeneratedCode_WhenEnabled_SkipsGeneratedFilesAsync()
        {
            var source = """
                // <auto-generated/>
                class C
            ...
            var bannedApiText = "T:System.Console";
                ...
                TestState =
                {
                    ...
                    AnalyzerConfigFiles =
                    {
                        ("/.editorconfig", """
                            ...
                            [*]
                            dotnet_diagnostic.exclude_generated_code = true
                            """)
                    },
                },
            };

            // No diagnostics expected since the file is generated and the option is enabled
            await test.RunAsync();
        }
                ...
                TestState =
                {
                    ...
                    AnalyzerConfigFiles =
                    {
                        ("/.editorconfig", """
                            ...
                            [*]
                            dotnet_diagnostic.exclude_generated_code = false
                            """)
                    },
                },
                ExpectedDiagnostics =
                {
                    GetCSharpResultAt(0, SymbolIsBannedAnalyzer.SymbolIsBannedRule, "System.Console", "")
                }
            };
