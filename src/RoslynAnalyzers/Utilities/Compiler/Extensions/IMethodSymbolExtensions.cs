...
namespace Analyzer.Utilities.Extensions
{
    internal static class IMethodSymbolExtensions
    {
        extension(IMethodSymbol method)
        {
            ...
            /// </summary>
            public bool IsObjectEqualsOverride()
            {
                return method != null &&
                    method.IsOverride &&
            ...
            /// </summary>
            public bool IsStaticObjectEqualsOrReferenceEquals()
            {
                return method != null &&
                    method.IsStatic &&
                    method.ContainingType.SpecialType == SpecialType.System_Object &&
            ...
            /// </summary>
            public bool IsImplementationOfInterfaceMethod(ITypeSymbol? typeArgument, [NotNullWhen(returnValue: true)] INamedTypeSymbol? interfaceType, string interfaceMethodName)
            {
            ...
            /// </summary>
            public bool IsDisposeImplementation(Compilation compilation)
            {
            ...
            /// </summary>
            public bool IsAsyncDisposeImplementation(Compilation compilation)
            {
            ...
            /// </summary>
            private bool HasDisposeMethodSignature()
            {
            ...
            /// </summary>
            public bool HasDisposeSignatureByConvention()
            {
            ...
            /// </summary>
            public bool HasDisposeBoolMethodSignature()
            {
            ...
            /// </summary>
            private bool HasDisposeCloseMethodSignature()
            {
            ...
            /// </summary>
            private bool HasDisposeCloseAsyncMethodSignature(INamedTypeSymbol? taskType)
            ...
            /// </summary>
            private bool HasDisposeAsyncMethodSignature(INamedTypeSymbol? task,
            ...
            /// </summary>
            private bool HasOverriddenDisposeCoreAsyncMethodSignature([NotNullWhen(returnValue: true)] INamedTypeSymbol? task)
            {
            ...
            /// </summary>
            private bool HasVirtualOrOverrideDisposeCoreAsyncMethodSignature([NotNullWhen(returnValue: true)] INamedTypeSymbol? valueTask)
            {
                return (method.Name == "DisposeAsyncCore" || method.Name == "DisposeCoreAsync") &&
                    method.MethodKind == MethodKind.Ordinary &&
            ...
            /// </summary>
            public DisposeMethodKind GetDisposeMethodKind(Compilation compilation)
            {
                INamedTypeSymbol? iDisposable = compilation.GetOrCreateTypeByMetadataName(WellKnownTypeNames.SystemIDisposable);
                INamedTypeSymbol? iAsyncDisposable = compilation.GetOrCreateTypeByMetadataName(WellKnownTypeNames.SystemIAsyncDisposable);
            ...
            /// Gets the <see cref="DisposeMethodKind"/> for the given method.
            /// </summary>
            public DisposeMethodKind GetDisposeMethodKind(
            ...
            /// </remarks>
            public bool IsCollectionAddMethod(ImmutableHashSet<INamedTypeSymbol> iCollectionTypes)
            {
            ...
            public bool IsTaskFromResultMethod([NotNullWhen(returnValue: true)] INamedTypeSymbol? taskType)
            ...
            public bool IsTaskConfigureAwaitMethod([NotNullWhen(returnValue: true)] INamedTypeSymbol? genericTaskType)
            ...
            public bool IsAsyncDisposableConfigureAwaitMethod([NotNullWhen(returnValue: true)] INamedTypeSymbol? asyncDisposableType, [NotNullWhen(returnValue: true)] INamedTypeSymbol? taskAsyncEnumerableExtensions)
            ...
            /// </summary>
            public IBlockOperation? GetTopmostOperationBlock(Compilation compilation, CancellationToken cancellationToken = default)
            {
            ...
            public bool IsLambdaOrLocalFunctionOrDelegate()
            {
            ...
            public bool IsLockMethod([NotNullWhen(returnValue: true)] INamedTypeSymbol? systemThreadingMonitor)
            {
            ...
            public bool IsInterlockedExchangeMethod(INamedTypeSymbol? systemThreadingInterlocked)
            {
            ...
            public bool IsInterlockedCompareExchangeMethod(INamedTypeSymbol? systemThreadingInterlocked)
            {
                Debug.Assert(SymbolEqualityComparer.Default.Equals(method.ContainingType.OriginalDefinition, systemThreadingInterlocked));
            ...
            /// </summary>
            public bool IsArgumentNullCheckMethod()
            {
            ...
            public bool IsBenchmarkOrXUnitTestMethod(ConcurrentDictionary<INamedTypeSymbol, bool> knownTestAttributes, INamedTypeSymbol? benchmarkAttribute, INamedTypeSymbol? xunitFactAttribute)
            {
        ...
        extension([NotNullWhen(true)] IMethodSymbol? method)
        {
            /// <summary>
            ...
            /// </summary>
            public bool IsDisposeImplementation([NotNullWhen(returnValue: true)] INamedTypeSymbol? iDisposable)
            {
                if (method == null)
                {
                    return false;
            ...
            /// </summary>
            public bool IsAsyncDisposeImplementation([NotNullWhen(returnValue: true)] INamedTypeSymbol? iAsyncDisposable, [NotNullWhen(returnValue: true)] INamedTypeSymbol? valueTaskType)
            {
                if (method == null)
                {
                    return false;
            ...
            public bool IsSerializationConstructor(INamedTypeSymbol? serializationInfoType, INamedTypeSymbol? streamingContextType)
            ...
            public bool IsGetObjectData(INamedTypeSymbol? serializationInfoType, INamedTypeSymbol? streamingContextType)
        ...
        extension(IMethodSymbol methodSymbol)
        {
            ...
            public bool HasParameterWithDelegateType()
                => methodSymbol.Parameters.Any(p => p.Type.TypeKind == TypeKind.Delegate);

            public ImmutableArray<IMethodSymbol> GetOriginalDefinitions()
            {
        ...
        extension(IMethodSymbol? method)
        {
            public IEnumerable<IMethodSymbol> GetOverloads()
            {
