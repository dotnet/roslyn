...
namespace System.Collections.Immutable
{
    ...
    {
        extension<T>(ImmutableHashSet<T> set1)
        {
            public ImmutableHashSet<T> AddRange(ImmutableHashSet<T> set2)
            {
            ...
            public ImmutableHashSet<T> IntersectSet(ImmutableHashSet<T> set2)
            {
            ...
            public bool IsSubsetOfSet(ImmutableHashSet<T> set2)
            {
