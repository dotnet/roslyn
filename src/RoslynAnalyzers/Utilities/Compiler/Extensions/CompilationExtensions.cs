...
namespace Analyzer.Utilities.Extensions
{
    ...
    internal static class CompilationExtensions
    {
        ...
        extension(Compilation compilation)
        {
            ...
            internal INamedTypeSymbol? GetOrCreateTypeByMetadataName(string fullTypeName) =>
            ...
            /// <param name="fullTypeName">Namespace + type name, e.g. "System.Exception".</param>
            /// <returns>The <see cref="INamedTypeSymbol"/> if found, null otherwise.</returns>
            internal bool TryGetOrCreateTypeByMetadataName(string fullTypeName, [NotNullWhen(returnValue: true)] out INamedTypeSymbol? namedTypeSymbol) =>
