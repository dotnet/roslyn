...
namespace Analyzer.Utilities.Extensions
{
    internal static class INamedTypeSymbolExtensions
    {
        ...
        {
            public bool IsFileLocal() => symbol.IsFileLocal;
        ...
        extension(INamedTypeSymbol type)
        {
            ...
            /// </para>
            /// </example>
            public bool DerivesFromOrImplementsAnyConstructionOf(INamedTypeSymbol parentType)
            {
        ...
        extension(INamedTypeSymbol attributeClass)
        {
            public bool IsBenchmarkOrXUnitTestAttribute(ConcurrentDictionary<INamedTypeSymbol, bool> knownTestAttributes, INamedTypeSymbol? benchmarkAttribute, INamedTypeSymbol? xunitFactAttribute)
            {
