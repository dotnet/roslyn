...
namespace System.Collections.Immutable
{
    internal static class ImmutableArrayExtensions
    {
        extension<TSource>(ImmutableArray<TSource> source)
        {
            ...
            public bool HasExactly(int count) => source.Length == count;
            ...
            public bool HasMoreThan(int count) => source.Length > count;
            ...
            public bool HasFewerThan(int count) => source.Length < count;
        }
    }
}
