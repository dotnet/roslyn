...
namespace Analyzer.Utilities
{
...
#endif
    {
        ...
        {
            public SymbolVisibilityGroup GetSymbolVisibilityGroupOption(
        ...
        => TryGetSyntaxTreeForOption(symbol, out var tree)
            ...
            private SymbolVisibilityGroup GetSymbolVisibilityGroupOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
                SymbolVisibilityGroup defaultValue)
            ...
            private SymbolModifiers GetRequiredModifiersOption(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            public EnumValuesPrefixTrigger GetEnumValuesPrefixTriggerOption(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            private EnumValuesPrefixTrigger GetEnumValuesPrefixTriggerOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
                EnumValuesPrefixTrigger defaultValue)
            ...
            public ImmutableHashSet<OutputKind> GetOutputKindsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            public ImmutableHashSet<SymbolKind> GetAnalyzedSymbolKindsOption(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            private ImmutableHashSet<SymbolKind> GetAnalyzedSymbolKindsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
                ImmutableHashSet<SymbolKind> defaultSymbolKinds)
            ...
            private TEnum GetFlagsEnumOptionValue<TEnum>(
                string optionName,
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
            ...
            private ImmutableHashSet<TEnum> GetNonFlagsEnumOptionValue<TEnum>(
                string optionName,
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
            ...
            private TEnum GetNonFlagsEnumOptionValue<TEnum>(
                string optionName,
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
            ...
            public bool GetBoolOptionValue(
                string optionName,
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            public uint GetUnsignedIntegralOptionValue(
                string optionName,
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
            ...
            public SymbolNamesWithValueOption<Unit> GetNullCheckValidationMethodsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            public SymbolNamesWithValueOption<Unit> GetAdditionalStringFormattingMethodsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            public bool IsConfiguredToSkipAnalysis(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation)
            ...
            public SymbolNamesWithValueOption<Unit> GetDisallowedSymbolNamesWithValueOption(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation)
            => options.GetDisallowedSymbolNamesWithValueOption(rule, symbol.Locations[0].SourceTree, compilation);

            private SymbolNamesWithValueOption<Unit> GetDisallowedSymbolNamesWithValueOption(
                DiagnosticDescriptor rule,
                SyntaxTree? tree,
                Compilation compilation)
            ...
            public SymbolNamesWithValueOption<string?> GetAdditionalRequiredSuffixesOption(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation)
            => options.GetAdditionalRequiredSuffixesOption(rule, symbol.Locations[0].SourceTree, compilation);

            private SymbolNamesWithValueOption<string?> GetAdditionalRequiredSuffixesOption(
                DiagnosticDescriptor rule,
                SyntaxTree? tree,
                Compilation compilation)
            {
            ...
            public SymbolNamesWithValueOption<INamedTypeSymbol?> GetAdditionalRequiredGenericInterfaces(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation)
            => options.GetAdditionalRequiredGenericInterfaces(rule, symbol.Locations[0].SourceTree, compilation);

            private SymbolNamesWithValueOption<INamedTypeSymbol?> GetAdditionalRequiredGenericInterfaces(
                DiagnosticDescriptor rule,
                SyntaxTree? tree,
                Compilation compilation)
            {
            ...
            public SymbolNamesWithValueOption<Unit> GetInheritanceExcludedSymbolNamesOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation,
            ...
            public SymbolNamesWithValueOption<Unit> GetAdditionalUseResultsMethodsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            public SymbolNamesWithValueOption<Unit> GetEnumerationMethodsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            public SymbolNamesWithValueOption<Unit> GetLinqChainMethodsOption(
                DiagnosticDescriptor rule,
                SyntaxTree tree,
                Compilation compilation)
            ...
            private SymbolNamesWithValueOption<TValue> GetSymbolNamesWithValueOption<TValue>(
                string optionName,
                DiagnosticDescriptor rule,
                SyntaxTree? tree,
                Compilation compilation,
            ...
            public ImmutableArray<string> GetMSBuildItemMetadataValues(
            ...
            /// </summary>
            public bool MatchesConfiguredVisibility(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            /// </summary>
            public bool MatchesConfiguredModifiers(
                DiagnosticDescriptor rule,
                ISymbol symbol,
                Compilation compilation,
            ...
            private ICategorizedAnalyzerConfigOptions GetOrComputeCategorizedAnalyzerConfigOptions(
    Compilation compilation)
            {
