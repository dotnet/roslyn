...
namespace Analyzer.Utilities
{
    internal static class SyntaxGeneratorExtensions
    {
        ...
        extension(SyntaxGenerator generator)
        {
            ...
            /// </returns>
            public SyntaxNode DefaultOperatorEqualityDeclaration(INamedTypeSymbol containingType)
            {
            ...
            public SyntaxNode TypeExpressionForStaticMemberAccess(INamedTypeSymbol typeSymbol)
            {
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultOperatorInequalityDeclaration(INamedTypeSymbol containingType)
            {
                var leftArgument = generator.IdentifierName(LeftIdentifierName);
                var rightArgument = generator.IdentifierName(RightIdentifierName);
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultOperatorLessThanDeclaration(INamedTypeSymbol containingType)
            {
                var leftArgument = generator.IdentifierName(LeftIdentifierName);
                var rightArgument = generator.IdentifierName(RightIdentifierName);
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultOperatorLessThanOrEqualDeclaration(INamedTypeSymbol containingType)
            {
                var leftArgument = generator.IdentifierName(LeftIdentifierName);
                var rightArgument = generator.IdentifierName(RightIdentifierName);
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultOperatorGreaterThanDeclaration(INamedTypeSymbol containingType)
            {
                var leftArgument = generator.IdentifierName(LeftIdentifierName);
                var rightArgument = generator.IdentifierName(RightIdentifierName);
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultOperatorGreaterThanOrEqualDeclaration(INamedTypeSymbol containingType)
            {
                var leftArgument = generator.IdentifierName(LeftIdentifierName);
                var rightArgument = generator.IdentifierName(RightIdentifierName);
            ...
            private SyntaxNode ComparisonOperatorDeclaration(OperatorKind operatorKind, INamedTypeSymbol containingType, params SyntaxNode[] statements)
            {
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultEqualsOverrideDeclaration(Compilation compilation, INamedTypeSymbol containingType)
            {
            ...
            /// A <see cref="SyntaxNode"/> representing the declaration.
            /// </returns>
            public SyntaxNode DefaultGetHashCodeOverrideDeclaration(
    Compilation compilation)
            ...
            /// </returns>
            public IEnumerable<SyntaxNode> DefaultMethodBody(
    Compilation compilation)
            {
                yield return DefaultMethodStatement(generator, compilation);
            }

            public SyntaxNode DefaultMethodStatement(Compilation compilation)
            {
            ...
            public SyntaxNode? TryGetContainingDeclaration(SyntaxNode? node, DeclarationKind kind)
            {
                if (node is null)
                {
                    return null;
            ...
            /// </returns>
            public SyntaxNode FirstUnusedIdentifierName(SemanticModel semanticModel, int position, string baseName, int maxTries = int.MaxValue)
            {
