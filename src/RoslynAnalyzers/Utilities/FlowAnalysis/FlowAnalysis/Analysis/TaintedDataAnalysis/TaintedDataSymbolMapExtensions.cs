...
namespace Analyzer.Utilities.FlowAnalysis.Analysis.TaintedDataAnalysis
{
    ...
    {
        extension(TaintedDataSymbolMap<SourceInfo> sourceSymbolMap)
        {
            /// <summary>
            ...
            /// <returns></returns>
            public bool IsSourceProperty(IPropertySymbol propertySymbol)
            {
            ...
            /// <returns></returns>
            public bool IsSourceParameter(IParameterSymbol parameterSymbol, WellKnownTypeProvider wellKnownTypeProvider)
            {
            ...
            /// <returns></returns>
            public bool IsSourceConstantArrayOfType(
            ...
            /// <returns></returns>
            public bool IsSourceTransferMethod(
                IMethodSymbol method,
                ImmutableArray<IArgumentOperation> arguments,
            ...
            /// </summary>
            public bool IsSourceTransferProperty(
