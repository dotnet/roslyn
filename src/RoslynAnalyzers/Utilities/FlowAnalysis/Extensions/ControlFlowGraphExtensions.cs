...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    internal static partial class ControlFlowGraphExtensions
    {
        ...
        {
            public BasicBlock GetEntry() => cfg.Blocks.Single(b => b.Kind == BasicBlockKind.Entry);
            public BasicBlock GetExit() => cfg.Blocks.Single(b => b.Kind == BasicBlockKind.Exit);

            internal bool SupportsFlowAnalysis()
            {
