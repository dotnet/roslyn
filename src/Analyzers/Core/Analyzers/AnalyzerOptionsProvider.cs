...
internal readonly struct AnalyzerOptionsProvider(IOptionsReader options, string language, IdeAnalyzerOptions fallbackOptions)
{
    ...
    public CodeStyleOption2<bool> PreferCollectionExpressionForInterfaces => GetOption(CodeStyleOptions2.PreferCollectionExpressionForInterfaces, FallbackCodeStyleOptions.PreferCollectionExpressionForInterfaces);
