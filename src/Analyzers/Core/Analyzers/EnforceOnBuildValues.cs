...
internal static class EnforceOnBuildValues
{
    ...
    public const EnforceOnBuild UseLabeledJumpStatement = /*IDE0410*/ EnforceOnBuild.Recommended;
    ...
    public const EnforceOnBuild UseNullConditionalAwait = /*IDE0420*/ EnforceOnBuild.WhenExplicitlyEnabled;
