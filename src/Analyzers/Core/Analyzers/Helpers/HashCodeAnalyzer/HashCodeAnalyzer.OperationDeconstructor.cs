            ...
            public bool TryAddHashedSymbol(IOperation value, bool seenHash)
            {
                ...
                switch (value)
                {
                    ...
                    case IInvocationOperation invocation:
                        ...
                        if (analyzer.OverridesSystemObject(targetMethod))
                        {
                            // Either:
                            //
                            //      a.GetHashCode()
                        ...
                        if (targetMethod.Name == nameof(GetHashCode) &&
                            Equals(analyzer._equalityComparerType, targetMethod.ContainingType.OriginalDefinition) &&
