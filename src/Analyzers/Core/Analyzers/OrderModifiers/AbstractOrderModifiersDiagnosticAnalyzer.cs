            ...
            SyntaxNode memberDeclaration)
        {
            ...
            if (!AbstractOrderModifiersHelpers.IsOrdered(preferredOrder, modifiers))
            {
                ...
                else
                {
                    ...
                    DiagnosticHelper.CreateAndReportDiagnostic(context.ReportDiagnostic, Descriptor, modifiers.First().GetLocation(), severity, additionalLocations: null, properties: null);
                }
            }
        }
    }
