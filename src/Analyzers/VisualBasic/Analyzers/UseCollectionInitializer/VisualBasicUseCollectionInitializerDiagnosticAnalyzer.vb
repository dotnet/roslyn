...
Namespace Microsoft.CodeAnalysis.VisualBasic.UseCollectionInitializer
    ...
    Friend NotInheritable Class VisualBasicUseCollectionInitializerDiagnosticAnalyzer
        ...
        Protected Overrides Function CanUseCollectionExpression(semanticModel As SemanticModel, objectCreationExpression As ObjectCreationExpressionSyntax, expressionType As INamedTypeSymbol, allowInterfaceConversion As Boolean, cancellationToken As CancellationToken) As Boolean
