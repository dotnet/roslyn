...
Namespace Microsoft.CodeAnalysis.VisualBasic.SimplifyObjectCreation
    ...
    Friend Class VisualBasicSimplifyObjectCreationCodeFixProvider
        ...
        Protected Overrides Async Function FixAllAsync(document As Document, diagnostics As ImmutableArray(Of Diagnostic), editor As SyntaxEditor, fallbackOptions As ICodeActionOptionsProvider, cancellationToken As CancellationToken) As Task
