...
internal sealed class CSharpDeclareAsNullableCodeFixProvider() : SyntaxEditorBasedCodeFixProvider
{
    ...
    // warning CS9400: Non-nullable event is uninitialized
    public sealed override ImmutableArray<string> FixableDiagnosticIds => ["CS8603", "CS8600", "CS8625", "CS8618", "CS9400"];
        ...
        Document document, SemanticModel? model, SyntaxNode node, CancellationToken cancellationToken)
    {
        ...
        // string x;
        // Unassigned value that's not marked as null
        if (node is VariableDeclaratorSyntax { Parent: VariableDeclarationSyntax { Parent: BaseFieldDeclarationSyntax, Variables.Count: 1 } declarationSyntax })
