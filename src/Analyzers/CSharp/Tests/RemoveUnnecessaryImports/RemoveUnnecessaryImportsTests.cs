...
public sealed class RemoveUnnecessaryImportsTests
{
    ...
    {
        var generatedFilePath = Path.Combine("Microsoft.CodeAnalysis.Test.Utilities", "Microsoft.NET.Sdk.Razor.SourceGenerators.RazorSourceGenerator", "Component.razor.g.cs");
        return new VerifyCS.Test
        {
            ...
            ExpectedDiagnostics = {
                VerifyCS.Diagnostic(RemoveUnnecessaryImportsConstants.IDE0005_gen).WithSpan(generatedFilePath, 1, 1, 1, 14),
                VerifyCS.Diagnostic(RemoveUnnecessaryImportsConstants.DiagnosticFixableId).WithSpan(generatedFilePath, 1, 1, 2, 34),
            }
        }.RunAsync();
    }
