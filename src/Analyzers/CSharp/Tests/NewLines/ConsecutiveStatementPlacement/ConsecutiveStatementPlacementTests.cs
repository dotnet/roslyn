...
class C
{
    ...
    int Y { get; }
            ...
            await new Verify.Test()
            {
                TestCode = code,
                FixedCode = code,
                Options = { { CodeStyleOptions2.DisallowStatementImmediatelyAfterBlock, CodeStyleOptions2.TrueWithSuggestionEnforcement } }
            }.RunAsync();
        }
    ...
    void M()
    {
        ...
        return;
            ...
            await new Verify.Test()
            {
                TestCode = code,
                FixedCode = code,
                Options = { { CodeStyleOptions2.DisallowStatementImmediatelyAfterBlock, CodeStyleOptions2.FalseWithSilentEnforcement } }
            }.RunAsync();
        }
