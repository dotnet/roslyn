...
// comment";
            ...
            await new Verify.Test()
            {
                TestCode = code,
                FixedCode = code,
                Options = { { CodeStyleOptions2.DisallowMultipleBlankLines, CodeStyleOptions2.TrueWithSuggestionEnforcement } }
            }.RunAsync();
        }
...
// comment";
            ...
            await new Verify.Test()
            {
                TestCode = code,
                FixedCode = code,
                Options = { { CodeStyleOptions2.DisallowMultipleBlankLines, CodeStyleOptions2.FalseWithSuggestionEnforcement } }
            }.RunAsync();
        }
