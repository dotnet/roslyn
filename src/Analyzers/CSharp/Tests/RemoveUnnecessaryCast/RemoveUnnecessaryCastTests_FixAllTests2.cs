...
{
    public class RemoveUnnecessaryCastTests2_FixAllTests : AbstractCSharpDiagnosticProviderBasedUserDiagnosticTest
    {
        public RemoveUnnecessaryCastTests2_FixAllTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
