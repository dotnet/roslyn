...
namespace Microsoft.CodeAnalysis.CSharp.Analyzers.MakeAnonymousFunctionStatic
{
    internal static class MakeAnonymousFunctionStaticHelper
    {
        ...
        public static bool TryGetCaputuredSymbolsAndCheckApplicability(AnonymousFunctionExpressionSyntax anonymousFunction, SemanticModel semanticModel, out ImmutableArray<ISymbol> captures)
            => TryGetCaputuredSymbols(anonymousFunction, semanticModel, out captures) && CanMakeAnonymousFunctionStatic(captures);

        private static bool CanMakeAnonymousFunctionStatic(ImmutableArray<ISymbol> captures)
