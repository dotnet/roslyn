...
namespace Microsoft.CodeAnalysis.ExpressionEvaluator.UnitTests
{
    ...
    internal static class ExpressionCompilerTestHelpers
    {
            ...
            where TMethodSymbol : IMethodSymbolInternal
        {
            ...
            Assert.Equal(((Cci.IMethodDefinition)methodData.Method.GetAdapter()).CallingConvention, expectedGeneric ? Cci.CallingConvention.Generic : Cci.CallingConvention.Default);
        }
