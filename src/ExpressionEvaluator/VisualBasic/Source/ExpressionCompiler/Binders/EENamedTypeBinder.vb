            ...
            If substitutedSourceType.Arity > 0 Then
                ...
                For i As Integer = 0 To symbols.Count - 1
                    ...
                    If symbol.Kind = SymbolKind.TypeParameter Then
                        Debug.Assert(TypeSymbol.Equals(DirectCast(symbol.OriginalDefinition.ContainingSymbol, TypeSymbol), substitutedSourceType.OriginalDefinition, TypeCompareKind.ConsiderEverything))
