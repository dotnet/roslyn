...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator
{
    internal static class CompilationExtensions
    {
            ...
            RefKind refKind)
        {
            ...
            var bytes = builder.Count > 0 && compilation.HasDynamicEmitAttributes(recordUsage: false) ?
            ...
            TypeSymbol type)
        {
            ...
            var names = CSharpCompilation.TupleNamesEncoder.TryGetNames(type, builder) && compilation.HasTupleNamesAttributes(recordUsage: false) ?
