...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator
{
    ...
    internal sealed class DisplayClassInstanceFromLocal : DisplayClassInstance
    {
        ...
        {
            get { return this.Local.TypeWithAnnotations.Type; }
        }
        ...
        {
            return new BoundLocal(syntax, this.Local, constantValueOpt: null, type: this.Local.TypeWithAnnotations.Type) { WasCompilerGenerated = true };
        }
    ...
    internal sealed class DisplayClassInstanceFromParameter : DisplayClassInstance
    {
        ...
        internal override TypeSymbol Type
        {
            get { return this.Parameter.TypeWithAnnotations.Type; }
        }
