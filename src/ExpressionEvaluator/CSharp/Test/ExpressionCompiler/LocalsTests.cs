    ...
    static void Main()
    {
        M(E.A);
            ...
            WithRuntimeInstance(compilation0, runtime =>
            {
                ...
                Assert.Equal(method.Parameters[0].TypeWithAnnotations.Type, method.ReturnTypeWithAnnotations.Type);
...
@"{
  ...
  IL_0001:  ret
                ...
                returnType = (NamedTypeSymbol)((ArrayTypeSymbol)method.ReturnTypeWithAnnotations.Type).ElementTypeWithAnnotations.Type;
...
@"{
  ...
  IL_0001:  ret
                ...
                Assert.Equal(containingType.TypeParameters[0], method.ReturnTypeWithAnnotations.Type);
  ...
  IL_0001:  ret
                ...
                containingType = method.ContainingType;
                Assert.Equal(containingType.TypeParameters[1], method.ReturnTypeWithAnnotations.Type);
  ...
  IL_0001:  ret
                ...
                Assert.Equal(method.TypeParameters[0], method.ReturnTypeWithAnnotations.Type);
  ...
  IL_0005:  ret
                ...
                returnType = (NamedTypeSymbol)method.ReturnTypeWithAnnotations.Type;
                Assert.Equal(containingType.TypeParameters[0], returnType.TypeArguments()[0]);
