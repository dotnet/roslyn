...
";
            ...
            WithRuntimeInstance(comp, runtime =>
            {
                ...
                var testData2 = new CompilationTestData();
                context.CompileExpression("a = default;", DkmEvaluationFlags.None, ImmutableArray<Alias>.Empty, out error, testData2);
                Assert.Null(error);
                testData2.GetMethodData("<>x.<>m0").VerifyIL(@"
{
  // Code size        4 (0x4)
  .maxstack  2
  ...
  IL_0003:  ret
                ...
                Assert.Null(error);
                testData3.GetMethodData("<>x.<>m0").VerifyIL(@"
{
  // Code size        2 (0x2)
  .maxstack  1
  .locals init (int V_0) //a
