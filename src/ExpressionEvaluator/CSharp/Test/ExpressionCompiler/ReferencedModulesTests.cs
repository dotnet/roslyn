...
#pragma warning restore 0436
            ...
            var compCorLib = CreateCompilationRaw(sourceCorLib, assemblyName: CorLibAssemblyName, references: new[] { MscorlibRef, refLib });
...
@"class C
{
    static void M()
    {
                ...
                var comp = CreateCompilationRaw(source, options: TestOptions.DebugDll, references: new[] { refLib, AssemblyMetadata.Create(module).GetReference() });
