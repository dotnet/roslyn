...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.Diagnostics
    ...
    Partial Public MustInherit Class AbstractVisualBasicDiagnosticProviderBasedUserDiagnosticTest
        Friend Shared Function SingleOption(Of T)(optionParam As SingleValuedOption2(Of T), enabled As T) As (OptionKey2, Object)
        ...
        Friend Shared Function SingleOption(Of T)(optionParam As SingleValuedOption2(Of CodeStyleOption2(Of T)), enabled As T, notification As NotificationOption2) As (OptionKey2, Object)
            Return SingleOption(optionParam, New CodeStyleOption2(Of T)(enabled, notification))
        End Function

        Friend Shared Function SingleOption(Of T)(optionParam As SingleValuedOption2(Of CodeStyleOption2(Of T)), codeStyle As CodeStyleOption2(Of T)) As (OptionKey2, Object)
        ...
        Friend Function [Option](Of T)(optionParam As SingleValuedOption2(Of CodeStyleOption2(Of T)), enabled As T, notification As NotificationOption2) As OptionsCollection
            Return New OptionsCollection(GetLanguage()) From {{optionParam, enabled, notification}}
        End Function

        Friend Function [Option](Of T)(optionParam As SingleValuedOption2(Of CodeStyleOption2(Of T)), codeStyle As CodeStyleOption2(Of T)) As OptionsCollection
        ...
        Friend Function [Option](Of T)(optionParam As SingleValuedOption2(Of T), value As T) As OptionsCollection
