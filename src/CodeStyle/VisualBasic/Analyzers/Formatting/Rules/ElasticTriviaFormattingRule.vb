...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    Friend Class ElasticTriviaFormattingRule
        ...
        Public Overrides Sub AddSuppressOperations(list As List(Of SuppressOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextOperation As NextAction(Of SuppressOperation))
            nextOperation.Invoke(list)
        End Sub

        Public Overrides Sub AddIndentBlockOperations(list As List(Of IndentBlockOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextOperation As NextAction(Of IndentBlockOperation))
            nextOperation.Invoke(list)
        ...
        Public Overrides Function GetAdjustSpacesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextOperation As Rules.NextOperation(Of AdjustSpacesOperation)) As AdjustSpacesOperation
