...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    Friend Class StructuredTriviaFormattingRule
        ...
        Public Overrides Function GetAdjustNewLinesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextOperation As NextOperation(Of AdjustNewLinesOperation)) As AdjustNewLinesOperation
        ...
        Public Overrides Function GetAdjustSpacesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextOperation As NextOperation(Of AdjustSpacesOperation)) As AdjustSpacesOperation
            If UnderStructuredTrivia(previousToken, currentToken) Then
