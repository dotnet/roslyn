...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    Friend Class AdjustSpaceFormattingRule
        ...
        Public Overrides Function GetAdjustSpacesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextFunc As NextOperation(Of AdjustSpacesOperation)) As AdjustSpacesOperation
            ' * <end of file token>
