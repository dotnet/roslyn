...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    ...
    Friend Class DefaultOperationProvider
        ...
        Public Sub AddSuppressOperations(operations As List(Of SuppressOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextAction As NextAction(Of SuppressOperation)) Implements IFormattingRule.AddSuppressOperations
        End Sub

        Public Sub AddAnchorIndentationOperations(operations As List(Of AnchorIndentationOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextAction As NextAction(Of AnchorIndentationOperation)) Implements IFormattingRule.AddAnchorIndentationOperations
        End Sub

        Public Sub AddIndentBlockOperations(operations As List(Of IndentBlockOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextAction As NextAction(Of IndentBlockOperation)) Implements IFormattingRule.AddIndentBlockOperations
        End Sub

        Public Sub AddAlignTokensOperations(operations As List(Of AlignTokensOperation), node As SyntaxNode, optionSet As AnalyzerConfigOptions, nextAction As NextAction(Of AlignTokensOperation)) Implements IFormattingRule.AddAlignTokensOperations
        End Sub

        Public Function GetAdjustNewLinesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextOperation As NextOperation(Of AdjustNewLinesOperation)) As AdjustNewLinesOperation Implements IFormattingRule.GetAdjustNewLinesOperation
        ...
        Public Function GetAdjustSpacesOperation(previousToken As SyntaxToken, currentToken As SyntaxToken, optionSet As AnalyzerConfigOptions, nextOperation As NextOperation(Of AdjustSpacesOperation)) As AdjustSpacesOperation Implements IFormattingRule.GetAdjustSpacesOperation
