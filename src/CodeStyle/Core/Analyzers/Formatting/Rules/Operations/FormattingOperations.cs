...
namespace Microsoft.CodeAnalysis.Formatting.Rules
{
    ...
    internal static class FormattingOperations
    {
        ...
        /// </summary>
        internal static IEnumerable<SuppressOperation> GetSuppressOperations(IEnumerable<IFormattingRule> formattingRules, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
        ...
        /// </summary>
        internal static IEnumerable<AnchorIndentationOperation> GetAnchorIndentationOperations(IEnumerable<IFormattingRule> formattingRules, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, optionSet);
        ...
        /// </summary>
        internal static IEnumerable<IndentBlockOperation> GetIndentBlockOperations(IEnumerable<IFormattingRule> formattingRules, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, optionSet);
        ...
        /// </summary>
        internal static IEnumerable<AlignTokensOperation> GetAlignTokensOperations(IEnumerable<IFormattingRule> formattingRules, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, optionSet);
        ...
        /// </summary>
        internal static AdjustNewLinesOperation GetAdjustNewLinesOperation(IEnumerable<IFormattingRule> formattingRules, SyntaxToken previousToken, SyntaxToken currentToken, AnalyzerConfigOptions optionSet)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, optionSet);
        ...
        /// </summary>
        internal static AdjustSpacesOperation GetAdjustSpacesOperation(IEnumerable<IFormattingRule> formattingRules, SyntaxToken previousToken, SyntaxToken currentToken, AnalyzerConfigOptions optionSet)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, optionSet);
