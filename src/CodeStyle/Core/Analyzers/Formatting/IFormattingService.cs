...
namespace Microsoft.CodeAnalysis.Formatting
{
    internal interface IFormattingService
    {
        ...
        Task<SyntaxTree> FormatAsync(SyntaxTree document, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, CancellationToken cancellationToken);
    }
}
