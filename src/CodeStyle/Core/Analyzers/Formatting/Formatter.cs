...
namespace Microsoft.CodeAnalysis.Formatting
{
    ...
    internal static class Formatter
    {
        ...
        internal static SyntaxNode Format(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<IFormattingRule> rules, CancellationToken cancellationToken)
        {
        ...
        internal static IList<TextChange> GetFormattedTextChanges(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<IFormattingRule> rules, CancellationToken cancellationToken)
        {
            var formattingResult = GetFormattingResult(node, syntaxFormattingService, spans, options, rules, cancellationToken);
        ...
        internal static IFormattingResult GetFormattingResult(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<IFormattingRule> rules, CancellationToken cancellationToken)
        {
            if (node == null)
            {
