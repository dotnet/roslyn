...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    internal class IndentBlockFormattingRule : BaseFormattingRule
    {
        ...
        private void AddSwitchIndentationOperation(List<IndentBlockOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
        ...
        private void AddLabelIndentationOperation(List<IndentBlockOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
            // label statement
        ...
        private void AddAlignmentBlockOperation(List<IndentBlockOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
            switch (node)
            {
        ...
        private void AddBlockIndentationOperation(List<IndentBlockOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
