...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    ...
    {
        public override AdjustSpacesOperation GetAdjustSpacesOperation(SyntaxToken previousToken, SyntaxToken currentToken, AnalyzerConfigOptions optionSet, NextOperation<AdjustSpacesOperation> nextOperation)
        {
            if (optionSet == null)
            {
        ...
        public override void AddSuppressOperations(List<SuppressOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet, NextAction<SuppressOperation> nextOperation)
        {
        ...
        private void SuppressVariableDeclaration(List<SuppressOperation> list, SyntaxNode node, AnalyzerConfigOptions optionSet)
        {
        ...
        private AdjustSpacesOperation AdjustSpacesOperationZeroOrOne(AnalyzerConfigOptions optionSet, Option<bool> option, AdjustSpacesOption explicitOption = AdjustSpacesOption.ForceSpacesIfOnSingleLine)
        {
