...
Namespace Microsoft.CodeAnalysis.VisualBasic.QuickInfo
    ...
    Friend Class VisualBasicSemanticQuickInfoProvider
        ...
        Protected Overrides Async Function BuildQuickInfoAsync(context As QuickInfoContext) As Task(Of QuickInfoItem)
            ...
            Dim workspace = context.Workspace
            ...
            Select Case token.Kind
                ...
                Case SyntaxKind.DimKeyword
                    If TypeOf parent Is FieldDeclarationSyntax Then
                        Return Await BuildContentAsync(semanticModel, token, DirectCast(parent, FieldDeclarationSyntax).Declarators, workspace, cancellationToken).ConfigureAwait(False)
                    ElseIf TypeOf parent Is LocalDeclarationStatementSyntax Then
                        Return Await BuildContentAsync(semanticModel, token, DirectCast(parent, LocalDeclarationStatementSyntax).Declarators, workspace, cancellationToken).ConfigureAwait(False)
                    End If
            ...
            Return Await MyBase.BuildQuickInfoAsync(context).ConfigureAwait(False)
        End Function
        ...
        Private Overloads Shared Async Function BuildContentAsync(
            ...
            Return Await CreateContentAsync(workspace, token, semanticModel, New TokenInformation(types), supportedPlatforms:=Nothing, cancellationToken:=cancellationToken).ConfigureAwait(False)
        End Function

        Private Shared Function BuildContentForIntrinsicOperator(semanticModel As SemanticModel,
                                                                 token As SyntaxToken,
