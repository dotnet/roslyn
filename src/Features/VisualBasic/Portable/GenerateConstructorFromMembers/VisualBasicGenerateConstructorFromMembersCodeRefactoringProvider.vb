...
Namespace Microsoft.CodeAnalysis.VisualBasic.GenerateConstructorFromMembers
    ...
    Friend NotInheritable Class VisualBasicGenerateConstructorFromMembersCodeRefactoringProvider
        ...
        Protected Overrides Function PrefersThrowExpressionAsync(document As Document, fallbackOptions As ISimplifierOptionsProvider, cancellationToken As CancellationToken) As ValueTask(Of Boolean)
