...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    ...
    Friend Class VisualBasicOrganizeUsingsNewDocumentFormattingProvider
        ...
        Public Function FormatNewDocumentAsync(document As Document, optionSet As DocumentOptionSet, hintDocument As Document, cancellationToken As CancellationToken) As Task(Of Document) Implements INewDocumentFormattingProvider.FormatNewDocumentAsync
