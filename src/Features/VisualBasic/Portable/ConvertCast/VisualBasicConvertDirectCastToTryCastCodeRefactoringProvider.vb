...
Namespace Microsoft.CodeAnalysis.VisualBasic.ConvertCast
    ...
    Friend Class VisualBasicConvertDirectCastToTryCastCodeRefactoringProvider
        ...
        Protected Overrides Function ConvertExpression(fromExpression As DirectCastExpressionSyntax, nullableContext As NullableContext) As TryCastExpressionSyntax
