...
Namespace Microsoft.CodeAnalysis.VisualBasic.ConvertConversionOperators
    ...
    Friend Class VisualBasicConvertTryCastToDirectCastCodeRefactoringProvider
        ...
        Protected Overrides Function ConvertExpression(fromExpression As TryCastExpressionSyntax, nullableContext As NullableContext) As DirectCastExpressionSyntax
