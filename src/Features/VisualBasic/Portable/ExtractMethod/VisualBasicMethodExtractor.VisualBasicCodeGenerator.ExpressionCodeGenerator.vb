    ...
    Partial Friend Class VisualBasicMethodExtractor
        Partial Private Class VisualBasicCodeGenerator
            Private Class ExpressionCodeGenerator
                ...
                Public Sub New(insertionPointNode As SyntaxNode, selectionResult As SelectionResult, analyzerResult As AnalyzerResult, options As VisualBasicCodeGenerationOptions)
                    MyBase.New(insertionPointNode, selectionResult, analyzerResult, options)
                End Sub
