...
Namespace Microsoft.CodeAnalysis.VisualBasic.RemoveSharedFromModuleMembers
    ...
    Friend NotInheritable Class VisualBasicRemoveSharedFromModuleMembersCodeFixProvider
        ...
        Protected Overrides Function FixAllAsync(document As Document, diagnostics As ImmutableArray(Of Diagnostic), editor As SyntaxEditor, fallbackOptions As ICodeActionOptionsProvider, cancellationToken As CancellationToken) As Task
