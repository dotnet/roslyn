...
Namespace Microsoft.CodeAnalysis.VisualBasic.IntroduceVariable
    ...
    Friend Class VisualBasicIntroduceLocalForExpressionCodeRefactoringProvider
        ...
        Protected Overrides Function CreateTupleDeconstructionAsync(document As Document, optionsProvider As ICodeActionOptionsProvider, tupleType As INamedTypeSymbol, expression As ExpressionSyntax, cancellationToken As CancellationToken) As Task(Of ExpressionStatementSyntax)
