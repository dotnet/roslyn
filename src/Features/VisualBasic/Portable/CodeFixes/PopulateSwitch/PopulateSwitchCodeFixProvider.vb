    ...
    Partial Friend Class PopulateSwitchCodeFixProvider
        ...
        Public NotOverridable Overrides Async Function RegisterCodeFixesAsync(context As CodeFixContext) As Task
            ...
            context.RegisterCodeFix(
                New MyCodeAction(
                    VBFeaturesResources.AddMissingLabels,
        ...
        Private Shared Async Function AddMissingSwitchLabelsAsync(model As SemanticModel, document As Document, root As SyntaxNode, selectBlock As SelectBlockSyntax) As Task(Of Document)
            ...
            ' This doesn't work in real life, possibly because of https://github.com/dotnet/roslyn/issues/473
            ' It does work in the tests, so I'm not sure what is up (or maybe the tests don't use a namespace
            ' In real life, it creates `Namespace.EnumName.Member`, rather than `EnumName.Member`
