...
Namespace Microsoft.CodeAnalysis.VisualBasic.CodeFixes.GenerateType
    ...
    Friend Class GenerateTypeCodeFixProvider
        ...
        Protected Overrides Function GetCodeActionsAsync(document As Document, node As SyntaxNode, fallbackOptions As ICleanCodeGenerationOptionsProvider, cancellationToken As CancellationToken) As Task(Of ImmutableArray(Of CodeAction))
