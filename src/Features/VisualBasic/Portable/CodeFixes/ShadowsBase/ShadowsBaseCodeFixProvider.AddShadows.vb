    ...
    Partial Friend Class ShadowsBaseCodeFixProvider
        Private Class AddShadowsKeywordAction
            ...
            Public Overrides ReadOnly Property Title As String
                Get
                    Return VBFeaturesResources.Add_Shadows
                End Get
            End Property
            ...
            Private Async Function GetNewNodeAsync(document As Document, node As SyntaxNode, cancellationToken As CancellationToken) As Task(Of SyntaxNode)
                ...
                If propertyStatement IsNot Nothing Then
                    newNode = propertyStatement.AddModifiers(SyntaxFactory.Token(SyntaxKind.ShadowsKeyword))
                End If

                Dim methodStatement = TryCast(node, MethodStatementSyntax)
                If methodStatement IsNot Nothing Then
                    newNode = methodStatement.AddModifiers(SyntaxFactory.Token(SyntaxKind.ShadowsKeyword))
                End If
