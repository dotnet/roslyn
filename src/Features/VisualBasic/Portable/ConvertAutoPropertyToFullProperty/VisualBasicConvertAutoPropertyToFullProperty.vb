...
Namespace Microsoft.CodeAnalysis.VisualBasic.ConvertAutoPropertyToFullProperty
    ...
    Friend Class VisualBasicConvertAutoPropertyToFullPropertyCodeRefactoringProvider
        ...
        ''' </summary>
        Protected Overrides Function GetFieldNameAsync(document As Document, propertySymbol As IPropertySymbol, fallbackOptions As INamingStylePreferencesProvider, cancellationToken As CancellationToken) As Task(Of String)
