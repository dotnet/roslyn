...
Namespace Microsoft.CodeAnalysis.VisualBasic.Completion.Providers
    Friend Module CompletionUtilities
        ...
        Public Function GetDisplayAndInsertionText(
            symbol As ISymbol,
            syntaxFacts As ISyntaxFactsService, context As VisualBasicSyntaxContext) As ValueTuple(Of String, String)

            Dim name As String = Nothing
            If Not CommonCompletionUtilities.TryRemoveAttributeSuffix(symbol, context.IsAttributeNameContext, syntaxFacts, name) Then
                name = symbol.Name
            End If
        ...
        Public Function GetInsertionText(name As String, symbol As ISymbol, context As VisualBasicSyntaxContext) As String
            name = name.EscapeIdentifier(context.IsRightOfNameSeparator, symbol, context.WithinAsyncMethod)
