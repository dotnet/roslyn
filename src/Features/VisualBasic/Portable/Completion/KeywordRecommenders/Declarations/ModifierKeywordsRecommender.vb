    ...
    Friend Class ModifierKeywordsRecommender
        ...
        Protected Overrides Function RecommendKeywords(context As VisualBasicSyntaxContext, cancellationToken As CancellationToken) As ImmutableArray(Of RecommendedKeyword)
            ...
            Dim innermostDeclarationKind =
                If(innermostDeclaration IsNot Nothing AndAlso Not innermostDeclaration.IsKind(SyntaxKind.CompilationUnit),
                   innermostDeclaration.Kind,
                   SyntaxKind.NamespaceBlock)

            If modifierFacts.AccessibilityKeyword.IsKind(SyntaxKind.None) AndAlso Not context.IsInterfaceMemberDeclarationKeywordContext Then
                If Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.PartialKeyword) Then
                ...
                If modifierFacts.NarrowingOrWideningKeyword.IsKind(SyntaxKind.None) Then
                    If Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.PartialKeyword) Then
                    ...
                    If modifierFacts.DefaultKeyword.IsKind(SyntaxKind.None) AndAlso innermostDeclarationKind <> SyntaxKind.NamespaceBlock Then
            ...
            If modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.ProtectedMember) Then
                If modifierFacts.AccessibilityKeyword.IsKind(SyntaxKind.None) Then
                ...
                ElseIf modifierFacts.AccessibilityKeyword.IsKind(SyntaxKind.ProtectedKeyword) AndAlso Not modifierFacts.HasProtectedAndFriend Then
                    ' We could still have a "Friend" later
                    recommendations.Add(New RecommendedKeyword("Friend", VBFeaturesResources.Specifies_that_one_or_more_declared_programming_elements_are_accessible_only_from_within_the_assembly_that_contains_their_declaration))
                ElseIf modifierFacts.AccessibilityKeyword.IsKind(SyntaxKind.FriendKeyword) AndAlso Not modifierFacts.HasProtectedAndFriend Then
            ...
            If innermostDeclarationKind = SyntaxKind.ClassBlock OrElse
               ...
               innermostDeclarationKind = SyntaxKind.NamespaceBlock Then
                ...
                If modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.Class) AndAlso
                    Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.PartialKeyword) AndAlso
                    modifierFacts.AsyncKeyword.IsKind(SyntaxKind.None) AndAlso
                    modifierFacts.IteratorKeyword.IsKind(SyntaxKind.None) Then
            ...
            If modifierFacts.AsyncKeyword.IsKind(SyntaxKind.None) AndAlso
               modifierFacts.IteratorKeyword.IsKind(SyntaxKind.None) Then

                If modifierFacts.MutabilityOrWithEventsKeyword.IsKind(SyntaxKind.None) Then
                ...
                If innermostDeclarationKind = SyntaxKind.ClassBlock OrElse
                   ...
                   innermostDeclarationKind = SyntaxKind.NamespaceBlock Then
                    ...
                    If modifierFacts.InheritenceKeyword.IsKind(SyntaxKind.None) AndAlso modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.Class) Then
                    ...
                    If modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.None) Then
                        If Not context.IsInterfaceMemberDeclarationKeywordContext AndAlso
                           Not modifierFacts.OverridesOrShadowsKeyword.IsKind(SyntaxKind.OverridesKeyword) Then
                        ...
                        If modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.OverridableMethod) Then
                            ...
                            If Not modifierFacts.OverridesOrShadowsKeyword.IsKind(SyntaxKind.ShadowsKeyword) Then
                            ...
                            If Not modifierFacts.OverridesOrShadowsKeyword.IsKind(SyntaxKind.OverridesKeyword) Then
                    ...
                    If modifierFacts.OverridesOrShadowsKeyword.IsKind(SyntaxKind.None) Then
                        If Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.OverridableKeyword) AndAlso
                           ...
                           modifierFacts.SharedKeyword.IsKind(SyntaxKind.None) AndAlso
                           Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.PartialKeyword) Then
                        ...
                        If modifierFacts.OverloadsKeyword.IsKind(SyntaxKind.None) AndAlso
                           Not modifierFacts.OverridableSharedOrPartialKeyword.IsKind(SyntaxKind.NotOverridableKeyword) AndAlso
                    ...
                    If modifierFacts.OverloadsKeyword.IsKind(SyntaxKind.None) AndAlso
                       Not modifierFacts.OverridesOrShadowsKeyword.IsKind(SyntaxKind.ShadowsKeyword) AndAlso
                    ...
                    If modifierFacts.DefaultKeyword.IsKind(SyntaxKind.None) AndAlso
                       modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.Property) AndAlso
                       Not modifierFacts.AccessibilityKeyword.IsKind(SyntaxKind.PrivateKeyword) Then
                    ...
                    If modifierFacts.NarrowingOrWideningKeyword.IsKind(SyntaxKind.None) AndAlso modifierFacts.CouldApplyToOneOf(PossibleDeclarationTypes.Operator) Then
