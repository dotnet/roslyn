...
namespace Microsoft.CodeAnalysis.CSharp.Completion.KeywordRecommenders
{
    internal class FieldKeywordRecommender : AbstractSyntacticSingleKeywordRecommender
    {
        ...
        private static readonly ISet<SyntaxKind> ValidTypeDeclarations = new HashSet<SyntaxKind>(SyntaxFacts.EqualityComparer)
        {
        ...
        {
            return context.IsMemberAttributeContext(ValidTypeDeclarations, cancellationToken);
        }
    }
}
