...
{
    extension(LocalizableString @this)
    {
    ...
    extension(NameSyntax? name)
    {
        public bool IsSuppressMessageAttribute()
        {
            if (name == null)
            {
                return false;
    ...
    extension(string checkId)
    {
        public string ExtractErrorCodeFromCheckId()
        {
