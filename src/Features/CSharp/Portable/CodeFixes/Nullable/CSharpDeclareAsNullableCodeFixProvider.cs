...
namespace Microsoft.CodeAnalysis.CSharp.CodeFixes.DeclareAsNullable
{
    ...
    internal class CSharpDeclareAsNullableCodeFixProvider : SyntaxEditorBasedCodeFixProvider
    {
        ...
        {
            if (!node.IsKind(SyntaxKind.NullLiteralExpression, SyntaxKind.AsExpression, SyntaxKind.DefaultExpression, SyntaxKind.DefaultLiteralExpression, SyntaxKind.ConditionalExpression))
            {
                return null;
            }
