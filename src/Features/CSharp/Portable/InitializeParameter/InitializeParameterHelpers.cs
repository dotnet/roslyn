        ...
        public static ImmutableArray<SyntaxNode> GetParameters(SyntaxNode functionDeclaration)
        {
            ...
            switch (functionDeclaration)
            {
                case BaseMethodDeclarationSyntax methodDeclaration:
                    return methodDeclaration.ParameterList.Parameters.SelectAsArray(p => p as SyntaxNode);
                case LocalFunctionStatementSyntax localFunction:
                    return localFunction.ParameterList.Parameters.SelectAsArray(p => p as SyntaxNode);
                case AnonymousMethodExpressionSyntax anonymousMethodExpression:
                    return anonymousMethodExpression.ParameterList.Parameters.SelectAsArray(p => p as SyntaxNode);
                case SimpleLambdaExpressionSyntax simpleLambdaExpression:
                    return ImmutableArray.Create<SyntaxNode>(simpleLambdaExpression.Parameter);
                case ParenthesizedLambdaExpressionSyntax lambdaExpressionSyntax:
                    return lambdaExpressionSyntax.ParameterList.Parameters.SelectAsArray(p => p as SyntaxNode);
                default:
