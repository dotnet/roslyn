...
{
    internal partial class BuiltinOperatorMethodSymbol
    {
        private class BuiltinOperatorParameterSymbol : IParameterSymbol
        {
            ...
            public bool Equals([NotNullWhen(true)] ISymbol? other, SymbolEqualityComparer equalityComparer)
                => other is BuiltinOperatorParameterSymbol otherParameter &&
                   Type.Equals(otherParameter.Type, equalityComparer);
