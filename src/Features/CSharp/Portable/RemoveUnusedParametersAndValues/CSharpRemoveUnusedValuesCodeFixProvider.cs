            ...
            ForEachStatementSyntax, SwitchSectionSyntax, SwitchLabelSyntax, CatchClauseSyntax, CatchClauseSyntax>
    {
        ...
        private sealed class RemoveDiscardHelper : IDisposable
        {
            ...
            private void ProcessDeclarationStatement()
            {
                ...
                // For example,
                //  1. "var _ = M();" is replaced with "_ = M();"
                //  2. "var x = 1, _ = M(), y = 2;" is replaced with following statements:
                //          var x = 1;
                //          _ = M();
                //          var y = 2;
            ...
            {
                // Convert a discard declaration with initializer of the form "var _ = M();" into
