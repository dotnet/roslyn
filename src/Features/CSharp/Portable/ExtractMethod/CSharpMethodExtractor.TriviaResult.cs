    ...
    internal partial class CSharpMethodExtractor
    {
        private class CSharpTriviaResult : TriviaResult
        {
            ...
            protected override AnnotationResolver GetAnnotationResolver(SyntaxNode callsite, SyntaxNode method)
            {
                ...
                {
                    return (node, location, annotation) => AnnotationResolver(node, location, annotation, callsite, localMethodDefinition);
                }
                else
                {
                    return null;
            ...
            protected override TriviaResolver GetTriviaResolver(SyntaxNode method)
            {
                ...
                {
                    return (location, tokenPair, triviaMap) => TriviaResolver(location, tokenPair, triviaMap, localMethodDefinition);
                }
                else
                {
                    return null;
