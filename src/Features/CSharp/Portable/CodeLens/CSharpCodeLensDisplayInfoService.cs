        ...
        public string GetDisplayName(SemanticModel semanticModel, SyntaxNode node)
        {
            ...
            switch (node.Kind())
            {
                case SyntaxKind.ConstructorDeclaration:
                    {
                        ...
                        var displayName = symbol.ToDisplayString(s_format);
                ...
                case SyntaxKind.UsingDirective:
                    {
                        ...
                        var enclosingScopeString = GetEnclosingScopeString(node, semanticModel, s_format);
                ...
                default:
                    {
                        var symbol = semanticModel.GetDeclaredSymbol(node);
                        return symbol != null ? symbol.ToDisplayString(s_format) : FeaturesResources.paren_Unknown_paren;
                    }
            }
        }
