...
namespace Microsoft.CodeAnalysis.CSharp.UseExpressionBodyForLambda
{
        ...
        : AbstractCodeStyleProvider<ExpressionBodyPreference, SyntaxKind, UseExpressionBodyForLambdaCodeStyleProvider>
    {
        ...
        private static LambdaExpressionSyntax Update(SemanticModel semanticModel, LambdaExpressionSyntax declaration)
            => UpdateWorker(semanticModel, declaration).WithAdditionalAnnotations(Formatter.Annotation);
