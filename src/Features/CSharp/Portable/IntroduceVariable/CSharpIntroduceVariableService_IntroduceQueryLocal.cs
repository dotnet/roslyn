...
namespace Microsoft.CodeAnalysis.CSharp.IntroduceVariable
{
    internal partial class CSharpIntroduceVariableService
    {
            ...
            SemanticDocument document, ExpressionSyntax expression, bool allOccurrences, CancellationToken cancellationToken)
        {
            ...
            var matches = FindMatches(document, expression, document, oldOutermostQuery, allOccurrences, includeLValues: true, cancellationToken);
            ...
            var newInnerMostQuery = Rewrite(
                document, expression, newLocalName, document, oldInnerMostCommonQuery, allOccurrences, includeLValues: true, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            var newClause = Rewrite(
                document, expression, newLocalName, document, oldClause, allOccurrences, includeLValues: true, cancellationToken);
