        ...
        private abstract class LatestDiagnosticsGetter : DiagnosticsGetter
        {
            ...
            protected async Task<DiagnosticAnalyzerDriver> GetDiagnosticAnalyzerDriverAsync(object documentOrProject, CancellationToken cancellationToken)
            {
                ...
                if (document != null)
                {
                    ...
                    return new DiagnosticAnalyzerDriver(document, root.FullSpan, root, this.DiagnosticLogAggregator, Owner.ReportAnalyzerExceptionDiagnostics, cancellationToken);
                }

                var project = documentOrProject as Project;
                if (project != null)
                {
                    return new DiagnosticAnalyzerDriver(project, this.DiagnosticLogAggregator, Owner.ReportAnalyzerExceptionDiagnostics, cancellationToken);
                }
