...
namespace Microsoft.CodeAnalysis.SolutionCrawler
{
    internal static class InternalSolutionCrawlerOptions
    {
        ...
        public static readonly Option2<int> ActiveFileWorkerBackOffTimeSpanInMS = new Option2<int>(nameof(InternalSolutionCrawlerOptions), "Active file worker backoff timespan in ms", defaultValue: 0,
