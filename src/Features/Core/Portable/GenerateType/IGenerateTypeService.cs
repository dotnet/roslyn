...
namespace Microsoft.CodeAnalysis.GenerateType
{
    ...
    {
        Task<ImmutableArray<CodeAction>> GenerateTypeAsync(Document document, SyntaxNode node, ICleanCodeGenerationOptionsProvider fallbackOptions, CancellationToken cancellationToken);
