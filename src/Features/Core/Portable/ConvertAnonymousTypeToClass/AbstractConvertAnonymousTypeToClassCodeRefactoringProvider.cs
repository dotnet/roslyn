...
namespace Microsoft.CodeAnalysis.CSharp.ConvertAnonymousTypeToClass
{
        ...
        where TNamespaceDeclarationSyntax : SyntaxNode
    {
        ...
        private async Task<INamedTypeSymbol> GenerateFinalNamedTypeAsync(
        ...
        private IPropertySymbol GenerateProperty(IPropertySymbol prop)
        {
            ...
            return CodeGenerationSymbolFactory.CreatePropertySymbol(
                ...
                prop.Name.ToPascalCase(trimLeadingTypePrefix: false),
        ...
        private IMethodSymbol CreateConstructor(
