        ...
        private sealed class CompilationAnalyzer
        {
            ...
            private void AnalyzeMemberReferenceOperation(OperationAnalysisContext operationContext)
            {
                ...
                if (IsCandidateSymbol(memberSymbol))
                {
                    ...
                    var valueUsageInfo = memberReference.GetValueUsageInfo(out var _);
                ...
                try
                {
                    ...
                    foreach (var member in namedType.GetMembers())
                    {
                            ...
                            !valueUsageInfo.IsReadFrom())
                        {
                            ...
                            var rule = !valueUsageInfo.IsWrittenTo() && !valueUsageInfo.IsInNonReadNonWriteContext() && !symbolsReferencedInDocComments.Contains(member)
