    ...
    where TSyntaxContext : SyntaxContext
{
    ...
    public override Task<TextChange?> GetTextChangeAsync(Document document, CompletionItem selectedItem, CompletionOptions options, char? ch, CancellationToken cancellationToken)
    {
