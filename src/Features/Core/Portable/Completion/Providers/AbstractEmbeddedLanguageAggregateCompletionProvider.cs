...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
    ...
    /// </summary>
    internal abstract class AbstractEmbeddedLanguageAggregateCompletionProvider : LSPCompletionProvider
    {
        public const string EmbeddedProviderName = "EmbeddedProvider";

        private ImmutableArray<IEmbeddedLanguage> _languageProviders;

        protected AbstractEmbeddedLanguageAggregateCompletionProvider(IEnumerable<Lazy<ILanguageService, LanguageServiceMetadata>> languageServices, string languageName)
        {
