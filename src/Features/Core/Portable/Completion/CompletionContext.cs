...
namespace Microsoft.CodeAnalysis.Completion
{
    ...
    public sealed class CompletionContext
    {
        ...
        public void AddItem(CompletionItem item)
        {
            ...
            item = FixItem(item, this.Provider);
            _items.Add(item);
        }
        ...
        public CompletionItem SuggestionModeItem
        {
            ...
            set
            {
                ...
                {
                    _suggestionModeItem = FixItem(_suggestionModeItem, this.Provider);
                }
            }
        }

        private CompletionItem FixItem(CompletionItem item, CompletionProvider provider)
        {
            // remember provider so we can find it again later
            item = item.AddProperty("Provider", GetProviderName(provider));
