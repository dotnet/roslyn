...
namespace Microsoft.CodeAnalysis.Completion
{
    ...
    public sealed class CompletionRules
    {
        ...
        /// </summary>
        public string DefaultCommitCharacters { get; }
        ...
        private CompletionRules(
            ...
            string defaultCommitCharacters,
            EnterKeyRule defaultEnterKeyRule)
        {
            ...
            this.DefaultCommitCharacters = string.IsNullOrEmpty(defaultCommitCharacters) ? string.Empty : defaultCommitCharacters;
        ...
        public static CompletionRules Create(
            ...
            string defaultCommitCharacters = null,
        ...
        private CompletionRules With(
            ...
            Optional<string> defaultCommitCharacters = default(Optional<string>),
        ...
        /// </summary>
        public CompletionRules WithDefaultCommitCharacters(string defaultCommitCharacters)
        {
        ...
        private static readonly string s_defaultCommitKeys = new string(new[]
            {
                ' ', '{', '}', '[', ']', '(', ')', '.', ',', ':',
                ';', '+', '-', '*', '/', '%', '&', '|', '^', '!',
                '~', '=', '<', '>', '?', '@', '#', '\'', '\"', '\\'
