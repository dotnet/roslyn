...
#pragma warning restore RS0030 // Do not used banned APIs
        ...
        // Use tri-value so the default state can be used to turn on the feature with experimentation service.
        public static readonly PerLanguageOption2<bool?> AutomaticallyAddParenthesisBySemicolon =
            new(nameof(CompletionOptions), nameof(AutomaticallyAddParenthesisBySemicolon), defaultValue: null,
            storageLocations: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.AutomaticallyAddParenthesisBySemicolon"));
