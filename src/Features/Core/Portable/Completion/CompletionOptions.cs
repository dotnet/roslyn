...
namespace Microsoft.CodeAnalysis.Completion
{
    ...
    internal static class CompletionControllerOptions
    {
        ...
        public static readonly Option<bool> TextEditorSnipppetsAreActive = new Option<bool>(nameof(CompletionControllerOptions), nameof(TextEditorSnipppetsAreActive), defaultValue: false);
    }
}
