        ...
        protected override void InitializeWorker(AnalysisContext context)
        {
            context.RegisterCompilationStartAction(compilationStartContext =>
            {
                ...
                void AnalyzeOperation(OperationAnalysisContext operationContext)
                {
                    ...
                    (var isCandidate, var written) = TryGetOrInitializeFieldState(fieldReference.Field, operationContext.Options, operationContext.CancellationToken);
                ...
                void OnSymbolEnd(SymbolAnalysisContext symbolEndContext)
                {
                    ...
                    foreach (var member in members)
                    {
                        ...
                        {
                            (var isCandidate, var written) = value;
                            if (isCandidate && !written)
                            {
