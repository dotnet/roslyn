...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    {
        Task<ImmutableArray<CodeFixCollection>> GetFixesAsync(Document document, TextSpan textSpan, bool includeSuppressionFixes, bool? highPriority, bool isBlocking, Func<string, IDisposable?> addOperationScope, CancellationToken cancellationToken);
    ...
    internal static class ICodeFixServiceExtensions
    {
        ...
        public static Task<ImmutableArray<CodeFixCollection>> GetFixesAsync(this ICodeFixService service, Document document, TextSpan range, bool includeConfigurationFixes, bool isBlocking, CancellationToken cancellationToken)
            => service.GetFixesAsync(document, range, includeConfigurationFixes, highPriority: null, isBlocking, addOperationScope: _ => null, cancellationToken);
    }
}
