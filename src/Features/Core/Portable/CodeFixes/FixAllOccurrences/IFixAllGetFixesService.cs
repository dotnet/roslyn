...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    internal interface IFixAllGetFixesService : IWorkspaceService
    {
        ...
        /// </summary>
        Task<IEnumerable<CodeActionOperation>> GetFixAllOperationsAsync(
        ...
        Task<Solution> GetFixAllChangedSolutionAsync(
            FixAllProvider fixAllProvider, FixAllContext fixAllContext, CancellationToken cancellationToken);
    }
}
