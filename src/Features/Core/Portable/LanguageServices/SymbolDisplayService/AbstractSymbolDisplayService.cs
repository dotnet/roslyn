...
namespace Microsoft.CodeAnalysis.LanguageServices
{
    internal abstract partial class AbstractSymbolDisplayService : ISymbolDisplayService
    {
        ...
        public abstract ImmutableArray<SymbolDisplayPart> PrimitiveToMinimalDisplayParts(SemanticModel semanticModel, int position, ITypeSymbol type, object value, SymbolDisplayFormat format);
