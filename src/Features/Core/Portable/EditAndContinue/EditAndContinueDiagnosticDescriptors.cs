...
internal static class EditAndContinueDiagnosticDescriptors
{
    ...
    static EditAndContinueDiagnosticDescriptors()
    {
        ...
        AddGeneralDiagnostic(EditAndContinueErrorCode.DeletingManifestResource, nameof(FeaturesResources.Deleting_or_updating_manifest_resource_0_has_no_effect_until_the_project_is_rebuit), DiagnosticSeverity.Warning, noEffect: true);
