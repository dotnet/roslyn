...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    internal static class EditAndContinueDiagnosticDescriptors
    {
        ...
        static EditAndContinueDiagnosticDescriptors()
        {
            ...
            AddRudeEdit(RudeEditKind.RenamingParameterNotSupportedByRuntime, nameof(FeaturesResources.Renaming_parameter_0_requires_restarting_the_application_because_it_is_not_supported_by_the_runtime));
