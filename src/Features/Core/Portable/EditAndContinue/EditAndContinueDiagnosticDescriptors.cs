...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    internal static class EditAndContinueDiagnosticDescriptors
    {
        ...
        static EditAndContinueDiagnosticDescriptors()
        {
            ...
            AddRudeEdit(RudeEditKind.ChangingNonCustomAttribute, nameof(FeaturesResources.Updating_the_attributes_of_0_requires_restarting_the_application_because_one_or_more_attributes_affect_compiler_behaviour));
