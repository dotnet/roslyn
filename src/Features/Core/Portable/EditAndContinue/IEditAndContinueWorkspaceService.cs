...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    ...
    {
        ValueTask<ImmutableArray<Diagnostic>> GetDocumentDiagnosticsAsync(DebuggingSessionId sessionId, Document document, ActiveStatementSpanProvider activeStatementSpanProvider, CancellationToken cancellationToken);
        ...
        void OnSourceFileUpdated(DebuggingSessionId sessionId, Document document);

        ValueTask<DebuggingSession> StartDebuggingSessionAsync(Solution solution, IManagedEditAndContinueDebuggerService debuggerService, bool captureMatchingDocuments, CancellationToken cancellationToken);
