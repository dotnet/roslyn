    ...
    internal abstract class EditAndContinueMethodDebugInfoReader
    {
        ...
        private sealed class Native : EditAndContinueMethodDebugInfoReader
        {
            ...
            public override EditAndContinueMethodDebugInformation GetDebugInfo(MethodDefinitionHandle methodHandle)
            {
                ...
                catch (Exception e) when (FatalError.ReportAndCatch(e, ErrorSeverity.General)) // likely a bug in the compiler/debugger
                {
                ...
                catch (InvalidOperationException e) when (FatalError.ReportAndCatch(e, ErrorSeverity.General)) // likely a bug in the compiler/debugger
                {
