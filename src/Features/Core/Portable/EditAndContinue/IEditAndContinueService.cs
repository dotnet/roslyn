...
internal interface IEditAndContinueService
{
    ...
    ValueTask<DebuggingSessionId> StartDebuggingSessionAsync(Solution solution, IManagedHotReloadService debuggerService, IPdbMatchingSourceTextProvider sourceTextProvider, bool reportDiagnostics, CancellationToken cancellationToken);
