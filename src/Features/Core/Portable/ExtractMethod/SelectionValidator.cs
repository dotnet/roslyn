    ...
    where TStatementSyntax : SyntaxNode
{
    ...
    protected abstract SelectionInfo<TStatementSyntax> GetInitialSelectionInfo(CancellationToken cancellationToken);
    protected abstract Task<TSelectionResult> CreateSelectionResultAsync(SelectionInfo<TStatementSyntax> selectionInfo, CancellationToken cancellationToken);
