...
namespace Microsoft.CodeAnalysis.ExtractMethod
{
    internal partial class OperationStatus
    {
        ...
        public static readonly OperationStatus IsPattern = new OperationStatus(OperationStatusFlag.BestEffort, reason: FeaturesResources.Cannot_extract_a_method_with_an_is_pattern_declaration);
