        ...
        where TLiteralExpressionSyntax : SyntaxNode
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            if (TryFindInvocation(context.Span, root, semanticModel, formatMethods, syntaxFactsService, context.CancellationToken, out invocation, out invocationSymbol) &&
                IsArgumentListCorrect(syntaxFactsService.GetArgumentsOfInvocationExpression<TArgumentSyntax>(invocation), invocationSymbol, formatMethods, semanticModel, syntaxFactsService, context.CancellationToken))
            {
            ...
            out ISymbol invocationSymbol)
        {
            ...
            {
                var arguments = syntaxFactsService.GetArgumentsOfInvocationExpression<TArgumentSyntax>(invocation);
