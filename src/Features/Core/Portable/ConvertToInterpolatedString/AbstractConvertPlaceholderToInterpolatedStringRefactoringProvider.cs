        ...
        where TArgumentListExpressionSyntax : SyntaxNode
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            if (invocation != null && invocationSymbol != null &&
                IsArgumentListCorrect(syntaxFactsService.GetArgumentsOfInvocationExpression(invocation).CastDown<TArgumentSyntax>(), invocationSymbol, formatMethods, semanticModel, syntaxFactsService, cancellationToken))
            {
