...
namespace Microsoft.CodeAnalysis.FindUsages
{
    ...
    internal abstract partial class DefinitionItem
    {
        ...
        /// </summary>
        public ImmutableArray<AdditionalProperty> DisplayableProperties { get; }
        ...
        protected DefinitionItem(
            ...
            this(
                ...
                sourceSpans,
                properties,
                ImmutableArray<AdditionalProperty>.Empty,
            ...
            bool displayIfNoReferences)
        {
            return Create(
                ...
                properties: null, displayableProperties: ImmutableArray<AdditionalProperty>.Empty, displayIfNoReferences: displayIfNoReferences);
        }
        ...
        public static DefinitionItem Create(
            ...
            bool displayIfNoReferences = true)
        {
            return Create(tags, displayParts, sourceSpans, nameDisplayParts, properties, ImmutableArray<AdditionalProperty>.Empty, displayIfNoReferences);
        }
        ...
        public static DefinitionItem Create(
            ...
            ImmutableArray<TaggedText> nameDisplayParts = default,
            ImmutableDictionary<string, string> properties = null,
            ImmutableArray<AdditionalProperty> displayableProperties = default,
            bool displayIfNoReferences = true)
        {
