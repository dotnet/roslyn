    ...
    where TExtension : class
{
    ...
    private ImmutableArray<TExtension> CreateExtensions(string language)
    {
        ...
        this.ExtensionManager.PerformAction(analyzerFileReference, LoadExtensionAssembly);
        ...
        void LoadExtensionAssembly()
        {
            ...
            foreach (var typeInfo in typeInfos)
            {
                ...
                {
                    this.ExtensionManager.PerformAction(analyzerFileReference, () => LoadExtensionType(typeInfo));
                }
            }
        }
