    ...
    internal static class GlyphTags
    {
        public static ImmutableArray<string> GetTags(Glyph glyph)
            => glyph switch
            {
                ...
                Glyph.ConstructorPublic => WellKnownTagArrays.MethodPublic,
                Glyph.ConstructorProtected => WellKnownTagArrays.MethodProtected,
                Glyph.ConstructorPrivate => WellKnownTagArrays.MethodPrivate,
                Glyph.ConstructorInternal => WellKnownTagArrays.MethodInternal,
