...
internal static class GlyphTags
{
    public static ImmutableArray<string> GetTags(Glyph glyph)
        => glyph switch
        {
            ...
            Glyph.OperatorPublic => WellKnownTagArrays.OperatorPublic,
            Glyph.OperatorProtected => WellKnownTagArrays.OperatorProtected,
            Glyph.OperatorPrivate => WellKnownTagArrays.OperatorPrivate,
            Glyph.OperatorInternal => WellKnownTagArrays.OperatorInternal,
            ...
            Glyph.UnionPublic => WellKnownTagArrays.UnionPublic,
            Glyph.UnionProtected => WellKnownTagArrays.UnionProtected,
            Glyph.UnionPrivate => WellKnownTagArrays.UnionPrivate,
            Glyph.UnionInternal => WellKnownTagArrays.UnionInternal,
