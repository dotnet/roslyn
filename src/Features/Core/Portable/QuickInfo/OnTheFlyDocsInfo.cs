...
internal sealed class OnTheFlyDocsInfo(string symbolSignature, ImmutableArray<string> declarationCode, string language, bool isContentExcluded, ImmutableArray<string> additionalContext, bool hasComments = false)
{
    ...
    public ImmutableArray<string> AdditionalContext { get; } = additionalContext;
