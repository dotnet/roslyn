...
namespace Microsoft.CodeAnalysis.MoveToNamespace
{
    ...
    {
        private sealed class MoveItemsToNamespaceCodeAction(IMoveToNamespaceService changeNamespaceService, MoveToNamespaceAnalysisResult analysisResult, ICodeCleanupOptionsProvider cleanupOptions)
