...
{
    internal interface IFixAllCodeRefactoringGetFixesService : IWorkspaceService
    {
        /// <summary>
        ...
        /// </summary>
        Task<ImmutableArray<CodeActionOperation>> GetFixAllOperationsAsync(FixAllContext fixAllContext);
