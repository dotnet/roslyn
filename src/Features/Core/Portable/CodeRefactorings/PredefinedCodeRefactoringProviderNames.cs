...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    internal static class PredefinedCodeRefactoringProviderNames
    {
        ...
        public const string ConvertConversionOperatorsFromThrowingCastToTryCast = "Convert Conversion Operators from throwing cast to try cast";
        public const string ConvertConversionOperatorsFromTryCastToThrowingCast = "Convert Conversion Operators from try cast to throwing cast";
