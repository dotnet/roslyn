...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    internal static class PredefinedCodeRefactoringProviderNames
    {
        ...
        public const string ArgumentWrapping = "Argument Wrapping Code Action Provider";
        ...
        public const string ParameterWrapping = "Parameter Wrapping Code Action Provider";
