...
namespace Microsoft.CodeAnalysis.UseConditionalExpression
{
        ...
        where TExpressionSyntax : SyntaxNode
    {
        ...
        private SyntaxNode GetValueFromAssignment(SyntaxGenerator generator, ISimpleAssignmentOperation assignment)
        {
            ...
            var sourceSyntax = assignment.Value.Syntax.WithoutTrivia();

            // If there was an implicit conversion generated by the compiler, then conver that to an
            ...
            if (assignment.Value is IConversionOperation conversion &&
