    ...
    ImmutableArray<PatternMatch> matches)
{
    ...
    private sealed class NavigateToSearchResult : INavigateToSearchResult, INavigableItem
    {
        ...
        private string ComputeSecondarySort()
            => NavigateToSearchResultHelpers.ComputeSecondarySort(
                _activeDocument, _itemDocument, _item.DeclaredSymbolInfo.ParameterCount, _item.DeclaredSymbolInfo.TypeParameterCount, _item.DeclaredSymbolInfo.Name);
        ...
        Glyph INavigableItem.Glyph => GlyphExtensions.GetGlyph(_item.DeclaredSymbolInfo.Kind, _item.DeclaredSymbolInfo.Accessibility);
