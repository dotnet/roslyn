...
internal abstract partial class AbstractNavigateToSearchService
{
    ...
    public static async Task SearchDocumentInCurrentProcessAsync(
        Document document, string searchPattern, IImmutableSet<string> kinds, Func<ImmutableArray<RoslynNavigateToItem>, CancellationToken, ValueTask> onItemsFound, CancellationToken cancellationToken)
    {
