    ...
    internal abstract partial class AbstractNavigateToSearchService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            await ProcessDocumentsAsync(
                searchDocument: null, patternName, patternContainerOpt, declaredSymbolInfoKindsSet, onResultFound, generatedDocs.ToSet<Document>(), highPriority: false, cancellationToken).ConfigureAwait(false);
        }
    }
}
