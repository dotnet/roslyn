...
namespace Microsoft.CodeAnalysis.NavigationBar
{
    ...
    internal sealed class SerializableNavigationBarItem
    {
        ...
        public RoslynNavigationBarItem Rehydrate()
            => this.Kind switch
            {
                RoslynNavigationBarItemKind.Symbol => new RoslynNavigationBarItem.SymbolItem(Name!, Text, Glyph, IsObsolete, Spans, SelectionSpan, NavigationSymbolId!.Value, NavigationSymbolIndex, ChildItems.SelectAsArray(i => i.Rehydrate()), Indent, Bolded, Grayed),
        ...
        public static SerializableNavigationBarItem ActionlessItem(string text, Glyph glyph, ImmutableArray<SerializableNavigationBarItem> childItems = default, int indent = 0, bool bolded = false, bool grayed = false)
            => new(RoslynNavigationBarItemKind.Actionless, text, glyph, bolded, grayed, indent, childItems, null, false, default, null, null, 0, null, null, null, null);

        public static SerializableNavigationBarItem SymbolItem(string text, Glyph glyph, string name, bool isObsolete, ImmutableArray<TextSpan> spans, TextSpan? selectionSpan, SymbolKey navigationSymbolId, int navigationSymbolIndex, ImmutableArray<SerializableNavigationBarItem> childItems = default, int indent = 0, bool bolded = false, bool grayed = false)
            => new(RoslynNavigationBarItemKind.Symbol, text, glyph, bolded, grayed, indent, childItems, name, isObsolete, spans, selectionSpan, navigationSymbolId, navigationSymbolIndex, null, null, null, null);

        public static SerializableNavigationBarItem GenerateFinalizer(string text, SymbolKey destinationTypeSymbolKey)
            => new(RoslynNavigationBarItemKind.GenerateFinalizer, text, Glyph.MethodProtected, bolded: false, grayed: false, indent: 0, default, null, false, default, null, null, 0, destinationTypeSymbolKey, null, null, null);
        ...
        public static SerializableNavigationBarItem GenerateEventHandler(string eventName, Glyph glyph, string containerName, SymbolKey eventSymbolKey, SymbolKey destinationTypeSymbolKey)
            => new(RoslynNavigationBarItemKind.GenerateEventHandler, eventName, glyph, bolded: false, grayed: false, indent: 0, default, null, false, default, null, null, 0, destinationTypeSymbolKey, containerName, eventSymbolKey, null);
        ...
        public static SerializableNavigationBarItem GenerateMethod(string text, Glyph glyph, SymbolKey destinationTypeSymbolId, SymbolKey methodToReplicateSymbolId)
            => new(RoslynNavigationBarItemKind.GenerateMethod, text, glyph, bolded: false, grayed: false, indent: 0, default, null, false, default, null, null, 0, destinationTypeSymbolId, null, null, methodToReplicateSymbolId);

        public static SerializableNavigationBarItem GenerateDefaultConstructor(string text, SymbolKey destinationTypeSymbolKey)
            => new(RoslynNavigationBarItemKind.GenerateDefaultConstructor, text, Glyph.MethodPublic, bolded: false, grayed: false, indent: 0, default, null, false, default, null, null, 0, destinationTypeSymbolKey, null, null, null);
    }
}
