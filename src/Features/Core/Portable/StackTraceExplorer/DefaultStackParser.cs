...
namespace Microsoft.CodeAnalysis.StackTraceExplorer
{
    ...
    {
        public bool TryParseLine(VirtualCharSequence virtualCharSequence, [NotNullWhen(true)] out ParsedFrame? parsedFrame)
        {
            ...
            parsedFrame = new IgnoredFrame(virtualCharSequence);
            return true;
        }
    }
}
