...
namespace Microsoft.CodeAnalysis.DocumentHighlighting
{
    ...
    internal class ExportEmbeddedLanguageDocumentHighlightsServiceAttribute : ExportAttribute
    {
        /// <summary>
        ...
        public ExportEmbeddedLanguageDocumentHighlightsServiceAttribute(
            ...
            : base(typeof(IEmbeddedLanguageDocumentHighlightsService))
        {
    ...
    /// <summary>
    /// Internal version of <see cref="ExportEmbeddedLanguageDocumentHighlightsServiceAttribute"/>.  Used so we can allow regex/json
    ...
    [MetadataAttribute]
    [AttributeUsage(AttributeTargets.Class)]
    internal sealed class ExportEmbeddedLanguageDocumentHighlightsServiceInternalAttribute : ExportEmbeddedLanguageDocumentHighlightsServiceAttribute
    {
        /// <inheritdoc cref="EmbeddedLanguageMetadata.SupportsUnannotatedAPIs"/>
        public bool SupportsUnannotatedAPIs { get; }

        public ExportEmbeddedLanguageDocumentHighlightsServiceInternalAttribute(
