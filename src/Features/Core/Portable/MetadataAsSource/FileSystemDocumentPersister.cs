...
internal class FileSystemDocumentPersister : IMetadataDocumentPersister
{
    ...
    public async Task<bool> WriteMetadataFileAsync(string documentPath, Encoding encoding, SourceText text, Action<Exception>? logFailure, CancellationToken cancellationToken)
    {
        try
        {
