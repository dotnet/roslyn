...
namespace Microsoft.CodeAnalysis.MetadataAsSource
{
    internal interface IMetadataAsSourceFileProvider
    {
        ...
        /// </summary>
        Task<MetadataAsSourceFile?> GetGeneratedFileAsync(Workspace workspace, Project project, ISymbol symbol, bool signaturesOnly, bool allowDecompilation, bool useDefaultSymbolServers, string tempPath, CancellationToken cancellationToken);

        /// <summary>
        /// Called when the file returned from <see cref="GetGeneratedFileAsync(Workspace, Project, ISymbol, bool, bool, bool, string, CancellationToken)"/>
