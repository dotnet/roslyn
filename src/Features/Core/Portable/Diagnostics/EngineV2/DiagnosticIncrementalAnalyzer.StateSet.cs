...
namespace Microsoft.CodeAnalysis.Diagnostics.EngineV2
{
    internal partial class DiagnosticIncrementalAnalyzer
    {
        ...
        private sealed class StateSet
        {
            ...
            public async Task<bool> OnDocumentOpenedAsync(IPersistentStorageService2 persistentStorageService, TextDocument document)
            {
            ...
            public async Task<bool> OnDocumentClosedAsync(IPersistentStorageService2 persistentStorageService, TextDocument document)
            {
                // can not be cancelled
