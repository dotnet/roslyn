...
internal static class SolutionCrawlerOptionsStorage
{
    ...
    extension(IGlobalOptionService globalOptions)
    {
        ...
        /// </summary>
        public BackgroundAnalysisScope GetBackgroundAnalysisScope(string language)
        {
        ...
        /// </summary>
        public CompilerDiagnosticsScope GetBackgroundCompilerAnalysisScope(string language)
        {
            if (LowMemoryForcedMinimalBackgroundAnalysis)
            {
        ...
        /// </summary>
        public bool IsFullSolutionAnalysisEnabled(
            string language)
        ...
        /// </summary>
        public bool IsAnalysisDisabled(
            string language)
        {
    ...
    extension(DiagnosticAnalyzer analyzer)
    {
        ...
        /// </summary>
        public bool IsFullSolutionAnalysisEnabled(IGlobalOptionService globalOptions, string language)
        {
