...
Namespace Microsoft.CodeAnalysis.LanguageServerIndexFormat.Generator.UnitTests
    ...
    Public NotInheritable Class SemanticTokensTests
        ...
        <Theory>
        <InlineData("", "{""data"":[]}")>
        <InlineData("namespace Foo;", "{""data"":[0,0,9,15,0,0,10,3,50,0,0,3,1,56,0]}")>
        <InlineData("namespace " & vbCrLf & " Foo {}", "{""data"":[0,0,9,15,0,2,1,3,50,0,0,4,1,56,0,0,1,1,56,0]}")>
        <InlineData("public class Foo { System.Collections.IList FooList { get; set; } int FooMethod() { int x = 0; return x; } }", "{""data"":[0,0,6,15,0,0,7,5,15,0,0,6,3,23,0,0,4,1,56,0,0,2,6,50,0,0,6,1,21,0,0,1,11,50,0,0,11,1,21,0,0,1,5,33,0,0,6,7,55,0,0,8,1,56,0,0,2,3,15,0,0,3,1,56,0,0,2,3,15,0,0,3,1,56,0,0,2,1,56,0,0,2,3,15,0,0,4,9,48,0,0,9,1,56,0,0,1,1,56,0,0,2,1,56,0,0,2,3,15,0,0,4,1,47,0,0,2,1,21,0,0,2,1,19,0,0,1,1,56,0,0,2,6,45,0,0,7,1,47,0,0,1,1,56,0,0,2,1,56,0,0,2,1,56,0]}")>
