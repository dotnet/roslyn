...
public interface IRequestHandler
{
    ...
    /// and <see cref="RequestContext.Document"/> will be <see langword="null"/>, even if <see cref="IRequestHandler{RequestType, ResponseType, RequestContextType}.GetTextDocumentIdentifier(RequestType)"/>
