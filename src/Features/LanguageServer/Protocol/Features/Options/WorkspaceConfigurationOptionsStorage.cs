...
internal static class WorkspaceConfigurationOptionsStorage
{
    public static WorkspaceConfigurationOptions GetWorkspaceConfigurationOptions(this IGlobalOptionService globalOptions)
        => new(
            ...
            TriggerGeneratorsWhenDebugSessionStarts: globalOptions.GetOption(TriggerGeneratorsWhenDebugSessionStarts));
    ...
    public static readonly Option2<bool> TriggerGeneratorsWhenDebugSessionStarts = new(
        "dotnet_trigger_generators_when_debug_session_starts", WorkspaceConfigurationOptions.Default.TriggerGeneratorsWhenDebugSessionStarts);
}
