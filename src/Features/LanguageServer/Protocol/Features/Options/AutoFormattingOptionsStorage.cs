...
internal static class AutoFormattingOptionsStorage
{
    ...
    internal static readonly PerLanguageOption2<bool> FormatOnReturn = new(
        "dotnet_formatting_options_auto_formatting_on_return", AutoFormattingOptions.Default.FormatOnReturn);

    public static readonly PerLanguageOption2<bool> FormatOnTyping = new(
        "dotnet_formatting_options_auto_formatting_on_typing", AutoFormattingOptions.Default.FormatOnTyping);

    public static readonly PerLanguageOption2<bool> FormatOnSemicolon = new(
        "dotnet_formatting_options_auto_formatting_on_semicolon", AutoFormattingOptions.Default.FormatOnSemicolon);

    public static readonly PerLanguageOption2<bool> FormatOnCloseBrace = new(
        "dotnet_brace_completion_options_auto_formatting_on_close_brace", AutoFormattingOptions.Default.FormatOnCloseBrace);
}
