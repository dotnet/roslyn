...
internal static class InternalDiagnosticsOptions
{
    ...
    public static readonly Option2<DiagnosticMode> RazorDiagnosticMode = new(
        "InternalDiagnosticsOptions_RazorDiagnosticMode", defaultValue: DiagnosticMode.LspPull, serializer: EditorConfigValueSerializer.CreateSerializerForEnum<DiagnosticMode>());
