...
internal static class InternalDiagnosticsOptions
{
    ...
    public static readonly Option2<DiagnosticMode> RazorDiagnosticMode = new(
        "InternalDiagnosticsOptions", "RazorDiagnosticMode", defaultValue: DiagnosticMode.LspPull);
    ...
    public static readonly Option2<DiagnosticMode> LiveShareDiagnosticMode = new(
        "InternalDiagnosticsOptions", "LiveShareDiagnosticMode", defaultValue: DiagnosticMode.LspPull);

    public static readonly Option2<DiagnosticMode> NormalDiagnosticMode = new(
        "InternalDiagnosticsOptions", "NormalDiagnosticMode", defaultValue: DiagnosticMode.Default);
}
