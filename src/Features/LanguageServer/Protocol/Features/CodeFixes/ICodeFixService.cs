...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    {
        IAsyncEnumerable<CodeFixCollection> StreamFixesAsync(TextDocument document, TextSpan textSpan, ICodeActionRequestPriorityProvider priorityProvider, CodeActionOptionsProvider options, Func<string, IDisposable?> addOperationScope, bool includeConfigureAndSuppressFixer, CancellationToken cancellationToken);
    ...
    internal static class ICodeFixServiceExtensions
    {
        public static IAsyncEnumerable<CodeFixCollection> StreamFixesAsync(this ICodeFixService service, TextDocument document, TextSpan range, CodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken)
            => service.StreamFixesAsync(document, range, new DefaultCodeActionRequestPriorityProvider(), fallbackOptions, addOperationScope: _ => null, includeConfigureAndSuppressFixer: true, cancellationToken);
        ...
        public static Task<ImmutableArray<CodeFixCollection>> GetFixesAsync(this ICodeFixService service, TextDocument document, TextSpan textSpan, ICodeActionRequestPriorityProvider priorityProvider, CodeActionOptionsProvider fallbackOptions, Func<string, IDisposable?> addOperationScope, CancellationToken cancellationToken, bool includeConfigureAndSuppressFixer = true)
            => service.StreamFixesAsync(document, textSpan, priorityProvider, fallbackOptions, addOperationScope, includeConfigureAndSuppressFixer, cancellationToken).ToImmutableArrayAsync(cancellationToken);
