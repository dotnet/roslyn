...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    internal interface ICodeFixService
    {
        ...
        Task<TDocument> ApplyCodeFixesForSpecificDiagnosticIdAsync<TDocument>(TDocument document, string diagnosticId, DiagnosticSeverity severity, IProgress<CodeAnalysisProgress> progress, CodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken)
    ...
    internal static class ICodeFixServiceExtensions
    {
        ...
        public static Task<TDocument> ApplyCodeFixesForSpecificDiagnosticIdAsync<TDocument>(this ICodeFixService service, TDocument document, string diagnosticId, IProgress<CodeAnalysisProgress> progress, CodeActionOptionsProvider fallbackOptions, CancellationToken cancellationToken) where TDocument : TextDocument
