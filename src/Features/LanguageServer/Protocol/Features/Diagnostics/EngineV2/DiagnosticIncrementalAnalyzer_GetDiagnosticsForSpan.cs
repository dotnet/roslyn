    ...
    internal partial class DiagnosticIncrementalAnalyzer
    {
        ...
        private sealed class LatestDiagnosticsForSpanGetter
        {
                 ...
                 CancellationToken cancellationToken)
            {
                ...
                var cacheFullDocumentDiagnostics = owner.AnalyzerService.GlobalOptions.IsLspPullDiagnostics(InternalDiagnosticsOptions.NormalDiagnosticMode);
                ...
                CancellationToken cancellationToken)
            {
                ...
                var incrementalAnalysis = !span.HasValue
                    ...
                    && _owner.GlobalOptions.IsLspPullDiagnostics(InternalDiagnosticsOptions.NormalDiagnosticMode);
