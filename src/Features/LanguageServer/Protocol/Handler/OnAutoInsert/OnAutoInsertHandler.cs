...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler
{
    ...
    internal sealed class OnAutoInsertHandler : ILspServiceRequestHandler<LSP.VSInternalDocumentOnAutoInsertParams, LSP.VSInternalDocumentOnAutoInsertResponseItem?>
    {
        ...
        public object? GetTextDocumentIdentifier(LSP.VSInternalDocumentOnAutoInsertParams request) => request.TextDocument;
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (request.Character == "\n" && context.ServerKind == WellKnownLspServerKinds.RazorLspServer.ToConvertableString())
            {
