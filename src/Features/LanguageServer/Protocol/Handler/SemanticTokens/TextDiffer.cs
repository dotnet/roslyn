...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.SemanticTokens
{
    ...
    ///
    /// This class is adapted from Razor's TextDiffer class:
    /// https://github.com/dotnet/aspnetcore-tooling/blob/main/src/Razor/src/Microsoft.AspNetCore.Razor.LanguageServer/TextDiffer.cs
    /// Roslyn has its own Myers diff implementation (<see cref="LongestCommonSubsequence"/>), but this
    /// version of the algorithm [to-do: Finish explanation]
    /// </summary>
    internal abstract class TextDiffer
    {
        ...
        internal IReadOnlyList<DiffEdit> ComputeDiff()
        {
