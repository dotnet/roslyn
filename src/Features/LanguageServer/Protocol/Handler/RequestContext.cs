...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler
{
    ...
    internal readonly struct RequestContext
    {
        ...
        /// <summary>
        /// The additional document that the request is for, if applicable. This comes from the <see cref="TextDocumentIdentifier"/> returned from the handler itself via a call to <see cref="IRequestHandler{RequestType, ResponseType}.GetTextDocumentIdentifier(RequestType)"/>.
        /// </summary>
        public readonly TextDocument? AdditionalDocument;
        ...
        public RequestContext(
            ...
            Document? document,
            TextDocument? additionalDocument,
            ...
            CancellationToken requestCancellationToken)
        {
            ...
            if (!requiresLSPSolution)
            {
                return new RequestContext(
                    solution: null, logger: logger, clientCapabilities: clientCapabilities, serverKind: serverKind, document: null, additionalDocument: null,
            ...
            TextDocument? additionalDocument = null;
