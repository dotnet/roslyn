...
{
    internal class QueueItem<TRequestType, TResponseType> : IQueueItem<RequestContext>
    {
        private readonly ILspLogger _logger;

        private readonly TRequestType _request;
        private readonly IRequestHandler<TRequestType, TResponseType, RequestContext> _handler;
