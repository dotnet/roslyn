...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.SpellChecking
{
        ...
        where TReport : VSInternalSpellCheckableRangeReport
    {
        ...
        /// </summary>
        protected abstract VSInternalSpellCheckableRangeReport CreateReport(TextDocumentIdentifier identifier, LSP.Diagnostic[]? diagnostics, string? resultId);

        protected abstract VSInternalSpellCheckableRangeReport[] CreateReturn(BufferedProgress<VSInternalSpellCheckableRangeReport> progress);
        ...
        public async Task<VSInternalSpellCheckableRangeReport[]> HandleRequestAsync(
        ...
        private async Task<VSInternalSpellCheckableRangeReport> ComputeAndReportCurrentDiagnosticsAsync(
        ...
        private void HandleRemovedDocuments(RequestContext context, ImmutableArray<PreviousResult> previousResults, BufferedProgress<VSInternalSpellCheckableRangeReport> progress)
        {
            Contract.ThrowIfNull(context.Solution);
