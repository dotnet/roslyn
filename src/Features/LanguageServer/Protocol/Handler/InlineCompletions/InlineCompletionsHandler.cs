...
internal partial class InlineCompletionsHandler : AbstractStatelessRequestHandlerAndProvider<VSInternalInlineCompletionRequest, VSInternalInlineCompletionList?>
{
    /// <summary>
