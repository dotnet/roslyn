...
namespace Microsoft.CodeAnalysis.LanguageServer
{
    internal sealed class LspOptions
    {
        ...
        public static readonly Option2<bool> LspEditorFeatureFlag = new("dotnet_lsp_editor", defaultValue: false);

        // Flag is defined in VisualStudio\Core\Def\PackageRegistration.pkgdef.
        public static readonly Option2<bool> LspSemanticTokensFeatureFlag = new("dotnet_lsp_semantic_tokens", defaultValue: false);
    }
}
