...
namespace Microsoft.CodeAnalysis.LanguageServer
{
    internal sealed class LspOptions
    {
        ...
        /// </summary>
        public static readonly SingleValuedOption2<int> MaxCompletionListSize = new(FeatureName, nameof(MaxCompletionListSize), defaultValue: 1000,
        ...
        public static readonly SingleValuedOption2<bool> LspEditorFeatureFlag = new(FeatureName, nameof(LspEditorFeatureFlag), defaultValue: false,
            new FeatureFlagStorageLocation("Roslyn.LSP.Editor"));

        // Flag is defined in VisualStudio\Core\Def\PackageRegistration.pkgdef.
        public static readonly SingleValuedOption2<bool> LspSemanticTokensFeatureFlag = new(FeatureName, nameof(LspSemanticTokensFeatureFlag), defaultValue: false,
