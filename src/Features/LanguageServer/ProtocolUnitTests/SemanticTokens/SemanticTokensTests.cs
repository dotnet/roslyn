...
";
        ...
        [Fact]
        public async Task TestGetSemanticTokensWithEscapeCharactersAsync()
        {
            var markup =
@"{|caret:|}class C
{
    void M()
    {
        ...
        [Fact]
        public async Task TestGetSemanticTokensWithEscapeCharactersEOFAsync()
        {
            var markup =
@"{|caret:|}class C
{
    void M()
    {
        ...
        [Fact]
        public async Task TestGetSemanticTokensWithRegexAsync()
        {
            var markup =
