...
public class LspWorkspaceManagerTests : AbstractLanguageServerProtocolTests
{
    ...
    public async Task TestLspUsesWorkspaceInstanceOnChangesAsync()
    {
        ...
        await testLspServer.TestWorkspace.ChangeDocumentAsync(firstDocument.Id, SourceText.From($"Some more text{markupOne}", System.Text.Encoding.UTF8, SourceHashAlgorithm.Sha256));
    ...
    public async Task TestLspHasClosedDocumentChangesAsync()
    {
        ...
        await testLspServer.TestWorkspace.ChangeDocumentAsync(secondDocument.Id, SourceText.From("Two is now three!", System.Text.Encoding.UTF8, SourceHashAlgorithm.Sha256));
    ...
    public async Task TestLspFindsNewDocumentAsync()
    {
        ...
        var newSolution = testLspServer.TestWorkspace.CurrentSolution.AddDocument(newDocumentId, "NewDoc.cs", SourceText.From("New Doc", System.Text.Encoding.UTF8, SourceHashAlgorithm.Sha256), filePath: @"C:\NewDoc.cs");
