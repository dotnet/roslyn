...
@$"<Workspace>
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj1"">
        ...
        using var testLspServerOne = await TestLspServer.CreateAsync(testWorkspace, clientCapabilities: new());
        using var testLspServerTwo = await TestLspServer.CreateAsync(testWorkspace, clientCapabilities: new());
