...
#pragma warning restore CS0067
    ...
    public async Task<DynamicFileInfo?> GetDynamicFileInfoAsync(ProjectId projectId, string? projectFilePath, string filePath, CancellationToken cancellationToken)
    {
        ...
        var requestParams = new ProvideDynamicFileParams { RazorFiles = [ProtocolConversions.GetUriFromFilePath(filePath)] };
    ...
    {
        var notificationParams = new RemoveDynamicFileParams { RazorFiles = [ProtocolConversions.GetUriFromFilePath(filePath)] };
