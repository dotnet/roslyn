...
class G
{
    RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(null);
            ...
            comp.VerifyEmitDiagnostics(
                // (6,32): error LAMA0006: Argument 'null' is not valid for Metalama.Compiler intrinsic method 'Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(string)'.
                //     RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(null);
...
class G
{
    RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(""incorrect"");
            ...
            var comp = CreateCompilation(code, _references);
            comp.VerifyEmitDiagnostics(
                // (6,32): error LAMA0006: Argument '"incorrect"' is not valid for Metalama.Compiler intrinsic method 'Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(string)'.
                //     RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle("incorrect");
...
class G
{
    RuntimeMethodHandle M()
    {
        ...
        return Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(docId);
            ...
            var comp = CreateCompilation(code, _references);
            comp.VerifyEmitDiagnostics(
                // (9,16): error LAMA0006: Argument 'docId' is not valid for Metalama.Compiler intrinsic method 'Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(string)'.
                //         return Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(docId);
...
class G
{
    RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(""M:C.op_Explicit"");
            ...
            var comp = CreateCompilation(code, _references);
            comp.VerifyEmitDiagnostics(
                // (12,32): error LAMA0006: Argument '"M:C.op_Explicit"' is not valid for Metalama.Compiler intrinsic method 'Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle(string)'.
                //     RuntimeMethodHandle M() => Metalama.Compiler.Intrinsics.GetRuntimeMethodHandle("M:C.op_Explicit");
