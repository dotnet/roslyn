    ...
    internal sealed class MetalamaCompilerMessageProvider : CommonMessageProvider
    {
        ...
        public override string LoadMessage(int code, CultureInfo? language) =>
            (MetalamaErrorCode)code switch
            {
                ...
                ERR_InvalidLicenseOverall => "Cannot start Metalama: invalid license. To register a license key, see https://doc.metalama.net/deployment/register-license.",
                ERR_InvalidLicenseForProducingTransformedOutput => "Cannot generate the transformed code: this feature is not available in your license(s). To register a license key, see https://doc.metalama.net/deployment/register-license.",
                ERR_InvalidLicenseForSdk => "Cannot transform code using custom transformer '{0}': Metalama SDK is not available in your license(s). To register a license key, see https://doc.metalama.net/deployment/register-license.",
