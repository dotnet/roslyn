    ...
    internal sealed class MetalamaCompilerMessageProvider : CommonMessageProvider
    {
        ...
        public override string LoadMessage(int code, CultureInfo? language) =>
            (MetalamaErrorCode)code switch
            {
                ...
                ERR_InvalidLicenseOverall => "Cannot start Metalama: invalid license.",
                ERR_InvalidLicenseForProducingTransformedOutput => "Cannot generate the transformed code: this feature is not available in Metalama Essentials.", 
                ERR_ErrorInGeneratedCode => "{0} in code generated by {1}: {2}",
                ERR_HowToDiagnoseInvalidAspect => "The compilation has failed because of a bug in an aspect. To diagnose the issue, build the project with the option '-p:MetalamaEmitCompilerTransformedFiles=True' and inspect the transformed files in 'obj/Debug/.../metalama'.",
                ERR_HowToReportMetalamaBug => "The compilation has failed because of a bug in Metalama. Please report the issue to the support team. To facilitate troubleshooting, build the project with the option '-p:MetalamaEmitCompilerTransformedFiles=True', inspect the transformed files in 'obj/Debug/.../metalama'"
