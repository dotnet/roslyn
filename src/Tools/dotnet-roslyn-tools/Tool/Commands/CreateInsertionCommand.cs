...
internal static class CreateInsertionCommand
{
    private static readonly CreateInsertionCommandDefaultHandler s_handler = new();

    private static readonly Option<bool> s_dummyOption = new("--dummy")
    {
        Description = "Create a dummy insertion PR that can be updated later.",
    };

    private static readonly Option<string> s_componentBranchOption = CommonInsertionOptions.CreateComponentBranchOption(required: false);
    ...
    {
        var command = new Command("create-insertion", "Create a Visual Studio insertion PR from a component build.")
        {
            CommonInsertionOptions.InsertionNameOption,
            CommonInsertionOptions.VsBranchOption,
            s_componentBranchOption,
    ...
    private sealed class CreateInsertionCommandDefaultHandler : AsynchronousCommandLineAction
    {
        public override async Task<int> InvokeAsync(ParseResult parseResult, CancellationToken cancellationToken)
        {
            ...
            var dummy = parseResult.GetValue(s_dummyOption);
