...
namespace Microsoft.CodeAnalysis.ExternalAccess.OmniSharp
{
    internal static class OmniSharpRenamer
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var resolution = await Renamer.RenameSymbolsAsync(solution, ImmutableArray.Create((symbol, newName, options.ToRenameOptions())) , CodeActionOptions.DefaultProvider, nonConflictSymbolsKeys, cancellationToken).ConfigureAwait(false);
