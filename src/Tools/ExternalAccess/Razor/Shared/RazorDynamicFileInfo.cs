...
/// </summary>
internal abstract class RazorDynamicFileInfo
{
    protected RazorDynamicFileInfo(string filePath, SourceCodeKind sourceCodeKind, TextLoader textLoader, IRazorDocumentServiceProvider documentServiceProvider)
    {
        FilePath = filePath;
    ...
    /// <summary>
    /// return <see cref="IDocumentServiceProvider"/> for the contents it provides
    /// </summary>
    ...
    /// </summary>
    public abstract DocumentInfo ToUpdatedDocumentInfo(DocumentInfo existingDocumentInfo);
}
