...
#pragma warning disable CS0612 // Type or member is obsolete
            if (_legacyService != null)
            {
                ...
                return (info != null) ? new FSharpInlineRenameInfoLegacyWrapper(info) : null;
            }
#pragma warning restore CS0612 // Type or member is obsolete

            if (_service != null)
            {
                return await _service.GetRenameInfoAsync(document, position, cancellationToken).ConfigureAwait(false);
            }
