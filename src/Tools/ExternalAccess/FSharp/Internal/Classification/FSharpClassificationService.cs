...
namespace Microsoft.CodeAnalysis.ExternalAccess.FSharp.Internal.Classification
{
    ...
    internal class FSharpClassificationService : IClassificationService
    {
        ...
        public void AddSyntacticClassifications(HostWorkspaceServices services, SyntaxNode root, TextSpan textSpan, ArrayBuilder<ClassifiedSpan> result, CancellationToken cancellationToken)
        {
