...
internal sealed class CSharpMapCodeService : IMapCodeService
{
    ...
    {
        private const string CodeMapperDllName = "Microsoft.VisualStudio.Copilot.Chat.CodeMappers.CSharp, Version=0.2.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a";
