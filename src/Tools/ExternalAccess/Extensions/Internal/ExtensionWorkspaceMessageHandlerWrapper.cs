...
internal sealed class ExtensionWorkspaceMessageHandlerWrapper(object handler, Type customMessageHandlerInterface)
    : ExtensionHandlerWrapper<Solution>(handler, customMessageHandlerInterface)
{
