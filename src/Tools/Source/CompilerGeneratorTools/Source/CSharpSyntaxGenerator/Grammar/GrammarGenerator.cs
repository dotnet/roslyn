    ...
    internal static class GrammarGenerator
    {
        public static string Run(List<TreeType> types)
        {
            ...
            var majorRules = ImmutableArray.Create(
                "CompilationUnitSyntax", "MemberDeclarationSyntax", "TypeSyntax", "StatementSyntax", "ExpressionSyntax", "XmlNodeSyntax", "StructuredTriviaSyntax", "LiteralExpressionSyntax",
                "SyntaxToken", "IdentifierToken", "Utf8Suffix");
