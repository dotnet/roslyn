...
Friend Class GrammarGenerator
    ...
    Friend Function Run() As String
        ...
        _nameToProductions("PunctuationSyntax").Clear()
        ...
        _majorRules = ImmutableArray.Create(
            "CompilationUnitSyntax", "StatementSyntax", "ExpressionSyntax", "TypeSyntax", "NameSyntax", "XmlNodeSyntax", "StructuredTriviaSyntax", "Modifier", "SyntaxToken", "PunctuationSyntax")
