...
namespace BuildValidator
{
    internal class LocalSourceResolver
    {
        ...
        public SourceText ResolveSource(SourceTextInfo sourceTextInfo)
        {
            ...
            var sourceText = SourceText.From(fileStream, encoding: sourceTextInfo.SourceTextEncoding, checksumAlgorithm: sourceTextInfo.HashAglorithm, canBeEmbedded: false);
