...
namespace AnalyzerRunner
{
    public sealed class IncrementalAnalyzerRunner
    {
        ...
        public async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            {
                await using var persistentStorage = await _workspace.CurrentSolution.GetPersistentStorageAsync(checkBranchId: true, cancellationToken).ConfigureAwait(false);
