...
";
            ...
            var comp = CreateCompilation(source, parseOptions: TestOptions.RegularPreview.WithFeature(FeatureFlag.RunNullableAnalysis, "never"), targetFramework: TargetFramework.NetCoreApp);
            comp.VerifyDiagnostics();
