    ...
    public class DictionaryExpressionTests : CSharpTestBase
    {
            ...
            bool includeExtensionMethod)
        {
            ...
            string sourceB = """
                ...
                {
                    public static void Add<K, V>(this IDictionary<K, V> dictionary, KeyValuePair<K, V> kvp)
                    {
                ...
                verifier.VerifyIL("Program.Main", """
                    {
                        ...
                        IL_002a:  dup
                        IL_002b:  ldloc.0
                        IL_002c:  call       "void Extensions.Add<int, string>(System.Collections.Generic.IDictionary<int, string>, System.Collections.Generic.KeyValuePair<int, string>)"
                        ...
                        IL_004a:  ldloc.1
                        IL_004b:  ldloc.s    V_4
                        IL_004d:  call       "void Extensions.Add<int, string>(System.Collections.Generic.IDictionary<int, string>, System.Collections.Generic.KeyValuePair<int, string>)"
                        IL_0052:  ldloc.3
                        IL_0053:  ldc.i4.1
                        IL_0054:  add
                        IL_0055:  stloc.3
