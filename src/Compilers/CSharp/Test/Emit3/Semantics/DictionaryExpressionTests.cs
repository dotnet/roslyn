    ...
    public class DictionaryExpressionTests : CSharpTestBase
    {
        ...
        public void Arguments_01()
        {
            ...
            string expectedIL = """
                ...
                """;
            verifier.VerifyIL("Program.F1<K, V>(K, V)", expectedIL);
            verifier.VerifyIL("Program.F2<K, V>(K, V)", expectedIL);
        }

        [Fact]
        public void Arguments_02()
        {
            string source = """
                using System.Collections.Generic;
                class Program
            ...
            verifier.VerifyDiagnostics();
            verifier.VerifyIL("Program.F<K, V>(K, V)", """
                {
                  // Code size       16 (0x10)
                  .maxstack  4
                  IL_0000:  ldc.i4.2
