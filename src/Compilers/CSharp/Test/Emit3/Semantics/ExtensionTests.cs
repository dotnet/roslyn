...
""";
    ...
    {
        // The type parameters for the extension declaration are inferred only based on the receiver (not the arguments)
        var src = """
public class C
{
...
""";
    ...
    [Fact]
    public void Mixing_RemoveLowerPriorityMembers_01()
    {
        var source = """
42.M(43);
...
""";
    ...
    [Fact]
    public void Mixing_RemoveLowerPriorityMembers_02()
    {
        var source = """
42.M(43);
...
""";
        // PROTOTYPE ORPA should not look at the extension declaration as the "containing type", but rather the containing static class
        var comp = CreateCompilation([source, OverloadResolutionPriorityAttributeDefinition]);
        CompileAndVerify(comp, expectedOutput: "ran").VerifyDiagnostics();
    ...
    [Fact]
    public void Mixing_RemoveStaticInstanceMismatches_01()
    {
        var src = """
using N;
...
""";
    ...
    [Fact]
    public void Mixing_RemoveStaticInstanceMismatches_02()
    {
        var src = """
using N;
...
""";
    ...
    [Fact]
    public void Mixing_RemoveStaticInstanceMismatches_03()
    {
        var src = """
using N;
...
""";
    ...
    [Fact]
    public void Mixing_RemoveStaticInstanceMismatches_ColorColor_01()
    {
        var src = """
using N;
...
""";
    ...
    [Fact]
    public void Mixing_RemoveStaticInstanceMismatches_ColorColor_02()
    {
        var src = """
using N;
...
""";
    ...
    [Fact]
    public void Mixing_RemoveInaccessibleTypeArguments()
    {
        var src = """
int.M(new A.C());
