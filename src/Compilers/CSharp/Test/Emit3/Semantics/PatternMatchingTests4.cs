...
""";
            var comp = CreateCompilation(source);
            comp.VerifyDiagnostics(
                // (10,22): hidden CS9271: The pattern is redundant.
                //             >= 0 and < 10.0 => "Acceptable",
                Diagnostic(ErrorCode.HDN_RedundantPattern, "< 10.0").WithLocation(10, 22),
                // (11,26): hidden CS9271: The pattern is redundant.
                //             >= -40.0 and < 0 => "Low",
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyDiagnostics(
                // (11,13): hidden CS9271: The pattern is redundant.
                //             >= -40.0 and < 0 => "Low",
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">= -40.0").WithLocation(11, 13),
                // (12,13): hidden CS9271: The pattern is redundant.
                //             >= 0 and < 10.0 => "Acceptable",
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,19): hidden CS9271: The pattern is redundant.
                // _ = o is not A or B; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "B").WithLocation(2, 19),
                ...
                // (5,21): hidden CS9271: The pattern is redundant.
                // _ = o is (not A) or B; // 3
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (4,20): hidden CS9271: The pattern is redundant.
                // _ = o is not (A or Derived); // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "Derived").WithLocation(4, 20),
                // (7,15): hidden CS9271: The pattern is redundant.
                // _ = o is A or Derived; // 3
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,20): hidden CS9271: The pattern is redundant.
                // _ = o is not A or (B or C); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "B").WithLocation(2, 20),
                // (2,25): hidden CS9271: The pattern is redundant.
                // _ = o is not A or (B or C); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "C").WithLocation(2, 25),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     B or C => 43, // 3
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (3,22): hidden CS9271: The pattern is redundant.
                // _ = o is not null or string; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(3, 22),
                // (4,24): hidden CS9271: The pattern is redundant.
                // _ = o is (not null) or string; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(4, 24),
                // (5,31): hidden CS9271: The pattern is redundant.
                // _ = o is not null or (not not string); // 3
...
_ = s is null and not { Length: >0 }; // 2
_ = s is (not null) or { Length: >0 }; // 3
_ = s is not (null or { Length: >0 });
_ = s is null and not { Length: >0 }; // 4
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (3,32): hidden CS9271: The pattern is redundant.
                // _ = s is not null or { Length: >0 }; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(3, 32),
                // (3,32): hidden CS9271: The pattern is redundant.
                // _ = s is not null or { Length: >0 }; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(3, 32),
                // (4,33): hidden CS9271: The pattern is redundant.
                // _ = s is null and not { Length: >0 }; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(4, 33),
                // (4,33): hidden CS9271: The pattern is redundant.
                // _ = s is null and not { Length: >0 }; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(4, 33),
                // (5,34): hidden CS9271: The pattern is redundant.
                // _ = s is (not null) or { Length: >0 }; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(5, 34),
                // (5,34): hidden CS9271: The pattern is redundant.
                // _ = s is (not null) or { Length: >0 }; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, ">0").WithLocation(5, 34),
                // (7,33): hidden CS9271: The pattern is redundant.
                // _ = s is null and not { Length: >0 }; // 4
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,30): hidden CS9271: The pattern is redundant.
                // _ = s is { Length: not 42 or 43 }; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 30),
                // (6,25): hidden CS9271: The pattern is redundant.
                //     { Length: not 42 or 43 } => 42, // 2
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,29): hidden CS9271: The pattern is redundant.
                // _ = s is { Prop1: not 42 or 43, Prop2: not 44 or 45 }; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 29),
                // (2,50): hidden CS9271: The pattern is redundant.
                // _ = s is { Prop1: not 42 or 43, Prop2: not 44 or 45 }; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 50),
                // (6,24): hidden CS9271: The pattern is redundant.
                //     { Prop1: not 42 or 43, Prop2: not 44 or 45 } => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 24),
                // (6,45): hidden CS9271: The pattern is redundant.
                //     { Prop1: not 42 or 43, Prop2: not 44 or 45 } => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 45),
                // (12,29): hidden CS9271: The pattern is redundant.
                //     case { Prop1: not 42 or 43, Prop2: not 44 or 45 }: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 29),
                // (12,50): hidden CS9271: The pattern is redundant.
                //     case { Prop1: not 42 or 43, Prop2: not 44 or 45 }: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(12, 50));
        }
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,21): hidden CS9271: The pattern is redundant.
                // _ = s is (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }; // 1, 2, 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 21),
                // (2,35): hidden CS9271: The pattern is redundant.
                // _ = s is (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }; // 1, 2, 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 35),
                // (2,57): hidden CS9271: The pattern is redundant.
                // _ = s is (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }; // 1, 2, 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(2, 57),
                // (6,16): hidden CS9271: The pattern is redundant.
                //     (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 } => 42, // 4, 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 16),
                // (6,30): hidden CS9271: The pattern is redundant.
                //     (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 } => 42, // 4, 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 30),
                // (6,52): hidden CS9271: The pattern is redundant.
                //     (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 } => 42, // 4, 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(6, 52),
                // (12,21): hidden CS9271: The pattern is redundant.
                //     case (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }: break; // 7, 8, 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 21),
                // (12,35): hidden CS9271: The pattern is redundant.
                //     case (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }: break; // 7, 8, 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(12, 35),
                // (12,57): hidden CS9271: The pattern is redundant.
                //     case (not 42 or 43, not 44 or 45) { Prop: not 46 or 47 }: break; // 7, 8, 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(12, 57));
        }
...
""";
            var comp = CreateCompilation(source, targetFramework: TargetFramework.Net80);
            comp.VerifyEmitDiagnostics(
                // (2,24): hidden CS9271: The pattern is redundant.
                // _ = s is [..(not 42 or 43), not 44 or 45]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 24),
                // (2,39): hidden CS9271: The pattern is redundant.
                // _ = s is [..(not 42 or 43), not 44 or 45]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 39),
                // (3,21): hidden CS9271: The pattern is redundant.
                // _ = s is [not 42 or 43, ..(not 44 or 45)]; // , 
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 21),
                // (3,38): hidden CS9271: The pattern is redundant.
                // _ = s is [not 42 or 43, ..(not 44 or 45)]; // , 
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 38),
                // (7,19): hidden CS9271: The pattern is redundant.
                //     [..(not 42 or 43), not 44 or 45] => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(7, 19),
                // (7,34): hidden CS9271: The pattern is redundant.
                //     [..(not 42 or 43), not 44 or 45] => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(7, 34),
                // (13,24): hidden CS9271: The pattern is redundant.
                //     case [..(not 42 or 43), not 44 or 45]: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(13, 24),
                // (13,39): hidden CS9271: The pattern is redundant.
                //     case [..(not 42 or 43), not 44 or 45]: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(13, 39));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = s is [..(not 42 or 43), not 44 or 45]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 39),
                // (6,19): hidden CS9271: The pattern is redundant.
                //     [..(not 42 or 43), not 44 or 45] => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 19),
                // (6,34): hidden CS9271: The pattern is redundant.
                //     [..(not 42 or 43), not 44 or 45] => 42, // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 34),
                // (12,24): hidden CS9271: The pattern is redundant.
                //     case [..(not 42 or 43), not 44 or 45]: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 24),
                // (12,39): hidden CS9271: The pattern is redundant.
                //     case [..(not 42 or 43), not 44 or 45]: break; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(12, 39));
        }
...
""";
            var comp = CreateCompilation(source, targetFramework: TargetFramework.Net80);
            comp.VerifyEmitDiagnostics(
                // (3,33): hidden CS9271: The pattern is redundant.
                // _ = s is [..({ Prop1: not 42 or 43, Prop2: not 44 or 45 }), { Prop1: not 46 or 47, Prop2: not 48 or 49 }]; // 1, 2, 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 33),
                // (3,54): hidden CS9271: The pattern is redundant.
                // _ = s is [..({ Prop1: not 42 or 43, Prop2: not 44 or 45 }), { Prop1: not 46 or 47, Prop2: not 48 or 49 }]; // 1, 2, 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 54),
                // (3,80): hidden CS9271: The pattern is redundant.
                // _ = s is [..({ Prop1: not 42 or 43, Prop2: not 44 or 45 }), { Prop1: not 46 or 47, Prop2: not 48 or 49 }]; // 1, 2, 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(3, 80),
                // (3,101): hidden CS9271: The pattern is redundant.
                // _ = s is [..({ Prop1: not 42 or 43, Prop2: not 44 or 45 }), { Prop1: not 46 or 47, Prop2: not 48 or 49 }]; // 1, 2, 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "49").WithLocation(3, 101),
                // (5,30): hidden CS9271: The pattern is redundant.
                // _ = s is [{ Prop1: not 46 or 47, Prop2: not 48 or 49 }, ..({ Prop1: not 42 or 43, Prop2: not 44 or 45 })]; // 5, 6, 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(5, 30),
                // (5,51): hidden CS9271: The pattern is redundant.
                // _ = s is [{ Prop1: not 46 or 47, Prop2: not 48 or 49 }, ..({ Prop1: not 42 or 43, Prop2: not 44 or 45 })]; // 5, 6, 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "49").WithLocation(5, 51),
                // (5,79): hidden CS9271: The pattern is redundant.
                // _ = s is [{ Prop1: not 46 or 47, Prop2: not 48 or 49 }, ..({ Prop1: not 42 or 43, Prop2: not 44 or 45 })]; // 5, 6, 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 79),
                // (5,100): hidden CS9271: The pattern is redundant.
                // _ = s is [{ Prop1: not 46 or 47, Prop2: not 48 or 49 }, ..({ Prop1: not 42 or 43, Prop2: not 44 or 45 })]; // 5, 6, 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 100),
                // (7,47): hidden CS9271: The pattern is redundant.
                // _ = s is [{ Prop1: 0 }, ..({ Prop1: not 42 or 43 })]; // 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(7, 47));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = s is (not 42 or 43, not 44 or 45); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 35),
                // (3,26): hidden CS9271: The pattern is redundant.
                // _ = s is not (42 and not 43, 44 and not 45); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 26),
                // (3,41): hidden CS9271: The pattern is redundant.
                // _ = s is not (42 and not 43, 44 and not 45); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 41),
                // (4,26): hidden CS9271: The pattern is redundant.
                // _ = s is not (42 and not 43, _ and var x); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(4, 26),
                // (5,40): hidden CS9271: The pattern is redundant.
                // _ = s is not (_ and var x2, 42 and not 43); // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 40),
                // (11,16): hidden CS9271: The pattern is redundant.
                //     (not 42 or 43, not 44 or 45) => 42, // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 16),
                // (11,30): hidden CS9271: The pattern is redundant.
                //     (not 42 or 43, not 44 or 45) => 42, // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(11, 30),
                // (17,21): hidden CS9271: The pattern is redundant.
                //     case (not 42 or 43, not 44 or 45): break; // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(17, 21),
                // (17,35): hidden CS9271: The pattern is redundant.
                //     case (not 42 or 43, not 44 or 45): break; // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(17, 35));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,35): hidden CS9271: The pattern is redundant.
                // _ = i is not object or (not 42 or 43, not 44 or 45); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 35),
                // (2,49): hidden CS9271: The pattern is redundant.
                // _ = i is not object or (not 42 or 43, not 44 or 45); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 49),
                // (5,64): hidden CS9271: The pattern is redundant.
                // _ = o is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 64),
                // (5,78): hidden CS9271: The pattern is redundant.
                // _ = o is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 78),
                // (8,64): hidden CS9271: The pattern is redundant.
                // _ = c is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(8, 64),
                // (8,78): hidden CS9271: The pattern is redundant.
                // _ = c is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(8, 78),
                // (9,35): hidden CS9271: The pattern is redundant.
                // _ = c is not object or (not 42 or 43, not 44 or 45); // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(9, 35),
                // (9,49): hidden CS9271: The pattern is redundant.
                // _ = c is not object or (not 42 or 43, not 44 or 45); // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(9, 49),
                // (12,64): hidden CS9271: The pattern is redundant.
                // _ = s is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 64),
                // (12,78): hidden CS9271: The pattern is redundant.
                // _ = s is System.Runtime.CompilerServices.ITuple and (not 42 or 43, not 44 or 45); // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(12, 78),
                // (13,35): hidden CS9271: The pattern is redundant.
                // _ = s is not object or (not 42 or 43, not 44 or 45); // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(13, 35),
                // (13,49): hidden CS9271: The pattern is redundant.
                // _ = s is not object or (not 42 or 43, not 44 or 45); // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(13, 49));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (3,22): hidden CS9271: The pattern is redundant.
                // _ = i is not null or 0; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "0").WithLocation(3, 22),
                // (4,24): hidden CS9271: The pattern is redundant.
                // _ = i is (not null) or 0; // 2
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (3,27): hidden CS9271: The pattern is redundant.
                // _ = i is 0 or not null or 1; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "1").WithLocation(3, 27),
                // (9,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     1 => 43, // 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (3,22): hidden CS9271: The pattern is redundant.
                // _ = b is not null or false; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "false").WithLocation(3, 22),
                // (4,24): hidden CS9271: The pattern is redundant.
                // _ = b is (not null) or false; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "false").WithLocation(4, 24),
                // (5,22): hidden CS9271: The pattern is redundant.
                // _ = b is not null or true; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "true").WithLocation(5, 22),
                // (6,24): hidden CS9271: The pattern is redundant.
                // _ = b is (not null) or true; // 4
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,21): hidden CS9271: The pattern is redundant.
                // _ = o is not "A" or "B"; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""B""").WithLocation(2, 21),
                // (3,23): hidden CS9271: The pattern is redundant.
                // _ = o is (not "A") or "B"; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""B""").WithLocation(3, 23),
                // (9,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     "B" => 43, // 3
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is not "A" or "B" or "C"; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""B""").WithLocation(2, 21),
                // (2,28): hidden CS9271: The pattern is redundant.
                // _ = o is not "A" or "B" or "C"; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""C""").WithLocation(2, 28),
                // (3,23): hidden CS9271: The pattern is redundant.
                // _ = o is (not "A") or "B" or "C"; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""B""").WithLocation(3, 23),
                // (3,30): hidden CS9271: The pattern is redundant.
                // _ = o is (not "A") or "B" or "C"; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""C""").WithLocation(3, 30),
                // (9,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     "B" => 43, // 5
                Diagnostic(ErrorCode.ERR_SwitchArmSubsumed, @"""B""").WithLocation(9, 5),
                // (10,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,21): hidden CS9271: The pattern is redundant.
                // _ = o is not "A" or null; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "null").WithLocation(2, 21),
                // (3,23): hidden CS9271: The pattern is redundant.
                // _ = o is (not "A") or null; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "null").WithLocation(3, 23),
                // (9,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     null => 43, // 3
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,20): hidden CS9271: The pattern is redundant.
                // _ = o is not 42 or 43; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 20),
                // (3,22): hidden CS9271: The pattern is redundant.
                // _ = o is (not 42) or 43; // 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (3,21): hidden CS9271: The pattern is redundant.
                // _ = o is not 42L or string; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(3, 21),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     string => 43, // 2
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,40): hidden CS9271: The pattern is redundant.
                // _ = o is not string { Length: > 0 } or B; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "B").WithLocation(2, 40),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     B => 43, // 2
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,33): hidden CS9271: The pattern is redundant.
                // _ = o is not { Length: > 0 } or null; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "null").WithLocation(2, 33),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     null => 43, // 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,30): hidden CS9271: The pattern is redundant.
                // _ = o is not null or not not "1" or "2"; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""1""").WithLocation(2, 30),
                // (2,37): hidden CS9271: The pattern is redundant.
                // _ = o is not null or not not "1" or "2"; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, @"""2""").WithLocation(2, 37),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     not not "1" or "2" => 43, // 3
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,22): hidden CS9271: The pattern is redundant.
                // _ = e is not null or E.Zero; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "E.Zero").WithLocation(2, 22),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     E.Zero => 43, // 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,24): hidden CS9271: The pattern is redundant.
                // _ = e is not E.Zero or E.One; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "E.One").WithLocation(2, 24),
                // (8,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     E.One => 43, // 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (3,41): hidden CS9271: The pattern is redundant.
                // _ = s is not { Length: 0 } or { Length: 10 }; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "10").WithLocation(3, 41),
                // (9,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     { Length: 10 } => 43, // 2
                Diagnostic(ErrorCode.ERR_SwitchArmSubsumed, "{ Length: 10 }").WithLocation(9, 5),
                // (15,55): hidden CS9271: The pattern is redundant.
                // _ = s is not string { Length: 0 } or string { Length: 10 }; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "10").WithLocation(15, 55),
...
""";
        ...
        public void RedundantPattern_NotOr()
        {
            var source = """
object o = null;
_ = o is (not null or 42) or string; // 1, 2
_ = o is (not (null or 42)) or string; // 3
_ = o is (not null and not 42) or string; // 4
_ = o is (not (not null or 42)) or string; // 5
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is (not null or 42) or string; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "42").WithLocation(2, 23),
                // (2,30): hidden CS9271: The pattern is redundant.
                // _ = o is (not null or 42) or string; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(2, 30),
                // (3,32): hidden CS9271: The pattern is redundant.
                // _ = o is (not (null or 42)) or string; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(3, 32),
                // (4,35): hidden CS9271: The pattern is redundant.
                // _ = o is (not null and not 42) or string; // 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(4, 35),
                // (5,28): hidden CS9271: The pattern is redundant.
                // _ = o is (not (not null or 42)) or string; // 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "42").WithLocation(5, 28),
                // (6,24): hidden CS9271: The pattern is redundant.
                // _ = o is (null and not 42) or string; // 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "42").WithLocation(6, 24),
                // (11,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     string => 42, // 7
                Diagnostic(ErrorCode.ERR_SwitchArmSubsumed, "string").WithLocation(11, 5),
                ...
                // (28,22): hidden CS9271: The pattern is redundant.
                //     not (not null or 42) => 41, // 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "42").WithLocation(28, 22),
                // (34,18): hidden CS9271: The pattern is redundant.
                //     null and not 42 => 41, // 11
                Diagnostic(ErrorCode.HDN_RedundantPattern, "42").WithLocation(34, 18));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,37): hidden CS9271: The pattern is redundant.
                // _ = o is (not (not null and 42)) or string; // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(2, 37),
                // (3,28): hidden CS9271: The pattern is redundant.
                // _ = o is null or not 42 or string; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(3, 28),
                // (5,28): hidden CS9271: The pattern is redundant.
                // _ = o is null or not 42 or string; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(5, 28),
                // (7,24): hidden CS9271: The pattern is redundant.
                // _ = o is (not (int and int)) or string; // 4, 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "int").WithLocation(7, 24),
                // (7,33): hidden CS9271: The pattern is redundant.
                // _ = o is (not (int and int)) or string; // 4, 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(7, 33),
                // (8,24): hidden CS9271: The pattern is redundant.
                // _ = o is not ((int and int) or string); // 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "int").WithLocation(8, 24),
                // (10,23): hidden CS9271: The pattern is redundant.
                // _ = o is (not int) or string; // 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(10, 23),
                // (16,5): error CS8510: The pattern is unreachable. It has already been handled by a previous arm of the switch expression or it is impossible to match.
                //     string => 42, // 8
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (5,16): hidden CS9271: The pattern is redundant.
                //     not int or string => 42, // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "string").WithLocation(5, 16),
                // (12,19): hidden CS9271: The pattern is redundant.
                //     not string or int => 42, // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "int").WithLocation(12, 19));
        }
...
""";
            ...
            compilation.VerifyDiagnostics(
                // (5,29): hidden CS9271: The pattern is redundant.
                //         if (o is not (1 and int)) { } // 1
                ...
                // (11,24): hidden CS9271: The pattern is redundant.
                //         if (o is (C or Derived) and var x5) { } // 6
...
""";
            var compilation = CreateCompilation(source);
            compilation.VerifyDiagnostics(
                // (6,37): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) { } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 37),
                // (6,64): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) { } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 64),
                ...
                // (8,45): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: (42 or (not 43 or 44)) or 45 } or { Prop2: (46 or (not 44 or 45)) or 46 }) { } // 4, 5, 6, 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "44").WithLocation(8, 45),
                // (8,53): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: (42 or (not 43 or 44)) or 45 } or { Prop2: (46 or (not 44 or 45)) or 46 }) { } // 4, 5, 6, 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(8, 53),
                // (8,88): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: (42 or (not 43 or 44)) or 45 } or { Prop2: (46 or (not 44 or 45)) or 46 }) { } // 4, 5, 6, 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(8, 88),
                // (8,96): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: (42 or (not 43 or 44)) or 45 } or { Prop2: (46 or (not 44 or 45)) or 46 }) { } // 4, 5, 6, 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "46").WithLocation(8, 96),
                // (10,38): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) or { Prop3: not 46 or 47 }) { } // 8, 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(10, 38),
                // (10,65): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) or { Prop3: not 46 or 47 }) { } // 8, 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(10, 65),
                // (10,93): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) or { Prop3: not 46 or 47 }) { } // 8, 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(10, 93),
                // (11,38): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop0: not 42 or 43 } or ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 })) or { Prop3: not 46 or 47 }) { } // 11, 12, 13, 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 38),
                // (11,66): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop0: not 42 or 43 } or ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 })) or { Prop3: not 46 or 47 }) { } // 11, 12, 13, 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 66),
                // (11,93): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop0: not 42 or 43 } or ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 })) or { Prop3: not 46 or 47 }) { } // 11, 12, 13, 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(11, 93),
                // (11,122): hidden CS9271: The pattern is redundant.
                //         if (s is ({ Prop0: not 42 or 43 } or ({ Prop1: not 42 or 43 } or { Prop2: not 44 or 45 })) or { Prop3: not 46 or 47 }) { } // 11, 12, 13, 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(11, 122));
        }
...
""";
            var compilation = CreateCompilation(source);
            compilation.VerifyDiagnostics(
                // (5,46): hidden CS9271: The pattern is redundant.
                //         if (c is { PropA: { Prop0: not 42 or 43 } or { Prop1: not 44 or 45 } } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 46),
                // (5,73): hidden CS9271: The pattern is redundant.
                //         if (c is { PropA: { Prop0: not 42 or 43 } or { Prop1: not 44 or 45 } } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 73),
                // (6,46): hidden CS9271: The pattern is redundant.
                //               or { PropB: { Prop2: not 46 or 47 } or { Prop3: not 48 or 49 } }) { } // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "47").WithLocation(6, 46),
                // (6,73): hidden CS9271: The pattern is redundant.
                //               or { PropB: { Prop2: not 46 or 47 } or { Prop3: not 48 or 49 } }) { } // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "49").WithLocation(6, 73));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (3,19): hidden CS9271: The pattern is redundant.
                // _ = o is not A or B x2; // 2, 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "B x2").WithLocation(3, 19),
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (2,43): hidden CS9271: The pattern is redundant.
                // _ = o is not S (42 and not 43, 44 and not 45); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 43),
                // (3,23): hidden CS9271: The pattern is redundant.
                // _ = o is S (not 42 or 43, not 44 or 45); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 23),
                // (3,37): hidden CS9271: The pattern is redundant.
                // _ = o is S (not 42 or 43, not 44 or 45); // 3, 4
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,34): hidden CS9271: The pattern is redundant.
                // _ = s is not { Prop1: 42 and not 43, Prop2: 44 and not 45 }; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 34),
                // (2,56): hidden CS9271: The pattern is redundant.
                // _ = s is not { Prop1: 42 and not 43, Prop2: 44 and not 45 }; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 56),
                // (3,29): hidden CS9271: The pattern is redundant.
                // _ = s is { Prop1: not 42 or 43, Prop2: not 44 or 45 }; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 29),
                // (3,50): hidden CS9271: The pattern is redundant.
                // _ = s is { Prop1: not 42 or 43, Prop2: not 44 or 45 }; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 50));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = s is null or not { }; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "{ }").WithLocation(3, 22),
                // (4,27): hidden CS9271: The pattern is redundant.
                // _ = s is not ({ } and not null); // 3
                ...
                // (6,22): hidden CS9271: The pattern is redundant.
                // _ = s is not null or { }; // 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "{ }").WithLocation(6, 22),
                // (7,22): hidden CS9271: The pattern is redundant.
                // _ = s is not null or S { }; // 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "S { }").WithLocation(7, 22),
                // (8,23): hidden CS9271: The pattern is redundant.
                // _ = s is not S { } or null; // 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "null").WithLocation(8, 23),
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (4,28): hidden CS9271: The pattern is redundant.
                // _ = o is not S (42 and not 43, int x2); // 1
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(4, 28),
                // (5,36): hidden CS9271: The pattern is redundant.
                // _ = o is not S { Prop1: 42 and not 43, Prop2: _ and var x3 }; // 2, 3
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                // (2,33): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and (42 and not 43, 44 and not 45)); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 33),
                // (2,48): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and (42 and not 43, 44 and not 45)); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 48),
                // (3,33): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and (42 and not 43, _) and (_, 44 and not 45)); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 33),
                // (3,59): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and (42 and not 43, _) and (_, 44 and not 45)); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 59));
        }
...
_ = o is not (S and { } and { Prop2: 44 and not 45 }); // 5, 6
_ = o is not (S and { Prop1: 42 and not 43 } and { }); // 7, 8
...
""";
            var comp = CreateCompilation(source);
            comp.VerifyEmitDiagnostics(
                // (2,41): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43, Prop2: 44 and not 45 }); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 41),
                // (2,63): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43, Prop2: 44 and not 45 }); // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 63),
                // (3,41): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43 } and { Prop2: 44 and not 45 }); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 41),
                // (3,70): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43 } and { Prop2: 44 and not 45 }); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 70),
                // (4,21): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { } and { Prop2: 44 and not 45 }); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "{ }").WithLocation(4, 21),
                // (4,49): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { } and { Prop2: 44 and not 45 }); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(4, 49),
                // (5,41): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43 } and { }); // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 41),
                // (5,50): hidden CS9271: The pattern is redundant.
                // _ = o is not (S and { Prop1: 42 and not 43 } and { }); // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "{ }").WithLocation(5, 50));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (6,17): hidden CS9271: The pattern is redundant.
                // _ = c is C and (int, int); // 3, 4
                ...
                // (9,11): hidden CS9271: The pattern is redundant.
                // _ = c is (int, int); // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "int").WithLocation(9, 11),
                // (9,16): hidden CS9271: The pattern is redundant.
                // _ = c is (int, int); // 5, 6
...
""";
            var comp = CreateCompilation(source, targetFramework: TargetFramework.Net80);
            comp.VerifyEmitDiagnostics(
                // (2,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, 44 and not 45]; // 1, 2
                ...
                // _ = o is [not 42 or 43, not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 21),
                // (3,35): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 35));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is not [{ Prop: 42 and not 43 }, { Prop: 44 and not 45 }]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 34),
                // (2,59): hidden CS9271: The pattern is redundant.
                // _ = o is not [{ Prop: 42 and not 43 }, { Prop: 44 and not 45 }]; // 1, 2
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (5,31): hidden CS9271: The pattern is redundant.
                // _ = o is int[] and [not 42 or 43, not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 31),
                // (5,45): hidden CS9271: The pattern is redundant.
                // _ = o is int[] and [not 42 or 43, not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 45),
                // (6,27): hidden CS9271: The pattern is redundant.
                // _ = o is C and [not 42 or 43, not 44 or 45]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 27),
                // (6,41): warning CS9269: The pattern is redundant.
                // _ = o is C and [not 42 or 43, not 44 or 45]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 41),
                ...
                // _ = s is not object or [not 42 or 43, not 44 or 45]; // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 35),
                // (12,49): warning CS9269: The pattern is redundant.
                // _ = s is not object or [not 42 or 43, not 44 or 45]; // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(12, 49));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (3,53): hidden CS9271: The pattern is redundant.
                // _ = o is not ([42 and not 43, _] and [_, 44 and not 45]); // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 53));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is [not 42 or 43, not 44 or 45, ..]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 35),
                // (5,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, .., 44 and not 45]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 26),
                // (5,45): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, .., 44 and not 45]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 45),
                // (6,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, .., not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 21),
                // (6,39): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, .., not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 39),
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (4,38): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, ..(_ or _)]; // 5, 6, 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "_").WithLocation(4, 38),
                // (5,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, ..(_ and _)]; // 8, 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 26),
                // (7,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, ..var x]; // 11
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(7, 26),
                // (8,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, ..var y]; // 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(8, 21),
                // (10,36): hidden CS9271: The pattern is redundant.
                // _ = o is not [..var x2, 42 and not 43]; // 13
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(10, 36),
                // (11,31): hidden CS9271: The pattern is redundant.
                // _ = o is [..var y2, not 42 or 43]; // 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 31),
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (4,24): hidden CS9271: The pattern is redundant.
                // _ = s is [..[not 42 or 43]]; // 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(4, 24),
                // (5,29): hidden CS9271: The pattern is redundant.
                // _ = s is not [..[42 and not 43]]; // 3
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 29),
                // (6,29): hidden CS9271: The pattern is redundant.
                // _ = s is not [..[42 and not 43]]; // 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 29),
                // (8,29): hidden CS9271: The pattern is redundant.
                // _ = s is not [..[42 and not 43, ..var x]]; // 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(8, 29),
                // (9,24): hidden CS9271: The pattern is redundant.
                // _ = s is [..[not 42 or 43]]; // 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(9, 24),
                // (11,29): hidden CS9271: The pattern is redundant.
                // _ = s is not [..[42 and not 43]]; // 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 29),
                // (12,25): hidden CS9271: The pattern is redundant.
                // _ = s is [.. [not 42 or 43]]; // 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 25));
        }
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is [not 42 or 43, var y]; // 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 21),
                // (8,34): hidden CS9271: The pattern is redundant.
                // _ = o is not [var x2, 42 and not 43]; // 5
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(8, 34),
                // (9,29): hidden CS9271: The pattern is redundant.
                // _ = o is [var y2, not 42 or 43]; // 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(9, 29),
                // (11,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, _ and var x3]; // 7, 8
                ...
                // _ = o is [not 42 or 43, _ and var y3]; // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 21),
                // (14,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, var x4 and _]; // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(14, 26),
                // (15,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, var y4 and _]; // 13, 14
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(15, 21),
                // (17,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, _ and int y5]; // 15, 16
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(17, 21),
                // (18,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, var y6]; // 17
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(18, 21),
                // (19,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, int y7]; // 18
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(19, 21),
                // (21,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, int and var y8]; // 19, 20
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(21, 26),
                // (21,30): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, int and var y8]; // 19, 20
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // _ = o is not [42 and not 43, _, ..44 and not 45]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 26),
                // (2,46): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, _, ..44 and not 45]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 46),
                // (3,21): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, _, ..not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 21),
                // (3,40): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, _, ..not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 40),
                // (5,26): hidden CS9271: The pattern is redundant.
                // _ = o is not [42 and not 43, var x, ..44 and not 45]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 26),
                // (5,50): hidden CS9271: The pattern is redundant.
                ...
                // _ = o is [not 42 or 43, var y, ..not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 21),
                // (6,44): hidden CS9271: The pattern is redundant.
                // _ = o is [not 42 or 43, var y, ..not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 44));
        }
...
""";
            var comp = CreateCompilation(source, targetFramework: TargetFramework.Net80);
            comp.VerifyEmitDiagnostics(
                // (2,27): hidden CS9271: The pattern is redundant.
                // _ = o is C and [not 42 or 43, ..(not 44 or 45)]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(2, 27),
                // (2,44): hidden CS9271: The pattern is redundant.
                // _ = o is C and [not 42 or 43, ..(not 44 or 45)]; // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(2, 44),
                // (3,31): hidden CS9271: The pattern is redundant.
                // _ = o is C and [..(42 and not 43), not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(3, 31),
                // (3,46): hidden CS9271: The pattern is redundant.
                // _ = o is C and [..(42 and not 43), not 44 or 45]; // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(3, 46),
                // (6,35): hidden CS9271: The pattern is redundant.
                // _ = c is not object or [not 42 or 43, ..(not 44 or 45)]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 35),
                // (6,52): hidden CS9271: The pattern is redundant.
                // _ = c is not object or [not 42 or 43, ..(not 44 or 45)]; // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 52),
                // (7,39): hidden CS9271: The pattern is redundant.
                // _ = c is not object or [..(42 and not 43), not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(7, 39),
                // (7,54): hidden CS9271: The pattern is redundant.
                // _ = c is not object or [..(42 and not 43), not 44 or 45]; // 7, 8
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(7, 54),
                // (10,35): hidden CS9271: The pattern is redundant.
                // _ = s is not object or [not 42 or 43, ..(44 and not 45)]; // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(10, 35),
                // (10,53): hidden CS9271: The pattern is redundant.
                // _ = s is not object or [not 42 or 43, ..(44 and not 45)]; // 9, 10
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(10, 53),
                // (11,38): hidden CS9271: The pattern is redundant.
                // _ = s is not object or [..(not 42 or 43), 44 and not 45]; // 11, 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 38),
                // (11,54): hidden CS9271: The pattern is redundant.
                // _ = s is not object or [..(not 42 or 43), 44 and not 45]; // 11, 12
...
""";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // (5,25): hidden CS9271: The pattern is redundant.
                // _ = i is not (1 or 2 or 1); // 3
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/75506")]
        public void RedundantPattern_NotIntInt()
        {
            var source = """
...
class C
{
    void M(S s, System.Runtime.CompilerServices.ITuple t, int o)
    {
        ...
        if (t is (not 42 or 43, not 44 or 45)) { } // 22, 23
        if (t is (42 and not 43, 44 and not 45)) { } // 24, 25
        if (t is (not 42 or 43, not 44 or 45) and (var x8, var x9)) { } // 26, 27

        if (o is (not 42 or 43) and var x10) { } // 28
    }
}
...
""";
            ...
            compilation.VerifyDiagnostics(
                // (5,38): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: 42 and not 43 } or { Prop2: 44 and not 45 }) { } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(5, 38),
                // (5,66): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: 42 and not 43 } or { Prop2: 44 and not 45 }) { } // 1, 2
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(5, 66),
                // (6,37): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } and { Prop2: not 44 or 45 }) { } // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(6, 37),
                // (6,65): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } and { Prop2: not 44 or 45 }) { } // 3, 4
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(6, 65),
                // (7,37): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) { } // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(7, 37),
                // (7,64): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: not 42 or 43 } or { Prop2: not 44 or 45 }) { } // 5, 6
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(7, 64),
                // (8,38): hidden CS9271: The pattern is redundant.
                //         if (s is { Prop1: (not 42 or 43) and var x1 }) { } // 7
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(8, 38),
                // (10,29): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, not 44 or 45)) { } // 8, 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(10, 29),
                // (10,43): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, not 44 or 45)) { } // 8, 9
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(10, 43),
                // (11,30): hidden CS9271: The pattern is redundant.
                //         if (s is (42 and not 43, 44 and not 45)) { } // 10, 11
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(11, 30),
                // (11,45): hidden CS9271: The pattern is redundant.
                //         if (s is (42 and not 43, 44 and not 45)) { } // 10, 11
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(11, 45),
                // (12,29): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, _) and var (x2, x3)) { } // 12
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(12, 29),
                // (13,29): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, _) and (_, _)) { } // 13
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(13, 29),
                // (14,29): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, not 44 or 45) and (var x4, var x5)) { } // 14, 15
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(14, 29),
                // (14,43): hidden CS9271: The pattern is redundant.
                //         if (s is (not 42 or 43, not 44 or 45) and (var x4, var x5)) { } // 14, 15
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(14, 43),
                // (16,29): hidden CS9271: The pattern is redundant.
                //         if (s is [not 42 or 43, not 44 or 45]) { } // 16, 17
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(16, 29),
                // (16,43): hidden CS9271: The pattern is redundant.
                //         if (s is [not 42 or 43, not 44 or 45]) { } // 16, 17
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(16, 43),
                // (17,30): hidden CS9271: The pattern is redundant.
                //         if (s is [42 and not 43, 44 and not 45]) { } // 18, 19
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(17, 30),
                // (17,45): hidden CS9271: The pattern is redundant.
                //         if (s is [42 and not 43, 44 and not 45]) { } // 18, 19
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(17, 45),
                // (18,29): hidden CS9271: The pattern is redundant.
                //         if (s is [not 42 or 43, not 44 or 45] and [var x6, var x7]) { } // 20, 21
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(18, 29),
                // (18,43): hidden CS9271: The pattern is redundant.
                //         if (s is [not 42 or 43, not 44 or 45] and [var x6, var x7]) { } // 20, 21
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(18, 43),
                // (20,29): hidden CS9271: The pattern is redundant.
                //         if (t is (not 42 or 43, not 44 or 45)) { } // 22, 23
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(20, 29),
                // (20,43): hidden CS9271: The pattern is redundant.
                //         if (t is (not 42 or 43, not 44 or 45)) { } // 22, 23
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(20, 43),
                // (21,30): hidden CS9271: The pattern is redundant.
                //         if (t is (42 and not 43, 44 and not 45)) { } // 24, 25
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(21, 30),
                // (21,45): hidden CS9271: The pattern is redundant.
                //         if (t is (42 and not 43, 44 and not 45)) { } // 24, 25
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(21, 45),
                // (22,29): hidden CS9271: The pattern is redundant.
                //         if (t is (not 42 or 43, not 44 or 45) and (var x8, var x9)) { } // 26, 27
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(22, 29),
                // (22,43): hidden CS9271: The pattern is redundant.
                //         if (t is (not 42 or 43, not 44 or 45) and (var x8, var x9)) { } // 26, 27
                Diagnostic(ErrorCode.HDN_RedundantPattern, "45").WithLocation(22, 43),
                // (24,29): hidden CS9271: The pattern is redundant.
                //         if (o is (not 42 or 43) and var x10) { } // 28
                Diagnostic(ErrorCode.HDN_RedundantPattern, "43").WithLocation(24, 29));
        }
