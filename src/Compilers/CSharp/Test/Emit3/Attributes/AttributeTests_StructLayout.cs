    ...
    public int y;
        ...
        public void ExtendedLayoutAttribute_OtherLayoutKind_Errors()
        {
            ...
            CreateCompilation(
                ...
                targetFramework: TargetFramework.Empty)
            .VerifyDiagnostics(
                // (5,8): error CS9317: Use of 'StructLayoutAttribute' and 'ExtendedLayoutAttribute' on the same type is not allowed.
                // struct C
                Diagnostic(ErrorCode.ERR_StructLayoutAndExtendedLayout, "C").WithLocation(5, 8),
                // (12,8): error CS9317: Use of 'StructLayoutAttribute' and 'ExtendedLayoutAttribute' on the same type is not allowed.
                // struct D
