    ...
    public int y;
        ...
        public void ExtendedLayoutAttribute_OtherLayoutKind_Errors()
        {
            ...
            CreateCompilation(
                ...
                targetFramework: TargetFramework.Empty)
            .VerifyDiagnostics(
                // (5,8): error CS9339: Use of 'StructLayoutAttribute' and 'ExtendedLayoutAttribute' on the same type is not allowed.
                // struct C
                Diagnostic(ErrorCode.ERR_StructLayoutAndExtendedLayout, "C").WithLocation(5, 8),
                // (12,8): error CS9339: Use of 'StructLayoutAttribute' and 'ExtendedLayoutAttribute' on the same type is not allowed.
                // struct D
        ...
        public void ExtendedLayout_OtherAssemblyDefinition_Fails()
        {
            ...
            CreateCompilation([source, ExtendedLayoutAttribute]).VerifyDiagnostics(
                // (2,2): error CS9340: The System.Runtime.InteropServices.ExtendedLayoutAttribute must be defined in the core assembly.
                // [ExtendedLayout(ExtendedLayoutKind.CStruct)]
