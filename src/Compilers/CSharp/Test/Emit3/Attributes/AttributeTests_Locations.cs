...
";
            CreateCompilation(source).VerifyDiagnostics(
                // (25,9): warning CS9265: The 'set' accessor of property 'C.Goo' should use 'field' because the other accessor is using it.
                //         set { }
...
";
            CreateCompilation(source).VerifyDiagnostics(
                // (11,9): warning CS9265: The 'get' accessor of property 'C.Goo' should use 'field' because the other accessor is using it.
                //         get { return 0; }
