...
public sealed class UnsafeEvolutionTests : CompilingTestBase
{
    ...
    public void Member_CollectionBuilder_Create()
    {
        CompileAndVerifyUnsafe(
            ...
            [
                ...
                // (3,15): error CS9362: 'C.Create(ReadOnlySpan<int>)' must be used in an unsafe context because it is marked as 'unsafe'
                // static void M(params C c) { }
                ...
                // (13,23): error CS9362: 'C.Create(ReadOnlySpan<int>)' must be used in an unsafe context because it is marked as 'unsafe'
                // static unsafe void M3(params C c) { }
    ...
    public void Member_CollectionConstructor()
    {
        CompileAndVerifyUnsafe(
            ...
            [
                ...
                // (3,16): error CS9362: 'C.C()' must be used in an unsafe context because it is marked as 'unsafe'
                // static void M1(params C c) { }
                ...
                // M3(1, 2, 3);
                Diagnostic(ErrorCode.ERR_UnsafeMemberOperation, "M3(1, 2, 3)").WithArguments("M3(params C)").WithLocation(12, 1),
                // (13,23): error CS9362: 'C.C()' must be used in an unsafe context because it is marked as 'unsafe'
                // static unsafe void M3(params C c) { }
    ...
    public void Member_CollectionAddMethod()
    {
        CompileAndVerifyUnsafe(
            ...
            [
                ...
                // (6,16): error CS9362: 'C.Add(int)' must be used in an unsafe context because it is marked as 'unsafe'
                // static void M1(params C c) { }
                ...
                // (19,23): error CS9362: 'C.Add(int)' must be used in an unsafe context because it is marked as 'unsafe'
                // static unsafe void M3(params C c) { }
    ...
    public void SafeModifier_Declarations_Interface(bool allowUnsafe)
    {
        ...
        CreateCompilation(source,
            ...
            //     safe event System.Action E;
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "safe").WithLocation(5, 5),
            // (6,18): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     int A { safe get; set; }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "get").WithLocation(6, 18),
    ...
    public void SafeModifier_Declarations_SafeOnly(bool allowUnsafe, bool updatedRules)
    {
        ...
        CreateCompilation(source, options: TestOptions.ReleaseDll.WithAllowUnsafe(allowUnsafe).WithUpdatedMemorySafetyRules(updatedRules)).VerifyDiagnostics(
            ...
            //     safe public int P1 { get; set; }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "safe").WithLocation(5, 5),
            // (6,5): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     safe public int this[int i] { get => i; set { } }
            ...
            // (21,26): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     public int P2 { safe get; set; }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "get").WithLocation(21, 26),
            // (22,41): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     public string this[string s] { safe get => s; set { } }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "get").WithLocation(22, 41),
    ...
    public void SafeModifier_Extern_SafeUnsafe(bool updatedRules)
    {
        ...
        CreateCompilation(source, options: TestOptions.UnsafeReleaseDll.WithUpdatedMemorySafetyRules(updatedRules)).VerifyDiagnostics(
            ...
            //     safe unsafe public extern int P1 { get; set; }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "safe").WithLocation(5, 5),
            // (6,45): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     public safe extern int P2 { safe unsafe get; set; }
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "get").WithLocation(6, 45),
            // (7,5): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
            //     safe unsafe public static extern event System.Action E1;
            Diagnostic(ErrorCode.ERR_SafeModifierUnsupportedTarget, "safe").WithLocation(7, 5),
            // (8,5): error CS9388: The 'safe' modifier may only be used on extern members that are not marked 'unsafe'.
