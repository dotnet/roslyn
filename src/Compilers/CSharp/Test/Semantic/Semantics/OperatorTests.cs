...
IBinaryOperatorExpression (BinaryOperatorKind.Or) ([0] OperationKind.BinaryOperatorExpression, Type: TestEnum, Constant: 6) (Syntax: 'TestEnum.Fi ... .Visibility')
  Left: 
    IFieldReferenceExpression: TestEnum.FilePath (Static) ([0] OperationKind.FieldReferenceExpression, Type: TestEnum, Constant: 2) (Syntax: 'TestEnum.FilePath')
      Instance Receiver: 
        null
  Right: 
    IFieldReferenceExpression: TestEnum.Visibility (Static) ([1] OperationKind.FieldReferenceExpression, Type: TestEnum, Constant: 4) (Syntax: 'TestEnum.Visibility')
      Instance Receiver: 
        null
";
...
";
            string expectedOperationTree = @"
IBlockStatement (2 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IIfStatement ([0] OperationKind.IfStatement) (Syntax: 'if (zero) ... Write('b');')
    Condition: 
      IUnaryOperatorExpression (UnaryOperatorKind.True) (OperatorMethod: System.Boolean S.op_True(S s)) ([0] OperationKind.UnaryOperatorExpression, Type: System.Boolean, IsImplicit) (Syntax: 'zero')
        Operand: 
          IParameterReferenceExpression: zero ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'zero')
    IfTrue: 
      IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'Console.Write('a');')
        Expression: 
          IInvocationExpression (void System.Console.Write(System.Char value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write('a')')
            Instance Receiver: 
              null
            Arguments(1):
                IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: ''a'')
                  ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.Char, Constant: a) (Syntax: ''a'')
                  InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                  OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
    IfFalse: 
      IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'Console.Write('b');')
        Expression: 
          IInvocationExpression (void System.Console.Write(System.Char value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write('b')')
            Instance Receiver: 
              null
            Arguments(1):
                IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: ''b'')
                  ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.Char, Constant: b) (Syntax: ''b'')
                  InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                  OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'Console.Wri ... 'g' : 'h');')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Char value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Wri ...  'g' : 'h')')
        Instance Receiver: 
          null
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'one ? 'g' : 'h'')
              IConditionalExpression ([0] OperationKind.ConditionalExpression, Type: System.Char) (Syntax: 'one ? 'g' : 'h'')
                Condition: 
                  IUnaryOperatorExpression (UnaryOperatorKind.True) (OperatorMethod: System.Boolean S.op_True(S s)) ([0] OperationKind.UnaryOperatorExpression, Type: System.Boolean, IsImplicit) (Syntax: 'one')
                    Operand: 
                      IParameterReferenceExpression: one ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'one')
                WhenTrue: 
                  ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Char, Constant: g) (Syntax: ''g'')
                WhenFalse: 
                  ILiteralExpression ([2] OperationKind.LiteralExpression, Type: System.Char, Constant: h) (Syntax: ''h'')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
";
            var expectedDiagnostics = DiagnosticDescription.None;
...
";
            string expectedOperationTree = @"
IBlockStatement (5 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(+a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(+a)')
        Instance Receiver: 
          null
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '+a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '+a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IUnaryOperatorExpression (UnaryOperatorKind.Plus) (OperatorMethod: S S.op_UnaryPlus(S x)) ([0] OperationKind.UnaryOperatorExpression, Type: S) (Syntax: '+a')
                    Operand: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(-a);')
    Expression: 
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '-a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '-a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IUnaryOperatorExpression (UnaryOperatorKind.Minus) (OperatorMethod: S S.op_UnaryNegation(S x)) ([0] OperationKind.UnaryOperatorExpression, Type: S) (Syntax: '-a')
                    Operand: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(~a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(~a)')
        Instance Receiver: 
          null
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '~a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '~a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IUnaryOperatorExpression (UnaryOperatorKind.BitwiseNegation) (OperatorMethod: S S.op_OnesComplement(S x)) ([0] OperationKind.UnaryOperatorExpression, Type: S) (Syntax: '~a')
                    Operand: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(!a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(!a)')
        Instance Receiver: 
          null
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '!a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '!a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IUnaryOperatorExpression (UnaryOperatorKind.Not) (OperatorMethod: S S.op_LogicalNot(S x)) ([0] OperationKind.UnaryOperatorExpression, Type: S) (Syntax: '!a')
                    Operand: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([4] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(+~!-a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(+~!-a)')
        Instance Receiver: 
          null
...
";
            string expectedOperationTree = @"
IBlockStatement (4 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(++a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(++a)')
        Instance Receiver: 
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '++a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '++a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IIncrementOrDecrementExpression (Prefix) (OperatorMethod: S S.op_Increment(S x)) ([0] OperationKind.IncrementExpression, Type: S) (Syntax: '++a')
                    Target: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a++')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: 'a++')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IIncrementOrDecrementExpression (Postfix) (OperatorMethod: S S.op_Increment(S x)) ([0] OperationKind.IncrementExpression, Type: S) (Syntax: 'a++')
                    Target: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '--a')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: '--a')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IIncrementOrDecrementExpression (Prefix) (OperatorMethod: S S.op_Decrement(S x)) ([0] OperationKind.DecrementExpression, Type: S) (Syntax: '--a')
                    Target: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a--')
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Object, IsImplicit) (Syntax: 'a--')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IIncrementOrDecrementExpression (Postfix) (OperatorMethod: S S.op_Decrement(S x)) ([0] OperationKind.DecrementExpression, Type: S) (Syntax: 'a--')
                    Target: 
                      IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
...
";
            string expectedOperationTree = @"
IBlockStatement (1 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IBlockStatement (4 statements) ([0] OperationKind.BlockStatement) (Syntax: '{ ... }')
    IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(++a);')
      Expression: 
        IInvocationExpression (void System.Console.Write(System.Object value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(++a)')
          Instance Receiver: 
...
IBlockStatement (4 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(++a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(++a)')
        Instance Receiver: 
          null
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '++a')
              IIncrementOrDecrementExpression (Prefix) ([0] OperationKind.IncrementExpression, Type: System.Int32) (Syntax: '++a')
                Target: 
  ...
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(a++);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(a++)')
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a++')
              IIncrementOrDecrementExpression (Postfix) ([0] OperationKind.IncrementExpression, Type: System.Int32) (Syntax: 'a++')
                Target: 
                  IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(--a);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(--a)')
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '--a')
              IIncrementOrDecrementExpression (Prefix) ([0] OperationKind.DecrementExpression, Type: System.Int32) (Syntax: '--a')
                Target: 
                  IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
  IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(a--);')
    Expression: 
      IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(a--)')
        ...
        Arguments(1):
            IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a--')
              IIncrementOrDecrementExpression (Postfix) ([0] OperationKind.DecrementExpression, Type: System.Int32) (Syntax: 'a--')
                Target: 
                  IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
    ...
    IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(++a);')
      Expression: 
        IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(++a)')
          ...
          Arguments(1):
              IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '++a')
                IIncrementOrDecrementExpression (Prefix, Checked) ([0] OperationKind.IncrementExpression, Type: System.Int32) (Syntax: '++a')
                  Target: 
                    IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
                InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
    IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(a++);')
      Expression: 
        IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(a++)')
          ...
          Arguments(1):
              IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a++')
                IIncrementOrDecrementExpression (Postfix, Checked) ([0] OperationKind.IncrementExpression, Type: System.Int32) (Syntax: 'a++')
                  Target: 
                    IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
                InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
    IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(--a);')
      Expression: 
        IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(--a)')
          ...
          Arguments(1):
              IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: '--a')
                IIncrementOrDecrementExpression (Prefix, Checked) ([0] OperationKind.DecrementExpression, Type: System.Int32) (Syntax: '--a')
                  Target: 
                    IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
                InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
    IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'Console.Write(a--);')
      Expression: 
        IInvocationExpression (void System.Console.Write(System.Int32 value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.Write(a--)')
          ...
          Arguments(1):
              IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 'a--')
                IIncrementOrDecrementExpression (Postfix, Checked) ([0] OperationKind.DecrementExpression, Type: System.Int32) (Syntax: 'a--')
                  Target: 
                    IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
                InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
...
";
            string expectedOperationTree = @"
IBinaryOperatorExpression (BinaryOperatorKind.Or) (OperatorMethod: S S.op_BitwiseOr(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: '(a >> 10) + ... m <= o >= p')
  Left: 
    IBinaryOperatorExpression (BinaryOperatorKind.And) (OperatorMethod: S S.op_BitwiseAnd(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: '(a >> 10) + ... / e % f & g')
      Left: 
        IBinaryOperatorExpression (BinaryOperatorKind.Subtract) (OperatorMethod: S S.op_Subtraction(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: '(a >> 10) + ... * d / e % f')
          Left: 
            IBinaryOperatorExpression (BinaryOperatorKind.Add) (OperatorMethod: S S.op_Addition(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: '(a >> 10) + (b << 20)')
              Left: 
                IBinaryOperatorExpression (BinaryOperatorKind.RightShift) (OperatorMethod: S S.op_RightShift(S x, System.Int32 y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'a >> 10')
                  Left: 
                    ILocalReferenceExpression: a ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'a')
                  Right: 
                    ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 10) (Syntax: '10')
              Right: 
                IBinaryOperatorExpression (BinaryOperatorKind.LeftShift) (OperatorMethod: S S.op_LeftShift(S x, System.Int32 y)) ([1] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'b << 20')
                  Left: 
                    ILocalReferenceExpression: b ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'b')
                  Right: 
                    ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 20) (Syntax: '20')
          Right: 
            IBinaryOperatorExpression (BinaryOperatorKind.Remainder) (OperatorMethod: S S.op_Modulus(S x, S y)) ([1] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'c * d / e % f')
              Left: 
                IBinaryOperatorExpression (BinaryOperatorKind.Divide) (OperatorMethod: S S.op_Division(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'c * d / e')
                  Left: 
                    IBinaryOperatorExpression (BinaryOperatorKind.Multiply) (OperatorMethod: S S.op_Multiply(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'c * d')
                      Left: 
                        ILocalReferenceExpression: c ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'c')
                      Right: 
                        ILocalReferenceExpression: d ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'd')
                  Right: 
                    ILocalReferenceExpression: e ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'e')
              Right: 
                ILocalReferenceExpression: f ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'f')
      Right: 
        ILocalReferenceExpression: g ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'g')
  Right: 
    IBinaryOperatorExpression (BinaryOperatorKind.ExclusiveOr) (OperatorMethod: S S.op_ExclusiveOr(S x, S y)) ([1] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'h ^ i == j  ... m <= o >= p')
      Left: 
        ILocalReferenceExpression: h ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'h')
      Right: 
        IBinaryOperatorExpression (BinaryOperatorKind.NotEquals) (OperatorMethod: S S.op_Inequality(S x, S y)) ([1] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'i == j != k ... m <= o >= p')
          Left: 
            IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: S S.op_Equality(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'i == j')
              Left: 
                ILocalReferenceExpression: i ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'i')
              Right: 
                ILocalReferenceExpression: j ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'j')
          Right: 
            IBinaryOperatorExpression (BinaryOperatorKind.GreaterThanOrEqual) (OperatorMethod: S S.op_GreaterThanOrEqual(S x, S y)) ([1] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'k < l > m <= o >= p')
              Left: 
                IBinaryOperatorExpression (BinaryOperatorKind.LessThanOrEqual) (OperatorMethod: S S.op_LessThanOrEqual(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'k < l > m <= o')
                  Left: 
                    IBinaryOperatorExpression (BinaryOperatorKind.GreaterThan) (OperatorMethod: S S.op_GreaterThan(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'k < l > m')
                      Left: 
                        IBinaryOperatorExpression (BinaryOperatorKind.LessThan) (OperatorMethod: S S.op_LessThan(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: S) (Syntax: 'k < l')
                          Left: 
                            ILocalReferenceExpression: k ([0] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'k')
                          Right: 
                            ILocalReferenceExpression: l ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'l')
                      Right: 
                        ILocalReferenceExpression: m ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'm')
                  Right: 
                    ILocalReferenceExpression: o ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'o')
              Right: 
                ILocalReferenceExpression: p ([1] OperationKind.LocalReferenceExpression, Type: S) (Syntax: 'p')
";
...
";
            string expectedOperationTree = @"
IBinaryOperatorExpression (BinaryOperatorKind.Add) ([0] OperationKind.BinaryOperatorExpression, Type: ?, IsInvalid) (Syntax: 'new C() + new B()')
  Left: 
    IObjectCreationExpression (Constructor: C..ctor()) ([0] OperationKind.ObjectCreationExpression, Type: C, IsInvalid) (Syntax: 'new C()')
      Arguments(0)
      Initializer: 
        null
  Right: 
    IObjectCreationExpression (Constructor: B..ctor()) ([1] OperationKind.ObjectCreationExpression, Type: B, IsInvalid) (Syntax: 'new B()')
      Arguments(0)
      Initializer: 
        null
";
...
";
            string expectedOperationTree = @"
IBinaryOperatorExpression (BinaryOperatorKind.Add) (OperatorMethod: System.Int32 D<System.Object>.C.op_Addition(D<System.Object>.C x, D<System.Object>.C y)) ([0] OperationKind.BinaryOperatorExpression, Type: System.Int32) (Syntax: 'x + y')
  Left: 
    ILocalReferenceExpression: x ([0] OperationKind.LocalReferenceExpression, Type: D<System.Object>.C) (Syntax: 'x')
  Right: 
    IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: D<System.Object>.C, IsImplicit) (Syntax: 'y')
      Conversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
      Operand: 
        ILocalReferenceExpression: y ([0] OperationKind.LocalReferenceExpression, Type: D<dynamic>.C) (Syntax: 'y')
";
...
";
            string expectedOperationTree = @"
IBinaryOperatorExpression (BinaryOperatorKind.Add) ([0] OperationKind.BinaryOperatorExpression, Type: ?, IsInvalid) (Syntax: 'x + y')
  Left: 
    ILocalReferenceExpression: x ([0] OperationKind.LocalReferenceExpression, Type: D<System.Object>.C, IsInvalid) (Syntax: 'x')
  Right: 
    ILocalReferenceExpression: y ([1] OperationKind.LocalReferenceExpression, Type: D<dynamic>.C, IsInvalid) (Syntax: 'y')
";
            var expectedDiagnostics = new DiagnosticDescription[] {
...
";
            string expectedOperationTree = @"
IBlockStatement (3 statements, 3 locals) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  Locals: Local_1: System.Int32 x
    Local_2: System.Int32? q
    Local_3: System.Boolean[] b
  IVariableDeclarationStatement (1 declarations) ([0] OperationKind.VariableDeclarationStatement) (Syntax: 'int x = xint + 123;')
    IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: 'x = xint + 123')
      Variables: Local_1: System.Int32 x
      Initializer: 
        IVariableInitializer ([0] OperationKind.VariableInitializer) (Syntax: '= xint + 123')
          IBinaryOperatorExpression (BinaryOperatorKind.Add) (OperatorMethod: System.Int32 X<System.Int32>.op_Addition(X<System.Int32> x, System.Int32 y)) ([0] OperationKind.BinaryOperatorExpression, Type: System.Int32) (Syntax: 'xint + 123')
            Left: 
              IParameterReferenceExpression: xint ([0] OperationKind.ParameterReferenceExpression, Type: X<System.Int32>) (Syntax: 'xint')
            Right: 
              ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 123) (Syntax: '123')
  IVariableDeclarationStatement (1 declarations) ([1] OperationKind.VariableDeclarationStatement) (Syntax: 'int? q = ne ... new int?();')
    IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: 'q = new Q<i ...  new int?()')
      Variables: Local_1: System.Int32? q
      Initializer: 
        IVariableInitializer ([0] OperationKind.VariableInitializer) (Syntax: '= new Q<int ...  new int?()')
          IBinaryOperatorExpression (BinaryOperatorKind.Add, IsLifted) (OperatorMethod: System.Int32 Q<System.Int32>.op_Addition(Q<System.Int32> x, System.Int32 y)) ([0] OperationKind.BinaryOperatorExpression, Type: System.Int32?) (Syntax: 'new Q<int>? ...  new int?()')
            Left: 
              IObjectCreationExpression (Constructor: Q<System.Int32>?..ctor()) ([0] OperationKind.ObjectCreationExpression, Type: Q<System.Int32>?) (Syntax: 'new Q<int>?()')
                Arguments(0)
                Initializer: 
                  null
            Right: 
              IObjectCreationExpression (Constructor: System.Int32?..ctor()) ([1] OperationKind.ObjectCreationExpression, Type: System.Int32?) (Syntax: 'new int?()')
                Arguments(0)
                Initializer: 
                  null
  IVariableDeclarationStatement (1 declarations) ([2] OperationKind.VariableDeclarationStatement) (Syntax: 'bool[] b = ... };')
    IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: 'b = ... }')
      Variables: Local_1: System.Boolean[] b
      Initializer: 
        IVariableInitializer ([0] OperationKind.VariableInitializer) (Syntax: '= ... }')
          IArrayCreationExpression ([0] OperationKind.ArrayCreationExpression, Type: System.Boolean[]) (Syntax: '{ ... }')
            Dimension Sizes(1):
                ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.Int32, Constant: 8, IsImplicit) (Syntax: '{ ... }')
            Initializer: 
              IArrayInitializer (8 elements) ([1] OperationKind.ArrayInitializer) (Syntax: '{ ... }')
                Element Values(8):
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S x, S y)) ([0] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's1 == s2')
                      Left: 
                        IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
                      Right: 
                        IParameterReferenceExpression: s2 ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's2')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([1] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's1 == s3')
                      Left: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: S?, IsImplicit) (Syntax: 's1')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
                            IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
                      Right: 
                        IParameterReferenceExpression: s3 ([1] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's3')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([2] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's1 == null')
                      Left: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: S?, IsImplicit) (Syntax: 's1')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
                            IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
                      Right: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: S?, Constant: null, IsImplicit) (Syntax: 'null')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
                            ILiteralExpression ([0] OperationKind.LiteralExpression, Type: null, Constant: null) (Syntax: 'null')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([3] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's3 == s1')
                      Left: 
                        IParameterReferenceExpression: s3 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's3')
                      Right: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: S?, IsImplicit) (Syntax: 's1')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
                            IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([4] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's3 == s4')
                      Left: 
                        IParameterReferenceExpression: s3 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's3')
                      Right: 
                        IParameterReferenceExpression: s4 ([1] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's4')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([5] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's3 == null')
                      Left: 
                        IParameterReferenceExpression: s3 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's3')
                      Right: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: S?, Constant: null, IsImplicit) (Syntax: 'null')
                          ...
                          Operand: 
                            ILiteralExpression ([0] OperationKind.LiteralExpression, Type: null, Constant: null) (Syntax: 'null')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([6] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 'null == s1')
                      Left: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: S?, Constant: null, IsImplicit) (Syntax: 'null')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
                            ILiteralExpression ([0] OperationKind.LiteralExpression, Type: null, Constant: null) (Syntax: 'null')
                      Right: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: S?, IsImplicit) (Syntax: 's1')
                          ...
                          Operand: 
                            IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
                    IBinaryOperatorExpression (BinaryOperatorKind.Equals) (OperatorMethod: System.Boolean S.op_Equality(S? x, S? y)) ([7] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 'null == s3')
                      Left: 
                        IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: S?, Constant: null, IsImplicit) (Syntax: 'null')
                          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                          Operand: 
...
";
            string expectedOperationTree = @"
IBlockStatement (10 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'a += b;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Add) (OperatorMethod: S S.op_Addition(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a += b')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: b ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'b')
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'a -= c;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Subtract) (OperatorMethod: S S.op_Subtraction(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a -= c')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: c ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'c')
  IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'a *= d;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Multiply) (OperatorMethod: S S.op_Multiply(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a *= d')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: d ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'd')
  IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'a /= e;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Divide) (OperatorMethod: S S.op_Division(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a /= e')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: e ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'e')
  IExpressionStatement ([4] OperationKind.ExpressionStatement) (Syntax: 'a %= f;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Remainder) (OperatorMethod: S S.op_Modulus(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a %= f')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: f ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'f')
  IExpressionStatement ([5] OperationKind.ExpressionStatement) (Syntax: 'a <<= 10;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.LeftShift) (OperatorMethod: S S.op_LeftShift(S x, System.Int32 y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a <<= 10')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 10) (Syntax: '10')
  IExpressionStatement ([6] OperationKind.ExpressionStatement) (Syntax: 'a >>= 20;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.RightShift) (OperatorMethod: S S.op_RightShift(S x, System.Int32 y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a >>= 20')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 20) (Syntax: '20')
  IExpressionStatement ([7] OperationKind.ExpressionStatement) (Syntax: 'a &= g;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.And) (OperatorMethod: S S.op_BitwiseAnd(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a &= g')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: g ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'g')
  IExpressionStatement ([8] OperationKind.ExpressionStatement) (Syntax: 'a |= h;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Or) (OperatorMethod: S S.op_BitwiseOr(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a |= h')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: h ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'h')
  IExpressionStatement ([9] OperationKind.ExpressionStatement) (Syntax: 'a ^= i;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.ExclusiveOr) (OperatorMethod: S S.op_ExclusiveOr(S x, S y)) ([0] OperationKind.CompoundAssignmentExpression, Type: S) (Syntax: 'a ^= i')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: i ([1] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 'i')
";
            var expectedDiagnostics = DiagnosticDescription.None;
...
IBlockStatement (10 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'a += b;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Add) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a += b')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: b ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'b')
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'a -= c;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Subtract) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a -= c')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: c ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'c')
  IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'a *= d;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Multiply) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a *= d')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
  ...
  IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'a /= e;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Divide) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a /= e')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
  ...
  IExpressionStatement ([4] OperationKind.ExpressionStatement) (Syntax: 'a %= f;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Remainder) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a %= f')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
  ...
  IExpressionStatement ([5] OperationKind.ExpressionStatement) (Syntax: 'a <<= 10;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.LeftShift) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a <<= 10')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
          ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 10) (Syntax: '10')
  IExpressionStatement ([6] OperationKind.ExpressionStatement) (Syntax: 'a >>= 20;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.RightShift) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a >>= 20')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
          ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 20) (Syntax: '20')
  IExpressionStatement ([7] OperationKind.ExpressionStatement) (Syntax: 'a &= g;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.And) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a &= g')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
  ...
  IExpressionStatement ([8] OperationKind.ExpressionStatement) (Syntax: 'a |= h;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.Or) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a |= h')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
          IParameterReferenceExpression: h ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'h')
  IExpressionStatement ([9] OperationKind.ExpressionStatement) (Syntax: 'a ^= i;')
    Expression: 
      ICompoundAssignmentExpression (BinaryOperatorKind.ExclusiveOr) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a ^= i')
        Left: 
          IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
        Right: 
...
";
            string expectedOperationTree = @"
ICompoundAssignmentExpression (BinaryOperatorKind.Add, IsLifted) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32, IsInvalid) (Syntax: 'a += b')
  Left: 
    IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32, IsInvalid) (Syntax: 'a')
  Right: 
    IParameterReferenceExpression: b ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32?, IsInvalid) (Syntax: 'b')
";
            var expectedDiagnostics = new DiagnosticDescription[] {
...
";
            string expectedOperationTree = @"
IBlockStatement (1 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IBlockStatement (10 statements) ([0] OperationKind.BlockStatement) (Syntax: '{ ... }')
    IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'a += b;')
      Expression: 
        ICompoundAssignmentExpression (BinaryOperatorKind.Add, Checked) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a += b')
          Left: 
            IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
          Right: 
            IParameterReferenceExpression: b ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'b')
    IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'a -= c;')
      Expression: 
        ICompoundAssignmentExpression (BinaryOperatorKind.Subtract, Checked) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a -= c')
          Left: 
            IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
          Right: 
            IParameterReferenceExpression: c ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'c')
    IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'a *= d;')
      Expression: 
        ICompoundAssignmentExpression (BinaryOperatorKind.Multiply, Checked) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a *= d')
          Left: 
            IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
          Right: 
            IParameterReferenceExpression: d ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'd')
    IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'a /= e;')
      Expression: 
        ICompoundAssignmentExpression (BinaryOperatorKind.Divide, Checked) ([0] OperationKind.CompoundAssignmentExpression, Type: System.Int32) (Syntax: 'a /= e')
          Left: 
            IParameterReferenceExpression: a ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'a')
          Right: 
            IParameterReferenceExpression: e ([1] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'e')
...
";
            string expectedOperationTree = @"
IBlockStatement (14 statements) ([Root] OperationKind.BlockStatement) (Syntax: '{ ... }')
  IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'i1 = +s1;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32) (Syntax: 'i1 = +s1')
        Left: 
          IParameterReferenceExpression: i1 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i1')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Plus) (OperatorMethod: System.Int32 S.op_UnaryPlus(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32) (Syntax: '+s1')
            Operand: 
              IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([1] OperationKind.ExpressionStatement) (Syntax: 'i2 = +s2;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32?) (Syntax: 'i2 = +s2')
        Left: 
          IParameterReferenceExpression: i2 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32?) (Syntax: 'i2')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Plus, IsLifted) (OperatorMethod: System.Int32 S.op_UnaryPlus(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32?) (Syntax: '+s2')
            Operand: 
              IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([2] OperationKind.ExpressionStatement) (Syntax: 'i1 = -s1;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32) (Syntax: 'i1 = -s1')
        Left: 
          IParameterReferenceExpression: i1 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i1')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Minus) (OperatorMethod: System.Int32 S.op_UnaryNegation(S? s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32) (Syntax: '-s1')
            Operand: 
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: S?, IsImplicit) (Syntax: 's1')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
                  IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([3] OperationKind.ExpressionStatement) (Syntax: 'i1 = -s2;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32) (Syntax: 'i1 = -s2')
        Left: 
          IParameterReferenceExpression: i1 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i1')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Minus) (OperatorMethod: System.Int32 S.op_UnaryNegation(S? s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32) (Syntax: '-s2')
            Operand: 
              IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([4] OperationKind.ExpressionStatement) (Syntax: 'i1 = !s1;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32) (Syntax: 'i1 = !s1')
        Left: 
          IParameterReferenceExpression: i1 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i1')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Not) (OperatorMethod: System.Int32 S.op_LogicalNot(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32) (Syntax: '!s1')
            Operand: 
              IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([5] OperationKind.ExpressionStatement) (Syntax: 'i2 = !s2;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32?) (Syntax: 'i2 = !s2')
        Left: 
          IParameterReferenceExpression: i2 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32?) (Syntax: 'i2')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.Not, IsLifted) (OperatorMethod: System.Int32 S.op_LogicalNot(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32?) (Syntax: '!s2')
            Operand: 
              IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([6] OperationKind.ExpressionStatement) (Syntax: 'i1 = ~s1;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32) (Syntax: 'i1 = ~s1')
        Left: 
          IParameterReferenceExpression: i1 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i1')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.BitwiseNegation) (OperatorMethod: System.Int32 S.op_OnesComplement(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32) (Syntax: '~s1')
            Operand: 
              IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([7] OperationKind.ExpressionStatement) (Syntax: 'i2 = ~s2;')
    Expression: 
      ISimpleAssignmentExpression ([0] OperationKind.SimpleAssignmentExpression, Type: System.Int32?) (Syntax: 'i2 = ~s2')
        Left: 
          IParameterReferenceExpression: i2 ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32?) (Syntax: 'i2')
        Right: 
          IUnaryOperatorExpression (UnaryOperatorKind.BitwiseNegation, IsLifted) (OperatorMethod: System.Int32 S.op_OnesComplement(S s)) ([1] OperationKind.UnaryOperatorExpression, Type: System.Int32?) (Syntax: '~s2')
            Operand: 
              IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([8] OperationKind.ExpressionStatement) (Syntax: 's1++;')
    Expression: 
      IIncrementOrDecrementExpression (Postfix) (OperatorMethod: S S.op_Increment(S s)) ([0] OperationKind.IncrementExpression, Type: S) (Syntax: 's1++')
        Target: 
          IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([9] OperationKind.ExpressionStatement) (Syntax: 's2++;')
    Expression: 
      IIncrementOrDecrementExpression (Postfix, IsLifted) (OperatorMethod: S S.op_Increment(S s)) ([0] OperationKind.IncrementExpression, Type: S?) (Syntax: 's2++')
        Target: 
          IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([10] OperationKind.ExpressionStatement) (Syntax: '++s1;')
    Expression: 
      IIncrementOrDecrementExpression (Prefix) (OperatorMethod: S S.op_Increment(S s)) ([0] OperationKind.IncrementExpression, Type: S) (Syntax: '++s1')
        Target: 
          IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([11] OperationKind.ExpressionStatement) (Syntax: '++s2;')
    Expression: 
      IIncrementOrDecrementExpression (Prefix, IsLifted) (OperatorMethod: S S.op_Increment(S s)) ([0] OperationKind.IncrementExpression, Type: S?) (Syntax: '++s2')
        Target: 
          IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
  IExpressionStatement ([12] OperationKind.ExpressionStatement) (Syntax: 's1--;')
    Expression: 
      IIncrementOrDecrementExpression (Postfix) (OperatorMethod: S S.op_Decrement(S? s)) ([0] OperationKind.DecrementExpression, Type: S) (Syntax: 's1--')
        Target: 
          IParameterReferenceExpression: s1 ([0] OperationKind.ParameterReferenceExpression, Type: S) (Syntax: 's1')
  IExpressionStatement ([13] OperationKind.ExpressionStatement) (Syntax: 's2--;')
    Expression: 
      IIncrementOrDecrementExpression (Postfix) (OperatorMethod: S S.op_Decrement(S? s)) ([0] OperationKind.DecrementExpression, Type: S?) (Syntax: 's2--')
        Target: 
          IParameterReferenceExpression: s2 ([0] OperationKind.ParameterReferenceExpression, Type: S?) (Syntax: 's2')
";
            var expectedDiagnostics = new DiagnosticDescription[] {
