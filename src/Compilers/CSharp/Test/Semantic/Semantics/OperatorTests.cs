...
{
    public partial class SyntaxBinderTests() : CompilingTestBase(TargetFramework.Standard)
    {
...
";
        ...
        private static void TestBoundTree(string source, System.Func<IEnumerable<KeyValuePair<TreeDumperNode, TreeDumperNode>>, IEnumerable<string>> query)
        {
            ...
            var compilation = CreateCompilationWithStandard(source, options: TestOptions.ReleaseDll);
