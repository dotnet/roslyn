...
struct S
{
    internal C? F;
        ...
        // PROTOTYPE(NullableReferenceTypes): Should not generate null reference
        // warnings for fields of uninitialized out parameter.
        [Fact]
        public void UnassignedOutParameterField()
        {
            var source =
@"class C
{
