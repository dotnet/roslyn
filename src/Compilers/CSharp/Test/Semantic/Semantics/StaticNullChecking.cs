...
" }, parseOptions: TestOptions.Regular.WithNullCheckingFeature());
            ...
            c.VerifyDiagnostics(
                // (12,9): warning CS8619: Nullability of reference types in value of type 'CL0<string?>' doesn't match target type 'CL0<string>'.
                //         M1(ref x1);
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "M1").WithArguments("CL0<string?>", "CL0<string>").WithLocation(12, 9),
                ...
                // (19,9): warning CS8619: Nullability of reference types in value of type 'CL0<string>' doesn't match target type 'CL0<string?>'.
                //         M2(out x2);
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "M2").WithArguments("CL0<string>", "CL0<string?>").WithLocation(19, 9),
                // (26,9): warning CS8619: Nullability of reference types in value of type 'CL0<string?>' doesn't match target type 'CL0<string>'.
                //         M3(x3);
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "M3").WithArguments("CL0<string?>", "CL0<string>").WithLocation(26, 9),
...
" }, parseOptions: TestOptions.Regular.WithNullCheckingFeature());
            ...
            c.VerifyDiagnostics(
                // (10,9): warning CS8619: Nullability of reference types in value of type 'CL1<string>' doesn't match target type 'CL1<string?>'.
                //         return x1;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "return x1;").WithArguments("CL1<string>", "CL1<string?>").WithLocation(10, 9),
                // (15,9): warning CS8619: Nullability of reference types in value of type 'CL1<string?>' doesn't match target type 'CL1<string>'.
                //         return x2;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "return x2;").WithArguments("CL1<string?>", "CL1<string>").WithLocation(15, 9)
                );
        }
...
" });
            ...
            c.VerifyDiagnostics(
                ...
                //         object []? u1 = null;
                Diagnostic(ErrorCode.ERR_FeatureIsExperimental, "?").WithArguments("static null checking", "staticNullChecking").WithLocation(10, 18),
                // (15,20): error CS8058: Feature 'static null checking' is experimental and unsupported; use '/features:staticNullChecking' to enable.
                //         object [][]? u2 = null;
                Diagnostic(ErrorCode.ERR_FeatureIsExperimental, "?").WithArguments("static null checking", "staticNullChecking").WithLocation(15, 20),
                // (20,18): error CS8058: Feature 'static null checking' is experimental and unsupported; use '/features:staticNullChecking' to enable.
                //         object []?[]? u3 = null;
                Diagnostic(ErrorCode.ERR_FeatureIsExperimental, "?").WithArguments("static null checking", "staticNullChecking").WithLocation(20, 18),
                // (20,21): error CS8058: Feature 'static null checking' is experimental and unsupported; use '/features:staticNullChecking' to enable.
                //         object []?[]? u3 = null;
                Diagnostic(ErrorCode.ERR_FeatureIsExperimental, "?").WithArguments("static null checking", "staticNullChecking").WithLocation(20, 21)
                );
        }
...
" }, parseOptions: TestOptions.Regular.WithNullCheckingFeature());
            ...
            c.VerifyDiagnostics(
                // (13,17): warning CS8619: Nullability of reference types in value of type 'CL0<string?>' doesn't match target type 'CL0<string>'.
                //         D1 x1 = new D1(M1);
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "new D1(M1)").WithArguments("CL0<string?>", "CL0<string>").WithLocation(13, 17),
                // (21,17): warning CS8619: Nullability of reference types in value of type 'CL0<string>' doesn't match target type 'CL0<string?>'.
                //         D2 x2 = new D2(M2);
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "new D2(M2)").WithArguments("CL0<string>", "CL0<string?>").WithLocation(21, 17));
        }
...
" }, parseOptions: TestOptions.Regular.WithNullCheckingFeature());
            ...
            c.VerifyDiagnostics(
                ...
                // (22,42): warning CS8619: Nullability of reference types in value of type 'CL0<string?>' doesn't match target type 'CL0<string>'.
                //         System.Action<CL0<string?>> u3 = M1<CL0<string>>;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "M1<CL0<string>>").WithArguments("CL0<string?>", "CL0<string>").WithLocation(22, 42),
                ...
                // (27,41): warning CS8619: Nullability of reference types in value of type 'CL0<string>' doesn't match target type 'CL0<string?>'.
                //         System.Action<CL0<string>> u4 = M1<CL0<string?>>;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "M1<CL0<string?>>").WithArguments("CL0<string>", "CL0<string?>").WithLocation(27, 41),
...
struct S
{
    ...
    public S(A a, B b)
    {
        ...
        // PROTOTYPE(NullableReferenceTypes): Update other tests with WithNullCheckingFeature(flags: NullableReferenceFlags.None) to verify expected changes.
    ...
    static void F(C<object>? x, C<object?> y, bool c)
    {
        ...
        b = c ? x! : y!;
            ...
            comp.VerifyDiagnostics(
                ...
                //         a = c ? x : y;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "c ? x : y").WithArguments("C<object?>", "C<object>").WithLocation(7, 13),
    ...
    static void F(C<object?> x, C<object> y)
    {
        ...
        b = y!;
            ...
            comp.VerifyDiagnostics(
                ...
                //         a = x;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "x").WithArguments("I<object?>", "I<object>").WithLocation(8, 13),
                // (11,13): warning CS8619: Nullability of reference types in value of type 'I<object>' doesn't match target type 'I<object?>'.
                //         b = y;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "y").WithArguments("I<object>", "I<object?>").WithLocation(11, 13));
        }
    ...
    static void F(object? o)
    {
        ...
        public void GetNullableReferenceFlags()
        {
            Assert.Equal(NullableReferenceFlags.None,
                TestOptions.Regular.GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled,
                TestOptions.Regular.WithFeature("staticNullChecking").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled,
                TestOptions.Regular.WithFeature("staticNullChecking", "0").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled | NullableReferenceFlags.IncludeNonNullWarnings | NullableReferenceFlags.InferLocalNullability,
                TestOptions.Regular.WithFeature("staticNullChecking", "3").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled | NullableReferenceFlags.AllowMemberOptOut | NullableReferenceFlags.AllowAssemblyOptOut,
                TestOptions.Regular.WithFeature("staticNullChecking", "12").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled | (NullableReferenceFlags)0x123,
                TestOptions.Regular.WithFeature("staticNullChecking", 0x123.ToString()).GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.None,
                TestOptions.Regular.WithFeature("staticNullChecking", "false").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.Enabled,
                TestOptions.Regular.WithFeature("staticNullChecking", "true").GetNullableReferenceFlags());
            Assert.Equal(NullableReferenceFlags.None,
                TestOptions.Regular.WithFeature("staticNullChecking", "other").GetNullableReferenceFlags());
        }
