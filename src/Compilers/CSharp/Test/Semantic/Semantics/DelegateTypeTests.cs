...
");
        ...
        public void SynthesizedDelegateTypes_UnscopedRefAttribute_MissingConstructor_03()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         var d = A.F;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "A.F").WithArguments("System.Diagnostics.CodeAnalysis.UnscopedRefAttribute", ".ctor").WithLocation(6, 17),
                // (6,17): error CS9340: Cannot convert method group 'F' to delegate type '<anonymous delegate>' due to mismatched ref safety requirements between the method and delegate.
                //         var d = A.F;
                Diagnostic(ErrorCode.ERR_RefSafetyInDelegateConversion, "A.F").WithArguments("F", "<anonymous delegate>").WithLocation(6, 17));
        }
