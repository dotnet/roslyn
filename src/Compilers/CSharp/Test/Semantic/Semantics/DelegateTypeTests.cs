...
""";
            ...
            comp.VerifyDiagnostics(
                ...
                // (7,13): error CS1503: Argument 1: cannot convert from 'method group' to 'MissingDelegate'

                //         Foo(M<int>);

                Diagnostic(ErrorCode.ERR_BadArgType, "M<int>").WithArguments("1", "method group", "MissingDelegate").WithLocation(7, 13),
