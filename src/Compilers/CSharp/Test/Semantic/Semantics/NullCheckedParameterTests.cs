...
class C
{
    public string this[string index!] => null;
            ...
            var comp = CreateCompilation(source, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
...
class C
{
    public void M()
    {
        Func<string, string> func1 = x! => x + ""1"";
            ...
            var tree = Parse(source, options: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
