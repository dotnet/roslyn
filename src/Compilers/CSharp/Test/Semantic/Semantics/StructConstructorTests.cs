...
class Program
{
    ...
    static void G12(decimal? s = (decimal)2) { }
            ...
            comp.VerifyDiagnostics(
                ...
                // (15,28): error CS1736: Default parameter value for 's' must be a compile-time constant
                //     static void G5(S1? s = new()) { }
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "new()").WithArguments("s").WithLocation(15, 28),
