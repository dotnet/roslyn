...
";
            ...
            Assert.Equal(SpecialType.System_IDisposable, declaredLocal.TypeWithAnnotations.SpecialType);
...
";
            ...
            Assert.Equal(((LocalSymbol)declaredSymbol).TypeWithAnnotations.Type, typeInfo.Symbol);
        }
...
";
            ...
            Assert.Equal(((LocalSymbol)model.GetDeclaredSymbol(usingStatement.Declaration.Variables.Last())).TypeWithAnnotations.Type, typeInfo.Symbol);
        }
...
" + _managedStruct;
            ...
            {
                VerifySymbolInfoForUsingStatements(compilation, ((LocalSymbol)x).TypeWithAnnotations.Type);
            }
        }
...
" + _managedClass;
            ...
            foreach (var x in symbols)
            {
                ...
                VerifySymbolInfoForUsingStatements(compilation, ((LocalSymbol)x).TypeWithAnnotations.Type, 2);
            }
        }
...
" + _managedClass;
            ...
            foreach (var x in symbols)
            {
                ...
                VerifySymbolInfoForUsingStatements(compilation, ((LocalSymbol)x).TypeWithAnnotations.Type, 1);
            }
        }
