    ...
    public void M(int[] arr) {
        var x = arr[0..2];
            ...
            comp.VerifyDiagnostics(
                ...
                //         var x = arr[0..2];
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "0..2").WithArguments("System.Runtime.CompilerServices.RuntimeHelpers", "GetSubArray").WithLocation(11, 17));
        }
    ...
    public readonly struct Index
    {
        public Index(int value, bool fromEnd) { }
            ...
            comp.VerifyDiagnostics(
                ...
                //         var x = arr[^2];
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "^2").WithArguments("System.Index", "GetOffset").WithLocation(6, 17));
