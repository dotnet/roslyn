...
class C
{
    ...
    public static void Main()
    {
        ...
        Throws(() => new Span<char>(s.ToCharArray())[0..1]);
            ...
            comp.VerifyDiagnostics(
                // (9,9): error CS9504: The type 'Span<char>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'T' in the generic type or method 'C.Throws<T>(Func<T>)'
                //         Throws(() => new Span<char>(s.ToCharArray())[0..1]);
