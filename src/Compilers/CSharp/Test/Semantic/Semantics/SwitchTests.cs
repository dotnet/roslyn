            ...
            CompileAndVerify(text, expectedOutput: "1").VerifyIL("C.Main", @"
{
  // Code size      201 (0xc9)
  .maxstack  14
  .locals init (System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int, int, int, int, int, int>> V_0)
  IL_0000:  ldloca.s   V_0
  IL_0002:  ldc.i4.1
  IL_0003:  ldc.i4.2
  IL_0004:  ldc.i4.3
  ...
  IL_00bb:  ldc.i4.s   13
  IL_00bd:  bne.un.s   IL_00c2
  IL_00bf:  ldc.i4.1
  IL_00c0:  br.s       IL_00c3
  IL_00c2:  ldc.i4.m1
  IL_00c3:  call       ""void System.Console.WriteLine(int)""
  IL_00c8:  ret
}
");
        }
            ...
            CompileAndVerify(text).VerifyIL("C.Main", @"
{
  // Code size      385 (0x181)
  .maxstack  21
  .locals init (System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int, int, int, int, int, int>>> V_0)
  IL_0000:  ldloca.s   V_0
  IL_0002:  ldc.i4.1
  IL_0003:  ldc.i4.2
  IL_0004:  ldc.i4.3
  ...
  IL_0173:  ldc.i4.s   20
  IL_0175:  bne.un.s   IL_017a
  IL_0177:  ldc.i4.1
  IL_0178:  br.s       IL_017b
  IL_017a:  ldc.i4.m1
  IL_017b:  call       ""void System.Console.WriteLine(int)""
  IL_0180:  ret
}
");
        }
            ...
            CompileAndVerify(text, expectedOutput: "12345678💥").VerifyIL("C.Main", @"
{
  ...
  .try
  {
    ...
    IL_0085:  ldc.i4.7
    IL_0086:  bne.un.s   IL_008b
    IL_0088:  ldc.i4.1
    IL_0089:  br.s       IL_0097
    IL_008b:  ldloc.0
    IL_008c:  box        ""System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int>>""
    IL_0091:  call       ""void <PrivateImplementationDetails>.ThrowSwitchExpressionException(object)""
    IL_0096:  ldc.i4.0
    IL_0097:  call       ""void System.Console.WriteLine(int)""
    IL_009c:  leave.s    IL_00ab
  }
            ...
            CompileAndVerify(text, expectedOutput: "123456789💥").VerifyIL("C.Main", @"
{
  // Code size      193 (0xc1)
  .maxstack  9
  .locals init (System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int, int>> V_0)
  .try
  {
    IL_0000:  ldc.i4.1
    IL_0001:  call       ""int C.M(int)""
    ...
    IL_009a:  ldc.i4.8
    IL_009b:  bne.un.s   IL_00a0
    IL_009d:  ldc.i4.1
    IL_009e:  br.s       IL_00ac
    IL_00a0:  ldloc.0
    IL_00a1:  box        ""System.ValueTuple<int, int, int, int, int, int, int, System.ValueTuple<int, int>>""
    IL_00a6:  call       ""void <PrivateImplementationDetails>.ThrowSwitchExpressionException(object)""
    IL_00ab:  ldc.i4.0
    IL_00ac:  call       ""void System.Console.WriteLine(int)""
    IL_00b1:  leave.s    IL_00c0
  }
  catch System.Runtime.CompilerServices.SwitchExpressionException
  {
    IL_00b3:  pop
