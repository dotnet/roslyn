...
public class C
{
    public void M(int[] array, ref int value)
    {
        array[0] = ref value;
            ...
            Assert.Equal(SpecialType.System_Int32, ((ArrayTypeSymbol)model.GetTypeInfo(left).Type).ElementTypeWithAnnotations.SpecialType);
...
public unsafe class C
{
    public void M(int* ptr, ref int value)
    {
        *ptr = ref value;
            ...
            Assert.Equal(SpecialType.System_Int32, ((PointerTypeSymbol)model.GetTypeInfo(left).Type).PointedAtTypeWithAnnotations.SpecialType);
