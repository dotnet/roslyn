...
public class C
{
    static void Main()
    {
        ...
        c.M(a: 1, 2);
            ...
            var verifier = CompileAndVerifyWithMscorlib40(source, expectedOutput: "1 2.", parseOptions: TestOptions.Regular7_2, references: new[] { Net40.SystemCore });
            verifier.VerifyDiagnostics();

            var comp = CreateCompilationWithMscorlib40(source, parseOptions: TestOptions.Regular7_1, references: new[] { Net40.SystemCore });
            comp.VerifyDiagnostics(
