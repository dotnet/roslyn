...
class Test
{
    static void Method1(int[] array)
    {
        ...
        var q3 = from item in array let v = stackalloc    [ ] { 1, 2, 3 } select v;
            ...
            CreateCompilationWithMscorlibAndSpan(source, TestOptions.ReleaseDll, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics(
                // (7,45): error CS1932: Cannot assign 'Span<int>' to a range variable. The target type is ambiguous or stack-only.
                //         var q1 = from item in array let v = stackalloc int[3] { 1, 2, 3 } select v;
                ...
                // (8,45): error CS1932: Cannot assign 'Span<int>' to a range variable. The target type is ambiguous or stack-only.
                //         var q2 = from item in array let v = stackalloc int[ ] { 1, 2, 3 } select v;
                ...
                // (9,45): error CS1932: Cannot assign 'Span<int>' to a range variable. The target type is ambiguous or stack-only.
                //         var q3 = from item in array let v = stackalloc    [ ] { 1, 2, 3 } select v;
