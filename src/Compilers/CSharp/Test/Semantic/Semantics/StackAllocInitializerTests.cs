    ...
    void Method1(S s, bool c)
    {
        ...
        var obj3 = c ? default : stackalloc[] { s };
            ...
            comp.VerifyDiagnostics(
                ...
                // (9,34): error CS9504: The type 'Test.S' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'T' in the generic type or method 'Span<T>'
                //         var obj3 = c ? default : stackalloc[] { s };
...
class Test
{
    static void Method1(int[] array)
    {
        ...
        var q3 = from item in array select stackalloc    [ ] { 1, 2, 3 };
            ...
            CreateCompilationWithMscorlibAndSpan(source, TestOptions.ReleaseDll, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics(
                // (7,37): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q1 = from item in array select stackalloc int[3] { 1, 2, 3 };
                ...
                // (8,37): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q2 = from item in array select stackalloc int[ ] { 1, 2, 3 };
                ...
                // (9,37): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q3 = from item in array select stackalloc    [ ] { 1, 2, 3 };
...
class Test
{
    static void Method1(int[] array)
    {
        ...
        var q3 = from item in array let v = stackalloc    [ ] { 1, 2, 3 } select v;
            ...
            CreateCompilationWithMscorlibAndSpan(source, TestOptions.ReleaseDll, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics(
                // (7,75): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q1 = from item in array let v = stackalloc int[3] { 1, 2, 3 } select v;
                ...
                // (8,75): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q2 = from item in array let v = stackalloc int[ ] { 1, 2, 3 } select v;
                ...
                // (9,75): error CS9504: The type 'Span<int>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'TResult' in the generic type or method 'Enumerable.Select<TSource, TResult>(IEnumerable<TSource>, Func<TSource, TResult>)'
                //         var q3 = from item in array let v = stackalloc    [ ] { 1, 2, 3 } select v;
