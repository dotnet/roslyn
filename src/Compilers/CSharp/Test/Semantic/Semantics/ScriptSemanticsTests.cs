...
";
        ...
        [Fact(Skip = "PROTOTYPE(TopLevelStatements): Figure out what do we want to do for scenarios when we parsed a compilation unit as a script, but then lost this fact because SyntaxTree is not created at the same time")]
