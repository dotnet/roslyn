...
namespace System
{
    //PROTOTYPE(spans): we consider System.Span a ref struct for now
    //                  to be able to detect current Span types that are not marked 'ref'
    //                  This may not be needed in the final implementation.
