...
class C : CSharpErrors.ClassMethods
{
    ...
    public override UnavailableClass[] ReturnType2() { return null; }
        ...
        private static readonly MetadataReference UnmanagedUseSiteError_Ref1 = CreateCompilationWithNetLatest(@"
public struct S1
{
    public int i;
}", assemblyName: "libS1").ToMetadataReference();

        private static readonly MetadataReference UnmanagedUseSiteError_Ref2 = CreateCompilationWithNetLatest(@"
public struct S2
{
    public S1 s1;
}
