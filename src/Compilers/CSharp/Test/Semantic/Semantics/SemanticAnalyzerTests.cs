...
");
            ...
            Assert.Equal("Int32", call.Constructor.Parameters[0].TypeWithAnnotations.Name);
        }
...
");
            ...
            Assert.Equal(1, call.Constructor.Parameters.Length);
            Assert.Equal("a", call.Constructor.Parameters[0].Name);
            Assert.Equal("String", call.Constructor.Parameters[0].TypeWithAnnotations.Name);
        }
...
");
            ...
            Assert.Equal("Int32", newExpr.Constructor.Parameters[0].TypeWithAnnotations.Name);
        }
    }
}
