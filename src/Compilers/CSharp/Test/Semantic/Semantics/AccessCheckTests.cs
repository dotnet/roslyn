...
");
            ...
            TypeSymbol karrayType = (classA.GetMembers("karray").Single() as FieldSymbol).TypeWithAnnotations.Type;
            TypeSymbol aarrayType = (classA.GetMembers("aarray").Single() as FieldSymbol).TypeWithAnnotations.Type;
            TypeSymbol kptrType = (classA.GetMembers("kptr").Single() as FieldSymbol).TypeWithAnnotations.Type;
            TypeSymbol aptrType = (classA.GetMembers("aptr").Single() as FieldSymbol).TypeWithAnnotations.Type;
            TypeSymbol kenumType = (classA.GetMembers("kenum").Single() as FieldSymbol).TypeWithAnnotations.Type;
            TypeSymbol aenumType = (classA.GetMembers("aenum").Single() as FieldSymbol).TypeWithAnnotations.Type;
            ...
            TypeSymbol unknownType = (classA.GetMembers("unknowntype").Single() as FieldSymbol).TypeWithAnnotations.Type;
