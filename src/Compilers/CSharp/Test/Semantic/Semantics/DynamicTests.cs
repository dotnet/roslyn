...
";
            ...
            var erasedType = eraser.EraseDynamic(f.TypeWithAnnotations.Type);
...
";
            ...
            Assert.Equal(typeGConstructed, typeD.GetMember<FieldSymbol>("MissingTrue").TypeWithAnnotations.Type);
            Assert.Equal(typeGConstructed, typeD.GetMember<FieldSymbol>("MissingFalse").TypeWithAnnotations.Type);
            Assert.Equal(typeGConstructed, typeD.GetMember<FieldSymbol>("ExtraTrue").TypeWithAnnotations.Type);
            Assert.Equal(typeGConstructed, typeD.GetMember<FieldSymbol>("ExtraFalse").TypeWithAnnotations.Type);
        }
