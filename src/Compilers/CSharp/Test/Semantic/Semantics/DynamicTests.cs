...
";
            ...
            var verifier = CompileAndVerify(source, options: TestOptions.DebugDll.WithAllowUnsafe(true), verify: Verification.FailsPeVerify_UnexpectedTypeOnStack).VerifyDiagnostics();
