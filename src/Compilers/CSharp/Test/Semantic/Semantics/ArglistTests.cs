...
public struct C
{
  ...
  IL_0013:  ret
            ...
            var verifier = CompileAndVerify(source: text, expectedOutput: "System.Int32", verify: Verification.FailsIlVerify_TypedReference);
...
public struct C
{
  ...
  IL_0008:  ret
            ...
            var verifier = CompileAndVerify(source: text, expectedOutput: "System.String", verify: Verification.FailsIlVerify_TypedReference);
...
public struct C
{
  ...
  IL_000c:  ret
            ...
            var verifier = CompileAndVerify(source: text, expectedOutput: "1123", verify: Verification.FailsIlVerify_TypedReference);
...
333
0
42", verify: Verification.FailsIlVerify_TypedReference);
...
public struct C
{
    static void Main()
    {
        ...
        Console.Write(j);
            ...
            var verifier = CompileAndVerify(source: text, expectedOutput: "4242", verify: Verification.FailsIlVerify_TypedReference);
