...
namespace System.Threading.Tasks
{
    public class Task
    {
        ...
        public class Awaiter : INotifyCompletion
        {
            ...
            var compilation0 = CreateCompilationRaw(source0, references: new[] { MscorlibRef_v20 });
            var ref0 = compilation0.EmitToImageReference();
            var source =
@"using System.Threading.Tasks;
class Program
{
    ...
    static void Main()
    {
        ...
        t.GetAwaiter().GetResult();
            ...
            var compilation = CreateCompilationRaw(source, references: new[] { MscorlibRef_v20, ref0 });
            compilation.VerifyEmitDiagnostics();
        }
