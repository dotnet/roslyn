...
class C
{
    ...
    public unsafe IEnumerable<int> M4(int* a)
    {
        yield return new Func<int>(() =>
            ...
            var comp = CreateCompilation(src, options: TestOptions.UnsafeDebugDll, parseOptions: TestOptions.Regular12.WithFeature(FeatureFlag.RunNullableAnalysis, "never"));
            ...
            CreateCompilation(src, options: TestOptions.UnsafeDebugDll, parseOptions: TestOptions.Regular13.WithFeature(FeatureFlag.RunNullableAnalysis, "never")).VerifyDiagnostics(expectedDiagnostics);
            CreateCompilation(src, options: TestOptions.UnsafeDebugDll, parseOptions: TestOptions.RegularPreview.WithFeature(FeatureFlag.RunNullableAnalysis, "never")).VerifyDiagnostics(expectedDiagnostics);
        }
