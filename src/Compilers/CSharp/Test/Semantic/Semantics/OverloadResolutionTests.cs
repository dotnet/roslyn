...
public class MainClass
{
    public static int Main ()
    {
        ...
        return 0;
            ...
            var compilation = CreateStandardCompilationWithCustomILSource(source, ilSource);
...
";
            CreateStandardCompilationWithCustomILSource(source2, source1).VerifyDiagnostics(
