...
";
            ...
            var type = compilation.GetMember<FieldSymbol>("C.F0").TypeWithAnnotations.Type;
            ...
            type = compilation.GetMember<FieldSymbol>("C.F1").TypeWithAnnotations.Type;
            ...
            type = compilation.GetMember<FieldSymbol>("C.F2").TypeWithAnnotations.Type;
            normalized = type.NormalizeTaskTypes(compilation);
            ...
            type = compilation.GetMember<FieldSymbol>("C.F3").TypeWithAnnotations.Type;
            normalized = type.NormalizeTaskTypes(compilation);
            ...
            type = compilation.GetMember<FieldSymbol>("C.F4").TypeWithAnnotations.Type;
            normalized = type.NormalizeTaskTypes(compilation);
...
";
            ...
            compilation.VerifyDiagnostics();
            var type = compilation.GetMember<FieldSymbol>("C.F").TypeWithAnnotations.Type;
            var normalized = type.NormalizeTaskTypes(compilation);
