...
";
            ...
            var compilation = CreateCompilationWithMscorlib40(source1, new[] { Net40.SystemCore }, options: TestOptions.DebugExe);
            compilation.VerifyDiagnostics();
        }
...
";
            ...
            var libComp = CreateCompilationWithMscorlib40(librarySrc, references: new[] { Net40.SystemCore }).VerifyDiagnostics();
