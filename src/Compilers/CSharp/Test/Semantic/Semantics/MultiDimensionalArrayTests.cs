...
@"class C
{
    ...
    static void M3<T>(System.Collections.Generic.IList<T> a){}
            ...
            var szArray = (IArrayTypeSymbol)m2.Parameters.First().TypeWithAnnotations.Type;
            ...
            var mdArray = (IArrayTypeSymbol)m2.Parameters.Last().TypeWithAnnotations.Type;
...
";
            ...
            var array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test1").ReturnTypeWithAnnotations.Type;
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test2").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test3").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test4").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test5").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test6").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test7").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test8").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test9").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test10").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test11").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5, 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test12").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test13").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5, 7 }, array.Sizes);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test14").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test15").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test16").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (IArrayTypeSymbol)test.GetMember<MethodSymbol>("Test17").ReturnTypeWithAnnotations.Type;
            Assert.Equal("System.Double[*]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
