...
@"class C
{
    ...
    static void M3<T>(System.Collections.Generic.IList<T> a){}
            ...
            var szArray = (ArrayTypeSymbol)m2.Parameters.First().Type.TypeSymbol;
            ...
            var mdArray = (ArrayTypeSymbol)m2.Parameters.Last().Type.TypeSymbol;
...
";
            ...
            var array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test1").ReturnType.TypeSymbol;
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test2").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test3").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test4").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test5").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test6").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test7").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test8").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test9").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test10").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test11").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5, 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test12").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test13").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.Equal(new[] { 5, 7 }, array.Sizes);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test14").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test15").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test16").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[,]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
            Assert.Equal(2, array.Rank);
            Assert.True(array.Sizes.IsEmpty);
            ...
            array = (ArrayTypeSymbol)test.GetMember<MethodSymbol>("Test17").ReturnType.TypeSymbol;
            Assert.Equal("System.Double[*]", array.ToTestDisplayString());
            Assert.False(array.IsSZArray);
