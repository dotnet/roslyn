...
";
            ...
            CompileAndVerify(comp, sourceSymbolValidator: symbolValidator, symbolValidator: symbolValidator,
                verify: Verification.Fails_InitOnly);
...
" }, verify: Verification.Fails_InitOnly, expectedOutput: "1");
...
" }, verify: Verification.Fails_InitOnly, expectedOutput: @"I1 was 1
I1 is 0");
...
";
            ...
            CompileAndVerify(comp, expectedOutput: "c", verify: Verification.Fails_InitOnly);
        }
