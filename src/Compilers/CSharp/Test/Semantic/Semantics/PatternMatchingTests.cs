...
";
        ...
        [Fact]
        public void ScopeOfPatternVariables_LocalDeclarationStmt_07()
        {
            var source =
@"
public class X
...
");
            ...
            Assert.Equal("System.Int32 y1", model.GetDeclaredSymbol(statement.Declaration.Variables.Single()).ToTestDisplayString());
        }
