...
";
            CreateCompilationWithMscorlibAndSystemCore(text, options: TestOptions.UnsafeReleaseDll).VerifyDiagnostics(
                ...
                // (39,13): error CS1113: Extension method 'S.ExtensionMethod()' defined on value type 'S' cannot be used to create delegates
                //         a = p->ExtensionMethod; //CS1113
                Diagnostic(ErrorCode.ERR_ValueTypeExtDelegate, "p->ExtensionMethod").WithArguments("S.ExtensionMethod()", "S").WithLocation(39, 13)
                );
        }
