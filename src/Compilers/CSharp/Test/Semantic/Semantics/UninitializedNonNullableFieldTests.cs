    ...
    internal C(object o)
    {
        ...
        E2 += p => {};
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("event", "E1", "Consider declaring").WithLocation(15, 14));
        }
...
@"class C
{
    ...
    static object G;
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal object F;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F").WithArguments("field", "F", "Consider declaring").WithLocation(3, 21),
                // (3,21): warning CS0649: Field 'C.F' is never assigned to, and will always have its default value null
                //     internal object F;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "F").WithArguments("C.F", "null").WithLocation(3, 21),
                // (4,19): warning CS8618: Non-nullable field 'G' is uninitialized. Consider declaring the field as nullable.
                //     static object G;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G").WithArguments("field", "G", "Consider declaring").WithLocation(4, 19),
                // (4,19): warning CS0169: The field 'C.G' is never used
                //     static object G;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "G").WithArguments("C.G").WithLocation(4, 19));
        }
...
#nullable disable
    C() { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     static C() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "G", "Consider declaring").WithLocation(7, 12));
        }
...
#nullable disable
    static C() { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     C() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F", "Consider declaring").WithLocation(7, 5));
        }
...
@"internal class C<T> where T : new()
{
    ...
    internal T F4 = default(T);
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal T F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(3, 16),
...
#pragma warning disable 0649
    ...
    private object[]? F4;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private object F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(5, 20),
                // (7,24): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     internal object?[] F3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3").WithArguments("field", "F3", "Consider declaring").WithLocation(7, 24));
        }
    ...
    internal C(object x, object y)
    {
        ...
        F4 = new[] { x, y };
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F3", "Consider declaring").WithLocation(7, 14),
                // (7,14): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     internal C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(7, 14),
                // (15,14): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     internal C(object x, object y)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F3", "Consider declaring").WithLocation(15, 14),
                // (15,14): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     internal C(object x, object y)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(15, 14));
        }
...
#pragma warning disable 0649
    ...
    private readonly object[]? F4;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private readonly object F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(5, 29),
                // (7,33): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     internal readonly object?[] F3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3").WithArguments("field", "F3", "Consider declaring").WithLocation(7, 33));
        }
...
#pragma warning disable 0169
    private static object F;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static object F;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F").WithArguments("field", "F", "Consider declaring").WithLocation(4, 27));
        }
...
@"class C
{
    private static object P { get; set; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static object P { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P").WithArguments("property", "P", "Consider declaring").WithLocation(3, 27));
        }
...
class C
{
    private static event D E;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static event D E;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E").WithArguments("event", "E", "Consider declaring").WithLocation(5, 28));
        }
...
#pragma warning disable 0169
    ...
    private static object P4 { get; set; } = new object();
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static object F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(4, 27),
                // (6,36): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     private readonly static object F3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3").WithArguments("field", "F3", "Consider declaring").WithLocation(6, 36),
                // (8,27): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     private static object P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring").WithLocation(8, 27),
                // (10,27): warning CS8618: Non-nullable property 'P3' is uninitialized. Consider declaring the property as nullable.
                //     private static object P3 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P3").WithArguments("property", "P3", "Consider declaring").WithLocation(10, 27));
        }
    ...
    static C()
    {
        ...
        P6 = new object();
            ...
            comp.VerifyDiagnostics(
                ...
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F4", "Consider declaring").WithLocation(16, 12),
                // (16,12): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P1", "Consider declaring").WithLocation(16, 12),
                // (16,12): warning CS8618: Non-nullable property 'P4' is uninitialized. Consider declaring the property as nullable.
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P4", "Consider declaring").WithLocation(16, 12),
                // (16,12): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(16, 12));
        }
    ...
    where V : struct
{
    ...
    private static V? P12 { get; } = default;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static T P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring").WithLocation(7, 22),
                ...
                //     private static U P5 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P5").WithArguments("property", "P5", "Consider declaring").WithLocation(11, 22));
        }
    ...
    static C()
    {
        ...
        E3 += d;
            ...
            comp.VerifyDiagnostics(
                ...
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("event", "E4", "Consider declaring").WithLocation(12, 12));
        }
    ...
    static C()
    {
        ...
        F3 = new object();
            ...
            comp.VerifyDiagnostics(
                ...
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(8, 12),
                // (8,12): warning CS8618: Non-nullable field 'F2' is uninitialized. Consider declaring the field as nullable.
                //     static C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider declaring").WithLocation(8, 12));
        }
    ...
    class C
    {
        ...
        event D E2;
            ...
            comp.VerifyDiagnostics(
                ...
                //         static object F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(9, 23),
                // (10,23): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //         static object P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring").WithLocation(10, 23),
                // (11,24): warning CS8618: Non-nullable event 'E1' is uninitialized. Consider declaring the event as nullable.
                //         static event D E1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E1").WithArguments("event", "E1", "Consider declaring").WithLocation(11, 24),
                // (12,16): warning CS8618: Non-nullable field 'F2' is uninitialized. Consider declaring the field as nullable.
                //         object F2;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F2").WithArguments("field", "F2", "Consider declaring").WithLocation(12, 16),
                // (13,16): warning CS8618: Non-nullable property 'P2' is uninitialized. Consider declaring the property as nullable.
                //         object P2 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P2").WithArguments("property", "P2", "Consider declaring").WithLocation(13, 16),
                // (14,17): warning CS8618: Non-nullable event 'E2' is uninitialized. Consider declaring the event as nullable.
                //         event D E2;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E2").WithArguments("event", "E2", "Consider declaring").WithLocation(14, 17));
        }
    ...
    internal C(object x, object y, string z) : base()
    {
        F3 = z;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider declaring").WithLocation(7, 13),
                // (7,13): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     private C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F3", "Consider declaring").WithLocation(7, 13),
                // (23,14): warning CS8618: Non-nullable field 'F2' is uninitialized. Consider declaring the field as nullable.
                //     internal C(object x, object y, string z) : base()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider declaring").WithLocation(23, 14),
                // (23,14): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     internal C(object x, object y, string z) : base()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(23, 14));
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public S1(object obj1, object obj2) : this() // 4
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S1").WithArguments("property", "Prop", "Consider declaring").WithLocation(15, 12));
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public S1(object obj1, object obj2) : this() // 2
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S1").WithArguments("field", "field", "Consider declaring").WithLocation(13, 12));
        }
    ...
    internal C(object x, object y)
    {
        ...
        P4 = new[] { x, y };
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P3", "Consider declaring").WithLocation(7, 14),
                // (7,14): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     internal C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P1", "Consider declaring").WithLocation(7, 14),
                // (15,14): warning CS8618: Non-nullable property 'P3' is uninitialized. Consider declaring the property as nullable.
                //     internal C(object x, object y)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P3", "Consider declaring").WithLocation(15, 14),
                // (15,14): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     internal C(object x, object y)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P1", "Consider declaring").WithLocation(15, 14));
        }
    ...
    private C(T t)
    {
        ...
        P4 = t;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private C(T t)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider declaring").WithLocation(12, 13),
                // (12,13): warning CS8618: Non-nullable property 'P2' is uninitialized. Consider declaring the property as nullable.
                //     private C(T t)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P2", "Consider declaring").WithLocation(12, 13),
                // (12,13): warning CS8618: Non-nullable property 'P3' is uninitialized. Consider declaring the property as nullable.
                //     private C(T t)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P3", "Consider declaring").WithLocation(12, 13));
        }
...
#pragma warning disable 0169
    ...
    private C()
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //     private C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P1", "Consider declaring").WithLocation(10, 13),
                // (10,13): warning CS8618: Non-nullable property 'P4' is uninitialized. Consider declaring the property as nullable.
                //     private C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P4", "Consider declaring").WithLocation(10, 13),
                // (10,13): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     private C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F1", "Consider declaring").WithLocation(10, 13));
        }
...
class C<T> where T : struct
{
    ...
    C() { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     B() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "B").WithArguments("field", "F2", "Consider declaring").WithLocation(11, 5),
                // (5,5): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     A() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "A").WithArguments("field", "F1", "Consider declaring").WithLocation(5, 5));
...
#nullable disable
    ...
    private T? P4 { get; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     private T F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(5, 15),
                // (7,15): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     private T P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring").WithLocation(7, 15),
...
#nullable disable
    ...
    private T? P4 { get; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     private T F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(6, 15),
                // (8,15): warning CS8618: Non-nullable property 'P1' is uninitialized. Consider declaring the property as nullable.
                //     private T P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring").WithLocation(8, 15),
...
class C5<T, U> where T : A where U : T
{
    ...
    U G5;
            ...
            comp.VerifyDiagnostics(
                ...
                //     T F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1").WithArguments("field", "F1", "Consider declaring").WithLocation(6, 7),
                // (7,7): warning CS8618: Non-nullable field 'G1' is uninitialized. Consider declaring the field as nullable.
                //     U G1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G1").WithArguments("field", "G1", "Consider declaring").WithLocation(7, 7),
                // (15,7): warning CS8618: Non-nullable field 'F3' is uninitialized. Consider declaring the field as nullable.
                //     T F3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3").WithArguments("field", "F3", "Consider declaring").WithLocation(15, 7),
                // (16,7): warning CS8618: Non-nullable field 'G3' is uninitialized. Consider declaring the field as nullable.
                //     U G3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G3").WithArguments("field", "G3", "Consider declaring").WithLocation(16, 7),
                // (20,7): warning CS8618: Non-nullable field 'F4' is uninitialized. Consider declaring the field as nullable.
                //     T F4;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F4").WithArguments("field", "F4", "Consider declaring").WithLocation(20, 7),
                // (21,7): warning CS8618: Non-nullable field 'G4' is uninitialized. Consider declaring the field as nullable.
                //     U G4;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G4").WithArguments("field", "G4", "Consider declaring").WithLocation(21, 7),
                // (25,7): warning CS8618: Non-nullable field 'F5' is uninitialized. Consider declaring the field as nullable.
                //     T F5;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F5").WithArguments("field", "F5", "Consider declaring").WithLocation(25, 7),
                // (26,7): warning CS8618: Non-nullable field 'G5' is uninitialized. Consider declaring the field as nullable.
                //     U G5;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G5").WithArguments("field", "G5", "Consider declaring").WithLocation(26, 7));
        }
    ...
    internal C(string s)
    {
        if (s.Length > 0)
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal C(string s)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P", "Consider declaring").WithLocation(6, 14),
                // (6,14): warning CS8618: Non-nullable field 'F' is uninitialized. Consider declaring the field as nullable.
                //     internal C(string s)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F", "Consider declaring").WithLocation(6, 14));
        }
    ...
    internal S(string s)
    {
        if (s.Length > 0)
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal S(string s)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("property", "P", "Consider declaring").WithLocation(6, 14),
                ...
                //     internal S(string s)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("field", "F", "Consider declaring").WithLocation(6, 14),
...
struct S
{
    ...
    static object F2;
            ...
            comp.VerifyDiagnostics(
                ...
                //     static object F2;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F2").WithArguments("field", "F2", "Consider declaring").WithLocation(6, 19));
        }
    ...
    static S()
    {
        F2 = new object();
            ...
            comp.VerifyDiagnostics(
                ...
                //     static S()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("field", "F3", "Consider declaring").WithLocation(8, 12));
        }
...
public interface I
{
    ...
    public static event System.Action E1; // 4, 5
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static object F2; // 2
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F2").WithArguments("field", "F2", "Consider declaring").WithLocation(5, 26),
                ...
                //     public static object F3 { get; set; } // 3
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3").WithArguments("property", "F3", "Consider declaring").WithLocation(6, 26),
                ...
                //     public static event System.Action E1; // 4, 5
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E1").WithArguments("event", "E1", "Consider declaring").WithLocation(7, 39),
    ...
    static I() // 2, 3, 4
    {
        ...
        E3 = () => {};
            ...
            comp.VerifyDiagnostics(
                ...
                //     static I() // 2, 3, 4
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "I").WithArguments("property", "F2", "Consider declaring").WithLocation(16, 12),
                ...
                //     static I() // 2, 3, 4
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "I").WithArguments("event", "E1", "Consider declaring").WithLocation(16, 12),
                ...
                //     static I() // 2, 3, 4
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "I").WithArguments("field", "F1", "Consider declaring").WithLocation(16, 12)
                );
        }
    ...
    C()
    {
        ...
        L(new object());
            ...
            comp.VerifyDiagnostics(
                ...
                //     C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "G", "Consider declaring").WithLocation(6, 5),
                ...
                //     C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F", "Consider declaring").WithLocation(6, 5));
        }
...
", options: WithNullableEnable());
            comp.VerifyDiagnostics(
                ...
                //     internal C(object o) { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "_f", "Consider declaring").WithLocation(11, 14),
                // (13,14): warning CS8618: Non-nullable field '_f' is uninitialized. Consider declaring the field as nullable.
                //     internal C(string s)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "_f", "Consider declaring").WithLocation(13, 14),
                // (19,14): warning CS8618: Non-nullable field '_f' is uninitialized. Consider declaring the field as nullable.
                //     internal C(int x)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "_f", "Consider declaring").WithLocation(19, 14),
                // (28,14): warning CS8618: Non-nullable field '_f' is uninitialized. Consider declaring the field as nullable.
                //     internal C(char c)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "_f", "Consider declaring").WithLocation(28, 14));
        }
    ...
    public C3()
    {
        ...
        if (Prop is null)
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //     public C1() // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C1").WithArguments("property", "Prop", "Consider declaring").WithLocation(9, 12));
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public string BaseProp { get; set; } // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "BaseProp").WithArguments("property", "BaseProp", "Consider declaring").WithLocation(4, 19),
...
";
            ...
            comp.GetDiagnosticsForSyntaxTree(CompilationStage.Compile, comp.SyntaxTrees[0], filterSpanWithinTree: null, includeEarlierStages: true)
                .Verify(
                    ...
                    //     public static readonly string Value1; // 1
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Value1").WithArguments("field", "Value1", "Consider declaring").WithLocation(4, 35));
            ...
            comp.GetDiagnosticsForSyntaxTree(CompilationStage.Compile, comp.SyntaxTrees[1], filterSpanWithinTree: null, includeEarlierStages: true)
                .Verify(
                    ...
                    //     public static readonly string Value2; // 2
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Value2").WithArguments("field", "Value2", "Consider declaring").WithLocation(4, 35));
...
public class C
{
    ...
    public string S { get; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     public C() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "S", "Consider declaring").WithLocation(4, 12));
...
public class C
{
    public string S { get; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     public string S { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("property", "S", "Consider declaring").WithLocation(4, 19));
    ...
    static void Main()
    {
        new C() { f = { f2 = null }};
            ...
            diagnostics.Verify(
                ...
                //     public B f;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "f").WithArguments("field", "f", "Consider declaring").WithLocation(8, 14).WithWarningAsError(warnAsError));
        ...
        public void CopyConstructor_01()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string Prop { get; init; } // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Prop").WithArguments("property", "Prop", "Consider declaring").WithLocation(6, 19),
                ...
                //     public Rec(Rec other) // 2
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Rec").WithArguments("property", "Prop", "Consider declaring").WithLocation(7, 12));
        }
        ...
        public void CopyConstructor_02()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public Rec(Rec other) // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Rec").WithArguments("property", "Prop", "Consider declaring").WithLocation(4, 12));
        }
        ...
        public void CopyConstructor_05()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public Rec(Rec other) { } // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Rec").WithArguments("property", "Prop", "Consider declaring").WithLocation(9, 12));
        }
    }
}
