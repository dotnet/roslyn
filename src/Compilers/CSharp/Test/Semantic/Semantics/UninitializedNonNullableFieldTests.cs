...
class C<T> where T : struct
{
    ...
    C() { }
            ...
            comp.VerifyDiagnostics(
                ...
                // (10,5): error CS8627: A nullable type parameter must be known to be a value type or non-nullable reference type. Please use language version 'preview' or greater to use annotations with unconstrained type parameters, or consider adding a 'class', 'struct', or type constraint.
                //     T? F3;
