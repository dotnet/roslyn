...
// (29,11): error CS0121: The call is ambiguous between the following methods or properties: 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)' and 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)'
//         i.Method<string>(1, x, 1);
Diagnostic(ErrorCode.ERR_AmbigCall, "Method<string>").WithArguments("I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)", "I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)").WithLocation(29, 11),
// (32,11): error CS0121: The call is ambiguous between the following methods or properties: 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)' and 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)'
//         i.Method<string>(1, x, 1);
Diagnostic(ErrorCode.ERR_AmbigCall, "Method<string>").WithArguments("I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)", "I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)").WithLocation(32, 11),
// (35,11): error CS0121: The call is ambiguous between the following methods or properties: 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)' and 'I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)'
//         i.Method<string>(1, x, 1);
Diagnostic(ErrorCode.ERR_AmbigCall, "Method<string>").WithArguments("I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)", "I1<int, int>.Method<string>(int, System.Func<int, int, string>, int)").WithLocation(35, 11));
        }
