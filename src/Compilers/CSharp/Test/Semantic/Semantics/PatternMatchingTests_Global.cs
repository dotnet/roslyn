...
";
...

            {
                ...
                compilation.VerifyDiagnostics(
                    // (3,6): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // bool b { get; } = (1 is int x1);
                    ...
                    // (7,6): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // bool d { get; } = (2 is int x2);
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "d").WithLocation(7, 6),
                    // (9,6): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // bool f { get; } = (3 is int x3);
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "f").WithLocation(9, 6),
                    // (12,6): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // bool h { get; } = H.Dummy((41 is int x4),
                    ...
                    // (15,6): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // bool x5 { get; } = 
...
";
...

            {
                ...
                compilation.VerifyDiagnostics(
                    // (3,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action b = H.Dummy(1 is int x1);
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "b").WithLocation(3, 21),
                    // (4,9): error CS0103: The name 'x1' does not exist in the current context
                    // H.Dummy(x1);
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "x1").WithArguments("x1").WithLocation(4, 9),
                    // (7,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action d = H.Dummy(2 is int x2);
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "d").WithLocation(7, 21),
                    // (9,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action f = H.Dummy(3 is int x3);
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "f").WithLocation(9, 21),
                    // (12,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action h = H.Dummy((41 is int x4),
                    ...
                    // (15,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action x5 = 
                    Diagnostic(ErrorCode.ERR_NamespaceUnexpected, "x5").WithLocation(15, 21),
                    // (18,21): error CS0116: A namespace or a top-level entry point cannot directly contain members such as fields or properties
                    // event System.Action i = H.Dummy(5 is int x6),
