...
";
        ...
        public void ThrowStatement_02()
        {
            ...
            var comp = CreateCompilation(text, options: TestOptions.DebugExe, parseOptions: DefaultParseOptions);
            comp.VerifyEmitDiagnostics();
            CompileAndVerify(comp).VerifyIL("<top-level-statements-entry-point>", displaySequencePoints: true, useEnhancedSequencePointDisplay: true, expectedIL:
@"
{
  // Code size        2 (0x2)
  .maxstack  1
...
";
            var comp = CreateCompilation(text, options: TestOptions.DebugExe, parseOptions: DefaultParseOptions);
            comp.VerifyEmitDiagnostics();
            CompileAndVerify(comp, expectedOutput: "3").VerifyIL("<top-level-statements-entry-point>", displaySequencePoints: true, useEnhancedSequencePointDisplay: true, expectedIL:
@"
{
  // Code size       20 (0x14)
  .maxstack  2
