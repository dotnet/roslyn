    ...
    static void New()
    {
        ...
        var d5 = new D5((ref R x, ref R y) => ref x);
            ...
            comp.VerifyDiagnostics(
                ...
                // (12,50): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         D3 d3 = (ref R x, scoped ref R y) => ref x;
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(12, 50),
                // (13,43): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         D5 d5 = (ref R x, ref R y) => ref x;
                ...
                // (19,56): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d3 = (D3)((ref R x, scoped ref R y) => ref x);
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(19, 56),
                // (20,49): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d5 = (D5)((ref R x, ref R y) => ref x);
                ...
                // (26,58): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d3 = new D3((ref R x, scoped ref R y) => ref x);
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(26, 58),
                // (27,51): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d5 = new D5((ref R x, ref R y) => ref x);
...
class Program
{
    ...
    static void New()
    {
        ...
        var d5 = new D5(M3);
            ...
            var comp = CreateCompilation(source);
            comp.VerifyDiagnostics(
                // (10,46): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //     static ref R M3(ref R x, ref R y) => ref x;
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(10, 46),
                // (11,53): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //     static ref R M5(ref R x, scoped ref R y) => ref x;
    ...
    static void New()
    {
        ...
        var d5 = new D5(delegate(ref R x, ref R y) { return ref x; });
            ...
            comp.VerifyDiagnostics(
                ...
                // (12,64): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         D3 d3 = delegate(ref R x, scoped ref R y) { return ref x; };
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(12, 64),
                // (13,57): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         D5 d5 = delegate(ref R x, ref R y) { return ref x; };
                ...
                // (19,70): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d3 = (D3)(delegate(ref R x, scoped ref R y) { return ref x; });
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(19, 70),
                // (20,63): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d5 = (D5)(delegate(ref R x, ref R y) { return ref x; });
                ...
                // (26,72): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d3 = new D3(delegate(ref R x, scoped ref R y) { return ref x; });
                Diagnostic(ErrorCode.ERR_RefReturnScopedParameter, "x").WithArguments("x").WithLocation(26, 72),
                // (27,65): error CS9080: Cannot return a parameter by reference 'x' because it is scoped to the current method
                //         var d5 = new D5(delegate(ref R x, ref R y) { return ref x; });
