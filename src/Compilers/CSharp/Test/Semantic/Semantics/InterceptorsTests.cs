...
public class InterceptorsTests : CSharpTestBase
{
    ...
    [Theory, WorkItem("https://github.com/dotnet/roslyn/issues/71714")]
...
""";
    ...
    [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/71657")]
    public void ReceiverCapturedToTemp_StructReadonlyRefReceiver()
    {
        var source = CSharpTestSource.Parse("""
            using System;
    ...
    [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/71657")]
    public void ReceiverNotCapturedToTemp_StructRefReadonlyReceiver()
    {
        var source = CSharpTestSource.Parse("""
            using System;
        ...
        var interceptors = CSharpTestSource.Parse($$"""
            ...
            {
                {{locationSpecifier.GetInterceptsLocationAttributeSyntax()}}
                public static void M1(this ref readonly S s) => Console.WriteLine(1);
            }
            """, "Interceptors.cs", RegularWithInterceptors);
        ...
        verifier.VerifyIL("S.M0", """
            {
              ...
              .maxstack  1
              IL_0000:  ldarg.0
              IL_0001:  call       "void C.M1(ref readonly S)"
              IL_0006:  ret
            }
            """);
        ...
        model = comp.GetSemanticModel(source);
        var method = model.GetInterceptorMethod(node);
        Assert.Equal("void C.M1(this ref readonly S s)", method.ToTestDisplayString());
    }
