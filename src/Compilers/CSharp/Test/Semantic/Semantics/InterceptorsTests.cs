...
public class InterceptorsTests : CSharpTestBase
{
    ...
    private static readonly CSharpParseOptions RegularWithInterceptors = TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "global");
    private static readonly CSharpParseOptions RegularPreviewWithInterceptors = TestOptions.RegularPreview.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "global");
    ...
    public void FeatureFlag_Granular_01()
    {
        ...
        var comp = CreateCompilation([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS"));
        comp.VerifyEmitDiagnostics(
        ...
        comp = CreateCompilation([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1.NS2"));
        comp.VerifyEmitDiagnostics(
            // (8,10): error CS9137: The 'interceptors' feature is not enabled in this namespace. Add '<InterceptorsNamespaces>$(InterceptorsNamespaces);NS1</InterceptorsNamespaces>' to your project.
            //         [InterceptsLocation(1, "eY+urAo7Kg2rsKgGSGjShwIAAAA=")]
            Diagnostic(ErrorCode.ERR_InterceptorsFeatureNotEnabled, "InterceptsLocation").WithArguments("<InterceptorsNamespaces>$(InterceptorsNamespaces);NS1</InterceptorsNamespaces>").WithLocation(8, 10));

        var verifier = CompileAndVerify([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1"), expectedOutput: "1");
        verifier.VerifyDiagnostics();

        verifier = CompileAndVerify([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1;NS2"), expectedOutput: "1");
        verifier.VerifyDiagnostics();
    }
    ...
    {
        test(TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS"), expectedOutput: null,
        ...
        test(TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1.NS2"), expectedOutput: null,
            // Interceptors.cs(7,10): error CS9137: The 'interceptors' experimental feature is not enabled in this namespace. Add '<InterceptorsNamespaces>$(InterceptorsNamespaces);NS1</InterceptorsNamespaces>' to your project.
            //         [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "eY+urAo7Kg2rsKgGSGjShwIAAABQcm9ncmFtLmNz")]
            Diagnostic(ErrorCode.ERR_InterceptorsFeatureNotEnabled, "global::System.Runtime.CompilerServices.InterceptsLocationAttribute").WithArguments("<InterceptorsNamespaces>$(InterceptorsNamespaces);NS1</InterceptorsNamespaces>").WithLocation(7, 10));

        test(TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1"), expectedOutput: "1");

        test(TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "NS1;NS2"), expectedOutput: "1");
    ...
    public void FeatureFlag_Granular_02()
    {
        ...
        {
            var comp = CreateCompilation([source, interceptor, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, featureValue));
            comp.VerifyEmitDiagnostics(
        ...
        {
            var verifier = CompileAndVerify([source, interceptor, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, featureValue), expectedOutput: "1");
            verifier.VerifyDiagnostics();
        }
    }
    ...
    public void FeatureFlag_Granular_03()
    {
        ...
        var comp = CreateCompilation([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, ""));
        comp.VerifyEmitDiagnostics(
    ...
    public void FeatureFlag_Granular_04()
    {
        ...
        var verifier = CompileAndVerify([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "global"), expectedOutput: "1");
        verifier.VerifyDiagnostics();

        verifier = CompileAndVerify([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "global"), expectedOutput: "1");
        verifier.VerifyDiagnostics();
    }
    ...
    public void FeatureFlag_Granular_05()
    {
        ...
        var comp = CreateCompilation([source, interceptors, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "global.A"));
        comp.VerifyEmitDiagnostics(
...
""";
    ...
    public void GetInterceptorMethod_03()
    {
        ...
        var comp = CreateCompilation(new[] { source, interceptorSource, s_attributesSource }, parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "Interceptors"));
    ...
    public void GetInterceptorMethod_09(bool featureExists)
    {
        ...
        var comp = CreateCompilation(new[] { source, interceptorSource, s_attributesSource }, parseOptions: featureExists ? TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "") : TestOptions.Regular);
    ...
    public void GetInterceptorMethod_10()
    {
        ...
        var comp = CreateCompilation(new[] { source, interceptorSource, s_attributesSource }, parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "Interceptors;Interceptors"));
    ...
    public void GetInterceptorMethod_11()
    {
        ...
        var comp = CreateCompilation(new[] { source, s_attributesSource }, parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "Interceptors"));
    ...
    public void GetInterceptorMethod_12()
    {
        ...
        var comp = CreateCompilation([], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "Interceptors"));
    ...
    public void GetInterceptorMethod_13(string @namespace)
    {
        ...
        var comp = CreateCompilation(new[] { source, interceptorSource, s_attributesSource }, parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, @namespace));
    ...
    public void GetInterceptorMethod_14()
    {
        ...
        var comp = CreateCompilation([source, interceptorSource, s_attributesSource], parseOptions: TestOptions.Regular.WithFeature(CodeAnalysis.FeatureFlag.InterceptorsNamespaces, "Interceptors.Nested"));
