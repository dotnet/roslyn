...
#nullable disable
    static object F2() => C2;
            ...
            void verify(CSharpParseOptions parseOptions, params string[] expectedAnalyzedKeys)
            {
                ...
                comp.CompilationData = new NullableWalker.NullableAnalysisData();
                ...
                var actualAnalyzedKeys = GetNullableDataKeysAsStrings(comp.CompilationData);
...
{methodDirectives}
    static void Main() {{ A.M(null); }}
            ...
            var actualAnalyzedKeys = GetNullableDataKeysAsStrings(comp.CompilationData, requiredAnalysis: true);
...
#nullable enable
            ...
            static void verify(string source, string[] expectedAnalyzedKeys, params DiagnosticDescription[] expectedDiagnostics)
            {
                ...
                AssertEx.Equal(expectedAnalyzedKeys, GetNullableDataKeysAsStrings(comp.CompilationData, requiredAnalysis: true));
                AssertEx.Equal(expectedAnalyzedKeys, GetIsNullableEnabledMethods(comp.CompilationData));
...
";
            ...
            static void verify(string source, string[] expectedAnalyzedKeys, params DiagnosticDescription[] expectedDiagnostics)
            {
                ...
                var actualAnalyzedKeys = GetIsNullableEnabledMethods(comp.CompilationData, key => ((MethodSymbol)key).ToTestDisplayString());
                AssertEx.Equal(expectedAnalyzedKeys, actualAnalyzedKeys);
            }
        }
