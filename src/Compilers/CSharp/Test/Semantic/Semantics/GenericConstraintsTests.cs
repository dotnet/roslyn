...
";
            CreateCompilation(code, options: TestOptions.UnsafeReleaseDll)
                .VerifyDiagnostics(
                    ...
                    // (12,9): error CS0208: Cannot take the address of, get the size of, or declare a pointer to a managed type ('MyStruct<U>')
                    //         M2<U>(&myStruct);
                    Diagnostic(ErrorCode.ERR_ManagedAddr, "M2<U>").WithArguments("MyStruct<U>").WithLocation(12, 9),
