...
";
            CreateCompilation(code, options: TestOptions.UnsafeReleaseDll, parseOptions: TestOptions.Regular7_3)
                .VerifyDiagnostics(
                    // (12,12): error CS8370: Feature 'unmanaged constructed types' is not available in C# 7.3. Please use language version 8.0 or greater.
                    //     public MyStruct<int>.InnerStruct* ms;
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7_3, "MyStruct<int>.InnerStruct*").WithArguments("unmanaged constructed types", "8.0").WithLocation(12, 12)
                );
