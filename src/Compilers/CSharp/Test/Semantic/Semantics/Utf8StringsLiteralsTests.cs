...
";
            ...
            comp.VerifyDiagnostics(
                // (6,9): error CS9504: The type 'ReadOnlySpan<byte>' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter 'T' in the generic type or method 'C.PrintType<T>(T)'
                //         PrintType(@"hello"u8);
