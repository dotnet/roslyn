    ...
    static void Main()
    {
        ...
        i.ToString();
            ...
            comp.VerifyDiagnostics(
                // (5,17): warning CS8599: Creating a null value of a non-nullable type.
                //         var s = default(string);
                Diagnostic(ErrorCode.WRN_DefaultOfNonNullableType, "default(string)").WithLocation(5, 17));
    ...
    static void F<T>() where T : class
    {
        ...
        t.ToString();
            ...
            comp.VerifyDiagnostics(
                // (5,17): warning CS8599: Creating a null value of a non-nullable type.
                //         var s = default(T);
                Diagnostic(ErrorCode.WRN_DefaultOfNonNullableType, "default(T)").WithLocation(5, 17),
    ...
    static void G(string x, string? y)
    {
        ...
        F(ref t4).ToString();
            ...
            comp.VerifyDiagnostics(
                ...
                // (7,15): warning CS8619: Nullability of reference types in value of type '(string, string?)' doesn't match target type '(string, string)'.
                //         F(ref t1).ToString();
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "t1").WithArguments("(string, string?)", "(string, string)").WithLocation(7, 15),
                ...
                // (11,15): warning CS8619: Nullability of reference types in value of type '(string?, string?)' doesn't match target type '(string?, string)'.
                //         F(ref t3).ToString();
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "t3").WithArguments("(string?, string?)", "(string?, string)").WithLocation(11, 15),
                // (11,9): warning CS8602: Possible dereference of a null reference.
                //         F(ref t3).ToString();
    ...
    static void G()
    {
        ...
        F(default).ToString();
            ...
            comp.VerifyDiagnostics(
                ...
                // (6,11): warning CS8599: Creating a null value of a non-nullable type.
                //         F(default(object)).ToString();
                Diagnostic(ErrorCode.WRN_DefaultOfNonNullableType, "default(object)").WithLocation(6, 11),
                // (8,11): warning CS8599: Creating a null value of a non-nullable type.
                //         F(default(string)).ToString();
                Diagnostic(ErrorCode.WRN_DefaultOfNonNullableType, "default(string)").WithLocation(8, 11));
        }
