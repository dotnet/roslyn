...
";
            ...
            var options = new CompilerAnalyzerConfigOptionsProvider(ImmutableDictionary<object, AnalyzerConfigOptions>.Empty, new AnalyzerConfigOptionsDictionary(ImmutableDictionary<string, string>.Empty.Add("a", "abc").Add("b", "def")));
...
";
            ...
            var optionsProvider = new CompilerAnalyzerConfigOptionsProvider(ImmutableDictionary<object, AnalyzerConfigOptions>.Empty, new AnalyzerConfigOptionsDictionary(builder.ToImmutable()));
            ...
            var newOptionsProvider = optionsProvider.WithGlobalOptions(new AnalyzerConfigOptionsDictionary(builder.ToImmutable()));
