...
";
        ...
        [Fact]
        public void GetInterceptsLocationAttributeArgument_01()
        {
            ...
            var source1 = ("""
                ...
                {
                    public class InterceptsLocationAttribute : Attribute { public InterceptsLocationAttribute(string locationSpecifier) { } }
                }
        ...
        {
            record InterceptorInfo(string locationSpecifier, object data);
...
#pragma warning disable RSEXPERIMENTAL002 // test
                        ...
                        var locationSpecifier = context.GetInterceptsLocationAttributeArgument((InvocationExpressionSyntax)context.Node);
                        if (locationSpecifier is null)
                        {
                            return null; // generator wants to intercept call, but host thinks call is not interceptable. bug.
                        }

                        // generator is careful to propagate only incrementally equatable data (i.e., not syntax nodes or symbols).
                ...
                context.RegisterSourceOutput(interceptorInfos, (context, interceptorInfos) =>
                {
                    ...
                    {
                        // Note: the value of 'locationSpecifier' is already a string literal.
                        // No need to pass through to 'SymbolDisplay.FormatLiteral(string, bool quote)'.
