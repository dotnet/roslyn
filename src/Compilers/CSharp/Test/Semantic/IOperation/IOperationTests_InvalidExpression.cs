...
";
            string expectedOperationTree = @"
IArrayInitializer (2 elements) (OperationKind.ArrayInitializer, IsInvalid, Language: C#) (Syntax: '{ { { 1, 1  ...  { 2, 2 } }')
  Element Values(2):
      IArrayInitializer (1 elements) (OperationKind.ArrayInitializer, IsInvalid, Language: C#) (Syntax: '{ { 1, 1 } }')
        Element Values(1):
...
";
            string expectedOperationTree = @"
IArrayCreationExpression (Element Type: X) (OperationKind.ArrayCreationExpression, Type: X[], IsInvalid, Language: C#) (Syntax: 'new X[Program] { { 1 } }')
  Dimension Sizes(1):
