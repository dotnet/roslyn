...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  ...
  Catch clauses(1):
      ICatchClause (Exception type: System.Exception) ([1] OperationKind.CatchClause) (Syntax: 'catch (Exce ... }')
        Locals: Local_1: System.Exception ex
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: '(Exception ex)')
            Variables: Local_1: System.Exception ex
            Initializer: 
              null
        Filter: 
          IBinaryOperatorExpression (BinaryOperatorKind.GreaterThan) ([1] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 'i > 0')
            Left: 
              IParameterReferenceExpression: i ([0] OperationKind.ParameterReferenceExpression, Type: System.Int32) (Syntax: 'i')
            Right: 
              ILiteralExpression ([1] OperationKind.LiteralExpression, Type: System.Int32, Constant: 0) (Syntax: '0')
        Handler: 
          IBlockStatement (1 statements) ([2] OperationKind.BlockStatement) (Syntax: '{ ... }')
            IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'throw ex;')
              Expression: 
                IThrowExpression ([0] OperationKind.ThrowExpression, Type: System.Exception) (Syntax: 'throw ex;')
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  ...
  Catch clauses(1):
      ICatchClause (Exception type: System.IO.IOException) ([1] OperationKind.CatchClause) (Syntax: 'catch (Syst ... }')
        Locals: Local_1: System.IO.IOException e
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: '(System.IO. ... xception e)')
        ...
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: '(System.IO. ... xception e)')
            ...
            Initializer: 
              null
        Filter: 
          IBinaryOperatorExpression (BinaryOperatorKind.NotEquals) ([1] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 'e.Message != null')
            Left: 
              IPropertyReferenceExpression: System.String System.Exception.Message { get; } ([0] OperationKind.PropertyReferenceExpression, Type: System.String) (Syntax: 'e.Message')
                Instance Receiver: 
                  ILocalReferenceExpression: e ([0] OperationKind.LocalReferenceExpression, Type: System.IO.IOException) (Syntax: 'e')
            Right: 
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  ...
  Catch clauses(2):
      ICatchClause (Exception type: System.IO.IOException) ([1] OperationKind.CatchClause) (Syntax: 'catch (Syst ... }')
        ...
        Handler: 
          IBlockStatement (0 statements) ([1] OperationKind.BlockStatement) (Syntax: '{ ... }')
      ICatchClause (Exception type: System.Exception) ([2] OperationKind.CatchClause) (Syntax: 'catch (Syst ... }')
        Locals: Local_1: System.Exception e
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: '(System.Exception e)')
        ...
        Filter: 
          IBinaryOperatorExpression (BinaryOperatorKind.NotEquals) ([1] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 'e.Message != null')
            Left: 
              IPropertyReferenceExpression: System.String System.Exception.Message { get; } ([0] OperationKind.PropertyReferenceExpression, Type: System.String) (Syntax: 'e.Message')
                Instance Receiver: 
                  ILocalReferenceExpression: e ([0] OperationKind.LocalReferenceExpression, Type: System.Exception) (Syntax: 'e')
            Right: 
              IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: System.String, Constant: null, IsImplicit) (Syntax: 'null')
                Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: True, IsUserDefined: False) (MethodSymbol: null)
                Operand: 
...
";
            string expectedOperationTree = @"
ITryStatement ([0] OperationKind.TryStatement, IsInvalid) (Syntax: 'try ... }')
  Body: 
    IBlockStatement (0 statements) ([0] OperationKind.BlockStatement) (Syntax: '{ ... }')
  Catch clauses(2):
      ICatchClause (Exception type: System.IO.IOException) ([1] OperationKind.CatchClause) (Syntax: 'catch (Syst ... }')
        ...
        Handler: 
          IBlockStatement (0 statements) ([1] OperationKind.BlockStatement) (Syntax: '{ ... }')
      ICatchClause (Exception type: System.IO.IOException) ([2] OperationKind.CatchClause, IsInvalid) (Syntax: 'catch (Syst ... }')
        Locals: Local_1: System.IO.IOException e
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration, IsInvalid) (Syntax: '(System.IO. ... xception e)')
            Variables: Local_1: System.IO.IOException e
            Initializer: 
              null
        Filter: 
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  Body: 
    IBlockStatement (0 statements) ([0] OperationKind.BlockStatement) (Syntax: '{ ... }')
  Catch clauses(1):
      ICatchClause (Exception type: null) ([1] OperationKind.CatchClause) (Syntax: 'catch ... }')
        ExceptionDeclarationOrExpression: 
          null
        Filter: 
          null
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  ...
  Finally: 
    IBlockStatement (1 statements) ([1] OperationKind.BlockStatement) (Syntax: '{ ... }')
      IExpressionStatement ([0] OperationKind.ExpressionStatement) (Syntax: 'Console.WriteLine(s);')
        Expression: 
          IInvocationExpression (void System.Console.WriteLine(System.String value)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: 'Console.WriteLine(s)')
            Instance Receiver: 
              null
            Arguments(1):
                IArgument (ArgumentKind.Explicit, Matching Parameter: value) ([0] OperationKind.Argument) (Syntax: 's')
                  IParameterReferenceExpression: s ([0] OperationKind.ParameterReferenceExpression, Type: System.String) (Syntax: 's')
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  Body: 
    IBlockStatement (1 statements, 1 locals) ([0] OperationKind.BlockStatement) (Syntax: '{ ... }')
  ...
  Catch clauses(1):
      ICatchClause (Exception type: System.Exception) ([1] OperationKind.CatchClause) (Syntax: 'catch (Exce ... }')
        ...
        ExceptionDeclarationOrExpression: 
          null
        Filter: 
          IIsPatternExpression ([0] OperationKind.IsPatternExpression, Type: System.Boolean) (Syntax: 'o is string s')
            Expression: 
              IParameterReferenceExpression: o ([0] OperationKind.ParameterReferenceExpression, Type: System.Object) (Syntax: 'o')
            Pattern: 
              IDeclarationPattern (Declared Symbol: System.String s) ([1] OperationKind.DeclarationPattern) (Syntax: 'string s')
        Handler: 
          IBlockStatement (0 statements) ([1] OperationKind.BlockStatement) (Syntax: '{ ... }')
  Finally: 
    null
...
ITryStatement ([0] OperationKind.TryStatement) (Syntax: 'try ... }')
  ...
  Catch clauses(1):
      ICatchClause (Exception type: System.Exception) ([1] OperationKind.CatchClause) (Syntax: 'catch (Exce ... }')
        ...
        ExceptionDeclarationOrExpression: 
          IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration) (Syntax: '(Exception e)')
            Variables: Local_1: System.Exception e
            Initializer: 
              null
        Filter: 
          IIsPatternExpression ([1] OperationKind.IsPatternExpression, Type: System.Boolean) (Syntax: 'o is string s')
            Expression: 
              IParameterReferenceExpression: o ([0] OperationKind.ParameterReferenceExpression, Type: System.Object) (Syntax: 'o')
            Pattern: 
              IDeclarationPattern (Declared Symbol: System.String s) ([1] OperationKind.DeclarationPattern) (Syntax: 'string s')
...
";
            string expectedOperationTree = @"
ICatchClause (Exception type: System.Int32) ([1] OperationKind.CatchClause, IsInvalid) (Syntax: 'catch (int  ... }')
  Locals: Local_1: System.Int32 e
  ExceptionDeclarationOrExpression: 
    IVariableDeclaration (1 variables) ([0] OperationKind.VariableDeclaration, IsInvalid) (Syntax: '(int e)')
...
";
            string expectedOperationTree = @"
IBinaryOperatorExpression (BinaryOperatorKind.NotEquals) ([0] OperationKind.BinaryOperatorExpression, Type: System.Boolean) (Syntax: 's != null')
  Left: 
    IParameterReferenceExpression: s ([0] OperationKind.ParameterReferenceExpression, Type: System.String) (Syntax: 's')
  Right: 
    IConversionExpression (Implicit, TryCast: False, Unchecked) ([1] OperationKind.ConversionExpression, Type: System.String, Constant: null, IsImplicit) (Syntax: 'null')
