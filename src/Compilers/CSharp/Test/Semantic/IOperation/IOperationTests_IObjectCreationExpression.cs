...
";
            var expectedDiagnostics = new DiagnosticDescription[] {
                // file.cs(24,36): error CS0029: Cannot implicitly convert type 'int' to 'B'
                //         F e1 = new() { Property2 = 1 };
                Diagnostic(ErrorCode.ERR_NoImplicitConv, "1").WithArguments("int", "B").WithLocation(24, 36),
                // file.cs(25,22): error CS1922: Cannot initialize type 'F' with a collection initializer because it does not implement 'System.Collections.IEnumerable'
                //         F e2 = new() { "" };
                Diagnostic(ErrorCode.ERR_CollectionInitRequiresIEnumerable, @"{ """" }").WithArguments("F").WithLocation(25, 22)
            };
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithCollectionInitializer()
        {
            string source = @"
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithNestedCollectionInitializer()
        {
            string source = @"
using System.Collections.Generic;
using System.Linq;
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithMemberAndCollectionInitializers()
        {
            string source = @"
using System.Collections.Generic;
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithArrayInitializer()
        {
            string source = @"
class C
{
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithInvalidInitializer()
        {
            string source = @"
class C
{
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithInvalidMemberInitializer()
        {
            string source = @"
class C
{
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithInvalidCollectionInitializer()
        {
            string source = @"
using System.Collections.Generic;
...
";
            var expectedDiagnostics = new DiagnosticDescription[] {
                // file.cs(8,33): error CS0117: 'C' does not contain a definition for 'MissingField'
                //         C x1 = /*<bind>*/new(){ MissingField = new List<int>() { 1 }}/*</bind>*/;
                Diagnostic(ErrorCode.ERR_NoSuchMember, "MissingField").WithArguments("C", "MissingField").WithLocation(8, 33)
            };
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithDynamicMemberInitializer_01()
        {
            string source = @"
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithDynamicMemberInitializer_02()
        {
            string source = @"
#pragma warning disable 0169
class A
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationWithDynamicMemberInitializer_03()
        {
            string source = @"
#pragma warning disable 0169
class A
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationDynamicCollectionInitializer()
        {
            string source = @"
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerWithRefAddMethod()
        {
            string source = @"
using System;
using System.Collections;
...
";
            var expectedDiagnostics = new DiagnosticDescription[] {
                // file.cs(10,33): error CS1954: The best overloaded method match 'C.Add(ref int)' for the collection initializer element cannot be used. Collection initializer 'Add' methods cannot have ref or out parameters.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasParamModifiers, "1").WithArguments("C.Add(ref int)").WithLocation(10, 33),
                // file.cs(10,36): error CS1954: The best overloaded method match 'C.Add(ref int)' for the collection initializer element cannot be used. Collection initializer 'Add' methods cannot have ref or out parameters.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasParamModifiers, "2").WithArguments("C.Add(ref int)").WithLocation(10, 36),
                // file.cs(10,39): error CS1954: The best overloaded method match 'C.Add(ref int)' for the collection initializer element cannot be used. Collection initializer 'Add' methods cannot have ref or out parameters.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasParamModifiers, "3").WithArguments("C.Add(ref int)").WithLocation(10, 39)
            };
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerWithDefaultParameterAddMethod()
        {
            string source = @"
using System;
using System.Collections;
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerWithParamsAddMethod()
        {
            string source = @"
using System.Collections;
using System.Collections.Generic;
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerExtensionAddMethod()
        {
            string source = @"
using System.Collections;
using System.Collections.Generic;
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerStaticAddMethod()
        {
            string source = @"
using System;
using System.Collections;
...
";
            var expectedDiagnostics = new DiagnosticDescription[] {
                // file.cs(10,33): error CS1921: The best overloaded method match for 'C.Add(int)' has wrong signature for the initializer element. The initializable Add must be an accessible instance method.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasWrongSignature, "1").WithArguments("C.Add(int)").WithLocation(10, 33),
                // file.cs(10,36): error CS1921: The best overloaded method match for 'C.Add(int)' has wrong signature for the initializer element. The initializable Add must be an accessible instance method.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasWrongSignature, "2").WithArguments("C.Add(int)").WithLocation(10, 36),
                // file.cs(10,39): error CS1921: The best overloaded method match for 'C.Add(int)' has wrong signature for the initializer element. The initializable Add must be an accessible instance method.
                //         C c = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_InitializerAddHasWrongSignature, "3").WithArguments("C.Add(int)").WithLocation(10, 39)
            };
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationCollectionInitializerAddMethodOnInterface()
        {
            string source = @"
using System.Collections.Generic;
...
";
            var expectedDiagnostics = new DiagnosticDescription[] {
                ...
                //         IInterface iinterface = new() /*<bind>*/{ 1, 2, 3 }/*</bind>*/;
                Diagnostic(ErrorCode.ERR_IllegalTargetTypeForNew, "new() /*<bind>*/{ 1, 2, 3 }").WithArguments("IInterface").WithLocation(21, 33)
            };

            string expectedOperationTree = @"
IObjectOrCollectionInitializerOperation (OperationKind.ObjectOrCollectionInitializer, Type: IInterface, IsInvalid) (Syntax: '{ 1, 2, 3 }')
  Initializers(3):
      IInvocationOperation (virtual void IInterface.Add(System.Int32 i)) (OperationKind.Invocation, Type: System.Void, IsInvalid, IsImplicit) (Syntax: '1')
        Instance Receiver: 
          IInstanceReferenceOperation (ReferenceKind: ImplicitReceiver) (OperationKind.InstanceReference, Type: IInterface, IsInvalid, IsImplicit) (Syntax: 'new() /*<bi ... { 1, 2, 3 }')
        Arguments(1):
            IArgumentOperation (ArgumentKind.Explicit, Matching Parameter: i) (OperationKind.Argument, Type: null, IsInvalid, IsImplicit) (Syntax: '1')
              ...
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
      IInvocationOperation (virtual void IInterface.Add(System.Int32 i)) (OperationKind.Invocation, Type: System.Void, IsInvalid, IsImplicit) (Syntax: '2')
        Instance Receiver: 
          IInstanceReferenceOperation (ReferenceKind: ImplicitReceiver) (OperationKind.InstanceReference, Type: IInterface, IsInvalid, IsImplicit) (Syntax: 'new() /*<bi ... { 1, 2, 3 }')
        Arguments(1):
            IArgumentOperation (ArgumentKind.Explicit, Matching Parameter: i) (OperationKind.Argument, Type: null, IsInvalid, IsImplicit) (Syntax: '2')
              ...
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
      IInvocationOperation (virtual void IInterface.Add(System.Int32 i)) (OperationKind.Invocation, Type: System.Void, IsInvalid, IsImplicit) (Syntax: '3')
        Instance Receiver: 
          IInstanceReferenceOperation (ReferenceKind: ImplicitReceiver) (OperationKind.InstanceReference, Type: IInterface, IsInvalid, IsImplicit) (Syntax: 'new() /*<bi ... { 1, 2, 3 }')
        Arguments(1):
            IArgumentOperation (ArgumentKind.Explicit, Matching Parameter: i) (OperationKind.Argument, Type: null, IsInvalid, IsImplicit) (Syntax: '3')
              ILiteralOperation (OperationKind.Literal, Type: System.Int32, Constant: 3, IsInvalid) (Syntax: '3')
              InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationNestedObjectInitializerNoSet()
        {
            string source = @"
class C1
{
...
";
        ...
        [CompilerTrait(CompilerFeature.IOperation)]
        [Fact]
        public void TargetTypedObjectCreationNestedCollectionInitializerNoSet()
        {
            string source = @"
using System.Collections;
using System.Collections.Generic;
