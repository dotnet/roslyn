    ...
    int x1(int x2)
    {
        ...
        return x3 + 1;
            ...
            var options = TestOptions.ReleaseDll.WithSpecificDiagnosticOptions(
                new[] { Roslyn.Utilities.KeyValuePair.Create("CA9999_UseOfVariableThatStartsWithX", ReportDiagnostic.Suppress) });
...
public class C : NotFound
{
    int x1(int x2)
    {
        ...
        return x3 + 1;
            ...
            // TODO: Compilation create doesn't accept analyzers anymore.
            var options = TestOptions.ReleaseDll.WithSpecificDiagnosticOptions(
                new[] { Roslyn.Utilities.KeyValuePair.Create("CA9999_UseOfVariableThatStartsWithX", ReportDiagnostic.Error) });
