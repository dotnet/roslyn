...
";
            var compilation = CreateCompilationWithMscorlib45(new[] { source, IsInitOnlyTypeDefinition }, parseOptions: TestOptions.RegularPreview);
            compilation.VerifyDiagnostics(
...
class C
{
    ...
    int P2 { get; set; }
            ...
            var compilation = CreateCompilation(new[] { source1, IsInitOnlyTypeDefinition }, parseOptions: TestOptions.RegularPreview);
            compilation.VerifyDiagnostics();
