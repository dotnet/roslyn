...
";
            ...
            builder.Add(tree);
            var analyzerConfigOptions = new AnalyzerConfigOptionsDictionary(ImmutableDictionary<string, string>.Empty.Add("generated_code", "true"));
            ...
            builder.Add(tree);
            analyzerConfigOptions = new AnalyzerConfigOptionsDictionary(ImmutableDictionary<string, string>.Empty.Add("generated_code", "TRUE"));
            analyzerConfigOptionsPerTreeBuilder.Add(tree, analyzerConfigOptions);

            // (3) "generated_code = false"
            tree = CSharpSyntaxTree.ParseText(string.Format(source, treeNum++), path: "MyGeneratedFileFalse.cs");
            builder.Add(tree);
            analyzerConfigOptions = new AnalyzerConfigOptionsDictionary(ImmutableDictionary<string, string>.Empty.Add("generated_code", "false"));
            analyzerConfigOptionsPerTreeBuilder.Add(tree, analyzerConfigOptions);
