  ...
  partial class C<T1>
  {
    partial void M(int x2) {}
            ...
            VerifyEvents(q,
                ...
                "SymbolDeclaredCompilationEvent(System System)",
                "SymbolDeclaredCompilationEvent(Runtime Runtime)",
                "SymbolDeclaredCompilationEvent(CompilerServices CompilerServices)",
                ...
                "SymbolDeclaredCompilationEvent(Microsoft Microsoft)",
                "SymbolDeclaredCompilationEvent(CodeAnalysis CodeAnalysis)",
