...
";
        ...
        {
            var compilation = CreateCompilationWithNone(string.Empty, parseOptions: new CSharpParseOptions().WithPreprocessorSymbols(new[] { "1" }));
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            var compilation = CreateCompilationWithNone(string.Empty, parseOptions: new CSharpParseOptions().WithLanguageVersion((LanguageVersion)10000));
            compilation.VerifyDiagnostics(
        ...
        {
            var compilation = CreateCompilationWithNone(string.Empty, parseOptions: new CSharpParseOptions().WithDocumentationMode(unchecked((DocumentationMode)100)));
            compilation.VerifyDiagnostics(
        ...
        public void CompilingCodeWithInvalidParseOptionsInMultipleSyntaxTreesShouldReportThemAll()
        {
            ...
            var compilation = CreateCompilationWithNone(new[] { syntaxTree1, syntaxTree2, syntaxTree3 });
