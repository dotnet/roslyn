...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols
{
    public class PEParameterSymbolTests : CSharpTestBase
    {
        ...
        public void NoParameterNames()
        {
            ...
            // }
            MetadataReference reference = DesktopRuntimeUtil.CreateReflectionEmitAssembly(moduleBuilder =>
                {
...
@"class C
{
    static void M(I o)
    {
        o.M(0, value: 2);
            ...
            CSharpCompilation compilation = CreateCompilation(source, new[] { reference });
        ...
        {
            MetadataReference vbComp = CreateVisualBasicCompilation(@"
Public Class Class1
...
";
            CSharpCompilation compilation = CreateCompilationWithMscorlib45(source, new[] { vbComp }, options: TestOptions.DebugExe, parseOptions: TestOptions.Regular);
            compilation.VerifyDiagnostics(
            ...
            MethodSymbol m = compilation.GetMember<MethodSymbol>("Class1.Test");

            Assert.Equal("void Class1.Test(out System.Object x, ref System.Object y, [System.Int32 z = -1])", m.ToTestDisplayString());

            ParameterSymbol x = m.Parameters[0];
            ParameterSymbol y = m.Parameters[1];
            ParameterSymbol z = m.Parameters[2];
