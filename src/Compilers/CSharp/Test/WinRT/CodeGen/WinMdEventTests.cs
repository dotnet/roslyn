...
";
            ...
            var comp1 = CreateCompilationRaw(source1, WinRtRefs, TestOptions.ReleaseWinMD, TestOptions.Regular, "Lib");

            var serializationRef = TestReferences.NetFx.v4_0_30319.System_Runtime_Serialization;

            var comp2 = CreateCompilationRaw(source2, WinRtRefs.Concat(new MetadataReference[] { new CSharpCompilationReference(comp1), serializationRef, SystemXmlRef }), TestOptions.ReleaseExe);
...
@"class C
{
    ...
    static void M()
    {
        ...
        var f = E = null;
            ...
            var comp = CreateCompilationRaw(source, WinRtRefs, TestOptions.ReleaseWinMD);
            comp.VerifyDiagnostics(
