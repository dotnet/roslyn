...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    ...
    public class WinMdMetadataTests : CSharpTestBase
    {
        ...
        public void FunctionPrototypeForwarded()
        {
            ...
            var pt = ((PEParameterSymbol)(func.Parameters[0])).TypeWithAnnotations.Type as PENamedTypeSymbol;
        ...
        public void TypeForwardingRenaming()
        {
            ...
            Assert.Equal(func.ReturnTypeWithAnnotations.Type.ToTestDisplayString(), "System.Uri");
        }
        ...
        public void WinMdColorType()
        {
            ...
            Assert.Equal(((Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE.PENamedTypeSymbol)
                ((((Microsoft.CodeAnalysis.CSharp.Symbols.PropertySymbol)(blk)).GetMethod).ReturnTypeWithAnnotations.Type)).ContainingModule.ToString(),
        ...
        public void IReferenceToINullableType()
        {
            ...
            Assert.Equal("ulong?",
                ...
                (((Microsoft.CodeAnalysis.CSharp.Symbols.MethodSymbol)puint).ReturnTypeWithAnnotations.Type)).ToString());
        }
