...
Block[B4] - Exit
    ...
    Statements (0)");
        ...
        [Fact]
        public void ObjectCreationFlow_IndexedProperties()
        {
            var source1 =
@"Imports System
...
Block[B5] - Exit
    ...
    Statements (0)";
            ...
            VerifyFlowGraphAndDiagnosticsForTest<BlockSyntax>(compilation2, expectedFlowGraph, expectedDiagnostics);
        }
    }
}
