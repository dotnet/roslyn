...
";
        ...
        [Fact, CompilerTrait(CompilerFeature.IOperation)]
        public void ILockStatement_LockObject_Conditional()
        {
            var source = """
                using System;
                using System.Threading;
            ...
            var expectedOperationTree = """
                ILockOperation (OperationKind.Lock, Type: null) (Syntax: 'lock (b ? l ... }')
                  Expression:
                    IConditionalOperation (OperationKind.Conditional, Type: System.Threading.Lock) (Syntax: 'b ? l1 : l2')
                      Condition:
                        ILocalReferenceOperation: b (OperationKind.LocalReference, Type: System.Boolean) (Syntax: 'b')
                      WhenTrue:
                        ILocalReferenceOperation: l1 (OperationKind.LocalReference, Type: System.Threading.Lock) (Syntax: 'l1')
                      WhenFalse:
                        ILocalReferenceOperation: l2 (OperationKind.LocalReference, Type: System.Threading.Lock) (Syntax: 'l2')
                  Body:
                    IBlockOperation (0 statements) (OperationKind.Block, Type: null) (Syntax: '{ ... }')
                """;
        ...
        [Fact, CompilerTrait(CompilerFeature.IOperation)]
        public void ILockStatement_LockObject_Conditional_Object()
        {
            var source = """
                using System;
                using System.Threading;
            ...
            var expectedOperationTree = """
                ILockOperation (OperationKind.Lock, Type: null) (Syntax: 'lock (b ? l ... }')
                  Expression:
                    IConditionalOperation (OperationKind.Conditional, Type: System.Object) (Syntax: 'b ? l : o')
                      Condition:
                        ILocalReferenceOperation: b (OperationKind.LocalReference, Type: System.Boolean) (Syntax: 'b')
                      WhenTrue:
            ...
            {
                // (7,21): warning CS9214: A value of type 'System.Threading.Lock' converted to a different type will use likely unintended monitor-based locking in 'lock' statement.
                // /*<bind>*/lock (b ? l : o)
                Diagnostic(ErrorCode.WRN_ConvertingLock, "l").WithLocation(7, 21)
            };
        ...
        [Fact, CompilerTrait(CompilerFeature.IOperation)]
        public void ILockStatement_LockObject_Coalesce()
        {
            var source = """
                using System;
                using System.Threading;
            ...
            var expectedOperationTree = """
                ILockOperation (OperationKind.Lock, Type: null) (Syntax: 'lock (l1 ?? ... }')
                  Expression:
                    ICoalesceOperation (OperationKind.Coalesce, Type: System.Threading.Lock) (Syntax: 'l1 ?? l2')
                      Expression:
                        ILocalReferenceOperation: l1 (OperationKind.LocalReference, Type: System.Threading.Lock) (Syntax: 'l1')
