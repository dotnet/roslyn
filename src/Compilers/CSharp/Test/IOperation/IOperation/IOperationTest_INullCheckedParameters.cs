...
public class C
{
    ...
    Block[B4] - Exit
        Predecessors: [B3]
        Statements (0)";
            VerifyFlowGraphAndDiagnosticsForTest<AccessorDeclarationSyntax>(source, expected, DiagnosticDescription.None, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
        }
