...
@"    }
        ...
        public void Interceptors()
        {
            ...
            var verifier = CompileAndVerify(files.ToArrayAndFree(), parseOptions: TestOptions.Regular.WithFeature(FeatureFlag.InterceptorsNamespaces, "global"), expectedOutput: makeExpectedOutput());
