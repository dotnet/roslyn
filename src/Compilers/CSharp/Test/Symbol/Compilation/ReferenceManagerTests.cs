...
";
            ...
            var libV1 = CreateCompilationRaw(
                sourceLibV1,
                assemblyName: "Lib",
...
";
            ...
            var libV2 = CreateCompilationRaw(
                sourceLibV2,
                assemblyName: "Lib",
                references: new[] { MinCorlibRef },
                options: s_signedDll);
...
";
            ...
            var refLibV1 = CreateCompilationRaw(
               sourceRefLibV1,
               assemblyName: "RefLibV1",
...
namespace Microsoft.TeamFoundation.WebAccess.Common
{
    public class CachedRegistry
    {
        public static void Main(string[] args)
        {
            ...
            var compilation = CreateCompilationRaw(new List<SyntaxTree> { tree }, new[] { MscorlibRef, r1, r2_SysCore }, new CSharpCompilationOptions(OutputKind.ConsoleApplication), "Test");
...
";
        ...
        public void PortableLibrary()
        {
            ...
            var pl = CreateCompilationRaw(plSource, new[] { MscorlibPP7Ref, SystemRuntimePP7Ref });
            var r1 = new CSharpCompilationReference(pl);

            var mainSource = @"public class D : C { }";

            // w/o facades:
            var main = CreateCompilationRaw(mainSource, new MetadataReference[] { r1, MscorlibFacadeRef }, options: TestOptions.ReleaseDll);
            main.VerifyDiagnostics(
            ...
            // facade specified:
            main = CreateCompilationRaw(mainSource, new MetadataReference[] { r1, MscorlibFacadeRef, SystemRuntimeFacadeRef });
            main.VerifyDiagnostics();
        }
...
";
        ...
        {
            var corlib1 = CreateCompilationRaw("");
        ...
        public void ReferenceSupersession_WeakNames1()
        {
            ...
            {
                MscorlibRef_v4_0_30316_17626,
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").EmitToImageReference(),
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference(),
            });
        ...
        public void ReferenceSupersession_AliasesErased()
        {
            ...
            {
                MscorlibRef_v4_0_30316_17626,
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""0.0.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference(),
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.1"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference(),
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference(),
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference(),
                CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.1.0.0"")] public class C {}", new[] { MscorlibRef }, assemblyName: "C").ToMetadataReference().
...
";
            ...
            var c = CreateCompilationRaw(source, new[]
            {
...
", new[] { aRef }, TestOptions.ReleaseDll.WithMetadataReferenceResolver(resolver));
        ...
        public void MissingAssemblyResolution_AliasesMerge()
        {
            ...
            var b1Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b2Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public class B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b3Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public class B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();

            var aRef = CreateCompilationRaw("public class A : B { }", new[] { MscorlibRef, b1Ref }, assemblyName: "A").EmitToImageReference();
            var dRef = CreateCompilationRaw("public class D : B { }", new[] { MscorlibRef, b2Ref }, assemblyName: "D").EmitToImageReference();
...
", new[] { MscorlibRef, aRef, dRef },
        ...
        public void MissingAssemblyResolution_WeakIdentities1()
        {
            // c - a -> "b,v1,PKT=null" 
            //   - d -> "b,v2,PKT=null"
            var b1Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface B { }", new[] { MscorlibRef }, assemblyName: "B").EmitToImageReference();
            var b2Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public interface B { }", new[] { MscorlibRef }, assemblyName: "B").EmitToImageReference();
            var b3Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public interface B { }", new[] { MscorlibRef }, assemblyName: "B").EmitToImageReference();
            var b4Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""4.0.0.0"")] public interface B { }", new[] { MscorlibRef }, assemblyName: "B").EmitToImageReference();

            var aRef = CreateCompilationRaw(@"public interface A : B { }", new[] { MscorlibRef, b1Ref }, assemblyName: "A").EmitToImageReference();
            var dRef = CreateCompilationRaw(@"public interface D : B { }", new[] { MscorlibRef, b2Ref }, assemblyName: "D").EmitToImageReference();
        ...
        public void MissingAssemblyResolution_BindingToExplicitReference_WorseVersion()
        {
            ...
            //          e -> "b,v1"
            //   - "b,v1"  
            var b1Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b2Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();

            var dRef = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface D : B { }", new[] { MscorlibRef, b2Ref }, options: s_signedDll, assemblyName: "D").EmitToImageReference();
            var eRef = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface E : B { }", new[] { MscorlibRef, b1Ref }, options: s_signedDll, assemblyName: "E").EmitToImageReference();
            ...
            var aRef = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface A : D, E { }", new[] { MscorlibRef, dRef, eRef },
            ...
            var c = CreateCompilationRaw("public class C : A { }", new[] { MscorlibRef, aRef, b1Ref },
        ...
        public void MissingAssemblyResolution_BindingToExplicitReference_BetterVersion()
        {
            ...
            //          e -> "b,v1"
            //   - "b,v2"  
            var b1Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface B { }", references: new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b2Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public interface B { }", references: new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            ...
            var c = CreateCompilationRaw("public class C : A { }", new[] { MscorlibRef, aRef, b2Ref },
                s_signedDll.WithMetadataReferenceResolver(resolverC));
        ...
        public void MissingAssemblyResolution_BindingToImplicitReference1()
        {
            ...
            var aRef = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface A : D, E { }", new[] { MscorlibRef, dRef, eRef, b1Ref, b2Ref },
        ...
        public void MissingAssemblyResolution_BindingToImplicitReference2()
        {
            ...
            var b1Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b2Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b3Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            var b4Ref = CreateCompilationRaw(@"[assembly: System.Reflection.AssemblyVersion(""4.0.0.0"")] public interface B { }", new[] { MscorlibRef }, options: s_signedDll, assemblyName: "B").EmitToImageReference();
            ...
            var c = CreateCompilationRaw("public class C : A { }", new[] { MscorlibRef, aRef },
                s_signedDll.WithMetadataReferenceResolver(resolverC));
        ...
        public void MissingAssemblyResolution_Supersession_FxUnification()
        {
            ...
            //     b -> "mscorlib, v4"
            //          "System, v4"
            var aRef = CreateCompilationRaw(@"public interface A { System.Diagnostics.Process PA { get; } }", new[] { TestReferences.NetFx.v2_0_50727.mscorlib, TestReferences.NetFx.v2_0_50727.System },
                options: options, assemblyName: "A").EmitToImageReference();

            var bRef = CreateCompilationRaw(@"public interface B { System.Diagnostics.Process PB { get; } }", new[] { MscorlibRef_v4_0_30316_17626, TestReferences.NetFx.v4_0_30319.System },
        ...
        public void MissingAssemblyResolution_Supersession_StrongNames()
        {
            ...
            // c - a -> "C, v2"
            //     b -> "C, v1"
            var aRef = CreateCompilationRaw(@"public interface A { C CA { get; } }", new[] { MscorlibRef, TestReferences.SymbolsTests.Versioning.C2 },
                options: options, assemblyName: "A").EmitToImageReference();

            var bRef = CreateCompilationRaw(@"public interface B { C CB { get; } }", new[] { MscorlibRef, TestReferences.SymbolsTests.Versioning.C1 },
                options: options, assemblyName: "B").EmitToImageReference();
