    ...
    public class CompilationCreationTests : CSharpTestBase
    {
        ...
        public void MultiTargeting1()
        {
            ...
            Assert.Equal(SymbolKind.ErrorType, asm1[1].GlobalNamespace.GetTypeMembers("Class4").
                                  Single().
                                  GetMembers("Foo").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Kind);
            ...
            var retval1 = asm2[1].GlobalNamespace.GetTypeMembers("Class4").
                          Single().
                          GetMembers("Foo").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            var retval3 = type1.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval3.Kind);
            Assert.Same(retval3, asm3[2].GlobalNamespace.GetMembers("Class1").Single());

            var retval4 = type1.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval4.Kind);
            Assert.Same(retval4, asm3[2].GlobalNamespace.GetMembers("Class2").Single());

            var retval5 = type1.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            var retval7 = type2.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval7.Kind);
            Assert.Same(retval7, asm4[2].GlobalNamespace.GetMembers("Class1").Single());

            var retval8 = type2.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval8.Kind);
            Assert.Same(retval8, asm4[2].GlobalNamespace.GetMembers("Class2").Single());

            var retval9 = type2.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            var retval15 = type4.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval15.Kind);

            var retval16 = type4.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval16.Kind);

            var retval17 = type4.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            var retval18 = type5.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval18.Kind);

            var retval19 = type5.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval19.Kind);

            var retval20 = type5.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval20.Kind);

            var retval21 = type5.GetMembers("Foo4").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval21.Kind);
            Assert.Same(retval21, asm7[1].GlobalNamespace.GetMembers("Class4").Single());

            var retval22 = type5.GetMembers("Foo5").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            retval3 = type1.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval3.Kind);
            Assert.Same(retval3, asm3[2].GlobalNamespace.GetMembers("Class1").Single());

            retval4 = type1.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval4.Kind);
            Assert.Same(retval4, asm3[2].GlobalNamespace.GetMembers("Class2").Single());

            retval5 = type1.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            retval7 = type2.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval7.Kind);
            Assert.Same(retval7, asm4[2].GlobalNamespace.GetMembers("Class1").Single());

            retval8 = type2.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval8.Kind);
            Assert.Same(retval8, asm4[2].GlobalNamespace.GetMembers("Class2").Single());

            retval9 = type2.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            retval10 = type3.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval10.Kind);
            Assert.Same(retval10, asm4[2].GlobalNamespace.GetMembers("Class1").Single());

            retval11 = type3.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval11.Kind);
            Assert.Same(retval11, asm4[2].GlobalNamespace.GetMembers("Class2").Single());

            retval12 = type3.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval12.Kind);
            Assert.Same(retval12, asm4[2].GlobalNamespace.GetMembers("Class3").Single());

            retval13 = type3.GetMembers("Foo4").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval13.Kind);
            Assert.Same(retval13, asm4[1].GlobalNamespace.GetMembers("Class4").Single());

            retval14 = type3.GetMembers("Foo5").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            retval15 = type4.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval15.Kind);

            retval16 = type4.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval16.Kind);

            retval17 = type4.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            retval18 = type5.GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval18.Kind);

            retval19 = type5.GetMembers("Foo2").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval19.Kind);

            retval20 = type5.GetMembers("Foo3").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.Equal(SymbolKind.ErrorType, retval20.Kind);

            retval21 = type5.GetMembers("Foo4").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;

            Assert.NotEqual(SymbolKind.ErrorType, retval21.Kind);
            Assert.Same(retval21, asm7[1].GlobalNamespace.GetMembers("Class4").Single());

            retval22 = type5.GetMembers("Foo5").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
...
"
        ...
        public void MultiTargeting3()
        {
            ...
            Assert.Same(retval1, asm2[1].GlobalNamespace.GetTypeMembers("Class4").
                          Single().
                          GetMembers("Bar").OfType<FieldSymbol>().Single().TypeWithAnnotations.Type);
...
"
            ...
            var retval1 = (NamedTypeSymbol)type3.GetMembers("Foo").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
            ...
            var retval3 = (NamedTypeSymbol)bar.ReturnTypeWithAnnotations.Type;
            ...
            var retval4 = foo1.ReturnTypeWithAnnotations.Type;
            ...
            Assert.Same(retval4,
                          ...
                          Single().
                          GetMembers("Foo1").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type);
            ...
            Assert.NotEqual(localC3Foo2.Parameters[0].TypeWithAnnotations.Type, x1.TypeWithAnnotations.Type);
            ...
            Assert.Equal(2, ((ArrayTypeSymbol)x1.TypeWithAnnotations.Type).Rank);

            Assert.Equal("x2", x2.Name);
            Assert.NotEqual(localC3Foo2.Parameters[1].TypeWithAnnotations.Type, x2.TypeWithAnnotations.Type);
            Assert.Equal(RefKind.Out, x2.RefKind);

            Assert.Equal("x3", x3.Name);
            Assert.Same(localC3Foo2.Parameters[2].TypeWithAnnotations.Type, x3.TypeWithAnnotations.Type);
            ...
            var retval5 = type3.GetMembers("Foo4").OfType<MethodSymbol>().Single().ReturnTypeWithAnnotations.Type;
...
";
            ...
            Assert.Same(module2, m1.ReturnTypeWithAnnotations.Type.ContainingModule);
            Assert.Same(module2, m2.ReturnTypeWithAnnotations.Type.ContainingModule);
            Assert.Same(module2, m3.ReturnTypeWithAnnotations.Type.ContainingModule);
        }
