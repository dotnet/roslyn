            ...
            var source = @"class A
{
    ...
    internal static S G = null;
            ...
            var compilation = CreateStandardCompilationWithCustomILSource(source, ilSource, appendDefaultHeader: false);
...
static class S
{
    ...
    internal static void M3<T, U>(this U u, IEnumerable<T> t) { }
            ...
            var compilation = CreateStandardCompilation(source, options: TestOptions.ReleaseDll.WithMetadataImportOptions(MetadataImportOptions.Internal));
            Action<ModuleSymbol> validator = module =>
            {
