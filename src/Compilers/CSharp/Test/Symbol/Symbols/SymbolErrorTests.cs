...
";
            ...
            CreateCompilation(text).VerifyDiagnostics(
                    // (3,25): warning CS9265: The 'set' accessor of property 'C.P' should use the backing 'field' because the other accessor is using it.
                    //     public int P { get; set { } }
                    Diagnostic(ErrorCode.WRN_AccessorDoesNotUseBackingField, "set").WithArguments("set", "C.P").WithLocation(3, 25),
                    // (4,20): warning CS9265: The 'get' accessor of property 'C.Q' should use the backing 'field' because the other accessor is using it.
                    //     public int Q { get { return 0; } set; }
