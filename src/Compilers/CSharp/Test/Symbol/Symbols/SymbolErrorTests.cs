...
";
            ...
            CreateCompilationRaw(text).VerifyDiagnostics(
...
";
        ...
        {
            var netModule = CreateCompilationRaw("", options: TestOptions.ReleaseModule, assemblyName: "lib").EmitToImageReference(expectedWarnings: new[] { Diagnostic(ErrorCode.WRN_NoRuntimeMetadataVersion) });
...
.class extern forwarder Testspace.TestType
{
	.assembly extern D2
            ...
            var forwarderCompilation = CreateCompilationRaw(
                source: string.Empty,
