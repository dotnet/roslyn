...
";
                    var comp = CreateCompilationWithStandard(src, assemblyName: "Goo1", options: TestOptions.ReleaseDll);
...
";
                    var comp = CreateCompilationWithStandard(src, assemblyName: "Goo2", options: TestOptions.ReleaseDll);
