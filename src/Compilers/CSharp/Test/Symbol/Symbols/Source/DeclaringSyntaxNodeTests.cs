...
";
            ...
            CheckDeclaringSyntaxNodes(comp, f.TypeWithAnnotations.Type, 1);  // constructed type C1<int>.
...
";
            ...
            {
                CheckDeclaringSyntaxNodes(comp, f.TypeWithAnnotations.Type, 0);
            }
        }
...
";
            ...
            var localA1Type = localA1.TypeWithAnnotations.Type;
...
";
            ...
            {
                foreach (TypeParameterSymbol tp in ((NamedTypeSymbol)f.TypeWithAnnotations.Type).TypeParameters)
                {
...
";
            ...
            var constructedC1 = fieldT.TypeWithAnnotations.Type;
