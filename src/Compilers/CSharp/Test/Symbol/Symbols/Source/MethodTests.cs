...
";
            ...
            Assert.Equal(@class, explicitOverride.ContainingType.AsSymbol);
            Assert.Equal(classMethod, explicitOverride.ImplementingMethod.AsSymbol);
            Assert.Equal(interfaceMethod, explicitOverride.ImplementedMethod.AsSymbol);
...
";
            ...
            Assert.Equal(substitutedInterface, explicitOverrideImplementedMethod.GetContainingType(context).AsSymbol);
...
";
            ...
            Assert.Equal(classC, explicitOverride.ContainingType.AsSymbol);
            Assert.Equal(methodC, explicitOverride.ImplementingMethod.AsSymbol);
            Assert.Equal(methodA, explicitOverride.ImplementedMethod.AsSymbol);
            context.Diagnostics.Verify();
        }
