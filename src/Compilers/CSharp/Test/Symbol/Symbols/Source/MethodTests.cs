...
";
            ...
            var comp = CreateExperimentalCompilationWithMscorlib45(new[] { text, text1, text2 }, MessageID.IDS_FeatureRefLocalsReturns);
...
";
            ...
            var comp1 = CreateExperimentalCompilationWithMscorlib45(text, MessageID.IDS_FeatureRefLocalsReturns);
            var compRef1 = new CSharpCompilationReference(comp1);

            var comp2 = CreateExperimentalCompilationWithMscorlib45(new string[] { text1 }, MessageID.IDS_FeatureRefLocalsReturns, new List<MetadataReference>() { compRef1 }, assemblyName: "Test2");
            ...
            var comp = CreateExperimentalCompilationWithMscorlib45(new string[] { text2 }, MessageID.IDS_FeatureRefLocalsReturns, new List<MetadataReference>() { compRef1, compRef2 }, assemblyName: "Test3");
...
";
            ...
            var parseOptions = TestOptions.Regular.WithLocalFunctionsFeature().WithRefsFeature();
