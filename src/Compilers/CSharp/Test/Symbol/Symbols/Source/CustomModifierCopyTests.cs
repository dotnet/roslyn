...
";
            var comp = CreateCompilationWithCustomILSource(source, il, targetFramework: TargetFramework.Standard);
            comp.VerifyDiagnostics();
...
";
            ...
            var comp = CreateCompilationWithNone(source, new[] { MscorlibRef, SystemCoreRef, ilRef });
            comp.VerifyDiagnostics();
...
";
            var ilRef = CompileIL(il, prependDefaultHeader: false);
            var comp1 = CreateCompilationWithNone(source1, new[] { MscorlibRef, SystemCoreRef, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp2 = CreateCompilationWithNone(source2, new[] { MscorlibRef, SystemCoreRef, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp3 = CreateCompilationWithNone(source3, new[] { MscorlibRef, SystemCoreRef, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp4 = CreateCompilationWithNone(source4, new[] { MscorlibRef, SystemCoreRef, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
