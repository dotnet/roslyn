...
";
        ...
        public void LocalTypeSubstitution1_1()
        {
            ...
            Assert.Equal(SymbolKind.ErrorType, param[0].TypeWithAnnotations.Kind);
            ...
            Assert.Equal(SymbolKind.ErrorType, param[1].TypeWithAnnotations.Kind);
...
";
            ...
            Assert.Equal(SymbolKind.ErrorType, assemblies1[0].GlobalNamespace.GetMember<MethodSymbol>("C.Test1").ReturnTypeWithAnnotations.Kind);
            ...
            Assert.Equal(SymbolKind.ErrorType, assemblies2[0].GlobalNamespace.GetMember<MethodSymbol>("C.Test1").ReturnTypeWithAnnotations.Kind);
        }
...
";
            ...
            Assert.Equal("Pia", test2.Parameters[0].TypeWithAnnotations.Type.ContainingAssembly.Name);
            Assert.IsType<UnsupportedMetadataTypeSymbol>(test2.Parameters[1].TypeWithAnnotations.Type);
...
";
            ...
            Assert.Equal("LocalTypes2", test2.Parameters[0].TypeWithAnnotations.Type.ContainingAssembly.Name);
            Assert.Equal("LocalTypes2", test2.Parameters[1].TypeWithAnnotations.Type.ContainingAssembly.Name);
...
";
            ...
            foreach (MetadataReference piaRef in new[] { piaCompilation.EmitToImageReference(), piaCompilation.ToMetadataReference() })
            {
                ...
                foreach (MetadataReference consumer1Ref in new[] { compilation1.EmitToImageReference(), compilation1.ToMetadataReference() })
                {
                    ...
                    Assert.Same(test, usePia1.GetMember<MethodSymbol>("M1").ReturnTypeWithAnnotations.Type);
                }
            }
        }
    }
