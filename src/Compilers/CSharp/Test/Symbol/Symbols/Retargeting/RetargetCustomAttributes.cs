...
";
            ...
            var c1 = CreateCompilationRaw(source1, new[] { OldMsCorLib });
            var c2 = CreateCompilationRaw(source2, new MetadataReference[] { NewMsCorLib, new CSharpCompilationReference(c1) });
