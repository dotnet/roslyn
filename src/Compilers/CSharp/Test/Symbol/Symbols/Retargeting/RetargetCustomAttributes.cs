...
";
            ...
            var c1 = CreateCompilationWithNone(source1, new[] { OldMsCorLib });
            var c2 = CreateCompilationWithNone(source2, new MetadataReference[] { NewMsCorLib, new CSharpCompilationReference(c1) });
