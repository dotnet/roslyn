...
"
            ...
            var retargetedClassCProperty1 = (PropertySymbol)retargetedClassC.GetMembers("Interface1.Property1").Single();
            {
                ...
                Assert.Equal(retargetedClassCProperty1Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Property1.TypeWithAnnotations.Type.ToTestDisplayString());
            }
            ...
            var retargetedClassCProperty4 = (PropertySymbol)retargetedClassC.GetMembers("Interface1.Property4").Single();
            {
                ...
                Assert.Equal(retargetedClassCProperty4Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Property4.TypeWithAnnotations.Type.ToTestDisplayString());
            }
            ...
            var retargetedClassCIndexer1 = FindIndexerWithParameterCount(retargetedClassC, 1);
            {
                ...
                Assert.Equal(retargetedClassCIndexer1Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Indexer1.TypeWithAnnotations.Type.ToTestDisplayString());
            }
            ...
            var retargetedClassCIndexer4 = FindIndexerWithParameterCount(retargetedClassC, 4);
            {
                ...
                Assert.Equal(retargetedClassCIndexer4Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Indexer4.TypeWithAnnotations.Type.ToTestDisplayString());
            }
            ...
            var retargetedClassCEvent1 = (EventSymbol)retargetedClassC.GetMembers("Interface1.Event1").Single();
            {
                ...
                Assert.Equal(retargetedClassCEvent1Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Event1.TypeWithAnnotations.Type.ToTestDisplayString());
            }
            ...
            var retargetedClassCEvent4 = (EventSymbol)retargetedClassC.GetMembers("Interface1.Event4").Single();
            {
                ...
                Assert.Equal(retargetedClassCEvent4Impl.TypeWithAnnotations.Type.ToTestDisplayString(), interfaceV1Event4.TypeWithAnnotations.Type.ToTestDisplayString());
            }
        }
