...
";
            ...
            verify(MetadataView(comp, assignments));
            verify(RetargetingView(comp, assignments));
            CompileAndVerify(SourceView(comp, assignments), verify: Verification.Skipped).VerifyIL("Program.M(Base, Derived)", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       15 (0xf)
  .maxstack  1
...
";
            ...
            verify(MetadataView(comp, assignments));
            verify(RetargetingView(comp, assignments));
            CompileAndVerify(SourceView(comp, assignments), verify: Verification.Skipped).VerifyIL("Program.M(Base<object>, Derived<object, string>)", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       15 (0xf)
  .maxstack  1
  // sequence point: object s1 = b.M();
...
";
            ...
            verify(MetadataView(comp, assignments));
            verify(RetargetingView(comp, assignments));
            CompileAndVerify(SourceView(comp, assignments), verify: Verification.Skipped).VerifyIL("Program.M(Base, Derived<Q>)", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       15 (0xf)
  .maxstack  1
...
";
            ...
            verify(MetadataView(comp, assignments));
            verify(RetargetingView(comp, assignments));
            CompileAndVerify(SourceView(comp, assignments), verify: Verification.Skipped).VerifyIL("Program.M(Base, Derived, Derived2)", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       22 (0x16)
  .maxstack  1
  // sequence point: object x1 = b.P;
...
";
            ...
            CompileAndVerify(vbComp, verify: Verification.Skipped).VerifyIL("Derived2.T(Base, Derived, Derived2)", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size      360 (0x168)
  .maxstack  7
...
";
            ...
            verifier.VerifyIL("Program.M1()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       63 (0x3f)
  .maxstack  5
...
");
            verifier.VerifyIL("Program.M2()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       58 (0x3a)
  .maxstack  5
  .locals init (System.Linq.Expressions.ParameterExpression V_0)
...
");
            verifier.VerifyIL("Program.M3()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size      129 (0x81)
  .maxstack  7
...
");
            verifier.VerifyIL("Program.M4()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size      129 (0x81)
  .maxstack  7
...
";
            ...
            var verifier = CompileAndVerify(comp, verify: Verification.Skipped);
            verifier.VerifyIL("Derived.M1()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       14 (0xe)
  .maxstack  2
  // sequence point: M
...
");
            verifier.VerifyIL("Derived.M2()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       13 (0xd)
  .maxstack  2
...
");
            verifier.VerifyIL("Derived.M3()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       14 (0xe)
  .maxstack  2
...
");
            verifier.VerifyIL("Derived.M4()", useEnhancedSequencePointDisplay: true, displaySequencePoints: true, expectedIL: @"
{
  // Code size       13 (0xd)
  .maxstack  2
