...
";
            ...
            var comp = CreateCompilationWithoutCovariantReturns(source).VerifyDiagnostics(
                // (9,17): error CS9331: 'Derived.M1' type must be 'object' to match implemented member '"Base.M1'
                //     string Base.M1 => null;   // 1
                ...
                // (10,17): error CS9332: 'Derived.M2()' return type must be 'object' to match implemented member 'Base.M2()'
                //     string Base.M2() => null; // 2
                ...
                // (14,17): error CS9331: 'C.M1' type must be 'object' to match implemented member 'Base.M1'
                //     string Base.M1 => null;   // 3
                Diagnostic(ErrorCode.ERR_ExplicitInterfaceMemberTypeMismatch, "M1").WithArguments("C.M1", "object", "Base.M1").WithLocation(14, 17),
                // (15,17): error CS9332: 'C.M2()' return type must be 'object' to match implemented member 'Base.M2()'
                //     string Base.M2() => null; // 4
