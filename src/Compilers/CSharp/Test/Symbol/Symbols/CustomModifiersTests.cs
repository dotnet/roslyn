...
";
            var compilation1 = CreateStandardCompilationWithCustomILSource(source, ilSource, options: TestOptions.ReleaseDll);
...
{}
";
            var compilation = CreateStandardCompilationWithCustomILSource(source, ilSource, options: TestOptions.ReleaseDll);
...
";
            var compilation = CreateStandardCompilationWithCustomILSource(source, ilSource, new[] { CSharpRef }, options: TestOptions.ReleaseExe);
