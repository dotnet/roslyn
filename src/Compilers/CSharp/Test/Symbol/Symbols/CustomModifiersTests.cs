...
";
            ...
            var compilation2 = CreateCompilationWithMscorlib461(new SyntaxTree[] { }, references: new[] { new CSharpCompilationReference(compilation1) });
...
";
            var compilation = CreateCompilationWithIL(source, ilSource, references: [CSharpRef], options: TestOptions.ReleaseExe, targetFramework: TargetFramework.Standard);
