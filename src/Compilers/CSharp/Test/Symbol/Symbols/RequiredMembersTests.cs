...
";
        ...
        comp.VerifyDiagnostics(
            ...
            //     public string P2 { get; set; }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P2").WithArguments("property", "P2", "Consider adding the \'required\' modifier or declaring").WithLocation(8, 19),
            ...
            //     public string F2;
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F2").WithArguments("field", "F2", "Consider adding the \'required\' modifier or declaring").WithLocation(9, 19)
        );
    }
...
";
        ...
        comp.VerifyDiagnostics(
            ...
            //     public C()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P2", "Consider adding the \'required\' modifier or declaring").WithLocation(11, 12),
            ...
            //     public C()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider adding the \'required\' modifier or declaring").WithLocation(11, 12),
            ...
            //     public C(int _) {}
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "P2", "Consider adding the \'required\' modifier or declaring").WithLocation(15, 12),
            ...
            //     public C(int _) {}
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "F2", "Consider adding the \'required\' modifier or declaring").WithLocation(15, 12)
        );
    }
...
";
        ...
        comp.VerifyDiagnostics(
            // (11,12): warning CS8618: Non-nullable property 'P2' must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring the property as nullable.
            //     public S() {}
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("property", "P2", "Consider adding the \'required\' modifier or declaring").WithLocation(11, 12),
            // (11,12): warning CS8618: Non-nullable field 'F2' must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring the field as nullable.
            //     public S() {}
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("field", "F2", "Consider adding the \'required\' modifier or declaring").WithLocation(11, 12)
        );
    }
...
""";
        ...
        comp.VerifyDiagnostics(
            ...
            //     public C() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "Property", "Consider declaring").WithLocation(9, 12),
            ...
            //     public C() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("field", "_field", "Consider declaring").WithLocation(9, 12)
        );
    }
...
""";
        ...
        comp.VerifyDiagnostics(
            ...
            //     public C() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "Prop3", "Consider adding the \'required\' modifier or declaring").WithLocation(8, 12)
        );
    }
...
""";
        ...
        comp.VerifyDiagnostics(
            ...
            //     public C() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "Property2", "Consider adding the \'required\' modifier or declaring").WithLocation(9, 12),
            ...
            //     public C() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "Property1", "Consider declaring").WithLocation(9, 12)
        );
    }
...
""";
        ...
        var expectedDiagnostics = new[] {
            ...
            //     private Derived()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("field", "_field", "Consider declaring").WithLocation(5, 13)
        };
...
""";
        ...
        var expectedDiagnostics = new[] {
            ...
            //     public Derived() { }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Property", "Consider declaring").WithLocation(6, 12),
...
";
    ...
    public void RequiredMemberSuppressesNullabilityWarnings_ChainedConstructor_08()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            //     protected Base() {} // 1
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Base").WithArguments("property", "Prop1", "Consider declaring").WithLocation(9, 15),
    ...
    public void RequiredMemberSuppressesNullabilityWarnings_ChainedConstructor_09A()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            //     public Derived(int unused) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop3", "Consider declaring").WithLocation(10, 12),
            ...
            //     public Derived(int unused) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop1", "Consider declaring").WithLocation(10, 12),
            ...
            //     public Derived(bool unused)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop3", "Consider declaring").WithLocation(16, 12),
            ...
            //     public Derived(bool unused)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop1", "Consider declaring").WithLocation(16, 12),
    ...
    public void RequiredMemberSuppressesNullabilityWarnings_ChainedConstructor_09B()
    {
        ...
        comp.VerifyDiagnostics(
                ...
                //     public Derived(int unused) : base()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("field", "Field3", "Consider declaring").WithLocation(17, 12),
                ...
                //     public Derived(int unused) : base()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("field", "Field1", "Consider declaring").WithLocation(17, 12),
                ...
                //     public Derived(bool unused)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("field", "Field3", "Consider declaring").WithLocation(23, 12),
                ...
                //     public Derived(bool unused)
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("field", "Field1", "Consider declaring").WithLocation(23, 12),
    ...
    public void RequiredMemberSuppressesNullabilityWarnings_ChainedConstructor_09C()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            //     public Derived(int unused) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop2", "Consider declaring").WithLocation(10, 12),
            // (10,12): warning CS8618: Non-nullable property 'Prop1' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(int unused) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop1", "Consider declaring").WithLocation(10, 12),
            ...
            //     public Derived(bool unused)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop2", "Consider declaring").WithLocation(15, 12),
            ...
            //     public Derived(bool unused)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Prop1", "Consider declaring").WithLocation(15, 12),
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_02()
    {
        ...
        var comp = CreateCompilationWithRequiredMembers(code);
        comp.VerifyDiagnostics(
            // (17,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str) : base(str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(17, 12)
        );
    }
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_03()
    {
        ...
        var comp = CreateCompilationWithRequiredMembers(code);
        comp.VerifyDiagnostics(
            // (7,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Base(string str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Base").WithArguments("property", "Str", "Consider declaring").WithLocation(7, 12)
        );
    }
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_04()
    {
        ...
        var comp = CreateCompilationWithRequiredMembers(code);
        comp.VerifyDiagnostics(
            // (16,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str) : base(str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(16, 12)
        );
    }
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_06()
    {
        ...
        var comp = CreateCompilationWithRequiredMembers(code);
        comp.VerifyDiagnostics(
            // (25,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public DerivedDerived(string str) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "DerivedDerived").WithArguments("property", "Str", "Consider declaring").WithLocation(25, 12),
            // (25,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public DerivedDerived(string str) : base()
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "DerivedDerived").WithArguments("property", "Str", "Consider declaring").WithLocation(25, 12)
        );
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_08()
    {
        ...
        comp.VerifyDiagnostics(
            // (18,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str) : base(str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(18, 12),
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_13()
    {
        ...
        var comp = CreateCompilationWithRequiredMembers(code);
        comp.VerifyDiagnostics(
            // (12,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(12, 12),
            // (12,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(12, 12)
        );
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_14()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            //     public virtual string Str { get; set; }
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Str").WithArguments("property", "Str", "Consider adding the \'required\' modifier or declaring").WithLocation(6, 27),
            // (12,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(12, 12)
        );
    ...
    public void SetsRequiredMembersHonoredForPropertyOverride_16()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            //     public Base(string str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Base").WithArguments("property", "Str", "Consider adding the \'required\' modifier or declaring").WithLocation(7, 12),
            // (17,12): warning CS8618: Non-nullable property 'Str' must contain a non-null value when exiting constructor. Consider declaring the property as nullable.
            //     public Derived(string str) : base(str)
            Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Derived").WithArguments("property", "Str", "Consider declaring").WithLocation(17, 12)
        );
