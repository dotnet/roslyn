...
";
        ...
        // PROTOTYPE(req): These errors should change with Rikki's DA changes.
        comp.VerifyDiagnostics(
            // (8,12): error CS0171: Field 'C.Field' must be fully assigned before control is returned to the caller
            //     public C(bool unused) { }
            Diagnostic(ErrorCode.ERR_UnassignedThis, "C").WithArguments("C.Field").WithLocation(8, 12),
            // (8,12): error CS0843: Auto-implemented property 'C.Prop' must be fully assigned before control is returned to the caller.
            //     public C(bool unused) { }
            Diagnostic(ErrorCode.ERR_UnassignedThisAutoProperty, "C").WithArguments("C.Prop").WithLocation(8, 12),
            // (12,9): warning CS8602: Dereference of a possibly null reference.
            //         Prop.ToString();
            Diagnostic(ErrorCode.WRN_NullReferenceReceiver, "Prop").WithLocation(12, 9),
            // (13,9): warning CS8602: Dereference of a possibly null reference.
