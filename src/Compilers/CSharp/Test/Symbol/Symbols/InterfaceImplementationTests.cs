...
";
            ...
            Assert.True(((Cci.IMethodDefinition)baseClassMethod.GetAdapter()).IsVirtual);
            Assert.True(((Cci.IMethodDefinition)baseClassPropertyGetter.GetAdapter()).IsVirtual);
            Assert.True(((Cci.IMethodDefinition)baseClassPropertySetter.GetAdapter()).IsVirtual);
...
";
            ...
            Assert.False(((Cci.IMethodDefinition)baseClassMethod.GetAdapter()).IsVirtual);
            Assert.False(((Cci.IMethodDefinition)baseClassPropertyGetter.GetAdapter()).IsVirtual);
            Assert.False(((Cci.IMethodDefinition)baseClassPropertySetter.GetAdapter()).IsVirtual);
