...
";
            ...
            VerifyEquality(type1, type2,
                ...
                expectedCompareEverything: true
            );
        }
...
";
            ...
            VerifyEquality(type1, type2,
                expectedDefault: true,
                expectedCompareEverything: true // We don't consider top-level nullability
                );
...
";
            ...
            VerifyEquality(type1, type2,
                expectedDefault: true,
                expectedCompareEverything: false // nested nullability is different
                );
...
";
            ...
            VerifyEquality(type1, type2,
                expectedDefault: true,
                expectedCompareEverything: true // nested nullability is the same
                );
        }
...
";
        ...
        private void VerifyEquality(ITypeSymbol type1, ITypeSymbol type2, bool expectedDefault, bool expectedCompareEverything)
        {
            // Symbol.Equals
            ...
            Assert.Equal(true, type1.Equals(type1, TypeSymbolEqualityComparer.Default));
            Assert.Equal(true, type2.Equals(type2, TypeSymbolEqualityComparer.Default));
            Assert.Equal(expectedDefault, type1.Equals(type2, TypeSymbolEqualityComparer.Default));
            Assert.Equal(expectedDefault, type2.Equals(type1, TypeSymbolEqualityComparer.Default));

            // TypeSymbol.Equals - CompareEverything
            Assert.Equal(true, type1.Equals(type1, TypeSymbolEqualityComparer.CompareEverything));
            Assert.Equal(true, type2.Equals(type2, TypeSymbolEqualityComparer.CompareEverything));
            Assert.Equal(expectedCompareEverything, type1.Equals(type2, TypeSymbolEqualityComparer.CompareEverything));
            Assert.Equal(expectedCompareEverything, type2.Equals(type1, TypeSymbolEqualityComparer.CompareEverything));
        }
    }
