...
@"class C
{
    ...
    static void Report(int x, int y)
    {
        System.Console.WriteLine(""{0}, {1}"", x, y);
            ...
            var compilation3 = CompileStandardAndVerify(source3, references: new[] { reference1 }, expectedOutput:
@"0, 0
1, 2
2, 4
");
...
@"class C
{
    static void M()
    {
        ...
        a[2] = a[1];
            ...
            var compilation3 = CompileStandardAndVerify(source3, references: new[] { reference1 });
...
@"class C
{
    static void M(I i)
    {
        ...
        o = i.valid_name(1);
            ...
            var compilation2 = CompileStandardAndVerify(source2, references: new[] { reference1 }, verify: Verification.Passes);
...
@"class C
{
    static void M(B b)
    {
        ...
        o = b.Q[2, 3];
            ...
            var compilation3 = CompileStandardAndVerify(source3, references: new[] { reference1 }, verify: Verification.Skipped);
...
public class B2 : A2
{
    ...
    public override void set_P(int index, object value)
    {
        Console.WriteLine(""B2.set_P({0}, ...)"", index);
            ...
            var compilation2 = CompileStandardAndVerify(source2, references: new[] { reference1 });
...
@"class C
{
    ...
    static void Invoke(I i)
    {
        ...
        i.P[6] = i.P[5];
            ...
            var compilation3 = CompileStandardAndVerify(source3, references: new[] { reference1, reference2 }, expectedOutput:
@"A2.get_P(1)
A2.set_P(2, ...)
A2.get_P(3)
A2.set_P(4, ...)
