...
@"class B
{
    static void Main()
    {
        ...
        a.P[2] = o;
            ...
            CompilationVerifier compilation2 = CompileAndVerify(source2, references: new[] { reference1 }, expectedOutput:
@"P[1]
P[2] = 2
");
...
@"class C
{
    ...
    static void Report(int x, int y)
    {
        System.Console.WriteLine(""{0}, {1}"", x, y);
            ...
            CompilationVerifier compilation3 = CompileAndVerify(source3, references: new[] { reference1 }, expectedOutput:
@"0, 0
1, 2
2, 4
");
...
@"class C
{
    static void M()
    {
        ...
        a[2] = a[1];
            ...
            CompilationVerifier compilation3 = CompileAndVerify(source3, references: new[] { reference1 });
...
");
            ...
            PropertySymbol property = @namespace.GetMember<NamedTypeSymbol>("IA").GetMember<PropertySymbol>("P");
...
@"class C
{
    static void M(I i)
    {
        ...
        o = i.valid_name(1);
            ...
            CompilationVerifier compilation2 = CompileAndVerify(source2, references: new[] { reference1 }, verify: Verification.Passes);

            var @namespace = (NamespaceSymbol)compilation2.Compilation.GlobalNamespace;
            // Indexed property with valid name.
            NamedTypeSymbol type = @namespace.GetMember<NamedTypeSymbol>("I");
...
@"class C
{
    static void M(B b)
    {
        ...
        o = b.Q[2, 3];
            ...
            CompilationVerifier compilation3 = CompileAndVerify(source3, references: new[] { reference1 }, verify: Verification.Skipped);
...
public class B2 : A2
{
    ...
    public override void set_P(int index, object value)
    {
        Console.WriteLine(""B2.set_P({0}, ...)"", index);
            ...
            CompilationVerifier compilation2 = CompileAndVerify(source2, references: new[] { reference1 });
            PortableExecutableReference reference2 = MetadataReference.CreateFromImage(compilation2.EmittedAssemblyData);
...
@"class C
{
    ...
    static void Invoke(I i)
    {
        ...
        i.P[6] = i.P[5];
            ...
            CompilationVerifier compilation3 = CompileAndVerify(source3, references: new[] { reference1, reference2 }, expectedOutput:
@"A2.get_P(1)
A2.set_P(2, ...)
A2.get_P(3)
A2.set_P(4, ...)
...
@"class C
{
    static void Main()
    {
        ...
        b.P[4] = b.P[3];
            ...
            CSharpCompilation compilation4 = CreateCompilation(source4, new[] { reference1, reference2 });
...
@"class B
{
    static void Main()
    {
        ...
        a = new IA() { P3 = { 6, 7 } };
            ...
            CompilationVerifier compilation2 = CompileAndVerify(source2, new[] { reference1 }, verify: Verification.Passes, expectedOutput:
@"P1(1).set
P2(2).get
P1(1).set
P3(3).get
...
class B
{
            ...
            CompilationVerifier compilation3 = CompileAndVerify(source3, new[] { reference1 });
        }
...
Public Interface IC
    Inherits IA, IB
End Interface";
            MetadataReference reference2 = BasicCompilationUtils.CompileToMetadata(source2, references: new[] { MscorlibRef, reference1 });
            var source3 =
@"class C
{
    static object F(IC c)
    {
        return c.P[null];
            ...
            CSharpCompilation compilation3 = CreateCompilation(source3, new[] { reference1, reference2 });
            compilation3.VerifyDiagnostics(
...
";
            ...
            PropertySymbol interfaceProperty = comp.GlobalNamespace
            ...
            NamedTypeSymbol sourceType1 = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("C");
            ...
            NamedTypeSymbol sourceType2 = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("D");
...
@"class B
{
    static void Main()
    {
        ...
        i.P[d] = o;
            ...
            CSharpCompilation compilation2 = CreateCompilationWithMscorlib40AndSystemCore(source2, new[] { reference1, CSharpRef }, TestOptions.ReleaseExe);
