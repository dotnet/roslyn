...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class NoPia : CSharpTestBase
    {
        ...
        public void HideLocalTypeDefinitions()
        {
            ...
            ModuleSymbol localTypes1 = assemblies[0].Modules[0];
            ModuleSymbol localTypes2 = assemblies[1].Modules[0];
        ...
        {
            AssemblySymbol[] assemblies1 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
            ...
            AssemblySymbol localTypes1_1 = assemblies1[0];
            AssemblySymbol localTypes2_1 = assemblies1[1];
            AssemblySymbol pia1_1 = assemblies1[2];

            NamedTypeSymbol varI1 = pia1_1.GlobalNamespace.GetTypeMembers("I1").Single();
            NamedTypeSymbol varS1 = pia1_1.GlobalNamespace.GetTypeMembers("S1").Single();
            NamespaceSymbol varNS1 = pia1_1.GlobalNamespace.GetMembers("NS1").OfType<NamespaceSymbol>().Single();
            NamedTypeSymbol varI2 = varNS1.GetTypeMembers("I2").Single();
            NamedTypeSymbol varS2 = varNS1.GetTypeMembers("S2").Single();
            ...
            AssemblySymbol[] assemblies2 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
                                        TestReferences.SymbolsTests.NoPia.Pia1,
            ...
            AssemblySymbol localTypes1_2 = assemblies2[0];
            AssemblySymbol localTypes2_2 = assemblies2[1];
            ...
            AssemblySymbol[] assemblies3 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
                                        TestReferences.SymbolsTests.NoPia.Pia1
            ...
            AssemblySymbol localTypes1_3 = assemblies3[0];
            AssemblySymbol localTypes2_3 = assemblies3[1];
            AssemblySymbol pia1_3 = assemblies3[2];
            ...
            AssemblySymbol[] assemblies4 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
                                        TestReferences.SymbolsTests.NoPia.Pia1,
            ...
            AssemblySymbol[] assemblies5 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
            ...
            AssemblySymbol localTypes1_5 = assemblies5[0];
            AssemblySymbol localTypes2_5 = assemblies5[1];
            ...
            AssemblySymbol[] assemblies6 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
            ...
            AssemblySymbol localTypes1_6 = assemblies6[0];
            AssemblySymbol localTypes2_6 = assemblies6[1];
            ...
            AssemblySymbol[] assemblies7 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
            ...
            AssemblySymbol localTypes1_7 = assemblies7[0];
            AssemblySymbol localTypes2_7 = assemblies7[1];
            ...
            AssemblySymbol[] assemblies8 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                        TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                        TestReferences.SymbolsTests.NoPia.LocalTypes2,
                                        TestReferences.SymbolsTests.NoPia.Pia4,
            ...
            AssemblySymbol localTypes1_8 = assemblies8[0];
            AssemblySymbol localTypes2_8 = assemblies8[1];
            AssemblySymbol pia4_8 = assemblies8[2];
            AssemblySymbol pia1_8 = assemblies8[3];
            ...
            AssemblySymbol[] assemblies9 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
            ...
            AssemblySymbol library1_9 = assemblies9[0];
            AssemblySymbol localTypes1_9 = assemblies9[1];

            AssemblySymbol[] assemblies10 = MetadataTestHelpers.GetSymbolsForReferences(new[]
                                    {
                                       TestReferences.SymbolsTests.NoPia.Library1,
                                       TestReferences.SymbolsTests.NoPia.LocalTypes1,
                                       TestReferences.SymbolsTests.NoPia.Pia4,
            ...
            AssemblySymbol library1_10 = assemblies10[0];
            AssemblySymbol localTypes1_10 = assemblies10[1];
...
";
            ...
            PortableExecutableReference pia1CopyLink = TestReferences.SymbolsTests.NoPia.Pia1Copy.WithEmbedInteropTypes(true);
            PortableExecutableReference pia1CopyRef = TestReferences.SymbolsTests.NoPia.Pia1Copy.WithEmbedInteropTypes(false);
            ...
            AssemblySymbol localTypes1_1 = assemblies1[4];
            AssemblySymbol localTypes2_1 = assemblies1[5];
            AssemblySymbol pia1_1 = assemblies1[0];
            ...
            AssemblySymbol localTypes1_2 = assemblies2[3];
            AssemblySymbol localTypes2_2 = assemblies2[4];
            ...
            AssemblySymbol localTypes1_3 = assemblies3[2];
            AssemblySymbol localTypes2_3 = assemblies3[3];
            ...
            AssemblySymbol localTypes1_5 = assemblies5[2];
            AssemblySymbol localTypes2_5 = assemblies5[3];
            ...
            AssemblySymbol localTypes1_6 = assemblies6[2];
            AssemblySymbol localTypes2_6 = assemblies6[3];
            ...
            AssemblySymbol pia4_7 = assemblies7[0];
            AssemblySymbol localTypes1_7 = assemblies7[2];
            AssemblySymbol localTypes2_7 = assemblies7[3];
            ...
            AssemblySymbol localTypes1_8 = assemblies8[3];
            AssemblySymbol localTypes2_8 = assemblies8[4];
            AssemblySymbol pia4_8 = assemblies8[0];
            AssemblySymbol pia1_8 = assemblies8[1];
            ...
            AssemblySymbol[] assemblies9 = MetadataTestHelpers.GetSymbolsForReferences(new MetadataReference[]
                                {
                    TestReferences.SymbolsTests.NoPia.Library1,
                    TestReferences.SymbolsTests.NoPia.Pia4,
                    TestReferences.NetFx.v4_0_21006.mscorlib,
            ...
            AssemblySymbol library1_9 = assemblies9[0];
            AssemblySymbol localTypes1_9 = assemblies9[3];

            Assert.Equal("LocalTypes1", localTypes1_9.Identity.Name);

            AssemblySymbol[] assemblies10 = MetadataTestHelpers.GetSymbolsForReferences(
                TestReferences.SymbolsTests.NoPia.Library1,
                TestReferences.SymbolsTests.NoPia.Pia4,
                TestReferences.NetFx.v4_0_21006.mscorlib,
                TestReferences.SymbolsTests.MDTestLib1,
            ...
            AssemblySymbol library1_10 = assemblies10[0];
            AssemblySymbol localTypes1_10 = assemblies10[4];
        ...
        {
            PortableExecutableReference mscorlibRef = TestReferences.SymbolsTests.MDTestLib1;
            PortableExecutableReference cyclic2Ref = TestReferences.SymbolsTests.Cyclic.Cyclic2.dll;
            PortableExecutableReference piaRef = TestReferences.SymbolsTests.NoPia.Pia1;
            PortableExecutableReference localTypes1Ref = TestReferences.SymbolsTests.NoPia.LocalTypes1;
        ...
        public void GenericsClosedOverLocalTypes1()
        {
            ...
            AssemblySymbol asmLocalTypes3 = assemblies[0];
            NamedTypeSymbol localTypes3 = asmLocalTypes3.GlobalNamespace.GetTypeMembers("LocalTypes3").Single();
        ...
        {
            PortableExecutableReference mscorlibRef = TestReferences.NetFx.v4_0_21006.mscorlib;
            PortableExecutableReference pia5Link = TestReferences.SymbolsTests.NoPia.Pia5.WithEmbedInteropTypes(true);
            PortableExecutableReference pia5Ref = TestReferences.SymbolsTests.NoPia.Pia5.WithEmbedInteropTypes(false);
            PortableExecutableReference library2Ref = TestReferences.SymbolsTests.NoPia.Library2.WithEmbedInteropTypes(false);
            PortableExecutableReference library2Link = TestReferences.SymbolsTests.NoPia.Library2.WithEmbedInteropTypes(true);
            PortableExecutableReference pia1Link = TestReferences.SymbolsTests.NoPia.Pia1.WithEmbedInteropTypes(true);
            PortableExecutableReference pia1Ref = TestReferences.SymbolsTests.NoPia.Pia1.WithEmbedInteropTypes(false);
            ...
            AssemblySymbol pia5Asm1 = tc1.GetReferencedAssemblySymbol(pia5Link);

            Assert.True(pia5Asm1.IsLinked);

            NamedTypeSymbol varI5_1 = pia5Asm1.GlobalNamespace.GetTypeMembers("I5").Single();
            ...
            AssemblySymbol pia5Asm2 = tc2.GetReferencedAssemblySymbol(pia5Ref);

            Assert.False(pia5Asm2.IsLinked);
            Assert.NotSame(pia5Asm1, pia5Asm2);

            NamedTypeSymbol varI5_2 = pia5Asm2.GlobalNamespace.GetTypeMembers("I5").Single();
            ...
            AssemblySymbol pia5Asm3 = tc3.GetReferencedAssemblySymbol(pia5Link);
            AssemblySymbol library2Asm3 = tc3.GetReferencedAssemblySymbol(library2Ref);
            ...
            NamedTypeSymbol varI7_3 = library2Asm3.GlobalNamespace.GetTypeMembers("I7").Single();
            ...
            AssemblySymbol pia5Asm4 = tc4.GetReferencedAssemblySymbol(pia5Ref);
            AssemblySymbol library2Asm4 = tc4.GetReferencedAssemblySymbol(library2Ref);
            ...
            NamedTypeSymbol varI7_4 = library2Asm4.GlobalNamespace.GetTypeMembers("I7").Single();
            ...
            AssemblySymbol pia1Asm5 = tc5.GetReferencedAssemblySymbol(pia1Link);
            AssemblySymbol pia5Asm5 = tc5.GetReferencedAssemblySymbol(pia5Link);
            AssemblySymbol library2Asm5 = tc5.GetReferencedAssemblySymbol(library2Ref);
            ...
            NamedTypeSymbol varI7_5 = library2Asm5.GlobalNamespace.GetTypeMembers("I7").Single();
            ...
            AssemblySymbol pia1Asm6 = tc6.GetReferencedAssemblySymbol(pia1Ref);
            AssemblySymbol pia5Asm6 = tc6.GetReferencedAssemblySymbol(pia5Link);
            AssemblySymbol library2Asm6 = tc6.GetReferencedAssemblySymbol(library2Ref);
            ...
            AssemblySymbol pia5Asm7 = tc7.GetReferencedAssemblySymbol(pia5Link);
            AssemblySymbol library2Asm7 = tc7.GetReferencedAssemblySymbol(library2Link);
            ...
            NamedTypeSymbol varI7_7 = library2Asm7.GlobalNamespace.GetTypeMembers("I7").Single();
        ...
        {
            PortableExecutableReference varmscorlibRef = TestReferences.NetFx.v4_0_21006.mscorlib;
            PortableExecutableReference varALink = TestReferences.SymbolsTests.NoPia.A.WithEmbedInteropTypes(true);
            PortableExecutableReference varARef = TestReferences.SymbolsTests.NoPia.A.WithEmbedInteropTypes(false);
            PortableExecutableReference varBLink = TestReferences.SymbolsTests.NoPia.B.WithEmbedInteropTypes(true);
            PortableExecutableReference varBRef = TestReferences.SymbolsTests.NoPia.B.WithEmbedInteropTypes(false);
            PortableExecutableReference varCLink = TestReferences.SymbolsTests.NoPia.C.WithEmbedInteropTypes(true);
            PortableExecutableReference varCRef = TestReferences.SymbolsTests.NoPia.C.WithEmbedInteropTypes(false);
            PortableExecutableReference varDLink = TestReferences.SymbolsTests.NoPia.D.WithEmbedInteropTypes(true);
            PortableExecutableReference varDRef = TestReferences.SymbolsTests.NoPia.D.WithEmbedInteropTypes(false);

            var tc1 = CSharpCompilation.Create("C1", references: new MetadataReference[] { varmscorlibRef, varCRef, varARef, varBLink });

            AssemblySymbol varA1 = tc1.GetReferencedAssemblySymbol(varARef);
            AssemblySymbol varB1 = tc1.GetReferencedAssemblySymbol(varBLink);
            AssemblySymbol varC1 = tc1.GetReferencedAssemblySymbol(varCRef);
            ...
            AssemblySymbol varD2 = tc2.GetReferencedAssemblySymbol(varDRef);
            ...
            AssemblySymbol varB4 = tc4.GetReferencedAssemblySymbol(varBRef);
            AssemblySymbol varC4 = tc4.GetReferencedAssemblySymbol(varCRef);
            ...
            AssemblySymbol varA5 = tc5.GetReferencedAssemblySymbol(varALink);
            AssemblySymbol varC5 = tc5.GetReferencedAssemblySymbol(varCRef);
            ...
            AssemblySymbol varC6 = tc6.GetReferencedAssemblySymbol(varCLink);
...
";
            ...
            AssemblySymbol asmLocalTypes3 = assemblies[1];
            NamedTypeSymbol localTypes3 = asmLocalTypes3.GlobalNamespace.GetTypeMembers("LocalTypes3").Single();
...
";
            ...
            NamedTypeSymbol varI5 = varC_Pia5.SourceModule.GlobalNamespace.GetTypeMembers("I5").Single();
            MethodSymbol varI5_Foo = varI5.GetMembers("Foo").OfType<MethodSymbol>().Single();
            NamedTypeSymbol varI6 = varC_Pia5.SourceModule.GlobalNamespace.GetTypeMembers("I6").Single();
            ...
            NamedTypeSymbol varI7 = varC_Library2.SourceModule.GlobalNamespace.GetTypeMembers("I7").Single();
            MethodSymbol varI7_Foo = varI7.GetMembers("Foo").OfType<MethodSymbol>().Single();
            MethodSymbol varI7_Bar = varI7.GetMembers("Bar").OfType<MethodSymbol>().Single();
            ...
            NamedTypeSymbol varI1 = varC_Pia1.SourceModule.GlobalNamespace.GetTypeMembers("I1").Single();
