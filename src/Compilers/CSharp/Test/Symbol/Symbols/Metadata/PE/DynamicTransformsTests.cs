...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class DynamicTransformsTests : CSharpTestBase
    {
        ...
        public void TestFieldDynamicTransforms()
        {
            ...
            Assert.Equal(s_dynamicType, field1.TypeWithAnnotations.Type);
            ...
            Assert.Equal(arrayOfDynamic, field2.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field8.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field9.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field10.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field11.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field12.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field13.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInner, field14.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInnerArray, field15.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInnerArrayOfArray, field16.TypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInnerArrayOfArray, field17.TypeWithAnnotations.Type);
            ...
            Assert.Equal(inner3OfDynamic, field1.TypeWithAnnotations.Type);
        }
        ...
        public void TestReturnValueParameterAndPropertyTransforms()
        {
            ...
            Assert.Equal(s_dynamicType, f1.ReturnTypeWithAnnotations.Type);
            Assert.Equal(s_dynamicType, f1.ParameterTypesWithAnnotations[0].Type);

            //public static dynamic F2(ref dynamic x) { return x; }
            var f2 = _derivedClass.GetMember<MethodSymbol>("F2");
            Assert.Equal(s_dynamicType, f2.ReturnTypeWithAnnotations.Type);
            Assert.Equal(s_dynamicType, f2.ParameterTypesWithAnnotations[0].Type);
            ...
            Assert.Equal(arrayOfDynamic, f3.ReturnTypeWithAnnotations.Type);
            Assert.Equal(arrayOfDynamic, f3.ParameterTypesWithAnnotations[0].Type);
            ...
            Assert.Equal(complicatedInnerInnerArrayOfArray, f4.ReturnTypeWithAnnotations.Type);
            Assert.Equal(complicatedInnerInnerArrayOfArray, f4.ParameterTypesWithAnnotations[0].Type);
            ...
            Assert.Equal(s_dynamicType, prop1.TypeWithAnnotations.Type);
            Assert.Equal(s_dynamicType, prop1.GetMethod.ReturnTypeWithAnnotations.Type);
            ...
            Assert.Equal(complicatedInnerInnerArrayOfArray, prop2.TypeWithAnnotations.Type);
            Assert.Equal(complicatedInnerInnerArrayOfArray, prop2.GetMethod.ReturnTypeWithAnnotations.Type);
            Assert.Equal(SpecialType.System_Void, prop2.SetMethod.ReturnTypeWithAnnotations.SpecialType);
            Assert.Equal(complicatedInnerInnerArrayOfArray, prop2.SetMethod.ParameterTypesWithAnnotations[0].Type);
        }
        ...
        public void TestNullableTypeTransforms()
        {
            ...
            Assert.True(field.TypeWithAnnotations.Type.ContainsDynamic());
            ...
            Assert.Equal(constructedInner, field.TypeWithAnnotations.Type);
        }
...
";
            ...
            Assert.True(f0.TypeWithAnnotations.Type.ContainsDynamic());

            // .field public static class A`1<object> modopt([mscorlib]System.Runtime.CompilerServices.IsConst) F0
            var constructedA = classA.Construct(s_dynamicType);
            Assert.Equal(constructedA, f0.TypeWithAnnotations.Type);
...
str";
            ...
            Assert.False(field1.TypeWithAnnotations.Type.ContainsDynamic());
