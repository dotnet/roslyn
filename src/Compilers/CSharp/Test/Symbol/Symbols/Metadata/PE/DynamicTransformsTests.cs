...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class DynamicTransformsTests : CSharpTestBase
    {
        ...
        public void TestBaseTypeDynamicTransforms()
        {
            ...
            // Outer<dynamic>
            NamedTypeSymbol outerClassOfDynamic = _outerClass.Construct(s_dynamicType);
            // Outer<dynamic>.Inner<T[], dynamic>
            TypeParameterSymbol t = _derivedClass.TypeParameters[0];
            var arrayOfT = ArrayTypeSymbol.CreateCSharpArray(_assembly, t);
            NamedTypeSymbol innerClassOfTArrDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(arrayOfT, s_dynamicType);
            // Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[]
            NamedTypeSymbol memberInnerInnerOfInt = innerClassOfTArrDynamic.GetTypeMember("InnerInner").Construct(_intType);
            var arrayOfInnerInnerOfInt = ArrayTypeSymbol.CreateCSharpArray(_assembly, memberInnerInnerOfInt);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[], dynamic>
            NamedTypeSymbol memberComplicatedInner = outerClassOfDynamic.GetTypeMember("Inner").Construct(arrayOfInnerInnerOfInt, s_dynamicType);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[], dynamic>.InnerInner<dynamic>
            NamedTypeSymbol memberInnerInnerOfDynamic = memberComplicatedInner.GetTypeMember("InnerInner").Construct(s_dynamicType);
            ...
            NamedTypeSymbol base1OfDynamic = _base1Class.Construct(s_dynamicType);
            ...
            NamedTypeSymbol base2OfDynamicV = _base2Class.Construct(s_dynamicType, _innerClass.TypeParameters[1]);
        ...
        public void TestFieldDynamicTransforms()
        {
            ...
            var arrayOfDynamic = ArrayTypeSymbol.CreateCSharpArray(_assembly, s_dynamicType, ImmutableArray.Create<CustomModifier>(), 1);
            ...
            var arrayOfArrayOfDynamic = ArrayTypeSymbol.CreateCSharpArray(_assembly, arrayOfDynamic, ImmutableArray.Create<CustomModifier>(), 1);
            ...
            TypeParameterSymbol derivedTypeParam = _derivedClass.TypeParameters[0];
            NamedTypeSymbol outerOfT = _outerClass.Construct(derivedTypeParam);
            NamedTypeSymbol innerOfIntOfTWithOuterT = outerOfT.GetTypeMember("Inner").Construct(_intType, derivedTypeParam);
            // Outer<dynamic>
            NamedTypeSymbol outerClassOfDynamic = _outerClass.Construct(s_dynamicType);
            NamedTypeSymbol complicatedInnerInner = innerOfIntOfTWithOuterT.GetTypeMember("InnerInner").Construct(outerClassOfDynamic);
            ...
            NamedTypeSymbol innerOfTTWithOuterOfDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(derivedTypeParam, derivedTypeParam);
            ...
            FieldSymbol field10 = _derivedClass.GetMember<FieldSymbol>("field10");
            // Outer<dynamic>.Inner<T, dynamic>
            NamedTypeSymbol innerOfTDynamicWithOuterOfDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(derivedTypeParam, s_dynamicType);
            // Outer<Outer<dynamic>.Inner<T, dynamic>>
            NamedTypeSymbol complicatedOuter = _outerClass.Construct(innerOfTDynamicWithOuterOfDynamic);
            // Outer<Outer<dynamic>.Inner<T, dynamic>>.Inner<dynamic, T>
            NamedTypeSymbol complicatedInner = complicatedOuter.GetTypeMember("Inner").Construct(s_dynamicType, derivedTypeParam);
            ...
            FieldSymbol field11 = _derivedClass.GetMember<FieldSymbol>("field11");
            // Outer<T>.Inner<dynamic, dynamic>
            NamedTypeSymbol innerOfDynamicDynamicWithOuterOfT = outerOfT.GetTypeMember("Inner").Construct(s_dynamicType, s_dynamicType);
            ...
            FieldSymbol field12 = _derivedClass.GetMember<FieldSymbol>("field12");
            // Outer<T>.Inner<T, T>
            NamedTypeSymbol innerOfTTWithOuterOfT = outerOfT.GetTypeMember("Inner").Construct(derivedTypeParam, derivedTypeParam);
            // Outer<dynamic>.Inner<T, dynamic>.InnerInner<int>
            ...
            FieldSymbol field13 = _derivedClass.GetMember<FieldSymbol>("field13");
            // Outer<dynamic>.Inner<Outer<T>, T>
            NamedTypeSymbol innerOfOuterOfTTWithOuterDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(outerOfT, derivedTypeParam);
            ...
            FieldSymbol field14 = _derivedClass.GetMember<FieldSymbol>("field14");
            // Outer<dynamic>.Inner<dynamic, dynamic>
            NamedTypeSymbol innerOfDynamicDynamicWithOuterOfDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(s_dynamicType, s_dynamicType);
            ...
            FieldSymbol field15 = _derivedClass.GetMember<FieldSymbol>("field15");
            // Outer<dynamic>.Inner<Outer<dynamic>, T>
            NamedTypeSymbol innerOfOuterOfDynamicTWithOuterDynamic = outerClassOfDynamic.GetTypeMember("Inner").Construct(outerClassOfDynamic, derivedTypeParam);
            ...
            FieldSymbol field16 = _derivedClass.GetMember<FieldSymbol>("field16");
            // Outer<dynamic>.Inner<T, dynamic>.InnerInner<int>
            complicatedInnerInner = innerOfTDynamicWithOuterOfDynamic.GetTypeMember("InnerInner").Construct(_intType);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T, dynamic>.InnerInner<int>, dynamic[]>
            ...
            FieldSymbol field17 = _derivedClass.GetMember<FieldSymbol>("field17");
            // T[]
            var arrayOfDerivedTypeParam = ArrayTypeSymbol.CreateCSharpArray(_assembly, derivedTypeParam, ImmutableArray.Create<CustomModifier>(), 1);
            // Outer<dynamic>.Inner<T[], dynamic>
            ...
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[], dynamic>.InnerInner<dynamic>[][]
            complicatedInnerInnerArray = ArrayTypeSymbol.CreateCSharpArray(_assembly, complicatedInnerInner, ImmutableArray.Create<CustomModifier>(), 1);
            complicatedInnerInnerArrayOfArray = ArrayTypeSymbol.CreateCSharpArray(_assembly, complicatedInnerInnerArray, ImmutableArray.Create<CustomModifier>(), 1);
            ...
            NamedTypeSymbol inner3OfDynamic = _inner3Class.Construct(s_dynamicType);
        ...
        public void TestReturnValueParameterAndPropertyTransforms()
        {
            ...
            MethodSymbol f1 = _derivedClass.GetMember<MethodSymbol>("F1");
            ...
            MethodSymbol f2 = _derivedClass.GetMember<MethodSymbol>("F2");
            ...
            MethodSymbol f3 = _derivedClass.GetMember<MethodSymbol>("F3");
            var arrayOfDynamic = ArrayTypeSymbol.CreateCSharpArray(_assembly, s_dynamicType);
            ...
            TypeParameterSymbol derivedTypeParam = _derivedClass.TypeParameters[0];
            var arrayOfDerivedTypeParam = ArrayTypeSymbol.CreateCSharpArray(_assembly, derivedTypeParam);
            // Outer<dynamic>
            NamedTypeSymbol outerClassOfDynamic = _outerClass.Construct(s_dynamicType);
            // Outer<dynamic>.Inner<T[], dynamic>
            NamedTypeSymbol complicatedInner = outerClassOfDynamic.GetTypeMember("Inner").Construct(arrayOfDerivedTypeParam, s_dynamicType);
            // Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>
            NamedTypeSymbol complicatedInnerInner = complicatedInner.GetTypeMember("InnerInner").Construct(_intType);
            // Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[]
            var complicatedInnerInnerArray = ArrayTypeSymbol.CreateCSharpArray(_assembly, complicatedInnerInner);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[], dynamic>
            complicatedInner = outerClassOfDynamic.GetTypeMember("Inner").Construct(complicatedInnerInnerArray, s_dynamicType);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int>[], dynamic>.InnerInner<dynamic>
            complicatedInnerInner = complicatedInner.GetTypeMember("InnerInner").Construct(s_dynamicType);
            ...
            var complicatedInnerInnerArrayOfArray = ArrayTypeSymbol.CreateCSharpArray(_assembly, complicatedInnerInnerArray);
            ...
            MethodSymbol f4 = _derivedClass.GetMember<MethodSymbol>("F4");
            ...
            PropertySymbol prop1 = _derivedClass.GetMember<PropertySymbol>("Prop1");
            ...
            PropertySymbol prop2 = _derivedClass.GetMember<PropertySymbol>("Prop2");
        ...
        public void TestPointerTypeTransforms()
        {
            ...
            NamedTypeSymbol unsafeClass = _assembly.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("UnsafeClass");
            Assert.False(unsafeClass.ContainsDynamic());
            Assert.True(unsafeClass.BaseType().ContainsDynamic());

            TypeParameterSymbol unsafeClassTypeParam = unsafeClass.TypeParameters[0];
            // T[]
            ...
            // Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int*[][]>
            NamedTypeSymbol complicatedInnerInner = complicatedInner.GetTypeMember("InnerInner").Construct(arrayOfArrayOfPointerToInt);
            // Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int*[][]>[]
            var complicatedInnerInnerArray = ArrayTypeSymbol.CreateCSharpArray(_assembly, complicatedInnerInner, ImmutableArray.Create<CustomModifier>(), 1);
            // Outer<dynamic>.Inner<Outer<dynamic>.Inner<T[], dynamic>.InnerInner<int*[][]>[], dynamic>
            complicatedInner = outerClassOfDynamic.GetTypeMember("Inner").Construct(complicatedInnerInnerArray, s_dynamicType);
            ...
            NamedTypeSymbol baseType = _base2Class.Construct(arrayOfPointerToInt, complicatedInnerInnerArrayOfArray);
        ...
        public void TestNullableTypeTransforms()
        {
            ...
            NamedTypeSymbol structType = _assembly.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("Struct");
            Assert.False(structType.ContainsDynamic());

            // public static Outer<dynamic>.Inner<dynamic, Struct?> nullableField;
            FieldSymbol field = structType.GetMember<FieldSymbol>("nullableField");
            Assert.True(field.Type.ContainsDynamic());

            NamedTypeSymbol nullableStruct = _assembly.CorLibrary.GetSpecialType(SpecialType.System_Nullable_T).Construct(structType);
            // Outer<dynamic>
            NamedTypeSymbol outerClassOfDynamic = _outerClass.Construct(s_dynamicType);
            // Outer<dynamic>.Inner<dynamic, Struct?>
            NamedTypeSymbol constructedInner = outerClassOfDynamic.GetTypeMember("Inner").Construct(s_dynamicType, nullableStruct);
...
";
            ...
            CSharpCompilation compilation = CreateCompilationWithILAndMscorlib40(String.Empty, il);
            ...
            FieldSymbol f0 = classB.GetMember<FieldSymbol>("F0");
            Assert.True(f0.Type.ContainsDynamic());

            // .field public static class A`1<object> modopt([mscorlib]System.Runtime.CompilerServices.IsConst) F0
            NamedTypeSymbol constructedA = classA.Construct(s_dynamicType);
...
";
            PortableExecutableReference dll = MetadataReference.CreateFromImage(TestResources.MetadataTests.Invalid.InvalidDynamicAttributeArgs.AsImmutableOrNull());

            CSharpCompilation c = CreateCompilation(csSource, new[] { dll });
...
str";
            ...
            CSharpCompilation compilation = CreateCompilationWithILAndMscorlib40(source, il, options: TestOptions.ReleaseExe);
            CompileAndVerify(compilation, expectedOutput: expectedOutput);

            NamedTypeSymbol classDerived = compilation.GlobalNamespace.GetMember<NamedTypeSymbol>("Derived");
            FieldSymbol field1 = classDerived.BaseType().GetMember<FieldSymbol>("field1");
            Assert.False(field1.Type.ContainsDynamic());

            NamedTypeSymbol classDerived2 = compilation.GlobalNamespace.GetMember<NamedTypeSymbol>("Derived2");
