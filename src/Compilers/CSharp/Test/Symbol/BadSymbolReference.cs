...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public class BadSymbolReference : CSharpTestBase
    {
        ...
        {
            PortableExecutableReference cl2 = TestReferences.SymbolsTests.MissingTypes.CL2;
            PortableExecutableReference cl3 = TestReferences.SymbolsTests.MissingTypes.CL3;
...
";
            ...
            CSharpCompilation compilation2 = CreateCompilation(a_cs, new MetadataReference[] { cl3 });
...
";
            ...
            CSharpCompilation cl3Compilation = CreateCompilation(cl3Source, new MetadataReference[] { cl2 });

            cl3Compilation.VerifyDiagnostics();

            CSharpCompilation compilation3 = CreateCompilation(a_cs, new MetadataReference[] { new CSharpCompilationReference(cl3Compilation) });

            compilation3.VerifyDiagnostics(errors);

            CSharpCompilation cl3BadCompilation1 = CreateCompilation(cl3Source, new MetadataReference[] { cl3 });

            CSharpCompilation compilation4 = CreateCompilation(a_cs, new MetadataReference[] { new CSharpCompilationReference(cl3BadCompilation1) });
            ...
            CSharpCompilation cl3BadCompilation2 = CreateCompilation(cl3Source);
            ...
            CSharpCompilation compilation5 = CreateCompilation(a_cs, new MetadataReference[] { new CSharpCompilationReference(cl3BadCompilation2) });
            ...
            CSharpCompilation compilation6 = CreateCompilation(cl4Source);
        ...
        public void MissingTypes3()
        {
            ...
            CSharpCompilation compilation1 = CreateEmptyCompilation(
@"
    class Program
    {
...
";
            ...
            MetadataReference libRef = CreateEmptyCompilation(libSource, new[] { MscorlibRef }, assemblyName: "System.Drawing").EmitToImageReference();

            CSharpCompilation comp1 = CreateEmptyCompilation(project1Source, new[] { MscorlibRef, libRef }, assemblyName: "Project1");
            comp1.VerifyDiagnostics();

            CSharpCompilation comp2 = CreateEmptyCompilation(project2Source, new[] { MscorlibRef, libRef }, assemblyName: "Project2");
            comp2.VerifyDiagnostics();

            // Scenario 1: Projects 1, 2, and 3 are in source; project 3 does not reference lib.
            {
                CSharpCompilation comp3 = CreateEmptyCompilation(project3Source, new[] { MscorlibRef, comp1.ToMetadataReference(), comp2.ToMetadataReference() }, assemblyName: "Project3");
            ...
            {
                CSharpCompilation comp3 = CreateEmptyCompilation(project3Source, new[] { MscorlibRef, comp1.EmitToImageReference(), comp2.EmitToImageReference() }, assemblyName: "Project3");
                comp3.VerifyDiagnostics(
                    // (2,7): error CS0012: The type 'System.Drawing.Point' is defined in an assembly that is not referenced. You must add a reference to assembly 'System.Drawing, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null'.
                    // class D : C, I { }
                    Diagnostic(ErrorCode.ERR_NoTypeDef, "D").WithArguments("System.Drawing.Point", "System.Drawing, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"));
        ...
        {
            CSharpCompilation lib1 = CreateCompilation(@"
namespace ErrorTest
{
    ...
    {}
            ...
            CSharpCompilation lib2 = CreateCompilation(@"
namespace ErrorTest
{
    ...
    {}
            ...
            CSharpCompilation lib3 = CreateCompilation(@"
namespace ErrorTest
{
...
namespace ErrorTest
{
    ...
    class Test6
    {
        ...
        {}
            ...
            CSharpCompilation lib4 = CreateCompilation(lib4Def, new[] { lib1Ref, lib3Ref }, TestOptions.ReleaseDll);
