...
";
            ...
            var cl3Compilation = CreateCompilationWithMscorlib(cl3Source, new MetadataReference[] { cl2 });

            cl3Compilation.VerifyDiagnostics();

            var compilation3 = CreateCompilationWithMscorlib(a_cs, new MetadataReference[] { new CSharpCompilationReference(cl3Compilation) });

            compilation3.VerifyDiagnostics(errors);

            var cl3BadCompilation1 = CreateCompilationWithMscorlib(cl3Source, new MetadataReference[] { cl3 });
            ...
            var cl3BadCompilation2 = CreateCompilationWithMscorlib(cl3Source);
...
";
            ...
            var libRef = CreateCompilationWithMscorlib(libSource, assemblyName: "System.Drawing").EmitToImageReference();

            var comp1 = CreateCompilationWithMscorlib(project1Source, new[] { libRef }, assemblyName: "Project1");
            comp1.VerifyDiagnostics();

            var comp2 = CreateCompilationWithMscorlib(project2Source, new[] { libRef }, assemblyName: "Project2");
            comp2.VerifyDiagnostics();

            // Scenario 1: Projects 1, 2, and 3 are in source; project 3 does not reference lib.
            {
                var comp3 = CreateCompilationWithMscorlib(project3Source, new[] { comp1.ToMetadataReference(), comp2.ToMetadataReference() }, assemblyName: "Project3");
