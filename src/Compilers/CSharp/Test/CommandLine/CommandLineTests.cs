...
");
        ...
        [Theory, WorkItem(41171, "https://github.com/dotnet/roslyn/issues/41171")]
        [InlineData("*.cs", 9, new[] { "C", "D", "G1_1", "G1_2", "G1_3", "G2_1", "G2_2", "G2_3" })]
        [InlineData("generated/Microsoft.CodeAnalysis.Test.Utilities/Roslyn.Test.Utilities.TestGenerators.PipelineCallbackGenerator/*.cs", 5, new[] { "C", "D", "G1_1", "G1_3", "G2_1" })]
        [InlineData("generated/Microsoft.CodeAnalysis.Test.Utilities/Roslyn.Test.Utilities.TestGenerators.PipelineCallbackGenerator2/*.cs", 5, new[] { "C", "D", "G1_1", "G1_2", "G2_3" })]
        [InlineData("generated/Microsoft.CodeAnalysis.Test.Utilities/*.cs", 2, new[] { "C", "D" })]
        public void GlobalAnalyzerConfig_SuppressDiagnosticInGeneratedFiles_NamedSection(
            string sectionName, int expectedWarningCount, string[] squiggledSymbols)
        {
            ...
            foreach (var symbol in squiggledSymbols)
            {
                Assert.Contains($"warning Warning01: '{symbol}'", output, StringComparison.Ordinal);
            }
        }
