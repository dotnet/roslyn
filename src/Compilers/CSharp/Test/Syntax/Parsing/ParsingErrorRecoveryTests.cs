...
";
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/72077")]
        public void IncompleteVariableDeclarationAboveLocalFunction()
        {
            var text = """
                class C
                {
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/72077")]
        public void IncompleteVariableDeclarationAboveLocalFunction_TopLevel()
        {
            var text = """
                C
                void C() { }
