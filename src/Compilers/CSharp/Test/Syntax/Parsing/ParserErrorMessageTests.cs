...
";
            ...
            ParseAndValidate(text, TestOptions.Regular,
                ...
                //             e = new ();     // CS1031, too few tuple elements
                Diagnostic(ErrorCode.ERR_TypeExpected, "(").WithLocation(9, 21)
             );
        }
    ...
    public static A operator ()
    {
        return null;
            ...
            ParseAndValidate(test, TestOptions.Regular,
                ...
                // (4,23): error CS1020: Overloadable binary operator expected
                //     public static int explicit operator ()
                Diagnostic(ErrorCode.ERR_OvlBinaryOperatorExpected, "explicit").WithLocation(4, 23),
                ...
                // (4,41): error CS1031: Type expected
                //     public static int explicit operator ()
                Diagnostic(ErrorCode.ERR_TypeExpected, "(").WithLocation(4, 41),
                // (4,41): error CS1001: Identifier expected
                //     public static int explicit operator ()
                Diagnostic(ErrorCode.ERR_IdentifierExpected, "(").WithLocation(4, 41),
                // (4,41): error CS1003: Syntax error, ',' expected
                //     public static int explicit operator ()
                Diagnostic(ErrorCode.ERR_SyntaxError, "(").WithArguments(",", "(").WithLocation(4, 41),
                // (4,41): error CS1031: Type expected
                //     public static int explicit operator ()
                Diagnostic(ErrorCode.ERR_TypeExpected, "(").WithLocation(4, 41),
                // (4,41): error CS1001: Identifier expected
...
";
            ...
            ParseAndValidate(test, TestOptions.Regular,
                ...
                // (3,23): error CS1037: Overloadable operator expected
                //     public static int implicit operator (foo f) { return 6; }    // Error
                Diagnostic(ErrorCode.ERR_OvlOperatorExpected, "implicit").WithLocation(3, 23),
                ...
                //     public static int implicit operator (foo f) { return 6; }    // Error
                Diagnostic(ErrorCode.ERR_SyntaxError, "foo").WithArguments(",", "").WithLocation(3, 42)
                );
        }
