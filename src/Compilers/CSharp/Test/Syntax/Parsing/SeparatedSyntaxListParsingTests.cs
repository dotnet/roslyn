...
";
            CreateCompilation(source).VerifyDiagnostics(
                ...
                //     A<T U> a4;
                Diagnostic(ErrorCode.ERR_SyntaxError, "U").WithArguments(",").WithLocation(7, 9),
                // (7,9): error CS0246: The type or namespace name 'U' could not be found (are you missing a using directive or an assembly reference?)
                //     A<T U> a4;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "U").WithArguments("U").WithLocation(7, 9),
                // (11,9): error CS1003: Syntax error, ',' expected
                //     A<T U,,> a8;
                Diagnostic(ErrorCode.ERR_SyntaxError, "U").WithArguments(",").WithLocation(11, 9),
                ...
                //     A<,T> a7;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<,T>").WithArguments("A<,>").WithLocation(10, 5),
                // (11,5): error CS0246: The type or namespace name 'A<,,,>' could not be found (are you missing a using directive or an assembly reference?)
                //     A<T U,,> a8;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<T U,,>").WithArguments("A<,,,>").WithLocation(11, 5),
                ...
                //     A<> a1;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<>").WithArguments("A<>").WithLocation(4, 5),
                ...
                //     A<T> a2;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<T>").WithArguments("A<>").WithLocation(5, 5),
                // (5,7): error CS0246: The type or namespace name 'T' could not be found (are you missing a using directive or an assembly reference?)
                //     A<T> a2;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "T").WithArguments("T").WithLocation(5, 7),
                ...
                //     A<,> a3;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<,>").WithArguments("A<,>").WithLocation(6, 5),
                ...
                //     A<T U> a4;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "A<T U>").WithArguments("A<,>").WithLocation(7, 5),
                // (7,7): error CS0246: The type or namespace name 'T' could not be found (are you missing a using directive or an assembly reference?)
                //     A<T U> a4;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "T").WithArguments("T").WithLocation(7, 7),
                // (6,10): warning CS0169: The field 'C.a3' is never used
                //     A<,> a3;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a3").WithArguments("C.a3").WithLocation(6, 10),
                // (10,11): warning CS0169: The field 'C.a7' is never used
                //     A<,T> a7;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a7").WithArguments("C.a7").WithLocation(10, 11),
                // (11,14): warning CS0169: The field 'C.a8' is never used
                //     A<T U,,> a8;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a8").WithArguments("C.a8").WithLocation(11, 14),
                // (9,11): warning CS0169: The field 'C.a6' is never used
                //     A<T,> a6;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a6").WithArguments("C.a6").WithLocation(9, 11),
                // (4,9): warning CS0169: The field 'C.a1' is never used
                //     A<> a1;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a1").WithArguments("C.a1").WithLocation(4, 9),
                // (7,12): warning CS0169: The field 'C.a4' is never used
                //     A<T U> a4;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a4").WithArguments("C.a4").WithLocation(7, 12),
                // (8,11): warning CS0169: The field 'C.a5' is never used
                //     A<,,> a5;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a5").WithArguments("C.a5").WithLocation(8, 11),
                // (5,10): warning CS0169: The field 'C.a2' is never used
                //     A<T> a2;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "a2").WithArguments("C.a2").WithLocation(5, 10));
        }
