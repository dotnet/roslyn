...
class A
{
    ...
    public int
        ...
        public void LexerTooManyBadTokens()
        {
            ...
            Assert.Equal($"(1,1201): error CS1056: {string.Format(CSharpResources.ERR_UnexpectedCharacter, "\\u003C")}", actualErrors.ElementAt(200).ToString());
            Assert.Equal($"(1,1207): error CS1056: {string.Format(CSharpResources.ERR_UnexpectedCharacter,"\\u003E\\u003E\\u003E\\u003E")}", actualErrors.ElementAt(201).ToString());
        }
        ...
        public void LexerTooManyBadTokens_LongUnicode()
        {
            ...
            Assert.Equal($"(1,2011): error CS1056: {string.Format(CSharpResources.ERR_UnexpectedCharacter,"\\u003E\\u003E\\u003E\\u003E")}", actualErrors.ElementAt(201).ToString());
        }
