...
"}");
        ...
        {
            TestNormalizeStatement(
                """writer.Write(data switch{global::Core.Networking.Data.NetworkedVector3 => 0, _ => throw new System.Exception("Failed to handle type in autogenerated polymorphic serialization!")});""",
                """
                writer.Write(data switch
                {
                  global::Core.Networking.Data.NetworkedVector3 => 0,
                  _ => throw new System.Exception("Failed to handle type in autogenerated polymorphic serialization!")
                });
                """);
            TestNormalizeStatement(
                """writer.Write(data switch{global::Core.Networking.Data.NetworkedVector3 => 0, _ => throw new System.Exception("Failed to handle type in autogenerated polymorphic serialization!"),});""",
