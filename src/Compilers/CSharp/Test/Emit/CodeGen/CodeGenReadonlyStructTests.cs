...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"12");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef, ref1}, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"12");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"hello2");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef, ref1 }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"hello2");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"Program+S1Program+S1");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"4242");
...
class Test
{
    public static void Main()
    {
        ...
        Console.WriteLine(x.Length);
            ...
            CompileAndVerify(comp, expectedOutput: "10", verify: Verification.Skipped).VerifyIL("Test.Main", @"
{
  // Code size       29 (0x1d)
  .maxstack  2
...
class Test
{
    ...
    {       
        for (int i = 0; i < 5; i++)
        {
            ...
            CompileAndVerify(comp, expectedOutput: "12345", verify: Verification.Skipped).VerifyIL("Test.Main", @"
{
  // Code size       44 (0x2c)
  .maxstack  2
...
unsafe class Test
{
    ...
    public static implicit operator Test(double* value) 
    {
        ...
        return default(Test);
            ...
            CompileAndVerify(comp, expectedOutput: "SpanOpCalled|PointerOpCalled", verify: Verification.Skipped);
        }
...
unsafe class Test
{
    ...
    public static explicit operator Test(Span<int> value) 
    {
        ...
        return default(Test);
            ...
            CompileAndVerify(comp, expectedOutput: "SpanOpCalled", verify: Verification.Skipped);
        }
    }
}
