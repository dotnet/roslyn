...
";
            var comp = CreateCompilationWithTasksExtensions(source + CSharpTestBase.IAsyncDisposableDefinition, options: TestOptions.DebugExe);
            comp.VerifyDiagnostics(
...
";
            var comp = CreateCompilationWithTasksExtensions(source + CSharpTestBase.IAsyncDisposableDefinition, options: TestOptions.UnsafeDebugDll);
            comp.VerifyDiagnostics(
...
";
            var comp = CreateCompilationWithTasksExtensions(new[] { source, CSharpTestBase.IAsyncDisposableDefinition }, options: TestOptions.DebugExe);
            comp.VerifyDiagnostics();
...
";
            var libComp = CreateCompilationWithTasksExtensions(lib_cs + CSharpTestBase.IAsyncDisposableDefinition);
...
";
            var comp = CreateCompilationWithTasksExtensions(source + CSharpTestBase.IAsyncDisposableDefinition, options: TestOptions.DebugExe, references: new[] { CSharpRef });
            comp.VerifyDiagnostics();
...
}" + CSharpTestBase.IAsyncDisposableDefinition);
            comp.VerifyDiagnostics(
...
class Program
{
    static async Task Main()
    {
        await using (new Disposable())
        {
            ...
            var comp = CreateCompilationWithTasksExtensions(new[] { source, CSharpTestBase.IAsyncDisposableDefinition }, options: TestOptions.ReleaseExe);
