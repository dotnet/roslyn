...
";
            ...
            comp.VerifyDiagnostics(
                // (6,9): error CS8806: The calling convention of 'delegate*<void>' is not supported by the language.
                //         c.Field(__arglist(1, 2));
                Diagnostic(ErrorCode.ERR_UnsupportedCallingConvention, "c.Field(__arglist(1, 2))").WithArguments("delegate*<void>").WithLocation(6, 9),
                ...
                // (7,9): error CS8806: The calling convention of 'delegate*<void>' is not supported by the language.
                //         c.Field(1, 2, 3);
                Diagnostic(ErrorCode.ERR_UnsupportedCallingConvention, "c.Field(1, 2, 3)").WithArguments("delegate*<void>").WithLocation(7, 9),
                ...
                // (8,9): error CS8806: The calling convention of 'delegate*<void>' is not supported by the language.
                //         c.Field();
                Diagnostic(ErrorCode.ERR_UnsupportedCallingConvention, "c.Field()").WithArguments("delegate*<void>").WithLocation(8, 9),
                ...
                // (10,9): error CS8806: The calling convention of 'delegate*<void>' is not supported by the language.
                //         c.Prop();
                Diagnostic(ErrorCode.ERR_UnsupportedCallingConvention, "c.Prop()").WithArguments("delegate*<void>").WithLocation(10, 9),
