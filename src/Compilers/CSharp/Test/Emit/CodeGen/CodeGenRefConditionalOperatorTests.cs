...
class C
{
    ...
    static ref int M1(ref int arg) => ref arg;
            ...
            var comp = CompileAndVerify(source, expectedOutput: "44", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
class C
{
    ...
    static int val2 = 44;
            ...
            var comp = CompileAndVerify(source, expectedOutput: "55", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
class C
{
    ...
    static int val2 = 44;
            ...
            var comp = CompileAndVerify(source, expectedOutput: "5555", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
class C
{
    ...
    static ref int M1(ref int arg) => ref arg;
            ...
            var comp = CompileAndVerify(source, expectedOutput: "67", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
class C
{
    ...
    static int val2 = 44;
            ...
            var comp = CompileAndVerify(source, expectedOutput: "446767", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
";
            var comp = CompileAndVerify(source, expectedOutput: "1", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
";
            ...
            var comp = CompileAndVerify(source, additionalRefs: new[] { SystemRuntimeFacadeRef, ValueTupleRef, SystemCoreRef }, expectedOutput: "00", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
...
";
            ...
            var comp = CompileAndVerify(source, additionalRefs: new[] { SystemRuntimeFacadeRef, ValueTupleRef }, expectedOutput: "00", verify: Verification.Skipped);
            comp.VerifyDiagnostics();
