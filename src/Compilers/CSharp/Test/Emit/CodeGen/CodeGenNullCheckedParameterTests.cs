...
public class C
{
    ...
    public void M(string input!) { }
            ...
            // Release
            var compilation = CompileAndVerify(source, options: TestOptions.ReleaseExe, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
            compilation.VerifyIL("C.M", @"
{
    ...
    -IL_000e:  ret
            ...
            // Debug
            compilation = CompileAndVerify(source, options: TestOptions.DebugExe, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
            compilation.VerifyIL("C.M", @"
{
    // Code size       16 (0x10)
    .maxstack  1
...
";
            var compilation = CompileAndVerify(source, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
...
ok
System.ArgumentNullException", parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview));
        }
...
class C
{
    ...
    static IEnumerable<char> GetChars(string s!)
    {
        yield break;
            ...
            CompileAndVerify(source, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview)).VerifyIL("C.GetChars(string)", @"
{
    // Code size       22 (0x16)
    .maxstack  1
    IL_0000:  ldarg.0
...
class C
{
    ...
    public void M(params int[] number!) {}
            ...
            CompileAndVerify(source, parseOptions: TestOptions.Regular.WithLanguageVersion(LanguageVersion.Preview)).VerifyIL("C.M(params int[])", @"
{
    // Code size       15 (0xf)
    .maxstack  1
    IL_0000:  ldarg.1
