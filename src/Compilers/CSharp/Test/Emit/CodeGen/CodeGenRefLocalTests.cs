...
";
            ...
            CompileAndVerify(text, options: TestOptions.DebugDll, verify: Verification.Skipped).VerifyIL("Program.M()", @"
{
  // Code size        8 (0x8)
  .maxstack  1
  .locals init (int& V_0) //rl
...
";
            ...
            var comp = CompileAndVerify(text, options: TestOptions.DebugDll, verify: Verification.Skipped);
...
";
            ...
            CompileAndVerify(text, options: TestOptions.DebugDll, verify: Verification.Skipped).VerifyIL("Program.M(ref int, ref int, object)", @"
{
  // Code size       16 (0x10)
  .maxstack  3
  .locals init (int& V_0, //rl
...
";
            ...
            CompileAndVerify(text, options: TestOptions.DebugDll, verify: Verification.Skipped).VerifyIL("Program.M(D, ref int, ref int, object)", @"
{
  // Code size       17 (0x11)
  .maxstack  4
  .locals init (int& V_0, //rl
