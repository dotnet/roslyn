...
";
            ...
            var comp = CompileAndVerify(text, parseOptions: TestOptions.Regular, verify: Verification.Skipped);
...
";
            ...
            var comp = CompileAndVerify(text, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"42
84");
            ...
            comp.VerifyIL("Program.M(in int)", @"
{
  ...
  IL_0001:  ret
            ...
            comp = CompileAndVerify(text, verify: Verification.Skipped, expectedOutput: "42", parseOptions: TestOptions.Regular.WithPEVerifyCompatFeature());
...
";
            ...
            var comp = CompileAndVerify(text, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"hi
42");
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped);
...
";
            ...
            var comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput:@"42");
...
";
            ...
            CompileAndVerify(comp, verify: Verification.Skipped, expectedOutput: @"6");
        }
...
";
            ...
            var result = CompileAndVerify(comp, verify: Verification.Skipped, expectedOutput: @"47");
...
";
            ...
            result = CompileAndVerify(comp, verify: Verification.Skipped, expectedOutput: @"47");
...
";
            ...
            var comp = CreateCompilationWithMscorlib46(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, options: TestOptions.ReleaseExe);
            var v = CompileAndVerify(comp, verify: Verification.Skipped, expectedOutput: @"
1
2
3
4");
...
";
            ...
            var comp = CompileAndVerify(text, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"0");
...
";
            ...
            var comp = CompileAndVerify(text, parseOptions: TestOptions.Regular, verify: Verification.Skipped, expectedOutput: @"");
