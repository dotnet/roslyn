...
"};
  ...
  IL_0006:  ret
            ...
            {
                CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(source, expectedOutput: expectedOutput);
...
";
  ...
  IL_0007:  ret
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(source, expectedOutput: expectedOutput, options: TestOptions.ReleaseExe, parseOptions: TestOptions.Regular.WithStrictFeature());
            comp.VerifyDiagnostics(
                // (21,16): warning CS0472: The result of the expression is always 'false' since a value of type 'int' is never equal to 'null' of type 'short?'
                //         return new int?(N1()) == new short?();
                Diagnostic(ErrorCode.WRN_NubExprIsConstBool, "new int?(N1()) == new short?()").WithArguments("false", "int", "short?").WithLocation(21, 16),
