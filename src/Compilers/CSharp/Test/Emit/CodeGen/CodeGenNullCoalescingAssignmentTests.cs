...
public class C
{
    ...
    public static void Main()
    {
        ...
        Console.WriteLine(c.GetF1() ??= 2);
                ...
                // (24,27): error CS8331: Cannot assign to property 'C.P1' or use it as the right hand side of a ref assignment because it is a readonly variable
                //         Console.WriteLine(c.P1 ??= 1);
                Diagnostic(ErrorCode.ERR_AssignReadonlyNotField, "c.P1").WithArguments("property", "C.P1").WithLocation(24, 27),
                // (26,27): error CS8331: Cannot assign to method 'C.GetF1()' or use it as the right hand side of a ref assignment because it is a readonly variable
                //         Console.WriteLine(c.GetF1() ??= 2);
...
class C
{
    void M(in object o1, out object o2)
    {
        ...
        o2 ??= null;
            ...
            CreateCompilation(source).VerifyDiagnostics(
                // (6,9): error CS8331: Cannot assign to variable 'in object' or use it as the right hand side of a ref assignment because it is a readonly variable
                //         o1 ??= null;
