...
";
            ...
            comp.VerifyDiagnostics(
                // (14,29): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //         ref var temp1 = ref F1(ref d.Length);
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(ref d.Length)").WithLocation(14, 29),
                // (16,29): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //         ref var temp2 = ref F1(ref d.Length);
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(ref d.Length)").WithLocation(16, 29));
        }
...
";
            ...
            comp.VerifyDiagnostics(
                // (14,33): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp1 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123))").WithLocation(14, 33),
                // (14,48): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp1 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(42, ref d.Length, 123)").WithLocation(14, 48),
                // (14,85): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp1 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(42, ref d.Length, 123)").WithLocation(14, 85),
                // (16,33): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp2 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123))").WithLocation(16, 33),
                // (16,48): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp2 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(42, ref d.Length, 123)").WithLocation(16, 48),
                // (16,85): error CS8349: Expression cannot be used in this context because it may indirectly expose variables outside of their declaration scope
                //             ref var temp2 = ref Test(arg2: ref F1(42, ref d.Length, 123), arg1: ref F1(42, ref d.Length, 123));
                Diagnostic(ErrorCode.ERR_EscapeOther, "F1(42, ref d.Length, 123)").WithLocation(16, 85));
        }
