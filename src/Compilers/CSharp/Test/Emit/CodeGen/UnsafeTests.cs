...
";
            CompileAndVerify(text, options: TestOptions.UnsafeReleaseExe, verify: Verification.Skipped).VerifyDiagnostics();
        }
...
";
            CompileAndVerify(text, options: TestOptions.UnsafeReleaseDll, verify: Verification.Skipped).VerifyDiagnostics(
...
";
            var comp = CompileAndVerify(text, options: TestOptions.UnsafeReleaseDll, verify: Verification.Skipped).VerifyDiagnostics();
...
");
    ...
    unsafe public struct FixedStruct
    {
        ...
        override public string ToString()
        {
            ...
            var comp = CompileAndVerify(text, options: TestOptions.UnsafeReleaseExe, expectedOutput:"ABC", verify: Verification.Skipped).VerifyDiagnostics();
