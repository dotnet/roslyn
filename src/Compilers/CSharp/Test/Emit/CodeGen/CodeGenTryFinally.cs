...
@"class C
{
    ...
    End:
        System.Console.Write(""4, "");
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "1, 3, 4, 1, 2, 3, ");
...
class C
{
    ...
    static void N(int f)
    {
        if (f > 0)
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "before, catch, before, after,");
            compilation.VerifyIL("C.M",
@"{
  // Code size       42 (0x2a)
  .maxstack  1
...
class C
{
    ...
    static void M()
    {
        ...
        catch (System.NullReferenceException NullException)//null Exception caught
        {
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "");
            compilation.VerifyIL("C.M",
@"{
  // Code size       24 (0x18)
  .maxstack  1
...
";
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "hellobyebye");
...
class C
{
    ...
    static void Main()
    {
        ...
        finally
        {
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(src,
...
class C
{
    ...
    static void Main()
    {
        ...
        finally
        {
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(src, expectedOutput: "TryCatchS1Finally");
            comp.VerifyIL("C.Main", @"
{
  // Code size       95 (0x5f)
  .maxstack  2
...
class C
{
    static void Main()
    {
        ...
        catch when (false)
        {
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(src, expectedOutput: "ExceptionFilter");
            comp.VerifyIL("C.Main", @"
{
  // Code size       68 (0x44)
  .maxstack  2
...
class C
{
    static void Main()
    {
        ...
        catch
        {
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier comp = CompileAndVerify(src, expectedOutput: "FinallyOuterCatch");
            comp.VerifyIL("C.Main", @"
{
  // Code size       31 (0x1f)
  .maxstack  1
...
class C
{
    ...
    static void Main()
    {
        Console.WriteLine(""M(0)={0}, M(1)={1}, M(2)={2}"", M(0), M(1), M(2));
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "M(0)=-4, M(1)=11, M(2)=6");
            compilation.VerifyIL("C.M",
@"{
  // Code size       34 (0x22)
  .maxstack  2
...
";
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "0");
...
";
            ...
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: "hello");
            compilation.VerifyIL("Program.T1",
@"{
  // Code size       16 (0x10)
  .maxstack  1
...
";
            CodeAnalysis.Test.Utilities.CompilationVerifier compilation = CompileAndVerify(source, expectedOutput: @"2
Finally
Out");
            compilation.VerifyIL("Program.Main",
@"
