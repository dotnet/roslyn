...
@"public class B
{
    ...
    public static int F2 = 0;
            ...
            var compilation1 = CreateCompilationWithMscorlib(source1, assemblyName: "1110a705-cc34-430b-9450-ca37031aa828");
...
@"class A
{
    ...
    private static object M(int i) { return null; }
            ...
            CreateCompilationWithMscorlib(source2, new[] { new CSharpCompilationReference(compilation1) }, assemblyName: "2110a705-cc34-430b-9450-ca37031aa828")
