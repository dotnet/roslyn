...
class C
{
    ...
    ref readonly S M()
    {
        ...
        return ref rs1;
            ...
            var comp = CompileAndVerify(source, parseOptions: TestOptions.Regular.WithPEVerifyCompatFeature(), verify: Verification.Skipped);
            comp.VerifyIL("C.M", @"
{
  // Code size       59 (0x3b)
  .maxstack  2
  ...
  IL_003a:  ret
            ...
            comp = CompileAndVerify(source, verify: Verification.Skipped);
            comp.VerifyIL("C.M", @"
{
  // Code size       59 (0x3b)
  .maxstack  2
            ...
            comp.VerifyIL("Program.Test", @"
{
  ...
  IL_0038:  ret
            ...
            comp = CompileAndVerify(text, new[] { ValueTupleRef, SystemRuntimeFacadeRef }, parseOptions: TestOptions.Regular.WithPEVerifyCompatFeature(), verify: Verification.Skipped);
            comp.VerifyIL("Program.Test", @"
{
  // Code size       57 (0x39)
  .maxstack  1
...
}", additionalRefs: new[] { SystemCoreRef }, verify: Verification.Skipped).VerifyIL("Test.M", @"
{
  // Code size       11 (0xb)
  .maxstack  1
...
}", verify: Verification.Skipped, expectedOutput: "optional-provided");
        }
    }
}
