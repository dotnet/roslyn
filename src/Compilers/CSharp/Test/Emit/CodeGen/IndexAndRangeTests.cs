...
""";
        ...
        public void InObjectInitializer_Array()
        {
            string source = """
class C
{
...
""");
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_Array_GetOffset()
        {
            string source = """
class C
{
...
""");
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_OptionalParameter()
        {
            string source = """
Buffer10 b = default;
b[^1] = 42; // 1
...
""";
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_Unassigned()
        {
            string source = """
class Program
{
...
""";
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_Nullability()
        {
            string source = """
#nullable enable
string? s = null;
...
""";
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_Readonly()
        {
            string source = """
class C
{
...
""");
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_RefReturningIndexer_ByRef()
        {
            string source = """
int i = 42;
...
""",
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_ArrayAccess_WithEmptyNestedNesting()
        {
            string source = """
C.M(1..^1, 2..^2);
...
""",
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_PointerAccess_WithEmptyNestedNesting()
        {
            string source = """
unsafe class C
{
...
""",
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_DynamicAccess_WithEmptyNestedNesting()
        {
            string source = """
C.M();
...
""",
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_DynamicAccess2_WithEmptyNestedNesting()
        {
            string source = """
C.M();
...
""",
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67533")]
        public void InObjectInitializer_DynamicAccess2_WithMixedNestedNesting()
        {
            string source = """
C.M();
