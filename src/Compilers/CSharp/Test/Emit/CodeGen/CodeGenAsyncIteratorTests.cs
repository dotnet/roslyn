...
""";
            ...
            CompileAndVerify(src, expectedOutput: ExpectedOutput("value exception value"), verify: Verification.Skipped, targetFramework: TargetFramework.Net80).VerifyDiagnostics();
        }
