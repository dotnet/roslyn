...
2";
            CompilationVerifier compVerifier = CompileAndVerify(source, expectedOutput: expectedOutput);
...
public struct MemberInitializerTest
{
    ...
    public static void Main()
    {
        var i = new MemberInitializerTest() { z = null };
            ...
            CompilationVerifier compVerifier = CompileAndVerify(source, expectedOutput: "");
            compVerifier.VerifyIL("MemberInitializerTest.Main", @"
{
  // Code size       17 (0x11)
  .maxstack  2
...
3";
            ...
            CompilationVerifier compVerifier = CompileAndVerify(source, targetFramework: TargetFramework.StandardAndCSharp, expectedOutput: expectedOutput);
        }
...
3";
            ...
            CompilationVerifier compVerifier = CompileAndVerify(source, references: new[] { SystemCoreRef, CSharpRef }, expectedOutput: expectedOutput);
            compVerifier.VerifyIL("A.Main()", @"
{
  // Code size      194 (0xc2)
  .maxstack  4
