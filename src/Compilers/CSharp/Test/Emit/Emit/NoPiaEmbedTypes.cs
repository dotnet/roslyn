...
";
            ...
            MetadataReference[] NetImpl_refs = [ new CSharpCompilationReference(NetImpl_1_Compilation),
            ...
            MetadataReference[] IEvent_refs = [ new CSharpCompilationReference(IEvent_Compilation),
