...
";
            ...
            var class1TypeDef = (Cci.ITypeDefinition)class1.GetAdapter();
            ...
            var cciMethods = class1TypeDef.GetMethods(context).Where(m => ((MethodSymbol)m.AsSymbol).MethodKind != MethodKind.Constructor);
