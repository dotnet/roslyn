...
");
        ...
        private static void VerifyMethods(MemoryStream stream, string containingType, string[] expectedMethods)
        {
            ...
            var compWithMetadata = CreateCompilationRaw("", references: new[] { MscorlibRef, metadataRef },
...
";
            CSharpCompilation comp = CreateCompilationRaw(source, references: new[] { MscorlibRef },
            ...
            var compWithReal = CreateCompilationRaw("", references: new[] { MscorlibRef, realImage },
                options: TestOptions.DebugDll.WithMetadataImportOptions(MetadataImportOptions.All));
            AssertEx.Equal(
            ...
            var compWithReal2 = CreateCompilationRaw("", references: new[] { MscorlibRef, realImage2 },
                options: TestOptions.DebugDll.WithMetadataImportOptions(MetadataImportOptions.All));
            AssertEx.Equal(
                new[] { "<Module>", "<>f__AnonymousType0<<anonymous>j__TPar>", "PublicClass" },
            ...
            var compWithMetadata = CreateCompilationRaw("", references: new[] { MscorlibRef, metadataImage },
                options: TestOptions.DebugDll.WithMetadataImportOptions(MetadataImportOptions.All));
            AssertEx.Equal(
            ...
            var compWithRef = CreateCompilationRaw("", references: new[] { MscorlibRef, refImage },
                options: TestOptions.DebugDll.WithMetadataImportOptions(MetadataImportOptions.All));
            AssertEx.Equal(
                new[] { "<Module>", "PublicClass" },
...
";
        ...
        {
            CSharpCompilation comp = CreateCompilationRaw("", references: new[] { MscorlibRef },
                options: TestOptions.DebugDll.WithDeterministic(true));
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseDll.WithPlatform(Platform.Itanium), assemblyName: "PlatformMismatch");
...
";
            var useCompilation = CreateCompilationRaw(useSource,
            ...
            useCompilation = CreateCompilationRaw(useSource,
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseModule.WithPlatform(Platform.Itanium), assemblyName: "PlatformMismatch");
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseDll.WithPlatform(Platform.X86), assemblyName: "PlatformMismatch");
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseModule.WithPlatform(Platform.X86), assemblyName: "PlatformMismatch");
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseDll.WithPlatform(Platform.AnyCpu), assemblyName: "PlatformMismatch");
...
{}
";
            var refCompilation = CreateCompilationRaw(refSource, options: TestOptions.ReleaseModule.WithPlatform(Platform.AnyCpu), assemblyName: "PlatformMismatch");
...
";
        ...
        {
            var comp = CreateCompilationRaw("", new[] { TestReferences.SymbolsTests.netModule.x64COFF }, options: TestOptions.DebugDll);
