...
class C
{
    static int F() { var <N:0>x</N:0> = (1, (2, 3)); return x.Item1 + x.Item2.Item1 + x.Item2.Item2; }
}");
            var source1 = MarkedSource(@"
class C
{
    static int F() { var <N:0>x</N:0> = (1, 2, 3); return x.Item1 + x.Item2 + x.Item3; }
}");

            var source2 = MarkedSource(@"
class C
{
    static int F() { var <N:0>x</N:0> = (1, 3); return x.Item1 + x.Item2; }
}");
...
class C
{
    static int F() { (int x, int y, int z) <N:0>a</N:0> = (1, 2, 3); return a.Item1 + a.Item2 + a.Item3; }
}");
            var source1 = MarkedSource(@"
class C
{
    static int F() { (int x, int z) <N:0>b</N:0> = (1, 3); return b.Item1 + b.Item2; }
}");

            var source2 = MarkedSource(@"
class C
{
    static int F() { (int x, int y, int z, int w) <N:0>a</N:0> = (1, 2, 3, 4); return a.Item1 + a.Item2 + a.Item3 + a.Item4; }
}");
            ...
            v0.VerifyIL("C.F", @"
{
  // Code size       35 (0x23)
  .maxstack  3
  .locals init (System.ValueTuple<int, int, int> V_0, //a
                int V_1)
  IL_0000:  nop
  IL_0001:  ldc.i4.1
  IL_0002:  ldc.i4.2
  IL_0003:  ldc.i4.3
  IL_0004:  newobj     ""System.ValueTuple<int, int, int>..ctor(int, int, int)""
  IL_0009:  stloc.0
  IL_000a:  ldloc.0
  IL_000b:  ldfld      ""int System.ValueTuple<int, int, int>.Item1""
  IL_0010:  ldloc.0
  IL_0011:  ldfld      ""int System.ValueTuple<int, int, int>.Item2""
  IL_0016:  add
  IL_0017:  ldloc.0
  IL_0018:  ldfld      ""int System.ValueTuple<int, int, int>.Item3""
  IL_001d:  add
  IL_001e:  stloc.1
            ...
            diff1.VerifyIL("C.F", @"
{
  ...
  .locals init ([unchanged] V_0,
                [int] V_1,
                System.ValueTuple<int, int> V_2, //b
                int V_3)
  IL_0000:  nop
  IL_0001:  ldc.i4.1
  IL_0002:  ldc.i4.3
  ...
  IL_0008:  stloc.2
  IL_0009:  ldloc.2
  IL_000a:  ldfld      ""int System.ValueTuple<int, int>.Item1""
  IL_000f:  ldloc.2
            ...
            diff2.VerifyIL("C.F", @"
{
  ...
  .locals init ([unchanged] V_0,
                ...
                [unchanged] V_2,
                [int] V_3,
                System.ValueTuple<int, int, int, int> V_4, //a
                int V_5)
  IL_0000:  nop
  IL_0001:  ldc.i4.1
  IL_0002:  ldc.i4.2
  IL_0003:  ldc.i4.3
  IL_0004:  ldc.i4.4
  IL_0005:  newobj     ""System.ValueTuple<int, int, int, int>..ctor(int, int, int, int)""
  IL_000a:  stloc.s    V_4
  IL_000c:  ldloc.s    V_4
  IL_000e:  ldfld      ""int System.ValueTuple<int, int, int, int>.Item1""
  IL_0013:  ldloc.s    V_4
  IL_0015:  ldfld      ""int System.ValueTuple<int, int, int, int>.Item2""
  IL_001a:  add
  IL_001b:  ldloc.s    V_4
  IL_001d:  ldfld      ""int System.ValueTuple<int, int, int, int>.Item3""
  IL_0022:  add
  IL_0023:  ldloc.s    V_4
  IL_0025:  ldfld      ""int System.ValueTuple<int, int, int, int>.Item4""
  IL_002a:  add
  IL_002b:  stloc.s    V_5
  IL_002d:  br.s       IL_002f
  IL_002f:  ldloc.s    V_5
