...
@"namespace N
{
    abstract class C
    {
        ...
        protected C() {}
            ...
            Func<bool, Action<ModuleSymbol>> validator = isFromSource => module =>
            {
                var type = module.GlobalNamespace.GetNamespaceMembers().Where(n => n.Name == "N").Single().GetTypeMembers("C").Single();
...
class Properties
{
    ...
    private object Private { get; set; }
            ...
            Func<bool, Action<ModuleSymbol>> validator = isFromSource => module =>
            {
                var nmspace = module.GlobalNamespace.GetNamespaceMembers().Where(n => n.Name == "Namespace").Single();
