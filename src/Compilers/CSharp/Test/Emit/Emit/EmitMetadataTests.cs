...
public class Child : Parent, IParent
{
        ...
        public void DataSectionStringLiterals_MissingMembers()
        {
            ...
            var comp = CreateCompilation(source, parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "0"));
            ...
            comp = CreateCompilation(source, parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "0"));
            ...
            comp = CreateCompilation(source, parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "1"));
            comp.MakeMemberMissing(WellKnownMember.System_Text_Encoding__get_UTF8);
            comp.MakeMemberMissing(WellKnownMember.System_Text_Encoding__GetString);
            comp.VerifyDiagnostics(
                // error CS0656: Missing compiler required member 'System.Text.Encoding.get_UTF8'
            ...
            comp = CreateCompilation(source, parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "3"));
            comp.MakeMemberMissing(WellKnownMember.System_Text_Encoding__get_UTF8);
            comp.MakeMemberMissing(WellKnownMember.System_Text_Encoding__GetString);
            comp.VerifyDiagnostics(
                // error CS0656: Missing compiler required member 'System.Text.Encoding.get_UTF8'
        ...
        public void DataSectionStringLiterals_Threshold()
        {
            ...
            foreach (var feature in new[] { "off", null })
            {
                verifier = CompileAndVerify(source,
                    parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, null),
            ...
            {
                verifier = CompileAndVerify(source,
                    parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, feature),
                    expectedOutput: expectedOutput)
                    .VerifyDiagnostics()
                    .VerifyIL("<top-level-statements-entry-point>", expectedIl);
            ...
            verifier = CompileAndVerify(source,
                parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "1000"),
                expectedOutput: expectedOutput)
                .VerifyDiagnostics()
                .VerifyIL("<top-level-statements-entry-point>", expectedIl);
            ...
            verifier = CompileAndVerify(source,
                parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "3"),
                expectedOutput: expectedOutput)
                .VerifyDiagnostics()
                .VerifyIL("<top-level-statements-entry-point>", expectedIl);
            ...
            verifier = CompileAndVerify(source,
                parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "2"),
                verify: Verification.Fails,
                expectedOutput: expectedOutput)
                .VerifyDiagnostics()
            ...
            verifier = CompileAndVerify(source,
                parseOptions: TestOptions.Regular.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "1"),
                verify: Verification.Fails,
                expectedOutput: expectedOutput)
                .VerifyDiagnostics()
                .VerifyIL("<top-level-statements-entry-point>", """
        ...
        public void PrivateImplDetailsWithoutString()
        {
            ...
            CreateEmptyCompilation(source,
                parseOptions: parseOptions.WithFeature(Feature.ExperimentalDataSectionStringLiterals, "0"))
                .VerifyDiagnostics(
                // error CS0656: Missing compiler required member 'System.Text.Encoding.get_UTF8'
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember).WithArguments("System.Text.Encoding", "get_UTF8").WithLocation(1, 1),
                // error CS0656: Missing compiler required member 'System.Text.Encoding.GetString'
