...
class Test
{
    public virtual void Method(in int x) { }
            ...
            CompileAndVerify(code, verify: Verification.Skipped, sourceSymbolValidator: validator, symbolValidator: validator);
        }
...
class Child: Parent, IM
{
    public void M(in int x) { }
            ...
            CompileAndVerify(code, verify: Verification.Skipped, symbolValidator: module =>
            {
                // Nothing on Parent
