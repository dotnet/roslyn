...
";
            ...
            CompileAndVerify(text, verify: Verification.Skipped, symbolValidator: module =>
            {
...
";
            ...
            CompileAndVerify(codeB, verify: Verification.Skipped, additionalRefs: new[] { referenceA }, symbolValidator: module =>
            {
                var type = module.ContainingAssembly.GetTypeByMetadataName("Test").GetTypeMember("S1");
...
public class Test1
{
	public ref struct S1{}
            ...
            CompileAndVerify(code2, verify: Verification.Skipped, symbolValidator: module =>
            {
...
public class Test
{
    public ref struct S1{}
            ...
            CompileAndVerify(code, verify: Verification.Skipped, additionalRefs: new[] { reference }, options: TestOptions.ReleaseModule, symbolValidator: module =>
            {
                var type = module.ContainingAssembly.GetTypeByMetadataName("Test").GetTypeMember("S1");
...
public class Test1
{
	public ref struct S1{}
            ...
            var comp1 = CompileAndVerify(code1, options: options, verify: Verification.Skipped, symbolValidator: module =>
            {
                AssertGeneratedEmbeddedAttribute(module.ContainingAssembly, AttributeDescription.CodeAnalysisEmbeddedAttribute.FullName);
                AssertGeneratedEmbeddedAttribute(module.ContainingAssembly, AttributeDescription.IsByRefLikeAttribute.FullName);
            });
...
namespace System
{
    ...
    public ref struct NotTypedReference { }
            ...
            CompileAndVerify(compilation1, verify: Verification.Skipped, symbolValidator: module =>
            {
