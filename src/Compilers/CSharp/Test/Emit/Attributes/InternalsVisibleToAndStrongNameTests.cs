...
";
        ...
        public void PubKeyFromKeyFileAttribute()
        {
            ...
            CSharpCompilation other = CreateCompilation(s, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider));
            ...
            CompileAndVerify(other, symbolValidator: (ModuleSymbol m) =>
            {
                ...
                foreach (CSharpAttributeData attrData in m.ContainingAssembly.GetAttributes())
                {
        ...
        public void PubKeyFromKeyFileAttribute_AssemblyKeyFileResolver()
        {
            ...
            SyntaxTree syntaxTree = Parse(s, @"IVTAndStrongNameTests\AnotherTempDir\temp.cs");

            // verify failure with default assembly key file resolver
            CSharpCompilation comp = CreateCompilation(syntaxTree, options: TestOptions.ReleaseDll);
        ...
        public void PubKeyFromKeyFileOptions()
        {
            ...
            CSharpCompilation other = CreateCompilation(s, options: TestOptions.ReleaseDll.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultDesktopProvider));
        ...
        public void PubKeyFromKeyFileOptions_ReferenceResolver()
        {
            ...
            CSharpCompilation comp = CreateCompilation(s, options: TestOptions.ReleaseDll.WithCryptoKeyFile(keyFileName).WithStrongNameProvider(s_defaultDesktopProvider));
        ...
        public void PubKeyFromKeyFileOptionsJustPublicKey_ReferenceResolver()
        {
            ...
            // verify failure with default resolver
            CSharpCompilation comp = CreateCompilation(s,
        ...
        {
            TempFile tempFile = Temp.CreateFile().WriteAllBytes(new byte[] { 1, 2, 3, 4 });
            string s = "public class C {}";
        ...
        public void PubKeyContainerBogusOptions()
        {
            ...
            Diagnostic err = other.GetDiagnostics().Single();
...
public class C {}";
            ...
            CSharpCompilation c = CreateCompilation(source, options: TestOptions.ReleaseDll.WithCryptoPublicKey(s_publicKey));
            c.VerifyDiagnostics();
            ...
            AssemblyIdentity identity = metadata.Module.ReadAssemblyIdentityOrThrow();
...
";
            ...
            CSharpCompilation c = CreateCompilation(source, options: TestOptions.ReleaseDll.WithCryptoPublicKey(s_publicKey).WithPublicSign(true));
            c.VerifyDiagnostics(
...
public class C {}
";
            CSharpCompilation c = CreateCompilation(source, options: TestOptions.ReleaseDll.WithPublicSign(true));
            c.VerifyDiagnostics(
                // warning CS7103: Attribute 'System.Reflection.AssemblyKeyFileAttribute' is ignored when public signing is specified.
                Diagnostic(ErrorCode.WRN_AttributeIgnoredWhenPublicSigning).WithArguments("System.Reflection.AssemblyKeyFileAttribute").WithLocation(1, 1),
...
";
        ...
        {
            using (MemoryStream outStream = comp.EmitToStream())
            {
        ...
        {
            TempFile pubKeyFile = Temp.CreateFile().WriteAllBytes(TestResources.General.snPublicKey);
...
public class C {}",
    ...
    Diagnostic(ErrorCode.ERR_PublicSignButNoKey).WithLocation(1, 1));
        ...
        public void PublicKeyFromOptions_InvalidCompilationOptions()
        {
            ...
            CSharpCompilation c = CreateCompilation(source, options: TestOptions.ReleaseDll.
    ...
    @"public class A
{
    internal class B
    {
        ...
        public void IVTBasicMetadata()
        {
            ...
            MemoryStream otherStream = CreateCompilation(s, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider)).EmitToStream();
    ...
    @"public class A
{
    internal class B
    {
        ...
        public void IVTSigned()
        {
            ...
            CSharpCompilation requestor = CreateCompilation(
    @"public class A
{
    internal class B
    {
        ...
        public void IVTErrorNotBothSigned()
        {
            ...
            CSharpCompilation other = CreateCompilation(s, assemblyName: "Paul", options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider));
            other.VerifyDiagnostics();
...
public class A
{
        ...
        public void IVTGivesAccessToUsingDifferentKeys()
        {
            ...
            CSharpCompilation giver = CreateCompilation(s,
                assemblyName: "Paul",
...
class D
{
    public static void Main()
    {
        C.M();
            ...
            CSharpCompilation comp2 = CreateCompilation(src,
...
options: TestOptions.ReleaseExe
        ...
        .WithStrongNameProvider(s_defaultDesktopProvider));
            ...
            CSharpCompilation comp3 = CreateCompilation(src,
...
public class C
{
  static void Goo() {}
      ...
      options: TestOptions.ReleaseDll.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultDesktopProvider));
            ...
            TempFile tempFile = Temp.CreateFile();

            using (FileStream outStrm = tempFile.Open())
            {
                EmitResult success = other.Emit(outStrm);
        ...
        private void ConfirmModuleAttributePresentAndAddingToAssemblyResultsInSignedOutput(MemoryStream moduleContents, AttributeDescription expectedModuleAttr, bool legacyStrongName)
        {
            ...
            {
                CorFlags flags = metadata.Module.PEReaderOpt.PEHeaders.CorHeader.Flags;
                ...
                System.Collections.Generic.List<PEModule.AttributeInfo> attrInfos = metadata.Module.FindTargetAttributes(token, expectedModuleAttr);
...
public class Z
{
                ...
                CSharpCompilation assemblyComp = CreateCompilation(source,
                    new[] { metadata.GetReference() },
                    TestOptions.ReleaseDll.WithStrongNameProvider(provider));

                using (FileStream finalStrm = tempFile.Open())
                {
        ...
        public void SignModuleKeyFileAttr()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseModule.WithStrongNameProvider(s_defaultPortableProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);

            MemoryStream outStrm = other.EmitToStream();
        ...
        public void SignModuleKeyFileAttr_Legacy()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseModule.WithStrongNameProvider(s_defaultDesktopProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
        ...
        public void SignModuleKeyContainerBogus()
        {
            ...
            CSharpCompilation other = CreateCompilation(s, options: TestOptions.ReleaseModule.WithStrongNameProvider(s_defaultDesktopProvider));
            //shouldn't have an error. The attribute's contents are checked when the module is added.
            MetadataReference reference = other.EmitToImageReference();
        ...
        public void AttemptToStrongNameWithOnlyPublicKey()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseDll.WithCryptoKeyFile(PublicKeyFile).WithStrongNameProvider(s_defaultPortableProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);

            var outStrm = new MemoryStream();
            var refStrm = new MemoryStream();
            EmitResult success = other.Emit(outStrm, metadataPEStream: refStrm);
        ...
        public void AttemptToStrongNameWithOnlyPublicKey_Legacy()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseDll.WithCryptoKeyFile(PublicKeyFile).WithStrongNameProvider(s_defaultDesktopProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
        ...
        public void SignModuleKeyContainerCmdLine_Legacy()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseModule.WithCryptoKeyContainer("roslynTestContainer").WithStrongNameProvider(s_defaultDesktopProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
...
public class C {}";
            ...
            CSharpCompilation other = CreateCompilation(s, options: TestOptions.ReleaseModule.WithCryptoKeyContainer("roslynTestContainer").WithStrongNameProvider(s_defaultDesktopProvider));
        ...
        public void SignModuleKeyFileCmdLine()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseModule.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultPortableProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
        ...
        public void BothLegacyAndNonLegacyGiveTheSameOutput()
        {
            ...
            CSharpCompilationOptions commonOptions = TestOptions.ReleaseDll
            ...
            {
                CSharpCompilationOptions options = commonOptions.WithStrongNameProvider(s_defaultPortableProvider);
                CSharpCompilation compilation = CreateCompilation(s, options: options);
                MemoryStream stream = compilation.EmitToStream(emitOptions);
                stream.Position = 0;
            ...
            ImmutableArray<byte> portable = EmitAndGetPublicKey(s_defaultPortableProvider);
            ImmutableArray<byte> desktop = EmitAndGetPublicKey(s_defaultDesktopProvider);
        ...
        public void SignRefAssemblyKeyFileCmdLine()
        {
            ...
            CSharpCompilationOptions options = TestOptions.DebugDll.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultPortableProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
        ...
        public void SignModuleKeyFileCmdLine_Legacy()
        {
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseModule.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultDesktopProvider);
            CSharpCompilation other = CreateCompilation(s, options: options);
        ...
        public void SignModuleKeyFileCmdLine_2()
        {
            ...
            CSharpCompilation other = CreateCompilation(s, options: TestOptions.ReleaseModule.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultDesktopProvider));
...
public class C
{
  static void Goo() {}
      ...
      options: TestOptions.ReleaseDll.WithCryptoKeyFile(s_publicKeyFile).WithStrongNameProvider(s_defaultDesktopProvider));
            ...
            var outStrm = new MemoryStream();
            EmitResult emitResult = other.Emit(outStrm);
...
public class C
{
  static void Goo() {}
                ...
                {
                    CorHeader header = metadata.Module.PEReaderOpt.PEHeaders.CorHeader;
...
";
            ...
            CSharpCompilation comp = CreateCompilation(csharp, new[] { ilRef }, assemblyName: "asm2", options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider));
            comp.VerifyDiagnostics(
...
";
            ...
            CSharpCompilation comp1 = CreateCompilationWithMscorlib45(source1, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider), assemblyName: "asm1");
            comp1.VerifyDiagnostics();
            var ref1 = new CSharpCompilationReference(comp1);

            CSharpCompilation comp2 = CreateCompilationWithMscorlib45(source2, new[] { ref1 }, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider), assemblyName: "asm2");
            comp2.VerifyDiagnostics();
            var ref2 = new CSharpCompilationReference(comp2);

            CSharpCompilation comp3 = CreateCompilationWithMscorlib45(source3, new[] { SystemCoreRef, ref1, ref2 }, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider), assemblyName: "asm3");
            comp3.VerifyDiagnostics();

            // Note: calls B.M, not A.M, since asm1 is not accessible.
            CompilationVerifier verifier = CompileAndVerify(comp3);
...
";
            ...
            CSharpCompilation comp3 = CreateCompilationWithMscorlib45(source3, new[] { ref1, ref2 }, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider), assemblyName: "asm3");
            comp3.VerifyDiagnostics();
            var ref3 = new CSharpCompilationReference(comp3);

            CSharpCompilation comp4 = CreateCompilationWithMscorlib45(source4, new[] { SystemCoreRef, ref1, ref2, ref3 }, options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider), assemblyName: "asm4");
            comp4.VerifyDiagnostics();

            // Note: calls C.M, not A.M, since asm2 is not accessible (stops search).
            // Confirmed in Dev11.
            CompilationVerifier verifier = CompileAndVerify(comp4);
...
";
            ...
            MetadataReference ref2 = CompileIL(source2, prependDefaultHeader: false);

            CSharpCompilation comp3 = CreateCompilation(source3,
                new[] { ref1, ref2 },
                options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider),
                assemblyName: "asm3");
...
", options: TestOptions.ReleaseDll.WithStrongNameProvider(s_defaultDesktopProvider).WithCryptoKeyFile(s_keyPairFile));
            ...
            CSharpCompilation[] comps = new[] {other.WithReferences(new []{other.References.ElementAt(0), new CSharpCompilationReference(unsigned)}),
                            other.WithReferences(new []{other.References.ElementAt(0), MetadataReference.CreateFromStream(unsigned.EmitToStream()) })};

            foreach (CSharpCompilation comp in comps)
            {
                var outStrm = new MemoryStream();
                EmitResult emitResult = comp.Emit(outStrm);
        ...
        public void Bug399()
        {
            ...
            PortableExecutableReference signed = DesktopRuntimeUtil.CreateMetadataReferenceFromHexGZipImage(@"
...
e29df38b5c72727c1333f32001949a0a0e2c10f8af0a344300ab2123052840cb16e30176c72818100000c85fc49900080000", filePath: "Signed.dll");
        ...
        {
            CSharpCompilation other = CreateEmptyCompilation(
            @"
...
public class C
{
  static void Goo() {}
            ...
            CSharpCompilationOptions options = TestOptions.ReleaseDll.WithCryptoKeyFile(s_keyPairFile).WithStrongNameProvider(s_defaultDesktopProvider);

            CSharpCompilation other = CreateEmptyCompilation(source, options: options, references: new[] { MscorlibRef_v4_0_30316_17626 });

            TempFile tempFile = Temp.CreateFile();

            using (FileStream outStrm = tempFile.Open())
            {
                EmitResult result = other.Emit(outStrm);
...
public class C
{
  static void Goo() {}
      ...
      options: TestOptions.ReleaseDll.WithCryptoKeyFile(s_publicKeyFile).WithDelaySign(true).WithStrongNameProvider(s_defaultDesktopProvider), references: new[] { MscorlibRef_v4_0_30316_17626 });
        ...
        {
            CSharpCompilation ca = CreateCompilation(
    @"
...
class B
{
    static void Main()
    {
        System.Console.Write(A.I);
            ...
            CSharpCompilation ca = CreateCompilation(sourceA, options: TestOptions.ReleaseDll, assemblyName: "ClassLibrary2");
            CompileAndVerify(ca);

            CSharpCompilation cb = CreateCompilation(sourceB, options: TestOptions.ReleaseExe, assemblyName: "X", references: new[] { new CSharpCompilationReference(ca) });
...
class B
{
    static void Main()
    {
        ...
        public void Bug1095618()
        {
            ...
            CSharpCompilation ca = CreateCompilation(source);
            ...
            CompilationVerifier verifier = CompileAndVerify(ca, symbolValidator: module =>
            {
        ...
        public void ConsistentErrorMessageWhenProvidingNullKeyFile()
        {
            ...
            CSharpCompilation compilation = CreateCompilation(string.Empty, options: options).VerifyDiagnostics();
