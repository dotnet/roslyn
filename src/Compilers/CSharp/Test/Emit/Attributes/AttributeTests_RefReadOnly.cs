...
public class Test
{
    public static int operator + (in Test x, in Test y) => 0;
        ...
        [Fact]
        public void ExternMethodInParametersShouldHaveInAttribute_Simple()
        {
            var text = @"
using System.Runtime.InteropServices;
class T
{
    [DllImport(""Other.dll"")]
    public static extern void M(in int p, int q);
}";
        ...
        [Fact]
        public void ExternMethodInParametersShouldHaveInAttribute_Complex()
        {
            var text = @"
using System.Runtime.InteropServices;
class T
{
    [DllImport(""Other.dll"")]
    public static extern void M([ComAliasName(""p2"")]in int p, [ComAliasName(""q2"")]int q);
}";
        ...
        [Fact]
        public void ExternMethodInParametersShouldHaveInAttribute_UserDefinedIn()
        {
            var text = @"
using System.Runtime.InteropServices;
class T
{
    [DllImport(""Other.dll"")]
    public static extern void M([In]in int p, int q);
}";
        ...
        [Fact]
        public void NonExternMethodInParametersShouldNotHaveInAttribute()
        {
            var text = @"
using System.Runtime.InteropServices;
class T
{
    public static void M(in int p, int q) { }
}";
            ...
            CompileAndVerify(text, symbolValidator: module =>
            {
                ...
                Assert.False(parameters[0].IsMetadataIn);
                Assert.False(parameters[1].IsMetadataIn);
            });
        }
