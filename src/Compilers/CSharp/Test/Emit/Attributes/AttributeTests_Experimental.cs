...
namespace N
{
    ...
    [Experimental] public enum E { A }
            ...
            CSharpCompilation comp1 = CreateCompilation(new[] { Parse(ExperimentalAttributeSource), Parse(source1) });
...
class C
{
    static void F()
    {
        ...
        e = E.A;
            ...
            CSharpCompilation comp2A = CreateCompilation(source2, new[] { comp1.EmitToImageReference() });
            ...
            CSharpCompilation comp2B = CreateCompilation(source2, new[] { new CSharpCompilationReference(comp1) });
...
.class public C implements I
{
  .method public virtual final instance void F() { ret }
            ...
            MetadataReference ref0 = CompileIL(source0);
            var source1 =
@"#pragma warning disable 219
class Program
{
    static void Main()
    {
        ...
        ((I)o).F();     // warning CS8305: 'I.F()' is for evaluation purposes only
            ...
            CSharpCompilation comp1 = CreateCompilation(source1, new[] { ref0 });
            comp1.VerifyDiagnostics(
...
class C
{
    static void F(A a)
    {
        ...
        (new A.B()).ToString();
            ...
            CSharpCompilation comp = CreateCompilationWithMscorlib40AndSystemCore(new[] { Parse(DeprecatedAttributeSource), Parse(ExperimentalAttributeSource), Parse(source) });
...
class C
{
    ...
    static object FB() => new B();
            ...
            CSharpCompilation comp = CreateCompilationWithMscorlib40AndSystemCore(new[] { Parse(ExperimentalAttributeSource), Parse(source) });
            comp.VerifyDiagnostics(
...
[Experimental,                                   Deprecated(""DP"", DeprecationType.Remove, 0)]   public enum EP { }";
            CSharpCompilation comp1 = CreateCompilationWithMscorlib40AndSystemCore(new[] { Parse(DeprecatedAttributeSource), Parse(ExperimentalAttributeSource), Parse(source1) });
            comp1.VerifyDiagnostics();
...
@"class C
{
    ...
    static void Main()
    {
        ...
        F(default(EP));
            ...
            CSharpCompilation comp2 = CreateCompilationWithMscorlib40AndSystemCore(source2, references: new[] { comp1.EmitToImageReference() });
