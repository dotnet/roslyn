    ...
    internal abstract class DecisionTree
    {
        ...
        public static DecisionTree Create(BoundExpression expression, TypeSymbol type, Symbol enclosingSymbol)
        {
            ...
            if (expression.ConstantValue == null)
            {
                ...
                temp = new SynthesizedLocal(enclosingSymbol as MethodSymbol, TypeSymbolWithAnnotations.Create(type), SynthesizedLocalKind.PatternMatchingTemp, expression.Syntax, false, RefKind.None);
