...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class BoundLambda : IBoundLambdaOrFunction
    {
            ...
            BoundNode node, CSharpCompilation compilation, ConversionsBase conversions, TypeSymbol delegateType, bool isAsync, bool withDependencies)
        {
            ...
            return new InferredLambdaReturnType(types.Count, hasReturnWithoutArgument, refKind, bestType,
    ...
    internal abstract class UnboundLambdaState
    {
        ...
        private BoundLambda ReallyBind(NamedTypeSymbol delegateType)
        {
            ...
            LambdaSymbol lambdaSymbol = CreateLambdaSymbol(
                ...
                out BindingDiagnosticBag diagnostics,
        ...
        private LambdaSymbol CreateLambdaSymbol(NamedTypeSymbol delegateType, Symbol containingSymbol, out MethodSymbol invokeMethod, out TypeWithAnnotations returnType, out BindingDiagnosticBag diagnostics, out ReturnInferenceCacheKey cacheKey)
        {
            ...
            diagnostics = BindingDiagnosticBag.GetInstance(withDiagnostics: true, _unboundLambda.WithDependencies);
