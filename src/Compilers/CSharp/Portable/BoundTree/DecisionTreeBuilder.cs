    ...
    internal abstract class DecisionTreeBuilder
    {
        ...
        private DecisionTree AddByValue(DecisionTree.ByType byType, BoundConstantPattern value, DecisionMaker makeDecision)
        {
            ...
            if (forType == null)
            {
                ...
                var localSymbol = new SynthesizedLocal(_enclosingSymbol as MethodSymbol, TypeSymbolWithAnnotations.Create(type), SynthesizedLocalKind.PatternMatchingTemp, Syntax, false, RefKind.None);
