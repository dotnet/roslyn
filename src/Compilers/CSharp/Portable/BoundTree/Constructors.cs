...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        public BoundBlock(SyntaxNode syntax, ImmutableArray<LocalSymbol> locals, ImmutableArray<BoundStatement> statements, bool hasErrors = false) : this(syntax, locals, ImmutableArray<LocalFunctionSymbol>.Empty, inUnsafeRegion: ThreeState.Unknown, statements, hasErrors)
        {
        }
