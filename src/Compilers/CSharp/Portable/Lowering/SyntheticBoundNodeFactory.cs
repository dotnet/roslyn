...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class SyntheticBoundNodeFactory
    {
        ...
        {
            Debug.Assert((object)CurrentFunction != null && !CurrentFunction.IsStatic);
            return new BoundBaseReference(Syntax, explicitBaseReferenceOpt: null, CurrentFunction.ThisParameter.Type.BaseTypeNoUseSiteDiagnostics) { WasCompilerGenerated = true };
        }
