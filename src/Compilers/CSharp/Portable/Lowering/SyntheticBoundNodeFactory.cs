...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class SyntheticBoundNodeFactory
    {
        ...
        public BoundReturnStatement Return(BoundExpression expression = null)
        {
            if (expression != null)
            {
                ...
                if (conversion.Kind != ConversionKind.Identity)
                {
                    ...
                    expression = BoundConversion.Synthesized(Syntax, expression, conversion, false, explicitCastInCode: false, conversionGroup: null, ConstantValue.NotAvailable, CurrentMethod.ReturnType.TypeSymbol);
                }
            }
        ...
        public BoundExpression Convert(TypeSymbol type, BoundExpression arg, Conversion conversion, bool isChecked = false)
        {
            ...
            return new BoundConversion(Syntax, arg, conversion, @checked: isChecked, explicitCastInCode: true, conversionGroup: null, null, type) { WasCompilerGenerated = true };
        }
