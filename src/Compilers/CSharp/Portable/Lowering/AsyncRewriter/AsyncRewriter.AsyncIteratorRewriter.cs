        ...
        private sealed class AsyncIteratorRewriter : AsyncRewriter
        {
            ...
            private void GenerateIAsyncEnumeratorImplementation_MoveNextAsync()
            {
                ...
                NamedTypeSymbol IAsyncEnumeratorOfElementType =
                    ...
                    .Construct(_currentField.TypeWithAnnotations.Type);
                ...
                var promiseType = (NamedTypeSymbol)_promiseOfValueOrEndField.TypeWithAnnotations.Type;
                ...
                var moveNextAsyncReturnType = (NamedTypeSymbol)IAsyncEnumerableOfElementType_MoveNextAsync.ReturnTypeWithAnnotations.Type;
                ...
                out BoundExpressionStatement startCall, out MethodSymbol promise_get_Version)
            {
                ...
                var resetMethod = (MethodSymbol)F.WellKnownMethod(WellKnownMember.System_Threading_Tasks_Sources_ManualResetValueTaskSourceCore_T__Reset, isOptional: true)
                    .SymbolAsMember((NamedTypeSymbol)_promiseOfValueOrEndField.TypeWithAnnotations.Type);
                ...
                promise_get_Version = F.WellKnownMethod(WellKnownMember.System_Threading_Tasks_Sources_ManualResetValueTaskSourceCore_T__get_Version)
                    .AsMember((NamedTypeSymbol)_promiseOfValueOrEndField.TypeWithAnnotations.Type);
            }
            ...
            private void GenerateIAsyncDisposable_DisposeAsync()
            {
                ...
                TypeSymbol returnType = IAsyncDisposable_DisposeAsync.ReturnTypeWithAnnotations.Type;
                ...
                MethodSymbol valueTask_ctor =
                    ...
                    .AsMember((NamedTypeSymbol)IAsyncDisposable_DisposeAsync.ReturnTypeWithAnnotations.Type);
            ...
            protected override void GenerateMoveNext(SynthesizedImplementationMethod moveNextMethod)
            {
                ...
                {
                    setResultMethod = (MethodSymbol)setResultMethod.SymbolAsMember((NamedTypeSymbol)_promiseOfValueOrEndField.TypeWithAnnotations.Type);
                }
                ...
                {
                    setExceptionMethod = (MethodSymbol)setExceptionMethod.SymbolAsMember((NamedTypeSymbol)_promiseOfValueOrEndField.TypeWithAnnotations.Type);
                }
