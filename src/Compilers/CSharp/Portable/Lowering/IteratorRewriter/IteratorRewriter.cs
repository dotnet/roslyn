...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class IteratorRewriter : StateMachineRewriter
    {
            ...
            out IteratorStateMachine stateMachineType)
        {
            ...
            bool isEnumerable;
            switch (method.ReturnTypeWithAnnotations.Type.OriginalDefinition.SpecialType)
            {
                ...
                default:
                    throw ExceptionUtilities.UnexpectedValue(method.ReturnTypeWithAnnotations.Type.OriginalDefinition.SpecialType);
            }
