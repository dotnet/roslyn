...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SynthesizedMethodBaseSymbol : SourceMemberMethodSymbol
    {
        ...
        private ImmutableArray<ParameterSymbol> MakeParameters()
        {
            ...
            {
                builder.Add(SynthesizedParameterSymbol.Create(this, this.TypeMap.SubstituteType(p.OriginalDefinition.TypeWithAnnotations), ordinal++, p.RefKind, p.Name, isNullChecked:((SourceParameterSymbolBase) p).IsNullChecked));
            }
