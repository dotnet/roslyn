...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal abstract partial class MethodToClassRewriter : BoundTreeToDifferentEnclosingContextRewriter
    {
        ...
        public override BoundNode VisitObjectInitializerMember(BoundObjectInitializerMember node)
        {
            ...
            return node.Update(member, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.DefaultArguments, node.ResultKind, node.AccessorKind, node.UnderlyingAccessOpt, receiverType, type);
        }
