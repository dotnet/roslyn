...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
            ...
            TypeSymbol rewrittenResultType)
        {
            ...
            Debug.Assert(rewrittenRight.Type.Equals(rewrittenResultType, ignoreDynamic: true, ignoreTupleNames: true));
            ...
            Debug.Assert(convertedLeft.Type.Equals(rewrittenResultType, ignoreDynamic: true, ignoreTupleNames: true));
            ...
            Debug.Assert(conditionalExpression.Type.Equals(rewrittenResultType, ignoreDynamic: true, ignoreTupleNames: true));
