...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
            ...
            TypeSymbol rewrittenResultType)
        {
            ...
            Debug.Assert(rewrittenRight.Type.Equals(rewrittenResultType, TypeCompareKind.IgnoreDynamic | TypeCompareKind.IgnoreTupleNames));
            ...
            Debug.Assert(convertedLeft.Type.Equals(rewrittenResultType, TypeCompareKind.IgnoreDynamic | TypeCompareKind.IgnoreTupleNames));
            ...
            Debug.Assert(conditionalExpression.Type.Equals(rewrittenResultType, TypeCompareKind.IgnoreDynamic | TypeCompareKind.IgnoreTupleNames));
