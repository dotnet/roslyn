            ...
            bool used)
        {
            ...
            if (setMethod is null)
            {
                ...
                Debug.Assert(autoProp.IsAutoPropertyWithGetAccessor || (
                        autoProp.SetMethod is null or SourcePropertyAccessorSymbol { IsEquivalentToBackingFieldAccess: true } &&
                        (autoProp.GetMethod is SourcePropertyAccessorSymbol { IsEquivalentToBackingFieldAccess: true } || autoProp.FieldKeywordBackingField is not null)
                    ),
