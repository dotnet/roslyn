...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        public override BoundNode VisitConversion(BoundConversion node)
        {
            ...
            Debug.Assert(result.Type.Equals(toType, ignoreDynamic: true, ignoreTupleNames: true));
            ...
            TypeSymbol rewrittenType)
        {
            ...
            switch (conversion.Kind)
            {
                case ConversionKind.Identity:
                    ...
                    if (_inExpressionLambda || !rewrittenOperand.Type.Equals(rewrittenType, ignoreCustomModifiersAndArraySizesAndLowerBounds: false, ignoreDynamic: false, ignoreTupleNames: false))
                    {
                        break;
                    }
                ...
                case ConversionKind.ExplicitTupleLiteral:
                    {
                        ...
                        Debug.Assert(rewrittenOperand.Type.Equals(rewrittenType, ignoreDynamic: true, ignoreTupleNames: true));
                        return rewrittenOperand;
                    }
