...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        public override BoundNode VisitConversion(BoundConversion node)
        {
            ...
            Debug.Assert(result.Type.Equals(toType, TypeCompareKind.IgnoreDynamic | TypeCompareKind.IgnoreTupleNames));
                ...
                case ConversionKind.ExplicitTupleLiteral:
                    {
                        ...
                        Debug.Assert(rewrittenOperand.Type.Equals(rewrittenType, TypeCompareKind.IgnoreDynamic | TypeCompareKind.IgnoreTupleNames));
                        return rewrittenOperand;
                    }
