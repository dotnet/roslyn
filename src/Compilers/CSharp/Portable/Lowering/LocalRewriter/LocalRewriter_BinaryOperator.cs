...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
        ...
        /// If used, a unit-test with a missing member is absolutely a must have.
        /// </summary>
        internal static MethodSymbol UnsafeGetNullableMethod(SyntaxNode syntax, TypeSymbol nullableType, SpecialMember member, CSharpCompilation compilation, in BindingDiagnosticBag diagnostics)
        {
