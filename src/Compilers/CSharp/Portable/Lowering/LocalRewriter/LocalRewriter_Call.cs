    ...
    internal sealed partial class LocalRewriter
    {
            ...
            bool invokedAsExtensionMethod)
        {
            ...
            if (CanSkipRewriting(arguments, methodOrIndexer, expanded, argsToParamsOpt, invokedAsExtensionMethod, out var _))
            {
                ...
                {
                    argumentsBuilder.Add(operationFactory.CreateArgumentOperation(ArgumentKind.Explicit, parameters[i], arguments[i], arguments[i].WasCompilerGenerated));
                }
                ...
                {
                    argumentsBuilder.Add(operationFactory.CreateArgumentOperation(ArgumentKind.Explicit, null, arguments[i], arguments[i].WasCompilerGenerated));
                }
            ...
            Binder binder)
        {
            ...
            for (int a = 0; a < arguments.Length; ++a)
            {
                ...
                argumentsInEvaluationBuilder.Add(operationFactory.CreateArgumentOperation(kind, parameter, argument, argument.WasCompilerGenerated));
            }
            ...
            ArrayBuilder<IArgument> argumentsBuilder)
        {
            ...
            foreach (ParameterSymbol parameter in missingParameters)
            {
                ...
                argumentsBuilder.Add(operationFactory.CreateArgumentOperation(kind, parameter, argument, argument.WasCompilerGenerated));
            }
        }
