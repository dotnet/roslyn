        ...
        private abstract class PatternLocalRewriter
        {
                    ...
                    case BoundDagTypeEvaluation t:
                        {
                            ...
                            Binder.ReportUseSite(_factory.Compilation, t.Syntax, useSiteInfo, _localRewriter._diagnostics, recordUsage: true);
                ...
                out BoundExpression testExpression)
            {
                    ...
                    typeEvaluation2.Input == nonNullTest.Input)
                {
                    ...
                    Binder.ReportUseSite(_factory.Compilation, test.Syntax, useSiteInfo, _localRewriter._diagnostics, recordUsage: true);
                    return true;
                }
