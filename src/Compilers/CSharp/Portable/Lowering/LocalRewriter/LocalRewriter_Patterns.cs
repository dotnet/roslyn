                    ...
                    case BoundDagFieldEvaluation f:
                        {
                            ...
                            var outputTemp = new BoundDagTemp(f.Syntax, field.TypeWithAnnotations.Type, f, index: 0);
                            BoundExpression output = _tempAllocator.GetTemp(outputTemp);
                            BoundExpression access = _localRewriter.MakeFieldAccess(f.Syntax, input, field, null, LookupResultKind.Viable, field.TypeWithAnnotations.Type);
                    ...
                    case BoundDagPropertyEvaluation p:
                        {
                            ...
                            var outputTemp = new BoundDagTemp(p.Syntax, property.TypeWithAnnotations.Type, p, index: 0);
                            BoundExpression output = _tempAllocator.GetTemp(outputTemp);
                    ...
                    case BoundDagDeconstructEvaluation d:
                        {
                            ...
                            for (int i = extensionExtra; i < method.ParameterCount; i++)
                            {
                                ...
                                var outputTemp = new BoundDagTemp(d.Syntax, parameter.TypeWithAnnotations.Type, d, i - extensionExtra);
                    ...
                    case BoundDagIndexEvaluation e:
                        {
                            ...
                            Debug.Assert(e.Property.GetMethod.Parameters[0].TypeWithAnnotations.SpecialType == SpecialType.System_Int32);
                            TypeSymbol type = e.Property.GetMethod.ReturnTypeWithAnnotations.Type;
                        ...
                        case BoundEvaluationDecisionDagNode evalNode:
                                ...
                                field.TupleElementIndex is int i)
                            {
                                if (!tupleElementEvaluated[i])
                                {
                                    ...
                                    var temp = new BoundDagTemp(eval.Syntax, field.TypeWithAnnotations.Type, eval, 0);
