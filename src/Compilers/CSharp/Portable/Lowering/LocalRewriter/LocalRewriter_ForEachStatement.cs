    ...
    internal partial class LocalRewriter
    {
            ...
            out bool hasAsyncDisposal)
        {
            ...
            if (disposeMethod is null)
            {
                ...
                implementsInterface = conversions.ClassifyImplicitConversionFromType(enumeratorType, idisposableTypeSymbol, ref useSiteInfo).IsImplicit ||
                                      (enumeratorType is TypeParameterSymbol { AllowByRefLike: true } typeParameter ?
                                           conversions.ImplementsVarianceCompatibleInterface(typeParameter, idisposableTypeSymbol, ref useSiteInfo) :
                                           (enumeratorType.IsRefLikeType && conversions.ImplementsVarianceCompatibleInterface(enumeratorType, idisposableTypeSymbol, ref useSiteInfo)));
