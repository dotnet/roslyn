...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        ...
        private BoundStatement RewriteEnumeratorForEachStatement(BoundForEachStatement node)
        {
            ...
            TypeSymbol elementType = enumeratorInfo.ElementType.Type;
            ...
            if (isAsync)
            {
                rewrittenCondition = RewriteAwaitExpression(forEachSyntax, rewrittenCondition, node.AwaitOpt, node.AwaitOpt.GetResult.ReturnTypeWithAnnotations.Type, used: true);
            }
        ...
        {
            TypeSymbol awaitExpressionType = disposeAwaitableInfoOpt.GetResult?.ReturnTypeWithAnnotations.Type ?? _compilation.DynamicType;
        ...
        private BoundStatement RewriteSingleDimensionalArrayForEachStatement(BoundForEachStatement node)
        {
            ...
            BoundExpression iterationVarInitValue = MakeConversionNode(
                ...
                rewrittenOperand: new BoundArrayAccess(
                    ...
                    type: arrayType.ElementTypeWithAnnotations.Type),
                conversion: node.ElementConversion,
                rewrittenType: node.IterationVariableType.Type,
                @checked: node.Checked);
