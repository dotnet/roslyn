...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class LocalRewriter
    {
            ...
            bool isRhsNestedInitializer)
        {
            ...
            Debug.Assert(_compilation.Conversions.HasImplicitConversionToOrImplementsVarianceCompatibleInterface(rewrittenReceiver.Type, memberSymbol.ContainingType, ref discardedUseSiteInfo));
