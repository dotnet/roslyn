    ...
    internal sealed partial class LocalRewriter
    {
            ...
            bool isRhsNestedInitializer)
        {
            ...
            Debug.Assert(_compilation.Conversions.ClassifyConversionFromType(rewrittenReceiver.Type, memberSymbol.ContainingType, isChecked: false, ref discardedUseSiteInfo).IsImplicit ||
                         (memberSymbol.IsExtensionBlockMember() && !memberSymbol.IsStatic && ConversionsBase.IsValidExtensionMethodThisArgConversion(_compilation.Conversions.ClassifyConversionFromType(rewrittenReceiver.Type, memberSymbol.RequiredContainingType.RequiredExtensionParameter.Type, isChecked: false, ref discardedUseSiteInfo))) ||
