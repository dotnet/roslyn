...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class MethodCompiler : CSharpSymbolVisitor<TypeCompilationState, object>
    {
            ...
            TypeCompilationState compilationState)
        {
            ...
            try
            {
                ...
                else if (methodSymbol.IsScriptInitializer)
                {
                    ...
                    var unusedDiagnostics = BindingDiagnosticBag.GetInstance();
                    DefiniteAssignmentPass.Analyze(_compilation, methodSymbol, initializerStatements, unusedDiagnostics.DiagnosticBag, requireOutParamsAssigned: false);
        ...
        private static void GenerateExternalMethodWarnings(SourceMemberMethodSymbol methodSymbol, BindingDiagnosticBag diagnostics)
        {
