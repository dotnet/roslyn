                ...
                var body = F.Block(
                        ...
                        F.If(
                            F.Binary(BinaryOperatorKind.ObjectNotEqual, F.SpecialType(SpecialType.System_Boolean),
                                F.Parameter(text),
                                F.Null(text.TypeWithAnnotations.Type)),
                            F.Block(
                                ...
                                F.Assignment(
                                    F.Local(hashCode),
                                    F.Binary(BinaryOperatorKind.Multiplication, hashCode.TypeWithAnnotations.Type,
                                        F.Binary(BinaryOperatorKind.Xor, hashCode.TypeWithAnnotations.Type,
                                            F.Convert(hashCode.TypeWithAnnotations.Type,
                                                F.Call(
                                                    F.Parameter(text),
                                ...
                                F.Assignment(
                                    F.Local(i),
                                    F.Binary(BinaryOperatorKind.Addition, i.TypeWithAnnotations.Type,
                                        F.Local(i),
                                        F.Literal(1))),
                                F.Label(start),
                                F.If(
