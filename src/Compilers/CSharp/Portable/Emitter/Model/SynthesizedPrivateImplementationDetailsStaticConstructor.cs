                ...
                foreach (KeyValuePair<int, InstrumentationPayloadRootField> payloadRoot in ContainingPrivateImplementationDetailsType.GetInstrumentationPayloadRoots())
                {
                    ...
                    BoundStatement payloadInitialization =
                        factory.Assignment(
                            ...
                            factory.Array(payloadArrayType.ElementTypeWithAnnotations.Type, factory.Binary(BinaryOperatorKind.Addition, factory.SpecialType(SpecialType.System_Int32), factory.MaximumMethodDefIndex(), factory.Literal(1))));
