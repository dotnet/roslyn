...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
        ...
        Cci.IPointerTypeReference
    {
        ...
        {
            var type = ((PEModuleBuilder)context.Module).Translate(this.PointedAtTypeWithAnnotations.Type, syntaxNodeOpt: (CSharpSyntaxNode)context.SyntaxNodeOpt, diagnostics: context.Diagnostics);
