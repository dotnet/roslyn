...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
        ...
        Cci.IEventDefinition
    {
        ...
        {
            return ((PEModuleBuilder)context.Module).Translate(this.TypeWithAnnotations.Type, syntaxNodeOpt: (CSharpSyntaxNode)context.SyntaxNodeOpt, diagnostics: context.Diagnostics);
        }
