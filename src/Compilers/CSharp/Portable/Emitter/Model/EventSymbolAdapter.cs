...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
        ...
        Cci.IEventDefinition
    {
        ...
        {
            return ((PEModuleBuilder)context.Module).Translate(AdaptedEventSymbol.Type, syntaxNodeOpt: (CSharpSyntaxNode?)context.SyntaxReference?.GetSyntax(), diagnostics: context.Diagnostics);
        }
