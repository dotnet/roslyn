...
#endif
    {
        Cci.INamespace Cci.INamespace.ContainingNamespace => AdaptedNamespaceSymbol.ContainingNamespace?.GetAdapter();
        string Cci.INamedEntity.Name => AdaptedNamespaceSymbol.MetadataName;

        CodeAnalysis.Symbols.INamespaceSymbolInternal Cci.INamespace.AsSymbol => AdaptedNamespaceSymbol;
    }
}
