...
#nullable disable
        ...
        private void ReportExportedTypeNameCollisions(ImmutableArray<Cci.ExportedType> exportedTypes, DiagnosticBag diagnostics)
        {
            ...
            {
                var type = (NamedTypeSymbol)exportedType.Type.AsSymbol;
...
#nullable disable
            ...
            bool needDeclaration = false)
        {
            ...
            if (!namedTypeSymbol.IsDefinition)
            {
                ...
                {
                    return (Cci.INamedTypeReference)GetAdapter(namedTypeSymbol);
                }
            }
        ...
        private object GetAdapter(Symbol symbol)
        {
            return _genericInstanceMap.GetOrAdd(symbol, s => s.GetAdapter());
        }
            ...
            bool needDeclaration = false)
        {
            ...
            if (!fieldSymbol.IsDefinition)
            {
                ...
                return (Cci.IFieldReference)GetAdapter(fieldSymbol);
            }
            ...
            bool needDeclaration)
        {
            ...
            if (!methodSymbol.IsDefinition)
            {
                ...
                return (Cci.IMethodReference)GetAdapter(methodSymbol);
            }
            else if (!needDeclaration)
            {
        ...
        {
            return (Cci.IArrayTypeReference)GetAdapter(symbol);
        }

        internal Cci.IPointerTypeReference Translate(PointerTypeSymbol symbol)
        {
            return (Cci.IPointerTypeReference)GetAdapter(symbol);
        }

        internal Cci.IFunctionPointerTypeReference Translate(FunctionPointerTypeSymbol symbol)
        {
            return (Cci.IFunctionPointerTypeReference)GetAdapter(symbol);
        }
