        ...
        internal SynthesizedAttributeData SynthesizeNullableAttributeIfNecessary(Symbol symbol, byte? nullableContextValue, TypeWithAnnotations type)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var value = flagsBuilder.SelectAsArray<byte, NamedTypeSymbol, TypedConstant>((flag, byteType) => new TypedConstant(byteType, TypedConstantKind.Primitive, flag), byteType);
