...
namespace Microsoft.CodeAnalysis.CSharp.Emit
{
    ...
    internal sealed class GenericNestedTypeInstanceReference : GenericTypeInstanceReference, Cci.INestedTypeReference
    {
        ...
        {
            return ((PEModuleBuilder)context.Module).Translate(UnderlyingNamedType.ContainingType, syntaxNodeOpt: (CSharpSyntaxNode)context.SyntaxReference?.GetSyntax(), diagnostics: context.Diagnostics);
        }
