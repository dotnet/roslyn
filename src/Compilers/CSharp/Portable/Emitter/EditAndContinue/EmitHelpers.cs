...
namespace Microsoft.CodeAnalysis.CSharp.Emit
{
    internal static class EmitHelpers
    {
            ...
            PEDeltaAssemblyBuilder moduleBeingBuilt)
        {
            ...
            var sourceContext = new EmitContext((PEModuleBuilder)previousGeneration.PEModuleBuilder, syntaxNodeOpt: null, rebuildDataOpt: null, new DiagnosticBag(), metadataOnly: false, includePrivateMembers: true);
            var otherContext = new EmitContext(moduleBeingBuilt, syntaxNodeOpt: null, rebuildDataOpt: null, new DiagnosticBag(), metadataOnly: false, includePrivateMembers: true);
