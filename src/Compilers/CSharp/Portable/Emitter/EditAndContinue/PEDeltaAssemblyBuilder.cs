...
namespace Microsoft.CodeAnalysis.CSharp.Emit
{
    internal sealed class PEDeltaAssemblyBuilder : PEAssemblyBuilderBase, IPEDeltaAssemblyBuilder
    {
            ...
            : base(sourceAssembly, emitOptions, outputKind, serializationProperties, manifestResources, additionalTypes: ImmutableArray<NamedTypeSymbol>.Empty)
        {
            ...
            var context = new EmitContext(this, null, null, new DiagnosticBag(), metadataOnly: false, includePrivateMembers: true);
            ...
            if (previousGeneration.Ordinal > 0)
            {
                ...
                var previousContext = new EmitContext((PEModuleBuilder)previousGeneration.PEModuleBuilder, null, null, new DiagnosticBag(), metadataOnly: false, includePrivateMembers: true);
