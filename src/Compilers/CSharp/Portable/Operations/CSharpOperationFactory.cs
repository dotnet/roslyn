...
namespace Microsoft.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        private IConstantPatternOperation CreateBoundConstantPatternOperation(BoundConstantPattern boundConstantPattern)
        {
            ...
            TypeSymbol outputType = boundConstantPattern.ConvertedType;
            return new CSharpLazyConstantPatternOperation(inputType.GetPublicSymbol(), outputType.GetPublicSymbol(), this, value, _semanticModel, syntax, isImplicit);
        }
        ...
        private IOperation CreateBoundRelationalPatternOperation(BoundRelationalPattern boundRelationalPattern)
        {
            ...
            TypeSymbol outputType = boundRelationalPattern.ConvertedType;
            return new CSharpLazyRelationalPatternOperation(inputType.GetPublicSymbol(), outputType.GetPublicSymbol(), this, operatorKind, value, _semanticModel, syntax, isImplicit);
        }
        ...
        private IDeclarationPatternOperation CreateBoundDeclarationPatternOperation(BoundDeclarationPattern boundDeclarationPattern)
        {
            ...
            ITypeSymbol outputType = boundDeclarationPattern.ConvertedType.GetPublicSymbol();
            ...
            return new DeclarationPatternOperation(inputType, outputType, matchedType, variable, acceptsNull, _semanticModel, syntax, isImplicit);
        }
        ...
        private IOperation CreateBoundTypePatternOperation(BoundTypePattern boundTypePattern)
        {
            return new TypePatternOperation(
                ...
                outputType: boundTypePattern.ConvertedType.GetPublicSymbol(),
        ...
        private IOperation CreateBoundDiscardPatternOperation(BoundDiscardPattern boundNode)
        {
            return new DiscardPatternOperation(
                ...
                outputType: boundNode.ConvertedType.GetPublicSymbol(),
                _semanticModel,
                boundNode.Syntax,
                isImplicit: boundNode.WasCompilerGenerated);
        }
