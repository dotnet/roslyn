...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal class SyntaxDiagnosticInfo : DiagnosticInfo
    {
        ...
        /// case.
        /// <para/> It is legal for the offset to be negative or position, and to extend beyond the FullSpan or Span of
        /// the entity that it is on.  For example, a diagnostic may be placed on a node corresponding to a token seen
