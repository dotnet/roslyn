...
#pragma warning disable CS8524 // The switch expression does not handle some values of its input type (it is not exhaustive) involving an unnamed enum value.
            return code switch
            {
                ...
                or ErrorCode.ERR_UnrecognizedDirective
                or ErrorCode.ERR_MissingDirectiveName
                or ErrorCode.ERR_PropertyDirectiveMissingParts
                or ErrorCode.ERR_PropertyDirectiveInvalidName
                or ErrorCode.ERR_CannotConvertDirective
                    => false,
            };
