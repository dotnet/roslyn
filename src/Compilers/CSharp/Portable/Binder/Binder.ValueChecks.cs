...
#nullable enable
        ...
        /// example it will remove anything which corresponds to scope parameters. For ref
        /// parameters it will place in two values representing both the RSTS and STS
        /// </summary>
