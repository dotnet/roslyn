...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal enum BinderFlags : uint
    {
        ...
        InFixedStatementBody = 1 << 4, // body of a 'fixed' statement (used to disallow 'await')
        ...
        AllClearedAtExecutableCodeBoundary = InLockBody | InCatchBlock | InCatchFilter | InFinallyBlock | InTryBlockOfTryCatch | InNestedFinallyBlock | InFixedStatementBody,
    }
}
