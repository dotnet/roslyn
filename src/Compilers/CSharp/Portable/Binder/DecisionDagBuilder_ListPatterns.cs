                ...
                foreach (BoundPattern subpattern in subpatterns)
                {
                    if (subpattern is BoundSlicePattern slice)
                    {
                        ...
                        if (slice.Pattern is BoundPattern slicePattern)
                        {
                            ...
                            Debug.Assert(slice.IndexerAccess is BoundIndexerAccess or BoundIndexOrRangePatternIndexerAccess or BoundArrayAccess);
                    ...
                    Debug.Assert(list.IndexerAccess is BoundIndexerAccess or BoundIndexOrRangePatternIndexerAccess or BoundArrayAccess);
