...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class DecisionDagBuilder
    {
            ...
            Dictionary<DagState, DagState> uniqueState)
        {
            ...
            while (workList.Count != 0)
            {
                ...
                else
                {
                    ...
                    switch (state.SelectedTest = state.ComputeSelectedTest(this, _forLowering, ref _suitableForLowering))
                    {
        ...
        private sealed class DagState
        {
            ...
            /// </summary>
            internal BoundDagTest ComputeSelectedTest(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering)
            {
                return Cases[0].RemainingTests.ComputeSelectedTest(builder, forLowering, ref suitableForLowering);
            }
        ...
        private abstract class Tests
        {
            ...
            public abstract void Filter(
                ...
                out Tests whenFalse,
                ref bool foundExplicitNullTest);
            public virtual BoundDagTest ComputeSelectedTest(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering) => throw ExceptionUtilities.Unreachable();
            ...
            public sealed class One : Tests
            {
                ...
                public override BoundDagTest ComputeSelectedTest(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering) => this.Test;
            ...
            public sealed class Not : Tests
            {
                ...
                public override BoundDagTest ComputeSelectedTest(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering) => Negated.ComputeSelectedTest(builder, forLowering, ref suitableForLowering);
            ...
            public abstract class SequenceTests : Tests
            {
                ...
                public sealed override BoundDagTest ComputeSelectedTest(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering)
                {
                    Tests firstTest;
                    var current = this;
                    ...
                    while (true)
                    {
                        if (current.ComputeSelectedTestEasyOut(builder, forLowering, ref suitableForLowering) is { } easy)
                        {
                            return easy;
                        }
                    ...
                    return firstTest.ComputeSelectedTest(builder, forLowering, ref suitableForLowering);
                }

                protected virtual BoundDagTest? ComputeSelectedTestEasyOut(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering) => null;
            }
            ...
            public sealed class AndSequence : SequenceTests
            {
                ...
                protected override BoundDagTest? ComputeSelectedTestEasyOut(DecisionDagBuilder builder, bool forLowering, ref bool suitableForLowering)
                {
                    ...
                    if (RemainingTests[0] is One { Test: { Kind: BoundKind.DagNonNullTest } planA })
                    {
                        ...
                        {
                            if (easyOutForLowering != (object)planA && !forLowering && ValueSetFactory.TypeUnionValueSetFactoryForInput(builder._compilation, planA.Input) is not null)
                            {
