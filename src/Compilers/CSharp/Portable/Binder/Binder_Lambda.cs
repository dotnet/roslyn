        ...
        private UnboundLambda BindAnonymousFunction(AnonymousFunctionExpressionSyntax syntax, BindingDiagnosticBag diagnostics)
        {
            ...
            if (data.HasExplicitlyTypedParameterList)
            {
                ...
                for (int i = 0; i < lambda.ParameterCount; i++)
                {
                    ...
                    ParameterHelpers.ReportParameterErrors(this, owner: null, paramSyntax, ordinal: i, lastParameterIndex: lambda.ParameterCount - 1, isParams: isParams, lambda.ParameterTypeWithAnnotations(i),
