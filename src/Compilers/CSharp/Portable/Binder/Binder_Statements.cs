...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        internal BoundExpression GenerateConversionForAssignment(TypeSymbol targetType, BoundExpression expression, DiagnosticBag diagnostics, bool isDefaultParameter = false, bool isRefAssignment = false)
        {
            ...
            return CreateConversion(expression.Syntax, expression, conversion, isCast: false, conversionGroup: null, targetType, diagnostics);
        }
        ...
        internal BoundExpression BindBooleanExpression(ExpressionSyntax node, DiagnosticBag diagnostics)
        {
            ...
            if (expr.HasAnyErrors)
            {
                ...
                return BoundConversion.Synthesized(node, expr, Conversion.NoConversion, false, explicitCastInCode: false, conversionGroup: null, ConstantValue.NotAvailable, boolean, hasErrors: true);
            }
            ...
            TypeSymbol returnType)
        {
            ...
            return CreateConversion(argument.Syntax, argument, conversion, isCast: false, conversionGroup: null, returnType, diagnostics);
        }
