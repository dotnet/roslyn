...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        /// </remarks>
        private Binder LookupSymbolsWithFallback(LookupResult result, string name, int arity, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved = null, LookupOptions options = LookupOptions.Default)
        {
        ...
        private Binder LookupSymbolsInternal(
            LookupResult result, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        /// </summary>
        private void LookupMembersWithFallback(LookupResult result, NamespaceOrTypeSymbol nsOrType, string name, int arity, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved = null, LookupOptions options = LookupOptions.Default)
        {
            Debug.Assert(options.AreValid());
        ...
        protected void LookupMembersInternal(LookupResult result, NamespaceOrTypeSymbol nsOrType, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(options.AreValid());
        ...
        protected void LookupMembersInType(LookupResult result, TypeSymbol type, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void LookupMembersInErrorType(LookupResult result, ErrorTypeSymbol errorType, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        /// </remarks>
        private void LookupMembersInSubmissions(LookupResult result, TypeSymbol submissionClass, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private static void LookupMembersInNamespace(LookupResult result, NamespaceSymbol ns, string name, int arity, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            CompoundUseSiteInfo attributeTypeWithoutSuffixViabilityUseSiteInfo;
            ...
            CompoundUseSiteInfo attributeTypeWithSuffixViabilityUseSiteInfo = default;
            ...
            else if (resultWithoutSuffixIsViable)
            {
                ...
                useSiteInfo.MergeAndFree(ref attributeTypeWithoutSuffixViabilityUseSiteInfo);
            }
            else if (resultWithSuffixIsViable)
            {
                ...
                useSiteInfo.MergeAndFree(ref attributeTypeWithSuffixViabilityUseSiteInfo);
            }
            else
            {
        ...
        private bool IsSingleViableAttributeType(LookupResult result, out Symbol symbol, out CompoundUseSiteInfo attributeTypeViabilityUseSiteInfo)
        {
        ...
        private bool CheckAttributeTypeViability(Symbol symbol, bool diagnose, ref DiagnosticInfo diagInfo, out CompoundUseSiteInfo attributeTypeViabilityUseSiteInfo)
        {
            Debug.Assert((object)symbol != null);
        ...
        protected static void LookupMembersWithoutInheritance(LookupResult result, TypeSymbol type, string name, int arity,
            LookupOptions options, Binder originalBinder, TypeSymbol accessThroughType, bool diagnose, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved)
        {
            ...
            ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            while ((object)currentType != null)
            {
                ...
                {
                    useSiteInfo.AddForSymbol(currentType.OriginalDefinition);
                }
            }
        ...
        private static ImmutableArray<NamedTypeSymbol> GetBaseInterfaces(NamedTypeSymbol type, ConsList<TypeSymbol> basesBeingResolved, ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            {
                useSiteInfo.AddForSymbol(candidate.OriginalDefinition);
            }
        ...
        private void LookupMembersInInterface(LookupResult current, NamedTypeSymbol type, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)type != null);
            Debug.Assert(type.IsInterface);
        ...
        private void LookupMembersInTypeParameter(LookupResult current, TypeParameterSymbol typeParameter, string name, int arity, ConsList<TypeSymbol> basesBeingResolved, LookupOptions options, Binder originalBinder, bool diagnose, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private static bool IsDerivedType(NamedTypeSymbol baseType, NamedTypeSymbol derivedType, ConsList<TypeSymbol> basesBeingResolved, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private static void MergeHidingLookupResults(LookupResult resultHiding, LookupResult resultHidden, ConsList<TypeSymbol> basesBeingResolved, ref CompoundUseSiteInfo useSiteInfo)
        {
...
symIsHidden:;
        ...
        /// </remarks>
        internal SingleLookupResult CheckViability(Symbol symbol, int arity, LookupOptions options, TypeSymbol accessThroughType, bool diagnose, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved = null)
        {
        ...
        internal void CheckViability<TSymbol>(LookupResult result, ImmutableArray<TSymbol> symbols, int arity, LookupOptions options, TypeSymbol accessThroughType, bool diagnose, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved) where TSymbol : Symbol
        {
        ...
        internal bool CanAddLookupSymbolInfo(Symbol symbol, LookupOptions options, LookupSymbolsInfo info, TypeSymbol accessThroughType, AliasSymbol aliasSymbol = null)
        {
                ...
                && IsNonInvocableMember(symbol))
            {
                return false;
                            ...
                            : !this.IsAccessible(symbol, ref ignoredUseSiteInfo, RefineAccessThroughType(options, accessThroughType)))
            {
                return false;
            }
        ...
        /// </summary>
        internal bool IsAccessible(Symbol symbol, ref CompoundUseSiteInfo useSiteInfo, TypeSymbol accessThroughType = null, ConsList<TypeSymbol> basesBeingResolved = null)
        {
        ...
        /// </summary>
        internal bool IsAccessible(Symbol symbol, TypeSymbol accessThroughType, out bool failedThroughTypeCheck, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved = null)
        {
        ...
        /// <remarks>
        /// Should only be called by <see cref="IsAccessible(Symbol, TypeSymbol, out bool, ref CompoundUseSiteInfo, ConsList{TypeSymbol})"/>,
        /// which will already have checked for <see cref="BinderFlags.IgnoreAccessibility"/>.
        /// </remarks>
        internal virtual bool IsAccessibleHelper(Symbol symbol, TypeSymbol accessThroughType, out bool failedThroughTypeCheck, ref CompoundUseSiteInfo useSiteInfo, ConsList<TypeSymbol> basesBeingResolved)
        {
