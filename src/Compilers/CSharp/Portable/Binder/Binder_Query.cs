...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        {
            var inExpression = BindToNaturalType(BindValue(join.InExpression, diagnostics, BindValueKind.RValue), diagnostics);
        ...
        private void ReduceLet(LetClauseSyntax let, QueryTranslationState state, DiagnosticBag diagnostics)
        {
            ...
            LambdaBodyFactory bodyFactory = (LambdaSymbol lambdaSymbol, Binder lambdaBodyBinder, DiagnosticBag d) =>
            {
                ...
                var yExpression = lambdaBodyBinder.BindToNaturalType(lambdaBodyBinder.BindValue(let.Expression, d, BindValueKind.RValue), diagnostics);
