...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        internal bool ReportUnsafeIfNotAllowed(SyntaxNode node, in BindingDiagnosticBag diagnostics, TypeSymbol sizeOfTypeOpt = null)
        {
        ...
        /// <returns>True if a diagnostic was reported</returns>
        internal bool ReportUnsafeIfNotAllowed(Location location, in BindingDiagnosticBag diagnostics)
        {
