...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private BoundExpression BindAwait(AwaitExpressionSyntax node, in BindingDiagnosticBag diagnostics)
        {
        ...
        private BoundAwaitExpression BindAwait(BoundExpression expression, SyntaxNode node, in BindingDiagnosticBag diagnostics)
        {
        ...
        internal void ReportBadAwaitDiagnostics(SyntaxNode node, Location location, in BindingDiagnosticBag diagnostics, ref bool hasErrors)
        {
            hasErrors |= ReportBadAwaitWithoutAsync(location, diagnostics);
            hasErrors |= ReportBadAwaitContext(node, location, diagnostics);
        }

        internal BoundAwaitableInfo BindAwaitInfo(BoundAwaitableValuePlaceholder placeholder, SyntaxNode node, in BindingDiagnosticBag diagnostics, ref bool hasErrors, BoundExpression? expressionOpt = null)
        {
        ...
        private bool ReportBadAwaitWithoutAsync(Location location, in BindingDiagnosticBag diagnostics)
        {
        ...
        private bool ReportBadAwaitContext(SyntaxNode node, Location location, in BindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static bool ValidateAwaitedExpression(BoundExpression expression, SyntaxNode node, in BindingDiagnosticBag diagnostics)
        {
        ...
        /// </remarks>
        private bool GetGetAwaiterMethod(BoundExpression expression, SyntaxNode node, in BindingDiagnosticBag diagnostics, [NotNullWhen(true)] out BoundExpression? getAwaiterCall)
        {
        ...
        /// </remarks>
        private bool GetIsCompletedProperty(TypeSymbol awaiterType, SyntaxNode node, TypeSymbol awaitedExpressionType, in BindingDiagnosticBag diagnostics, [NotNullWhen(true)] out PropertySymbol? isCompletedProperty)
        {
        ...
        /// </remarks>
        private bool AwaiterImplementsINotifyCompletion(TypeSymbol awaiterType, SyntaxNode node, in BindingDiagnosticBag diagnostics)
        {
        ...
        /// </remarks>
        private bool GetGetResultMethod(BoundExpression awaiterExpression, SyntaxNode node, TypeSymbol awaitedExpressionType, in BindingDiagnosticBag diagnostics, out MethodSymbol? getResultMethod, [NotNullWhen(true)] out BoundExpression? getAwaiterGetResultCall)
        {
