    ...
    internal sealed partial class OverloadResolution
    {
        internal static class BinopEasyOut
        {
            ...
            private static readonly BinaryOperatorKind[,] s_arithmetic =
            {
                ...
                /* nint */{ ERR, ERR, ERR, NIN, NIN, NIN, NIN, ERR, NIN, NIN, ERR, ERR, NIN, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, LNI, LNU, ERR, ERR, ERR },
                ...
                /* nu32 */{ ERR, ERR, ERR, LUN, LLG, LLG, LLG, LLG, LUN, LUN, LUN, LUL, LNI, LNU, LFL, LDB, LDC, ERR, LUN, LLG, LLG, LLG, LLG, LUN, LUN, LUN, LUL, LNI, LNU, LFL, LDB, LDC },
            ...
            private static readonly BinaryOperatorKind[,] s_addition =
            {
                //                    ----------------regular--------------------                                ----------------nullable-------------------
                //          obj  str  bool chr  i08  i16  i32  i64  u08  u16  u32  u64 nint nuint r32  r64  dec  bool chr  i08  i16  i32  i64  u08  u16  u32  u64 nint nuint r32  r64  dec  
                /*  obj */{ ERR, OSC, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, NUI, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, LNU, ERR, ERR, ERR },
                /*  str */{ SOC, STR, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, ERR, NUI, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, SOC, ERR, LNU, SOC, SOC, SOC },
                ...
                /* nint */{ ERR, ERR, ERR, NIN, NIN, NIN, NIN, ERR, NIN, NIN, ERR, ERR, NIN, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, LNI, ERR, ERR, ERR, ERR },
                /*nuint */{ ERR, ERR, ERR, NUI, NUI, NUI, ERR, ERR, NUI, NUI, NUI, ERR, ERR, NUI, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, ERR, LNU, ERR, ERR, ERR },
                ...
                /*nnint */{ ERR, ERR, ERR, LNI, LNI, LNI, LNI, ERR, LNI, LNI, ERR, ERR, LNI, ERR, ERR, ERR, ERR, ERR, LNI, LNI, LNI, LNI, ERR, LNI, LNI, ERR, ERR, LNI, ERR, ERR, ERR, ERR },
                /*nnuint*/{ ERR, ERR, ERR, LNU, LNU, LNU, ERR, ERR, LNU, LNU, LNU, ERR, ERR, LNU, ERR, ERR, ERR, ERR, LNU, LNU, LNU, ERR, ERR, LNU, LNU, LNU, ERR, ERR, LNU, ERR, ERR, ERR },
