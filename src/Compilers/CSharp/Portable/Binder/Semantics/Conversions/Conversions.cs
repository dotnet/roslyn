...
#nullable disable
        ...
        public static bool ReportDelegateOrFunctionPointerMethodGroupDiagnostics(Binder binder, BoundMethodGroup expr, TypeSymbol targetType, in BindingDiagnosticBag diagnostics)
        {
            ...
            if (resolution.MethodGroup != null)
            {
                ...
                if (result != null)
                {
                    ...
                    {
                        var overloadDiagnostics = BindingDiagnosticBagFactory.GetInstance(withDiagnostics: true, diagnostics.AccumulatesDependencies);
