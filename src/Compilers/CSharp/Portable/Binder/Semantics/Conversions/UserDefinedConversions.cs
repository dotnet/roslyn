...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private static TypeSymbol GetUnderlyingEffectiveType(TypeSymbol type, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        public static void AddTypesParticipatingInUserDefinedConversion(ArrayBuilder<NamedTypeSymbol> result, TypeSymbol type, bool includeBaseTypes, ref CompoundUseSiteInfo useSiteInfo)
        {
            if ((object)type == null)
            {
                return;
