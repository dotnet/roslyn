...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class ConversionsBase
    {
        ...
        private static void ComputeUserDefinedExplicitConversionTypeSet(TypeSymbol source, TypeSymbol target, ArrayBuilder<NamedTypeSymbol> d, ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            if ((object)source != null)
            {
                ...
                CompoundUseSiteInfo inLambdaUseSiteInfo = useSiteInfo;
        ...
        private Conversion EncompassingExplicitConversion(BoundExpression expr, TypeSymbol a, TypeSymbol b, ref CompoundUseSiteInfo useSiteInfo)
        {
