...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class MethodTypeInferrer
    {
        ...
        private MethodTypeInferenceResult InferTypeArgs(Binder binder, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void InferTypeArgsFirstPhase(Binder binder, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void MakeExplicitParameterTypeInferences(Binder binder, BoundExpression argument, TypeWithAnnotations target, ExactOrBoundsKind kind, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool MakeExplicitParameterTypeInferences(Binder binder, BoundTupleLiteral argument, TypeWithAnnotations target, ExactOrBoundsKind kind, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool InferTypeArgsSecondPhase(Binder binder, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private InferenceResult DoSecondPhase(Binder binder, ref CompoundUseSiteInfo useSiteInfo)
        {
            // SPEC: * If no unfixed type parameters exist then type inference succeeds.
            if (AllFixed())
            {
        ...
        private void MakeOutputTypeInferences(Binder binder, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void MakeOutputTypeInferences(Binder binder, BoundExpression argument, TypeWithAnnotations formalType, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void MakeOutputTypeInferences(Binder binder, BoundTupleLiteral argument, TypeWithAnnotations formalType, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private InferenceResult FixNondependentParameters(ref CompoundUseSiteInfo useSiteInfo)
        {
            // SPEC: * Otherwise, if there exists one or more type parameters Xi such that
            // SPEC:     o Xi is unfixed, and
            // SPEC:     o Xi has a non-empty set of bounds, and
        ...
        private InferenceResult FixDependentParameters(ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void OutputTypeInference(Binder binder, BoundExpression expression, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool InferredReturnTypeInference(BoundExpression source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool MethodGroupReturnTypeInference(Binder binder, BoundExpression source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source != null);
        ...
        //
        private void ExplicitParameterTypeInference(BoundExpression source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source != null);
            Debug.Assert(target.HasType);
        ...
        // Exact inferences
        //
        private void ExactInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool ExactArrayInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private void ExactOrBoundsInference(ExactOrBoundsKind kind, TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            switch (kind)
            {
        ...
        private bool ExactOrBoundsNullableInference(ExactOrBoundsKind kind, TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private bool ExactNullableInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            return ExactOrBoundsNullableInference(ExactOrBoundsKind.Exact, source, target, ref useSiteInfo);
        }

        private bool LowerBoundTupleInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private bool ExactConstructedInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private bool ExactPointerInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private void ExactTypeArgumentInference(NamedTypeSymbol source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        //
        private void LowerBoundInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private static TypeWithAnnotations GetMatchingElementType(ArrayTypeSymbol source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private bool LowerBoundArrayInference(TypeSymbol source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private bool LowerBoundNullableInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            return ExactOrBoundsNullableInference(ExactOrBoundsKind.LowerBound, source, target, ref useSiteInfo);
        }

        private bool LowerBoundConstructedInference(TypeSymbol source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private bool LowerBoundClassInference(TypeSymbol source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private bool LowerBoundInterfaceInference(TypeSymbol source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private void LowerBoundTypeArgumentInference(NamedTypeSymbol source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        //
        private void UpperBoundInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private bool UpperBoundArrayInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(source.HasType);
            Debug.Assert(target.HasType);
        ...
        private bool UpperBoundNullableInference(TypeWithAnnotations source, TypeWithAnnotations target, ref CompoundUseSiteInfo useSiteInfo)
        {
            return ExactOrBoundsNullableInference(ExactOrBoundsKind.UpperBound, source, target, ref useSiteInfo);
        }

        private bool UpperBoundConstructedInference(TypeWithAnnotations sourceWithAnnotations, TypeWithAnnotations targetWithAnnotations, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        private bool UpperBoundClassInference(NamedTypeSymbol source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private bool UpperBoundInterfaceInference(NamedTypeSymbol source, TypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)source != null);
            Debug.Assert((object)target != null);
        ...
        private void UpperBoundTypeArgumentInference(NamedTypeSymbol source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            // SPEC: The choice of inference for the i-th type argument is made
            // SPEC: based on the declaration of the i-th type parameter of C, as
            // SPEC: follows:
        ...
        private bool Fix(int iParam, ref CompoundUseSiteInfo useSiteInfo)
        {
            ...
            if (_conversions.IncludeNullability)
            {
                ...
                var withoutNullability = Fix(exact, lower, upper, ref ignoredUseSiteInfo, _conversions.WithNullability(false));
...
OuterBreak:
        ...
        //
        private TypeWithAnnotations InferReturnType(BoundExpression source, NamedTypeSymbol target, ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert((object)target != null);
        ...
        private bool InferTypeArgumentsFromFirstArgument(ref CompoundUseSiteInfo useSiteInfo)
        {
            Debug.Assert(!_formalParameterTypes.IsDefault);
