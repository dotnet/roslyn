...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class OverloadResolutionResult<TMember> where TMember : Symbol
    {
            ...
            Location location)
        {
            ...
            formalParameterType.CheckAllConstraints(new CheckConstraintsArgs((CSharpCompilation)compilation, conversions, includeNullability: false, location, diagnostics));
