...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class OverloadResolutionResult<TMember> where TMember : Symbol
    {
        ...
        private static void ReportUnsupportedMetadata(Location location, in BindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, MemberResolutionResult<TMember> firstUnsupported)
        {
        ...
        private static void ReportWrongCallingConvention(Location location, in BindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, MemberResolutionResult<TMember> firstSupported, MethodSymbol target)
        {
        ...
        private bool HadReturnMismatch(Location location, in BindingDiagnosticBag diagnostics, TypeSymbol delegateOrFunctionPointerType)
        {
        ...
        private bool HadConstraintFailure(Location location, in BindingDiagnosticBag diagnostics)
        {
        ...
        private static void ReportDuplicateNamedArgument(MemberResolutionResult<TMember> result, in BindingDiagnosticBag diagnostics, AnalyzedArguments arguments)
        {
        ...
        private static bool HadLambdaConversionError(in BindingDiagnosticBag diagnostics, AnalyzedArguments arguments)
        {
            bool hadError = false;
        ...
        private bool HadAmbiguousWorseMethods(in BindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, Location location, bool isQuery, BoundExpression receiver, string name)
        {
        ...
        private bool HadAmbiguousBestMethods(in BindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, Location location)
        {
