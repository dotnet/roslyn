...
#nullable disable
                ...
                else
                {
                    ...
                    Debug.Assert(
                        ...
                        (!conversion.IsDynamic ||
                            (ignoreOpenTypes && parameters.ParameterTypes[argumentPosition].Type.ContainsTypeParameter(parameterContainer: (MethodSymbol)candidate)))); // TODO2
            ...
            bool isMethodGroupConversion)
        {
            ...
            if (ignoreOpenTypes && parameterType.ContainsTypeParameter(parameterContainer: (MethodSymbol)candidate)) // TODO2
            {
