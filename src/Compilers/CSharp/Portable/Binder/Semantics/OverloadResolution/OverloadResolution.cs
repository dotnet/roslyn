...
#nullable disable
        ...
        // PROTOTYPE we'll want to prefer more specific new extension methods over less specific ones. Consider doing the same for classic extension methods
...
#nullable disable
            ...
            where TMember : Symbol
        {
                ...
                member.Kind == SymbolKind.Method && (method = (MethodSymbol)(Symbol)member).Arity > 0)
            {
                ...
                else
                {
                    ...
                    // We don't need to check the receiver parameter on a new extension method since
                    // it is not part of type inference from the arguments.
            ...
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo)
        {
            ...
            if (arguments.IsExtensionMethodInvocation && !method.GetIsNewExtensionMember())
            {
