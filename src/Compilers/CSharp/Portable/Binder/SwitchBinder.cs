...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class SwitchBinder : LocalScopeBinder
    {
            ...
            foreach (var labelSyntax in labelsSyntax)
            {
                ...
                switch (labelSyntax.Kind())
                {
                    case SyntaxKind.CaseSwitchLabel:
                        ...
                        var boundLabelExpression = sectionBinder.BindToNaturalType(sectionBinder.BindValue(caseLabel.Value, tempDiagnosticBag, BindValueKind.RValue), tempDiagnosticBag);
        ...
        private BoundExpression BindSwitchGoverningExpression(DiagnosticBag diagnostics)
        {
            ...
            var switchGoverningExpression = binder.BindToNaturalType(binder.BindValue(node, diagnostics, BindValueKind.RValue), diagnostics);
