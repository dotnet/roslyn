...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class ForEachLoopBinder : LoopBinder
    {
        ...
        /// </summary>
        internal override BoundStatement BindForEachParts(in BindingDiagnosticBag diagnostics, Binder originalBinder)
        {
        ...
        /// </summary>
        internal override BoundStatement BindForEachDeconstruction(in BindingDiagnosticBag diagnostics, Binder originalBinder)
        {
        ...
        private BoundForEachStatement BindForEachPartsWorker(in BindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            if (IsAsync)
            {
        ...
        private bool GetAwaitDisposeAsyncInfo(ref ForEachEnumeratorInfo.Builder builder, in BindingDiagnosticBag diagnostics)
        {
        ...
        internal TypeWithAnnotations InferCollectionElementType(in BindingDiagnosticBag diagnostics, ExpressionSyntax collectionSyntax)
        {
            // Use the right binder to avoid seeing iteration variable
        ...
        private bool GetEnumeratorInfoAndInferCollectionElementType(ref ForEachEnumeratorInfo.Builder builder, ref BoundExpression collectionExpr, in BindingDiagnosticBag diagnostics, out TypeWithAnnotations inferredType)
        {
        ...
        private BoundExpression UnwrapCollectionExpressionIfNullable(BoundExpression collectionExpr, in BindingDiagnosticBag diagnostics)
        {
        ...
        private bool GetEnumeratorInfo(ref ForEachEnumeratorInfo.Builder builder, ref BoundExpression collectionExpr, in BindingDiagnosticBag diagnostics)
        {
        ...
        private EnumeratorResult GetEnumeratorInfo(ref ForEachEnumeratorInfo.Builder builder, ref BoundExpression collectionExpr, bool isAsync, in BindingDiagnosticBag diagnostics)
        {
            TypeSymbol collectionExprType = collectionExpr.Type;
            ...
            EnumeratorResult createPatternBasedEnumeratorResult(ref ForEachEnumeratorInfo.Builder builder, BoundExpression collectionExpr, bool isAsync, bool viaExtensionMethod, in BindingDiagnosticBag diagnostics)
            {
        ...
        private EnumeratorResult SatisfiesIEnumerableInterfaces(ref ForEachEnumeratorInfo.Builder builder, BoundExpression collectionExpr, bool isAsync, in BindingDiagnosticBag diagnostics, TypeSymbol unwrappedCollectionExprType)
        {
        ...
        private bool ReportConstantNullCollectionExpr(BoundExpression collectionExpr, in BindingDiagnosticBag diagnostics)
        {
        ...
        private void GetDisposalInfoForEnumerator(ref ForEachEnumeratorInfo.Builder builder, BoundExpression expr, bool isAsync, in BindingDiagnosticBag diagnostics)
        {
        ...
        private ForEachEnumeratorInfo.Builder GetDefaultEnumeratorInfo(ForEachEnumeratorInfo.Builder builder, in BindingDiagnosticBag diagnostics, TypeSymbol collectionExprType)
        {
        ...
        /// </remarks>
        private bool SatisfiesGetEnumeratorPattern(ref ForEachEnumeratorInfo.Builder builder, BoundExpression collectionExpr, bool isAsync, bool viaExtensionMethod, in BindingDiagnosticBag diagnostics)
        {
        ...
        private MethodArgumentInfo FindForEachPatternMethod(TypeSymbol patternType, string methodName, LookupResult lookupResult, bool warningsOnly, in BindingDiagnosticBag diagnostics, bool isAsync)
        {
        ...
        /// </summary>
        private MethodArgumentInfo PerformForEachPatternOverloadResolution(TypeSymbol patternType, ArrayBuilder<MethodSymbol> candidateMethods, bool warningsOnly, in BindingDiagnosticBag diagnostics, bool isAsync)
        {
        ...
        private MethodArgumentInfo FindForEachPatternMethodViaExtension(BoundExpression collectionExpr, string methodName, in BindingDiagnosticBag diagnostics)
        {
            var analyzedArguments = AnalyzedArguments.GetInstance();
        ...
        /// </remarks>
        private bool SatisfiesForEachPattern(ref ForEachEnumeratorInfo.Builder builder, bool isAsync, in BindingDiagnosticBag diagnostics)
        {
        ...
        private void ReportEnumerableWarning(in BindingDiagnosticBag diagnostics, TypeSymbol enumeratorType, Symbol patternMemberCandidate)
        {
            CompoundUseSiteInfo<AssemblySymbol> useSiteInfo = GetNewCompoundUseSiteInfo(diagnostics);
        ...
        private void ReportPatternMemberLookupDiagnostics(LookupResult lookupResult, TypeSymbol patternType, string memberName, bool warningsOnly, in BindingDiagnosticBag diagnostics)
        {
        ...
        private MethodArgumentInfo GetParameterlessSpecialTypeMemberInfo(SpecialMember member, SyntaxNode syntax, in BindingDiagnosticBag diagnostics)
        {
        ...
        private MethodArgumentInfo BindDefaultArguments(MethodSymbol method, BoundExpression extensionReceiverOpt, bool expanded, SyntaxNode syntax, in BindingDiagnosticBag diagnostics, bool assertMissingParametersAreOptional = true)
        {
