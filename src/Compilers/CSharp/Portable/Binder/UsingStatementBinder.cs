    ...
    internal sealed class UsingStatementBinder : LockOrUsingBinder
    {
        ...
        protected override ImmutableArray<LocalSymbol> BuildLocals()
        {
            ...
            else
            {
                ...
                {
                    locals.Add(MakeLocal(declarationSyntax, declarator, LocalDeclarationKind.UsingVariable, allowScoped: false)); // https://github.com/dotnet/roslyn/issues/62039: Allow 'scoped' modifier.
