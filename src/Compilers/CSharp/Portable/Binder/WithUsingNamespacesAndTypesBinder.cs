...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal abstract class WithUsingNamespacesAndTypesBinder : Binder
    {
        ...
        /// </remarks>
        protected override AssemblySymbol? GetForwardedToAssemblyInUsingNamespaces(string name, ref NamespaceOrTypeSymbol qualifierOpt, in BindingDiagnosticBag diagnostics, Location location)
        {
