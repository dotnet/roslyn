...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class BoundBinaryOperator : BoundBinaryOperatorBase
    {
        ...
        {
            if (operatorKind != this.OperatorKind || constantValueOpt != this.ConstantValueOpt || methodOpt != this.MethodOpt || resultKind != this.ResultKind || left != this.Left || right != this.Right || type != this.Type)
            {
    ...
    internal sealed partial class BoundDynamicCollectionElementInitializer : BoundDynamicInvocableBase
    {
        ...
        {
            if (applicableMethods != this.ApplicableMethods || expression != this.Expression || arguments != this.Arguments || type != this.Type)
            {
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitSuppressNullableWarningExpression(BoundSuppressNullableWarningExpression node, object arg) => new TreeDumperNode("suppressNullableWarningExpression", null, new TreeDumperNode[]
        {
            new TreeDumperNode("expression", null, new TreeDumperNode[] { Visit(node.Expression, null) }),
            new TreeDumperNode("type", node.Type, null)
        }
        ...
        public override TreeDumperNode VisitPatternSwitchStatement(BoundPatternSwitchStatement node, object arg) => new TreeDumperNode("patternSwitchStatement", null, new TreeDumperNode[]
        {
            new TreeDumperNode("expression", null, new TreeDumperNode[] { Visit(node.Expression, null) }),
        ...
        public override TreeDumperNode VisitPatternSwitchSection(BoundPatternSwitchSection node, object arg) => new TreeDumperNode("patternSwitchSection", null, new TreeDumperNode[]
        {
            new TreeDumperNode("locals", node.Locals, null),
            new TreeDumperNode("switchLabels", null, from x in node.SwitchLabels select Visit(x, null)),
            new TreeDumperNode("statements", null, from x in node.Statements select Visit(x, null))
        ...
        public override TreeDumperNode VisitPatternSwitchLabel(BoundPatternSwitchLabel node, object arg) => new TreeDumperNode("patternSwitchLabel", null, new TreeDumperNode[]
        {
            new TreeDumperNode("label", node.Label, null),
        ...
        public override TreeDumperNode VisitWildcardPattern(BoundWildcardPattern node, object arg) => new TreeDumperNode("wildcardPattern", null, Array.Empty<TreeDumperNode>()
        );
