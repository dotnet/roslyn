...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal abstract partial class BoundValuePlaceholderBase : BoundExpression
    {
            ...
            : base(kind, syntax, type, hasErrors)
        {
            ...
            Debug.Assert(!TypeSymbol.Equals(type, null, TypeCompareKind.ConsiderEverything2), "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    internal sealed partial class BoundDeconstructValuePlaceholder : BoundValuePlaceholderBase
    {
        ...
        {
            if (valEscape != this.ValEscape || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTupleOperandPlaceholder : BoundValuePlaceholderBase
    {
        ...
        {
            if (!TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDup : BoundExpression
    {
        ...
        {
            if (refKind != this.RefKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundPassByCopy : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundBadExpression : BoundExpression
    {
        ...
        {
            if (resultKind != this.ResultKind || symbols != this.Symbols || childBoundNodes != this.ChildBoundNodes || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTypeExpression : BoundExpression
    {
        ...
        {
            if (aliasOpt != this.AliasOpt || inferredType != this.InferredType || boundContainingTypeOpt != this.BoundContainingTypeOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTypeOrValueExpression : BoundExpression
    {
        ...
        {
            if (data != this.Data || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundUnaryOperator : BoundExpression
    {
        ...
        {
            if (operatorKind != this.OperatorKind || operand != this.Operand || constantValueOpt != this.ConstantValueOpt || methodOpt != this.MethodOpt || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundIncrementOperator : BoundExpression
    {
        ...
        {
            if (operatorKind != this.OperatorKind || operand != this.Operand || methodOpt != this.MethodOpt || operandConversion != this.OperandConversion || resultConversion != this.ResultConversion || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAddressOfOperator : BoundExpression
    {
        ...
        {
            if (operand != this.Operand || isManaged != this.IsManaged || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundPointerIndirectionOperator : BoundExpression
    {
        ...
        {
            if (operand != this.Operand || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundPointerElementAccess : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || index != this.Index || @checked != this.Checked || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundRefTypeOperator : BoundExpression
    {
        ...
        {
            if (operand != this.Operand || getTypeFromHandle != this.GetTypeFromHandle || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundFromEndIndexExpression : BoundExpression
    {
        ...
        {
            if (operand != this.Operand || methodOpt != this.MethodOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundRangeExpression : BoundExpression
    {
        ...
        {
            if (leftOperand != this.LeftOperand || rightOperand != this.RightOperand || methodOpt != this.MethodOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundBinaryOperator : BoundBinaryOperatorBase
    {
        ...
        {
            if (operatorKind != this.OperatorKind || constantValueOpt != this.ConstantValueOpt || methodOpt != this.MethodOpt || resultKind != this.ResultKind || left != this.Left || right != this.Right || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTupleBinaryOperator : BoundExpression
    {
        ...
        {
            if (left != this.Left || right != this.Right || convertedLeft != this.ConvertedLeft || convertedRight != this.ConvertedRight || operatorKind != this.OperatorKind || operators != this.Operators || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundUserDefinedConditionalLogicalOperator : BoundBinaryOperatorBase
    {
        ...
        {
            if (operatorKind != this.OperatorKind || logicalOperator != this.LogicalOperator || trueOperator != this.TrueOperator || falseOperator != this.FalseOperator || resultKind != this.ResultKind || left != this.Left || right != this.Right || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundCompoundAssignmentOperator : BoundExpression
    {
        ...
        {
            if (@operator != this.Operator || left != this.Left || right != this.Right || leftConversion != this.LeftConversion || finalConversion != this.FinalConversion || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAssignmentOperator : BoundExpression
    {
        ...
        {
            if (left != this.Left || right != this.Right || isRef != this.IsRef || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDeconstructionAssignmentOperator : BoundExpression
    {
        ...
        {
            if (left != this.Left || right != this.Right || isUsed != this.IsUsed || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundNullCoalescingOperator : BoundExpression
    {
        ...
        {
            if (leftOperand != this.LeftOperand || rightOperand != this.RightOperand || leftConversion != this.LeftConversion || operatorResultKind != this.OperatorResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundNullCoalescingAssignmentOperator : BoundExpression
    {
        ...
        {
            if (leftOperand != this.LeftOperand || rightOperand != this.RightOperand || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundConditionalOperator : BoundExpression
    {
        ...
        {
            if (isRef != this.IsRef || condition != this.Condition || consequence != this.Consequence || alternative != this.Alternative || constantValueOpt != this.ConstantValueOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundArrayAccess : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || indices != this.Indices || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAwaitExpression : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || awaitableInfo != this.AwaitableInfo || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTypeOfOperator : BoundTypeOf
    {
        ...
        {
            if (sourceType != this.SourceType || getTypeFromHandle != this.GetTypeFromHandle || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundMethodDefIndex : BoundExpression
    {
        ...
        {
            if (method != this.Method || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundInstrumentationPayloadRoot : BoundExpression
    {
        ...
        {
            if (analysisKind != this.AnalysisKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundSourceDocumentIndex : BoundExpression
    {
        ...
        {
            if (document != this.Document || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundMethodInfo : BoundExpression
    {
        ...
        {
            if (method != this.Method || getMethodFromHandle != this.GetMethodFromHandle || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundFieldInfo : BoundExpression
    {
        ...
        {
            if (field != this.Field || getFieldFromHandle != this.GetFieldFromHandle || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDefaultExpression : BoundExpression
    {
        ...
        {
            if (constantValueOpt != this.ConstantValueOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundIsOperator : BoundExpression
    {
        ...
        {
            if (operand != this.Operand || targetType != this.TargetType || conversion != this.Conversion || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundSizeOfOperator : BoundExpression
    {
        ...
        {
            if (sourceType != this.SourceType || constantValueOpt != this.ConstantValueOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundArgListOperator : BoundExpression
    {
        ...
        {
            if (arguments != this.Arguments || argumentRefKindsOpt != this.ArgumentRefKindsOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundFixedLocalCollectionInitializer : BoundExpression
    {
            ...
            : base(BoundKind.FixedLocalCollectionInitializer, syntax, type, hasErrors || expression.HasErrors())
        {
            ...
            Debug.Assert(!TypeSymbol.Equals(elementPointerType, null, TypeCompareKind.ConsiderEverything2), "Field 'elementPointerType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(!TypeSymbol.Equals(type, null, TypeCompareKind.ConsiderEverything2), "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
        ...
        {
            if (!TypeSymbol.Equals(elementPointerType, this.ElementPointerType, TypeCompareKind.ConsiderEverything2) || elementPointerTypeConversion != this.ElementPointerTypeConversion || expression != this.Expression || getPinnableOpt != this.GetPinnableOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundSequence : BoundExpression
    {
        ...
        {
            if (locals != this.Locals || sideEffects != this.SideEffects || value != this.Value || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundCatchBlock : BoundNode
    {
        ...
        {
            if (locals != this.Locals || exceptionSourceOpt != this.ExceptionSourceOpt || !TypeSymbol.Equals(exceptionTypeOpt, this.ExceptionTypeOpt, TypeCompareKind.ConsiderEverything2) || exceptionFilterOpt != this.ExceptionFilterOpt || body != this.Body || isSynthesizedAsyncCatchAll != this.IsSynthesizedAsyncCatchAll)
            {
    ...
    internal sealed partial class BoundLocal : BoundExpression
    {
        ...
        {
            if (localSymbol != this.LocalSymbol || declarationKind != this.DeclarationKind || constantValueOpt != this.ConstantValueOpt || isNullableUnknown != this.IsNullableUnknown || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundPseudoVariable : BoundExpression
    {
        ...
        {
            if (localSymbol != this.LocalSymbol || emitExpressions != this.EmitExpressions || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundRangeVariable : BoundExpression
    {
        ...
        {
            if (rangeVariableSymbol != this.RangeVariableSymbol || value != this.Value || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundParameter : BoundExpression
    {
        ...
        {
            if (parameterSymbol != this.ParameterSymbol || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundLabel : BoundExpression
    {
        ...
        {
            if (label != this.Label || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicMemberAccess : BoundExpression
    {
        ...
        {
            if (receiver != this.Receiver || typeArgumentsOpt != this.TypeArgumentsOpt || name != this.Name || invoked != this.Invoked || indexed != this.Indexed || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicInvocation : BoundDynamicInvocableBase
    {
        ...
        {
            if (argumentNamesOpt != this.ArgumentNamesOpt || argumentRefKindsOpt != this.ArgumentRefKindsOpt || applicableMethods != this.ApplicableMethods || expression != this.Expression || arguments != this.Arguments || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundConditionalAccess : BoundExpression
    {
        ...
        {
            if (receiver != this.Receiver || accessExpression != this.AccessExpression || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundLoweredConditionalAccess : BoundExpression
    {
        ...
        {
            if (receiver != this.Receiver || hasValueMethodOpt != this.HasValueMethodOpt || whenNotNull != this.WhenNotNull || whenNullOpt != this.WhenNullOpt || id != this.Id || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundConditionalReceiver : BoundExpression
    {
        ...
        {
            if (id != this.Id || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundComplexConditionalReceiver : BoundExpression
    {
        ...
        {
            if (valueTypeReceiver != this.ValueTypeReceiver || referenceTypeReceiver != this.ReferenceTypeReceiver || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundEventAssignmentOperator : BoundExpression
    {
        ...
        {
            if (@event != this.Event || isAddition != this.IsAddition || isDynamic != this.IsDynamic || receiverOpt != this.ReceiverOpt || argument != this.Argument || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAttribute : BoundExpression
    {
        ...
        {
            if (constructor != this.Constructor || constructorArguments != this.ConstructorArguments || constructorArgumentNamesOpt != this.ConstructorArgumentNamesOpt || namedArguments != this.NamedArguments || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundTupleLiteral : BoundTupleExpression
    {
        ...
        {
            if (argumentNamesOpt != this.ArgumentNamesOpt || inferredNamesOpt != this.InferredNamesOpt || arguments != this.Arguments || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundConvertedTupleLiteral : BoundTupleExpression
    {
        ...
        {
            if (!TypeSymbol.Equals(naturalTypeOpt, this.NaturalTypeOpt, TypeCompareKind.ConsiderEverything2) || arguments != this.Arguments || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicObjectCreationExpression : BoundExpression
    {
        ...
        {
            if (name != this.Name || arguments != this.Arguments || argumentNamesOpt != this.ArgumentNamesOpt || argumentRefKindsOpt != this.ArgumentRefKindsOpt || initializerExpressionOpt != this.InitializerExpressionOpt || applicableMethods != this.ApplicableMethods || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundNoPiaObjectCreationExpression : BoundExpression
    {
        ...
        {
            if (guidString != this.GuidString || initializerExpressionOpt != this.InitializerExpressionOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundObjectInitializerExpression : BoundObjectInitializerExpressionBase
    {
        ...
        {
            if (initializers != this.Initializers || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundObjectInitializerMember : BoundExpression
    {
            ...
            : base(BoundKind.ObjectInitializerMember, syntax, type, hasErrors || arguments.HasErrors())
        {
            ...
            Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(!TypeSymbol.Equals(receiverType, null, TypeCompareKind.ConsiderEverything2), "Field 'receiverType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(!TypeSymbol.Equals(type, null, TypeCompareKind.ConsiderEverything2), "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
        ...
        {
            if (memberSymbol != this.MemberSymbol || arguments != this.Arguments || argumentNamesOpt != this.ArgumentNamesOpt || argumentRefKindsOpt != this.ArgumentRefKindsOpt || expanded != this.Expanded || argsToParamsOpt != this.ArgsToParamsOpt || resultKind != this.ResultKind || !TypeSymbol.Equals(receiverType, this.ReceiverType, TypeCompareKind.ConsiderEverything2) || binderOpt != this.BinderOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicObjectInitializerMember : BoundExpression
    {
        ...
        {
            if (memberName != this.MemberName || !TypeSymbol.Equals(receiverType, this.ReceiverType, TypeCompareKind.ConsiderEverything2) || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicCollectionElementInitializer : BoundDynamicInvocableBase
    {
        ...
        {
            if (applicableMethods != this.ApplicableMethods || expression != this.Expression || arguments != this.Arguments || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAnonymousObjectCreationExpression : BoundExpression
    {
        ...
        {
            if (constructor != this.Constructor || arguments != this.Arguments || declarations != this.Declarations || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundAnonymousPropertyDeclaration : BoundExpression
    {
        ...
        {
            if (property != this.Property || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundNewT : BoundExpression
    {
        ...
        {
            if (initializerExpressionOpt != this.InitializerExpressionOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDelegateCreationExpression : BoundExpression
    {
        ...
        {
            if (argument != this.Argument || methodOpt != this.MethodOpt || isExtensionMethod != this.IsExtensionMethod || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundArrayCreation : BoundExpression
    {
        ...
        {
            if (bounds != this.Bounds || initializerOpt != this.InitializerOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal partial class BoundStackAllocArrayCreation : BoundExpression
    {
            ...
            : base(kind, syntax, type, hasErrors)
        {
            ...
            Debug.Assert(!TypeSymbol.Equals(elementType, null, TypeCompareKind.ConsiderEverything2), "Field 'elementType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
        ...
        {
            if (!TypeSymbol.Equals(elementType, this.ElementType, TypeCompareKind.ConsiderEverything2) || count != this.Count || initializerOpt != this.InitializerOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundFieldAccess : BoundExpression
    {
        ...
        {
            if (receiverOpt != this.ReceiverOpt || fieldSymbol != this.FieldSymbol || constantValueOpt != this.ConstantValueOpt || resultKind != this.ResultKind || isByValue != this.IsByValue || isDeclaration != this.IsDeclaration || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundHoistedFieldAccess : BoundExpression
    {
        ...
        {
            if (fieldSymbol != this.FieldSymbol || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundPropertyAccess : BoundExpression
    {
        ...
        {
            if (receiverOpt != this.ReceiverOpt || propertySymbol != this.PropertySymbol || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundEventAccess : BoundExpression
    {
        ...
        {
            if (receiverOpt != this.ReceiverOpt || eventSymbol != this.EventSymbol || isUsableAsField != this.IsUsableAsField || resultKind != this.ResultKind || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundDynamicIndexerAccess : BoundExpression
    {
        ...
        {
            if (receiverOpt != this.ReceiverOpt || arguments != this.Arguments || argumentNamesOpt != this.ArgumentNamesOpt || argumentRefKindsOpt != this.ArgumentRefKindsOpt || applicableIndexers != this.ApplicableIndexers || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundLambda : BoundExpression
    {
        ...
        {
            if (unboundLambda != this.UnboundLambda || symbol != this.Symbol || body != this.Body || diagnostics != this.Diagnostics || binder != this.Binder || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundQueryClause : BoundExpression
    {
        ...
        {
            if (value != this.Value || definedSymbol != this.DefinedSymbol || binder != this.Binder || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundNameOfOperator : BoundExpression
    {
        ...
        {
            if (argument != this.Argument || constantValueOpt != this.ConstantValueOpt || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundInterpolatedString : BoundExpression
    {
        ...
        {
            if (parts != this.Parts || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundStringInsert : BoundExpression
    {
        ...
        {
            if (value != this.Value || alignment != this.Alignment || format != this.Format || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundIsPatternExpression : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || pattern != this.Pattern || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
    ...
    internal sealed partial class BoundExpressionWithNullability : BoundExpression
    {
        ...
        {
            if (expression != this.Expression || nullableAnnotation != this.NullableAnnotation || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything2))
            {
