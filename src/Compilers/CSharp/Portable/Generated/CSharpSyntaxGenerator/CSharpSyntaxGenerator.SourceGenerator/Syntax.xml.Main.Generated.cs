...
public partial class CSharpSyntaxVisitor<TResult>
{
    ...
    /// <summary>Called when the visitor visits a ForTypeSyntax node.</summary>
    public virtual TResult? VisitForType(ForTypeSyntax node) => this.DefaultVisit(node);
...
public partial class CSharpSyntaxVisitor
{
    ...
    /// <summary>Called when the visitor visits a ForTypeSyntax node.</summary>
    public virtual void VisitForType(ForTypeSyntax node) => this.DefaultVisit(node);
...
public partial class CSharpSyntaxRewriter : CSharpSyntaxVisitor<SyntaxNode?>
{
    ...
    public override SyntaxNode? VisitForType(ForTypeSyntax node)
        => node.Update(VisitToken(node.ForKeyword), (TypeSyntax?)Visit(node.UnderlyingType) ?? throw new ArgumentNullException("underlyingType"));

    public override SyntaxNode? VisitExtensionDeclaration(ExtensionDeclarationSyntax node)
        => node.Update(VisitList(node.AttributeLists), VisitList(node.Modifiers), VisitToken(node.ImplicitOrExplicitKeyword), VisitToken(node.Keyword), VisitToken(node.Identifier), (TypeParameterListSyntax?)Visit(node.TypeParameterList), (ParameterListSyntax?)Visit(node.ParameterList), (ForTypeSyntax?)Visit(node.ForUnderlyingType), (BaseListSyntax?)Visit(node.BaseList), VisitList(node.ConstraintClauses), VisitToken(node.OpenBraceToken), VisitList(node.Members), VisitToken(node.CloseBraceToken), VisitToken(node.SemicolonToken));
...
#pragma warning restore RS0027
    ...
    /// <summary>Creates a new ForTypeSyntax instance.</summary>
    public static ForTypeSyntax ForType(SyntaxToken forKeyword, TypeSyntax underlyingType)
    {
        if (forKeyword.Kind() != SyntaxKind.ForKeyword) throw new ArgumentException(nameof(forKeyword));
        if (underlyingType == null) throw new ArgumentNullException(nameof(underlyingType));
        return (ForTypeSyntax)Syntax.InternalSyntax.SyntaxFactory.ForType((Syntax.InternalSyntax.SyntaxToken)forKeyword.Node!, (Syntax.InternalSyntax.TypeSyntax)underlyingType.Green).CreateRed();
    }

    /// <summary>Creates a new ForTypeSyntax instance.</summary>
    public static ForTypeSyntax ForType(TypeSyntax underlyingType)
        => SyntaxFactory.ForType(SyntaxFactory.Token(SyntaxKind.ForKeyword), underlyingType);

    /// <summary>Creates a new ExtensionDeclarationSyntax instance.</summary>
    public static ExtensionDeclarationSyntax ExtensionDeclaration(SyntaxList<AttributeListSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken implicitOrExplicitKeyword, SyntaxToken keyword, SyntaxToken identifier, TypeParameterListSyntax? typeParameterList, ParameterListSyntax? parameterList, ForTypeSyntax? forUnderlyingType, BaseListSyntax? baseList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken openBraceToken, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken semicolonToken)
    {
        ...
        return (ExtensionDeclarationSyntax)Syntax.InternalSyntax.SyntaxFactory.ExtensionDeclaration(attributeLists.Node.ToGreenList<Syntax.InternalSyntax.AttributeListSyntax>(), modifiers.Node.ToGreenList<Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)implicitOrExplicitKeyword.Node!, (Syntax.InternalSyntax.SyntaxToken)keyword.Node!, (Syntax.InternalSyntax.SyntaxToken)identifier.Node!, typeParameterList == null ? null : (Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, parameterList == null ? null : (Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, forUnderlyingType == null ? null : (Syntax.InternalSyntax.ForTypeSyntax)forUnderlyingType.Green, baseList == null ? null : (Syntax.InternalSyntax.BaseListSyntax)baseList.Green, constraintClauses.Node.ToGreenList<Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken?)openBraceToken.Node, members.Node.ToGreenList<Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken?)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken?)semicolonToken.Node).CreateRed();
    }
