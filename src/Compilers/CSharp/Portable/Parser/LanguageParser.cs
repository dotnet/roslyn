...
tryAgain:
        ...
        private void ParseAnonymousTypeMemberInitializers(ref SyntaxToken openBrace, ref SeparatedSyntaxListBuilder<AnonymousObjectMemberDeclaratorSyntax> list)
        {
            ...
            {
tryAgain:
                if (this.IsValidInitializerToken(ref openBrace, IsPossibleExpression))
                {
                    // first argument
...
#nullable disable
        ...
        private void ParseObjectOrCollectionInitializerMembers(ref SyntaxToken startToken, SeparatedSyntaxListBuilder<ExpressionSyntax> list, out bool isObjectInitializer)
        {
            ...
            {
tryAgain:
                if (this.IsValidInitializerToken(ref startToken, IsInitializerMember))
                {
        ...
        private bool IsValidInitializerToken(ref SyntaxToken startToken, Func<bool> isInitializerMemberFn)
        {
            ...
            else if (this.CurrentToken.Kind != SyntaxKind.SemicolonToken)
            {
                ...
                // 1. a separator
                // 2. a member
                return this.CurrentToken.Kind == SyntaxKind.CommaToken || isInitializerMemberFn();
            }
...
tryAgain:
        ...
        private InitializerExpressionSyntax ParseArrayInitializer()
        {
            ...
            try
            {
                ...
                {
tryAgain:
                    if (this.IsValidInitializerToken(ref openBrace, IsPossibleVariableInitializer))
                    {
