...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    public enum SyntaxKind : ushort
    {
        ...
        /// <summary>Represents <code>$"</code> token.</summary>
        InterpolatedStringStartToken = 8482,            // $"
        /// <summary>Represents <code>"</code> token that is closing <code>$"</code>.</summary>
        InterpolatedStringEndToken = 8483,              // "
        /// <summary>Represents <code>$@</code> or <code>@$</code> token.</summary>
        ...
        VarKeyword = 8490,
        /// <summary>Represents <code>_</code> token.</summary>
        UnderscoreToken = 8491,
        /// <summary>Represents <code>TODO: What's this?</code> token.</summary>
