...
namespace Microsoft.CodeAnalysis.CSharp
{
    public static class SyntaxExtensions
    {
        ...
        /// <summary>
        /// Returns true if the expression on the left of an assignment would be of the deconstruction variety.
        /// </summary>
        internal static bool IsDeconstructionLeft(this ExpressionSyntax node)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.IdentifierName:
                    ...
                    return ((IdentifierNameSyntax)node).Identifier.RawContextualKind == (int)SyntaxKind.UnderscoreToken;
                default:
                    return false;
            }
        }
