...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    internal class SyntaxListBuilder : AbstractSyntaxListBuilder
    {
        ...
        internal override GreenNode ToListNode()
        {
            switch (this.Count)
            {
                case 0:
                ...
                case 2:
                    return Syntax.InternalSyntax.SyntaxList.List(
                        (Syntax.InternalSyntax.CSharpSyntaxNode)Nodes[0].Value,
                        (Syntax.InternalSyntax.CSharpSyntaxNode)Nodes[1].Value);
                case 3:
                    return Syntax.InternalSyntax.SyntaxList.List(
                        (Syntax.InternalSyntax.CSharpSyntaxNode)Nodes[0].Value,
                        (Syntax.InternalSyntax.CSharpSyntaxNode)Nodes[1].Value,
                        (Syntax.InternalSyntax.CSharpSyntaxNode)Nodes[2].Value);
                default:
