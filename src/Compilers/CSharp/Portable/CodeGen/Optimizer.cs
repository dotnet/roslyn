...
namespace Microsoft.CodeAnalysis.CSharp.CodeGen
{
    ...
    internal sealed class StackOptimizerPass1 : BoundTreeRewriter
    {
        ...
        public override BoundNode VisitObjectCreationExpression(BoundObjectCreationExpression node)
        {
            ...
            return node.Update(constructor, rewrittenArguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt,
                node.Expanded, node.ArgsToParamsOpt, node.DefaultArgumentsOpt, node.ConstantValue, null, node.BinderOpt, node.Type);
        }
    ...
    internal sealed class StackOptimizerPass2 : BoundTreeRewriterWithStackGuard
    {
        ...
        public override BoundNode VisitObjectCreationExpression(BoundObjectCreationExpression node)
        {
            ...
            return node.Update(node.Constructor, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.DefaultArgumentsOpt, node.ConstantValueOpt, null, node.BinderOpt, type);
        }
