                ...
                if (result == null)
                {
                    ...
                    if (_ilEmitStyle == ILEmitStyle.Debug && bodySyntax != null)
                    {
                        ...
                        result = _builder.LocalSlotManager.DeclareLocal(
                            type: _module.Translate(localSymbol.TypeWithAnnotations.Type, bodySyntax, _diagnostics),
                            symbol: localSymbol,
                            name: null,
                    ...
                    {
                        result = AllocateTemp(_method.ReturnTypeWithAnnotations.Type, _boundBody.Syntax, slotConstraints);
                    }
