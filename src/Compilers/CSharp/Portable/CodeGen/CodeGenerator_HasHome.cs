        ...
        switch (expression.Kind)
        {
            ...
            case BoundKind.Local:
                ...
                if (!IsAnyReadOnly(addressKind))
                {
                    ...
                    {
                        Debug.Assert(localRefKind != RefKindExtensions.StrictIn, "Add a test if this assert fails for a the scenario.");
                        return false;
                    }
                }
            ...
            case BoundKind.Dup:
                ...
                if (IsAnyReadOnly(addressKind))
                {
                    ...
                    {
                        Debug.Assert(dupRefKind != RefKindExtensions.StrictIn, "Add a test if this assert fails for a the scenario.");
                        return true;
                    }
                }
