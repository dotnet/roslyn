...
#nullable restore
            ...
            Location location = null)
        {
            ...
            {
                ReportDiagnostic(assignmentKind switch { AssignmentKind.Return => ErrorCode.WRN_NullReferenceReturn, AssignmentKind.ForEachIterationVariable => throw ExceptionUtilities.Unreachable, _ => ErrorCode.WRN_NullReferenceAssignment }, location);
            }
