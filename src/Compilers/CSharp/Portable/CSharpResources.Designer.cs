...
namespace Microsoft.CodeAnalysis.CSharp {
    ...
    internal class CSharpResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Feature &apos;{0}&apos; is not available. Please use language version {1} or greater..
        /// </summary>
        internal static string ERR_ThrowExpressionNotAvailable {
            get {
                return ResourceManager.GetString("ERR_ThrowExpressionNotAvailable", resourceCulture);
            }
        }
