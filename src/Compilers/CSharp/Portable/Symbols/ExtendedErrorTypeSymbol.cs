...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class ExtendedErrorTypeSymbol : ErrorTypeSymbol
    {
        ...
        internal override bool Equals(TypeSymbol t2, bool ignoreCustomModifiersAndArraySizesAndLowerBounds, bool ignoreDynamic, bool ignoreTupleNames)
        {
            ...
            return
                ((object)this.ContainingType != null ? this.ContainingType.Equals(other.ContainingType, ignoreCustomModifiersAndArraySizesAndLowerBounds, ignoreDynamic, ignoreTupleNames) :
