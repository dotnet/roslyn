...
{
    internal sealed class SynthesizedReadOnlyListIndexOfMethod : SynthesizedImplementationMethod
    {
        internal SynthesizedReadOnlyListIndexOfMethod(SynthesizedReadOnlyListTypeSymbol containingType, MethodSymbol interfaceMethod) : base(interfaceMethod, containingType)
        {
        }
