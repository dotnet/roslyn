...
{
    internal sealed class SynthesizedReadOnlyListContainsMethod : SynthesizedImplementationMethod
    {
        internal SynthesizedReadOnlyListContainsMethod(SynthesizedReadOnlyListTypeSymbol containingType, MethodSymbol interfaceMethod) : base(interfaceMethod, containingType)
        {
        }
