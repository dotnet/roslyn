...
{
    internal sealed class SynthesizedReadOnlyListNotSupportedMethod : SynthesizedImplementationMethod
    {
        internal SynthesizedReadOnlyListNotSupportedMethod(SynthesizedReadOnlyListTypeSymbol containingType, MethodSymbol interfaceMethod) : base(interfaceMethod, containingType)
        {
        }
        ...
        internal sealed override void GenerateMethodBody(TypeCompilationState compilationState, BindingDiagnosticBag diagnostics)
        {
            ...
            try
            {
                ...
                // PROTOTYPE: Add NotSupportedException constructor to WellKnownMember.
