...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SynthesizedDelegateInvokeMethod : SynthesizedInstanceMethodSymbol
    {
        ...
        internal SynthesizedDelegateInvokeMethod(NamedTypeSymbol containingType, ArrayBuilder<(TypeWithAnnotations Type, RefKind RefKind, DeclarationScope Scope, SourceComplexParameterSymbolBase? SynthesizedAttributes)> parameterDescriptions, TypeWithAnnotations returnType, RefKind refKind)
        {
            _containingType = containingType;

            Parameters = parameterDescriptions.SelectAsArrayWithIndex(static (p, i, a) =>
                SynthesizedParameterSymbol.Create(a.Method, p.Type, i, p.RefKind, GeneratedNames.AnonymousDelegateParameterName(i, a.ParameterCount), p.Scope, synthesizedParameterAttributes: p.SynthesizedAttributes),
