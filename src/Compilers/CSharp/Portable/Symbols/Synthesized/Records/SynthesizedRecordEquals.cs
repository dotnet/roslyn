...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SynthesizedRecordEquals : SynthesizedRecordOrdinaryMethod
    {
        ...
        public SynthesizedRecordEquals(SourceMemberContainerTypeSymbol containingType, PropertySymbol? equalityContract, int memberOffset, in BindingDiagnosticBag diagnostics)
        ...
        protected override DeclarationModifiers MakeDeclarationModifiers(DeclarationModifiers allowedModifiers, in BindingDiagnosticBag diagnostics)
        {
        ...
        protected override (TypeWithAnnotations ReturnType, ImmutableArray<ParameterSymbol> Parameters, bool IsVararg, ImmutableArray<TypeParameterConstraintClause> DeclaredConstraintsForOverrideOrImplementation)
            MakeParametersAndBindReturnType(in BindingDiagnosticBag diagnostics)
        {
