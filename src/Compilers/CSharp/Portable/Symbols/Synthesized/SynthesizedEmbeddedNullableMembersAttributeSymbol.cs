...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal sealed class SynthesizedEmbeddedNullableMembersAttributeSymbol : SynthesizedEmbeddedAttributeSymbolBase
    {
        ...
        public SynthesizedEmbeddedNullableMembersAttributeSymbol(
            ...
            : base(AttributeDescription.NullableMembersAttribute, compilation, diagnostics)
        {
            ...
            Debug.Assert(_constructors.Length == AttributeDescription.NullableMembersAttribute.Signatures.Length);
        }
