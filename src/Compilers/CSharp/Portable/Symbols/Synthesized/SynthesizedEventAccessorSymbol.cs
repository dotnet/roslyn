...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SynthesizedEventAccessorSymbol : SourceEventAccessorSymbol
    {
        ...
        internal SynthesizedEventAccessorSymbol(SourceEventSymbol @event, bool isAdder, bool hasAnyBody, bool isExpressionBodied, EventSymbol explicitlyImplementedEventOpt = null, string aliasQualifierOpt = null)
            : base(@event, null, @event.Location, explicitlyImplementedEventOpt, aliasQualifierOpt, isAdder, isIterator: false, isNullableAnalysisEnabled: false, hasAnyBody: hasAnyBody, isExpressionBodied: isExpressionBodied)
        {
        }
