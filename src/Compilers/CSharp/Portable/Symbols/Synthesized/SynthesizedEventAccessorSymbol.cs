...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SynthesizedEventAccessorSymbol : SourceEventAccessorSymbol
    {
        ...
        internal SynthesizedEventAccessorSymbol(SourceEventSymbol @event, bool isAdder, BodyInfo bodyInfo, EventSymbol explicitlyImplementedEventOpt = null, string aliasQualifierOpt = null)
            : base(@event, null, @event.Location, explicitlyImplementedEventOpt, aliasQualifierOpt, isAdder, isIterator: false, isNullableAnalysisEnabled: false, bodyInfo: bodyInfo)
        {
        }
