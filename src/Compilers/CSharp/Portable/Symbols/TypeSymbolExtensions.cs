...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        public static bool ImplementsInterface(this TypeSymbol subType, TypeSymbol superInterface, ref CompoundUseSiteInfo useSiteInfo)
        {
        ...
        {
            CompoundUseSiteInfo localUseSiteInfo = useSiteInfo;
        ...
        private static bool IsTypeLessVisibleThan(TypeSymbol type, Symbol sym, ref CompoundUseSiteInfo useSiteInfo)
        {
            switch (type.TypeKind)
            {
                case TypeKind.Class:
        ...
        private static bool IsAsRestrictive(NamedTypeSymbol s1, Symbol sym2, ref CompoundUseSiteInfo useSiteInfo)
        {
...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
        ...
        private static bool NormalizeTaskTypesInNamedType(CSharpCompilation compilation, ref NamedTypeSymbol type)
        {
            ...
            if (!type.IsDefinition)
            {
                ...
                type.GetAllTypeArguments(typeArgumentsBuilder, ref unused);
