    ...
    internal sealed class PEMethodSymbol : MethodSymbol
    {
        ...
        private SignatureData LoadSignature()
        {
            ...
            if (count > 0)
            {
                ...
                {
                    builder.Add(PEParameterSymbol.Create(moduleSymbol, this, i, paramInfo[i + 1], isreturnParam: false, out isBadParameter));
                    if (isBadParameter)
                    {
                        makeBad = true;
                    }
            ...
            var returnParam = PEParameterSymbol.Create(moduleSymbol, this, 0, paramInfo[0], isreturnParam: true, out isBadParameter);
