...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    internal sealed class SymbolFactory : SymbolFactory<PEModuleSymbol, TypeSymbol>
    {
        ...
        private static TypeSymbolWithAnnotations CreateType(TypeSymbol type, ImmutableArray<ModifierInfo<TypeSymbol>> customModifiers)
        {
            ...
            return TypeSymbolWithAnnotations.Create(type, NonNullTypesFalseContext.Instance, isAnnotated: false, treatUnconstrainedTypeParameterAsNullable: false /* PROTOTYPE(NullableReferenceTypes): true? */, CSharpCustomModifier.Convert(customModifiers));
        }
    }
}
