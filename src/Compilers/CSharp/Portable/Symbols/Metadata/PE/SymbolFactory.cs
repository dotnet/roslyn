...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    internal sealed class SymbolFactory : SymbolFactory<PEModuleSymbol, TypeSymbol>
    {
                                                          ...
                                                          ImmutableArray<int> sizes, ImmutableArray<int> lowerBounds)
        {
            ...
            return ArrayTypeSymbol.CreateMDArray(moduleSymbol.ContainingAssembly, TypeSymbolWithAnnotations.Create(elementType, customModifiers), rank, sizes, lowerBounds);
        }
        ...
        internal override TypeSymbol MakePointerTypeSymbol(PEModuleSymbol moduleSymbol, TypeSymbol type, ImmutableArray<ModifierInfo<TypeSymbol>> customModifiers)
        {
            ...
            return new PointerTypeSymbol(TypeSymbolWithAnnotations.Create(type, customModifiers));
        }
        ...
        internal override TypeSymbol GetSZArrayTypeSymbol(PEModuleSymbol moduleSymbol, TypeSymbol elementType, ImmutableArray<ModifierInfo<TypeSymbol>> customModifiers)
        {
            ...
            return ArrayTypeSymbol.CreateSZArray(moduleSymbol.ContainingAssembly, TypeSymbolWithAnnotations.Create(elementType, customModifiers));
        }
            ...
            ImmutableArray<bool> refersToNoPiaLocalType)
        {
            ...
            TypeMap substitution = new TypeMap(typeParameters, arguments.SelectAsArray(arg => TypeSymbolWithAnnotations.Create(arg.Key, arg.Value)));
