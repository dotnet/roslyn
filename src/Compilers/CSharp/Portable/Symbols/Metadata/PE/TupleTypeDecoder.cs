    ...
    internal struct TupleTypeDecoder
    {
            ...
            PEModuleSymbol containingModule)
        {
            ...
            return (object)decoded == (object)type ?
                metadataType :
                TypeSymbolWithAnnotations.Create(decoded, metadataType.NonNullTypesContext, isAnnotated: metadataType.IsAnnotated, treatUnconstrainedTypeParameterAsNullable: false /* PROTOTYPE(NullableReferenceTypes): true? */, metadataType.CustomModifiers);
        }
        ...
        private TypeSymbolWithAnnotations DecodeTypeInternal(TypeSymbolWithAnnotations typeWithAnnotations)
        {
            ...
            return ReferenceEquals(decoded, type) ?
                typeWithAnnotations :
                TypeSymbolWithAnnotations.Create(decoded, typeWithAnnotations.NonNullTypesContext, isAnnotated: typeWithAnnotations.IsAnnotated, treatUnconstrainedTypeParameterAsNullable: false /* PROTOTYPE(NullableReferenceTypes): true? */, typeWithAnnotations.CustomModifiers);
        }
