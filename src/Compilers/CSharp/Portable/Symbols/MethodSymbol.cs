...
#nullable restore
        ...
        /// <summary>
        /// Returns if the method is implicit static constructor
        /// </summary>
        internal bool IsImplicitStaticConstructor
        {
            get
            {
                return MethodKind == MethodKind.StaticConstructor && IsImplicitlyDeclared;
            }
        }
