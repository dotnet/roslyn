...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class ConstantValueUtils
    {
        ...
        internal static ConstantValue GetAndValidateConstantValue(
            ...
            ExpressionSyntax initValueNode,
            BindingDiagnosticBag diagnostics)
        {
            ...
            if (!boundValue.HasAnyErrors)
            {
                ...
                {
                    diagnostics.Add(ErrorCode.ERR_InvalidConstantDeclarationType, initValueNode, thisSymbol, typeSymbol);
                }
                else
                {
                        ...
                        typeSymbol.SpecialType != SpecialType.System_String)
                    {
                        ...
                        diagnostics.Add(ErrorCode.ERR_NotNullConstRefField, initValueNode, thisSymbol, typeSymbol);
                    ...
                    {
                        diagnostics.Add(ErrorCode.ERR_NotConstantExpression, initValueNode, thisSymbol);
                    }
                }
            }
