    ...
    internal class SynthesizedRecordGetHashCodeSymbol : SynthesizedInstanceMethodSymbol
    {
        ...
        internal override void GenerateMethodBody(TypeCompilationState compilationState, DiagnosticBag diagnostics)
        {
            ...
            foreach (var prop in _properties)
            {
                ...
                NamedTypeSymbol constructedEqualityComparer = equalityComparerType.Construct(prop.Type.TypeSymbol);
        ...
        public override TypeSymbolWithAnnotations ReturnType
            => TypeSymbolWithAnnotations.Create(DeclaringCompilation.GetSpecialType(SpecialType.System_Int32));
