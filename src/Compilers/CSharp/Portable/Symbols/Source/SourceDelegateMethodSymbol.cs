...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal abstract class SourceDelegateMethodSymbol : SourceMemberMethodSymbol
    {
            ...
            BindingDiagnosticBag diagnostics)
        {
            ...
            if (returnTypeSyntax is ScopedTypeSyntax)
            {
                diagnostics.Add(ErrorCode.ERR_BadMemberFlag, syntax.Identifier.GetLocation(), SyntaxFacts.GetText(SyntaxKind.ScopedKeyword));
            }
