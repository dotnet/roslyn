...
#nullable enable
        ...
        protected abstract void CheckForBlockAndExpressionBody(CSharpSyntaxNode syntax, BindingDiagnosticBag diagnostics);
...
#nullable enable
        protected abstract ImmutableArray<ParameterSymbol> ComputeParameters(Binder? binder, CSharpSyntaxNode syntax, BindingDiagnosticBag diagnostics);

        protected abstract TypeWithAnnotations ComputeType(Binder? binder, SyntaxNode syntax, BindingDiagnosticBag diagnostics);
