...
#nullable enable
        ...
        /// overrides to <see cref="ComputeType(Binder?, SyntaxNode, DiagnosticBag)" />. If a binder is not required in this situation
...
#nullable enable
        protected Binder CreateBinderForTypeAndParameters()
        {
            var compilation = this.DeclaringCompilation;
