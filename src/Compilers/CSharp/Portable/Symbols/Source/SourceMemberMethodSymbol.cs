...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        protected void CheckEffectiveAccessibility(TypeWithAnnotations returnType, ImmutableArray<ParameterSymbol> parameters, in BindingDiagnosticBag diagnostics)
        {
        ...
        protected void CheckFileTypeUsage(TypeWithAnnotations returnType, ImmutableArray<ParameterSymbol> parameters, in BindingDiagnosticBag diagnostics)
        {
        ...
        /// </remarks>
        protected abstract void MethodChecks(in BindingDiagnosticBag diagnostics);
...
// diagnostics have been reported (not necessarily on this thread).
        ...
        /// </summary>
        protected void CheckModifiersForBody(Location location, in BindingDiagnosticBag diagnostics)
        {
        ...
        protected void CheckFeatureAvailabilityAndRuntimeSupport(SyntaxNode declarationSyntax, Location location, bool hasBody, in BindingDiagnosticBag diagnostics)
        {
