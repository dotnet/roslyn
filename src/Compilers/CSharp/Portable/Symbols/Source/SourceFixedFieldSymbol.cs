...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal class SourceFixedFieldSymbol : SourceMemberFieldSymbolFromDeclarator
    {
        ...
        internal override void AddSynthesizedAttributes(PEModuleBuilder moduleBuilder, ref ArrayBuilder<SynthesizedAttributeData> attributes)
        {
            ...
            var item1 = new TypedConstant(systemType, TypedConstantKind.Type, ((PointerTypeSymbol)this.TypeWithAnnotations.Type).PointedAtTypeWithAnnotations.Type);
                        ...
                        else
                        {
                            ...
                            if (sizeConstant.IsIntegral)
                            {
                                ...
                                if (int32Value > 0)
                                {
                                    ...
                                    TypeSymbol elementType = ((PointerTypeSymbol)this.TypeWithAnnotations.Type).PointedAtTypeWithAnnotations.Type;
    ...
    internal sealed class FixedFieldImplementationType : SynthesizedContainer
    {
            ...
            : base(GeneratedNames.MakeFixedFieldImplementationName(field.Name), typeParameters: ImmutableArray<TypeParameterSymbol>.Empty, typeMap: TypeMap.Empty)
        {
            ...
            _internalField = new SynthesizedFieldSymbol(this, ((PointerTypeSymbol)field.TypeWithAnnotations.Type).PointedAtTypeWithAnnotations.Type, FixedElementFieldName, isPublic: true);
        }
        ...
        internal override TypeLayout Layout
        {
            get
            {
                ...
                var elementType = ((PointerTypeSymbol)_field.TypeWithAnnotations.Type).PointedAtTypeWithAnnotations.Type;
                int elementSize = elementType.FixedBufferElementSizeInBytes();
