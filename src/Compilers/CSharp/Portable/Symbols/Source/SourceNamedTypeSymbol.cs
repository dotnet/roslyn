...
next:;
        ...
        private ImmutableArray<TypeParameterConstraintKind> MakeTypeParameterConstraintKinds()
        {
            ...
            if (arity > 0)
            {
                ...
                results = AdjustConstraintKindsBasedOnConstraintTypes(results);
                                                                                                         ...
                                                                                                         DiagnosticBag diagnostics)
        {
                                         ...
                                         TypeParameterConstraintClause clause)
            {
                ...
                originalConstraintTypesMap ??= toDictionary(originalConstraintTypes,
                                                            new TypeWithAnnotations.EqualsComparer(TypeCompareKind.IgnoreNullableModifiersForReferenceTypes, isValueTypeOverrideOpt: null));
        ...
        private ImmutableArray<TypeParameterConstraintClause> AdjustConstraintKindsBasedOnConstraintTypes(ImmutableArray<TypeParameterConstraintClause> constraintClauses)
        {
            return ConstraintsHelper.AdjustConstraintKindsBasedOnConstraintTypes(this, TypeParameters, constraintClauses);
        }
