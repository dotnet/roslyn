...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed partial class SourceNamedTypeSymbol : SourceMemberContainerTypeSymbol, IAttributeTargetSymbol
    {
        ...
        internal SourceNamedTypeSymbol(NamespaceOrTypeSymbol containingSymbol, MergedTypeDeclaration declaration, in BindingDiagnosticBag diagnostics, TupleExtraData tupleData = null)
...
next:;
        ...
        private ImmutableArray<ImmutableArray<TypeWithAnnotations>> MakeTypeParameterConstraintTypes(in BindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        protected sealed override void DecodeWellKnownAttributeImpl(ref DecodeWellKnownAttributeArguments<AssemblySymbol, AttributeSyntax, CSharpAttributeData, AttributeLocation> arguments)
        {
            ...
            {
                AttributeData.DecodeStructLayoutAttribute<TypeWellKnownAttributeData, AssemblySymbol, AttributeSyntax, CSharpAttributeData, AttributeLocation>(
        ...
        private void DecodeCoClassAttribute(ref DecodeWellKnownAttributeArguments<AssemblySymbol, AttributeSyntax, CSharpAttributeData, AttributeLocation> arguments)
        {
            var attribute = arguments.Attribute;
            Debug.Assert(!attribute.HasErrors);
        ...
        private void ValidateConditionalAttribute(CSharpAttributeData attribute, AttributeSyntax node, in BindingDiagnosticBag diagnostics)
        {
...
#nullable enable
        ...
        protected override void AfterMembersCompletedChecks(in BindingDiagnosticBag diagnostics)
        {
