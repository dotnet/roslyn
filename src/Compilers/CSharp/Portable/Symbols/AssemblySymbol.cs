...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class AssemblySymbol : Symbol, IAssemblySymbolInternal
    {
        ...
        internal AssemblySymbol CorLibrary
        {
            get
            {
#nullable disable // Can '_corLibrary' be null? https://github.com/dotnet/roslyn/issues/39166
                return _corLibrary;
#nullable enable
            }
        }
        ...
        {
            RoslynDebug.Assert((object?)_corLibrary == null);
        ...
        private bool IsValidWellKnownType([NotNullWhen(returnValue: true)] NamedTypeSymbol? result)
        {
