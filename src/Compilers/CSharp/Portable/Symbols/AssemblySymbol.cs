...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class AssemblySymbol : Symbol, IAssemblySymbolInternal
    {
        ...
        bool IAssemblySymbol.GivesAccessTo(IAssemblySymbol assemblyWantingAccess)
        {
            ...
            if (myKeys.Any() && assembly?.DeclaringCompilation?.Options.OutputKind.IsNetModule() == true)
            {
                return true;
            }
            ...
            {
                IVTConclusion conclusion = assemblyWantingAccess.PerformIVTCheck(assemblyWantingAccess.Identity.PublicKey, key, this.Identity);
