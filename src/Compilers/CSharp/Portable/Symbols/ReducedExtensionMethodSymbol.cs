...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class ReducedExtensionMethodSymbol : MethodSymbol
    {
            ...
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo, out bool wasFullyInferred)
        {
            ...
            var success = method.CheckConstraints(new ConstraintsHelper.CheckConstraintsArgs(compilation, conversions, includeNullability: false, NoLocation.Singleton, diagnostics: null, template: new CompoundUseSiteInfo<AssemblySymbol>(useSiteInfo), reportUnsafeConstructorConstraintErrors: false),
