...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class TypeMap : AbstractTypeParameterMap
    {
            ...
            : base(ConstructMapping(from, to))
        {
            ...
            Debug.Assert(allowAlpha || !from.Any(static tp => tp is SubstitutedTypeParameterSymbol && tp.ContainingSymbol is not SourceExtensionImplementationMethodSymbol)); // PROTOTYPE: Follow up
        }
