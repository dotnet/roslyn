...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal abstract class RewrittenParameterSymbol : WrappedParameterSymbol
    {
        ...
        internal sealed override ImmutableArray<int> InterpolatedStringHandlerArgumentIndexes => throw ExceptionUtilities.Unreachable(); // Tracked by https://github.com/dotnet/roslyn/issues/76130 : interpolated string, Follow up

        internal sealed override bool HasInterpolatedStringHandlerArgumentError => throw ExceptionUtilities.Unreachable(); // Tracked by https://github.com/dotnet/roslyn/issues/76130 : interpolated string, Follow up
    }
}
