...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class SymbolDisplayVisitor
    {
        ...
        {
            AddPunctuation((Format.CompilerInternalOptions & SymbolDisplayCompilerInternalOptions.UsePlusForNestedTypes) == SymbolDisplayCompilerInternalOptions.UsePlusForNestedTypes ? SyntaxKind.PlusToken : SyntaxKind.DotToken);
        }
        ...
        private void AddNameAndTypeArgumentsOrParameters(INamedTypeSymbol symbol)
        {
            ...
            {
                if ((Format.CompilerInternalOptions & SymbolDisplayCompilerInternalOptions.UseMetadataMemberNames) == SymbolDisplayCompilerInternalOptions.UseMetadataMemberNames)
                {
