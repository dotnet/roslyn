...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal static partial class ValueSetFactory
    {
        ...
        {
            public static readonly NuintValueSet AllValues = new NuintValueSet(values: NumericValueSet<uint, UIntTC>.AllValues(UIntTC.Instance), hasLarge: true);

            public static readonly NuintValueSet NoValues = new NuintValueSet(values: NumericValueSet<uint, UIntTC>.NoValues(UIntTC.Instance), hasLarge: false);
