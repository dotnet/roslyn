...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal static partial class ValueSetFactory
    {
        private sealed class NintValueSet : IValueSet<int>, IValueSet
        {
            ...
            bool IValueSet.All(BinaryOperatorKind relation, ConstantValue value) => value.IsBad ? true : All(relation, value.Int32Value);
            ...
            bool IValueSet.Any(BinaryOperatorKind relation, ConstantValue value) => value.IsBad ? true : Any(relation, value.Int32Value);
