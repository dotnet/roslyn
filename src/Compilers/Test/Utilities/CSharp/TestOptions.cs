...
namespace Microsoft.CodeAnalysis.CSharp.Test.Utilities
{
    public static class TestOptions
    {
        ...
        public static readonly CSharpParseOptions Regular6WithV8SwitchBinder = Regular6.WithFeatures(new Dictionary<string, string>() { { "testV8SwitchBinder", "true" } });
        public static readonly CSharpParseOptions RegularWithV8SwitchBinder = Regular.WithFeatures(new Dictionary<string, string>() { { "testV8SwitchBinder", "true" } });
