        ...
        public static void CheckAccessorShape(this MethodSymbol accessor, Symbol propertyOrEvent)
        {
            ...
            switch (accessor.MethodKind)
            {
                ...
                case MethodKind.EventRemove:
                    ...
                    Assert.Equal(propertyOrEventType.TypeSymbol, accessor.Parameters.Single().Type.TypeSymbol);
                    break;
                ...
                case MethodKind.PropertySet:
                    ...
                    {
                        Assert.Equal(propertyOrEventType.TypeSymbol, accessor.ReturnType.TypeSymbol);
                    }
                    ...
                    if (isSetter)
                    {
                        ...
                        Assert.Equal(propertyOrEventType.TypeSymbol, valueParameter.Type.TypeSymbol);
