...
#Region "Diagnostics"
        ...
        Friend Overrides Function AnalyzerForLanguage(analyzers As ImmutableArray(Of DiagnosticAnalyzer), analyzerManager As DefaultAnalyzerHostContext) As AnalyzerDriver
