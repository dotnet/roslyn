        ...
        Private Shared Function SignaturesCollide(x As Symbol, y As Symbol) As Boolean
            ...
            For i = 0 To numParams - 1
                ...
                If typeKind = TypeKind.Array Then
                    ...
                    Dim elementTypesDiffer As Boolean = Not TypeSymbol.Equals(xArrayType.ElementType, yArrayType.ElementType, TypeCompareKind.ConsiderEverything2)
                    ...
                    ElseIf elementTypesDiffer Then
                        Return False
                    End If
                ElseIf Not TypeSymbol.Equals(xType, yType, TypeCompareKind.ConsiderEverything2) Then
                    Return False
                End If
            Next
