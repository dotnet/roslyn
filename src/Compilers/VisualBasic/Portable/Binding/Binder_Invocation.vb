...
#End If
        ...
        Friend Function GetArgumentForParameterDefaultValue(param As ParameterSymbol, syntax As VisualBasicSyntaxNode, diagnostics As DiagnosticBag, callerInfoOpt As VisualBasicSyntaxNode) As BoundExpression
            ...
            If defaultConstantValue IsNot Nothing Then
                ...
                defaultArgument = AdditionalChecks(param, syntax, diagnostics, callerInfoOpt, defaultConstantValue)
            ...
            ElseIf param.IsOptional Then
                ...
                Else
                    defaultArgument = AdditionalChecks(param, syntax, diagnostics, callerInfoOpt, ConstantValue.Nothing)
                End If
        ...
        Private Function AdditionalChecks(param As ParameterSymbol, syntax As VisualBasicSyntaxNode, diagnostics As DiagnosticBag, callerInfoOpt As VisualBasicSyntaxNode, defaultConstantValue As ConstantValue) As BoundExpression
        ...
        Private Function CheckSpecialTypeObject(param As ParameterSymbol, syntax As VisualBasicSyntaxNode, diagnostics As DiagnosticBag, defaultArgument As BoundExpression) As BoundExpression
        ...
        Private Function CheckDefaultSpecialType(syntax As VisualBasicSyntaxNode, diagnostics As DiagnosticBag, defaultSpecialType As SpecialType, paramNullableUnderlyingTypeOrSelf As TypeSymbol) As TypeSymbol
            Dim defaultArgumentType As TypeSymbol
            ...
            Return defaultArgumentType
        End Function

        Private Sub CheckOptionCompare(syntax As VisualBasicSyntaxNode, diagnostics As DiagnosticBag, ByRef defaultConstantValue As ConstantValue, ByRef defaultArgumentType As TypeSymbol, paramNullableUnderlyingTypeOrSelf As TypeSymbol)
