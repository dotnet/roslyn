...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend Class Binder
        ...
        Private Function CreateBoundCallOrPropertyAccess(
            ...
            If group.ResultKind = LookupResultKind.Inaccessible Then
                ReportDiagnostic(diagnostics, target, GetInaccessibleErrorInfo(bestResult.Candidate.UnderlyingSymbol, useSiteInfo:=CompoundUseSiteInfo(Of AssemblySymbol).Discarded))
            Else
        ...
        Private Function ReportOverloadResolutionFailureAndProduceBoundNode(
            ...
            If lookupResult = LookupResultKind.Inaccessible Then
                If singleCandidate IsNot Nothing Then
                    ReportDiagnostic(diagnostics, If(groupOpt IsNot Nothing, groupOpt.Syntax, node), GetInaccessibleErrorInfo(singleCandidate.UnderlyingSymbol, useSiteInfo:=CompoundUseSiteInfo(Of AssemblySymbol).Discarded))
                Else
