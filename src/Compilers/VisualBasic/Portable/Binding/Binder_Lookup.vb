...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend Class Binder
        ...
        Friend Function GetInaccessibleErrorInfo(sym As Symbol, <[In], Out> ByRef useSiteInfo As CompoundUseSiteInfo(Of AssemblySymbol)) As DiagnosticInfo
            CheckAccessibility(sym, useSiteInfo) ' For diagnostics.
