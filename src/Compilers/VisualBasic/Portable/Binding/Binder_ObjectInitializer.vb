...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Partial Class Binder
        ...
        Private Function BindObjectCreationExpression(
            ...
            Debug.Assert(objectInitializerExpressionOpt Is Nothing OrElse TypeSymbol.Equals(objectInitializerExpressionOpt.Type, type0, TypeCompareKind.ConsiderEverything2))
...
#End If
                ...
                Else
                    ...
                    Else
                        Debug.Assert(TypeSymbol.Equals(type, type0, TypeCompareKind.ConsiderEverything2))
                    End If
        ...
        Private Function BindObjectInitializer(
            ...
            For Each fieldInitializer In memberInitializerSyntax.Initializers
                ...
                Debug.Assert(TypeSymbol.Equals(DirectCast(memberAssignments.Last, BoundAssignmentOperator).Right.Type, DirectCast(memberAssignments.Last, BoundAssignmentOperator).Left.Type, TypeCompareKind.ConsiderEverything2))
