                    ...
                    For Each local In binder.Locals
                        If local.IsStatic Then
                            ...
                            If staticLocals Is Nothing Then
                                staticLocals = New Dictionary(Of String, ArrayBuilder(Of LocalSymbol))(StringComparers.IdentifierComparer)
...
#End If
        ...
        Private Sub VerifyLocalSymbolNameAndSetType(local As LocalSymbol,
            ...
            If localForFunctionValue IsNot Nothing AndAlso StringComparers.IdentifierComparer.Equals(local.Name, localForFunctionValue.Name) Then
