            ...
            Private Sub New(containingBinder As Binder,
                ...
                For fieldIndex = 0 To initializersCount - 1
                    ...
                    If fieldSyntax.Kind = SyntaxKind.InferredFieldInitializer Then
                        ...
                        If fieldNameToken.IsKind(SyntaxKind.None) Then
                        ...
                        Else
                            ...
                            fieldIsKey = inferredFieldInitializer.KeyKeyword.IsKind(SyntaxKind.KeyKeyword)
                        End If
                    ...
                    Else
                        ...
                        fieldIsKey = namedFieldInitializer.KeyKeyword.IsKind(SyntaxKind.KeyKeyword)
