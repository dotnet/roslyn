...
#End If
        ...
        Friend Overrides Function FramePointer(syntax As SyntaxNode, frameClass As NamedTypeSymbol) As BoundExpression
            ...
            If _currentFrameThis IsNot Nothing AndAlso TypeSymbol.Equals(_currentFrameThis.Type, frameClass, TypeCompareKind.ConsiderEverything2) Then
        ...
        Private Function RewriteCatch(node As BoundCatchBlock,
            ...
            ElseIf node.LocalOpt IsNot Nothing Then
                ...
                If TypeSymbol.Equals(newType, origLocal.Type, TypeCompareKind.ConsiderEverything2) Then
                    ' keeping same local
