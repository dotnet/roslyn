...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Partial Friend Class ExpressionLambdaRewriter
            ...
            If fromIsNullable OrElse toIsNullable Then
                ...
                If fromIsNullable Then
                    If Not toIsNullable Then
                        ...
                        ElseIf TypeSymbol.Equals(notNullableFrom, notNullableTo, TypeCompareKind.ConsiderEverything2) Then
                        ...
                        Else
                            ...
                            Debug.Assert(Not TypeSymbol.Equals(interimType, typeTo, TypeCompareKind.ConsiderEverything2))
        ...
        Private Function CreateTypeAsIfNeeded(operand As BoundExpression, oldType As TypeSymbol, newType As TypeSymbol) As BoundExpression
            Return If((TypeSymbol.Equals(oldType, newType, TypeCompareKind.ConsiderEverything2)), operand, CreateTypeAs(operand, newType))
        End Function
        ...
        Private Function ConvertIfNeeded(operand As BoundExpression, oldType As TypeSymbol, newType As TypeSymbol, isChecked As Boolean) As BoundExpression
            Return If((TypeSymbol.Equals(oldType, newType, TypeCompareKind.ConsiderEverything2)), operand, Convert(operand, newType, isChecked))
        End Function
