        ...
        Partial Friend Class AsyncMethodToClassRewriter
            ...
            Public Overrides Function VisitBinaryOperator(node As BoundBinaryOperator) As BoundNode
                ...
                If operatorKind = BinaryOperatorKind.AndAlso OrElse operatorKind = BinaryOperatorKind.OrElse Then
                    ...
                    Dim spilledLeft = SpillValue(left, shouldCheckSideEffects:=True, sideEffectsAlreadyChecked:=False, builder)
            ...
            Friend Function ProcessRewrittenAssignmentOperator(rewritten As BoundAssignmentOperator) As BoundExpression
                ...
                Dim spilledLeft As BoundExpression = SpillLValue(left, isReceiver:=False, shouldCheckSideEffects:=False, sideEffectsAlreadyChecked:=False, builder:=builder)
                    ...
                    If node.CaptureReceiver OrElse conditionalAccessReceiverPlaceholderReplacementInfo.IsSpilled Then
                        ...
                        If node.CaptureReceiver Then
                            ...
                            If Not receiver.Type.IsReferenceType Then
                                receiver = SpillValue(receiver, isReceiver:=True, shouldCheckSideEffects:=True, sideEffectsAlreadyChecked:=False, builder:=builder)
                            End If
                        ...
                        Else
                            ...
                            placeholderReplacement = SpillValue(receiver, isReceiver:=True, shouldCheckSideEffects:=True, sideEffectsAlreadyChecked:=False, builder:=builder)
