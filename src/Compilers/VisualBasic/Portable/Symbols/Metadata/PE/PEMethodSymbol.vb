...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols.Metadata.PE
    ...
    Friend NotInheritable Class PEMethodSymbol
        ...
        Private Structure PackedFlags
            ...
            ' c = obsolete attribute populated. 1 bit
            ' d = custom attributes populated. 1 bit
            ' e = use site diagnostic populated. 1 bit
            ' f = conditional attributes populted. 1 bit
            ...
            Private Const IsObsoleteAttributePopulatedBit As Integer = 1 << 6
            Private Const IsCustomAttributesPopulatedBit As Integer = 1 << 7
            Private Const IsUseSiteDiagnosticPopulatedBit As Integer = 1 << 8
            Private Const IsConditionalAttributePopulatedBit As Integer = 1 << 9
