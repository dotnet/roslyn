...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend NotInheritable Class SourceTypeParameterOnTypeSymbol
        ...
        Public Overrides ReadOnly Property LocationsCount As Integer
            Get
                Return SymbolLocationHelper.Many.LocationsCount(_syntaxRefs)
            End Get
        End Property

        Public Overrides Function GetCurrentLocation(slot As Integer, index As Integer) As Location
            Return SymbolLocationHelper.Many.GetCurrentLocation(slot, index, _syntaxRefs, Function(decl) decl.GetLocation())
        End Function
        ...
        Public Overrides Function MoveNextLocation(previousSlot As Integer, previousIndex As Integer) As (hasNext As Boolean, nextSlot As Integer, nextIndex As Integer)
            Return SymbolLocationHelper.Many.MoveNextLocation(previousSlot, previousIndex, _syntaxRefs)
        End Function
        ...
        Public Overrides Function MoveNextLocationReversed(previousSlot As Integer, previousIndex As Integer) As (hasNext As Boolean, nextSlot As Integer, nextIndex As Integer)
            Return SymbolLocationHelper.Many.MoveNextLocationReversed(previousSlot, previousIndex, _syntaxRefs)
        End Function
    ...
    Friend NotInheritable Class SourceTypeParameterOnMethodSymbol
        ...
        Public Overrides Function GetCurrentLocation(slot As Integer, index As Integer) As Location
            Return SymbolLocationHelper.Single.GetCurrentLocation(slot, index, GetSymbolLocation(_syntaxRef))
        End Function
