    ...
    Friend MustInherit Class SynthesizedEventAccessorSymbol
        ...
        Private Shared Function ConstructFieldLikeEventAccessorBody_Regular(eventSymbol As SourceEventSymbol,
            ...
            If compareExchangeMethod Is Nothing Then
                ...
                Dim conversionKind1 As ConversionKind = Conversions.ClassifyDirectCastConversion(fieldSymbol.Type, updateMethod.Parameters(0).Type, conversionsUseSiteInfo)
                Dim conversionKind2 As ConversionKind = Conversions.ClassifyDirectCastConversion(boundParameter.Type, updateMethod.Parameters(1).Type, conversionsUseSiteInfo)
