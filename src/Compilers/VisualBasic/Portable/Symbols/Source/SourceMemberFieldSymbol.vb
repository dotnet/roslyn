                ...
                For nameIndex = 0 To nameCount - 1
                    ...
                    If (modifiers.FoundFlags And SourceMemberFlags.Const) <> 0 AndAlso
                        ...
                        If simpleAsClauseSyntax Is Nothing OrElse
                            (simpleAsClauseSyntax.Type.Kind = SyntaxKind.PredefinedType AndAlso DirectCast(simpleAsClauseSyntax.Type, PredefinedTypeSyntax).Keyword.IsKind(SyntaxKind.ObjectKeyword)) Then
