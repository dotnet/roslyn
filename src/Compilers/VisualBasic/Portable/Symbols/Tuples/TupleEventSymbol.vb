    ...
    Friend NotInheritable Class TupleEventSymbol
        ...
        Public Overloads Function Equals(other As TupleEventSymbol) As Boolean
            Return other Is Me OrElse
                (other IsNot Nothing AndAlso TypeSymbol.Equals(Me._containingType, other._containingType, TypeCompareKind.ConsiderEverything2) AndAlso Me._underlyingEvent = other._underlyingEvent)
        End Function
