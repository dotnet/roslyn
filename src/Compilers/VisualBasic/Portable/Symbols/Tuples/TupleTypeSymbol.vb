...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    Friend NotInheritable Class TupleTypeSymbol
        ...
        Public Overrides ReadOnly Property DeclaredAccessibility As Accessibility
            Get
                If _underlyingType.IsErrorType() Then Return Accessibility.[Public]
        ...
        Private Function ComputeDefinitionToMemberMap() As SmallDictionary(Of Symbol, Symbol)
            ...
            Dim originalDefinition As NamedTypeSymbol = _underlyingType.OriginalDefinition
                ...
                Select Case kind
                    Case SymbolKind.[Event]
                        ...
                        If associatedField IsNot Nothing Then
                            Debug.Assert(associatedField.ContainingSymbol Is _underlyingType)
                            Debug.Assert(_underlyingType.GetMembers(associatedField.Name).IndexOf(associatedField) < 0)
        ...
        Friend Overrides Function GetUseSiteErrorInfo() As DiagnosticInfo
            Return _underlyingType.GetUseSiteErrorInfo()
        End Function
