...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend NotInheritable Class TuplePropertySymbol
        ...
        Public Overrides ReadOnly Property GetMethod As MethodSymbol
            Get
                Return _containingType.GetTupleMemberSymbolForUnderlyingMember(Of MethodSymbol)(_underlyingProperty.GetMethod)
            End Get
        End Property

        Public Overrides ReadOnly Property SetMethod As MethodSymbol
            Get
                Return _containingType.GetTupleMemberSymbolForUnderlyingMember(Of MethodSymbol)(_underlyingProperty.SetMethod)
            End Get
        End Property

        Friend Overrides ReadOnly Property AssociatedField As FieldSymbol
            Get
                Return _containingType.GetTupleMemberSymbolForUnderlyingMember(Of FieldSymbol)(_underlyingProperty.AssociatedField)
            End Get
        End Property
        ...
        Private Function CreateParameters() As ImmutableArray(Of ParameterSymbol)
            Return _underlyingProperty.Parameters.SelectAsArray(Of ParameterSymbol)(Function(p) New TupleParameterSymbol(Me, p))
        End Function

        Friend Overrides Function GetUseSiteErrorInfo() As DiagnosticInfo
            Dim useSiteDiagnostic As DiagnosticInfo = MyBase.GetUseSiteErrorInfo
            MyBase.MergeUseSiteErrorInfo(useSiteDiagnostic, _underlyingProperty.GetUseSiteErrorInfo())
        ...
        Public Overloads Function Equals(other As TuplePropertySymbol) As Boolean
            Return other Is Me OrElse
                (other IsNot Nothing AndAlso _containingType = other._containingType AndAlso _underlyingProperty = other._underlyingProperty)
        End Function
