    ...
    Friend Module CompileTimeCalculations
        ...
        Friend Function Multiply(
            ...
            If ConstantValue.IsUnsignedIntegralType(resultType) Then
                ...
                End If
            Else
                If (ResultValue <= 0 AndAlso ( (leftValue > 0 AndAlso rightValue > 0) OrElse (leftValue < 0 AndAlso rightValue < 0))) OrElse
                   (ResultValue >= 0 AndAlso ( (leftValue > 0 AndAlso rightValue > 0) OrElse (leftValue < 0 AndAlso rightValue < 0))) OrElse
