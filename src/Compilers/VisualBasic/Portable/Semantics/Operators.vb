...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend Class OverloadResolution
        ...
        Private Shared Function OverloadedOperatorTargetsContainingType(containingType As NamedTypeSymbol, typeFromSignature As TypeSymbol) As Boolean
            ...
            Else
                Return TypeSymbol.Equals(typeFromSignature.GetNullableUnderlyingTypeOrSelf().GetTupleUnderlyingTypeOrSelf(), containingType.GetTupleUnderlyingTypeOrSelf(), TypeCompareKind.ConsiderEverything2)
            End If
        End Function
