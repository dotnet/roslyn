...
#End If
        ...
        Private Shared Function IsConversionOperatorViableBasedOnTypesInvolved(
            ...
            If Not method.ContainingType.IsDefinition Then
                ...
                If Conversions.ConversionExists(Conversions.ClassifyPredefinedConversion(inputType, outputType, useSiteInfo)) OrElse
                   Not useSiteInfo.Diagnostics.IsNullOrEmpty Then
                    Return False
                End If
            End If
