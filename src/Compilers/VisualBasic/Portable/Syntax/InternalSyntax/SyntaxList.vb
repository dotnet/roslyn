...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Friend Class SyntaxListBuilder
        ...
        Public Overloads Function AddRange(Of TNode As VisualBasicSyntaxNode)(list As SyntaxList(Of TNode)) As SyntaxListBuilder
            Return Me.AddRange(Of TNode)(list, 0, list.Count)
        End Function

        Public Overloads Function AddRange(Of TNode As VisualBasicSyntaxNode)(list As SyntaxList(Of TNode), offset As Integer, length As Integer) As SyntaxListBuilder
        ...
        Friend Overrides Function ToListNode() As VisualBasicSyntaxNode
            Select Case Me.Count
                ...
                Case 2
                    Return SyntaxList.List(
                        DirectCast(Nodes(0).Value, VisualBasicSyntaxNode),
                        DirectCast(Nodes(1).Value, VisualBasicSyntaxNode))
                Case 3
                    Return SyntaxList.List(
                        DirectCast(Nodes(0).Value, VisualBasicSyntaxNode),
                        DirectCast(Nodes(1).Value, VisualBasicSyntaxNode),
                        DirectCast(Nodes(2).Value, VisualBasicSyntaxNode))
            End Select

            Dim tmp = New ArrayElement(Of VisualBasicSyntaxNode)(Me.Count) {}
            Array.Copy(Nodes, tmp, Me.Count)
            Return SyntaxList.List(tmp)
        End Function
