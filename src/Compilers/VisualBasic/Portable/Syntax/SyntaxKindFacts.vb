...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Partial Public Class SyntaxFacts
    ...
    Public Shared Function IsReservedKeyword(kind As SyntaxKind) As Boolean
      Return (kind = SyntaxKind.NameOfKeyword) OrElse
             (kind - SyntaxKind.AddHandlerKeyword) <= (SyntaxKind.WendKeyword - SyntaxKind.AddHandlerKeyword)
    End Function
    ...
    Public Shared Function IsContextualKeyword(kind As SyntaxKind) As Boolean
      Return (kind - SyntaxKind.AggregateKeyword) <= (SyntaxKind.YieldKeyword - SyntaxKind.AggregateKeyword)
    End Function
    ...
    Private Shared reservedKeywords As SyntaxKind() =
      {
    ...
    Private Shared contextualKeywords As SyntaxKind() = _
      {
    ...
    Private Shared punctuationKinds As SyntaxKind() = _ 
      {
    ...
    Private Shared preprocessorKeywords As SyntaxKind() =
      {
        SyntaxKind.IfKeyword,
        SyntaxKind.ThenKeyword,
        SyntaxKind.ElseIfKeyword,
