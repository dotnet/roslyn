...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Public Class SyntaxFactory
        ...
        Friend Shared Function IsCompleteSubmission(tree As SyntaxTree) As Boolean
            ...
            Return True
        End Function
        Friend Shared Function FlagsEnumIsAnyToken(leadingTrivia As SyntaxTriviaList, trailingTrivia As SyntaxTriviaList) As SyntaxToken
            Return SyntaxFactory.FlagsEnumOperator(leadingTrivia, SyntaxKind.FlagsEnumIsAnyToken, "!/", trailingTrivia)
        End Function
