        ...
        Private Shared Function GetSerializationData() As IEnumerable(Of Object)
            If s_serializationData Is Nothing Then
                Dim data = New Object() {
                    ...
                    GetType(Microsoft.CodeAnalysis.Syntax.InternalSyntax.CommonSyntaxList),
                    GetType(Microsoft.CodeAnalysis.Syntax.InternalSyntax.CommonSyntaxList.WithTwoChildren),
                    GetType(Microsoft.CodeAnalysis.Syntax.InternalSyntax.CommonSyntaxList.WithThreeChildren),
                    GetType(Microsoft.CodeAnalysis.Syntax.InternalSyntax.CommonSyntaxList.WithManyChildren),
                    GetType(Microsoft.CodeAnalysis.Syntax.InternalSyntax.CommonSyntaxList.WithLotsOfChildren),
