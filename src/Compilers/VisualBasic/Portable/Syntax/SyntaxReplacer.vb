    ...
    Friend Class SyntaxReplacer
        ...
        Private Class Replacer(Of TNode As SyntaxNode)
            ...
            Public Overrides Function VisitListElement(trivia As SyntaxTrivia) As SyntaxTrivia
                ...
                If VisitIntoStructuredTrivia AndAlso trivia.HasStructure AndAlso ShouldVisit(trivia.FullSpan) Then
        ...
        Private Class BaseListEditor
            ...
            Public Overrides Function VisitToken(token As SyntaxToken) As SyntaxToken
                Dim rewritten = token
                If _visitTrivia AndAlso ShouldVisit(token.FullSpan) Then
                    rewritten = MyBase.VisitToken(token)
                End If
                Return rewritten
            End Function
            ...
            Public Overrides Function VisitListElement(element As SyntaxTrivia) As SyntaxTrivia
                ...
                If _visitIntoStructuredTrivia AndAlso element.HasStructure AndAlso ShouldVisit(element.FullSpan) Then
