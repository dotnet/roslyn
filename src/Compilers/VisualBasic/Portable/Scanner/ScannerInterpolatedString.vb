...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    Partial Friend Class Scanner
        ...
        Private Function ScanInterpolatedStringPunctuation() As SyntaxToken
            ...
            If Not AreCharsUpto(offset) Then
                Return MakeEndOfInterpolatedStringToken()
            End If
            ...
            Debug.Assert(Not AreCharsUpto(1) OrElse Peek(offset + 1) <> c OrElse IsRightCurlyBracket(c), "Escape sequence not detected.")
            ...
            Select Case c
                Case "$"c, FULLWIDTH_DOLLAR_SIGN
                    ...
                    If AreCharsUpto(offset + 1) AndAlso IsDoubleQuote(Peek(offset + 1)) Then
                ...
                Case Else
                    ...
                    If IsDoubleQuote(c) Then
                        Debug.Assert(Not AreCharsUpto(offset + 1) OrElse Not IsDoubleQuote(Peek(offset + 1)))
        ...
        Private Function IsInterpolatedStringPunctuation(Optional offset As Integer = 0) As Boolean
            If Not AreCharsUpto(offset) Then Return False

            Dim c = Peek(offset)

            If IsLeftCurlyBracket(c) Then
                Return Not AreCharsUpto(offset + 1) OrElse Not IsLeftCurlyBracket(Peek(offset + 1))

            ElseIf IsRightCurlyBracket(c) Then
                Return Not AreCharsUpto(offset + 1) OrElse Not IsRightCurlyBracket(Peek(offset + 1))
            ...
            ElseIf IsDoubleQuote(c)
                ...
                Return Not AreCharsUpto(offset + 1) OrElse Not IsDoubleQuote(Peek(offset + 1))
        ...
        Private Function ScanInterpolatedStringText(scanTrailingWhitespaceAsTrivia As Boolean) As SyntaxToken
            ...
            Do While AreCharsUpto(offset)
                ...
                If IsLeftCurlyBracket(c) Then
                    ...
                    If AreCharsUpto(offset + 1) AndAlso IsLeftCurlyBracket(Peek(offset + 1)) Then
                ...
                ElseIf IsRightCurlyBracket(c) Then
                    ...
                    If AreCharsUpto(offset + 1) AndAlso IsRightCurlyBracket(Peek(offset + 1)) Then
                        ' This is an escape sequence.
