...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  Partial Friend Class Scanner
    ...
    Private ReadOnly Property ShouldReportXmlError As Boolean
      Get
        Return Not Me._IsScanningXmlDoc OrElse Me._options.DocumentationMode = DocumentationMode.Diagnose
      End Get
    End Property
...
ScanChars:
    ...
    Friend Function ScanXmlPIDataInXmlDoc(state As ScannerState) As SyntaxToken
      ...
      Debug.Assert(state = ScannerState.StartProcessingInstruction OrElse state = ScannerState.ProcessingInstruction)
