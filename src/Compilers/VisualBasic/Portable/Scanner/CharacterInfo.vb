...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Module CharExts
        ...
        Friend Function IsFrom(c As Char, c0 As Char, c1 As Char) As Boolean
            Return (c = c0) OrElse (c = c1)
        End Function

        <Runtime.CompilerServices.Extension>
        Friend Function IsFrom(c As Char, c0 As Char, c1 As Char, c2 As Char) As Boolean
            Return (c = c0) OrElse (c = c1) OrElse (c = c2)
        End Function

        <Runtime.CompilerServices.Extension>
        Friend Function IsFrom(c As Char, c0 As Char, c1 As Char, c2 As Char, c3 As Char) As Boolean
