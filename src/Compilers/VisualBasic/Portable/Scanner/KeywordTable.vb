  ...
  Friend Class KeywordTable
    ...
    Shared Sub New()
      ...
      For i As Integer = 0 To keywordInitData.Length - 1 Step 2
        ...
        AddKeyword(   Token:= DirectCast(keywordInitData(i), SyntaxKind),
    ...
    Public Structure KeywordDescription
      ...
      Public Sub New ( New7To8 As Boolean, Precedence As OperatorPrecedence, isQueryClause As Boolean, canFollowExpr As Boolean)
    ...
    Private Shared Function EnsureHalfWidth(s As String) As String
      ...
      If result IsNot Nothing Then Return New String(result)
      Return s
    End Function

    Friend Shared Function CanFollowExpression(kind As SyntaxKind) As Boolean
      Dim description As KeywordDescription = Nothing
      If (_KeywordProperties.TryGetValue(kind, description)) Then Return description.kdCanFollowExpr
      Return False
    End Function
