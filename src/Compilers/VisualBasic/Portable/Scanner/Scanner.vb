...
FullWidthRepeat2:
            ...
            If UnderscoreUsed Then
                result = FeatureCheck.CheckFeatureAvailability(result, Feature.DigitSeparators, Me.Options)
            End If
            If Base = LiteralBase.Binary Then
                result = FeatureCheck.CheckFeatureAvailability(result, Feature.BinaryLiterals, Me.Options)
            End If
        ...
        Private Function ScanDateLiteral(precedingTrivia As SyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
            ...
            If Not DateIsInvalid Then
                ...
                If yearIsFirst Then
                    result = FeatureCheck.CheckFeatureAvailability(Feature.YearFirstDateLiterals, result, Options.LanguageVersion)
                End If
        ...
        Private Function ScanStringLiteral(precedingTrivia As SyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
            ...
            While CanGet(length)
                ...
                If IsDoubleQuote(ch) Then
                    ...
                    If haveNewLine Then
                        result = FeatureCheck.CheckFeatureAvailability(Feature.MultilineStringLiterals, result, Options.LanguageVersion)
                    End If
