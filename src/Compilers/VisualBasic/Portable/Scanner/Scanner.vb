...
FullWidthRepeat2:
            ...
            ElseIf LeadingUnderscoreUsed Then
                result = result.CheckFeatureAvailability(Feature.LeadingDigitSeparator, Me.Options)
            ElseIf UnderscoreUsed Then
                result = result.CheckFeatureAvailability(Feature.DigitSeparators, Me.Options)
            End If

            If Base = LiteralBase.Binary Then
                result = result.CheckFeatureAvailability(Feature.BinaryLiterals, Me.Options)
            End If
        ...
        Private Function ScanDateLiteral(precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
            ...
            If Not DateIsInvalid Then
                ...
                If yearIsFirst Then
                    result = result.CheckFeatureAvailability(Feature.YearFirstDateLiterals, Me.Options)
                End If
        ...
        Private Function ScanStringLiteral(precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
            ...
            While CanGet(length)
                ...
                If IsDoubleQuote(ch) Then
                    ...
                    If haveNewLine Then
                        result = result.CheckFeatureAvailability(Feature.MultilineStringLiterals, Me.Options)
                    End If
