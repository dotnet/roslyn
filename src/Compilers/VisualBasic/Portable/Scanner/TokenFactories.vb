...
#Region "WhiteSpaceList"
        ...
        Private Shared ReadOnly s_wsListKeyHasher As Func(Of CommonSyntaxListBuilder, Integer) =
            Function(builder)
                Dim code = 0
        ...
        Private Shared ReadOnly s_wsListKeyEquality As Func(Of CommonSyntaxListBuilder, CommonSyntaxList(Of VisualBasicSyntaxNode), Boolean) =
        ...
        Private Shared ReadOnly s_wsListFactory As Func(Of CommonSyntaxListBuilder, CommonSyntaxList(Of VisualBasicSyntaxNode)) =
            Function(builder)
...
#Region "Tokens"
        ...
        Private Structure TokenParts
            ...
            Friend Sub New(pTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), fTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), spelling As String)
                Me.spelling = spelling
...
#End Region
        ...
        Private Shared Function CanCache(trivia As CommonSyntaxListBuilder) As Boolean
...
#Region "Trivia"
        ...
        Friend Function MakeTriviaArray(builder As CommonSyntaxListBuilder) As CommonSyntaxList(Of VisualBasicSyntaxNode)
            If builder.Count = 0 Then
                Return Nothing
            End If
            Dim foundTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode) = Nothing
...
#Region "Identifiers"
        Private Function MakeIdentifier(spelling As String,
                                       ...
                                       leadingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode)) As IdentifierTokenSyntax
        ...
        Private Function MakeIdentifier(spelling As String,
                               ...
                               BaseSpelling As String,
                               TypeCharacter As TypeCharacter,
                               precedingTrivia As CommonSyntaxList(Of GreenNode),
                               followingTrivia As CommonSyntaxList(Of GreenNode)) As IdentifierTokenSyntax
...
#Region "Keywords"
        ...
        Private Function MakeKeyword(tokenType As SyntaxKind,
                                     spelling As String,
                                     precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode)) As KeywordSyntax
        ...
        Private Function MakeKeyword(tokenType As SyntaxKind,
                              spelling As String,
                              precedingTrivia As CommonSyntaxList(Of GreenNode),
                              followingTrivia As CommonSyntaxList(Of GreenNode)) As KeywordSyntax
...
#Region "Punctuation"
        Friend Function MakePunctuationToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode),
                                              spelling As String,
        ...
        Private Function MakePunctuationToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode),
                                              length As Integer,
                                              kind As SyntaxKind) As PunctuationSyntax
        ...
        Friend Function MakePunctuationToken(kind As SyntaxKind,
                                      spelling As String,
                                      precedingTrivia As CommonSyntaxList(Of GreenNode),
                                      followingTrivia As CommonSyntaxList(Of GreenNode)
        ...
        Private Function MakeOpenParenToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeCloseParenToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeDotToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeCommaToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeHashToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeAmpersandToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeOpenBraceToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeCloseBraceToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeColonToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeEmptyToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode)) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, "", SyntaxKind.EmptyToken)
        End Function

        Private Function MakePlusToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeMinusToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeAsteriskToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeSlashToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeBackslashToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeCaretToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeExclamationToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeQuestionToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeGreaterThanToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeLessThanToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
        ...
        Private Function MakeStatementTerminatorToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), width As Integer) As PunctuationSyntax
        ...
        Private Function MakeAmpersandEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.AmpersandEqualsToken)
        End Function

        Private Function MakeColonEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.ColonEqualsToken)
        End Function

        Private Function MakePlusEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.PlusEqualsToken)
        End Function

        Private Function MakeMinusEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.MinusEqualsToken)
        End Function

        Private Function MakeAsteriskEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.AsteriskEqualsToken)
        End Function

        Private Function MakeSlashEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.SlashEqualsToken)
        End Function

        Private Function MakeBackSlashEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.BackslashEqualsToken)
        End Function

        Private Function MakeCaretEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.CaretEqualsToken)
        End Function

        Private Function MakeGreaterThanEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.GreaterThanEqualsToken)
        End Function

        Private Function MakeLessThanEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.LessThanEqualsToken)
        End Function

        Private Function MakeLessThanGreaterThanToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.LessThanGreaterThanToken)
        End Function

        Private Function MakeLessThanLessThanToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.LessThanLessThanToken)
        End Function

        Private Function MakeGreaterThanGreaterThanToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.GreaterThanGreaterThanToken)
        End Function

        Private Function MakeLessThanLessThanEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.LessThanLessThanEqualsToken)
        End Function

        Private Function MakeGreaterThanGreaterThanEqualsToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer) As PunctuationSyntax
            Return MakePunctuationToken(precedingTrivia, length, SyntaxKind.GreaterThanGreaterThanEqualsToken)
        End Function

        Private Function MakeAtToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), charIsFullWidth As Boolean) As PunctuationSyntax
...
#Region "Literals"
        Private Function MakeIntegerLiteralToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode),
                                         base As LiteralBase,
                                         typeCharacter As TypeCharacter,
        ...
        Private Function MakeCharacterLiteralToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), value As Char, length As Integer) As SyntaxToken
            Dim spelling = GetText(length)
            Dim followingTrivia = ScanSingleLineTrivia()
        ...
        Private Function MakeDateLiteralToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), value As DateTime, length As Integer) As SyntaxToken
            Dim spelling = GetText(length)
            Dim followingTrivia = ScanSingleLineTrivia()
        ...
        Private Function MakeFloatingLiteralToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode),
                                         typeCharacter As TypeCharacter,
        ...
        Private Function MakeDecimalLiteralToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode),
                                 typeCharacter As TypeCharacter,
...
#End Region
        ...
        Private Function MakeBadToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode), length As Integer, errId As ERRID) As SyntaxToken
        ...
        Private Shared Function MakeEofToken(precedingTrivia As CommonSyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
