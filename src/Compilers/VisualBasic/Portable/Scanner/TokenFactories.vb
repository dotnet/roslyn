...
#Region "Identifiers"
    ...
    Friend Function MakeIdentifier ( keyword As KeywordSyntax ) As IdentifierTokenSyntax
      Return MakeIdentifier( keyword.Text, keyword.Kind, False, keyword.Text, TypeCharacter.None,
                             keyword.GetLeadingTrivia, keyword.GetTrailingTrivia )
    End Function
    ...
    Private Function MakeIdentifier ( spelling        As String,
      ...
      If contextualKind <> SyntaxKind.IdentifierToken OrElse
          isBracketed = True OrElse TypeCharacter <> TypeCharacter.None Then
...
#Region "Keywords"
    ...
    Friend Function MakeKeyword ( id As IdentifierTokenSyntax ) As KeywordSyntax
      Debug.Assert((id.PossibleKeywordKind <> SyntaxKind.IdentifierToken) AndAlso Not id.IsBracketed AndAlso
