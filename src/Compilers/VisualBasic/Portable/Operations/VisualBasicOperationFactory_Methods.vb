...
#Region "Conversions"
        ...
        Private Shared Function CreateConversion(expression As BoundExpression) As Conversion
            If expression.Kind = BoundKind.Conversion Then
                ...
                If (conversionKind And VisualBasic.ConversionKind.UserDefined) = VisualBasic.ConversionKind.UserDefined AndAlso conversion.Operand.Kind = BoundKind.UserDefinedConversion Then
