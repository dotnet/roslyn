...
#Enable Warning RS0026 ' Do not add multiple overloads with optional parameters
        ...
        Private Sub New(
            ...
            MyBase.New(
                ...
                warningLevel:=1,
                specificDiagnosticOptions:=specificDiagnosticOptions.ToImmutableDictionaryOrEmpty(StringComparers.IdentifierComparer), ' Diagnostic ids must be processed in case-insensitive fashion.
        ...
        Public Overrides Function GetHashCode() As Integer
            Return Hash.Combine(MyBase.GetHashCodeHelper(),
                   ...
                   Hash.Combine(If(Me.RootNamespace IsNot Nothing, StringComparers.IdentifierComparer.GetHashCode(Me.RootNamespace), 0),
