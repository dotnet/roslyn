...
Partial Class AnonymousTypeManager
    Partial Class AnonymousTypePropertyPublicSymbol
        ...
        Public Overrides Function GetCurrentLocation(slot As Integer, index As Integer) As Location
            Return SymbolLocationHelper.Single.GetCurrentLocation(slot, index, Me._container.TypeDescriptor.Fields(Me.PropertyIndex).Location)
        End Function
