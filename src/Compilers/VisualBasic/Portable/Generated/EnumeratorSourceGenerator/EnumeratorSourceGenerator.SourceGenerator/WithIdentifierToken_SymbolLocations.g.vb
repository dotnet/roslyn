...
Partial Class RangeVariableSymbol
    Partial Class WithIdentifierToken
        ...
        Public Overrides Function GetCurrentLocation(slot As Integer, index As Integer) As Location
            Return SymbolLocationHelper.Single.GetCurrentLocation(slot, index, _identifierToken.GetLocation())
        End Function
