...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Friend NotInheritable Class SpecializedFieldReference
        ...
        Private Function IFieldReferenceGetType(context As EmitContext) As Cci.ITypeReference Implements Cci.IFieldReference.GetType
            ...
            Dim type = DirectCast(context.Module, PEModuleBuilder).Translate(_underlyingField.Type, syntaxNodeOpt:=DirectCast(context.SyntaxReference?.GetSyntax(), VisualBasicSyntaxNode), diagnostics:=context.Diagnostics)
