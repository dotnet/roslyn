...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Friend NotInheritable Class PEDeltaAssemblyBuilder
        ...
        Public Sub New(sourceAssembly As SourceAssemblySymbol,
            ...
            Dim assemblyRefMap = initialBaseline.LazyMetadataSymbols.AssemblyReferenceIdentityMap

            Dim matchToMetadata = New VisualBasicSymbolMatcher(initialBaseline.LazyMetadataSymbols.AnonymousTypes, assemblyRefMap, sourceAssembly, context, metadataAssembly)
