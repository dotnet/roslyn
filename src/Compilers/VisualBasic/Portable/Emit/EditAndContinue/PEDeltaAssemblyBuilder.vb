...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Friend NotInheritable Class PEDeltaAssemblyBuilder
        ...
        Public Sub New(sourceAssembly As SourceAssemblySymbol,
            ...
            Dim context = New EmitContext(Me, Nothing, Nothing, New DiagnosticBag(), metadataOnly:=False, includePrivateMembers:=True)
            ...
            If previousGeneration.Ordinal > 0 Then
                ...
                Dim previousContext = New EmitContext(DirectCast(previousGeneration.PEModuleBuilder, PEModuleBuilder), Nothing, Nothing, New DiagnosticBag(), metadataOnly:=False, includePrivateMembers:=True)
