...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Friend Module EmitHelpers
        ...
        Friend Function MapToCompilation(
            ...
            Dim sourceContext = New EmitContext(DirectCast(previousGeneration.PEModuleBuilder, PEModuleBuilder), Nothing, Nothing, New DiagnosticBag(), metadataOnly:=False, includePrivateMembers:=True)
            Dim otherContext = New EmitContext(moduleBeingBuilt, Nothing, Nothing, New DiagnosticBag(), metadataOnly:=False, includePrivateMembers:=True)
