...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Partial Friend Class VisualBasicCustomModifier
        ...
        Private Function CciGetModifier(context As EmitContext) As Cci.ITypeReference Implements Cci.ICustomModifier.GetModifier
            Return DirectCast(context.Module, PEModuleBuilder).Translate(Me.ModifierSymbol, DirectCast(context.SyntaxReference?.GetSyntax(), VisualBasicSyntaxNode), context.Diagnostics)
        End Function
    End Class
End Namespace
