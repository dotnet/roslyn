...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Partial Friend Class SymbolDisplayVisitor
        ...
        Private Sub AddNestedTypeSeparator()
            If (Format.CompilerInternalOptions And SymbolDisplayCompilerInternalOptions.UsePlusForNestedTypes) = SymbolDisplayCompilerInternalOptions.UsePlusForNestedTypes Then
