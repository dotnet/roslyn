    ...
    Partial Friend Class SymbolDisplayVisitor
        ...
        Private Shared Function AlwaysEscape(kind As SymbolDisplayPartKind, text As String) As Boolean
            If kind <> SymbolDisplayPartKind.Keyword Then
                ...
                If StringComparers.IdentifierComparer.Equals(SyntaxFacts.GetText(SyntaxKind.REMKeyword), text) OrElse
                   StringComparers.IdentifierComparer.Equals(SyntaxFacts.GetText(SyntaxKind.NewKeyword), text) Then
                    Return True
                End If
            End If
