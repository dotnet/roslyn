...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Friend Partial Class Parser
        ...
        Private Function ParseSelectList() As CommonSeparatedSyntaxList(Of ExpressionRangeVariableSyntax)
        ...
        Private Function ParseAggregateList(
            ...
            IsGroupJoinProjection As Boolean) As CommonSeparatedSyntaxList(Of AggregationRangeVariableSyntax)
        ...
        Private Function ParseLetList() As CommonSeparatedSyntaxList(Of ExpressionRangeVariableSyntax)
        ...
        Private Function ParseFromControlVars() As CommonSeparatedSyntaxList(Of CollectionRangeVariableSyntax)
        ...
        Private Function ParseGroupByExpression(groupKw As KeywordSyntax) As GroupByClauseSyntax
            ...
            Dim elements As CommonSeparatedSyntaxList(Of ExpressionRangeVariableSyntax) = Nothing
            ...
            Dim keys As CommonSeparatedSyntaxList(Of ExpressionRangeVariableSyntax) = Nothing
            ...
            Dim Aggregation As CommonSeparatedSyntaxList(Of AggregationRangeVariableSyntax) = Nothing
        ...
        Private Function MissingAggregationRangeVariables() As CommonSeparatedSyntaxList(Of AggregationRangeVariableSyntax)
            Dim rangeVariables = Me._pool.AllocateSeparated(Of AggregationRangeVariableSyntax)()
            ...
            Dim result As CommonSeparatedSyntaxList(Of AggregationRangeVariableSyntax) = rangeVariables.ToList
            Me._pool.Free(rangeVariables)
            Return result
        End Function
        ...
        Private Function ParseInnerJoinOrGroupJoinExpression(groupKw As KeywordSyntax,
            ...
            Dim Predicate As CommonSeparatedSyntaxList(Of JoinConditionSyntax) = Nothing
            ...
            Else
                ...
                Predicate = New CommonSeparatedSyntaxList(Of JoinConditionSyntax)(missingEq)
            End If

            Dim joinVarList = New CommonSeparatedSyntaxList(Of CollectionRangeVariableSyntax)(joinVariable)
        ...
        Private Function ParseJoinPredicateExpression() As CommonSeparatedSyntaxList(Of JoinConditionSyntax)
            ...
            If result.Node.ContainsDiagnostics Then
                ...
                result = New CommonSeparatedSyntaxList(Of JoinConditionSyntax)(New CommonSyntaxList(Of JoinConditionSyntax)(elements))
            End If
        ...
        Private Function ParseOrderByList() As CommonSeparatedSyntaxList(Of OrderingSyntax)
        ...
        Private Sub ParseMoreQueryOperators(ByRef operators As CommonSyntaxListBuilder(Of QueryClauseSyntax))
            Do
                ' // try to recover
        ...
        Private Function ParseAggregateClause(AggregateKw As KeywordSyntax) As AggregateClauseSyntax
            ...
            Dim intoKw As KeywordSyntax = Nothing
            Dim variables As CommonSeparatedSyntaxList(Of AggregationRangeVariableSyntax) = Nothing
            If TryEatNewLineAndGetContextualKeyword(SyntaxKind.IntoKeyword, intoKw, createIfMissing:=True) Then
