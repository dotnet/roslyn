...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Class TypeUnification
        ...
        Public Shared Function CanUnify(containingGenericType As NamedTypeSymbol, t1 As TypeSymbol, t2 As TypeSymbol) As Boolean
            ...
            If TypeSymbol.Equals(t1, t2, TypeCompareKind.ConsiderEverything2) Then
                Return True
            End If
            ...
            Select Case t1.Type.Kind
                ...
                Case SymbolKind.NamedType, SymbolKind.ErrorType
                    ...
                    If Not nt1.IsGenericType Then
                        Return Not nt2.IsGenericType AndAlso TypeSymbol.Equals(nt1, nt2, TypeCompareKind.ConsiderEverything2)
                    ElseIf Not nt2.IsGenericType Then
                        Return False
                    End If

                    Dim arity As Integer = nt1.Arity
                    If nt2.Arity <> arity OrElse Not TypeSymbol.Equals(nt2.OriginalDefinition, nt1.OriginalDefinition, TypeCompareKind.ConsiderEverything2) Then
                        Return False
                    End If
