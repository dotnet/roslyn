            ...
            Select Case node.Kind()
                ...
                Case Else
                    ...
                    If methodBlock IsNot Nothing Then
                        Dim paramInitializers = GetParameterInitializers(methodBlock.Begin.ParameterList)
                        Dim codeBlocks = paramInitializers.Concat(methodBlock.Statements).Concat(methodBlock.End)
                        builder.Add(GetDeclarationInfo(model, node, getSymbol, codeBlocks, cancellationToken))
                        Return
                    End If
