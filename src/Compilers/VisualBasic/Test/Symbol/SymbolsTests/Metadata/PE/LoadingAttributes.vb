...
End Class
            ...
            Dim builder = GetDefaultPEBuilder(c1)
            ...
            Assert.Equal("System.Runtime.CompilerServices.DateTimeConstantAttribute(634925952000000000)", d2.GetCustomAttributesToEmit(builder).Single().ToString())
