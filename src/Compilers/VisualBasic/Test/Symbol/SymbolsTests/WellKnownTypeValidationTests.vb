            ...
            For Each wkm As WellKnownMember In [Enum].GetValues(GetType(WellKnownMember))
                Select Case wkm
                    ...
                    Case WellKnownMember.System_Array__Empty,
                         ...
                         WellKnownMember.System_String__Concat_2ReadOnlySpans,
                         WellKnownMember.System_String__Concat_3ReadOnlySpans,
                         WellKnownMember.System_String__Concat_4ReadOnlySpans,
