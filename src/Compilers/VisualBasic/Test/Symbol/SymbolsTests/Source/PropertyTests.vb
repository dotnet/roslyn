...
BC30643: Property 'A.R(val As Integer, Param As Integer)' is of an unsupported type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528159")>
        <Fact()>
...
BC30643: Property 'A.P' is of an unsupported type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528160")>
        <Fact()>
...
#Region "Code Gen"
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539893")>
        <Fact()>
...
23
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542749")>
        <Fact>
...
BC30057: Too many arguments to 'Public Overloads ReadOnly Default Property F(o As Object) As Object'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529554")>
        <Fact()>
...
BC30057: Too many arguments to 'Public Overloads ReadOnly Default Property F(o As Object) As Object'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529553")>
        <Fact()>
...
BC31048: Properties with no required parameters cannot be declared 'Default'.
    Default ReadOnly Property P()
        ...
        ''' </summary>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531372")>
        <Fact()>
...
BC30057: Too many arguments to 'Public Function ElementAtOrDefault() As B'.
        ...
        ''' </summary>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531372")>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/575547")>
...
BC30057: Too many arguments to 'D'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/578180")>
        <Fact()>
...
BC30547: 'U' cannot be indexed because it has no default property.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539951")>
        <Fact>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539957")>
        <Fact>
...
BC30524: Property 'Goo' is 'WriteOnly'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539903")>
        <Fact>
...
#Region "Properties member access"
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539962")>
        <Fact>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528038")>
        <Fact()>
...
BC30456: 'get_Goo' is not a member of 'A'.
        ...
        <WorkItem("https://devdiv.visualstudio.com/defaultcollection/DevDiv/_workitems#_a=edit&id=99292")>
        <Fact>
...
End Class
  ...
  IL_001a:  ret       
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528542")>
        <Fact()>
...
#End Region
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540343")>
        <Fact>
...
End Interface
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544315")>
...
End Class
        ...
        ''' </summary>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545814")>
        <Fact()>
...
BC30643: Property 'A.Q(o As Object, v As Object)' is of an unsupported type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545959")>
        <Fact()>
...
BC30455: Argument not specified for parameter 'y' of 'Public MustOverride Overrides Property Q(x As Integer, y As Integer) As Integer'.
        ...
        ''' </summary>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546476")>
        <Fact()>
...
BC30002: Type 'System.Object' is not defined.
    WriteOnly Property Q As Object
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530418")>
        <WorkItem("https://devdiv.visualstudio.com/defaultcollection/DevDiv/_workitems#_a=edit&id=101153")>
        <Fact>
...
BC30002: Type 'System.Object' is not defined.
    Property P As Object
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531292")>
        <Fact()>
        Public Sub Bug17897()
            Dim compilation = CompilationUtils.CreateCompilationWithMscorlib40AndVBRuntime(
<compilation>
