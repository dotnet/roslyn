...
<Module: CLSCompliant(True)>
            ...
            CompileAndVerify(source, options:=TestOptions.ReleaseModule, sourceSymbolValidator:=validator(True, True), symbolValidator:=validator(False, True), verify:=Verification.Skipped) ' PEVerify doesn't like netmodules
        End Sub
