...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests
    ...
    Public Class SourceSymbolTests
        ...
        Public Sub NamespaceWithoutName()
            ...
            Dim nsArray = tree.GetRoot().DescendantNodes().Where(Function(node) (node.IsKind(SyntaxKind.NamespaceStatement))).ToArray()
...
End Module
            ...
            Dim list = tree.GetRoot().DescendantNodes().Where(Function(n) (n.IsKind(SyntaxKind.ForStatement))).ToArray()
