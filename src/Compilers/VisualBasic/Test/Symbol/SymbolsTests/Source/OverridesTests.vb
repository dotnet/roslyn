...
void ValidatorBase<T>.DoValidate(T objectToValidate)")
        ...
        <Fact>
        Public Sub OverrideOfCSharpCovariantReturn_01()
            Dim csSource = <![CDATA[
public class Base
{
...
BC30437: 'Public Overrides ReadOnly Default Property Item(i As Integer) As Object' cannot override 'Public Overridable Overloads ReadOnly Default Property Item(i As Integer) As String' because they differ by their return types.
    Public Overrides Default ReadOnly Property Item(i As Integer) As Object
        ...
        <Fact>
        Public Sub OverrideOfCSharpCovariantReturn_02()
            Dim csSource = <![CDATA[
public class Base
{
    public virtual object M() => null;
            ...
            <![CDATA[
{
  ...
  IL_000b:  pop
  IL_000c:  ldarg.0
  IL_000d:  callvirt   "Function Base.get_P() As Object"
  IL_0012:  call       "Function System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(Object) As Object"
  IL_0017:  pop
  IL_0018:  ldarg.0
  IL_0019:  ldc.i4.0
  IL_001a:  callvirt   "Function Base.get_Item(Integer) As Object"
  IL_001f:  call       "Function System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(Object) As Object"
  IL_0024:  pop
  IL_0025:  ldarg.1
  IL_0026:  callvirt   "Function Derived.M() As String"
  IL_002b:  pop
  IL_002c:  ldarg.1
  IL_002d:  callvirt   "Function Derived.get_P() As String"
  IL_0032:  pop
  IL_0033:  ldarg.1
  IL_0034:  ldc.i4.0
  IL_0035:  callvirt   "Function Derived.get_Item(Integer) As String"
  IL_003a:  pop
  IL_003b:  ldarg.2
  IL_003c:  callvirt   "Function Derived2.M() As String"
  IL_0041:  pop
  IL_0042:  ldarg.2
  IL_0043:  callvirt   "Function Derived2.get_P() As String"
  IL_0048:  pop
  IL_0049:  ldarg.2
  IL_004a:  ldc.i4.0
  IL_004b:  callvirt   "Function Derived2.get_Item(Integer) As String"
  IL_0050:  pop
  IL_0051:  ret
}
]]>)
