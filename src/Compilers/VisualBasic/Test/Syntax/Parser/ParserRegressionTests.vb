...
Namespace Global.Microsoft.CodeAnalysis.VisualBasic.UnitTests
    ...
    MustInherit Class B(Of T)"
            ...
            <Fact>
            Public Sub VB000147()
                Dim text = "    Sub Overloads  Method1a * )
     Binary  Sub
...
"
            ...
            <Fact>
            Public Sub VB000211()
                Dim text = "        Dim s As Object = Function(x <[CDATA[   [And]  + 1 '=>
End  ' 
#End Region
"
                VisualBasicSyntaxTree.ParseText(text)
...
"
            ...
            <Fact>
            Public Sub VB001507()
                Dim text = "Function  [For]  << ) As  SByte 
         Option 
...
"
            ...
            <Fact>
            Public Sub VB001690()
                Dim text = "Function RunTests( !   Interface  Integer [SyncLock] 
	 By   Function 
...
"
            ...
            <Fact>
            Public Sub VB001874()
                Dim text = "   Function MyClass  Foo(ByVal  [Preserve]  As  [Protected]  /=  For  T [CStr] ) :  As  Enum 
     Call  Function
     MustInherit   Enum 
...
"
            ...
            <Fact>
            Public Sub VB003108()
                Dim text = "Function RunTests </ ) As Integer Char 
...
"
            ...
            Public Sub VB003108_minimal()
                Dim text = "Function RunTests As Integer
if true then Event
"
                VisualBasicSyntaxTree.ParseText(text)
            End Sub
...
"
    ...
    MustInherit Class B(Of T)"
            ...
            <Fact>
            Public Sub VB004298()
                Dim text = "If Sub  (  [Option]  & AnonymousType <>  WriteOnly  @   Overloads 
    MustInherit Class B(Of T)
"
                VisualBasicSyntaxTree.ParseText(text)
            End Sub
            ...
            <Fact>
            Public Sub VB004742()
                Dim text = "        Function Overridable  SelectionMethods "" )  When  Integer
...
"
            ...
            <Fact>
            Public Sub VB010019()
                Dim text = "             Sub  Case x. Select  [UShort] 
...
"
            ...
            <Fact>
            Public Sub VB013380()
                Dim text = "        Function Operators As () As [Or]  Integer
            If ( [Mod]  Or
            Return  [Iterator] 
         Type  Function
...
"
            ...
            <Fact>
            Public Sub VB029482()
                Dim text = "Dim  [Each]  =  <[CDATA[ 1, Select 
                    #  ]
"
                VisualBasicSyntaxTree.ParseText(text)
            End Sub
            ...
            <Fact>
            Public Sub VB038799()
                Dim text = "        Public Sub Declare  Dispose [By]  (  <[CDATA[  Implements IDisposable.Dispose
            If  <[CDATA[ aa < 10)  Long 
                Return  Sub 
         EndIf   Explicit 
...
"
            ...
            Public Sub VB030545_02()
                Dim text = "        Function =   [IsFalse]  \=  &=   Equals  Integer
         Assembly  Function
            Private  Set 
"
                VisualBasicSyntaxTree.ParseText(text)
            ...
            <Fact>
            Public Sub VB016274()
                Dim text = "        Function LoopingMethod( @ ) As Integer
            While  [As]  <= 100 [Into] 
         Ascending  Function
 Wend  Class
            If  [Overloads]   xml "
...
"
            ...
            <Fact>
            Public Sub VB025825()
                Dim text = "        Function [Interface]  Operators( [TryCast]  <?  As Integer
            If CSByte  ( [End]  Or
            Return 0
...
"
            ...
            <Fact>
            Public Sub VB069460()
                Dim text = "sub Main Byte  ]]&lt; )
     Assembly  Function
 MustInherit  Class Bar Iterator "
                VisualBasicSyntaxTree.ParseText(text)
            End Sub
            ...
            <Fact>
            Public Sub VB101269()
                Dim text = "        Function  [CLng] ()  CULng  Integer As 
            If icount [End]   ;  1  Xor 
         Me  Function
...
"
            ...
            <Fact>
            Public Sub VB070370()
                Dim text = "             Sub  Pclass [GetXmlNamespace]  As [Const]  New ClsPPMTest003
...
"
            ...
            <Fact>
            Public Sub VB075281()
                Dim text = "    Sub Method1a Mod  "" )
                    If y [When]   &=   [Then]   >>  10 Then Inherits 
                     Join  If Xor 
                 CULng  Function
         End If [Call] ( {  =  . ""Beverages"" <   [Ascending]  {   GoTo , [CObj]  ""Dairy Products"", ""Seafood"" - 
...
"
            ...
            <Fact>
            Public Sub VB087373()
                Dim text = " Function RunTests </  <<=  As  False 
	 Try   [Erase] 
...
"
            ...
            Public Sub VB087373_minimal()
                Dim text = " Function RunTests() As Boolean
	 Try 
If true then
	 where sub
	 Else   Finally 
...
"
            ...
            <Fact>
            Public Sub VB087839()
                Dim text = "    Friend Function  [Date] ( Or ByVal i As (  Integer) As  Take 
            retVal  <--  1
        Else ; 
...
"
            ...
            Public Sub VB087839_02()
                Dim text = "             Operator  icount [As]   }  1 Then
...
"
            ...
            <Fact>
            Public Sub VB074167()
                Dim text = "Function RunTests >>=  &   Enum  Integer
...
"
            ...
            <Fact>
            Public Sub VB137731()
                Dim text = "    Function  [Unicode]  <<= ) As Integer
     Call  Function
 Custom   Overloads 
...
"
            ...
            Public Sub VB121067_02()
                Dim text = "             Operator  a And MustInherit 
...
"
            ...
            <Fact>
            Public Sub VB142448()
                Dim text = "     Public  [Key]  = Function( CULng  [RaiseEvent]  As  Let  {  As <<=  Boolean
...
"
            ...
            <Fact>
            Public Sub VB138211()
                Dim text = "        Function [On]  Operators &  =  As Integer [ByVal] 
            If  Me  a  IsNot 
             If   Function 
...
"
            ...
            Public Sub CaseStatementOutsideMethodBody()
                Dim text = "        Dim number As Integer = 8
Select Case number
    Case 1 To 5
    ...
    <errors>
        ...
        <error id="30184"/>
            ...
            Public Sub TestBinary()
                ...
                Assert.Equal(VisualBasic.Syntax.InternalSyntax.Scanner.BadTokenCountLimit, tree.GetDiagnostics().Where(Function(d) d.Code = ERRID.ERR_IllegalChar).Count())
            End Sub
