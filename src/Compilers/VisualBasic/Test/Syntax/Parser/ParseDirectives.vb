...
End Module]]>,
    ...
    Public Sub ParseWarningDirective_LineContinuation2V16()
        ...
        Assert.True(tt(0).IsKind(SyntaxKind.WhitespaceTrivia))
        Assert.True(tt(1).IsKind(SyntaxKind.LineContinuationTrivia))
        Assert.True(tt(2).IsKind(SyntaxKind.WhitespaceTrivia))
        Assert.True(tt(3).IsKind(SyntaxKind.CommentTrivia))
        Assert.Equal(SyntaxKind.WarningKeyword, enableNode.WarningKeyword.Kind)
        Assert.False(enableNode.WarningKeyword.IsMissing)
        Assert.Empty(enableNode.ErrorCodes)
    End Sub
