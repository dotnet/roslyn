...
Dim q2 = From x In col let y = x Group x, y By"
    ...
    Public Sub IncParseExprLambdaInSubContext()
        Dim code As String = "Function() NewTextPI.UnwrapObject().FileCodeModel)
If True Then
End If
End Sub
...
"
    ...
    Public Sub IncParseLCFunctionCompoundAsn()
        Dim code As String = "Public Function foo() As String
...
End Class"
    ...
    Public Sub InsertSubBeforeCustomEvent()
        Dim code As String = "            Custom Event e As del
...
#End Region"
    ...
    Public Sub ParseEnumWithoutEnd()
        Dim code As String = "Public Class Class2
    Protected Enum e
        e1
        e2
	End Enum
...
End Class"
    ...
    Public Sub IncParseDoLoop()
        Dim code As String = "        Sub AnonTConStmnt()
                Do
                    i += 1
                Loop Until true
        End Sub
...
"
    ...
    Public Sub IncParseInvalidText()
        Dim code As String = "1. Verify that INT accepts an constant of each type as the
        '                  argument."
...
Module M
    ...
    Inherits Attribute
"
        Dim code1 As String = "    Property foo() A"
