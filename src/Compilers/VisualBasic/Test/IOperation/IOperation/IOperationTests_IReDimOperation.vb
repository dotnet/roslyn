...
Block[B6] - Exit
    ...
    Statements (0)
        ...
        <CompilerTrait(CompilerFeature.IOperation, CompilerFeature.Dataflow)>
        <Fact()>
        Public Sub ReDimStatement_ControlFlowInMultipleIndices()
            Dim source = <![CDATA[
Imports System
...
Block[B10] - Exit
    ...
    Statements (0)
        ...
        <CompilerTrait(CompilerFeature.IOperation, CompilerFeature.Dataflow)>
        <Fact()>
        Public Sub ReDimStatement_ControlFlowInOperandAndIndices()
            Dim source = <![CDATA[
Imports System
...
.locals {R1}
{
    ...
    Block[B5] - Block
        Predecessors: [B3] [B4]
        Statements (1)
            IReDimOperation (OperationKind.ReDim, Type: null) (Syntax: 'ReDim x1(If ... a2)), x2(b)')
              Clauses(2):
...
.locals {R1}
{
    ...
    Block[B5] - Block
        Predecessors: [B3] [B4]
        Statements (1)
            IReDimOperation (OperationKind.ReDim, Type: null) (Syntax: 'ReDim x1(b) ... If(a1, a2))')
              Clauses(2):
                  ...
                  IReDimClauseOperation (OperationKind.ReDimClause, Type: null) (Syntax: 'x2(If(a1, a2))')
                    Operand: 
                      IFlowCaptureReferenceOperation: 2 (OperationKind.FlowCaptureReference, Type: System.Int32(), IsImplicit) (Syntax: 'x2')
                    Indices(1):
                        IBinaryOperation (BinaryOperatorKind.Add, Checked) (OperationKind.BinaryOperator, Type: System.Int32, IsImplicit) (Syntax: 'If(a1, a2)')
                          Left: 
                            IFlowCaptureReferenceOperation: 4 (OperationKind.FlowCaptureReference, Type: System.Int32, IsImplicit) (Syntax: 'If(a1, a2)')
...
.locals {R1}
{
    ...
    Block[B6] - Block
        Predecessors: [B5]
        Statements (1)
            IFlowCaptureOperation: 4 (OperationKind.FlowCapture, Type: null, IsImplicit) (Syntax: 'x2')
              Value: 
                IParameterReferenceOperation: x2 (OperationKind.ParameterReference, Type: System.Int32()) (Syntax: 'x2')
    ...
    .locals {R4}
    {
        ...
        Block[B7] - Block
            ...
            Jump if True (Regular) to Block[B9]
                IIsNullOperation (OperationKind.IsNull, Type: System.Boolean, IsImplicit) (Syntax: 'b1')
                  Operand: 
                    IFlowCaptureReferenceOperation: 5 (OperationKind.FlowCaptureReference, Type: System.Nullable(Of System.Int32), IsImplicit) (Syntax: 'b1')
                Leaving: {R4}
    ...
    Block[B9] - Block
        Predecessors: [B7]
        Statements (1)
            IFlowCaptureOperation: 6 (OperationKind.FlowCapture, Type: null, IsImplicit) (Syntax: 'b2')
              Value: 
                IParameterReferenceOperation: b2 (OperationKind.ParameterReference, Type: System.Int32) (Syntax: 'b2')
    ...
    Block[B10] - Block
        Predecessors: [B8] [B9]
        Statements (1)
            IReDimOperation (OperationKind.ReDim, Type: null) (Syntax: 'ReDim x1(If ... If(b1, b2))')
              Clauses(2):
                  IReDimClauseOperation (OperationKind.ReDimClause, Type: null) (Syntax: 'x1(If(a1, a2))')
                    Operand: 
                      IFlowCaptureReferenceOperation: 0 (OperationKind.FlowCaptureReference, Type: System.Int32(), IsImplicit) (Syntax: 'x1')
                  ...
                  IReDimClauseOperation (OperationKind.ReDimClause, Type: null) (Syntax: 'x2(If(b1, b2))')
                    Operand: 
                      IFlowCaptureReferenceOperation: 4 (OperationKind.FlowCaptureReference, Type: System.Int32(), IsImplicit) (Syntax: 'x2')
                    Indices(1):
                        IBinaryOperation (BinaryOperatorKind.Add, Checked) (OperationKind.BinaryOperator, Type: System.Int32, IsImplicit) (Syntax: 'If(b1, b2)')
                          Left: 
                            IFlowCaptureReferenceOperation: 6 (OperationKind.FlowCaptureReference, Type: System.Int32, IsImplicit) (Syntax: 'If(b1, b2)')
                          Right: 
                            ILiteralOperation (OperationKind.Literal, Type: System.Int32, Constant: 1, IsImplicit) (Syntax: 'If(b1, b2)')
