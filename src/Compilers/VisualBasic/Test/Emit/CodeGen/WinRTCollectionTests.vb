...
End Class
            ...
            Dim add = tree.GetRoot().DescendantNodes().Where(Function(n) n.IsKind(SyntaxKind.IdentifierName) AndAlso DirectCast(n, IdentifierNameSyntax).Identifier.ValueText = "Add").Single()
