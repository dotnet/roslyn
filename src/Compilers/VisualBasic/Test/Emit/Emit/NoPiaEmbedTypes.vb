...
BC35000: Requested operation is not available because the runtime library function 'System.Runtime.InteropServices.ComAwareEventInfo..ctor' is not defined.
        ...
        <Fact()>
        Public Sub DefaultValueWithoutOptional_01a()
            Dim sources1 = <![CDATA[
    ...
    End Class
            ...
            CompileAndVerify(sources2, additionalRefs:={reference1}, symbolValidator:=
                                                Sub([module] As ModuleSymbol)
                                                    ...
                                                    Assert.Equal(CObj(&HC), p.ExplicitDefaultConstantValue.Value)
        ...
        Public Sub DefaultValueWithoutOptional_01b()
            Assert.True(MyParseOptions.HasFeature(InternalSyntax.Feature.ImplicitDefaultValueOnOptionalParameter), "Requires Language Feature: ImplicitDefaultValueOnOptionalParameter")
            Dim sources1 = <![CDATA[
.assembly extern mscorlib
{
  .publickeytoken = (B7 7A 5C 56 19 34 E0 89 )                         // .z\V.4..
...
.class interface public abstract auto ansi import IA
{
          ...
          instance void  M(int32 x) cil managed
  {
    ...
    End Class
            ...
            Dim reference1 = CompileIL(sources1, appendDefaultHeader:=False, embedInteropTypes:=True)
            CompileAndVerify(sources2, parseOptions:=MyParseOptions,
        ...
        <Fact()>
        Public Sub DefaultValueWithoutOptional_02a()
            Dim sources1 = <![CDATA[
.assembly extern mscorlib
{
  .publickeytoken = (B7 7A 5C 56 19 34 E0 89 )                         // .z\V.4..
...
.class interface public abstract auto ansi import IA
{
  ...
  .custom instance void [mscorlib]System.Runtime.CompilerServices.DateTimeConstantAttribute::.ctor(int64) = ( 01 00 B1 68 DE 3A 00 00 00 00 00 00 )             // ...h.:......
    ...
    End Class
        ...
        Dim MyParseOptions As VisualBasicParseOptions = VisualBasicParseOptions.Default.WithMyFeature
