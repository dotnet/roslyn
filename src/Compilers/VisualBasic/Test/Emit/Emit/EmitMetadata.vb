...
End Class 
            ...
            dllImage = CompileAndVerify(c2, verify:=Verification.FailsIlVerify_UnspecifiedError).EmittedAssemblyData
...
End Class
            ...
            Dim manifestModule = CompileAndVerify(c1, verify:=Verification.FailsIlVerify_MissingAssembly).EmittedAssemblyData
