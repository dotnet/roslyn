...
End Class
            ...
            CompileAndVerify(unverifiable, validator:=validator, verify:=Verification.Skipped)
            CompileAndVerify(unloadable, validator:=validator, verify:=Verification.Skipped)
        End Sub
