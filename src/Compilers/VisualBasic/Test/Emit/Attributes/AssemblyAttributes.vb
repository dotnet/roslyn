...
End Class
    ...
    Private Shared Sub TestDuplicateAssemblyAttributesNotEmitted(assembly As AssemblySymbol, expectedSrcAttrCount As Integer, expectedDuplicateAttrCount As Integer, attrTypeName As String)
        ...
        Dim allEmittedAttrs = assembly.GetCustomAttributesToEmit(GetDefaultPEBuilder(compilation)).Cast(Of VisualBasicAttributeData)()
...
End Class
        ...
        Dim attrs = consoleappCompilation.Assembly.GetCustomAttributesToEmit(GetDefaultPEBuilder(consoleappCompilation)).Cast(Of VisualBasicAttributeData)()
        For Each a In attrs
            Select Case a.AttributeClass.Name
                Case "AssemblyTitleAttribute"
