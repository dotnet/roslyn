...
|]
            ...
            Assert.Equal("Me, x", GetSymbolNamesJoined(analysis.DefinitelyAssignedOnExit))
...
|]
        ...
        System.Console.WriteLine(i)
            ...
            Assert.Equal("Me, args", GetSymbolNamesJoined(analysis.DefinitelyAssignedOnExit))
        End Sub
   ...
   sub F(b as boolean)
    ...
    [next]:
        Static j as integer = i
            ...
            Assert.Equal("Me, b", GetSymbolNamesJoined(analysis.DefinitelyAssignedOnExit))
        End Sub
...
|]
        ...
        Static c as integer = a + 4 + x + y
            ...
            Assert.Equal("Me, x, a, tmp", GetSymbolNamesJoined(analysis.DefinitelyAssignedOnExit))
        End Sub
...
End Module
            ...
            Assert.Equal("ary, local01, local02", GetSymbolNamesJoined(dataFlowAnalysisResults.DefinitelyAssignedOnExit))
...
End Class
            ...
            Assert.Equal("Me, t", GetSymbolNamesJoined(dataFlowAnalysisResults.DefinitelyAssignedOnExit))
...
End Module
            ...
            Assert.Equal("x", GetSymbolNamesJoined(dataFlowResults.DefinitelyAssignedOnExit))
...
End Class
            ...
            Assert.Equal("local", GetSymbolNamesJoined(dataFlowResults.DefinitelyAssignedOnExit))
...
End Module
            ...
            Assert.Equal("args, igoo, at1", GetSymbolNamesJoined(dataFlowResults.DefinitelyAssignedOnExit))
...
End Module
            ...
            Assert.Equal("v0, v1, v2, v3, v4, v5", GetSymbolNamesJoined(dataFlowAnalysis.DefinitelyAssignedOnExit))
