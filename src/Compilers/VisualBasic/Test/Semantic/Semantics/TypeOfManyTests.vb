...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests.Semantics
    <Xunit.Trait("TypeOfMany", "")>
    Public Class TypeOfManyTests
        Inherits BasicTestBase
        ' These test should return the same diagnostics as there traditional form (Type expr Is T0).
...
IOperation:  (OperationKind.None) (Syntax: 'TypeOf o Is {Integer}')
]]>.Value

            Dim expectedDiagnostics = String.Empty

            VerifyOperationTreeAndDiagnosticsForTest(Of TypeOfManyExpressionSyntax)(source, expectedOperationTree, expectedDiagnostics)
        End Sub
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf o Is ... Comparable}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf v Is {DayOfWeek}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf e Is {DayOfWeek}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf oT Is {TRef}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf oT Is {TVal}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf vVal Is {TRef}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf oT Is {String}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None, IsInvalid) (Syntax: 'TypeOf obj Is {Program}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None, IsInvalid) (Syntax: 'TypeOf s Is {AppDomain}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None, IsInvalid) (Syntax: 'TypeOf s Is {Integer}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None, IsInvalid) (Syntax: 'TypeOf i Is {String}')
]]>.Value
...
Module Program
    ...
    Sub M(Of T, TA As A, TB As B, TC As Structure, TD As IDisposable)(x As T, a As TA, b As TB, c As TC, d As TD, s As String)
        ...
        If TypeOf x Is {TA,TB,TC,TD,String} Then
            Console.WriteLine("Success!")
        End If
 
        If TypeOf a Is {TB,TC,String} Then
            Console.WriteLine("Fail!")
        ElseIf TypeOf a Is {T,TD} Then
            Console.WriteLine("Success!")
        End If
 
        If TypeOf b Is {TA,TC,String} Then
            Console.WriteLine("Fail!")
        ElseIf TypeOf b Is {T,TD} Then
            Console.WriteLine("Success!")
        End If
 
        If TypeOf c Is {TA,TB,String} Then
            Console.WriteLine("Fail!")
        ElseIf TypeOf c Is {T,TD} Then
            Console.WriteLine("Success!")
        End If
 
        If TypeOf d Is {T,TA,TB,TC,String} Then
            Console.WriteLine("Success!")
        End If
 
        If TypeOf s Is {TA,TB,TC} Then
            Console.WriteLine("Fail!")
        ElseIf TypeOf s Is {T,T,TD} Then
            Console.WriteLine("Success!")
        End If
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf o Is ... erSequence}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf o Is {HRESULT}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IOperation:  (OperationKind.None) (Syntax: 'TypeOf o IsNot {HRESULT}')
]]>.Value
