...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests.Semantics
    ...
    Public Class OptionalArgumentTests
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543066")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543202")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543179")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543230")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543395")>
        <Fact()>
...
End Module
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543526")>
...
End Module
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543527")>
...
End Class
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543531")>
...
End Structure
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544515")>
...
]]>).VerifyIL("m.main", <![CDATA[
{
  ...
  IL_000e:  ret
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544603")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545416")>
        <Fact()>
...
End Enum
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/536772")>
        <Fact()>
...
x = nothing
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543187")>
...
IInvocationOperation (Sub C.M7([x As System.Object])) (OperationKind.Invocation, Type: System.Void) (Syntax: 'C.M7()')
  ...
  Arguments(1):
      IArgumentOperation (ArgumentKind.DefaultValue, Matching Parameter: x) (OperationKind.Argument, Type: null, IsImplicit) (Syntax: 'C.M7')
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545405")>
        <Fact()>
...
1
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545686")>
        <Fact()>
...
End Interface
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/578129")>
        <Fact()>
...
Void Main() - 10, Main, a.vb
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1040287")>
        <Fact()>
...
")
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/623122"), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/619347")>
        <Fact()>
