...
<compilation name="TestOptionalOnGenericMethod">
    <file name="a.vb">
        ...
        Module Program
            Sub Foo(Of T)(x As Integer, Optional y As Integer)
                Console.WriteLine(y) 
            End Sub
...
<compilation name="MidParameterMissOptional">
    <file name="a.vb">
        ...
        End Module
            ...
            CompilationUtils.CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, parseOptions:=MyParseOptions).VerifyDiagnostics(
...
<compilation name="OptionalParameterForConstructorofStructure">
    <file name="a.vb">
        ...
        End Structure
            ...
            CompilationUtils.CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, parseOptions:=MyParseOptions).AssertNoDiagnostics()
        End Sub
...
</compilation>, parseOptions:=MyParseOptions)
...
<compilation>
    <file name="c.vb"><![CDATA[
        ...
        End Enum
            ...
            CompileAndVerify(compilation, parseOptions:=MyParseOptions, expectedOutput:="B").VerifyDiagnostics()
        End Sub
...
<compilation>
    <file name="c.vb"><![CDATA[
        ...
        End Module
            ...
            CompileAndVerify(compilation, parseOptions:=MyParseOptions, expectedOutput:="
x = 0
x = 0
x = nothing
x = nothing
...
<compilation>
    <file name="c.vb"><![CDATA[
        ...
        End Class
            ...
            Dim libComp = CompilationUtils.CreateCompilationWithMscorlibAndVBRuntimeAndReferences(libSource, parseOptions:=MyParseOptions)
...
"
            ...
            Dim metadataRef = MetadataReference.CreateFromImage(libComp.EmitToArray())
            CompileAndVerify(source, parseOptions:=MyParseOptions, additionalRefs:={metadataRef}, expectedOutput:=expected).VerifyDiagnostics()
        End Sub
        ...
        End Class
            ...
            Dim validator As Func(Of Boolean, Action(Of ModuleSymbol)) = Function(isFromSource) _
                Sub([module])
                    ...
                    Assert.False(parameters(1).HasExplicitDefaultValue)
                    Assert.Equal(Nothing, parameters(1).ExplicitDefaultValue)
                    Assert.Equal(Nothing, parameters(1).ExplicitDefaultConstantValue)
                    ...
                    Assert.Null(parameters(4).ExplicitDefaultValue)
                    ...
                    If isFromSource Then
                        ...
                        Assert.Null(parameters(6).ExplicitDefaultValue)
                        ...
                        Assert.Null(parameters(7).ExplicitDefaultValue)
        ...
        End Structure
            ...
            Dim validator As Func(Of Boolean, Action(Of ModuleSymbol)) = Function(isFromSource) _
                Sub([module])
                    ...
                    Assert.Null(parameters(1).ExplicitDefaultConstantValue)
                    Assert.Equal(0, parameters(1).GetAttributes().Length)
...
<compilation name="TestOptionalOnGenericMethod">
    <file name="a.vb">
        ...
        Public Class C
            ...
            End Sub
            Public Sub M1a(Optional p As String) ' default of type
            End Sub
        ...
        End Class
            ...
            Dim validator As Func(Of Boolean, Action(Of ModuleSymbol)) = Function(isFromSource) _
                Sub([module])
                    ...
                    Assert.True(parameters(2).HasExplicitDefaultValue)
                    Assert.Null(parameters(2).ExplicitDefaultValue)
                    Assert.Equal(ConstantValue.Null, parameters(2).ExplicitDefaultConstantValue)
                    Assert.Equal(0, parameters(2).GetAttributes().Length)

                    Assert.True(parameters(3).IsOptional)
                    Assert.True(parameters(3).HasExplicitDefaultValue)
                    Assert.Equal("A", parameters(3).ExplicitDefaultValue)
                    Assert.Equal(ConstantValue.Create("A"), parameters(3).ExplicitDefaultConstantValue)
                    Assert.Equal(0, parameters(3).GetAttributes().Length)
                    ...
                    Else
                        ...
                        Assert.Null(parameters(4).ExplicitDefaultValue)
                        Assert.Null(parameters(4).ExplicitDefaultConstantValue)
                        Assert.Equal(0, parameters(4).GetAttributes().Length)
                        ...
                        Assert.Null(parameters(8).ExplicitDefaultValue)
                        Assert.Null(parameters(8).ExplicitDefaultConstantValue)
                        Assert.Equal(1, parameters(8).GetAttributes().Length)
                    End If
                End Sub
...
End Class
            ...
            Dim validator As Func(Of Boolean, Action(Of ModuleSymbol)) = Function(isFromSource) _
                Sub([module])
                    ...
                    Assert.Null(parameters(9).ExplicitDefaultValue)
                    ...
                    If isFromSource Then
                        ...
                        Assert.Null(parameters(10).ExplicitDefaultValue)
                        ...
                        Assert.Null(parameters(11).ExplicitDefaultValue)
