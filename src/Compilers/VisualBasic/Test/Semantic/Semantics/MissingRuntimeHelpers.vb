...
End Namespace
            ...
            compilation.VerifyEmitDiagnostics(
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Nothing").WithArguments("System.DateTime.New").WithLocation(6, 22),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Nothing").WithArguments("System.Decimal.New").WithLocation(7, 25),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "[Do] ^ [Do]").WithArguments("System.Math.Pow").WithLocation(10, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Da > Da").WithArguments("System.DateTime.Compare").WithLocation(11, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "De > De").WithArguments("System.Decimal.Compare").WithLocation(12, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "De + De").WithArguments("System.Decimal.Add").WithLocation(13, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "St + St").WithArguments("System.String.Concat").WithLocation(14, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "-De").WithArguments("System.Decimal.Negate").WithLocation(15, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CType(ChArray, String)").WithArguments("System.String.New").WithLocation(16, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CDec([Do])").WithArguments("System.Decimal.New").WithLocation(17, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CInt(De)").WithArguments("System.Convert.ToInt32").WithLocation(18, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CInt([Do])").WithArguments("System.Math.Round").WithLocation(19, 10))
        End Sub
...
End Class
            ...
            '         ~~~~~~~~
            compilation.VerifyEmitDiagnostics(
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "St > St").WithArguments("Microsoft.VisualBasic.CompilerServices.Operators.CompareString").WithLocation(8, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Ob AndAlso Ob").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToBoolean").WithLocation(9, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Ob + Ob").WithArguments("Microsoft.VisualBasic.CompilerServices.Operators.AddObject").WithLocation(10, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "St Like St").WithArguments("Microsoft.VisualBasic.CompilerServices.LikeOperator.LikeString").WithLocation(11, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Ob > Ob").WithArguments("Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectGreater").WithLocation(12, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "Not Ob").WithArguments("Microsoft.VisualBasic.CompilerServices.Operators.NotObject").WithLocation(13, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CType(Ob, Char())").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToCharArrayRankOne").WithLocation(14, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CLng(Ob)").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToLong").WithLocation(15, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CStr([Do])").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToString").WithLocation(16, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CInt(St)").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger").WithLocation(17, 10),
                Diagnostic(ERRID.ERR_MissingRuntimeHelper, "CDec(Bo)").WithArguments("Microsoft.VisualBasic.CompilerServices.Conversions.ToDecimal").WithLocation(18, 10))
        End Sub
