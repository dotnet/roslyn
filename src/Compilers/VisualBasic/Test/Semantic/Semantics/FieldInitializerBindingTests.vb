...
BC30799: Field 'Clazz.b' has an invalid constant value.
    Console.WriteLine(Clazz.b.ToString())
        ...
        Sub WriteOfReadonlyStaticMemberOfAnotherInstatiation01()
            Dim compilation = CompilationUtils.CreateCompilationWithMscorlib(
   <compilation>
       <file name="a.vb">
Class Foo(Of T)
    ...
    Public Shared ReadOnly Property Y As Integer = Nothing
End Class
        </file>
   </compilation>, TestOptions.ReleaseDll)
...
BC30526: Property 'Y' is 'ReadOnly'.
        ...
        <Fact, WorkItem(1028, "https://github.com/dotnet/roslyn/issues/1028")>
        Public Sub WriteOfReadonlyStaticMemberOfAnotherInstatiation02()
            CompileAndVerify(
<compilation>
    <file name="a.vb">
Imports System
