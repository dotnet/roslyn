...
End Module
            ...
            Dim withExpression = DirectCast(tree.GetCompilationUnitRoot().DescendantNodes().Where(Function(n) n.IsKind(SyntaxKind.SimpleMemberAccessExpression)).First(), MemberAccessExpressionSyntax)
