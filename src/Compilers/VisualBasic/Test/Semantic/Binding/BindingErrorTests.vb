...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540629")>
        <Fact()>
...
BC30039: Loop control variable cannot be a property or a late-bound indexed array.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545641")>
...
BC30043: 'MyClass' is valid only within an instance method.
    Public Shared Property P As Integer = MyClass.GetBar(1)
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542958")>
        <Fact()>
...
BC30049: 'Redim' statement requires an array.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542209")>
        <Fact()>
...
<compilation name="ArrayRankLimit">
    ...
    End Class
        ...
        <Fact, WorkItem("https://github.com/dotnet/roslyn/issues/2424")>
...
BC30057: Too many arguments to 'Public Sub test(name As String, age As Integer)'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528720")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542967")>
        <Fact()>
...
BC30068: Expression is a value and therefore cannot be the target of an assignment.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/575055")>
        <Fact>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538107")>
        <Fact()>
...
BC42024: Unused local variable: 'i'.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528749")>
...
BC30277: Type character '#' does not match declared data type 'Integer'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528681")>
        <Fact()>
...
BC30282: Constructor call is valid only as the first statement in an instance constructor.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/541012")>
        <Fact()>
...
BC42024: Unused local variable: 'i'.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531346")>
...
BC30333: Value of type 'Integer()' cannot be converted to 'Object()' because 'Integer' is not a reference type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/579764")>
        <Fact()>
...
End Module        </file>
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542069")>
...
BC30337: 'For' loop control variable cannot be of type 'Date' because the type does not support the required operators.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542069"), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544464")>
...
BC30369: Cannot refer to an instance member of a class from within a shared method or shared member initializer without an explicit instance of the class.
        ...
        <Fact, WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529193")>
...
BC30390: 'B.Private Sub M()' is not accessible in this context because it is 'Private'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540640")>
        <Fact()>
...
BC30393: 'Exit Try' can only appear inside a 'Try' statement.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542801")>
        <Fact()>
...
BC30456: 'bar1' is not a member of 'S1'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538903")>
        <Fact()>
...
BC30456: 'M' is not a member of 'M1.B'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529710")>
        <Fact()>
...
BC30500: Constant 'f1' cannot depend on its own value.
    private const f1 = f2
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528728")>
...
BC30512: Option Strict On disallows implicit conversions from 'UInteger' to 'Integer'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528762")>
        <Fact>
...
BC30518: Overload resolution failed because no accessible 'sub1' can be called with these arguments:
    ...
    'Public Sub sub1(Of Integer, String)(p1 As String(), p2 As Integer())': Value of type 'String()' cannot be converted to 'Integer()' because 'String' is not derived from 'Integer'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546763")>
        <Fact()>
...
BC30518: Overload resolution failed because no accessible 'ForEach' can be called with these arguments:
    ...
    'Public Shared Overloads Function ForEach(Of TSource)(source As OrderablePartitioner(Of TSource), body As Action(Of TSource, ParallelLoopState, Long)) As ParallelLoopResult': Data type(s) of the type parameter(s) cannot be inferred from these arguments. Specifying the data type(s) explicitly might correct this error.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542956")>
...
BC30545: Property access must assign to the property or use its value.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531311")>
        <Fact()>
...
BC30616: Variable 's' hides a variable in an enclosing block.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528680")>
        <Fact()>
...
BC42104: Variable 'a6' is used before it has been assigned a value. A null reference exception could result at runtime.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542258")>
        <Fact()>
...
BC30742: Value '65536' cannot be converted to 'Char'.
    private const f5 as Char = ChrW(65536)
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/574290")>
        <Fact()>
...
BC30754: 'GoTo LB1' is not valid because 'LB1' is inside a 'Try', 'Catch' or 'Finally' statement that does not contain this statement.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543055")>
        <Fact()>
...
BC32023: Expression is of type 'Type1', which is not a collection type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540627")>
        <Fact()>
...
BC30920: First statement of this 'Sub New' must be an explicit call to 'MyBase.New' or 'MyClass.New' because the 'Public Sub New()' in the base class 'C1' of 'C2' is marked obsolete: 'hello'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531309")>
        <Fact()>
...
BC30939: 'AddressOf' expression cannot be converted to '[Delegate]' because type '[Delegate]' is declared 'MustInherit' and cannot be created.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529157")>
...
BC30451: 'value' is not declared. It may be inaccessible due to its protection level.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542270")>
        <Fact()>
...
BC42104: Variable 'a' is used before it has been assigned a value. A null reference exception could result at runtime.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542191")>
...
BC31082: 'ex' is not a local variable or parameter, and so cannot be used as a 'Catch' variable.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538613")>
        <Fact()>
...
BC31095: Reference to object under construction is not valid when calling another constructor.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/541798")>
        <Fact()>
...
BC31095: Reference to object under construction is not valid when calling another constructor.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/541799")>
        <Fact()>
...
BC31148: XML namespace prefix 'p6' is not defined.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531633")>
        <Fact()>
...
BC31394: Expression of type 'ArgIterator' cannot be converted to 'Object' or 'ValueType'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/527685")>
        <Fact()>
...
BC31394: Expression of type 'RuntimeArgumentHandle' cannot be converted to 'Object' or 'ValueType'.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529561")>
...
BC31419: 'IsNot' requires operands that have reference types, but this operand has the value type 'T3'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542192")>
        <Fact()>
       ...
       extends BaseAttribute
{
  ...
  .property instance int32 PROP()
  {
    .get instance int32 DerivedAttribute::get_PROP()
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528981")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539101")>
        <Fact()>
...
BC32001: 'Me' is not valid within a Module.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542960")>
        <Fact()>
...
BC32014: Bounds can be specified only for the top-level array when initializing an array of arrays.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545621")>
        <Fact()>
...
BC32014: Bounds can be specified only for the top-level array when initializing an array of arrays.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528729")>
        <Fact()>
...
BC32059: Array lower bounds can be only '0'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542204")>
        <Fact()>
...
BC32096: 'For Each' on type 'T1' is ambiguous because the type implements multiple instantiations of 'System.Collections.Generic.IEnumerable(Of T)'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543616")>
        <Fact()>
...
BC32128: 'IsNot' operand of type 'S1?' can be compared only to 'Nothing' because 'S1?' is a nullable type.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545669")>
        <Fact()>
...
BC42104: Variable 'y' is used before it has been assigned a value. A null reference exception could result at runtime.
    ...
    Diagnostic(ERRID.ERR_DelegateBindingMismatchStrictOff2, "System.Console.Read").WithArguments("Public Shared Overloads Function Read() As Integer", "AnonymousType Function <generated method>() As String"))
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528732")>
        <Fact()>
...
BC40052: Range specified for 'Case' statement is not valid. Make sure that the lower bound is less than or equal to the upper bound.
        ...
        <Fact>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/759127")>
...
BC42025: Access of shared member, constant member, enum member or nested type through an instance; qualifying expression will not be evaluated.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528718")>
        <Fact()>
...
BC42025: Access of shared member, constant member, enum member or nested type through an instance; qualifying expression will not be evaluated.
    B = B.A + 1
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528734")>
...
BC42025: Access of shared member, constant member, enum member or nested type through an instance; qualifying expression will not be evaluated.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/528735")>
        <Fact()>
...
BC42105: Function 'F6' doesn't return a value on all code paths. A null reference exception could occur at run time when the result is used.
    ...
    ~~~~~~~~~~~~
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545313")>
        <Fact()>
...
BC42105: Function '<anonymous method>' doesn't return a value on all code paths. A null reference exception could occur at run time when the result is used.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/837973")>
        <Fact()>
...
BC42107: Property 'P6' doesn't return a value on all code paths. A null reference exception could occur at run time when the result is used.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540421")>
        <Fact()>
...
BC42109: Variable 's' is used before it has been assigned a value. A null reference exception could result at runtime. Make sure the structure or all the reference members are initialized before use
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546818")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/547098")>
        <Fact()>
...
Imports System
   ...
   End Module
    ...
    End Structure
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546377")>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546423")>
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546420")>
        <Fact()>
        Public Sub Bug15747()
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546175")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/652008")>
        <Fact()>
...
BC42322: Runtime errors might occur when converting 'String' to 'IEnumerator(Of Integer)'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545479")>
        <Fact()>
...
BC42324: Using the iteration variable in a lambda expression may have unexpected results.  Instead, create a local variable within the loop and assign it the value of the iteration variable.
    ...
    <compilation name="LambdaPassedToRemoveHandler">
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545252")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545195")>
        <Fact()>
...
BC42353: Function 'Fun1' doesn't return a value on all code paths. Are you missing a 'Return' statement?
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542802")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542816")>
        <Fact()>
...
~~~~~~~~~
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/938459")>
        <Fact>
...
BC30002: Type 'System.Void' is not defined.
    ...
    ~~~~~~~~
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530126")>
...
BC30451: 'Environent' is not declared. It may be inaccessible due to its protection level.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545179")>
        Public Sub Bug13459()
            Dim compilation1 = CompilationUtils.CreateCompilationWithMscorlib40AndVBRuntime(
    <compilation name="NotYetImplementedInRoslyn">
        <file name="a.vb">
...
BC31422: 'System.Void' can only be used in a GetType expression.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/541066")>
        <Fact()>
...
Enum E
     ~
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/541468")>
        <Fact()>
...
BC30260: 'Main' is already declared as 'Friend Const main As Object' in this module.
    Sub Main
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542596")>
        <Fact()>
...
End Structure
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543300")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543333")>
        <Fact()>
...
End Class
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543746")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543823")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543821")>
        <Fact()>
...
End Module
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543755")>
        <Fact()>
...
BC30034: Bracketed identifier is missing closing ']'.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/536245"), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543652")>
...
BC30050: ParamArray parameter must be an array.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544501")>
        <Fact()>
...
BC31408: 'Private' and 'NotOverridable' cannot be combined.
    Private NotOverridable Sub Foo(ByRef x() As Integer)
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546098")>
        <Fact()>
...
BC30369: Cannot refer to an instance member of a class from within a shared method or shared member initializer without an explicit instance of the class.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546053")>
        <Fact()>
...
BC30676: 'evt' is not an event of 'Object'.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530912")>
        <Fact()>
...
BC30574: Option Strict On disallows late binding.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531400")>
        <Fact()>
        Public Sub Bug18070()
            Dim compilation =
                CreateCompilationWithMscorlib40AndVBRuntime(
...
Font)
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/566606")>
        <Fact()>
...
BC36908: Late-bound extension methods are not supported.
        ...
        <WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/573728")>
        <Fact()>
...
BC30057: Too many arguments to 'D'.
        ...
        <Fact(), WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/792754")>
...
BC42004: Expression recursively calls the containing Operator 'Public Shared Widening Operator CType(y As RecAcc001mod.cls) As Integer'.
        ...
        <Fact(), WorkItem("https://github.com/dotnet/roslyn/issues/5072")>
