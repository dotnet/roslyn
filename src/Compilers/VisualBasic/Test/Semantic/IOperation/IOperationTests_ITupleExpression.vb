...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (I ... r) = (1, 2)')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (U ... r) = (1, 2)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.UInt32, System.String)) (Syntax: '(1, Nothing)')
  Elements(2):
      IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: System.UInt32, Constant: 1, IsImplicit) (Syntax: '1')
        Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: True, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
        Operand: 
          ILiteralOperation (OperationKind.Literal, IsExpression, Type: System.Int32, Constant: 1) (Syntax: '1')
      IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: System.String, Constant: null, IsImplicit) (Syntax: 'Nothing')
        Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
        Operand: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (U ... 1, Nothing)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    ...
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= (1, Nothing)')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: (System.UInt32, System.String), IsImplicit) (Syntax: '(1, Nothing)')
          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
          Operand: 
            ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.UInt32, System.String)) (Syntax: '(1, Nothing)')
              Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (A As System.Int32, B As System.Int32)) (Syntax: '(A:=1, B:=2)')
  Elements(2):
      ILiteralOperation (OperationKind.Literal, IsExpression, Type: System.Int32, Constant: 1) (Syntax: '1')
      ILiteralOperation (OperationKind.Literal, IsExpression, Type: System.Int32, Constant: 2) (Syntax: '2')
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t = (A:=1, B:=2)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (A ... r) = (1, 2)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    Variables: Local_1: t As (A As System.Int32, B As System.Int32)
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= (1, 2)')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: (A As System.Int32, B As System.Int32), IsImplicit) (Syntax: '(1, 2)')
          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
          Operand: 
            ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int32, System.Int32)) (Syntax: '(1, 2)')
              Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (A As System.Int16, B As System.String)) (Syntax: '(A:=1, B:=Nothing)')
  Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (A ... B:=Nothing)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    ...
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= (A:=1, B:=Nothing)')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: (A As System.Int16, B As System.String), IsImplicit) (Syntax: '(A:=1, B:=Nothing)')
          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
          Operand: 
            ITupleOperation (OperationKind.Tuple, IsExpression, Type: (A As System.Int16, B As System.String)) (Syntax: '(A:=1, B:=Nothing)')
              Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int16, c1 As System.String)) (Syntax: '(New C(0), c1)')
  Elements(2):
      IConversionOperation (Implicit, TryCast: False, Unchecked) (OperatorMethod: Function C.op_Implicit(c As C) As System.Int16) (OperationKind.Conversion, IsExpression, Type: System.Int16, IsImplicit) (Syntax: 'New C(0)')
        ...
        Operand: 
          IObjectCreationOperation (Constructor: Sub C..ctor(x As System.Int32)) (OperationKind.ObjectCreation, IsExpression, Type: C) (Syntax: 'New C(0)')
            Arguments(1):
            ...
            Initializer: 
              null
      IConversionOperation (Implicit, TryCast: False, Unchecked) (OperatorMethod: Function C.op_Implicit(c As C) As System.String) (OperationKind.Conversion, IsExpression, Type: System.String, IsImplicit) (Syntax: 'c1')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (A ... w C(0), c1)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    Variables: Local_1: t As (A As System.Int16, B As System.String)
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= (New C(0), c1)')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: (A As System.Int16, B As System.String), IsImplicit) (Syntax: '(New C(0), c1)')
          Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
          Operand: 
            ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int16, c1 As System.String)) (Syntax: '(New C(0), c1)')
              Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int32, System.Object)) (Syntax: '(0, Nothing)')
  Elements(2):
      ILiteralOperation (OperationKind.Literal, IsExpression, Type: System.Int32, Constant: 0) (Syntax: '0')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As C  ... 0, Nothing)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    Variables: Local_1: t As C
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= (0, Nothing)')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperatorMethod: Function C.op_Implicit(x As (System.Int32, System.String)) As C) (OperationKind.Conversion, IsExpression, Type: C, IsImplicit) (Syntax: '(0, Nothing)')
          ...
          Operand: 
            IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: (System.Int32, System.Object), IsImplicit) (Syntax: '(0, Nothing)')
              Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
              Operand: 
                ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int32, System.Object)) (Syntax: '(0, Nothing)')
                  Elements(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null) (Syntax: 'Dim t As (I ... tring) = c1')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
    ...
    Initializer: 
      IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= c1')
        IConversionOperation (Implicit, TryCast: False, Unchecked) (OperatorMethod: Function C.op_Implicit(c As C) As (System.Int32, System.String)) (OperationKind.Conversion, IsExpression, Type: (System.Int32, System.String), IsImplicit) (Syntax: 'c1')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITupleOperation (OperationKind.Tuple, IsExpression, Type: (System.Int16, c1 As System.String), IsInvalid) (Syntax: '(New C(0), c1)')
  Elements(2):
      IConversionOperation (Implicit, TryCast: False, Unchecked) (OperationKind.Conversion, IsExpression, Type: System.Int16, IsInvalid, IsImplicit) (Syntax: 'New C(0)')
        ...
        Operand: 
          IObjectCreationOperation (Constructor: Sub C..ctor(x As System.Int32)) (OperationKind.ObjectCreation, IsExpression, Type: C, IsInvalid) (Syntax: 'New C(0)')
            Arguments(1):
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IVariableDeclarationsOperation (1 declarations) (OperationKind.VariableDeclarations, IsStatement, Type: null, IsInvalid) (Syntax: 'Dim t As (S ... w C(0), c1)')
  IVariableDeclarationOperation (1 variables) (OperationKind.VariableDeclaration, Type: null) (Syntax: 't')
