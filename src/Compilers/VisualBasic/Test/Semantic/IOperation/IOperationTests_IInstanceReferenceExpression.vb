...
IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: C1) (Syntax: 'MyBase')
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: System.Object, IsInvalid) (Syntax: 'MyBase')
]]>.Value
