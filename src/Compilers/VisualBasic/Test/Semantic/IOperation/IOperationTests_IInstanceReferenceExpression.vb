...
IInstanceReferenceExpression (OperationKind.InstanceReferenceExpression, Type: C1, Language: Visual Basic) (Syntax: 'MyBase')
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInstanceReferenceExpression (OperationKind.InstanceReferenceExpression, Type: System.Object, IsInvalid, Language: Visual Basic) (Syntax: 'MyBase')
]]>.Value
