...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITypeOfOperation (OperationKind.TypeOf, IsExpression, Type: System.Type) (Syntax: 'GetType(C)')
  TypeOperand: C
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITypeOfOperation (OperationKind.TypeOf, IsExpression, Type: System.Type, IsInvalid) (Syntax: 'GetType(UndefinedType)')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITypeOfOperation (OperationKind.TypeOf, IsExpression, Type: System.Type, IsInvalid) (Syntax: 'GetType(t)')
  TypeOperand: t
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITypeOfOperation (OperationKind.TypeOf, IsExpression, Type: System.Type, IsInvalid) (Syntax: 'GetType(M2())')
  TypeOperand: M2()
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
ITypeOfOperation (OperationKind.TypeOf, IsExpression, Type: System.Type, IsInvalid) (Syntax: 'GetType()')
  TypeOperand: ?
]]>.Value
