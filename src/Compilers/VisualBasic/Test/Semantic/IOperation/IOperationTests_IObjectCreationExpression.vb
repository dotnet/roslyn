...
IBlockStatement (9 statements, 7 locals) (OperationKind.BlockStatement, IsInvalid, Language: Visual Basic) (Syntax: 'Public Sub  ... End Sub')
  ...
  Initializer: 
    IObjectOrCollectionInitializerExpression (OperationKind.ObjectOrCollectionInitializerExpression, Type: System.Collections.Generic.List(Of System.Int32), Language: Visual Basic) (Syntax: 'From {x, y, field}')
      Initializers(3):
          ...
          ICollectionElementInitializerExpression (AddMethod: Sub System.Collections.Generic.List(Of System.Int32).Add(item As System.Int32)) (IsDynamic: False) (OperationKind.CollectionElementInitializerExpression, Type: System.Void, IsImplicit, Language: Visual Basic) (Syntax: 'y')
            Arguments(1):
                          ...
                          Initializer: 
                            IArrayInitializer (2 elements) (OperationKind.ArrayInitializer, IsImplicit, Language: Visual Basic) (Syntax: '{x, y}')
                              Element Values(2):
                                  ...
                                  ILocalReferenceExpression: y (OperationKind.LocalReferenceExpression, Type: System.Int32, Language: Visual Basic) (Syntax: 'y')
                  Arguments(0)
          ICollectionElementInitializerExpression (AddMethod: Sub System.Collections.Generic.List(Of System.Collections.Generic.List(Of System.Int32)).Add(item As System.Collections.Generic.List(Of System.Int32))) (IsDynamic: False) (OperationKind.CollectionElementInitializerExpression, Type: System.Void, IsImplicit, Language: Visual Basic) (Syntax: 'New List(Of ... rom {field}')
            Arguments(1):
