...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IReturnStatement ([0] OperationKind.ReturnStatement) (Syntax: 'Return True')
  ReturnedValue: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IReturnStatement ([0] OperationKind.YieldReturnStatement) (Syntax: 'Yield 0')
  ReturnedValue: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IReturnStatement ([0] OperationKind.ReturnStatement, IsInvalid) (Syntax: 'Return 0.0')
  ReturnedValue: 
    IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Byte, Constant: 0, IsInvalid, IsImplicit) (Syntax: '0.0')
      Conversion: CommonConversion (Exists: True, IsIdentity: False, IsNumeric: True, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
      Operand: 
        ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.Double, Constant: 0, IsInvalid) (Syntax: '0.0')
]]>.Value
