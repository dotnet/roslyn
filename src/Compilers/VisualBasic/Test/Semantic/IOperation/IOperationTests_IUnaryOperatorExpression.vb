...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IConditionalOperation (isStatement: True) (OperationKind.Conditional, Type: null) (Syntax: 'If x AndAls ... End If')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IConditionalOperation (isStatement: True) (OperationKind.Conditional, Type: null) (Syntax: 'If x OrElse ... End If')
  Condition: 
