...
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each s  ... Next')
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each it ... Next')
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each y  ... Next')
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each x  ... Next y, x')
  ...
  Body: 
    IBlockOperation (1 statements) (OperationKind.Block, Type: null, IsImplicit) (Syntax: 'For Each x  ... Next y, x')
      IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each y  ... Next y, x')
        Locals: Local_1: y As System.Char
        LoopControlVariable: 
          IVariableDeclaratorOperation (Symbol: y As System.Char) (OperationKind.VariableDeclarator, Type: null) (Syntax: 'y As Char')
            Initializer: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each x  ... Next')
  Locals: Local_1: x As System.String
  LoopControlVariable: 
    IVariableDeclaratorOperation (Symbol: x As System.String) (OperationKind.VariableDeclarator, Type: null) (Syntax: 'x As String')
      Initializer: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each co ... Next')
          ...
          IInvocationOperation (Sub System.Diagnostics.Debug.WriteLine(message As System.String)) (OperationKind.Invocation, Type: System.Void) (Syntax: 'Debug.Write ... ntry.Count)')
            ...
            Arguments(1):
                IArgumentOperation (ArgumentKind.Explicit, Matching Parameter: message) (OperationKind.Argument, Type: null) (Syntax: 'country.Cou ... untry.Count')
                  ...
                  InConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
                  OutConversion: CommonConversion (Exists: True, IsIdentity: True, IsNumeric: False, IsReference: False, IsUserDefined: False) (MethodSymbol: null)
      IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each cu ... Next')
...
End Module
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each [C ... Next')
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each el ... ambda_local')
  LoopControlVariable: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null, IsInvalid) (Syntax: 'For Each el ... Next')
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each o  ... Next')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each X  ... Next X')
  LoopControlVariable: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'For Each c. ... Next c.X')
  LoopControlVariable: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IForEachLoopOperation (LoopKind.ForEach, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null, IsInvalid) (Syntax: 'For Each i  ... Next i')
