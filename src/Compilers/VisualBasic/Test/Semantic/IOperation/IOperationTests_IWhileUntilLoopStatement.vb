...
IWhileLoopOperation (ConditionIsTop: False, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'Do'BIND:"Do ... While i < 4')
  Condition: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: True) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'Do Until X  ... Loop')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While condi ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While i < 5 ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While True' ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While (Inli ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While numbe ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null, IsInvalid) (Syntax: 'While 'BIND ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While (cond ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While i <=  ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While IsTru ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While i < 1 ... End While')
  Condition: 
        ...
        IVariableDeclarationOperation (1 declarators) (OperationKind.VariableDeclaration, Type: null) (Syntax: 'j As Integer = 0')
          ...
          Initializer: 
            IVariableInitializerOperation (OperationKind.VariableInitializer, Type: null) (Syntax: '= 0')
              ILiteralOperation (OperationKind.Literal, Type: System.Int32, Constant: 0) (Syntax: '0')
      IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While j < 1 ... End While')
        Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While Syste ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While i > 0 ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While b = b ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null, IsInvalid) (Syntax: 'While Syste ... End While')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'Do While G( ... Loop')
  Condition: 
...
End Class
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: False, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'Do'BIND:"Do ... p While G()')
  Condition: 
    IInvocationOperation ( Function C.G() As System.Boolean) (OperationKind.Invocation, Type: System.Boolean) (Syntax: 'G()')
      Instance Receiver: 
        IInstanceReferenceOperation (OperationKind.InstanceReference, Type: C, IsImplicit) (Syntax: 'G')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: False, ConditionIsUntil: True) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'Do'BIND:"Do ... Until X < 0')
  Condition: 
    IBinaryOperation (BinaryOperatorKind.LessThan, Checked) (OperationKind.BinaryOperator, Type: System.Boolean) (Syntax: 'X < 0')
      Left: 
        IFieldReferenceOperation: C.X As System.Int32 (OperationKind.FieldReference, Type: System.Int32) (Syntax: 'X')
...
End Module
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null) (Syntax: 'While Not b ... End While')
  Condition: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IWhileLoopOperation (ConditionIsTop: True, ConditionIsUntil: False) (LoopKind.While, ContinueLabel, ExitLabel) (OperationKind.Loop, Type: null, IsInvalid) (Syntax: 'Do While i  ... ntil i <= 0')
  Condition: 
    IBinaryOperation (BinaryOperatorKind.GreaterThan, Checked) (OperationKind.BinaryOperator, Type: System.Boolean) (Syntax: 'i > 0')
      Left: 
