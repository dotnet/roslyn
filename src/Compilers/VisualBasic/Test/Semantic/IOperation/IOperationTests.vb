...
End Module
            ...
            Assert.Equal(add1.OperatorKind, BinaryOperationKind.OperatorMethodAdd)
...
")
            ...
            Assert.Equal(add2.OperatorKind, BinaryOperationKind.OperatorMethodAdd)
...
End Module
            ...
            Assert.Equal(assignment1.OperatorKind, BinaryOperationKind.IntegerAdd)
...
")
            ...
            Assert.Equal(assignment2.OperatorKind, BinaryOperationKind.OperatorMethodAdd)
