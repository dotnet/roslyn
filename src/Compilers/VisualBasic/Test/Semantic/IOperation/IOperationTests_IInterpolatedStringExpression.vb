...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInterpolatedStringExpression ([1] OperationKind.InterpolatedStringExpression, Type: System.String, IsInvalid) (Syntax: '$"{}"')
  Parts(1):
...
IInterpolatedStringExpression ([0] OperationKind.InterpolatedStringExpression, Type: System.String) (Syntax: '$"String {x ... nstant {1}"')
  Parts(6):
      ...
      IInterpolation ([1] OperationKind.Interpolation) (Syntax: '{x,20}')
        Expression: 
          IFieldReferenceExpression: [Class].x As System.String ([0] OperationKind.FieldReferenceExpression, Type: System.String) (Syntax: 'x')
            Instance Receiver: 
      ...
      IInterpolation ([3] OperationKind.Interpolation) (Syntax: '{y:D3}')
        Expression: 
          IFieldReferenceExpression: [Class].y As System.Int32 ([0] OperationKind.FieldReferenceExpression, Type: System.Int32) (Syntax: 'y')
            Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInterpolatedStringExpression ([0] OperationKind.InterpolatedStringExpression, Type: System.String) (Syntax: '$"String {x,20:D3}"')
  Parts(2):
      IInterpolatedStringText ([0] OperationKind.InterpolatedStringText) (Syntax: 'String ')
        Text: 
          ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.String, Constant: "String ") (Syntax: 'String ')
      IInterpolation ([1] OperationKind.Interpolation) (Syntax: '{x,20:D3}')
        Expression: 
          IFieldReferenceExpression: [Class].x As System.String ([0] OperationKind.FieldReferenceExpression, Type: System.String) (Syntax: 'x')
            Instance Receiver: 
              IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: [Class], IsImplicit) (Syntax: 'x')
...
IInterpolatedStringExpression ([0] OperationKind.InterpolatedStringExpression, Type: System.String) (Syntax: '$"String {x ... nstant {1}"')
  Parts(6):
      ...
      IInterpolation ([3] OperationKind.Interpolation) (Syntax: '{M2(y)}')
        Expression: 
          IInvocationExpression ( Function [Class].M2(z As System.Int32) As System.String) ([0] OperationKind.InvocationExpression, Type: System.String) (Syntax: 'M2(y)')
            Instance Receiver: 
...
IInterpolatedStringExpression ([0] OperationKind.InterpolatedStringExpression, Type: System.String) (Syntax: '$"String {M2($"{y}")}"')
  Parts(2):
      ...
      IInterpolation ([1] OperationKind.Interpolation) (Syntax: '{M2($"{y}")}')
        Expression: 
          IInvocationExpression ( Function [Class].M2(z As System.String) As System.Int32) ([0] OperationKind.InvocationExpression, Type: System.Int32) (Syntax: 'M2($"{y}")')
            Instance Receiver: 
              IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: [Class], IsImplicit) (Syntax: 'M2')
            Arguments(1):
                IArgument (ArgumentKind.Explicit, Matching Parameter: z) ([1] OperationKind.Argument) (Syntax: '$"{y}"')
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInterpolatedStringExpression ([1] OperationKind.InterpolatedStringExpression, Type: System.String, IsInvalid) (Syntax: '$"String {x ...  {[Class]}"')
  Parts(4):
      IInterpolatedStringText ([0] OperationKind.InterpolatedStringText) (Syntax: 'String ')
        Text: 
          ILiteralExpression ([0] OperationKind.LiteralExpression, Type: System.String, Constant: "String ") (Syntax: 'String ')
