...
End Class
            ...
            For i = 0 To autoGeneratedPrefixes.Length - 1
                Dim autoGeneratedPrefix = autoGeneratedPrefixes(AggregateSyntaxNotWithinSyntaxTree)
                tree = VisualBasicSyntaxTree.ParseText(String.Format(autoGeneratedPrefix + source, treeNum), path:=$"SourceFileWithAutoGeneratedComment{AggregateSyntaxNotWithinSyntaxTree}.vb")
                builder.Add(tree)
                treeNum = treeNum + 1
            Next
