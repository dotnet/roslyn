...
End Module
            ...
            Assert.Equal(add1.BinaryOperationKind, TypedBinaryOperationKind.OperatorMethodAdd)
            ...
            Assert.Equal(add2.BinaryOperationKind, TypedBinaryOperationKind.OperatorMethodAdd)
            ...
            Assert.Equal(negate3.UnaryOperationKind, TypedUnaryOperationKind.OperatorMethodMinus)
...
End Module
            ...
            Assert.Equal(assignment1.BinaryOperationKind, TypedBinaryOperationKind.IntegerAdd)
            ...
            Assert.Equal(assignment2.BinaryOperationKind, TypedBinaryOperationKind.OperatorMethodAdd)
