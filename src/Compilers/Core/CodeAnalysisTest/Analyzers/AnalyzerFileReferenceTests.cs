...
namespace Microsoft.CodeAnalysis.UnitTests
{
    ...
    public class AnalyzerFileReferenceTests : TestBase
    {
        ...
        public void AssemblyLoading_ReferencesLaterFakeCompiler_EndToEnd_CSharp()
        {
            ...
            AssertEx.Equal($"""
                warning CS9057: The analyzer assembly '{_testFixture.AnalyzerWithLaterFakeCompilerDependency}' references version '100.0.0.0' of the compiler, which is newer than the currently running version '{typeof(AnalyzerAssemblyLoader).Assembly.GetName().Version}'.
