...
namespace Microsoft.CodeAnalysis.UnitTests
{
    public class ModuleMetadataTests : TestBase
    {
        ...
        public unsafe void CreateFromImage()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => ModuleMetadata.CreateFromImage((IEnumerable<byte>)null));
            Assert.Throws<ArgumentNullException>(() => ModuleMetadata.CreateFromImage((byte[])null));
