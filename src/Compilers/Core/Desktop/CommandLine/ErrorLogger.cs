...
#pragma warning restore RS0013
        ...
        internal static void LogDiagnostic(DiagnosticInfo diagnostic, CultureInfo culture, ErrorLogger errorLogger)
        {
            if (errorLogger != null)
            {
#pragma warning disable RS0013 // We need to invoke Diagnostic.Descriptor here to log all the metadata properties of the diagnostic.
                var issue = new Issue(diagnostic.MessageIdentifier, diagnostic.GetMessage(culture),
                    diagnostic.Descriptor.Description.ToString(culture), diagnostic.Descriptor.Title.ToString(culture),
                    diagnostic.Category, diagnostic.Descriptor.HelpLinkUri, diagnostic.Descriptor.IsEnabledByDefault,
                    diagnostic.DefaultSeverity, diagnostic.Severity, diagnostic.WarningLevel, Location.None,
                    diagnostic.AdditionalLocations, diagnostic.CustomTags, ImmutableDictionary<string, string>.Empty);
#pragma warning restore RS0013
