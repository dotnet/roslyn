...
namespace Microsoft.CodeAnalysis
{
    ...
    internal sealed class ExternalFileLocation : Location, IEquatable<ExternalFileLocation>
    {
        ...
        public override TextSpan SourceSpan  { get  { return _sourceSpan; } }

        public override FileLinePositionSpan GetLineSpan()  { return _lineSpan; }

        public override FileLinePositionSpan GetMappedLineSpan()  { return _lineSpan; }

        public override LocationKind Kind { get { return LocationKind.ExternalFile; } }

        public override bool Equals(object obj) { return this.Equals(obj as ExternalFileLocation); }
