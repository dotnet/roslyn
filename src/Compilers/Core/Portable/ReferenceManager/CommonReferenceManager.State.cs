...
namespace Microsoft.CodeAnalysis
{
    ...
    internal partial class CommonReferenceManager<TCompilation, TAssemblySymbol> : CommonReferenceManager
    {
        ...
        /// </summary>
        private IDictionary<(string, string), ImmutableArray<MetadataReference>> _lazyReferenceDirectiveMap;
        ...
        internal IDictionary<(string, string), ImmutableArray<MetadataReference>> ReferenceDirectiveMap
        {
            get
            {
                AssertBound();
        ...
        internal void InitializeNoLock(
            ...
            IDictionary<(string, string), ImmutableArray<MetadataReference>> boundReferenceDirectiveMap,
