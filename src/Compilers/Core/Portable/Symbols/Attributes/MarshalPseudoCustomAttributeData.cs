...
namespace Microsoft.CodeAnalysis
{
    ...
    internal sealed class MarshalPseudoCustomAttributeData : Cci.IMarshallingInformation
    {
        ...
        object Cci.IMarshallingInformation.GetCustomMarshaller(EmitContext context)
        {
            ...
            if (typeSymbol != null)
            {
                return ((CommonPEModuleBuilder)context.Module).Translate(typeSymbol, context.SyntaxReference?.GetSyntax(), context.Diagnostics);
            }
            else
            {
        ...
        Cci.ITypeReference Cci.IMarshallingInformation.GetSafeArrayElementUserDefinedSubtype(EmitContext context)
        {
            ...
            return ((CommonPEModuleBuilder)context.Module).Translate((ITypeSymbolInternal)_marshalTypeNameOrSymbol, context.SyntaxReference?.GetSyntax(), context.Diagnostics);
        }
