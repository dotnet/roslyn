...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class SymbolEqualityComparer : IEqualityComparer<ISymbol?>
    {
        ...
        /// </summary>
        /// <remarks>
        /// Comparing <code>string</code> and <code>string?</code> will return equal. Use <see cref="IncludeNullability"/> if you don't want them to be considered equal.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Comparing <code>string</code> and <code>string?</code> will not return equal. Use <see cref="Default"/> if you want them to be considered equal.
        /// </remarks>
