...
namespace Microsoft.CodeAnalysis
{
    ...
    internal abstract partial class CommonCompiler
    {
            ...
            DiagnosticBag generatorDiagnostics)
        {
            ...
            bool disableCache =
                !Arguments.ParseOptions.HasFeature(FeatureFlag.EnableGeneratorCache) ||
            ...
            out GeneratorDriverTimingInfo? generatorTimingInfo)
        {
            ...
            try
            {
                ...
                if (Arguments.ParseOptions.HasFeature(FeatureFlag.PdbPathDeterminism) && !string.IsNullOrEmpty(emitOptions.PdbFilePath))
                {
                    emitOptions = emitOptions.WithPdbFilePath(Path.GetFileName(emitOptions.PdbFilePath));
                }

                if (Arguments.ParseOptions.HasFeature(FeatureFlag.DebugDeterminism))
                {
