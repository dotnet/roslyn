...
namespace Microsoft.CodeAnalysis
{
    ...
    internal abstract partial class CommonCompiler
    {
            ...
            DiagnosticBag generatorDiagnostics)
        {
            ...
            bool disableCache =
                !Arguments.ParseOptions.Features.ContainsKey(FeatureFlag.EnableGeneratorCache) ||
            ...
            out GeneratorDriverTimingInfo? generatorTimingInfo)
        {
            ...
            try
            {
                ...
                if (Arguments.ParseOptions.Features.ContainsKey(FeatureFlag.PdbPathDeterminism) && !string.IsNullOrEmpty(emitOptions.PdbFilePath))
                {
                    emitOptions = emitOptions.WithPdbFilePath(Path.GetFileName(emitOptions.PdbFilePath));
                }

                if (Arguments.ParseOptions.Features.ContainsKey(FeatureFlag.DebugDeterminism))
                {
