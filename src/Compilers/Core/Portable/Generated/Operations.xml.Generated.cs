...
namespace Microsoft.CodeAnalysis.Semantics
{
    ...
    {
        protected BaseQueryExpression(SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.QueryExpression, semanticModel, syntax, type, constantValue)
        {
        }
        protected abstract IOperation LastClauseOrContinuationImpl { get; }
        /// <summary>
        ...
        /// </summary>
        public IOperation LastClauseOrContinuation => Operation.SetParentOperation(LastClauseOrContinuationImpl, this);
        public override IEnumerable<IOperation> Children
        {
            get
            {
    ...
    {
        public QueryExpression(IOperation lastClauseOrContinuation, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(semanticModel, syntax, type, constantValue)
        {
            LastClauseOrContinuationImpl = lastClauseOrContinuation;
        }
        protected override IOperation LastClauseOrContinuationImpl { get; }
    }
    ...
    internal sealed partial class LazyQueryExpression : BaseQueryExpression, IQueryExpression
    {
        ...
        public LazyQueryExpression(Lazy<IOperation> lastClauseOrContinuation, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(semanticModel, syntax, type, constantValue)
        {
        ...
        protected override IOperation LastClauseOrContinuationImpl => _lazyLastClauseOrContinuation.Value;
    }
    ...
    {
        protected BaseOrderingExpression(OrderKind orderKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.OrderingExpression, semanticModel, syntax, type, constantValue)
        {
            OrderKind = orderKind;
        }
        /// <summary>
    ...
    {
        public OrderingExpression(IOperation expression, OrderKind orderKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(orderKind, semanticModel, syntax, type, constantValue)
        {
            ExpressionImpl = expression;
        }
        protected override IOperation ExpressionImpl { get; }
    ...
    internal sealed partial class LazyOrderingExpression : BaseOrderingExpression, IOrderingExpression
    {
        ...
        public LazyOrderingExpression(Lazy<IOperation> expression, OrderKind orderKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(orderKind, semanticModel, syntax, type, constantValue)
        {
            _lazyExression = expression ?? throw new System.ArgumentNullException(nameof(expression));
        }
        protected override IOperation ExpressionImpl => _lazyExression.Value;
    }
    ...
    {
        protected BaseAggregationExpression(bool isGroupAggregation, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.AggregationExpression, semanticModel, syntax, type, constantValue)
        {
    ...
    {
        public AggregationExpression(IOperation expression, bool isGroupAggregation, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(isGroupAggregation, semanticModel, syntax, type, constantValue)
        {
            ExpressionImpl = expression;
        }
        protected override IOperation ExpressionImpl { get; }
    ...
    internal sealed partial class LazyAggregationExpression : BaseAggregationExpression, IAggregationExpression
    {
        ...
        public LazyAggregationExpression(Lazy<IOperation> expression, bool isGroupAggregation, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(isGroupAggregation, semanticModel, syntax, type, constantValue)
        {
            _lazyExression = expression ?? throw new System.ArgumentNullException(nameof(expression));
        }
    ...
    {
        protected BaseQueryContinuation(IRangeVariableSymbol declaredSymbol, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.QueryContinuation, semanticModel, syntax, type, constantValue)
        {
            DeclaredSymbol = declaredSymbol;
        }
        /// <summary>
        ...
        /// </summary>
        public IOperation QueryBody => Operation.SetParentOperation(QueryBodyImpl, this);
        protected abstract IOperation QueryBodyImpl { get; }
        public override IEnumerable<IOperation> Children
        {
            get
            {
    ...
    {
        public QueryContinuation(IOperation queryBody, IRangeVariableSymbol definedSymbol, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(definedSymbol, semanticModel, syntax, type, constantValue)
        {
            QueryBodyImpl = queryBody;
        }
        protected override IOperation QueryBodyImpl { get; }
    }
    ...
    internal sealed partial class LazyQueryContinuation : BaseQueryContinuation, IQueryContinuation
    {
        ...
        public LazyQueryContinuation(Lazy<IOperation> queryBody, IRangeVariableSymbol definedSymbol, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(definedSymbol, semanticModel, syntax, type, constantValue)
        {
            _lazyQueryBody = queryBody ?? throw new System.ArgumentNullException(nameof(queryBody));
        }
        protected override IOperation QueryBodyImpl => _lazyQueryBody.Value;
    }
    ...
    {
        protected BaseQueryClause(QueryClauseKind clauseKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(OperationKind.QueryClause, semanticModel, syntax, type, constantValue)
        {
        ...
        /// </summary>
        public IOperation ReducedExpression => Operation.SetParentOperation(ReducedExpressionImpl, this);
        protected abstract IOperation ReducedExpressionImpl { get; }
        public override IEnumerable<IOperation> Children
        {
            get
            {
    ...
    {
        protected QueryClause(IOperation reducedExpression, QueryClauseKind clauseKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(clauseKind, semanticModel, syntax, type, constantValue)
        {
            ReducedExpressionImpl = reducedExpression;
        }
        protected override IOperation ReducedExpressionImpl { get; }
    }
    ...
    internal abstract partial class LazyQueryClause : BaseQueryClause, IQueryClause
    {
        ...
        protected LazyQueryClause(Lazy<IOperation> reducedExpression, QueryClauseKind clauseKind, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(clauseKind, semanticModel, syntax, type, constantValue)
        {
            _lazyReducedExpression = reducedExpression ?? throw new System.ArgumentNullException(nameof(reducedExpression));
        }
        protected override IOperation ReducedExpressionImpl => _lazyReducedExpression.Value;
    }
    ...
    {
        public FromQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.FromClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyFromQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.FromClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public SelectQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SelectClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazySelectQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SelectClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public WhereQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.WhereClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyWhereQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.WhereClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public LetQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.LetClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyLetQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.LetClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public OrderByQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.OrderByClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyOrderByQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.OrderByClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public GroupByQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.GroupByClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyGroupByQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.GroupByClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public GroupJoinQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.GroupJoinClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyGroupJoinQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.GroupJoinClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public JoinQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.JoinClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyJoinQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.JoinClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public JoinIntoQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.JoinIntoClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyJoinIntoQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.JoinIntoClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public DistinctQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.DistinctClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyDistinctQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.DistinctClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public AggregateQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.AggregateClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyAggregateQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.AggregateClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public SkipQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SkipClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazySkipQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SkipClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public SkipWhileQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SkipWhileClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazySkipWhileQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.SkipWhileClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public TakeQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.TakeClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyTakeQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.TakeClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
    ...
    {
        public TakeWhileQueryClause(IOperation reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.TakeWhileClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
        {
    ...
    {
        public LazyTakeWhileQueryClause(Lazy<IOperation> reducedExpression, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(reducedExpression, QueryClauseKind.TakeWhileClause, semanticModel, syntax, type, constantValue)
        {
        }
        public override void Accept(OperationVisitor visitor)
