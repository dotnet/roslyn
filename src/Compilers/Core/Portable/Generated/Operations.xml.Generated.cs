...
namespace Microsoft.CodeAnalysis.Semantics
{
    ...
    {
        protected BaseAnonymousFunctionExpression(IMethodSymbol symbol, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.AnonymousFunctionExpression, semanticModel, syntax, type, constantValue)
        {
            Symbol = symbol;
        }
    ...
    {
        public AnonymousFunctionExpression(IMethodSymbol symbol, IBlockStatement body, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(symbol, semanticModel, syntax, type, constantValue)
        {
            BodyImpl = body;
        }
    ...
    internal sealed partial class LazyAnonymousFunctionExpression : BaseAnonymousFunctionExpression, IAnonymousFunctionExpression
    {
        ...
        public LazyAnonymousFunctionExpression(IMethodSymbol symbol, Lazy<IBlockStatement> body, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) : base(symbol, semanticModel, syntax, type, constantValue)
        {
            _lazyBody = body ?? throw new System.ArgumentNullException(nameof(body));
        }
