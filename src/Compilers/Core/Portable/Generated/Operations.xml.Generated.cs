...
namespace Microsoft.CodeAnalysis.Operations
{
    ...
    {
        public ConditionalOperation(IOperation condition, IOperation whenTrue, IOperation whenFalse, bool isStatement, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit) :
            base(isStatement, semanticModel, syntax, type, constantValue, isImplicit)
        {
    ...
    internal sealed partial class LazyConditionalOperation : BaseConditionalOperation, IConditionalOperation
    {
        ...
        public LazyConditionalOperation(Lazy<IOperation> condition, Lazy<IOperation> whenTrue, Lazy<IOperation> whenFalse, bool isStatement, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit)
            : base(isStatement, semanticModel, syntax, type, constantValue, isImplicit)
        {
    ...
    /// Represents a binding of an event.
    /// </summary>
    internal sealed partial class EventAssignmentExpression : BaseEventAssignmentExpression, IEventAssignmentOperation
    {
        public EventAssignmentExpression(IEventReferenceOperation eventReference, IOperation handlerValue, bool adds, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit) :
    ...
    /// Represents a binding of an event.
    /// </summary>
    internal sealed partial class LazyEventAssignmentExpression : BaseEventAssignmentExpression, IEventAssignmentOperation
    {
        private readonly Lazy<IEventReferenceOperation> _lazyEventReference;
        private readonly Lazy<IOperation> _lazyHandlerValue;

        public LazyEventAssignmentExpression(Lazy<IEventReferenceOperation> eventReference, Lazy<IOperation> handlerValue, bool adds, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit) : base(adds, semanticModel, syntax, type, constantValue, isImplicit)
    ...
    {
        public InvalidOperation(ImmutableArray<IOperation> children, bool isStatement, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit) :
            base(isStatement, semanticModel, syntax, type, constantValue, isImplicit)
        {
    ...
    internal sealed partial class LazyInvalidOperation : BaseInvalidOperation, IInvalidOperation
    {
        ...
        public LazyInvalidOperation(Lazy<ImmutableArray<IOperation>> children, bool isStatement, SemanticModel semanticModel, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue, bool isImplicit) : base(isStatement, semanticModel, syntax, type, constantValue, isImplicit)
        {
