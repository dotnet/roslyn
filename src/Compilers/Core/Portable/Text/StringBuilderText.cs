...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    internal sealed partial class StringBuilderText : SourceText
    {
        ...
        public override void Write(TextWriter textWriter, TextSpan span, CancellationToken cancellationToken = default)
        {
            ...
            // chunks, so the TextWriter will never have to allocate an enourmous array and this will still be faster than the
            // base implementation (likely because this way, we would always copy each chunks directly rather than buffering
