...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
        ...
        /// type), use <see cref="Compilation.ClassifyCommonConversion"/>.</remarks>
        public abstract CommonConversion ClassifyCommonConversion(SyntaxNode expression, ITypeSymbol destination, bool isExplicitInSource = false);
        ...
        /// <remarks>To determine the conversion between two types (instead of an expression and a
        /// type), use <see cref="Compilation.ClassifyCommonConversion"/>.</remarks>
        public abstract CommonConversion ClassifyCommonConversion(int position, SyntaxNode expression, ITypeSymbol destination, bool isExplicitInSource = false);
