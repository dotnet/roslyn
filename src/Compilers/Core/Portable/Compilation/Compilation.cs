...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Compilation
    {
        ...
        internal abstract AnalyzerDriver CreateAnalyzerDriver(ImmutableArray<DiagnosticAnalyzer> analyzers, AnalyzerManager analyzerManager, ImmutableHashSet<ReportDiagnostic> filteredSeverities);
