    ...
    public class CompilationWithAnalyzers
    {
        ...
        private async Task ComputeAnalyzerDiagnosticsWithoutStateTrackingAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                driver.Initialize(compilation, _analysisOptions, compilationData, categorizeDiagnostics, artifactCallback: null, cancellationToken);
                var hasAllAnalyzers = analyzers.Length == Analyzers.Length;
        ...
        private async Task<AnalyzerDriver> GetAnalyzerDriverAsync(CancellationToken cancellationToken)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        driver.Initialize(_compilation, _analysisOptions, _compilationData, categorizeDiagnostics: true, artifactCallback: null, cancellationToken);
                    }
            ...
            Action<Exception, DiagnosticAnalyzer, Diagnostic>? onAnalyzerException = null)
        {
            ...
            var analyzerExecutor = AnalyzerExecutor.CreateForSupportedDiagnostics(onAnalyzerException, artifactCallback: null, analyzerManager);
