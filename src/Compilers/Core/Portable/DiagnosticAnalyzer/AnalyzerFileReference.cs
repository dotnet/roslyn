...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public sealed class AnalyzerFileReference : AnalyzerReference, IEquatable<AnalyzerReference>
    {
        ...
        internal ImmutableDictionary<string, ImmutableSortedSet<string>> GetAnalyzerTypeNameMap()
        {
        ...
        private static ImmutableDictionary<string, ImmutableSortedSet<string>> GetAnalyzerTypeNameMap(string fullPath, Type attributeType, AttributeLanguagesFunc languagesFunc)
        {
            ...
            return typeNameMap.ToImmutableDictionary(g => g.Key, g => g.ToImmutableSortedSet(StringComparer.OrdinalIgnoreCase));
        }
            ...
            where TExtension : class
        {
            ...
            private ImmutableDictionary<string, ImmutableSortedSet<string>>? _lazyExtensionTypeNameMap;
            ...
            internal ImmutableDictionary<string, ImmutableSortedSet<string>> GetExtensionTypeNameMap()
            {
            ...
            {
                ImmutableDictionary<string, ImmutableSortedSet<string>> analyzerTypeNameMap;
            ...
            private ImmutableArray<TExtension> GetLanguageSpecificAnalyzers(Assembly analyzerAssembly, ImmutableDictionary<string, ImmutableSortedSet<string>> analyzerTypeNameMap, string language, ref bool reportedError)
            {
