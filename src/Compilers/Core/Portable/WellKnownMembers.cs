    ...
    internal static class WellKnownMembers
    {
        ...
        static WellKnownMembers()
        {
            byte[] initializationBytes = new byte[]
            {
                ...
                //System_String__CompareOrdinalStringIntStringIntInt
                (byte)(MemberFlags.Method | MemberFlags.Static),                                                            // Flags
                (byte)SpecialType.System_String,                                                                            // DeclaringTypeId
                0,                                                                                                          // Arity
                    5,                                                                                                      // Method Signature
            ...
            string[] allNames = new string[(int)WellKnownMember.Count]
            {
                ...
                "CompareOrdinal",                           // System_String__CompareOrdinalStringIntStringIntInt
                ...
                "SequenceEqual",                            // System_MemoryExtensions__SequenceEqual_T
                "AsSpan",                                   // System_MemoryExtensions__AsSpanString
                "AsSpan",                                   // System_MemoryExtensions__AsSpanStringIntInt
            };
