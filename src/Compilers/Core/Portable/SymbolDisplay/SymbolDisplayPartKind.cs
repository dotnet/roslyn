...
namespace Microsoft.CodeAnalysis
{
    ...
    public enum SymbolDisplayPartKind
    {
        ...
        RecordStructName = 32,
        /// <summary>The name of a preprocessing symbol.</summary>
        PreprocessingName = 33,
    }

    internal static class InternalSymbolDisplayPartKind
    {
        private const SymbolDisplayPartKind @base = SymbolDisplayPartKind.PreprocessingName + 1;
    ...
    internal static partial class EnumBounds
    {
        ...
        {
            return (value >= SymbolDisplayPartKind.AliasName && value <= SymbolDisplayPartKind.PreprocessingName) ||
