...
namespace Roslyn.Utilities
{
    internal static class GeneratedCodeUtilities
    {
        ...
        internal static bool IsGeneratedCode(AdditionalText additionalText)
        {
            return IsGeneratedCodeFile(additionalText.Path);
        }
        ...
        internal static bool IsGeneratedCodeFile([NotNullWhen(returnValue: true)] string? filePath)
        {
