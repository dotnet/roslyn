...
namespace Microsoft.CodeAnalysis
{
    internal sealed class AssociateNode<TInput1, TInput2> : IIncrementalGeneratorNode<(TInput1, TInput2)>
    {
        ...
        public AssociateNode(IIncrementalGeneratorNode<TInput1> input1, IIncrementalGeneratorNode<TInput2> input2, IEqualityComparer<(TInput1, ImmutableArray<TInput2>)>? comparer = null)
        {
            _input1 = input1;
            _input2 = input2;
            _comparer = comparer;
        ...
        public IIncrementalGeneratorNode<(TInput1, ImmutableArray<TInput2>)> WithComparer(IEqualityComparer<(TInput1, ImmutableArray<TInput2>)> comparer) => new AssociateNode<TInput1, TInput2>(_input1, _input2, comparer);
