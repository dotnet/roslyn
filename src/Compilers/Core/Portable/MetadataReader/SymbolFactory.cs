...
namespace Microsoft.CodeAnalysis
{
        ...
        where TypeSymbol : class
    {
        ...
        internal abstract TypeSymbol GetArrayTypeSymbol(ModuleSymbol moduleSymbol, int rank, TypeSymbol elementType);
        ...
        /// </param>
        internal abstract TypeSymbol SubstituteTypeParameters(ModuleSymbol moduleSymbol, TypeSymbol generic, ImmutableArray<TypeSymbol> arguments, ImmutableArray<bool> refersToNoPiaLocalType);

        internal abstract TypeSymbol GetByRefReturnTypeSymbol(ModuleSymbol moduleSymbol, TypeSymbol referencedType);
