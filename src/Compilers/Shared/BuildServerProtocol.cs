...
// This file contains the wire protocol types and logging infrastructure used to
// communicate between compiler clients (csc, vbc, MSBuild task) and the VBCSCompiler
// server. It is shared as source between all of these projects. Do not add types
// here that are not related to the build server protocol.
//
