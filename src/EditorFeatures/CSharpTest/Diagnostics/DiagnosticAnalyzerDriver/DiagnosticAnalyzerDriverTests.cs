...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Diagnostics.UserDiagnosticProviderEngine
{
    public class DiagnosticAnalyzerDriverTests
    {
        ...
        public async Task DiagnosticAnalyzerDriverAllInOne()
        {
            ...
            using (var workspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source, TestOptions.Regular))
            {
...
";
            ...
            using (var ideEngineWorkspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source))
            {
            ...
            using (var compilerEngineWorkspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source))
            {
        ...
        {
            using (var workspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(TestResource.AllInOneCSharpCode, TestOptions.Regular))
            {
