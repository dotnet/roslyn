...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Diagnostics.UserDiagnosticProviderEngine
{
    public class DiagnosticAnalyzerDriverTests
    {
        ...
        public async Task DiagnosticAnalyzerDriverAllInOne()
        {
            ...
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(source, TestOptions.Regular))
            {
...
";
            ...
            using (var ideEngineWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(source))
            {
            ...
            using (var compilerEngineWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(source))
            {
        ...
        {
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(TestResource.AllInOneCSharpCode, TestOptions.Regular))
            {
