...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Diagnostics.UserDiagnosticProviderEngine
{
    public class DiagnosticAnalyzerDriverTests
    {
        ...
        public async Task DiagnosticAnalyzerDriverAllInOne()
        {
            ...
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source, TestOptions.Regular))
            {
...
";
            ...
            using (var ideEngineWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source))
            {
            ...
            using (var compilerEngineWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source))
            {
        ...
        {
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(TestResource.AllInOneCSharpCode, TestOptions.Regular))
            {
