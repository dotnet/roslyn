...
static class Test { int a = MyStruct.Some$$Field; }";
            ...
            await TestAsync(markup,
                MainDescription($"(static {FeaturesResources.field}) int MyStruct.SomeField"));
        }
...
static class Test { static void Method() { int a = MyStruct.Some$$Field; } }";
        ...
        public async Task TestMetadataFieldMinimal()
        {
            await TestInMethodAsync(@"DateTime dt = DateTime.MaxValue$$",
                MainDescription($"(static readonly {FeaturesResources.field}) DateTime DateTime.MaxValue"));
        }
...
@"class C {
    void M()
    {
        DateTime dt = System.DateTime.MaxValue$$
            ...
            await TestAsync(markup,
                MainDescription($"(static readonly {FeaturesResources.field}) System.DateTime System.DateTime.MaxValue"));
        }
