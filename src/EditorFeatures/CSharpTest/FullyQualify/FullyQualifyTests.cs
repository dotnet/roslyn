...
class Class
{
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(527360, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/527360")]
...
class Goo
{
    void Bar()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(538018, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538018")]
...
@"class Class
{
    void Test()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(538136, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538136")]
...
namespace B
{
    namespace C
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(527395, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/527395")]
...
@"class Class { void Test() { /*goo*/System.Collections.Generic.List<int> l; } }", testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(538740, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538740")]
...
class Test
{
    Program.Inner i;
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(26887, "https://github.com/dotnet/roslyn/issues/26887")]
...
class Test
{
    [|Inner|] i;
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(538764, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538764")]
...
class C
{
    Alias.Int32 i;
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(538763, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/538763")]
...
index: 1, testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(539853, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/539853")]
...
parseOptions: GetScriptOptions(), testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(540318, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540318")]
...
class Program
{
    static void Main(string[] args)
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(540942, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540942")]
...
class C
{
    static void Main(string[] args)
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(542643, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/542643")]
...
@"[assembly: System.Runtime.CompilerServices.InternalsVisibleTo(""Project"")]", testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(543388, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/543388")]
...
class M
{
    ...
    static extern int? My();
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(544950, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544950")]
...
class Program
{
    static void Main(string[] args)
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(545774, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545774")]
...
@"[ assembly : System.Runtime.InteropServices.Guid( ""9ed54f84-a89d-4fcd-a854-44251e925f09"" ) ] ", testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(546027, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546027")]
...
namespace n2
{
    class A
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(995857, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/995857")]
...
public class Program
{
    static void M()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(11071, "https://github.com/dotnet/roslyn/issues/11071")]
...
@"class Class
{
    (System.Collections.IDictionary a, string) Method()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(18275, "https://github.com/dotnet/roslyn/issues/18275")]
...
class C
{
    void M()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(18623, "https://github.com/dotnet/roslyn/issues/18623")]
...
class Program : [|IReadOnlyCollection|]
{
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(19575, "https://github.com/dotnet/roslyn/issues/19575")]
...
class C
{
    private void GetEvaluationRuleNames()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(49986, "https://github.com/dotnet/roslyn/issues/49986")]
...
class Class
{
    void Test()
    {
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(51274, "https://github.com/dotnet/roslyn/issues/51274")]
...
@"using M = System.Math", testHost: testHost);
        ...
        [ConditionalTheory, CombinatorialData, WorkItem(54544, "https://github.com/dotnet/roslyn/issues/54544")]
