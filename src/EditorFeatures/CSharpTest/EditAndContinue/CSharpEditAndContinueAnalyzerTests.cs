...
";
            ...
            using (var workspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source1))
            {
...
";
            ...
            using (var workspace = await CSharpWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(source))
            {
