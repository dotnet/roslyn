                ...
                new[]
                {
                    DocumentResults(
                        semanticEdits: new[]
                        {
                            ...
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IPropertySymbol>("P1"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IPropertySymbol>("P2"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMembers("this[]").Cast<IPropertySymbol>().Single(m => m.GetParameters().Single().Type.Name == "Int32"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMembers("this[]").Cast<IPropertySymbol>().Single(m => m.GetParameters().Single().Type.Name == "Byte"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IEventSymbol>("E"), preserveLocalVariables: false),
                            ...
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IEventSymbol>("EF"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IFieldSymbol>("F1"), preserveLocalVariables: false),
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember<IFieldSymbol>("F2"), preserveLocalVariables: false),
                        })
                });
        }
...
partial class C { IEnumerable<int> F() { yield 1; } }
";
            var srcB1 = "partial class C { }";
...
partial class C { IEnumerable<int> F() { yield 1; yield 2; } }
";
            ...
            EditAndContinueValidation.VerifySemantics(
                ...
                new[]
                {
                    ...
                    DocumentResults(
                        semanticEdits: new[]
                        {
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").GetMember("puts"))
                        })
                });
        }
    ...
    static void Main(string[] args)
    {
        ...
        public void InstanceCtorDelete_Public_PartialWithInitializerUpdate()
        {
            ...
            EditAndContinueValidation.VerifySemantics(
                ...
                {
                    DocumentResults(
                        semanticEdits: new[] { SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").InstanceConstructors.Single(), partialType: "C") }),
...
";
            ...
            EditAndContinueValidation.VerifySemantics(
                ...
                new[]
                {
                    ...
                    DocumentResults(semanticEdits: new[]
                    {
                       SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").Constructors.First()),
                       SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").Constructors.Skip(1).First()),
                       SemanticEdit(SemanticEditKind.Insert, c => c.GetMember<INamedTypeSymbol>("C").Constructors.Skip(2).First()),
                    })
                });
        }
                ...
                new[]
                {
                    ...
                    DocumentResults(
                        semanticEdits: new[]
                        {
                            ...
                            SemanticEdit(SemanticEditKind.Update, c => c.GetMember<INamedTypeSymbol>("C").InstanceConstructors.Single(), partialType: "C")
                        }),
                });
        }
...
";
        ...
        public void PrivateAutoPropertyAccessorDelete_Set()
        {
            ...
            edits.VerifyEdits("Delete [get;]@23");
        ...
        {
            var src1 = "class C { int this[int a] { set { } } }";
        ...
        {
            var src1 = "class C { int this[int a] { init { } } }";
