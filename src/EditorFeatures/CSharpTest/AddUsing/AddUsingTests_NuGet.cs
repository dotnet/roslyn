...
@"class C
{
    NuGetType n;
        ...
        private Task<IList<PackageWithTypeResult>> CreateSearchResultAsync(
        ...
        private Task<IList<PackageWithTypeResult>> CreateSearchResultAsync(params PackageWithTypeResult[] results)
