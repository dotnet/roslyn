...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.AddUsing
{
    ...
    public class AddUsingNuGetTests : AbstractAddUsingTests
    {
        ...
        private static readonly Task<ImmutableArray<PackageSource>> NugetPackageSources =
            Task.FromResult(ImmutableArray.Create(new PackageSource(NugetOrgSource, "http://nuget.org/")));
        ...
        public async Task TestSearchPackageSingleName()
        {
            ...
            installerServiceMock.Setup(i => i.GetPackageSourcesAsync(It.IsAny<CancellationToken>())).Returns(NugetPackageSources);
