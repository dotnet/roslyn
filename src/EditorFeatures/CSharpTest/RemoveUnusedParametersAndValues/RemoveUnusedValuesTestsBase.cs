...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.RemoveUnusedParametersAndValues
{
    public abstract class RemoveUnusedValuesTestsBase : AbstractCSharpDiagnosticProviderBasedUserDiagnosticTest
    {
        ...
        private protected abstract IDictionary<OptionKey2, object> PreferNone { get; }
        private protected abstract IDictionary<OptionKey2, object> PreferDiscard { get; }
        private protected abstract IDictionary<OptionKey2, object> PreferUnusedLocal { get; }

        private protected IDictionary<OptionKey2, object> GetOptions(string optionName)
        {
            switch (optionName)
            {
        ...
        private protected Task TestMissingInRegularAndScriptAsync(string initialMarkup, IDictionary<OptionKey2, object> options, ParseOptions parseOptions = null)
