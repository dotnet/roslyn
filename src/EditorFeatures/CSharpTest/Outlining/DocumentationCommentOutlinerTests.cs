...
{
    public class DocumentationCommentOutlinerTests : AbstractOutlinerTests<DocumentationCommentTriviaSyntax>
    {
        internal override AbstractSyntaxNodeOutliner<DocumentationCommentTriviaSyntax> CreateOutliner()
        {
