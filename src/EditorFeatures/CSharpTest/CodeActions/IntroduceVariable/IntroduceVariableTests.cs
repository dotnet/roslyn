    ...
    @"class Program
{
    static void Main(string a, string b)
    {
        var reducedextension = new Program().Bar(1, [|2|], 3);
    }
}

static class ProgramExtensions
{
    public static int Bar(this Program p, int x, int y, int z)
    { return 1; }
}";
            var expected =
    @"class Program
{
    static void Main(string a, string b)
    {
        const int {|Rename:y|} = 2;
        var reducedextension = new Program().Bar(1, y, 3);
    }
}
