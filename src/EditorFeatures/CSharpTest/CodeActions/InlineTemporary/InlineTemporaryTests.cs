...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.CodeRefactorings.InlineTemporary
{
    public class InlineTemporaryTests : AbstractCSharpCodeActionTest
    {
        ...
        {
            await TestInRegularAndScriptAsync(GetTreeText(initial), GetTreeText(expected), index: 0);
        }
...
{ 
    static void Main()
    {
        System.Array a = new int[] { 3, 4, 5 };
            ...
            await TestInRegularAndScriptAsync(initial, expected, index: 0, compareTokens: false);
        }
...
class Program
{
    void Main()
    {
        ...
        Console.WriteLine(1);
            ...
            await TestInRegularAndScriptAsync(initial, expected, index: 0);
        }
