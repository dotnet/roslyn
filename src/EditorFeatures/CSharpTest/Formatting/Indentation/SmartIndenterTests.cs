...
";
        ...
        private static async Task AssertSmartIndentInProjectionAsync(string markup, int expectedIndentation, CSharpParseOptions options = null)
        {
            ...
            {
                using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(markup, parseOptions: option))
                {
            ...
            CSharpParseOptions options = null)
        {
            ...
            foreach (var option in optionsSet)
            {
                using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(code, parseOptions: option))
                {
