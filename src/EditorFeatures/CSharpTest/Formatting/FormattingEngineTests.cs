...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Formatting
{
    public class FormattingEngineTests : CSharpFormattingEngineTestBase
    {
        ...
        private static Dictionary<OptionKey2, object> SmartIndentButDoNotFormatWhileTyping()
        {
            ...
            {
                { new OptionKey2(AutoFormattingOptions.SmartIndent, LanguageNames.CSharp), FormattingOptions.IndentStyle.Smart },
                { new OptionKey2(AutoFormattingOptions.AutoFormattingOnTyping, LanguageNames.CSharp),  false },
                { new OptionKey2(AutoFormattingOptions.AutoFormattingOnCloseBrace, LanguageNames.CSharp),  false },
            };
        }
    ...
    class C1<U>
{
            ...
            var optionSet = new Dictionary<OptionKey2, object>
                            {
                                { new OptionKey2(AutoFormattingOptions.SmartIndent, LanguageNames.CSharp), FormattingOptions.IndentStyle.None }
                            };
...
";
            ...
            var optionSet = new Dictionary<OptionKey2, object>
            {
                    { new OptionKey2(AutoFormattingOptions.AutoFormattingOnSemicolon, LanguageNames.CSharp), false }
            };
