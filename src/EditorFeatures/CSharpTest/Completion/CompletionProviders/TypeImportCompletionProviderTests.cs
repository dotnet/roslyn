...
namespace Baz
{
    class Bat
    {
         $$
            ...
            AssertRelativeOrder(new List<string>() { "SomeType", "SomeTypeWithLongerName" }, completionList.ItemsInternal.ToImmutableArray());
        }
...
namespace Foo
{
    using CollectionOfStringBuilders = System.Collections.Generic.List<Foo.Bar.MyClass$$>
        ...
        public async Task TriggerCompletionInSubsequentSubmission()
        {
            ...
            Assert.NotEmpty(completionList.ItemsInternal);
        }
