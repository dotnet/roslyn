...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Completion.CompletionProviders
{
    ...
    public class LoadDirectiveCompletionProviderTests : AbstractCSharpCompletionProviderTests
    {
        ...
        public void ShouldTriggerCompletion(string textWithPositionMarker, bool expectedResult)
        {
            ...
            Assert.Equal(expectedResult, provider.ShouldTriggerCompletion(languageServices.ProjectServices, SourceText.From(text), position, trigger: default, CompletionOptions.Default, OptionValueSet.Empty));
        }
    }
}
