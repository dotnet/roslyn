    ...
    public class Class1
    {
        ...
        public virtual void Bar() {}
            ...
            using (var workspace = TestWorkspace.Create(text))
            {
                ...
                var reference = MetadataReference.CreateFromImage(Test.Utilities.CompilationTestUtilities.EmitToArray(compilation));
...
";
                ...
                var libRef = MetadataReference.CreateFromImage(Test.Utilities.CompilationTestUtilities.EmitToArray(libComp));
