...
class C
{
            ...
            using (var workspace = await TestWorkspaceFactory.CreateWorkspaceAsync(LanguageNames.CSharp, new CSharpCompilationOptions(OutputKind.ConsoleApplication), new CSharpParseOptions(), new[] { text }, exportProvider))
            {
