...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    ...
    internal partial class CSharpFormattingInteractionService : IFormattingInteractionService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(Formatter.GetFormattedTextChanges(parsedDocument.Root, SpecializedCollections.SingletonEnumerable(formattingSpan), parsedDocument.SolutionServices, options, cancellationToken).ToImmutableArray());
        }
