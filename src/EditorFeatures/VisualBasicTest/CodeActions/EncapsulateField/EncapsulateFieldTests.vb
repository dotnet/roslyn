...
End Class</File>.ConvertTestSourceTag()
            ...
            Await TestInRegularAndScriptAsync(text, expected, compareTokens:=False, index:=0)
...
End Class</File>.ConvertTestSourceTag()
            ...
            Await TestInRegularAndScriptAsync(text, expected, compareTokens:=False, index:=1)
        End Function
...
End Class</File>.ConvertTestSourceTag()
            ...
            Await TestInRegularAndScriptAsync(text, expected, compareTokens:=False, index:=0, options:=[Option](CodeStyleOptions.QualifyFieldAccess, True, NotificationOption.Error))
