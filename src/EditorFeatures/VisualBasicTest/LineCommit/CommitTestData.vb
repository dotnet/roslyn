    ...
    Friend Class CommitTestData
        ...
        Private Class FormatterMock
            ...
            Public Sub CommitRegion(spanToFormat As SnapshotSpan,
                ...
                Dim realCommitFormatter As New CommitFormatter(_testWorkspace.GetService(Of IIndentationManagerService), _testWorkspace.GetService(Of IEditorOptionsFactoryService))
