...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.Recommendations
    Public Module RecommendationTestHelpers
        ...
        Friend Async Function VerifyRecommendationsWithPriority(testSource As XElement, priority As MatchPriority, ParamArray recommendations As String()) As Task
        ...
        Private Async Function VerifyRecommendationsContainNothingTypedAsync(source As String, priority As MatchPriority?, ParamArray recommendations As String()) As Task
        ...
        Private Async Function VerifyRecommendationsContainPartiallyTypedAsync(source As String, priority As MatchPriority?, ParamArray recommendations As String()) As Task
