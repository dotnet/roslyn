...
Imports S |
        ...
        <WpfFact, Trait(Traits.Feature, Traits.Features.KeywordRecommending), WorkItem(544278)>
        Public Sub NoneAfterMidStatement()
            VerifyRecommendationsMissing(<MethodBody>Mid(s, 1, 1) |</MethodBody>, s_expectedKeywords)
        End Sub

        <WpfFact, Trait(Traits.Feature, Traits.Features.KeywordRecommending), WorkItem(544576)>
        ...
        <WpfFact, Trait(Traits.Feature, Traits.Features.KeywordRecommending), WorkItem(545988)>
        Public Sub NoneAfterNamedArgument()
            VerifyRecommendationsMissing(<MethodBody>Foo(f:=|</MethodBody>, s_expectedKeywords)
        End Sub

        <WpfFact, Trait(Traits.Feature, Traits.Features.KeywordRecommending), WorkItem(546659)>
        Public Sub NoneInUsingStatement()
            VerifyRecommendationsMissing(<MethodBody>Using Foo |</MethodBody>, s_expectedKeywords)
        End Sub

        <WpfFact, Trait(Traits.Feature, Traits.Features.KeywordRecommending), WorkItem(531329)>
