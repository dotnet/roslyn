...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.Diagnostics.FullyQualify
    ...
    Public Class FullyQualifyTests
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue)>
...
End Namespace", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540559, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540559")>
...
End Namespace", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540560, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540560")>
...
End Namespace", New TestParameters(testHost:=testHost))
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540673, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540673")>
...
End Namespace", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540543, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540543")>
...
End Namespace", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540706, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540706")>
...
End Class")
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540736, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540736")>
...
End Class", New TestParameters(testHost:=testHost))
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(540745, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/540745")>
...
End Namespace", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(821292, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/821292")>
...
End Module", testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(545993, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/545993")>
...
End Module", New TestParameters(testHost:=testHost))
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(546107, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546107")>
...
End Module</Text>.Value.Replace(vbLf, vbCrLf), testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(775448, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/775448")>
...
End Module</Text>.Value.Replace(vbLf, vbCrLf), testHost:=testHost)
        ...
        <ConditionalTheory(GetType(IsNot32BitDebug), Reason:=ConditionalSkipReason.TestIsTriggeringMessagePackIssue), WorkItem(947579, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/947579")>
