...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.CodeActions.AddImport
    Public Class AddImportNuGetTests
        ...
        Private Shared ReadOnly NugetPackageSources As Task(Of ImmutableArray(Of PackageSource)) =
        ...
        Public Async Function TestSearchPackageSingleName() As Task
            ...
            installerServiceMock.Setup(Function(i) i.GetPackageSourcesAsync(It.IsAny(Of CancellationToken))).Returns(NugetPackageSources)
