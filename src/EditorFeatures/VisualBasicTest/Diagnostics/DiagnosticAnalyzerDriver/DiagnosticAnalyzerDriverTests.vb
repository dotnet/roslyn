...
End Class
        ...
        Using ideEngineWorkspace = Await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(source.Value)
        ...
        Using compilerEngineWorkspace = Await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(source.Value)
    ...
    Public Async Function AnalyzerOptionsArePassedToAllAnalyzers() As Task
        Using workspace = Await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(TestResource.AllInOneVisualBasicCode)
