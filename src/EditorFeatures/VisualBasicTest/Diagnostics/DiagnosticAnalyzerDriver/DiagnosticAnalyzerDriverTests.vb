...
End Class
        ...
        Using ideEngineWorkspace = Await TestWorkspaceFactory.CreateVisualBasicAsync(source.Value)
        ...
        Using compilerEngineWorkspace = Await TestWorkspaceFactory.CreateVisualBasicAsync(source.Value)
    ...
    Public Async Function AnalyzerOptionsArePassedToAllAnalyzers() As Task
        Using workspace = Await TestWorkspaceFactory.CreateVisualBasicAsync(TestResource.AllInOneVisualBasicCode)
