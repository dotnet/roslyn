...
End Class
            ...
            TestExactActionSetOffered(code.ConvertTestSourceTag(), {String.Format(FeaturesResources.ChangeTo1, "Function", "Sub"), String.Format(VBFeaturesResources.DeleteTheStatement, "Exit Function")})
        End Sub
