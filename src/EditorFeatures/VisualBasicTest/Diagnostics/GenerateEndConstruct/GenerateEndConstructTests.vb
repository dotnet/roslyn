...
End If</MethodBody>
            ...
            Await TestInRegularAndScriptAsync(text.ConvertTestSourceTag(), expected.ConvertTestSourceTag(), compareTokens:=False)
        End Function
...
Structure Foo[||]</File>
            ...
            Await TestInRegularAndScriptAsync(text.ConvertTestSourceTag(), expected, compareTokens:=False)
        End Function
