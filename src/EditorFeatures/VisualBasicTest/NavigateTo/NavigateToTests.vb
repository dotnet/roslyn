...
End Class", Async Function(w)
                ...
                VerifyNavigateToResultItem(item, "DoSomething", "[|D|]o[|S|]omething()", PatternMatchKind.Fuzzy, NavigateToItemKind.Method,
...
End Class", Async Function(w)
                ...
                {
                    New NavigateToItem("Goo", NavigateToItemKind.Class, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing),
                    New NavigateToItem("Goo", NavigateToItemKind.Class, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing)
                }
...
End Class", Async Function(w)
                Dim item As NavigateToItem = (Await _aggregator.GetItemsAsync("DS")).Single()
                VerifyNavigateToResultItem(item, "DoSomething", "[|D|]o[|S|]omething(Integer, String)", PatternMatchKind.Fuzzy, NavigateToItemKind.Method, Glyph.MethodPrivate, String.Format(FeaturesResources.in_0_project_1, "Goo", "Test"))
            End Function)
        End Function
...
End Class", Async Function(w)
                ...
                Dim expecteditems = New List(Of NavigateToItem) From
                {
                    New NavigateToItem("Bar", NavigateToItemKind.Method, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing),
                    New NavigateToItem("Bar", NavigateToItemKind.Method, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing)
                }
...
sub Quux()
                    ...
                    Dim expecteditems = New List(Of NavigateToItem) From
                        {
                            New NavigateToItem("Quux", NavigateToItemKind.Method, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Prefix, True, True, ImmutableArray(Of Span).Empty), Nothing)
                        }
...
sub Quux()
                    ...
                    Dim expecteditems = New List(Of NavigateToItem) From
                        {
                            New NavigateToItem("Quux", NavigateToItemKind.Method, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing)
                        }
...
End Module", Async Function(w)
                 ...
                 VerifyNavigateToResultItem(item, "ModuleTest", "[|M|]odule[|T|]est", PatternMatchKind.Fuzzy, NavigateToItemKind.Module, Glyph.ModuleInternal)
             End Function)
        End Function
...
End Class", Async Function(w)
                Dim expectedItems = New List(Of NavigateToItem) From
                    {
                        New NavigateToItem("Goo", NavigateToItemKind.Method, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing),
                        New NavigateToItem("Goo", NavigateToItemKind.Class, "vb", Nothing, Nothing, New PatternMatch(PatternMatchKind.Exact, True, True, ImmutableArray(Of Span).Empty), Nothing)
                    }
