...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.ExtractMethod
    Partial Public Class ExtractMethodTests
        Protected Shared Async Function ExpectExtractMethodToFailAsync(codeWithMarker As XElement, Optional dontPutOutOrRefOnStruct As Boolean = True) As Tasks.Task
            ...
            Using workspace = Await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFileAsync(codeWithoutMarker)
        ...
        Protected Overloads Shared Async Function TestExtractMethodAsync(
            ...
            Using workspace = Await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFilesAsync(New String() {codeWithMarker}, metadataReferences:=metadataReferences, compilationOptions:=New VisualBasicCompilationOptions(OutputKind.DynamicallyLinkedLibrary))
