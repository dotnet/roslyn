...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.EndConstructGeneration
    ...
    Public Class EndConstructCommandHandlerTests
        Private _endConstructServiceMock As New Mock(Of IEndConstructGenerationService)(MockBehavior.Strict)
        Private _featureOptions As New Mock(Of IOptionService)(MockBehavior.Strict)
        Private _textViewMock As New Mock(Of ITextView)(MockBehavior.Strict)
        Private _textBufferMock As New Mock(Of ITextBuffer)(MockBehavior.Strict)
