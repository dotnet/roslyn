...
End Class]]></a>.Value.NormalizeLineEndings()
            ...
            Using workspace = Await TestWorkspaceFactory.CreateAsync(LanguageNames.VisualBasic, New VisualBasicCompilationOptions(OutputKind.ConsoleApplication), New VisualBasicParseOptions(), {text}, exportProvider)
