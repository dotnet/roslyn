...
End Class</a>.Value
            ...
            Await BaseVerifyWorkerAsync(code, position, "[Class]()", "Sub CBase.Class()", SourceCodeKind.Regular, False, False, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False)
        End Function
...
End Class</a>.Value
            ...
            Await BaseVerifyWorkerAsync(
                ...
                SourceCodeKind.Regular, False, False, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False)
        End Function
