...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    {
        protected abstract Task<TestWorkspace> CreateWorkspaceFromFile(string definition, ParseOptions parseOptions);
        ...
        {
            using (var workspace = await CreateWorkspaceFromFile(code, options))
            {
