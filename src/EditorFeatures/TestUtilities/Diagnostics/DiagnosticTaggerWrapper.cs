...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
        ...
        where TTag : ITag
    {
            ...
            bool createTaggerProvider = true)
        {
            ...
            workspace.GlobalOptions.SetGlobalOption(new OptionKey(SolutionCrawlerOptions.BackgroundAnalysisScopeOption, LanguageNames.CSharp), BackgroundAnalysisScope.OpenFiles);
            workspace.GlobalOptions.SetGlobalOption(new OptionKey(SolutionCrawlerOptions.BackgroundAnalysisScopeOption, LanguageNames.VisualBasic), BackgroundAnalysisScope.OpenFiles);
