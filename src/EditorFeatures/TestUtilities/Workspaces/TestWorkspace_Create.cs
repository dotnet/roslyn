...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Workspaces
{
    public partial class TestWorkspace
    {
        ...
        public static TestWorkspace CreateCSharp(
            ...
            bool openDocuments = false)
        {
            return CreateCSharp(new[] { file }, [], parseOptions, compilationOptions, composition, metadataReferences, isMarkup, openDocuments);
        }
        ...
        public static TestWorkspace CreateVisualBasic(
            ...
            bool openDocuments = false)
        {
            return CreateVisualBasic(new[] { file }, [], parseOptions, compilationOptions, composition, metadataReferences, openDocuments);
        }
