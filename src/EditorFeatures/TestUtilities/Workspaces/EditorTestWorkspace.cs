...
public partial class EditorTestWorkspace : TestWorkspace
{
    ...
    public new EditorTestHostDocument DocumentWithCursor => (EditorTestHostDocument)base.DocumentWithCursor;
    public new IList<EditorTestHostDocument> Documents => (IList<EditorTestHostDocument>)base.Documents;
    public new IList<EditorTestHostDocument> AdditionalDocuments => (IList<EditorTestHostDocument>)base.AdditionalDocuments;
    public new IList<EditorTestHostDocument> AnalyzerConfigDocuments => (IList<EditorTestHostDocument>)base.AnalyzerConfigDocuments;
    public new IList<EditorTestHostDocument> ProjectionDocuments => (IList<EditorTestHostDocument>)base.ProjectionDocuments;

    public new EditorTestHostDocument? GetTestDocument(DocumentId documentId)
        => (EditorTestHostDocument?)Documents.FirstOrDefault(d => d.Id == documentId);

    public new EditorTestHostDocument? GetTestAdditionalDocument(DocumentId documentId)
        => (EditorTestHostDocument?)AdditionalDocuments.FirstOrDefault(d => d.Id == documentId);

    public new EditorTestHostDocument? GetTestAnalyzerConfigDocument(DocumentId documentId)
        => (EditorTestHostDocument?)AnalyzerConfigDocuments.FirstOrDefault(d => d.Id == documentId);
