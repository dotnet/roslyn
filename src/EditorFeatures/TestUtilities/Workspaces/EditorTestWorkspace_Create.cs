...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Workspaces
{
    ...
    {
        public static new EditorTestWorkspace Create(string xmlDefinition, bool openDocuments = false, TestComposition composition = null)
            => Create(XElement.Parse(xmlDefinition), openDocuments, composition);

        public static new EditorTestWorkspace CreateWorkspace(
        ...
        internal static new EditorTestWorkspace Create(
            XElement workspaceElement,
            bool openDocuments = true,
            TestComposition composition = null,
            string workspaceKind = null,
        ...
        internal static new EditorTestWorkspace CreateWithSingleEmptySourceFile(
            string language,
            CompilationOptions compilationOptions,
            ParseOptions parseOptions,
        ...
        public static new EditorTestWorkspace CreateCSharp(
            string file,
        ...
        public static new EditorTestWorkspace CreateVisualBasic(
            string file,
            ParseOptions parseOptions = null,
            CompilationOptions compilationOptions = null,
            TestComposition composition = null,
