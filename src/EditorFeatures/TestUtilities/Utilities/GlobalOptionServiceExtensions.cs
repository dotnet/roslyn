...
internal static class GlobalOptionServiceExtensions
{
    /// <summary>
    /// Sets options stored in <see cref="OptionsCollection"/> that are read by command handlers from the text editor to given <see cref="IEditorOptions"/>.
    /// </summary>
