...
{
    extension(ExportProvider exportProvider)
    {
        public TCommandHandler GetCommandHandler<TCommandHandler>(string name)
        ...
        public TCommandHandler GetCommandHandler<TCommandHandler>(string name, string contentType)
            where TCommandHandler : ICommandHandler
        {
