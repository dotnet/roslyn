...
'                Await goToDefService.FindDefinitionLocationAsync(document, cursorPosition, CancellationToken.None);
...
'                Await handler.GetTestAccessor().(document, cursorPosition, goToDefService, New CommandExecutionContext(waitContext))
