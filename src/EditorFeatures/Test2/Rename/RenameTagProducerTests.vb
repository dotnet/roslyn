...
Namespace Microsoft.CodeAnalysis.Editor.UnitTests.Rename
    ...
    Public Class RenameTagProducerTests
        ...
        Private Shared Async Function VerifyAnnotatedTaggedSpans(tagType As TextMarkerTag, annotationString As String, actualWorkspace As EditorTestWorkspace, renameService As InlineRenameService, expectedTaggedWorkspace As TestWorkspace) As Task
