...
Namespace Microsoft.CodeAnalysis.Editor.UnitTests.Rename
    Friend Module RenameTestHelpers
        ...
        Public Async Function WaitForRename(workspace As TestWorkspace) As Task
            ...
            Await provider.WaitAllDispatcherOperationAndTasksAsync(willBlockOnCompletion:=True, FeatureAttribute.EventHookup, FeatureAttribute.Rename, FeatureAttribute.RenameTracking)
        End Function
