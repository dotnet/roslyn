...
Imports VSC2 = Microsoft.VisualStudio.Text.UI.Commanding

Namespace Microsoft.CodeAnalysis.Editor.UnitTests.Rename
    'Module ICommandHandlerExtensions
    '    <Extension>
    '    Public Function ExecuteCommand(Of T As VSC.CommandArgs)(handler As VSC2.ICommandHandler, args As T, successor As Func(Of T, Boolean)) As Boolean
    '        Dim typedHandler = DirectCast(handler, VSC2.ICommandHandler(Of T))
    '        If Not typedHandler.ExecuteCommand(args) Then
    '            successor(args)
    '        End If
    '    End Function
    'End Module
    ...
    Public Class RenameCommandHandlerTests
        ...
        Public Sub RenameCommandInvokesInlineRename()
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                Assert.True(CreateCommandHandler(workspace).ExecuteCommand(New VSC.RenameCommandArgs(view, view.TextBuffer)))
        ...
        Public Sub RenameCommandDisabledInSubmission()
            ...
            Using workspace = TestWorkspace.Create(
                ...
                Dim state = handler.GetCommandState(New VSC.RenameCommandArgs(textView, textView.TextBuffer))
...
End Class
                ...
                Chain(DirectCast(commandHandler, VSC2.ICommandHandler(Of VSC.TypeCharCommandArgs)),
                      Function(unused) editorOperations.InsertText("p"),
                      New VSC.TypeCharCommandArgs(view, view.TextBuffer, "p"c))

                Assert.Equal("    p", view.Caret.Position.BufferPosition.GetContainingLine.GetText())
            End Using
        End Sub

        Private Sub Chain(Of T As VSC.CommandArgs)(handler As VSC2.ICommandHandler(Of T), successor As Func(Of T, Boolean), args As T)
            If Not handler.ExecuteCommand(args) Then
                successor(args)
            End If
        End Sub
        ...
        Public Sub RenameCommandNotActiveWhenNotTouchingIdentifier()
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                Dim commandState = commandHandler.GetCommandState(New VSC.RenameCommandArgs(view, view.TextBuffer))

                Assert.False(commandState.IsAvailable)
            End Using
        End Sub
        ...
        Public Sub TypingSpaceDuringRename()
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                Assert.True(commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(view, view.TextBuffer, " "c)))
        ...
        Public Async Function TypingTabDuringRename() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                commandHandler.ExecuteCommand(New VSC.TabKeyCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Tab should not have been passed to the editor."))
...
Foo f;
                ...
                commandHandler.ExecuteCommand(New VSC.SelectAllCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Ctrl+A should not have been passed to the editor."))
                Assert.Equal(identifierSpan, view.Selection.SelectedSpans.Single().Span)
                Assert.Equal(identifierSpan.End, view.Caret.Position.BufferPosition.Position)

                commandHandler.ExecuteCommand(New VSC.SelectAllCommandArgs(view, view.TextBuffer), Sub() editorOperations.SelectAll())
...
class [|$$Foo|] // comment
{
                ...
                commandHandler.ExecuteCommand(New VSC.WordDeleteToEndCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Command should not have been passed to the editor."))
                ...
                commandHandler.ExecuteCommand(New VSC.WordDeleteToStartCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Command should not have been passed to the editor."))
...
#Region "LineStart"
                ...
                commandHandler.ExecuteCommand(New VSC.LineStartCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Home should not have been passed to the editor."))
                ...
                commandHandler.ExecuteCommand(New VSC.LineStartCommandArgs(view, view.TextBuffer), Sub() editorOperations.MoveToStartOfLine(extendSelection:=False))
...
#Region "LineStartExtend"
                ...
                commandHandler.ExecuteCommand(New VSC.LineStartExtendCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Shift+Home should not have been passed to the editor."))
                ...
                commandHandler.ExecuteCommand(New VSC.LineStartExtendCommandArgs(view, view.TextBuffer), Sub() editorOperations.MoveToStartOfLine(extendSelection:=True))
...
#Region "LineEnd"
                ...
                commandHandler.ExecuteCommand(New VSC.LineEndCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("End should not have been passed to the editor."))
                Assert.Equal(0, view.Selection.SelectedSpans.Single().Span.Length)
                Assert.Equal(identifierSpan.End, view.Caret.Position.BufferPosition.Position)

                ' LineEnd again should move to the end of the line
                commandHandler.ExecuteCommand(New VSC.LineEndCommandArgs(view, view.TextBuffer), Sub() editorOperations.MoveToEndOfLine(extendSelection:=False))
...
#Region "LineEndExtend"
                ...
                commandHandler.ExecuteCommand(New VSC.LineEndExtendCommandArgs(view, view.TextBuffer), Sub() AssertEx.Fail("Shift+End should not have been passed to the editor."))
                ...
                commandHandler.ExecuteCommand(New VSC.LineEndExtendCommandArgs(view, view.TextBuffer), Sub() editorOperations.MoveToEndOfLine(extendSelection:=True))
...
#End Region
        ...
        Public Async Function TypingTypeCharacterDuringRename() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                Chain(DirectCast(commandHandler, VSC2.ICommandHandler(Of VSC.TypeCharCommandArgs)),
                      Function(unused) editorOperations.InsertText("$"),
                      New VSC.TypeCharCommandArgs(view, view.TextBuffer, "$"c))
        ...
        Public Async Function TypingInOtherPartsOfFileTriggersCommit() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                view.Selection.Clear()
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                Dim typedHandler = DirectCast(commandHandler, VSC2.ICommandHandler(Of VSC.TypeCharCommandArgs))

                Chain(typedHandler,
                      Function(unused) editorOperations.InsertText("B"),
                      New VSC.TypeCharCommandArgs(view, view.TextBuffer, "B"c))
                ...
                Chain(typedHandler,
                      Function(unused) editorOperations.InsertText("Z"),
                      New VSC.TypeCharCommandArgs(view, view.TextBuffer, "Z"c))
        ...
        Public Async Function DeletingInEditSpanPropagatesEdit() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                commandHandler.ExecuteCommand(New VSC.DeleteKeyCommandArgs(view, view.TextBuffer), Function() editorOperations.Delete())
        ...
        Public Async Function BackspacingInEditSpanPropagatesEdit() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                ' Delete the first identifier char
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                commandHandler.ExecuteCommand(New VSC.BackspaceKeyCommandArgs(view, view.TextBuffer), Function() editorOperations.Backspace())
        ...
        Public Async Function DeletingInOtherPartsOfFileTriggersCommit() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                ' Type first in the main identifier
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(view, view.TextBuffer, "B"c),
                    Function(args) editorOperations.InsertText(args.TypedChar))
        ...
        Public Async Function TypingInOtherFileTriggersCommit() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                ' Type first in the main identifier
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(view, view.TextBuffer, "B"c), Function() editorOperations.InsertText("B"))
                ...
                commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(newview, newview.TextBuffer, "Z"c), Function() editorOperations.InsertText("Z"))
...
class Program
{
    ...
    static void [|Main|](string[] args)
    {
                ...
                commandHandler.ExecuteCommand(New VSC.RenameCommandArgs(view, view.TextBuffer))
                commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(view, view.TextBuffer, "Z"c), Function() editorOperations.InsertText("Z"))
                commandHandler.ExecuteCommand(New VSC.ReturnKeyCommandArgs(view, view.TextBuffer), Sub() Exit Sub)
...
partial class [|Program|]
{
        ...
        Public Sub TypingCtrlEnterDuringRenameCSharp()
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                commandHandler.ExecuteCommand(New VSC.OpenLineAboveCommandArgs(view, view.TextBuffer))
        ...
        Public Sub TypingCtrlShiftEnterDuringRenameCSharp()
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                commandHandler.ExecuteCommand(New VSC.OpenLineBelowCommandArgs(view, view.TextBuffer))
        ...
        Public Async Function SaveDuringRenameCommits() As Task
            Using workspace = CreateWorkspaceWithWaiter(
                ...
                commandHandler.ExecuteCommand(New SaveCommandArgs(view, view.TextBuffer))
        ...
        Public Async Function CutDuringRename_InsideIdentifier() As Task
            Await VerifySessionActiveAfterCutPasteInsideIdentifier(
                Sub(commandHandler As RenameCommandHandler, view As IWpfTextView, nextHandler As Action)
                    commandHandler.ExecuteCommand(New VSC.CutCommandArgs(view, view.TextBuffer))
                End Sub)
        End Function
        ...
        Public Async Function PasteDuringRename_InsideIdentifier() As Task
            Await VerifySessionActiveAfterCutPasteInsideIdentifier(
                Sub(commandHandler As RenameCommandHandler, view As IWpfTextView, nextHandler As Action)
                    commandHandler.ExecuteCommand(New VSC.PasteCommandArgs(view, view.TextBuffer))
                End Sub)
        End Function
...
class [|C$$|]
{
    [|C|] f;
                ...
                view.Selection.Clear()
                view.Caret.MoveTo(New SnapshotPoint(view.TextBuffer.CurrentSnapshot, workspace.Documents.Single(Function(d) d.CursorPosition.HasValue).CursorPosition.Value))
                commandHandler.ExecuteCommand(New VSC.TypeCharCommandArgs(view, view.TextBuffer, "D"c), Function() editorOperations.InsertText("D"))
