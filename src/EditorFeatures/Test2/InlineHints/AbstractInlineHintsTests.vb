...
Namespace Microsoft.CodeAnalysis.Editor.UnitTests.InlineHints
    ...
    Public MustInherit Class AbstractInlineHintsTests
        ...
        Protected Async Function VerifyParamHintsWithOptions(test As XElement, output As XElement, options As InlineParameterHintsOptions) As Task
            Using workspace = EditorTestWorkspace.Create(test)
                WpfTestRunner.RequireWpfFact($"{NameOf(AbstractInlineHintsTests)}.{NameOf(Me.VerifyParamHintsWithOptions)} creates asynchronous taggers")
        ...
        Protected Async Function VerifyTypeHintsWithOptions(test As XElement, output As XElement, options As InlineTypeHintsOptions) As Task
            Using workspace = EditorTestWorkspace.Create(test)
                WpfTestRunner.RequireWpfFact($"{NameOf(AbstractInlineHintsTests)}.{NameOf(Me.VerifyTypeHintsWithOptions)} creates asynchronous taggers")
