...
<%= code %>
        ...
        <MemberData(NameOf(GetAllCompletions))>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
        Public Async Function AssertCompletionListHasItems_IfNamedParameterAndNamedPositionalParametersArePresent(completion As Completions) As Task
            Await AssertCompletionListHasItems(completion, "[assembly: InternalsVisibleTo(assemblyName: ""$$, AllInternalsVisible = true)]", True)
        End Function
...
[assembly: InternalsVisibleTo("$$
        ...
        <MemberData(NameOf(GetAllCompletions))>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
        Public Async Function CodeCompletionIgnoresUnsupportedProjectTypes(completion As Completions) As Task
            Using state = TestStateFactory.CreateTestStateFromWorkspace(completion,
                <Workspace>
