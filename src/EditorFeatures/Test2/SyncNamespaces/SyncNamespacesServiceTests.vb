...
namespace Test.Namespace.App
{
    class Goo
    {
            ...
            Using workspace = TestWorkspace.Create(test)
                ...
                Dim newSolution = Await syncService.SyncNamespacesAsync(ImmutableArray.Create(project), CodeActionOptions.DefaultProvider, CodeAnalysisProgress.Null, CancellationToken.None)
...
namespace Test
{
    class Goo
    {
            ...
            Using workspace = TestWorkspace.Create(test)
                ...
                Dim syncService = project.GetLanguageService(Of ISyncNamespacesService)()
                Dim newSolution = Await syncService.SyncNamespacesAsync(projects, CodeActionOptions.DefaultProvider, CodeAnalysisProgress.Null, CancellationToken.None)
