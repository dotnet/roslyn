...
End Class
                ...
                Assert.True(result.GetRemainingIdentifierLineTextOnDisk(index:=0).StartsWith("SerializableAttribute()", StringComparison.Ordinal)) ' Navigates to constructor (which is decompiled to C#)
            End Using
        End Sub
