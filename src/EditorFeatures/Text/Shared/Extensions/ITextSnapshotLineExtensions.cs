...
internal static class ITextSnapshotLineExtensions
{
    extension(ITextSnapshotLine line)
    {
        ...
        /// </summary>
        public bool IsEmptyOrWhitespace(int startIndex = 0, int endIndex = -1)
        {
        ...
        public ITextSnapshotLine? GetPreviousMatchingLine(Func<ITextSnapshotLine, bool> predicate)
        {
            Contract.ThrowIfNull(line, @"line");
        ...
        public int GetColumnOfFirstNonWhitespaceCharacterOrEndOfLine(IEditorOptions editorOptions)
        ...
        public int GetColumnFromLineOffset(int lineOffset, IEditorOptions editorOptions)
            => line.GetText().GetColumnFromLineOffset(lineOffset, editorOptions.GetTabSize());

        public int GetLineOffsetFromColumn(int column, IEditorOptions editorOptions)
        ...
        /// </summary>
        public bool StartsWith(int index, string value, bool ignoreCase)
        {
            var snapshot = line.Snapshot;
        ...
        public bool Contains(int index, string value, bool ignoreCase)
        {
            var snapshot = line.Snapshot;
