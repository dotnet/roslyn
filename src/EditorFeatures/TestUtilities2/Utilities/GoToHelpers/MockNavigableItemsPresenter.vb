...
Namespace Microsoft.CodeAnalysis.Editor.UnitTests.Utilities.GoToHelpers
    Friend Class MockStreamingFindUsagesPresenter
        ...
        Public Function StartSearch(title As String, allowGroupingByDefinition As Boolean) As FindUsagesContext Implements IStreamingFindUsagesPresenter.StartSearch
            _action()
            Return Context
        End Function
    End Class
