...
namespace Microsoft.CodeAnalysis.Editor.Implementation.Classification
{
    internal sealed class ClassificationTypeFormatDefinitions
    {
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesFieldsFormatDefinition : ClassificationFormatDefinition
        {
        ...
        #endregion
        #region User Types - Enum Fields
        [Export(typeof(EditorFormatDefinition))]
        [ClassificationType(ClassificationTypeNames = ClassificationTypeNames.EnumFieldName)]
        [Name(ClassificationTypeNames.EnumFieldName)]
        [Order(After = LanguagePriority.NaturalLanguage, Before = LanguagePriority.FormalLanguage)]
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesEnumFieldsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesEnumFieldsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_EnumFields;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesConstantsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesConstantsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Constants;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        #region User Types - Locals
        [Export(typeof(EditorFormatDefinition))]
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesLocalsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesLocalsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Locals;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesParametersFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesParametersFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Parameters;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        #region User Types - Methods
        [Export(typeof(EditorFormatDefinition))]
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesMethodsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesMethodsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Methods;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        #region User Types - Extension Methods
        [Export(typeof(EditorFormatDefinition))]
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesExtensionMethodsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesExtensionMethodsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_ExtensionMethods;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        #region User Types - Properties
        [Export(typeof(EditorFormatDefinition))]
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesPropertiesFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesPropertiesFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Properties;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
        #region User Types - Events
        [Export(typeof(EditorFormatDefinition))]
        ...
        [UserVisible(true)]
        [ExcludeFromCodeCoverage]
        private class UserTypesEventsFormatDefinition : ClassificationFormatDefinition
        {
            private UserTypesEventsFormatDefinition()
            {
                this.DisplayName = EditorFeaturesResources.User_Types_Events;
                this.ForegroundColor = Colors.Black;
            }
        }
        #endregion
