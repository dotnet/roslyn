    ...
    Friend Class CommitFormatter
        ...
        Public Sub CommitRegion(spanToFormat As SnapshotSpan,
            ...
            Using (Logger.LogBlock(FunctionId.LineCommit_CommitRegion, cancellationToken))
                ...
                Dim documentOptions = document.GetDocumentOptionsWithInferredIndentation(spanToFormat.Start, isExplicitFormat, _indentationManagerService, cancellationToken).WaitAndGetResult(cancellationToken)
