...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticServiceTests
    {
        ...
        public void TestGetDiagnostics1()
        {
            ...
            var data1 = diagnosticService.GetPushDiagnostics(workspace, null, null, null, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
            Assert.Equal(diagnostic, data1.Single());

            var data2 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, null, null, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
            Assert.Equal(diagnostic, data2.Single());

            var data3 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, document.Id, null, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
            Assert.Equal(diagnostic, data3.Single());

            var data4 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, document.Id, id, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
        ...
        public void TestGetDiagnostics2()
        {
            ...
            var data3 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, null, id3, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
            Assert.Equal(1, data3.Count());

            var data4 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, document.Id, null, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
            Assert.Equal(2, data4.Count());

            var data5 = diagnosticService.GetPushDiagnostics(workspace, document.Project.Id, document.Id, id, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
        ...
        public void TestCleared()
        {
            ...
            var data2 = diagnosticService.GetPushDiagnostics(workspace, null, null, null, includeSuppressedDiagnostics: false, InternalDiagnosticsOptions.LspPullDiagnostics, CancellationToken.None);
