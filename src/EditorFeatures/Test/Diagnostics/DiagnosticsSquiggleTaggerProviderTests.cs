...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticsSquiggleTaggerProviderTests
    {
        ...
        public async Task Test_TagSourceDiffer()
        {
            ...
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFilesAsync(new string[] { "class A { }", "class E { }" }, CSharpParseOptions.Default))
        ...
        {
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFilesAsync(new string[] { "class A {" }, CSharpParseOptions.Default))
        ...
        {
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFilesAsync(new string[] { "class C {" }, CSharpParseOptions.Default))
