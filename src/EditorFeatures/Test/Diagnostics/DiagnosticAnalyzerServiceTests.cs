...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticAnalyzerServiceTests
    {
        ...
        public async Task TestHasSuccessfullyLoadedBeingFalseFSAOn()
        {
            ...
            globalOptions.SetGlobalOption(new OptionKey(SolutionCrawlerOptions.BackgroundAnalysisScopeOption, LanguageNames.CSharp), BackgroundAnalysisScope.FullSolution);
...
";
        ...
        internal async Task TestDiagnosticSuppressor(bool includeAnalyzer, bool includeSuppressor, BackgroundAnalysisScope analysisScope)
        {
            ...
            workspace.GlobalOptions.SetGlobalOption(new OptionKey(SolutionCrawlerOptions.BackgroundAnalysisScopeOption, LanguageNames.CSharp), analysisScope);
