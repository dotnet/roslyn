...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticAnalyzerServiceTests
    {
        ...
        public async Task TestHasSuccessfullyLoadedBeingFalse()
        {
            ...
            {
                var diagnostics = a.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.NormalDiagnosticMode, CancellationToken.None);
...
";
        ...
        internal async Task TestAdditionalFileAnalyzer(bool registerFromInitialize, bool testMultiple, BackgroundAnalysisScope analysisScope)
        {
            ...
            service.DiagnosticsUpdated += (s, e) =>
            {
                diagnostics.AddRange(e.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.NormalDiagnosticMode, CancellationToken.None));
            };
...
";
            ...
            service.DiagnosticsUpdated += (s, e) =>
            {
                diagnostics.AddRange(
                    e.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.NormalDiagnosticMode, CancellationToken.None)
