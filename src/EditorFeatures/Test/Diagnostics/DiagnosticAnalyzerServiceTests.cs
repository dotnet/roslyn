...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticAnalyzerServiceTests
    {
        ...
        public async Task TestHasSuccessfullyLoadedBeingFalse()
        {
            ...
            {
                var diagnostics = a.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.RoslynDiagnosticMode);
...
";
        ...
        internal async Task TestAdditionalFileAnalyzer(bool registerFromInitialize, bool testMultiple, BackgroundAnalysisScope analysisScope)
        {
            ...
            service.DiagnosticsUpdated += (s, e) =>
            {
                diagnostics.AddRange(e.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.RoslynDiagnosticMode));
            };
...
";
            ...
            service.DiagnosticsUpdated += (s, e) =>
            {
                diagnostics.AddRange(
                    e.GetPushDiagnostics(workspace, InternalDiagnosticsOptions.RoslynDiagnosticMode)
