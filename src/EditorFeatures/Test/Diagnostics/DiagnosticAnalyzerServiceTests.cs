...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    {
        [Fact]
        public async Task TestDependentCompleteBeingFalse()
        {
        ...
        [Fact]
        public async Task TestDependentCompleteBeingFalseWhenFileOpened()
        {
            var workspace = new AdhocWorkspace();
            var document = GetDocumentFromIncompleteProject(workspace);
        ...
        private static Document GetDocumentFromIncompleteProject(AdhocWorkspace workspace)
        {
            var project = workspace.AddProject(
                            ProjectInfo.Create(
                                ...
                                "CSharpProject",
                                "CSharpProject",
                                LanguageNames.CSharp).WithIsComplete(isComplete: false));
