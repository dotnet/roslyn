...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        ...
        private class MockHostWorkspaceServices : HostWorkspaceServices
        {
            ...
            public MockHostWorkspaceServices(HostServices hostServices, Workspace workspace)
            {
                ...
                var globalOptionService = new GlobalOptionService(ImmutableArray<Lazy<IOptionProvider, LanguageMetadata>>.Empty, ImmutableArray<Lazy<IOptionPersisterProvider>>.Empty);
