...
";
            ...
            var refactorings = await refactoringService.GetRefactoringsAsync(document, TextSpan.FromBounds(0, 0), options.CreateProvider(), CancellationToken.None);
            ...
            where T : CodeRefactoringProvider
        {
            ...
            var options = CodeActionOptions.Default;
            var result = await refactoringService.GetRefactoringsAsync(document, TextSpan.FromBounds(0, 0), options.CreateProvider(), CancellationToken.None);
