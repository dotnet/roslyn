        ...
        public async Task GetHotReloadDiagnostics()
        {
            ...
            var diagnosticData = ImmutableArray.Create(
                new DiagnosticData(
                    ...
                    document.Project.Id,
                    new DiagnosticDataLocation("a.cs", document.Id, new TextSpan(1, 2), 0, 0, 0, 5, "a.razor", 10, 10, 10, 15),
                    language: "C#",
                    title: "title",
                ...
                new DiagnosticData(
                    ...
                    properties: ImmutableDictionary<string, string?>.Empty,
                    document.Project.Id,
                    new DiagnosticDataLocation(originalFilePath: sourcePath, document.Id, new TextSpan(1, 2), 0, 0, 0, 5, mappedFilePath: @"..\a.razor", 10, 10, 10, 15),
                    language: "C#",
                    title: "title",
                    description: "description",
                    helpLink: "http://link"));
            ...
            var syntaxError = new DiagnosticData(
                ...
                properties: ImmutableDictionary<string, string?>.Empty,
                document.Project.Id,
                new DiagnosticDataLocation(originalFilePath: sourcePath, document.Id, new TextSpan(1, 2), 0, 1, 0, 5, mappedFilePath: null, 0, 0, 0, 0),
                language: "C#",
                title: "title",
                description: "description",
                helpLink: "http://link");
