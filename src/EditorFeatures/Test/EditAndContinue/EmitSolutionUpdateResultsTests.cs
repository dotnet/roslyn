        ...
        public async Task GetHotReloadDiagnostics()
        {
            ...
            var diagnosticData = ImmutableArray.Create(
                new DiagnosticData(
                    ...
                    document.Project.Id,
                    new DiagnosticDataLocation(document.Id, new TextSpan(1, 2), new("a.cs", new(0, 0), new(0, 5)), new("a.razor", new(10, 10), new(10, 15))),
                    language: "C#",
                    title: "title",
                ...
                new DiagnosticData(
                    ...
                    properties: ImmutableDictionary<string, string?>.Empty,
                    document.Project.Id,
                    new DiagnosticDataLocation(document.Id, new TextSpan(1, 2), new(sourcePath, new(0, 0), new(0, 5)), new(@"..\a.razor", new(10, 10), new(10, 15))),
                    language: "C#",
                    title: "title",
                    description: "description",
                    helpLink: "http://link"));
            ...
            var syntaxError = new DiagnosticData(
                ...
                properties: ImmutableDictionary<string, string?>.Empty,
                document.Project.Id,
                new DiagnosticDataLocation(document.Id, new TextSpan(1, 2), new(sourcePath, new(0, 1), new(0, 5)), mappedFileSpan: null),
                language: "C#",
                title: "title",
                description: "description",
                helpLink: "http://link");
