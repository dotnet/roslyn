...
namespace Microsoft.CodeAnalysis.EditAndContinue.UnitTests
{
    internal class MockDiagnosticAnalyzerService : IDiagnosticAnalyzerService
    {
        ...
        public Task<ImmutableArray<DiagnosticData>> GetDiagnosticsForSpanAsync(Document document, TextSpan range, string? diagnosticIdOpt = null, bool includeSuppressedDiagnostics = false, bool? highPriority = null, Func<string, IDisposable?>? addOperationScope = null, CancellationToken cancellationToken = default)
            => throw new NotImplementedException();
