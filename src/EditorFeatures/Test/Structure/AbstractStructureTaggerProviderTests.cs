...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Structure
{
    ...
    public class AbstractStructureTaggerProviderTests
    {
        private static void TextContainsRegionOrUsing(string input, bool expected, string language)
        {
            ...
            var actual = AbstractStructureTaggerProvider.ContainsRegionOrUsing(textSnapshot, collapseRegions: true, collapseUsings: true, language);
...
";
            ...
            TextContainsRegionOrUsing(input, false, LanguageNames.CSharp);
        }
