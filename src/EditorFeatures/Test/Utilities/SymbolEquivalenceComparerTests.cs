...
@"class C
{
    ...
    System.Int32 int32Field2;
            ...
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode))
            {
...
@"class C
    ...
    dim int32Field1 as System.Int32
            ...
            using (var csharpWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode))
            using (var vbWorkspace = await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFileAsync(vbCode))
            {
...
class Type2
{
    ...
    string field2;
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode2))
            {
...
class Type2
    ...
    dim field2 as String;
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFileAsync(vbCode1))
            {
                var type1_v1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type1").Single();
                var type2_v1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type2").Single();
                var type1_v2 = (await workspace2.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type1").Single();
...
";
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode1))
            {
...
";
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(code))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(code))
            {
...
End Class
";
            using (var workspace1 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFileAsync(code))
            using (var workspace2 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceFromFileAsync(code))
            {
                var comp1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync());
                var comp2 = (await workspace2.CurrentSolution.Projects.Single().GetCompilationAsync());
...
@"namespace N
{
    namespace M
    {
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode, compilationOptions: new CS.CSharpCompilationOptions(OutputKind.NetModule, moduleName: "FooModule")))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceFromFileAsync(csharpCode, compilationOptions: new CS.CSharpCompilationOptions(OutputKind.NetModule, moduleName: "BarModule")))
            {
