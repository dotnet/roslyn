...
@"class C
{
    ...
    System.Int32 int32Field2;
            ...
            using (var workspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode))
            {
...
@"class C
    ...
    dim int32Field1 as System.Int32
            ...
            using (var csharpWorkspace = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode))
            using (var vbWorkspace = await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(vbCode))
            {
...
class Type2
{
    ...
    string field2;
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode2))
            {
...
class Type2
    ...
    dim field2 as String;
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(vbCode1))
            {
                var type1_v1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type1").Single();
                var type2_v1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type2").Single();
                var type1_v2 = (await workspace2.CurrentSolution.Projects.Single().GetCompilationAsync()).GlobalNamespace.GetTypeMembers("Type1").Single();
...
";
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode1))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode1))
            {
...
";
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(code))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(code))
            {
...
End Class
";
            using (var workspace1 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(code))
            using (var workspace2 = await TestWorkspaceFactory.CreateVisualBasicWorkspaceAsync(code))
            {
                var comp1 = (await workspace1.CurrentSolution.Projects.Single().GetCompilationAsync());
                var comp2 = (await workspace2.CurrentSolution.Projects.Single().GetCompilationAsync());
...
@"namespace N
{
    namespace M
    {
            ...
            using (var workspace1 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode, compilationOptions: new CS.CSharpCompilationOptions(OutputKind.NetModule, moduleName: "FooModule")))
            using (var workspace2 = await TestWorkspaceFactory.CreateCSharpWorkspaceAsync(csharpCode, compilationOptions: new CS.CSharpCompilationOptions(OutputKind.NetModule, moduleName: "BarModule")))
            {
