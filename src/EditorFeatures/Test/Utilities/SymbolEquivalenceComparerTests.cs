...
@"namespace N
{
    namespace M
    {
        ...
        {
            var references = new[] { Net451.mscorlib };
...
";
            ...
            var c1 = (Compilation)CS.CSharpCompilation.Create("comp1", Array.Empty<SyntaxTree>(), new[] { Net451.mscorlib, r1 });
            var c2 = (Compilation)CS.CSharpCompilation.Create("comp2", Array.Empty<SyntaxTree>(), new[] { Net451.mscorlib, r2 });
