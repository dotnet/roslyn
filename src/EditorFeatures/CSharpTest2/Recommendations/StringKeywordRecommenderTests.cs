...
@"IList<IGoo<int?,byte*>,$$"));
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericClassDecl()
            => VerifyAbsence(@"class CL<$$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericClassDeclList()
            => VerifyAbsence(@"class CL<T, $$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericStructDecl()
            => VerifyAbsence(@"struct S<$$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericStructDeclList()
            => VerifyAbsence(@"struct S<T, $$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericInterfaceDecl()
            => VerifyAbsence(@"interface S<$$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericInterfaceDeclList()
            => VerifyAbsence(@"interface S<T, $$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericDelegateDecl()
            => VerifyAbsence(@"delegate void Del<$$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericDelegateDeclList()
            => VerifyAbsence(@"delegate void Del<T, $$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericMethodDecl()
            => VerifyAbsence(@"class C { void Method<$$");

        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInGenericMethodDeclList()
...
@"for ($$"));
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInForCondition()
        {
            VerifyKeyword(AddInsideMethod(
@"for (;$$"));
        }
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestInForIncrementor()
        {
            VerifyKeyword(AddInsideMethod(
@"for (;;$$"));
        }
...
@"new $$"));
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public void TestAfterNestedType()
        {
            VerifyKeyword(
