...
public sealed class DoKeywordRecommenderTests : KeywordRecommenderTests
{
    [Fact]
...
@"$$"));
    ...
    [Fact]
    public Task TestInsideDoInsideDo()
        => VerifyKeywordAsync(AddInsideMethod(
            """
            do
                 do
