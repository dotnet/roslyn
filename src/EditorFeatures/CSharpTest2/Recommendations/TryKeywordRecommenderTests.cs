...
public sealed class TryKeywordRecommenderTests : KeywordRecommenderTests
{
    [Fact]
...
@"$$"));
    ...
    [Fact]
    public Task TestNotAfterTry()
        => VerifyAbsenceAsync(AddInsideMethod(
@"try $$"));

    [Fact]
    public Task TestInsideTry()
        => VerifyKeywordAsync(AddInsideMethod(
            """
            try {
                $$
