...
@"class C {
  ...
  $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestAfterMethodInExtensionType()
        {
            await VerifyKeywordAsync(
@"extension class C {
  void Foo() {}
  $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestAfterFieldInExtensionClass()
        {
            await VerifyKeywordAsync(
@"extension class C {
  int i;
  $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestAfterPropertyInExtensionClass()
        {
            await VerifyKeywordAsync(
@"extension class C {
  int i { get; }
...
$$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestAfterNestedAttributeInExtensionClass()
        {
            await VerifyKeywordAsync(
@"extension class C {
  [foo]
...
@"struct S {
   $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestInsideExtensionStruct()
        {
            await VerifyKeywordAsync(
@"extension struct S {
   $$");
   ...
   $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestInsideExtensionClass()
        {
            await VerifyKeywordAsync(
@"extension class C {
   $$");
...
@"partial class C {
   $$");
        ...
        [Fact, Trait(Traits.Feature, Traits.Features.KeywordRecommending)]
        public async Task TestNotAfterExtension()
        {
            await VerifyAbsenceAsync(@"extension $$");
        }
