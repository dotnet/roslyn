...
public partial class CSharpJsonParserTests
{
    ...
    [ConditionalFact(skipConditions: typeof(WindowsOnly), Reason = "Deep recursion test relies on Windows stack size (~1MB) to trigger stack overflow; Linux has 8MB stack")]
    ...
    [ConditionalFact(skipConditions: typeof(WindowsOnly), Reason = "Deep recursion test relies on Windows stack size"), WorkItem("https://devdiv.visualstudio.com/DevDiv/_queries/edit/1691963")]
