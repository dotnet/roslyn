            ...
            IReadOnlyDictionary<string, string> expectedSymbolChanges = null)
        {
            ...
            if (expectedSuccess)
            {
                ...
                var operationTasks = actions
                    ...
                    .Select(action => action.GetOperationsAsync(workspace.CurrentSolution, action.GetOptions(CancellationToken.None), CodeAnalysisProgress.Null, CancellationToken.None));
