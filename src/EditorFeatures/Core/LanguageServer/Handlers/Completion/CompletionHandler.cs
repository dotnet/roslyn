    ...
    internal class CompletionHandler : IRequestHandler<LSP.CompletionParams, LSP.CompletionList?>
    {
        ...
        public async Task<LSP.CompletionList?> HandleRequestAsync(LSP.CompletionParams request, RequestContext context, CancellationToken cancellationToken)
        {
            ...
            var completionChange = await completionService.GetChangeAsync(
                document, list.ItemsInternal.First(), cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            foreach (var item in list.ItemsInternal)
            {
            ...
            Document document)
        {
            ...
            var isIncomplete = completionList.ItemsInternal.Count > newCompletionList.ItemsInternal.Count;
