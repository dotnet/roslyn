...
namespace Microsoft.CodeAnalysis.Editor.Shared.Options
{
    internal sealed class FeatureOnOffOptions
    {
        ...
        public static readonly PerLanguageValuedOption2<bool> EndConstruct = new(FeatureName, "EndConstruct", defaultValue: true,
        ...
        public static readonly PerLanguageValuedOption2<bool> AutomaticInsertionOfAbstractOrInterfaceMembers = new(FeatureName, "AutomaticInsertionOfAbstractOrInterfaceMembers", defaultValue: true,
            storageLocation: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.AutoRequiredMemberInsert"));

        public static readonly PerLanguageValuedOption2<bool> LineSeparator = new(FeatureName, "LineSeparator", defaultValue: false,
        ...
        public static readonly PerLanguageValuedOption2<bool> Outlining = new(FeatureName, "Outlining", defaultValue: true,
            storageLocation: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.Outlining"));

        public static readonly PerLanguageValuedOption2<bool> KeywordHighlighting = new(FeatureName, "KeywordHighlighting", defaultValue: true,
        ...
        public static readonly PerLanguageValuedOption2<bool> ReferenceHighlighting = new(FeatureName, "ReferenceHighlighting", defaultValue: true,
        ...
        public static readonly PerLanguageValuedOption2<bool> AutoInsertBlockCommentStartString = new(FeatureName, "AutoInsertBlockCommentStartString", defaultValue: true,
            storageLocation: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.Auto Insert Block Comment Start String"));

        public static readonly PerLanguageValuedOption2<bool> PrettyListing = new(FeatureName, "PrettyListing", defaultValue: true,
            storageLocation: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.PrettyListing"));

        public static readonly PerLanguageValuedOption2<bool> StringIdentation = new(FeatureName, "StringIdentation", defaultValue: true,
            storageLocation: new RoamingProfileStorageLocation("TextEditor.%LANGUAGE%.Specific.StringIdentation"));

        public static readonly PerLanguageValuedOption2<bool> RenameTrackingPreview = new(FeatureName, "RenameTrackingPreview", defaultValue: true,
        ...
        /// </summary>
        public static readonly PerLanguageValuedOption2<bool> RenameTracking = new(FeatureName, "RenameTracking", defaultValue: true);
        ...
        /// </summary>
        public static readonly PerLanguageValuedOption2<bool> AddImportsOnPaste = new(
        ...
        public static readonly PerLanguageValuedOption2<bool?> ShowInheritanceMargin = new(
        ...
        public static readonly PerLanguageValuedOption2<bool> InheritanceMarginIncludeGlobalImports = new(
        ...
        public static readonly PerLanguageValuedOption2<bool> AutomaticallyFixStringContentsOnPaste = new(
