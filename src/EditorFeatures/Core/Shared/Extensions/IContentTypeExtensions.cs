...
{
    extension(IContentType dataContentType)
    {
        /// <summary>
        ...
        public bool MatchesAny(IEnumerable<string> extensionContentTypes)
            => extensionContentTypes.Any(v => dataContentType.IsOfType(v));

        public bool MatchesAny(params string[] extensionContentTypes)
