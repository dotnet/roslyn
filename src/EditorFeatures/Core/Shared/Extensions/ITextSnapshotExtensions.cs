...
internal static partial class ITextSnapshotExtensions
{
    extension(ITextBuffer textBuffer)
    {
        ...
        /// </summary>
        public void FormatAndApplyToBuffer(
            TextSpan span,
    ...
    extension(ITextSnapshot snapshot)
    {
        ...
        /// </summary>
        public async Task<Document?> GetFullyLoadedOpenDocumentInCurrentContextWithChangesAsync(
    IUIThreadOperationContext operationContext)
        ...
        /// once <see cref="IWorkspaceStatusService.WaitUntilFullyLoadedAsync(CancellationToken)"/> returns
        /// </summary>
        public Document? GetFullyLoadedOpenDocumentInCurrentContextWithChanges(
    IUIThreadOperationContext operationContext, IThreadingContext threadingContext)
        {
