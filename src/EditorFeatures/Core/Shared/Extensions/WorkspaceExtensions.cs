...
internal static partial class IWorkspaceExtensions
{
    extension(Workspace workspace)
    {
        ...
        /// </summary>
        internal async Task ApplyDocumentChangesAsync(
    IThreadingContext threadingContext, Document newDocument, CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        internal void ApplyTextChanges(DocumentId id, IEnumerable<TextChange> textChanges, CancellationToken cancellationToken)
        {
            var oldSolution = workspace.CurrentSolution;
    ...
    {
        private Solution UpdateDocument(DocumentId id, IEnumerable<TextChange> textChanges, CancellationToken cancellationToken)
        {
