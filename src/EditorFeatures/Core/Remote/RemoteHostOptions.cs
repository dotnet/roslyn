...
namespace Microsoft.VisualStudio.LanguageServices.Remote
{
    internal static class RemoteHostOptions
    {
        ...
        public static readonly Option2<int> SolutionChecksumMonitorBackOffTimeSpanInMS = new Option2<int>(
            nameof(RemoteHostOptions), nameof(SolutionChecksumMonitorBackOffTimeSpanInMS), defaultValue: 4000,
