...
namespace Microsoft.CodeAnalysis.InlineRename
{
    internal static class InlineRenameSessionOptionsStorage
    {
        ...
        public static readonly Option2<bool> CollapseUI = new(FeatureName, "CollapseRenameUI", defaultValue: false, storageLocation: new RoamingProfileStorageLocation("TextEditor.CollapseRenameUI"));
    }
}
