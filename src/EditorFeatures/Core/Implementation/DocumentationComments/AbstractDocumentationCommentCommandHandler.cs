...
namespace Microsoft.CodeAnalysis.Editor.Implementation.DocumentationComments
{
        ...
        IChainedCommandHandler<OpenLineBelowCommandArgs>
    {
        ...
        private static DocumentationCommentSnippet? InsertOnEnterTyped(IDocumentationCommentSnippetService service, SyntaxTree syntaxTree, SourceText text, int position, DocumentOptionSet options, SemanticModel model, CancellationToken cancellationToken)
            => service.GetDocumentationCommentSnippetOnEnterTyped(syntaxTree, text, position, options, model, cancellationToken);

        private static DocumentationCommentSnippet? InsertOnCommandInvoke(IDocumentationCommentSnippetService service, SyntaxTree syntaxTree, SourceText text, int position, DocumentOptionSet options, SemanticModel model, CancellationToken cancellationToken)
            => service.GetDocumentationCommentSnippetOnCommandInvoke(syntaxTree, text, position, options, model, cancellationToken);
        ...
        private static bool CompleteComment(
            ...
            ITextView textView,
            Func<IDocumentationCommentSnippetService, SyntaxTree, SourceText, int, DocumentOptionSet, SemanticModel, CancellationToken, DocumentationCommentSnippet?> getSnippetAction,
            CancellationToken cancellationToken)
        {
            ...
            var snippet = getSnippetAction(service, syntaxTree, text, caretPosition, documentOptions, semanticModel, cancellationToken);
            if (snippet != null)
            {
