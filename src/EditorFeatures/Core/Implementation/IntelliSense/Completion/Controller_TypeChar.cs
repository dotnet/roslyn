...
namespace Microsoft.CodeAnalysis.Editor.Implementation.IntelliSense.Completion
{
    internal partial class Controller
    {
        ...
        private CompletionHelper GetCompletionHelper(Model model)
        {
            ...
            if (document != null)
            {
                ...
                if (service != null)
                {
                    return new CompletionHelper(model.OriginalList.Rules, document.Project.Language, service);
                }
            }
        ...
        private bool IsCommitCharacter(char ch)
        {
            ...
            var helper = GetCompletionHelper(model);
            if (helper != null)
            {
