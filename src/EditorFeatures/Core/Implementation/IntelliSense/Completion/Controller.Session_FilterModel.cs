    ...
    internal partial class Controller
    {
        internal partial class Session
        {
                ...
                CompletionFilterReason filterReason)
            {
                ...
                var completionRules = this.Controller.GetCompletionHelper(model);
                ...
                foreach (var currentItem in model.TotalItems)
                {
                    ...
                    var matchesFilterText = completionRules.MatchesFilterText(currentItem.Item, filterText, model.Trigger, filterReason, recentItems);
                    ...
                    if (matchesFilterText)
                    {
                        ...
                        if (bestFilterMatch == null ||
                            completionRules.IsBetterFilterMatch(currentItem.Item, bestFilterMatch.Item, filterText, model.Trigger, filterReason, recentItems))
                        {
