        ...
        void ICommandHandler<TabKeyCommandArgs>.ExecuteCommand(TabKeyCommandArgs args, Action nextHandler)
        {
            ...
            if (sessionOpt == null)
            {
                ...
                if (completionService != null &&
                    completionService.Language == LanguageNames.VisualBasic &&
                ...
                if (documentId != null)
                {
                    ...
                    if (document != null)
                    {
                        ...
                        if (caretPoint >= 2 && text[caretPoint - 1] == '?' && QuestionMarkIsPrecededByIdentifierAndWhitespace(text, caretPoint - 2, syntaxFacts))
                        {
                            ...
                            this.StartNewModelComputation(completionService, new CompletionTrigger(CommonCompletionService.SnippetsTriggerReason), filterItems: false);
                            return true;
                        }
                    }
                }
