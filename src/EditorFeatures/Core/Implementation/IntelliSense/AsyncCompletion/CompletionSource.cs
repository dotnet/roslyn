...
namespace Microsoft.CodeAnalysis.Editor.Implementation.IntelliSense.AsyncCompletion
{
    internal sealed class CompletionSource : ForegroundThreadAffinitizedObject, IAsyncExpandingCompletionSource
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            _textView.Options.GlobalOptions.SetOptionValue(NonBlockingCompletionEditorOption, !options.GetOption(CompletionOptions.BlockForCompletionItems2, service.Language));
        ...
        {
            var rules = completionService.GetRules(document.Project.Solution.Options);
