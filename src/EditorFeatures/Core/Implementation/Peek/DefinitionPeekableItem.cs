        ...
        private sealed class ResultSource : IPeekResultSource
        {
            ...
            public void FindResults(string relationshipName, IPeekResultCollection resultCollection, CancellationToken cancellationToken, IFindPeekResultsCallback callback)
            {
                ...
                if (!sourceLocations.Any())
                {
                    ...
                    var declarationFile = _peekableItem._metadataAsSourceFileService.GetGeneratedFileAsync(project, symbol, null, cancellationToken).WaitAndGetResult(cancellationToken);
