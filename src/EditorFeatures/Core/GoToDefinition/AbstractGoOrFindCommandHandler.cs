...
internal abstract class AbstractGoOrFindService<TLanguageService>(
    ...
    where TLanguageService : class, ILanguageService
{
    ...
    public bool IsAvailable(Document document)
    {
        return document?.GetLanguageService<TLanguageService>() != null;
    }
    ...
    {
        private readonly AbstractGoOrFindService<TLanguageService> _instance;

        internal TestAccessor(AbstractGoOrFindService<TLanguageService> instance)
            => _instance = instance;
