...
{
    internal class PerLanguageStringWhitespaceSetting : PerLanguageWhitespaceSetting<string>
    {
        public PerLanguageStringWhitespaceSetting(PerLanguageOption2<string> option,
                                    string description,
