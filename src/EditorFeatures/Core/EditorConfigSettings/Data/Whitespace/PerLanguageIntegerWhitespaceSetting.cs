...
{
    internal class PerLanguageIntegerWhitespaceSetting : PerLanguageWhitespaceSetting<int>
    {
        public PerLanguageIntegerWhitespaceSetting(PerLanguageOption2<int> option,
                                    string description,
