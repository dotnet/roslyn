...
internal class AnalyzerSettingsWorkspaceServiceFactory(IDiagnosticAnalyzerService analyzerService, IGlobalOptionService globalOptions) : IWorkspaceServiceFactory
{
    private readonly IDiagnosticAnalyzerService _analyzerService = analyzerService;

    public IWorkspaceService CreateService(HostWorkspaceServices workspaceServices)
        => new AnalyzerSettingsProviderFactory(workspaceServices.Workspace, _analyzerService, globalOptions);
}
