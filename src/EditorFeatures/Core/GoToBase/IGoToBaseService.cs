...
namespace Microsoft.CodeAnalysis.Editor.GoToBase
{
    internal interface IGoToBaseService : ILanguageService
    {
        ...
        /// </summary>
        Task FindBasesAsync(Document document, int position, IFindUsagesContextRenameOnceTypeScriptMovesToExternalAccess context, CancellationToken cancellationToken);
    }
}
