...
namespace Microsoft.CodeAnalysis.Editor.GoToBase
{
    ...
    {
        public async Task FindBasesAsync(Document document, int position, IFindUsagesContextRenameOnceTypeScriptMovesToExternalAccess context, CancellationToken cancellationToken)
        {
