...
namespace Microsoft.CodeAnalysis.Editor.Host
{
    ...
    internal interface IStreamingFindUsagesPresenter
    {
        ...
        /// etc. etc.
        /// </summary>
        FindUsagesContext StartSearch(string title, bool allowGroupingByDefinition);
    }
    ...
    internal static class IStreamingFindUsagesPresenterExtensions
    {
        ...
        public static async Task<bool> TryNavigateToOrPresentItemsAsync(
            ...
            ImmutableArray<DefinitionItem> items, bool allowGroupingByDefinition)
        {
            ...
            if (presenter != null)
            {
                ...
                var context = presenter.StartSearch(title, allowGroupingByDefinition);
