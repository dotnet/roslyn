...
internal static class VisualStudioMacOptionStorage
{
    ...
    {
        {"dotnet_brace_completion_options_auto_formatting_on_close_brace", new PropertyName("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Close Brace")},
        {"dotnet_formatting_options_auto_formatting_on_return", new PropertyName("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Return")},
        ...
        {"dotnet_formatting_options_auto_formatting_on_typing", new PropertyName("TextEditor.%LANGUAGE%.Specific.Auto Formatting On Typing")},
        ...
        {"dotnet_completion_options_show_items_from_unimported_namespaces", new PropertyName("TextEditor.%LANGUAGE%.Specific.ShowItemsFromUnimportedNamespaces")},
