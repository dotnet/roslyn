...
- **PROTOTYPE Comments**: Used to track follow-up work in feature branches. Do not flag them in feature-branch PR reviews solely for existing; they are disallowed only when merging to `main`, where CI enforces removal.
