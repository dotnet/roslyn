        ...
        Friend Overrides Sub RegisterSyntaxNodeAction(context As CompilationStartAnalysisContext)
            context.RegisterSyntaxNodeAction(
                Sub(ctx)
                    ...
                    Dim isArrayCreationExpression As Boolean = (ctx.Node.VisualBasicKind() = SyntaxKind.ArrayCreationExpression)
                        ...
                        If arrayCreationExpr.ArrayBounds IsNot Nothing Then
                            If arrayCreationExpr.ArrayBounds.Arguments.Count = 1 Then
                                ...
                                If sizeSpecifier IsNot Nothing Then
                                    ...
                                    If unaryExpression IsNot Nothing AndAlso unaryExpression.OperatorToken.VisualBasicKind() = SyntaxKind.MinusToken Then
                    ...
                    Else
                        ...
                        Select Case ctx.Node.Parent.VisualBasicKind()
