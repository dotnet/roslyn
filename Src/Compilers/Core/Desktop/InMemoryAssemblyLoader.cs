...
namespace Microsoft.CodeAnalysis
{
    ...
    public static class InMemoryAssemblyLoader
    {
        ...
        /// <summary>
        /// Fired when the loader has successfully loaded an <see cref="Assembly"/>.
        /// </summary>
        internal static event EventHandler<InMemoryAssemblyLoadEventArgs> AssemblyLoad;
        ...
        private static Assembly LoadCore(string fullPath)
        {
            ...
            EventHandler<InMemoryAssemblyLoadEventArgs> handler = AssemblyLoad;
            if (handler != null)
            {
                handler(null, new InMemoryAssemblyLoadEventArgs(fullPath, assembly));
            }
