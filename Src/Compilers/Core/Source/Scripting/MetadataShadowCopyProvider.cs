...
namespace Roslyn.Scripting
{
    ...
    /// </summary>
    public sealed class MetadataShadowCopyProvider : MetadataFileProvider
    {
        /// <summary>
        ...
        private static readonly IEnumerable<string> frameworkNoShadowCopyDirectories =
            GlobalAssemblyCache.RootLocations.AsEnumerable().
        ...
        public MetadataShadowCopyProvider(string directory = null, IEnumerable<string> noShadowCopyDirectories = null)
        {
            if (directory != null)
            {
                FileUtilities.RequireAbsolutePath(directory, "directory");
        ...
        {
            FileUtilities.RequireAbsolutePath(fullPath, "fullPath");
        ...
        {
            FileUtilities.RequireAbsolutePath(originalPath, "originalPath");
