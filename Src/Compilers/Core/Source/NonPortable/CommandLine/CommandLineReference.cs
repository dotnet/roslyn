...
namespace Microsoft.CodeAnalysis
{
    ...
    public struct CommandLineReference
    {
        ...
        /// </remarks>
        /// <param name="metadataResolver"><see cref="MetadataReferenceResolver"/> to use for assembly name and relative path resolution, or null to use a default.</param>
        ...
        internal MetadataReference Resolve(MetadataFileReferenceResolver metadataResolver, MetadataReferenceProvider metadataProvider, List<DiagnosticInfo> diagnosticsOpt, CommonMessageProvider messageProviderOpt)
        {
            ...
            {
                path = metadataResolver.ResolveAssemblyName(this.reference);
                if (path == null)
                {
            ...
            string fullPath = metadataResolver.ResolveMetadataFileChecked(path, baseFilePath: null);
            if (fullPath == null)
            {
                if (diagnosticsOpt != null)
                {
