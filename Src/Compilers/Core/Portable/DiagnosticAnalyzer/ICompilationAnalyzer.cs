...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    /// </summary>
    public interface ICompilationAnalyzer : IDiagnosticAnalyzer
    {
        /// <summary>
        ...
        void AnalyzeCompilation(Compilation compilation, Action<Diagnostic> addDiagnostic, AnalyzerOptions options, CancellationToken cancellationToken);
    }
}
