...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Diagnostic : IEquatable<Diagnostic>
    {
            ...
            params object[] messageArgs)
        {
            ...
            return Create(descriptor.Id, descriptor.Category, message, severity: descriptor.DefaultSeverity, 
                defaultSeverity: descriptor.DefaultSeverity, isEnabledByDefault: descriptor.IsEnabledByDefault, 
                warningLevel: warningLevel, description: descriptor.Description, helpLink: descriptor.HelpLink, 
                location: location ?? Location.None, additionalLocations: additionalLocations, customTags: descriptor.CustomTags);
        }
            ...
            IEnumerable<string> customTags = null)
        {
            ...
            return new SimpleDiagnostic(id, category, message, description ?? string.Empty, helpLink ?? string.Empty,
