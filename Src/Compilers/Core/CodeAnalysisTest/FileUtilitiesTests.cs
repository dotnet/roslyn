...
namespace Microsoft.CodeAnalysis.UnitTests
{
    public class FileUtilitiesTests
    {
        ...
        public void GetPathRoot()
        {
            ...
            Assert.Equal(PathUtilities.DirectorySeparatorStr, PathUtilities.GetPathRoot(@"\"));
            Assert.Equal(PathUtilities.DirectorySeparatorStr, PathUtilities.GetPathRoot(@"\x"));
            Assert.Equal(PathUtilities.DirectorySeparatorStr, PathUtilities.GetPathRoot(@"/"));
            Assert.Equal(PathUtilities.DirectorySeparatorStr, PathUtilities.GetPathRoot(@"/x"));
            Assert.Equal(null, PathUtilities.GetPathRoot(@"\\"));
