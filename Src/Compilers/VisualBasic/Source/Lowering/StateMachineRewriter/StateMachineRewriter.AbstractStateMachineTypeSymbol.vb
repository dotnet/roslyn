...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend MustInherit Class StateMachineRewriter(Of TStateMachineState As AbstractStateMachineTypeSymbol, TProxy)
        ...
        Friend MustInherit Class AbstractStateMachineTypeSymbol
            ...
            Private Shared ReadOnly TypeSubstitutionFactory As Func(Of Symbol, TypeSubstitution) =
                Function(container) DirectCast(container, AbstractStateMachineTypeSymbol).TypeSubstitution
            ...
            Public NotOverridable Overrides ReadOnly Property MemberNames As IEnumerable(Of String)
                Get
