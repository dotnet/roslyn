...
Namespace Roslyn.Compilers.VisualBasic
    ...
    Friend NotInheritable Partial Class BoundConversion
        ...
        Public Sub New(syntax As SyntaxNode, operand As BoundExpression, conversionKind As ConversionKind, checked As Boolean, explicitCastInCode As Boolean, constantValueOpt As ConstantValue, constructorOpt As MethodSymbol, relaxationLambdaOpt As BoundLambda, relaxationReceiverPlaceholderOpt As BoundRValuePlaceholder, type As TypeSymbol, Optional hasErrors As Boolean = False)
            MyBase.New(BoundKind.Conversion, syntax, type, hasErrors OrElse operand.NonNullAndHasErrors() OrElse relaxationLambdaOpt.NonNullAndHasErrors() OrElse relaxationReceiverPlaceholderOpt.NonNullAndHasErrors())
        ...
        Public Function Update(operand As BoundExpression, conversionKind As ConversionKind, checked As Boolean, explicitCastInCode As Boolean, constantValueOpt As ConstantValue, constructorOpt As MethodSymbol, relaxationLambdaOpt As BoundLambda, relaxationReceiverPlaceholderOpt As BoundRValuePlaceholder, type As TypeSymbol) As BoundConversion
            If operand IsNot Me.Operand OrElse conversionKind <> Me.ConversionKind OrElse checked <> Me.Checked OrElse explicitCastInCode <> Me.ExplicitCastInCode OrElse constantValueOpt IsNot Me.ConstantValueOpt OrElse constructorOpt IsNot Me.ConstructorOpt OrElse relaxationLambdaOpt IsNot Me.RelaxationLambdaOpt OrElse relaxationReceiverPlaceholderOpt IsNot Me.RelaxationReceiverPlaceholderOpt OrElse type IsNot Me.Type Then
                Dim result = New BoundConversion(Me.Syntax, operand, conversionKind, checked, explicitCastInCode, constantValueOpt, constructorOpt, relaxationLambdaOpt, relaxationReceiverPlaceholderOpt, type, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundLateInvocation
        ...
        Public Sub New(syntax As SyntaxNode, member As BoundExpression, argumentsOpt As ReadOnlyArray(of BoundExpression), argumentNamesOpt As ReadOnlyArray(of string), accessKind As LateBoundAccessKind, methodOrPropertyGroupOpt As BoundMethodOrPropertyGroup, type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Private ReadOnly _ArgumentsOpt As ReadOnlyArray(of BoundExpression)
        Public ReadOnly Property ArgumentsOpt As ReadOnlyArray(of BoundExpression)
            Get
                Return _ArgumentsOpt
            End Get
        End Property

        Private ReadOnly _ArgumentNamesOpt As ReadOnlyArray(of string)
        Public ReadOnly Property ArgumentNamesOpt As ReadOnlyArray(of string)
            Get
        ...
        Public Function Update(member As BoundExpression, argumentsOpt As ReadOnlyArray(of BoundExpression), argumentNamesOpt As ReadOnlyArray(of string), accessKind As LateBoundAccessKind, methodOrPropertyGroupOpt As BoundMethodOrPropertyGroup, type As TypeSymbol) As BoundLateInvocation
    ...
    Friend NotInheritable Partial Class BoundObjectCreationExpression
        ...
        Public Sub New(syntax As SyntaxNode, constructorOpt As MethodSymbol, arguments As ReadOnlyArray(of BoundExpression), initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
            MyBase.New(BoundKind.ObjectCreationExpression, syntax, initializerOpt, type, hasErrors OrElse arguments.NonNullAndHasErrors() OrElse initializerOpt.NonNullAndHasErrors())
        ...
        Public Function Update(constructorOpt As MethodSymbol, arguments As ReadOnlyArray(of BoundExpression), initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol) As BoundObjectCreationExpression
            If constructorOpt IsNot Me.ConstructorOpt OrElse arguments <> Me.Arguments OrElse initializerOpt IsNot Me.InitializerOpt OrElse type IsNot Me.Type Then
                Dim result = New BoundObjectCreationExpression(Me.Syntax, constructorOpt, arguments, initializerOpt, type, Me.HasErrors)
    ...
    Friend MustInherit Partial Class BoundObjectInitializerExpressionBase
        ...
        Protected Sub New(kind As BoundKind, syntax as SyntaxNode, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ReadOnlyArray(of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
            MyBase.New(kind, syntax, type, hasErrors)
    ...
    Friend NotInheritable Partial Class BoundObjectInitializerExpression
        ...
        Public Sub New(syntax As SyntaxNode, createTemporaryLocalForInitialization As Boolean, binder As Binder, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ReadOnlyArray(of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(createTemporaryLocalForInitialization As Boolean, binder As Binder, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ReadOnlyArray(of BoundExpression), type As TypeSymbol) As BoundObjectInitializerExpression
    ...
    Friend NotInheritable Partial Class BoundCollectionInitializerExpression
        ...
        Public Sub New(syntax As SyntaxNode, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ReadOnlyArray(of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ReadOnlyArray(of BoundExpression), type As TypeSymbol) As BoundCollectionInitializerExpression
    ...
    Friend NotInheritable Partial Class BoundArrayLiteral
        ...
        Public Sub New(syntax As SyntaxNode, hasDominantType As Boolean, numberOfCandidates As Integer, inferredType As ArrayTypeSymbol, bounds As ReadOnlyArray(Of BoundExpression), initializer As BoundArrayInitialization, binder As Binder, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(hasDominantType As Boolean, numberOfCandidates As Integer, inferredType As ArrayTypeSymbol, bounds As ReadOnlyArray(Of BoundExpression), initializer As BoundArrayInitialization, binder As Binder) As BoundArrayLiteral
    ...
    Friend NotInheritable Partial Class BoundFieldAccess
        ...
        Public Sub New(syntax As SyntaxNode, receiverOpt As BoundExpression, fieldSymbol As FieldSymbol, isLValue As Boolean, constantsInProgressOpt As SymbolsInProgress(Of FieldSymbol), type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(receiverOpt As BoundExpression, fieldSymbol As FieldSymbol, isLValue As Boolean, constantsInProgressOpt As SymbolsInProgress(Of FieldSymbol), type As TypeSymbol) As BoundFieldAccess
    ...
    Friend NotInheritable Partial Class BoundBlock
        ...
        Public Sub New(syntax As SyntaxNode, statementListSyntax As SyntaxList(Of StatementSyntax), localsOpt As ReadOnlyArray(Of LocalSymbol), statements As ReadOnlyArray(Of BoundStatement), Optional hasErrors As Boolean = False)
        ...
        Public Function Update(statementListSyntax As SyntaxList(Of StatementSyntax), localsOpt As ReadOnlyArray(Of LocalSymbol), statements As ReadOnlyArray(Of BoundStatement)) As BoundBlock
    ...
    Friend NotInheritable Partial Class BoundAsNewLocalDeclarations
        ...
        Public Sub New(syntax As SyntaxNode, localDeclarations As ReadOnlyArray(of BoundLocalDeclaration), initializer As BoundExpression, syntaxNodesOpt As ReadOnlyArray(Of ModifiedIdentifierSyntax), Optional hasErrors As Boolean = False)
            ...
            Me._Initializer = initializer
            Me._SyntaxNodesOpt = syntaxNodesOpt
        End Sub
        ...
        Private ReadOnly _SyntaxNodesOpt As ReadOnlyArray(Of ModifiedIdentifierSyntax)
        Public ReadOnly Property SyntaxNodesOpt As ReadOnlyArray(Of ModifiedIdentifierSyntax)
            Get
                Return _SyntaxNodesOpt
            End Get
        End Property
        ...
        Public Function Update(localDeclarations As ReadOnlyArray(of BoundLocalDeclaration), initializer As BoundExpression, syntaxNodesOpt As ReadOnlyArray(Of ModifiedIdentifierSyntax)) As BoundAsNewLocalDeclarations
            If localDeclarations <> Me.LocalDeclarations OrElse initializer IsNot Me.Initializer OrElse syntaxNodesOpt <> Me.SyntaxNodesOpt Then
                Dim result = New BoundAsNewLocalDeclarations(Me.Syntax, localDeclarations, initializer, syntaxNodesOpt, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundFieldOrPropertyInitializer
        ...
        Public Sub New(syntax As SyntaxNode, initializedSymbols As ReadOnlyArray(Of Symbol), memberAccessExpressionOpt As BoundExpression, initialValue As BoundExpression, asNewSyntaxNodesOpt As ReadOnlyArray(Of SyntaxNode), Optional hasErrors As Boolean = False)
            MyBase.New(BoundKind.FieldOrPropertyInitializer, syntax, hasErrors OrElse memberAccessExpressionOpt.NonNullAndHasErrors() OrElse initialValue.NonNullAndHasErrors())

            Debug.Assert(Not (initializedSymbols.IsNull), "Field 'initializedSymbols' cannot be null (use Null=""allow"" in BoundNodes.xml to remove this check)")
            ...
            Me._InitializedSymbols = initializedSymbols
            Me._MemberAccessExpressionOpt = memberAccessExpressionOpt
            Me._InitialValue = initialValue
            Me._AsNewSyntaxNodesOpt = asNewSyntaxNodesOpt
        End Sub


        Private ReadOnly _InitializedSymbols As ReadOnlyArray(Of Symbol)
        Public ReadOnly Property InitializedSymbols As ReadOnlyArray(Of Symbol)
            Get
                Return _InitializedSymbols
            End Get
        End Property
        ...
        Private ReadOnly _AsNewSyntaxNodesOpt As ReadOnlyArray(Of SyntaxNode)
        Public ReadOnly Property AsNewSyntaxNodesOpt As ReadOnlyArray(Of SyntaxNode)
            Get
                Return _AsNewSyntaxNodesOpt
            End Get
        End Property
        ...
        Public Function Update(initializedSymbols As ReadOnlyArray(Of Symbol), memberAccessExpressionOpt As BoundExpression, initialValue As BoundExpression, asNewSyntaxNodesOpt As ReadOnlyArray(Of SyntaxNode)) As BoundFieldOrPropertyInitializer
            If initializedSymbols <> Me.InitializedSymbols OrElse memberAccessExpressionOpt IsNot Me.MemberAccessExpressionOpt OrElse initialValue IsNot Me.InitialValue OrElse asNewSyntaxNodesOpt <> Me.AsNewSyntaxNodesOpt Then
                Dim result = New BoundFieldOrPropertyInitializer(Me.Syntax, initializedSymbols, memberAccessExpressionOpt, initialValue, asNewSyntaxNodesOpt, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundSelectStatement
        ...
        Public Sub New(syntax As SyntaxNode, expressionStatement As BoundExpressionStatement, exprPlaceholderOpt As BoundRValuePlaceholder, caseBlocks As ReadOnlyArray(Of BoundCaseBlock), recommendSwitchTable As Boolean, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(expressionStatement As BoundExpressionStatement, exprPlaceholderOpt As BoundRValuePlaceholder, caseBlocks As ReadOnlyArray(Of BoundCaseBlock), recommendSwitchTable As Boolean, exitLabel As LabelSymbol) As BoundSelectStatement
    ...
    Friend NotInheritable Partial Class UnboundLambda
        ...
        Public Sub New(syntax As SyntaxNode, binder As Binder, flags As SourceMemberFlags, parameters As ReadOnlyArray(Of ParameterSymbol), returnType As TypeSymbol, bindingCache As UnboundLambda.UnboundLambdaBindingCache, hasErrors As Boolean)
        ...
        Public Sub New(syntax As SyntaxNode, binder As Binder, flags As SourceMemberFlags, parameters As ReadOnlyArray(Of ParameterSymbol), returnType As TypeSymbol, bindingCache As UnboundLambda.UnboundLambdaBindingCache)
        ...
        Public Function Update(binder As Binder, flags As SourceMemberFlags, parameters As ReadOnlyArray(Of ParameterSymbol), returnType As TypeSymbol, bindingCache As UnboundLambda.UnboundLambdaBindingCache) As UnboundLambda
    ...
    Friend NotInheritable Partial Class BoundLambda
        ...
        Public Sub New(syntax As SyntaxNode, lambdaSymbol As LambdaSymbol, body As BoundBlock, diagnosticsOpt As DiagnosticBag, lambdaBinderOpt As LambdaBodyBinder, delegateRelaxation As ConversionKind, methodConversionKind As MethodConversionKind, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(lambdaSymbol As LambdaSymbol, body As BoundBlock, diagnosticsOpt As DiagnosticBag, lambdaBinderOpt As LambdaBodyBinder, delegateRelaxation As ConversionKind, methodConversionKind As MethodConversionKind) As BoundLambda
            If lambdaSymbol IsNot Me.LambdaSymbol OrElse body IsNot Me.Body OrElse diagnosticsOpt IsNot Me.DiagnosticsOpt OrElse lambdaBinderOpt IsNot Me.LambdaBinderOpt OrElse delegateRelaxation <> Me.DelegateRelaxation OrElse methodConversionKind <> Me.MethodConversionKind Then
                Dim result = New BoundLambda(Me.Syntax, lambdaSymbol, body, diagnosticsOpt, lambdaBinderOpt, delegateRelaxation, methodConversionKind, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundQueryLambda
        ...
        Public Sub New(syntax As SyntaxNode, lambdaSymbol As QueryLambdaSymbol, rangeVariables As ReadOnlyArray(Of RangeVariableSymbol), expression As BoundExpression, exprIsOperandOfConditionalBranch As Boolean, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(lambdaSymbol As QueryLambdaSymbol, rangeVariables As ReadOnlyArray(Of RangeVariableSymbol), expression As BoundExpression, exprIsOperandOfConditionalBranch As Boolean) As BoundQueryLambda
    ...
    Friend NotInheritable Partial Class BoundSyncLockStatement
        ...
        Public Sub New(syntax As SyntaxNode, lockExpression As BoundExpression, body As BoundBlock, checkForSyncLockOnValueType As Boolean, Optional hasErrors As Boolean = False)
            ...
            Me._Body = body
            Me._CheckForSyncLockOnValueType = checkForSyncLockOnValueType
        End Sub
        ...
        Private ReadOnly _CheckForSyncLockOnValueType As Boolean
        Public ReadOnly Property CheckForSyncLockOnValueType As Boolean
            Get
                Return _CheckForSyncLockOnValueType
            End Get
        End Property
        ...
        Public Function Update(lockExpression As BoundExpression, body As BoundBlock, checkForSyncLockOnValueType As Boolean) As BoundSyncLockStatement
            If lockExpression IsNot Me.LockExpression OrElse body IsNot Me.Body OrElse checkForSyncLockOnValueType <> Me.CheckForSyncLockOnValueType Then
                Dim result = New BoundSyncLockStatement(Me.Syntax, lockExpression, body, checkForSyncLockOnValueType, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionHandlingStatement
        ...
        Public Sub New(syntax As SyntaxNode, containsOnError As Boolean, containsResume As Boolean, resumeWithoutLabelOpt As StatementSyntax, body As BoundBlock, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(containsOnError As Boolean, containsResume As Boolean, resumeWithoutLabelOpt As StatementSyntax, body As BoundBlock) As BoundUnstructuredExceptionHandlingStatement
            If containsOnError <> Me.ContainsOnError OrElse containsResume <> Me.ContainsResume OrElse resumeWithoutLabelOpt IsNot Me.ResumeWithoutLabelOpt OrElse body IsNot Me.Body Then
                Dim result = New BoundUnstructuredExceptionHandlingStatement(Me.Syntax, containsOnError, containsResume, resumeWithoutLabelOpt, body, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionOnErrorSwitch
        ...
        Public Sub New(syntax As SyntaxNode, value As BoundExpression, jumps As ReadOnlyArray(Of BoundGotoStatement), Optional hasErrors As Boolean = False)
            ...
            Debug.Assert(value IsNot Nothing, "Field 'value' cannot be null (use Null=""allow"" in BoundNodes.xml to remove this check)")
            Debug.Assert(Not (jumps.IsNull), "Field 'jumps' cannot be null (use Null=""allow"" in BoundNodes.xml to remove this check)")
        ...
        Private ReadOnly _Jumps As ReadOnlyArray(Of BoundGotoStatement)
        Public ReadOnly Property Jumps As ReadOnlyArray(Of BoundGotoStatement)
            Get
                Return _Jumps
            End Get
        End Property
        ...
        Public Function Update(value As BoundExpression, jumps As ReadOnlyArray(Of BoundGotoStatement)) As BoundUnstructuredExceptionOnErrorSwitch
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionResumeSwitch
        ...
        Public Sub New(syntax As SyntaxNode, resumeTargetTemporary As BoundLocal, resumeLabel As BoundLabelStatement, resumeNextLabel As BoundLabelStatement, jumps As ReadOnlyArray(Of BoundGotoStatement), Optional hasErrors As Boolean = False)
        ...
        Public Function Update(resumeTargetTemporary As BoundLocal, resumeLabel As BoundLabelStatement, resumeNextLabel As BoundLabelStatement, jumps As ReadOnlyArray(Of BoundGotoStatement)) As BoundUnstructuredExceptionResumeSwitch
    ...
    Friend NotInheritable Partial Class BoundAwaitOperator
        ...
        Public Sub New(syntax As SyntaxNode, operand As BoundExpression, awaitableInstancePlaceholder As BoundExpression, getAwaiter As BoundExpression, awaiterInstancePlaceholder As BoundExpression, isCompleted As BoundExpression, getResult As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Private ReadOnly _AwaitableInstancePlaceholder As BoundExpression
        Public ReadOnly Property AwaitableInstancePlaceholder As BoundExpression
            Get
        ...
        Private ReadOnly _AwaiterInstancePlaceholder As BoundExpression
        Public ReadOnly Property AwaiterInstancePlaceholder As BoundExpression
            Get
        ...
        Public Function Update(operand As BoundExpression, awaitableInstancePlaceholder As BoundExpression, getAwaiter As BoundExpression, awaiterInstancePlaceholder As BoundExpression, isCompleted As BoundExpression, getResult As BoundExpression, type As TypeSymbol) As BoundAwaitOperator
    ...
    Friend MustInherit Partial Class BoundTreeRewriter
        ...
        Public Overrides Function VisitConversion(node As BoundConversion) As BoundNode
            ...
            Dim type as TypeSymbol = Me.VisitType(node.Type)
            Return node.Update(operand, node.ConversionKind, node.Checked, node.ExplicitCastInCode, node.ConstantValueOpt, node.ConstructorOpt, relaxationLambdaOpt, relaxationReceiverPlaceholderOpt, type)
        End Function
        ...
        Public Overrides Function VisitLateInvocation(node As BoundLateInvocation) As BoundNode
            ...
            Dim argumentsOpt As ReadOnlyArray(of BoundExpression) = Me.VisitList(node.ArgumentsOpt)
        ...
        Public Overrides Function VisitObjectCreationExpression(node As BoundObjectCreationExpression) As BoundNode
            ...
            Dim type as TypeSymbol = Me.VisitType(node.Type)
            Return node.Update(node.ConstructorOpt, arguments, initializerOpt, type)
        End Function
        ...
        Public Overrides Function VisitAsNewLocalDeclarations(node As BoundAsNewLocalDeclarations) As BoundNode
            ...
            Return node.Update(localDeclarations, initializer, node.SyntaxNodesOpt)
        End Function
        ...
        Public Overrides Function VisitFieldOrPropertyInitializer(node As BoundFieldOrPropertyInitializer) As BoundNode
            ...
            Return node.Update(node.InitializedSymbols, memberAccessExpressionOpt, initialValue, node.AsNewSyntaxNodesOpt)
        End Function
        ...
        Public Overrides Function VisitLambda(node As BoundLambda) As BoundNode
            Dim body As BoundBlock = DirectCast(Me.Visit(node.Body), BoundBlock)
            Dim type as TypeSymbol = Me.VisitType(node.Type)
            Return node.Update(node.LambdaSymbol, body, node.DiagnosticsOpt, node.LambdaBinderOpt, node.DelegateRelaxation, node.MethodConversionKind)
        End Function
        ...
        Public Overrides Function VisitSyncLockStatement(node As BoundSyncLockStatement) As BoundNode
            ...
            Dim body As BoundBlock = DirectCast(Me.Visit(node.Body), BoundBlock)
            Return node.Update(lockExpression, body, node.CheckForSyncLockOnValueType)
        End Function
        ...
        Public Overrides Function VisitUnstructuredExceptionHandlingStatement(node As BoundUnstructuredExceptionHandlingStatement) As BoundNode
            Dim body As BoundBlock = DirectCast(Me.Visit(node.Body), BoundBlock)
            Return node.Update(node.ContainsOnError, node.ContainsResume, node.ResumeWithoutLabelOpt, body)
        End Function
        ...
        Public Overrides Function VisitUnstructuredExceptionOnErrorSwitch(node As BoundUnstructuredExceptionOnErrorSwitch) As BoundNode
            Dim value As BoundExpression = DirectCast(Me.Visit(node.Value), BoundExpression)
            Dim jumps As ReadOnlyArray(Of BoundGotoStatement) = Me.VisitList(node.Jumps)
        ...
        Public Overrides Function VisitAwaitOperator(node As BoundAwaitOperator) As BoundNode
            Dim operand As BoundExpression = DirectCast(Me.Visit(node.Operand), BoundExpression)
            Dim awaitableInstancePlaceholder As BoundExpression = DirectCast(Me.Visit(node.AwaitableInstancePlaceholder), BoundExpression)
            Dim getAwaiter As BoundExpression = DirectCast(Me.Visit(node.GetAwaiter), BoundExpression)
            Dim awaiterInstancePlaceholder As BoundExpression = DirectCast(Me.Visit(node.AwaiterInstancePlaceholder), BoundExpression)
    ...
    Friend NotInheritable Class BoundTreeDumperNodeProducer
        ...
        Public Overrides Function VisitAsNewLocalDeclarations(node As BoundAsNewLocalDeclarations, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("asNewLocalDeclarations", Nothing, New TreeDumperNode() {
                ...
                New TreeDumperNode("initializer", Nothing, new TreeDumperNode() { Visit(node.Initializer, Nothing) }),
                New TreeDumperNode("syntaxNodesOpt", node.SyntaxNodesOpt, Nothing)
            })
        End Function
        ...
        Public Overrides Function VisitFieldOrPropertyInitializer(node As BoundFieldOrPropertyInitializer, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("fieldOrPropertyInitializer", Nothing, New TreeDumperNode() {
                New TreeDumperNode("initializedSymbols", node.InitializedSymbols, Nothing),
                ...
                New TreeDumperNode("asNewSyntaxNodesOpt", node.AsNewSyntaxNodesOpt, Nothing)
            })
        End Function
        ...
        Public Overrides Function VisitSyncLockStatement(node As BoundSyncLockStatement, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("syncLockStatement", Nothing, New TreeDumperNode() {
                ...
                New TreeDumperNode("body", Nothing, new TreeDumperNode() { Visit(node.Body, Nothing) }),
                New TreeDumperNode("checkForSyncLockOnValueType", node.CheckForSyncLockOnValueType, Nothing)
            })
        End Function
