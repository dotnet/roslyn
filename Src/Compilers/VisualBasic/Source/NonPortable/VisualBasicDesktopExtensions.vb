...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Module VisualBasicDesktopExtensions
        ''' <summary>
        ...
        Function Emit(compilation As VisualBasicCompilation,
            ...
            Return DesktopExtensions.Emit(compilation, outputPath, pdbPath, xmlDocPath, win32ResourcesPath, manifestResources, cancellationToken)
        End Function
    End Module
End Namespace
