...
End Class]]>).Value
        ...
        Assert.Equal(SyntaxKind.SubBlock, exp1.VisualBasicKind())
        Assert.Equal(exp1.VisualBasicKind(), inc1.VisualBasicKind())

        Dim exp2 = exp1.ChildNodesAndTokens()(1)
        Dim inc2 = inc1.ChildNodesAndTokens()(1)
        Assert.Equal(SyntaxKind.LocalDeclarationStatement, exp2.VisualBasicKind())
        Assert.Equal(exp2.VisualBasicKind(), inc2.VisualBasicKind())
...
End Class
        ...
        Dim tempToken2 = tempRoot2.DescendantTokens().First(Function(t) t.VisualBasicKind = SyntaxKind.IdentifierToken)
