...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests
    ...
    Public Class SyntaxEquivalenceTests
        ...
        Private Sub VerifyEquivalent(tree1 As SyntaxTree, tree2 As SyntaxTree, topLevel As Boolean)
            ...
            Dim tree3 = VBSyntaxTree.ParseText(tree2.GetText().ToString())
        ...
        Public Sub TestEmptyTrees()
            Dim text = ""
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text)
        ...
        Public Sub TestAddingClass()
            Dim tree1 = VBSyntaxTree.ParseText(NewLines("namespace N \n end namespace"))
        ...
        Public Sub TestChangingEnumMember()
            Dim tree1 = VBSyntaxTree.ParseText(NewLines("enum E \n i = 5 \n end enum"))
            Dim tree2 = tree1.WithReplaceFirst("5", "6")
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
        End Sub
        ...
        Public Sub TestChangingUsing()
            Dim tree1 = VBSyntaxTree.ParseText(NewLines("Imports System \n namespace N \n class C \n sub Foo() \n Console.Write(0) \n end sub \n end class \n end namespace"))
        ...
        Public Sub TestChangingBaseType()
            Dim tree1 = VBSyntaxTree.ParseText(NewLines("class C \n sub Foo() \n Console.Write(0) \n end sub \n end class"))
        ...
        Public Sub TestChangeWhitespace()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace(" ", "  "))
            VerifyEquivalent(tree1, tree2, topLevel:=True)
            VerifyEquivalent(tree1, tree2, topLevel:=False)
        End Sub
        ...
        Public Sub TestSkippedText()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Modle ", "Mode "))
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
...
#Region "Methods"
        ...
        Public Sub TestMethod_Body()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) \n Body(1) \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Body(1)", "Body(2)"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_Modifiers()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Friend", ""))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ParameterName()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) \n \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("args", "arg"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ParameterAttribute()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) \n \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("args", "<A>args"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ParameterModifier()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) \n \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("args", "ByRef args"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ParameterDefaultValue()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("123", "456"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_Kind()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Function", "Sub"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ReturnType1()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("As Integer", ""))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ReturnType2()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("As C", "As D"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ReturnTypeCustomAttribute()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("As <A(1)>C", "As <A(2)>C"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_Handles()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("E.Foo", "E.Bar"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_Implements()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("I.Foo", "I.Bar"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_RemoveEnd()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) Implements I.Foo \n \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("End Sub", ""))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestMethod_ChangeEndKind()
            Dim text = NewLines("Imports System \n Module Program \n Sub Main(args As String()) Implements I.Foo \n \n End Sub \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("End Sub", "End Function"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
...
#Region "Constructor"
        ...
        Public Sub TestConstructor_Initializer()
            Dim text = NewLines("Imports System \n Class Program \n Sub New(args As String()) \n MyBase.New(1) \n End Sub \n End Class")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("MyBase", "Me"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
...
#Region "Operator"
        ...
        Public Sub TestOperator_Body()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Return 0", "Return 1"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestOperator_ParameterName()
            Dim text = NewLines("Imports System \n Class C \n Shared Operator *(a As C, b As C) As Integer \n Return 0 \n End Operator \n End Class")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("b As C", "c As C"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
#End Region
...
#Region "Property"
        ...
        Public Sub TestPropertyAccessor_Attribute1()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("<A(1)>", "<A(2)>"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestProperty_Parameters()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("123", "345"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
...
#Region "Declare"
        ...
        Public Sub TestDeclare_Modifier()
            ...
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Ansi", "Unicode"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestDeclare_LibName()
            Dim text = NewLines("Imports System \n Module Program \n Declare Ansi Function Foo Lib ""foo"" Alias ""bar"" () As Integer \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("foo", "foo2"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestDeclare_AliasName()
            Dim text = NewLines("Imports System \n Module Program \n Declare Ansi Function Foo Lib ""foo"" Alias ""bar"" () As Integer \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("bar", "bar2"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestDeclare_ReturnType()
            Dim text = NewLines("Imports System \n Module Program \n Declare Ansi Function Foo Lib ""foo"" Alias ""bar"" () As Integer \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("Integer", "Boolean"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
        ...
        Public Sub TestDeclare_Parameter()
            Dim text = NewLines("Imports System \n Module Program \n Declare Ansi Function Foo Lib ""foo"" Alias ""bar"" () As Integer \n End Module")
            Dim tree1 = VBSyntaxTree.ParseText(text)
            Dim tree2 = VBSyntaxTree.ParseText(text.Replace("()", "(a As Integer)"))
            VerifyNotEquivalent(tree1, tree2, topLevel:=False)
            VerifyNotEquivalent(tree1, tree2, topLevel:=True)
        End Sub
#End Region
