...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef,
                                                                                     {SystemCoreRef},
                                                                                     OptionsExe.WithDebugInformationKind(DebugInformationKind.Full).WithOptimizations(False))
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlib(compilationDef, OptionsDll)
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef, {SystemRef},
                                                                                     OptionsDll.WithRootNamespace("WindowsApplication1"))
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef,
                                                                                     {SystemCoreRef},
                                                                                     OptionsExe.WithRootNamespace("WindowsApplication1"))
...
End Module
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef,
                                                                                     {SystemCoreRef},
                                                                                     OptionsExe.WithRootNamespace("WindowsApplication1").WithDebugInformationKind(DebugInformationKind.Full))
