...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(compilationDef, OptionsExe.WithMainTypeName("Test"))
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef, {SystemWindowsFormsRef, SystemDrawingRef}, OptionsExe.WithMainTypeName("ns.test"))
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntimeAndReferences(compilationDef, {SystemWindowsFormsRef, SystemDrawingRef}, OptionsExe.WithMainTypeName("Test"))
