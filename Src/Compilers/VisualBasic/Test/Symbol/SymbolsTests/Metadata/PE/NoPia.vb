...
End Class
            ...
            Dim localTypes1 = VBCompilation.Create("LocalTypes1", {Parse(localTypes1Source)}, {pia1CopyLink, mscorlibRef})
            Dim localTypes1Asm = localTypes1.Assembly

            Dim localTypes2 = VBCompilation.Create("LocalTypes2", {Parse(localTypes2Source)}, {mscorlibRef, pia1CopyLink})
        ...
        Public Sub GenericsClosedOverLocalTypes2()
            ...
            Dim tc1 = VBCompilation.Create("C1", references:={mscorlibRef, pia5Link})
            ...
            Dim tc2 = VBCompilation.Create("C1", references:={mscorlibRef, pia5Ref})
            ...
            Dim tc3 = VBCompilation.Create("C1", references:={mscorlibRef, library2Ref, pia5Link, pia1Ref})
            ...
            Dim tc4 = VBCompilation.Create("C1", references:={mscorlibRef, library2Ref, pia5Ref, pia1Ref})
            ...
            Dim tc5 = VBCompilation.Create("C1", references:={mscorlibRef, library2Ref, pia5Link, pia1Link})
            ...
            Dim tc6 = VBCompilation.Create("C1", references:={mscorlibRef, library2Ref, pia5Link, pia1Ref})
            ...
            Dim tc7 = VBCompilation.Create("C1", references:={mscorlibRef, library2Link, pia5Link, pia1Ref})
        ...
        Public Sub GenericsClosedOverLocalTypes3()
            ...
            Dim tc1 = VBCompilation.Create("C1", references:={varmscorlibRef, varCRef, varARef, varBLink})
            ...
            Dim tc2 = VBCompilation.Create("C2", references:={varmscorlibRef, varCRef, varARef, varDRef, varBLink})
            ...
            Dim tc3 = VBCompilation.Create("C3", references:={varmscorlibRef, varCRef, varBLink})
            ...
            Dim tc4 = VBCompilation.Create("C4", references:={varmscorlibRef, varCRef, varARef, varBRef})
            ...
            Dim tc5 = VBCompilation.Create("C5", references:={varmscorlibRef, varCRef, varALink, varBLink})
            ...
            Dim tc6 = VBCompilation.Create("C6", references:={varmscorlibRef, varARef, varBLink, varCLink})
            ...
            Dim tc7 = VBCompilation.Create("C7", references:={varmscorlibRef, varCRef, varARef})
...
End Class
            ...
            Dim varC_LocalTypes3 = VBCompilation.Create("LocalTypes3", {Parse(localTypes3Source)}, {mscorlibRef, pia1CopyLink})
...
End interface
            ...
            Dim varC_Pia5 = VBCompilation.Create("Pia5", {Parse(pia5Source)}, {mscorlibRef})
            ...
            Dim varC_Pia1 = VBCompilation.Create("Pia1", {Parse(pia1Source)}, {mscorlibRef})
            ...
            Dim varC_Library2 = VBCompilation.Create("Library2", {Parse(library2Source)}, {mscorlibRef, pia1Ref, pia5Ref})
        ...
        Public Sub GenericsClosedOverLocalTypes6()
            Dim mscorlibRef = TestReferences.NetFx.v4_0_21006.mscorlib
            Dim varC_A = VBCompilation.Create("A", references:={mscorlibRef})
            ...
            Dim varC_B = VBCompilation.Create("B", references:={mscorlibRef})
            ...
            Dim varC_C = VBCompilation.Create("C", references:={mscorlibRef, varARef, varBRef})
            ...
            Dim varC_D = VBCompilation.Create("D", references:={mscorlibRef})
            ...
            Dim tc1 = VBCompilation.Create("C1", references:={mscorlibRef, varCRef, varARef, varBLink})
            Dim varA1 = tc1.GetReferencedAssemblySymbol(varARef)
            Dim varB1 = tc1.GetReferencedAssemblySymbol(varBLink)
            Dim varC1 = tc1.GetReferencedAssemblySymbol(varCRef)
            Dim tc2 = VBCompilation.Create("C2", references:={mscorlibRef, varCRef, varARef, varDRef, varBLink})
            Assert.Same(varA1, tc2.GetReferencedAssemblySymbol(varARef))
            Assert.Same(varB1, tc2.GetReferencedAssemblySymbol(varBLink))
            Assert.Same(varC1, tc2.GetReferencedAssemblySymbol(varCRef))
            Dim varD2 = tc2.GetReferencedAssemblySymbol(varDRef)
            Dim tc3 = VBCompilation.Create("C3", references:={mscorlibRef, varCRef, varBLink})
            Assert.Same(varB1, tc3.GetReferencedAssemblySymbol(varBLink))
            Assert.True(tc3.GetReferencedAssemblySymbol(varCRef).RepresentsTheSameAssemblyButHasUnresolvedReferencesByComparisonTo(varC1))
            Dim tc4 = VBCompilation.Create("C4", references:={mscorlibRef, varCRef, varARef, varBRef})
            Assert.Same(varA1, tc4.GetReferencedAssemblySymbol(varARef))
            Dim varB4 = tc4.GetReferencedAssemblySymbol(varBRef)
            Dim varC4 = tc4.GetReferencedAssemblySymbol(varCRef)
            Assert.NotSame(varC1, varC4)
            Assert.NotSame(varB1, varB4)
            Dim tc5 = VBCompilation.Create("C5", references:={mscorlibRef, varCRef, varALink, varBLink})
            Assert.Same(varB1, tc5.GetReferencedAssemblySymbol(varBLink))
            Dim varA5 = tc5.GetReferencedAssemblySymbol(varALink)
            Dim varC5 = tc5.GetReferencedAssemblySymbol(varCRef)
            Assert.NotSame(varA1, varA5)
            Assert.NotSame(varC1, varC5)
            Assert.NotSame(varC4, varC5)
            Dim tc6 = VBCompilation.Create("C6", references:={mscorlibRef, varARef, varBLink, varCLink})
            Assert.Same(varA1, tc6.GetReferencedAssemblySymbol(varARef))
            Assert.Same(varB1, tc6.GetReferencedAssemblySymbol(varBLink))
            Dim varC6 = tc6.GetReferencedAssemblySymbol(varCLink)
            Assert.NotSame(varC1, varC6)
            Assert.NotSame(varC4, varC6)
            Assert.NotSame(varC5, varC6)
            Dim tc7 = VBCompilation.Create("C7", references:={mscorlibRef, varCRef, varARef})
            Assert.Same(varA1, tc7.GetReferencedAssemblySymbol(varARef))
            Assert.True(tc7.GetReferencedAssemblySymbol(varCRef).RepresentsTheSameAssemblyButHasUnresolvedReferencesByComparisonTo(varC4))
            GC.KeepAlive(tc1)
            GC.KeepAlive(tc2)
