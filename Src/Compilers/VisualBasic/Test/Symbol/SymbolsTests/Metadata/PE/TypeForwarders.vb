...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests.Symbols.Metadata.PE
    ...
    Public Class TypeForwarders : Inherits BasicTestBase
        ...
        Public Sub TypeInNamespace()
            ...
            Dim funcType = corlibAssembly.GetTypeByMetadataName(funcTypeMetadataName, includeReferences:=False)
            ...
            Assert.Equal(funcType, comp.Assembly.GetTypeByMetadataName(funcTypeMetadataName, includeReferences:=True))
        End Sub
...
End Class
            ...
            Dim ref1 = CompileIL(il1.Value, appendDefaultHeader:=False)
            Dim ref2 = CompileIL(il2.Value, appendDefaultHeader:=False)
            Dim ref3 = CompileIL(il3.Value, appendDefaultHeader:=False)
...
End Class
            ...
            Dim ref2 = CompileIL(il2.Value, appendDefaultHeader:=False)
            Dim ref3 = CompileIL(il3.Value, appendDefaultHeader:=False)
            Dim ref4 = CompileIL(il4.Value, appendDefaultHeader:=False)
