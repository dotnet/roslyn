...
End Module
            ...
            Assert.True(trivia.Any(Function(x) x.VisualBasicKind = SyntaxKind.CommentTrivia))
            Assert.False(trivia.Any(Function(x) x.VisualBasicKind = SyntaxKind.DocumentationCommentTrivia))
...
End Module
            ...
            Assert.False(trivia.Any(Function(x) x.VisualBasicKind = SyntaxKind.CommentTrivia))
            Assert.True(trivia.Any(Function(x) x.VisualBasicKind = SyntaxKind.DocumentationCommentTrivia))
