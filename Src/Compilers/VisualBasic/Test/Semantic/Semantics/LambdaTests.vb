...
End Module
            ...
            Dim comp1 = CompilationUtils.CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithOptionStrict(OptionStrict.Off))
            CompilationUtils.AssertNoErrors(comp1)
            Dim comp2 = CompilationUtils.CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithOptionStrict(OptionStrict.On))
...
End Class
            ...
            Dim compilation = CompilationUtils.CreateCompilationWithMscorlib(compilationDef, OptionsExe)
