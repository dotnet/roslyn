...
End Module
            ...
            Dim compilation = CreateCompilationWithReferences(source, {MscorlibRef, MsvbRef}, OptionsExe)
...
End Class
            ...
            Dim compilation = CreateCompilationWithReferences(source, {MscorlibRef_v20}, OptionsExe)
...
End Class
            ...
            Dim compilation = CreateCompilationWithReferences(source, LatestReferences, OptionsExe)
...
End Class
            ...
            Dim compilation = CreateCompilationWithReferences(source, {MscorlibRef_v4_0_30316_17626, MsvbRef_v4_0_30319_17929}, OptionsDll)
...
<compilation>
    <file name="a.vb">
        <%= My.Resources.Resource.Async_Overload_Change_3_vb %>
            ...
            Dim compilation = CreateCompilationWithReferences(source,
                                    {MscorlibRef_v4_0_30316_17626, MsvbRef_v4_0_30319_17929},
                                    OptionsExe.WithSpecificDiagnosticOptions(New ReadOnlyDictionary(Of String, ReportDiagnostic)(warnings)))
