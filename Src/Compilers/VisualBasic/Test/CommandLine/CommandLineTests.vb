...
a.vb
    ...
    Public Sub ParseResourceDescription()
        ...
        desc = VisualBasicCommandLineParser.ParseResourceDescription("resource", "\somepath\someFile.foo.bar,someName,pubic", _baseDirectory, diags, embedded:=False)
        diags.Verify(Diagnostic(ERRID.ERR_InvalidSwitchValue).WithArguments("pubic", "resource"))
        diags.Clear()
        Assert.Null(desc)
