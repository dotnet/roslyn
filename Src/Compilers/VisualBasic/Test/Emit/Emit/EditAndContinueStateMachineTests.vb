                ...
                diff1.VerifyIL("C.VB$StateMachine_1_F.MoveNext()", "
{
  ...
  .try
  {
    ...
    IL_007f:  ldloc.s    V_6
    IL_0081:  stloc.0
    IL_0082:  leave.s    IL_00a9
  }
  catch System.Exception
  {
    IL_0084:  dup
    IL_0085:  call       ""Sub Microsoft.VisualBasic.CompilerServices.ProjectData.SetProjectError(System.Exception)""
    IL_008a:  stloc.s    V_7
    IL_008c:  ldarg.0
    IL_008d:  ldc.i4.s   -2
    IL_008f:  stfld      ""C.VB$StateMachine_1_F.$State As Integer""
    IL_0094:  ldarg.0
    IL_0095:  ldflda     ""C.VB$StateMachine_1_F.$Builder As System.Runtime.CompilerServices.AsyncTaskMethodBuilder(Of Integer)""
    IL_009a:  ldloc.s    V_7
    IL_009c:  call       ""Sub System.Runtime.CompilerServices.AsyncTaskMethodBuilder(Of Integer).SetException(System.Exception)""
    IL_00a1:  nop
    IL_00a2:  call       ""Sub Microsoft.VisualBasic.CompilerServices.ProjectData.ClearProjectError()""
    IL_00a7:  leave.s    IL_00c0
  }
  IL_00a9:  ldarg.0
  IL_00aa:  ldc.i4.s   -2
  IL_00ac:  dup
  IL_00ad:  stloc.1
  IL_00ae:  stfld      ""C.VB$StateMachine_1_F.$State As Integer""
  IL_00b3:  ldarg.0
  IL_00b4:  ldflda     ""C.VB$StateMachine_1_F.$Builder As System.Runtime.CompilerServices.AsyncTaskMethodBuilder(Of Integer)""
  IL_00b9:  ldloc.0
