...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe)
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsDll)
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(
                {VisualBasicSyntaxTree.ParseText(vbx.Value, options:=OptionsScript),
                 VisualBasicSyntaxTree.ParseText(vb.Value, options:=VisualBasicParseOptions.Default)}, compOptions:=OptionsExe)
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("N.M"))
...
End Namespace
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithMainTypeName("N.M"))
            compilation.VerifyDiagnostics()
        End Sub
...
End Structure
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("C.D"))
            compilation.VerifyDiagnostics()
        End Sub
...
End Interface
            ...
            Dim compilation = CreateCompilationWithMscorlib(vb, options:=OptionsExe)
            compilation.VerifyDiagnostics()
            CompileAndVerify(compilation, expectedOutput:="5")

            compilation = CreateCompilationWithMscorlib(vb, options:=OptionsExe.WithMainTypeName("C"))
            compilation.VerifyDiagnostics(Diagnostic(ERRID.ERR_GenericSubMainsFound1).WithArguments("C"))

            compilation = CreateCompilationWithMscorlib(vb, options:=OptionsExe.WithMainTypeName("D.DD"))
            compilation.VerifyDiagnostics(Diagnostic(ERRID.ERR_GenericSubMainsFound1).WithArguments("D(Of T).DD"))

            compilation = CreateCompilationWithMscorlib(vb, options:=OptionsExe.WithMainTypeName("I"))
...
End Class
            ...
            CompileAndVerify(source, options:=OptionsExe.WithMainTypeName("A.B.C"), expectedOutput:="1")
        End Sub
...
End Class
            ...
            CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("A.B.C")).VerifyDiagnostics(Diagnostic(ERRID.ERR_GenericSubMainsFound1).WithArguments("A.B(Of T).C"))
        End Sub
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("C"))
            compilation.VerifyDiagnostics()
        End Sub
...
System.Console.WriteLine(1)
            ...
            Dim compilation = CreateCompilationWithMscorlib(
                {VisualBasicSyntaxTree.ParseText(vbx.Value, options:=OptionsScript)}, compOptions:=OptionsExe)
...
End Class
            ...
            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("D"))
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("D"))
...
End Interface
            ...
            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("I"))
            compilation.VerifyDiagnostics(
...
End Class
            ...
            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("E"))
            compilation.VerifyDiagnostics(Diagnostic(ERRID.ERR_StartupCodeNotFound1).WithArguments("E"))

            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("F"))
            compilation.VerifyDiagnostics(Diagnostic(ERRID.ERR_InValidSubMainsFound1).WithArguments("F"))

            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("G.P"))
            compilation.VerifyDiagnostics(Diagnostic(ERRID.ERR_InValidSubMainsFound1).WithArguments("G.P"))

            compilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("G.P.Q"))
...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib(
                {VisualBasicSyntaxTree.ParseText(vbx.Value, options:=OptionsScript),
                 VisualBasicSyntaxTree.ParseText(vb.Value, options:=OptionsRegular)}, compOptions:=OptionsExe.WithMainTypeName("C"))
...
<compilation name="a">
    <file>
        ...
        End Class
            ...
            CreateCompilationWithMscorlib(source, options:=OptionsExe).VerifyDiagnostics(
                 Diagnostic(ERRID.ERR_InValidSubMainsFound1).WithArguments("a"))
...
<compilation name="a">
    <file>
        ...
        End Module
            ...
            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe).VerifyDiagnostics(
                Diagnostic(ERRID.ERR_InValidSubMainsFound1).WithArguments("a"))
        End Sub
...
<compilation name="a">
    <file>
        ...
        End Module
            ...
            CreateCompilationWithMscorlibAndVBRuntime(source, Nothing, options:=OptionsExe).VerifyDiagnostics(
...
End Class
            ...
            CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("Main")).VerifyDiagnostics(
...
End Class
            ...
            AssertTheseDiagnostics(CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("")),
                                                                 <expected>
...
<compilation>
    <file>
        ...
        End Module
            ...
            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe.WithMainTypeName("B")).VerifyDiagnostics(
                Diagnostic(ERRID.ERR_StartupCodeNotFound1).WithArguments("B"))

            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe.WithMainTypeName("extention")).VerifyDiagnostics(
...
<compilation>
    <file>
        ...
        Delegate Sub mydelegate(args As String()) 
            ...
            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe.WithMainTypeName("I1")).VerifyDiagnostics(
                Diagnostic(ERRID.ERR_StartupCodeNotFound1).WithArguments("i1"))

            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe.WithMainTypeName("COLOR")).VerifyDiagnostics(
                Diagnostic(ERRID.ERR_StartupCodeNotFound1).WithArguments("color"))

            CreateCompilationWithMscorlibAndVBRuntimeAndReferences(source, {SystemCoreRef}, options:=OptionsExe.WithMainTypeName("mydelegate")).VerifyDiagnostics(
...
<compilation>
    <file>
        class a
            ...
            CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("1")).VerifyDiagnostics(
...
<compilation>
    <file>
        class a
            ...
            CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("<")).VerifyDiagnostics(
...
<compilation>
    <file>
        ...
        End Class
            ...
            Dim compilation As VisualBasicCompilation = CreateCompilationWithMscorlib(source, options:=OptionsExe.WithMainTypeName("B"))
            compilation.VerifyDiagnostics()
...
<compilation>
    <file>
        ...
        End Class
            ...
            Dim compilation2 As VisualBasicCompilation = CreateCompilationWithMscorlibAndReferences(source2, {New VisualBasicCompilationReference(compilation1)}, options:=OptionsExe.WithMainTypeName("B"))
...
End Class
            ...
            Dim netModule = CreateCompilationWithMscorlib(source, options:=OptionsNetModule)

            compilation = CreateCompilationWithMscorlibAndReferences(
<compilation name="Bug630763">
    <file>
    </file>
</compilation>, {netModule.EmitToImageReference()}, options:=OptionsExe)
...
BC30420: 'Sub Main' was not found in 'Bug630763'.
        ...
        Public Sub RootMemberNamedScript()
            ...
            comp = CompilationUtils.CreateCompilationWithMscorlib(options:=OptionsExe, sources:=
