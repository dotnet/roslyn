...
End Module
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithDebugInformationKind(DebugInformationKind.None).WithOptimizations(True))
...
End Module
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithDebugInformationKind(DebugInformationKind.None).WithOptimizations(True)).VerifyDiagnostics(Diagnostic(ERRID.ERR_MultiplyDefined1, "10").WithArguments("10"))
        End Sub
...
End Module
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithDebugInformationKind(DebugInformationKind.None).WithOptimizations(True)).VerifyDiagnostics(Diagnostic(ERRID.ERR_Syntax, "-"))
        End Sub
...
End Module
            ...
            Dim compilation = CreateCompilationWithMscorlibAndVBRuntime(source, OptionsExe.WithDebugInformationKind(DebugInformationKind.None).WithOptimizations(True)).VerifyDiagnostics(Diagnostic(ERRID.ERR_Syntax, "1L"),
...
End Module
            ...
            Dim compilation = CreateCompilationWithReferences(source, {MscorlibRef_v4_0_30316_17626, MsvbRef_v4_0_30319_17929}, OptionsExe)
            CompileAndVerify(compilation, expectedOutput:=<![CDATA[21
0
0
]]>)
...
End Module
            ...
            Dim compilation = CompilationUtils.CreateCompilationWithReferences(source,
                                                                            ...
                                                                            options:=OptionsDll.WithEmbedVbCoreRuntime(True)).VerifyDiagnostics(Diagnostic(ERRID.ERR_NameNotDeclared1, "Err").WithArguments("Err"),
