            ...
            <![CDATA[
{
  ...
  IL_0005:  dup
  IL_0006:  ldarg.0
  IL_0007:  stfld      "C2._Closure$__1.$VB$Me As C2"
  IL_000c:  dup
            ...
            <![CDATA[
{
  ...
  .maxstack  2
  IL_0000:  ldarg.0
  IL_0001:  ldfld      "C2._Closure$__1.$VB$Me As C2"
  IL_0006:  ldflda     "C2.X As C1"
  IL_000b:  ldarg.0
  IL_000c:  ldfld      "C2._Closure$__1.$VB$Local_val As Integer"
  IL_0011:  stfld      "C1.field As Integer"
  IL_0016:  ldarg.0
  IL_0017:  ldfld      "C2._Closure$__1.$VB$Me As C2"
            ...
            <![CDATA[
{
  ...
  IL_0006:  ldloc.0
  IL_0007:  ldarg.1
  IL_0008:  stfld      "C2._Closure$__1.$VB$Local_i As C2.ABC"
  IL_000d:  ldarg.0
  IL_000e:  initobj    "C2"
  IL_0014:  ldloc.0
  IL_0015:  ldflda     "C2._Closure$__1.$VB$Local_i As C2.ABC"
  IL_001a:  ldc.i4.1
  ...
  IL_0031:  ldarg.0
  IL_0032:  ldloc.0
  IL_0033:  ldfld      "C2._Closure$__1.$VB$Local_i As C2.ABC"
            ...
            <![CDATA[
{
  ...
  .maxstack  2
  IL_0000:  ldarg.0
  IL_0001:  ldflda     "C2._Closure$__1.$VB$Local_i As C2.ABC"
  IL_0006:  ldc.i8     0x8c48009070c0000
  IL_000f:  newobj     "Sub Date..ctor(Long)"
  IL_0014:  stfld      "C2.ABC.B As Date"
  IL_0019:  ldarg.0
  IL_001a:  ldflda     "C2._Closure$__1.$VB$Local_i As C2.ABC"
  IL_001f:  ldstr      "!"
            ...
            <![CDATA[
{
  ...
  IL_0000:  newobj     "Sub C2._Closure$__1..ctor()"
  IL_0005:  dup
  IL_0006:  ldflda     "C2._Closure$__1.$VB$Local_x As C2.ABC"
  IL_000b:  initobj    "C2.ABC"
  IL_0011:  dup
  IL_0012:  ldflda     "C2._Closure$__1.$VB$Local_x As C2.ABC"
  IL_0017:  ldc.i4.1
            ...
            <![CDATA[
{
  ...
  .maxstack  2
  IL_0000:  ldarg.0
  IL_0001:  ldflda     "C2._Closure$__1.$VB$Local_x As C2.ABC"
  IL_0006:  ldc.i8     0x8c48009070c0000
  IL_000f:  newobj     "Sub Date..ctor(Long)"
  IL_0014:  stfld      "C2.ABC.B As Date"
  IL_0019:  ldarg.0
  IL_001a:  ldflda     "C2._Closure$__1.$VB$Local_x As C2.ABC"
  IL_001f:  ldstr      "!"
  IL_0024:  stfld      "C2.ABC.C As String"
  IL_0029:  ret
}
            ...
            <![CDATA[
{
  ...
  IL_0025:  newobj     "Sub C2._Closure$__1..ctor()"
  IL_002a:  dup
  IL_002b:  ldarg.0
  IL_002c:  ldfld      "C2.ARR As C2.ABC()"
  IL_0031:  stfld      "C2._Closure$__1.$VB$NonLocal_VB$With As C2.ABC()"
  IL_0036:  dup
  IL_0037:  ldarg.0
  ...
  IL_005e:  ldnull
  IL_005f:  stfld      "C2._Closure$__1.$VB$NonLocal_VB$With As C2.ABC()"
  IL_0064:  ldarg.0
  IL_0065:  ldarg.0
            ...
            <![CDATA[
{
  ...
  IL_0000:  ldarg.0
  IL_0001:  ldfld      "C2._Closure$__1.$VB$NonLocal_VB$With As C2.ABC()"
  IL_0006:  ldarg.0
  IL_0007:  ldfld      "C2._Closure$__1.$VB$NonLocal_VB$With As Integer"
            ...
            <![CDATA[
{
  ...
  IL_0024:  ldarg.0
  IL_0025:  ldfld      "C2._Closure$__1.$VB$NonLocal_VB$With As C2.ABC()"
  IL_002a:  ldarg.0
  IL_002b:  ldfld      "C2._Closure$__1.$VB$NonLocal_VB$With As Integer"
            ...
            <![CDATA[
{
  ...
  IL_000b:  dup
  IL_000c:  ldarg.0
  IL_000d:  stfld      "C2._Closure$__1.$VB$Me As C2"
  IL_0012:  dup
  IL_0013:  ldstr      "?"
            ...
            <![CDATA[
{
  ...
  IL_001e:  ldarg.0
  IL_001f:  ldfld      "C2._Closure$__1.$VB$Me As C2"
  IL_0024:  ldflda     "C2.ARR As C2.ABC"
  IL_0029:  ldarg.0
  IL_002a:  ldfld      "C2._Closure$__1.$VB$Local_sss As String"
...
expectedOutput:="A = 2; B = 6/6/2006; C = ?").
            VerifyDiagnostics(Diagnostic(ERRID.WRN_SharedMemberThroughInstance, "Me.ARR")).
            VerifyIL("C2..ctor",
            <![CDATA[
{
  // Code size       56 (0x38)
            ...
            <![CDATA[
{
  ...
  IL_0005:  dup
  IL_0006:  ldstr      "?"
  IL_000b:  stfld      "C2._Closure$__1.$VB$Local_x As String"
            ...
            <![CDATA[
{
  ...
  IL_001d:  ldarg.0
  IL_001e:  ldfld      "C2._Closure$__1.$VB$Local_x As String"
            ...
            <![CDATA[
{
  ...
  IL_0000:  ldstr      ""
  IL_0005:  ldarg.0
  IL_0006:  ldftn      "Function Clazz._Lambda$__1(Char) As String"
            ...
            <![CDATA[
{
  ...
  .locals init (Integer V_0)
  IL_0000:  ldarg.0
  IL_0001:  ldfld      "Clazz._Closure$__1.$VB$Local_x As STRUCT"
  IL_0006:  ldfld      "STRUCT.D As Integer"
  IL_000b:  stloc.0
  IL_000c:  ldloca.s   V_0
  IL_000e:  call       "Sub Clazz.Foo(ByRef Integer)"
  IL_0013:  ldarg.0
  IL_0014:  ldfld      "Clazz._Closure$__1.$VB$Local_x As STRUCT"
  IL_0019:  ret
}
]]>)
        End Sub
            ...
            <![CDATA[
{
  ...
  IL_0006:  ldloc.0
  IL_0007:  ldarg.1
  IL_0008:  stfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz()"
  IL_000d:  ldloc.0
  IL_000e:  ldarg.2
  IL_000f:  ldc.i4.5
  IL_0010:  sub.ovf
  IL_0011:  stfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Integer"
  IL_0016:  ldloc.0
  IL_0017:  ldfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz()"
  IL_001c:  ldloc.0
  IL_001d:  ldfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Integer"
  ...
  IL_0051:  ldloc.0
  IL_0052:  ldnull
  IL_0053:  stfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz()"
  IL_0058:  ret
}
]]>).
            ...
            <![CDATA[
{
  ...
  .maxstack  2
  IL_0000:  ldarg.0
  IL_0001:  ldfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz()"
  IL_0006:  ldarg.0
  IL_0007:  ldfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Integer"
            ...
            <![CDATA[
{
  ...
  IL_0020:  stloc.1
  IL_0021:  newobj     "Sub Clazz._Closure$__1..ctor()"
  IL_0026:  stloc.2
  IL_0027:  ldloc.2
  IL_0028:  ldloca.s   V_1
  IL_002a:  ldstr      "Three"
  IL_002f:  call       "Function Clazz.get_F(String) As Clazz"
  IL_0034:  stfld      "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz"
  IL_0039:  ldloc.2
  IL_003a:  ldflda     "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz"
  ...
  IL_007d:  ldloc.2
  IL_007e:  ldflda     "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz"
            ...
            <![CDATA[
{
  ...
  .maxstack  2
  IL_0000:  ldarg.0
  IL_0001:  ldflda     "Clazz._Closure$__1.$VB$NonLocal_VB$With As Clazz"
  IL_0006:  ldstr      "Query"
