...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Partial Class Parser
        ...
        Friend Shared Function ReportSyntaxError(Of T As VBSyntaxNode)(syntax As T, ErrorId As ERRID) As T
            Return DirectCast(syntax.AddError(ErrorFactory.ErrorInfo(ErrorId)), T)
        End Function

        Friend Shared Function ReportSyntaxError(Of T As VBSyntaxNode)(syntax As T, ErrorId As ERRID, ParamArray args() As Object) As T
