...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundLocal
        ...
        Public Sub New(syntax As VBSyntaxNode, localSymbol As LocalSymbol, type As TypeSymbol, hasErrors As Boolean)
            Me.New(syntax, localSymbol, Not localSymbol.IsReadOnly, type:=type, hasErrors:=hasErrors)
        End Sub

        Public Sub New(syntax As VBSyntaxNode, localSymbol As LocalSymbol, type As TypeSymbol)
