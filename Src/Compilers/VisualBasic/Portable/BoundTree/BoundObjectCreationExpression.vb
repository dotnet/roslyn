...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundObjectCreationExpression
        ...
        Public Sub New(syntax As VBSyntaxNode, constructorOpt As MethodSymbol, arguments As ImmutableArray(Of BoundExpression), initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
