...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundFieldAccess
        ...
        Public Sub New(syntax As VBSyntaxNode, receiverOpt As BoundExpression, fieldSymbol As FieldSymbol, isLValue As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
