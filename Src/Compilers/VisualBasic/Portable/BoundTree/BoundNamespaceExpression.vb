...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundNamespaceExpression
        Public Sub New(syntax As VBSyntaxNode, unevaluatedReceiverOpt As BoundExpression, namespaceSymbol As NamespaceSymbol, hasErrors As Boolean)
            MyClass.New(syntax, unevaluatedReceiverOpt, Nothing, namespaceSymbol, hasErrors)
        End Sub

        Public Sub New(syntax As VBSyntaxNode, unevaluatedReceiverOpt As BoundExpression, namespaceSymbol As NamespaceSymbol)
