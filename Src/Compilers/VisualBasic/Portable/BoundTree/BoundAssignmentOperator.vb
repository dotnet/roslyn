...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend NotInheritable Class BoundAssignmentOperator
        ...
        Public Sub New(
            ...
            '
            'TODO: it could make sense to have BoundAssignemntStatement just for the purpose of 
            '      binding assignments. It would make invariants for both BoundAssignmentExpressin and BoundAssignmentStateent simpler.
