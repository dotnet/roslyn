...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundPropertyAccess
        Public Sub New(syntax As VBSyntaxNode, propertySymbol As PropertySymbol, propertyGroupOpt As BoundPropertyGroup, accessKind As PropertyAccessKind, isWriteable As Boolean, receiverOpt As BoundExpression, arguments As ImmutableArray(Of BoundExpression), Optional hasErrors As Boolean = False)
