...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Class BoundArrayAccess
        ...
        Public Sub New(syntax As VBSyntaxNode, expression As BoundExpression, indices As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
