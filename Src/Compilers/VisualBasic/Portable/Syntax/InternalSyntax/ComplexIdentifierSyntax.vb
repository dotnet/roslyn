...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Friend NotInheritable Class ComplexIdentifierSyntax
        ...
        Friend Sub New(kind As SyntaxKind, errors As DiagnosticInfo(), annotations As SyntaxAnnotation(), text As String, precedingTrivia As VBSyntaxNode, followingTrivia As VBSyntaxNode, possibleKeywordKind As SyntaxKind, isBracketed As Boolean, identifierText As String, typeCharacter As TypeCharacter)
        ...
        Public Overrides Function WithLeadingTrivia(trivia As GreenNode) As GreenNode
            Return New ComplexIdentifierSyntax(Kind, GetDiagnostics, GetAnnotations, Text, DirectCast(trivia, VBSyntaxNode), GetTrailingTrivia, PossibleKeywordKind, IsBracketed, IdentifierText, TypeCharacter)
        End Function

        Public Overrides Function WithTrailingTrivia(trivia As GreenNode) As GreenNode
            Return New ComplexIdentifierSyntax(Kind, GetDiagnostics, GetAnnotations, Text, GetLeadingTrivia, DirectCast(trivia, VBSyntaxNode), PossibleKeywordKind, IsBracketed, IdentifierText, TypeCharacter)
        End Function
