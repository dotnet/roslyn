...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Friend NotInheritable Class IntegerLiteralTokenSyntax(Of T)
        ...
        Friend Sub New(kind As SyntaxKind, text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, base As LiteralBase, typeSuffix As TypeCharacter, value As T)
            MyBase.New(kind, text, leadingTrivia, trailingTrivia, base, typeSuffix)
            Me._value = value
        End Sub

        Friend Sub New(kind As SyntaxKind, errors As DiagnosticInfo(), annotations As SyntaxAnnotation(), text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, base As LiteralBase, typeSuffix As TypeCharacter, value As T)
        ...
        Public Overrides Function WithLeadingTrivia(trivia As GreenNode) As GreenNode
            Return New IntegerLiteralTokenSyntax(Of T)(Kind, GetDiagnostics, GetAnnotations, Text, DirectCast(trivia, VBSyntaxNode), GetTrailingTrivia, _base, _typeSuffix, _value)
        End Function

        Public Overrides Function WithTrailingTrivia(trivia As GreenNode) As GreenNode
            Return New IntegerLiteralTokenSyntax(Of T)(Kind, GetDiagnostics, GetAnnotations, Text, GetLeadingTrivia, DirectCast(trivia, VBSyntaxNode), _base, _typeSuffix, _value)
        End Function
    ...
    Friend MustInherit Class IntegerLiteralTokenSyntax
        ...
        Friend Sub New(kind As SyntaxKind, text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, base As LiteralBase, typeSuffix As TypeCharacter)
            MyBase.New(kind, text, leadingTrivia, trailingTrivia)
            Me._base = base
            Me._typeSuffix = typeSuffix
        End Sub

        Friend Sub New(kind As SyntaxKind, errors As DiagnosticInfo(), annotations As SyntaxAnnotation(), text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, base As LiteralBase, typeSuffix As TypeCharacter)
    ...
    Friend NotInheritable Class FloatingLiteralTokenSyntax(Of T)
        ...
        Friend Sub New(kind As SyntaxKind, text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, typeSuffix As TypeCharacter, value As T)
            MyBase.New(kind, text, leadingTrivia, trailingTrivia, typeSuffix)
            Me._value = value
        End Sub

        Friend Sub New(kind As SyntaxKind, errors As DiagnosticInfo(), annotations As SyntaxAnnotation(), text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, typeSuffix As TypeCharacter, value As T)
        ...
        Public Overrides Function WithLeadingTrivia(trivia As GreenNode) As GreenNode
            Return New FloatingLiteralTokenSyntax(Of T)(Kind, GetDiagnostics, GetAnnotations, Text, DirectCast(trivia, VBSyntaxNode), GetTrailingTrivia, _typeSuffix, _value)
        End Function

        Public Overrides Function WithTrailingTrivia(trivia As GreenNode) As GreenNode
            Return New FloatingLiteralTokenSyntax(Of T)(Kind, GetDiagnostics, GetAnnotations, Text, GetLeadingTrivia, DirectCast(trivia, VBSyntaxNode), _typeSuffix, _value)
        End Function
    ...
    Friend MustInherit Class FloatingLiteralTokenSyntax
        ...
        Friend Sub New(kind As SyntaxKind, text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, typeSuffix As TypeCharacter)
            MyBase.New(kind, text, leadingTrivia, trailingTrivia)
            Me._typeSuffix = typeSuffix
        End Sub

        Friend Sub New(kind As SyntaxKind, errors As DiagnosticInfo(), annotations As SyntaxAnnotation(), text As String, leadingTrivia As VBSyntaxNode, trailingTrivia As VBSyntaxNode, typeSuffix As TypeCharacter)
            MyBase.New(kind, errors, annotations, text, leadingTrivia, trailingTrivia)
            Me._typeSuffix = typeSuffix
        End Sub
