...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Friend NotInheritable Class SimpleIdentifierSyntax
        ...
        Public Overrides Function WithLeadingTrivia(trivia As GreenNode) As GreenNode
            Return New SimpleIdentifierSyntax(Kind, GetDiagnostics, GetAnnotations, Text, DirectCast(trivia, VBSyntaxNode), GetTrailingTrivia)
        End Function

        Public Overrides Function WithTrailingTrivia(trivia As GreenNode) As GreenNode
            Return New SimpleIdentifierSyntax(Kind, GetDiagnostics, GetAnnotations, Text, GetLeadingTrivia, DirectCast(trivia, VBSyntaxNode))
        End Function
