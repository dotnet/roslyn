...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit.NoPia
    ...
    Friend NotInheritable Class EmbeddedEvent
        ...
        Protected Overrides Function [GetType](moduleBuilder As PEModuleBuilder, syntaxNodeOpt As VBSyntaxNode, diagnostics As DiagnosticBag) As Cci.ITypeReference
        ...
        Protected Overrides Sub EmbedCorrespondingComEventInterfaceMethodInternal(syntaxNodeOpt As VBSyntaxNode, diagnostics As DiagnosticBag, isUsedForComAwareEventBinding As Boolean)
        ...
        Private Function EmbedMatchingInterfaceMethods(sourceInterface As NamedTypeSymbol, syntaxNodeOpt As VBSyntaxNode, diagnostics As DiagnosticBag) As Boolean
            Dim foundMatch = False
