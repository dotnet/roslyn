...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Partial Class FieldSymbol
        ...
        Private Function IFieldReferenceGetType(context As EmitContext) As ITypeReference Implements IFieldReference.GetType
            ...
            Dim type = moduleBeingBuilt.Translate(Me.Type, syntaxNodeOpt:=DirectCast(context.SyntaxNodeOpt, VBSyntaxNode), diagnostics:=context.Diagnostics)
        ...
        Friend Function GetMetadataConstantValue(context As EmitContext) As IMetadataConstant
            ...
            If Me.IsMetadataConstant Then
                Return DirectCast(context.Module, PEModuleBuilder).CreateConstant(Me.Type, Me.ConstantValue, syntaxNodeOpt:=DirectCast(context.SyntaxNodeOpt, VBSyntaxNode), diagnostics:=context.Diagnostics)
            End If
