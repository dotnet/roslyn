...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class AwaitExpressionSpiller : BoundTreeRewriter
    {
        ...
        public override BoundNode VisitSwitchStatement(BoundSwitchStatement node)
        {
            ...
            return UpdateStatement(builder, node.Update(node.OuterLocals, boundExpression, node.ConstantTargetOpt, node.InnerLocals, switchSections, node.BreakLabel, node.StringEquality), substituteTemps: true);
        }
