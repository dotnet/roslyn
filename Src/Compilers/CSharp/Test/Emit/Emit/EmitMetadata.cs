...
";
            ...
            }, emitOptions: EmitOptions.CCI); // TODO(tomat): Ref.Emit infrastructure can't locate the dependent assemblies
...
";
            ...
            CompileAndVerify(source, new[] { netModule1, netModule2 }, emitOptions: EmitOptions.RefEmitBug, assemblyValidator: (assembly, _) =>
            {
...
public class E
{
  ...
  public static void Main()
  {
    System.Console.Write(1234);
            ...
            CompileAndVerify(source, expectedOutput: @"1234", emitOptions: EmitOptions.RefEmitUnsupported_646042);
        }
...
";
            CompileAndVerify(source, emitOptions: EmitOptions.RefEmitUnsupported_646042);
        }
