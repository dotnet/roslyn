...
");
            ...
            var compilation1 = CreateCompilationWithMscorlib(builder.ToString(), null, TestOptions.ReleaseDll.WithSpecificDiagnosticOptions(warnOpts).WithOptimizations(false));
