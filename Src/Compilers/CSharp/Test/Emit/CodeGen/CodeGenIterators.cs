    ...
    static void Main(string[] args)
    {
        ...
        foreach (var i in new C(4).IE(5, 6)) Console.Write(i);
            ...
            var compilation = CompileAndVerify(source, expectedOutput: "12324565")
                .VerifyIL("C.<IE>d__0<T>.System.Collections.Generic.IEnumerable<T>.GetEnumerator()", @"
{
  // Code size       84 (0x54)
  .maxstack  2
  .locals init (C.<IE>d__0<T> V_0)
  IL_0000:  ldarg.0
  IL_0001:  ldfld      ""int C.<IE>d__0<T>.<>1__state""
  IL_0006:  ldc.i4.s   -2
  IL_0008:  bne.un.s   IL_0027
  IL_000a:  ldarg.0
  IL_000b:  ldfld      ""int C.<IE>d__0<T>.<>l__initialThreadId""
  ...
  IL_001c:  ldarg.0
  IL_001d:  ldc.i4.0
  IL_001e:  stfld      ""int C.<IE>d__0<T>.<>1__state""
  IL_0023:  ldarg.0
  IL_0024:  stloc.0
  IL_0025:  br.s       IL_003a
  IL_0027:  ldc.i4.0
  IL_0028:  newobj     ""C.<IE>d__0<T>..ctor(int)""
  IL_002d:  stloc.0
  IL_002e:  ldloc.0
  IL_002f:  ldarg.0
  IL_0030:  ldfld      ""C C.<IE>d__0<T>.<>4__this""
  IL_0035:  stfld      ""C C.<IE>d__0<T>.<>4__this""
  IL_003a:  ldloc.0
  IL_003b:  ldarg.0
  IL_003c:  ldfld      ""T C.<IE>d__0<T>.<>3__i0""
  IL_0041:  stfld      ""T C.<IE>d__0<T>.i0""
  IL_0046:  ldloc.0
  IL_0047:  ldarg.0
  IL_0048:  ldfld      ""T C.<IE>d__0<T>.<>3__i1""
  IL_004d:  stfld      ""T C.<IE>d__0<T>.i1""
  IL_0052:  ldloc.0
  IL_0053:  ret
}")
                .VerifyIL("S.<IE>d__0<T>.System.Collections.Generic.IEnumerable<T>.GetEnumerator()", @"
{
  // Code size       84 (0x54)
  .maxstack  2
  .locals init (S.<IE>d__0<T> V_0)
  IL_0000:  ldarg.0
  IL_0001:  ldfld      ""int S.<IE>d__0<T>.<>1__state""
  IL_0006:  ldc.i4.s   -2
  IL_0008:  bne.un.s   IL_0027
  IL_000a:  ldarg.0
  IL_000b:  ldfld      ""int S.<IE>d__0<T>.<>l__initialThreadId""
  IL_0010:  call       ""System.Threading.Thread System.Threading.Thread.CurrentThread.get""
  IL_0015:  callvirt   ""int System.Threading.Thread.ManagedThreadId.get""
  IL_001a:  bne.un.s   IL_0027
  IL_001c:  ldarg.0
  IL_001d:  ldc.i4.0
  IL_001e:  stfld      ""int S.<IE>d__0<T>.<>1__state""
  IL_0023:  ldarg.0
  IL_0024:  stloc.0
  IL_0025:  br.s       IL_002e
  IL_0027:  ldc.i4.0
  IL_0028:  newobj     ""S.<IE>d__0<T>..ctor(int)""
  IL_002d:  stloc.0
  IL_002e:  ldloc.0
  IL_002f:  ldarg.0
  IL_0030:  ldfld      ""S S.<IE>d__0<T>.<>3__<>4__this""
  IL_0035:  stfld      ""S S.<IE>d__0<T>.<>4__this""
  IL_003a:  ldloc.0
  IL_003b:  ldarg.0
  IL_003c:  ldfld      ""T S.<IE>d__0<T>.<>3__i0""
  IL_0041:  stfld      ""T S.<IE>d__0<T>.i0""
  IL_0046:  ldloc.0
  IL_0047:  ldarg.0
  IL_0048:  ldfld      ""T S.<IE>d__0<T>.<>3__i1""
  IL_004d:  stfld      ""T S.<IE>d__0<T>.i1""
  IL_0052:  ldloc.0
  IL_0053:  ret
}");
        }
    ...
    public static void Main(string[] args)
    {
        for (int i = 0; i < 7; i++)
        {
            ...
            var compilation = CompileAndVerify(source, expectedOutput: "0|01Z|012XZ|012X3Z|012X34YZ|012X34Y5Z|012X34Y5Z6").
                VerifyIL("Program.<Int0>d__0.System.Collections.IEnumerator.MoveNext()",
@"
{
  // Code size      303 (0x12f)
  .maxstack  2
...
")
 .VerifyIL("Program.<Int0>d__0.System.IDisposable.Dispose()",
@"
{
  // Code size      121 (0x79)
  .maxstack  2
