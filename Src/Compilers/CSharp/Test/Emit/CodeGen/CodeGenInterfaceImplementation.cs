...
";
            ...
            CompileAndVerify(comp3, emitOptions: EmitOptions.RefEmitBug, expectedOutput: @"ImpSubDerived ImpFuncDerived ImpSubDerived ImpFunc ExpSubDerived ExpFuncDerived");
        }
...
class Test
{
    public static void Main()
    {
        ...
        j.Property = 0;
            ...
            CompileAndVerify(source, emitOptions: EmitOptions.RefEmitUnsupported_646042, expectedOutput: @"
C.Method
Base.Method
C.IY.set_Property
U.I.Method
