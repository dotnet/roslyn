...
";
  ...
  IL_0007:  ret
        ...
        public void RetargetedSynthesizedStructConstructor()
        {
            ...
            Assert.True(method.IsParameterlessValueTypeConstructor(requireSynthesized: true));

            //TODO (tomat)
            CompileAndVerify(c2, emitOptions: EmitOptions.RefEmitBug).VerifyIL("C.M", @"
{
  // Code size       20 (0x14)
  .maxstack  1
  .locals init (S V_0)
...
";
            ...
            // TODO (tomat)
            CompileAndVerify(compilation, emitOptions: EmitOptions.RefEmitBug).VerifyIL("C.M", @"
{
  // Code size       35 (0x23)
  .maxstack  1
  .locals init (S V_0)
...
";
            ...
            CompileAndVerify(comp, emitOptions: EmitOptions.RefEmitBug).VerifyIL("C.M", @"
{
  // Code size       39 (0x27)
  .maxstack  1
  .locals init (S V_0)
