...
");
        ...
        {
            var expr = this.ParseExpression("int x", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("int x = 2", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Int32 x", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Value ? x :", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Value ? x.y :", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Value1 ?? Value2 ? x :", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("IEnumerable<int> x = null", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("MyGeneric<int>.F1 x", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("MyGeneric<int>.F1<int> x = null", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("MyGeneric<int>.F1<int>? x", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("var x", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(a < b, c > d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(ref a < b, c > d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(ref (a < b > d))", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(out a < b, c > d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(out (a < b > d))", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(a < b, c > d = e)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(a * d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(ref a * d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(out a * d)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
        ...
        {
            var expr = this.ParseExpression("Test(a * d = e)", options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Experimental));
