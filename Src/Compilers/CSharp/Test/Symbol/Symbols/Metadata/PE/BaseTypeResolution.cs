...
";
            ...
            var compilation1 = CreateCompilationWithMscorlib( compilationDef1, new MetadataReference[] {crossRefLib}, TestOptions.Dll);
...
{}
";
            var compilation2 = CreateCompilationWithMscorlib(compilationDef2, new MetadataReference[] { crossRefModule1, crossRefModule2 }, TestOptions.Dll);
            ...
            var compilation3 = CreateCompilationWithMscorlib(compilationDef2, new MetadataReference[] {crossRefModule2}, TestOptions.Dll);
