...
class B
{
    ...
    static void ReportAndReset()
    {
        ...
        i = new[] { 0 };
            ...
            var compilation2 = CompileAndVerify(source2, emitOptions: EmitOptions.RefEmitBug, additionalRefs: new[] { reference1 }, expectedOutput:
@"F()
F()
0
F()
...
@"class C
{
    static void M()
    {
        ...
        a[2] = a[1];
            ...
            var compilation3 = CompileAndVerify(source3, additionalRefs: new[] { reference1 }, emitOptions: EmitOptions.CCI);
...
@"class C
{
    static void M(I i)
    {
        ...
        o = i.valid_name(1);
            ...
            var compilation2 = CompileAndVerify(source2, additionalRefs: new[] { reference1 }, emitOptions: EmitOptions.CCI, verify: true);
...
@"class C
{
    static void M(B b)
    {
        ...
        o = b.Q[2, 3];
            ...
            var compilation3 = CompileAndVerify(source3, additionalRefs: new[] { reference1 }, emitOptions: EmitOptions.CCI, verify: false);
...
@"class C
{
    ...
    static void Invoke(I i)
    {
        ...
        i.P[6] = i.P[5];
            ...
            var compilation3 = CompileAndVerify(source3, additionalRefs: new[] { reference1, reference2 }, emitOptions: EmitOptions.CCI, expectedOutput:
@"A2.get_P(1)
A2.set_P(2, ...)
A2.get_P(3)
A2.set_P(4, ...)
...
class C
{
    static void Main()
    {
        ...
        b2.set_P(1, b2.get_P(0));
            ...
            var compilation2 = CompileAndVerify(source2, additionalRefs: new[] { reference1 }, emitOptions: EmitOptions.CCI, expectedOutput:
@"B1.get_P(0)
A1.set_P(1, ...)
A1.get_P(0)
B2.set_P(1, ...)
...
@"class B
{
    static void Main()
    {
        ...
        a = new IA() { P3 = { 6, 7 } };
            ...
            var compilation2 = CompileAndVerify(source2, new[] { reference1 }, emitOptions: EmitOptions.CCI, verify: true, expectedOutput:
@"P1(1).set
P2(2).get
P1(1).set
P3(3).get
...
class B
{
            ...
            var compilation3 = CompileAndVerify(source3, new[] { reference1 }, emitOptions: EmitOptions.CCI);
        }
...
";
            ...
            var compilation2 = CompileAndVerify(source2, new[] { reference1, SystemCoreRef }, emitOptions: EmitOptions.CCI, verify: true, expectedOutput:
@"P1(2).get
P1(2).get
P1(2).get
P1(2).get
