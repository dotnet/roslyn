...
namespace Roslyn.Compilers.CSharp
{
    ...
    {
        public BoundTypeOrValueExpression(SyntaxNode syntax, Binder binder, TypeSymbol type, bool hasErrors)
        ...
        public BoundTypeOrValueExpression(SyntaxNode syntax, Binder binder, TypeSymbol type)
        ...
        public BoundTypeOrValueExpression Update(Binder binder, TypeSymbol type)
        {
            if (binder != this.Binder || type != this.Type)
            {
                var result = new BoundTypeOrValueExpression(this.Syntax, binder, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundIncrementOperator : BoundExpression
    {
            ...
            : base(BoundKind.IncrementOperator, syntax, type, hasErrors || operand.HasErrors())
        {
            ...
            Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(operandConversion != null, "Field 'operandConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(resultConversion != null, "Field 'resultConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    internal sealed partial class BoundCompoundAssignmentOperator : BoundExpression
    {
            ...
            : base(BoundKind.CompoundAssignmentOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors())
        {
            ...
            Debug.Assert(left != null, "Field 'left' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(right != null, "Field 'right' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(leftConversion != null, "Field 'leftConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(finalConversion != null, "Field 'finalConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    internal sealed partial class BoundIsOperator : BoundExpression
    {
            ...
            : base(BoundKind.IsOperator, syntax, type, hasErrors || operand.HasErrors() || targetType.HasErrors())
        {
            ...
            Debug.Assert(conversion != null, "Field 'conversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    {
        public BoundSizeOfOperator(SyntaxNode syntax, BoundTypeExpression sourceType, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundSizeOfOperator Update(BoundTypeExpression sourceType, TypeSymbol type)
        {
            if (sourceType != this.SourceType || type != this.Type)
            {
                var result = new BoundSizeOfOperator(this.Syntax, sourceType, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundConversion(SyntaxNode syntax, BoundExpression operand, ConversionKind conversionKind, MethodSymbol symbolOpt, Boolean @checked, Boolean explicitCastInCode, Boolean isExtensionMethod, ConstantValue constantValueOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundConversion Update(BoundExpression operand, ConversionKind conversionKind, MethodSymbol symbolOpt, Boolean @checked, Boolean explicitCastInCode, Boolean isExtensionMethod, ConstantValue constantValueOpt, LookupResultKind resultKind, TypeSymbol type)
        {
            if (operand != this.Operand || conversionKind != this.ConversionKind || symbolOpt != this.SymbolOpt || @checked != this.Checked || explicitCastInCode != this.ExplicitCastInCode || isExtensionMethod != this.IsExtensionMethod || constantValueOpt != this.ConstantValueOpt || resultKind != this.ResultKind || type != this.Type)
            {
                var result = new BoundConversion(this.Syntax, operand, conversionKind, symbolOpt, @checked, explicitCastInCode, isExtensionMethod, constantValueOpt, resultKind, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundArgListOperator(SyntaxNode syntax, ReadOnlyArray<BoundExpression> arguments, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundArgListOperator Update(ReadOnlyArray<BoundExpression> arguments, TypeSymbol type)
        {
            if (arguments != this.Arguments || type != this.Type)
            {
                var result = new BoundArgListOperator(this.Syntax, arguments, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundFixedLocalCollectionInitializer : BoundExpression
    {
            ...
            : base(BoundKind.FixedLocalCollectionInitializer, syntax, type, hasErrors || expression.HasErrors())
        {
            ...
            Debug.Assert(elementPointerTypeConversion != null, "Field 'elementPointerTypeConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    internal sealed partial class BoundSequencePointWithSpan : BoundStatement
    {
            ...
            : base(BoundKind.SequencePointWithSpan, syntax, hasErrors || statementOpt.HasErrors())
        {
            ...
            Debug.Assert(span != null, "Field 'span' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    {
        public BoundSequence(SyntaxNode syntax, ReadOnlyArray<LocalSymbol> locals, ReadOnlyArray<BoundExpression> sideEffects, BoundExpression value, TypeSymbol type, bool hasErrors = false)
        ...
        public ReadOnlyArray<BoundExpression> SideEffects { get; private set; }
        ...
        public BoundSequence Update(ReadOnlyArray<LocalSymbol> locals, ReadOnlyArray<BoundExpression> sideEffects, BoundExpression value, TypeSymbol type)
        {
    ...
    internal sealed partial class BoundForEachStatement : BoundLoopStatement
    {
            ...
            : base(BoundKind.ForEachStatement, syntax, breakLabel, continueLabel, hasErrors || iterationVariableType.HasErrors() || expression.HasErrors() || body.HasErrors())
        {
            ...
            Debug.Assert(elementConversion != null, "Field 'elementConversion' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
    ...
    internal sealed partial class BoundMethodGroup : BoundExpression
    {
        public BoundMethodGroup(SyntaxNode syntax, ReadOnlyArray<TypeSymbol> typeArgumentsOpt, BoundExpression receiverOpt, string name, ReadOnlyArray<MethodSymbol> methods, Symbol lookupSymbolOpt, LookupResultKind resultKind, DiagnosticInfo lookupError, bool searchExtensionMethods, bool hasErrors = false)
            : base(BoundKind.MethodGroup, syntax, null, hasErrors || receiverOpt.HasErrors())
        {
            ...
            this.SearchExtensionMethods = searchExtensionMethods;
        }
        ...
        public bool SearchExtensionMethods { get; private set; }
        ...
        public BoundMethodGroup Update(ReadOnlyArray<TypeSymbol> typeArgumentsOpt, BoundExpression receiverOpt, string name, ReadOnlyArray<MethodSymbol> methods, Symbol lookupSymbolOpt, LookupResultKind resultKind, DiagnosticInfo lookupError, bool searchExtensionMethods)
        {
            if (typeArgumentsOpt != this.TypeArgumentsOpt || receiverOpt != this.ReceiverOpt || name != this.Name || methods != this.Methods || lookupSymbolOpt != this.LookupSymbolOpt || resultKind != this.ResultKind || lookupError != this.LookupError || searchExtensionMethods != this.SearchExtensionMethods)
            {
                var result = new BoundMethodGroup(this.Syntax, typeArgumentsOpt, receiverOpt, name, methods, lookupSymbolOpt, resultKind, lookupError, searchExtensionMethods, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundEventAssignmentOperator : BoundExpression
    {
        ...
        {
            if (@event != this.Event || isAddition != this.IsAddition || receiverOpt != this.ReceiverOpt || argument != this.Argument || type != this.Type)
            {
    ...
    {
        public BoundObjectCreationExpression(SyntaxNode syntax, MethodSymbol constructor, ReadOnlyArray<BoundExpression> arguments, ReadOnlyArray<string> argumentNamesOpt, ReadOnlyArray<RefKind> argumentRefKindsOpt, bool expanded, ReadOnlyArray<int> argsToParamsOpt, ConstantValue constantValueOpt, TypeSymbol type, bool hasErrors = false)
            : base(BoundKind.ObjectCreationExpression, syntax, type, hasErrors || arguments.HasErrors())
        {
        ...
        public BoundObjectCreationExpression Update(MethodSymbol constructor, ReadOnlyArray<BoundExpression> arguments, ReadOnlyArray<string> argumentNamesOpt, ReadOnlyArray<RefKind> argumentRefKindsOpt, bool expanded, ReadOnlyArray<int> argsToParamsOpt, ConstantValue constantValueOpt, TypeSymbol type)
        {
            if (constructor != this.Constructor || arguments != this.Arguments || argumentNamesOpt != this.ArgumentNamesOpt || argumentRefKindsOpt != this.ArgumentRefKindsOpt || expanded != this.Expanded || argsToParamsOpt != this.ArgsToParamsOpt || constantValueOpt != this.ConstantValueOpt || type != this.Type)
            {
                var result = new BoundObjectCreationExpression(this.Syntax, constructor, arguments, argumentNamesOpt, argumentRefKindsOpt, expanded, argsToParamsOpt, constantValueOpt, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundObjectInitializerExpression(SyntaxNode syntax, BoundExpression objectCreationExpressionOpt, ReadOnlyArray<BoundExpression> initializers, TypeSymbol type, bool hasErrors = false)
            : base(BoundKind.ObjectInitializerExpression, syntax, type, hasErrors || objectCreationExpressionOpt.HasErrors() || initializers.HasErrors())
        {

            Debug.Assert(!initializers.IsNull, "Field 'initializers' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");

            this.ObjectCreationExpressionOpt = objectCreationExpressionOpt;
            this.Initializers = initializers;
        }


        public BoundExpression ObjectCreationExpressionOpt { get; private set; }
        ...
        public BoundObjectInitializerExpression Update(BoundExpression objectCreationExpressionOpt, ReadOnlyArray<BoundExpression> initializers, TypeSymbol type)
        {
            if (objectCreationExpressionOpt != this.ObjectCreationExpressionOpt || initializers != this.Initializers || type != this.Type)
            {
                var result = new BoundObjectInitializerExpression(this.Syntax, objectCreationExpressionOpt, initializers, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundCollectionInitializerExpression(SyntaxNode syntax, BoundExpression objectCreationExpressionOpt, ReadOnlyArray<BoundExpression> initializers, TypeSymbol type, bool hasErrors = false)
            : base(BoundKind.CollectionInitializerExpression, syntax, type, hasErrors || objectCreationExpressionOpt.HasErrors() || initializers.HasErrors())
        {
        ...
        public BoundCollectionInitializerExpression Update(BoundExpression objectCreationExpressionOpt, ReadOnlyArray<BoundExpression> initializers, TypeSymbol type)
        {
            if (objectCreationExpressionOpt != this.ObjectCreationExpressionOpt || initializers != this.Initializers || type != this.Type)
            {
                var result = new BoundCollectionInitializerExpression(this.Syntax, objectCreationExpressionOpt, initializers, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundNewT(SyntaxNode syntax, TypeSymbol type, bool hasErrors)
            : base(BoundKind.NewT, syntax, type, hasErrors)
        {
        ...
        public BoundNewT(SyntaxNode syntax, TypeSymbol type)
            : base(BoundKind.NewT, syntax, type)
        {
        ...
        public BoundNewT Update(TypeSymbol type)
        {
            if (type != this.Type)
            {
                var result = new BoundNewT(this.Syntax, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal abstract partial class BoundTreeWalker<A> : BoundTreeVisitor<A, object>
    {
        public override object VisitFieldInitializer(BoundFieldInitializer node, A arg)
        {
            this.Visit(node.InitialValue, arg);
            return null;
        }
        public override object VisitGlobalStatementInitializer(BoundGlobalStatementInitializer node, A arg)
        {
            this.Visit(node.Statement, arg);
            return null;
        }
        public override object VisitDup(BoundDup node, A arg)
        {
            return null;
        }
        public override object VisitBadExpression(BoundBadExpression node, A arg)
        {
            this.VisitList(node.ChildBoundNodes, arg);
            return null;
        }
        public override object VisitBadStatement(BoundBadStatement node, A arg)
        {
            this.VisitList(node.ChildBoundNodes, arg);
            return null;
        }
        public override object VisitTypeExpression(BoundTypeExpression node, A arg)
        {
            this.Visit(node.BoundContainingTypeOpt, arg);
            return null;
        }
        public override object VisitTypeOrValueExpression(BoundTypeOrValueExpression node, A arg)
        {
            return null;
        }
        public override object VisitNamespaceExpression(BoundNamespaceExpression node, A arg)
        {
            return null;
        }
        public override object VisitUnaryOperator(BoundUnaryOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            return null;
        }
        public override object VisitIncrementOperator(BoundIncrementOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            return null;
        }
        public override object VisitAddressOfOperator(BoundAddressOfOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            return null;
        }
        public override object VisitPointerIndirectionOperator(BoundPointerIndirectionOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            return null;
        }
        public override object VisitBinaryOperator(BoundBinaryOperator node, A arg)
        {
            this.Visit(node.Left, arg);
            this.Visit(node.Right, arg);
            return null;
        }
        public override object VisitCompoundAssignmentOperator(BoundCompoundAssignmentOperator node, A arg)
        {
            this.Visit(node.Left, arg);
            this.Visit(node.Right, arg);
            return null;
        }
        public override object VisitAssignmentOperator(BoundAssignmentOperator node, A arg)
        {
            this.Visit(node.Left, arg);
            this.Visit(node.Right, arg);
            return null;
        }
        public override object VisitNullCoalescingOperator(BoundNullCoalescingOperator node, A arg)
        {
            this.Visit(node.LeftOperand, arg);
            this.Visit(node.RightOperand, arg);
            return null;
        }
        public override object VisitConditionalOperator(BoundConditionalOperator node, A arg)
        {
            this.Visit(node.Condition, arg);
            this.Visit(node.Consequence, arg);
            this.Visit(node.Alternative, arg);
            return null;
        }
        public override object VisitArrayAccess(BoundArrayAccess node, A arg)
        {
            this.Visit(node.Expression, arg);
            this.VisitList(node.Indices, arg);
            return null;
        }
        public override object VisitArrayLength(BoundArrayLength node, A arg)
        {
            this.Visit(node.Expression, arg);
            return null;
        }
        public override object VisitTypeOfOperator(BoundTypeOfOperator node, A arg)
        {
            this.Visit(node.SourceType, arg);
            return null;
        }
        public override object VisitMethodInfo(BoundMethodInfo node, A arg)
        {
            return null;
        }
        public override object VisitFieldInfo(BoundFieldInfo node, A arg)
        {
            return null;
        }
        public override object VisitDefaultOperator(BoundDefaultOperator node, A arg)
        {
            return null;
        }
        public override object VisitIsOperator(BoundIsOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            this.Visit(node.TargetType, arg);
            return null;
        }
        public override object VisitAsOperator(BoundAsOperator node, A arg)
        {
            this.Visit(node.Operand, arg);
            this.Visit(node.TargetType, arg);
            return null;
        }
        public override object VisitSizeOfOperator(BoundSizeOfOperator node, A arg)
        {
            this.Visit(node.SourceType, arg);
            return null;
        }
        public override object VisitConversion(BoundConversion node, A arg)
        {
            this.Visit(node.Operand, arg);
            return null;
        }
        public override object VisitArgListOperator(BoundArgListOperator node, A arg)
        {
            this.VisitList(node.Arguments, arg);
            return null;
        }
        public override object VisitFixedLocalCollectionInitializer(BoundFixedLocalCollectionInitializer node, A arg)
        {
            this.Visit(node.Expression, arg);
            return null;
        }
        public override object VisitSequencePoint(BoundSequencePoint node, A arg)
        {
            this.Visit(node.StatementOpt, arg);
            return null;
        }
        public override object VisitSequencePointWithSpan(BoundSequencePointWithSpan node, A arg)
        {
            this.Visit(node.StatementOpt, arg);
            return null;
        }
        public override object VisitBlock(BoundBlock node, A arg)
        {
            this.VisitList(node.Statements, arg);
            return null;
        }
        public override object VisitIteratorScope(BoundIteratorScope node, A arg)
        {
            this.Visit(node.Statement, arg);
            return null;
        }
        public override object VisitLocalDeclaration(BoundLocalDeclaration node, A arg)
        {
            this.Visit(node.DeclaredType, arg);
            this.Visit(node.InitializerOpt, arg);
            this.VisitList(node.ArgumentsOpt, arg);
            return null;
        }
        public override object VisitMultipleLocalDeclarations(BoundMultipleLocalDeclarations node, A arg)
        {
            this.VisitList(node.LocalDeclarations, arg);
            return null;
        }
        public override object VisitSequence(BoundSequence node, A arg)
        {
            this.VisitList(node.SideEffects, arg);
            this.Visit(node.Value, arg);
            return null;
        }
        public override object VisitNoOpStatement(BoundNoOpStatement node, A arg)
        {
            return null;
        }
        public override object VisitReturnStatement(BoundReturnStatement node, A arg)
        {
            this.Visit(node.ExpressionOpt, arg);
            return null;
        }
        public override object VisitYieldReturnStatement(BoundYieldReturnStatement node, A arg)
        {
            this.Visit(node.Expression, arg);
            return null;
        }
        public override object VisitYieldBreakStatement(BoundYieldBreakStatement node, A arg)
        {
            return null;
        }
        public override object VisitThrowStatement(BoundThrowStatement node, A arg)
        {
            this.Visit(node.ExpressionOpt, arg);
            return null;
        }
        public override object VisitExpressionStatement(BoundExpressionStatement node, A arg)
        {
            this.Visit(node.Expression, arg);
            return null;
        }
        public override object VisitSwitchStatement(BoundSwitchStatement node, A arg)
        {
            this.Visit(node.BoundExpression, arg);
            this.VisitList(node.SwitchSections, arg);
            return null;
        }
        public override object VisitSwitchSection(BoundSwitchSection node, A arg)
        {
            this.VisitList(node.BoundSwitchLabels, arg);
            this.VisitList(node.Statements, arg);
            return null;
        }
        public override object VisitSwitchLabel(BoundSwitchLabel node, A arg)
        {
            this.Visit(node.ExpressionOpt, arg);
            return null;
        }
        public override object VisitBreakStatement(BoundBreakStatement node, A arg)
        {
            return null;
        }
        public override object VisitContinueStatement(BoundContinueStatement node, A arg)
        {
            return null;
        }
        public override object VisitIfStatement(BoundIfStatement node, A arg)
        {
            this.Visit(node.Condition, arg);
            this.Visit(node.Consequence, arg);
            this.Visit(node.AlternativeOpt, arg);
            return null;
        }
        public override object VisitDoStatement(BoundDoStatement node, A arg)
        {
            this.Visit(node.Condition, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitWhileStatement(BoundWhileStatement node, A arg)
        {
            this.Visit(node.Condition, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitForStatement(BoundForStatement node, A arg)
        {
            this.Visit(node.Initializer, arg);
            this.Visit(node.Condition, arg);
            this.Visit(node.Increment, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitForEachStatement(BoundForEachStatement node, A arg)
        {
            this.Visit(node.IterationVariableType, arg);
            this.Visit(node.Expression, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitUsingStatement(BoundUsingStatement node, A arg)
        {
            this.Visit(node.DeclarationsOpt, arg);
            this.Visit(node.ExpressionOpt, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitFixedStatement(BoundFixedStatement node, A arg)
        {
            this.Visit(node.Declarations, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitLockStatement(BoundLockStatement node, A arg)
        {
            this.Visit(node.Argument, arg);
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitTryStatement(BoundTryStatement node, A arg)
        {
            this.Visit(node.TryBlock, arg);
            this.VisitList(node.CatchBlocks, arg);
            this.Visit(node.FinallyBlockOpt, arg);
            return null;
        }
        public override object VisitCatchBlock(BoundCatchBlock node, A arg)
        {
            this.Visit(node.BoundBlock, arg);
            return null;
        }
        public override object VisitLiteral(BoundLiteral node, A arg)
        {
            return null;
        }
        public override object VisitThisReference(BoundThisReference node, A arg)
        {
            return null;
        }
        public override object VisitPreviousSubmissionReference(BoundPreviousSubmissionReference node, A arg)
        {
            return null;
        }
        public override object VisitHostObjectMemberReference(BoundHostObjectMemberReference node, A arg)
        {
            return null;
        }
        public override object VisitBaseReference(BoundBaseReference node, A arg)
        {
            return null;
        }
        public override object VisitLocal(BoundLocal node, A arg)
        {
            return null;
        }
        public override object VisitRangeVariable(BoundRangeVariable node, A arg)
        {
            this.Visit(node.Value, arg);
            return null;
        }
        public override object VisitParameter(BoundParameter node, A arg)
        {
            return null;
        }
        public override object VisitLabelStatement(BoundLabelStatement node, A arg)
        {
            return null;
        }
        public override object VisitGotoStatement(BoundGotoStatement node, A arg)
        {
            this.Visit(node.CaseExpressionOpt, arg);
            this.Visit(node.LabelExpressionOpt, arg);
            return null;
        }
        public override object VisitLabeledStatement(BoundLabeledStatement node, A arg)
        {
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitLabel(BoundLabel node, A arg)
        {
            return null;
        }
        public override object VisitStatementList(BoundStatementList node, A arg)
        {
            this.VisitList(node.Statements, arg);
            return null;
        }
        public override object VisitConditionalGoto(BoundConditionalGoto node, A arg)
        {
            this.Visit(node.Condition, arg);
            return null;
        }
        public override object VisitMethodGroup(BoundMethodGroup node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            return null;
        }
        public override object VisitCall(BoundCall node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            this.VisitList(node.Arguments, arg);
            return null;
        }
        public override object VisitEventAssignmentOperator(BoundEventAssignmentOperator node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            this.Visit(node.Argument, arg);
            return null;
        }
        public override object VisitDelegateCall(BoundDelegateCall node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            this.VisitList(node.Arguments, arg);
            return null;
        }
        public override object VisitAttribute(BoundAttribute node, A arg)
        {
            this.VisitList(node.ConstructorArguments, arg);
            this.VisitList(node.NamedArguments, arg);
            return null;
        }
        public override object VisitObjectCreationExpression(BoundObjectCreationExpression node, A arg)
        {
            this.VisitList(node.Arguments, arg);
            return null;
        }
        public override object VisitObjectInitializerExpression(BoundObjectInitializerExpression node, A arg)
        {
            this.Visit(node.ObjectCreationExpressionOpt, arg);
            this.VisitList(node.Initializers, arg);
            return null;
        }
        public override object VisitCollectionInitializerExpression(BoundCollectionInitializerExpression node, A arg)
        {
            this.Visit(node.ObjectCreationExpressionOpt, arg);
            this.VisitList(node.Initializers, arg);
            return null;
        }
        public override object VisitAnonymousObjectCreationExpression(BoundAnonymousObjectCreationExpression node, A arg)
        {
            this.VisitList(node.Arguments, arg);
            this.VisitList(node.Declarations, arg);
            return null;
        }
        public override object VisitAnonymousPropertyDeclaration(BoundAnonymousPropertyDeclaration node, A arg)
        {
            return null;
        }
        public override object VisitNewT(BoundNewT node, A arg)
        {
            return null;
        }
        public override object VisitDelegateCreationExpression(BoundDelegateCreationExpression node, A arg)
        {
            this.Visit(node.Argument, arg);
            return null;
        }
        public override object VisitArrayCreation(BoundArrayCreation node, A arg)
        {
            this.VisitList(node.Bounds, arg);
            this.Visit(node.InitializerOpt, arg);
            return null;
        }
        public override object VisitArrayInitialization(BoundArrayInitialization node, A arg)
        {
            this.VisitList(node.Initializers, arg);
            return null;
        }
        public override object VisitFieldAccess(BoundFieldAccess node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            return null;
        }
        public override object VisitPropertyAccess(BoundPropertyAccess node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            return null;
        }
        public override object VisitEventAccess(BoundEventAccess node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            return null;
        }
        public override object VisitIndexerAccess(BoundIndexerAccess node, A arg)
        {
            this.Visit(node.ReceiverOpt, arg);
            this.VisitList(node.Arguments, arg);
            return null;
        }
        public override object VisitLambda(BoundLambda node, A arg)
        {
            this.Visit(node.Body, arg);
            return null;
        }
        public override object VisitUnboundLambda(UnboundLambda node, A arg)
        {
            return null;
        }
        public override object VisitQueryClause(BoundQueryClause node, A arg)
        {
            this.Visit(node.Value, arg);
            return null;
        }
    ...
    internal abstract partial class BoundTreeWalker: BoundTreeVisitor
    {
        ...
        {
            this.Visit(node.ObjectCreationExpressionOpt);
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        {
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.Binder, type);
        }
        public override BoundNode VisitNamespaceExpression(BoundNamespaceExpression node)
        {
            TypeSymbol type = this.VisitType(node.Type);
        ...
        public override BoundNode VisitConversion(BoundConversion node)
        {
            BoundExpression operand = (BoundExpression)this.Visit(node.Operand);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(operand, node.ConversionKind, node.SymbolOpt, node.Checked, node.ExplicitCastInCode, node.IsExtensionMethod, node.ConstantValueOpt, node.ResultKind, type);
        }
        public override BoundNode VisitArgListOperator(BoundArgListOperator node)
        {
            ReadOnlyArray<BoundExpression> arguments = (ReadOnlyArray<BoundExpression>)this.VisitList(node.Arguments);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(arguments, type);
        }
        public override BoundNode VisitFixedLocalCollectionInitializer(BoundFixedLocalCollectionInitializer node)
        {
            BoundExpression expression = (BoundExpression)this.Visit(node.Expression);
        ...
        public override BoundNode VisitMethodGroup(BoundMethodGroup node)
        {
            ...
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.TypeArgumentsOpt, receiverOpt, node.Name, node.Methods, node.LookupSymbolOpt, node.ResultKind, node.LookupError, node.SearchExtensionMethods);
        }
        public override BoundNode VisitCall(BoundCall node)
        {
            BoundExpression receiverOpt = (BoundExpression)this.Visit(node.ReceiverOpt);
        ...
        public override BoundNode VisitObjectCreationExpression(BoundObjectCreationExpression node)
        {
            ReadOnlyArray<BoundExpression> arguments = (ReadOnlyArray<BoundExpression>)this.VisitList(node.Arguments);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.Constructor, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.ConstantValueOpt, type);
        }
        public override BoundNode VisitObjectInitializerExpression(BoundObjectInitializerExpression node)
        {
            BoundExpression objectCreationExpressionOpt = (BoundExpression)this.Visit(node.ObjectCreationExpressionOpt);
            ReadOnlyArray<BoundExpression> initializers = (ReadOnlyArray<BoundExpression>)this.VisitList(node.Initializers);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(objectCreationExpressionOpt, initializers, type);
        }
        public override BoundNode VisitCollectionInitializerExpression(BoundCollectionInitializerExpression node)
        {
            BoundExpression objectCreationExpressionOpt = (BoundExpression)this.Visit(node.ObjectCreationExpressionOpt);
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitMethodGroup(BoundMethodGroup node, object arg)
        {
            return new TreeDumperNode("methodGroup", null, new TreeDumperNode[]
            {
                ...
                new TreeDumperNode("searchExtensionMethods", node.SearchExtensionMethods, null),
                new TreeDumperNode("type", node.Type, null)
            }
            );
        }
        ...
        public override TreeDumperNode VisitObjectInitializerExpression(BoundObjectInitializerExpression node, object arg)
        {
            ...
            {
                new TreeDumperNode("objectCreationExpressionOpt", null, new TreeDumperNode[] { Visit(node.ObjectCreationExpressionOpt, null) }),
