...
{
    public static class CSharpDesktopExtensions
    {
        /// <summary>
        ...
        {
            return DesktopExtensions.Emit(compilation, outputPath, pdbPath, xmlDocumentationPath, win32ResourcesPath, manifestResources, cancellationToken);
        }
    }
}
