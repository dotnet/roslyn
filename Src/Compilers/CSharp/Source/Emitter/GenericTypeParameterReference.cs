...
{
    internal sealed class GenericTypeParameterReference : GenericParameterReference, Microsoft.Cci.IGenericTypeParameterReference
    {
        ...
        {
            visitor.Visit((Microsoft.Cci.IGenericTypeParameterReference)this);
        }
