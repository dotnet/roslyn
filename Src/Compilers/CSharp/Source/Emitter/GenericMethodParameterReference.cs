...
{
    internal sealed class GenericMethodParameterReference : GenericParameterReference, Microsoft.Cci.IGenericMethodParameterReference
    {
        ...
        {
            visitor.Visit((Microsoft.Cci.IGenericMethodParameterReference)this);
        }
