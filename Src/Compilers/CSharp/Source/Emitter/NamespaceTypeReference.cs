...
{
    internal sealed class NamespaceTypeReference : NamedTypeReference, Microsoft.Cci.INamespaceTypeReference
    {
        ...
        {
            visitor.Visit((Microsoft.Cci.INamespaceTypeReference)this);
        }
