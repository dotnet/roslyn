...
Public Class VBParser : Implements IParser
    Private m_Options As VBParseOptions

    Public Sub New(Optional options As VBParseOptions = Nothing)
        m_Options = options
    End Sub

    Public Function Parse(code As String) As SyntaxTree Implements IParser.Parse
        Dim tree = VBSyntaxTree.ParseText(code, m_Options, "", Encoding.UTF8)
        Return tree
    End Function
End Class
