...
{
    internal class ArgumentDefinition : CodeDefinition
    {
        public string NameOpt { get; private set; }
        public RefKind RefKind { get; private set; }
        public CommonSyntaxNode Expression { get; private set; }

        public ArgumentDefinition(string nameOpt, RefKind refKind, CommonSyntaxNode expression)
        {
        ...
        {
            return new ArgumentDefinition(this.NameOpt, this.RefKind, this.Expression);
        }
