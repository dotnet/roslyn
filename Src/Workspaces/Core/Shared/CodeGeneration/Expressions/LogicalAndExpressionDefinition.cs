...
{
    internal class LogicalAndExpressionDefinition : BinaryExpressionDefinition
    {
        public LogicalAndExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new LogicalAndExpressionDefinition(this.Left, this.Right);
        }
