...
{
    internal class InvocationExpressionDefinition : ExpressionDefinition
    {
        public CommonSyntaxNode Expression { get; private set; }
        public IList<CommonSyntaxNode> Arguments { get; private set; }

        public InvocationExpressionDefinition(CommonSyntaxNode expression, IList<CommonSyntaxNode> arguments)
        {
