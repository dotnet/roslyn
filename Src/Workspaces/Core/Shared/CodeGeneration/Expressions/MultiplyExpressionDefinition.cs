...
{
    internal class MultiplyExpressionDefinition : BinaryExpressionDefinition
    {
        public MultiplyExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new MultiplyExpressionDefinition(this.Left, this.Right);
        }
