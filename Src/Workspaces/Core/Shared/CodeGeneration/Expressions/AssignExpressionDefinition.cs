...
{
    internal class AssignExpressionDefinition : BinaryExpressionDefinition
    {
        public AssignExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new AssignExpressionDefinition(this.Left, this.Right);
        }
