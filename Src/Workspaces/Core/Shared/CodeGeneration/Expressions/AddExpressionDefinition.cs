...
{
    internal class AddExpressionDefinition : BinaryExpressionDefinition
    {
        public AddExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new AddExpressionDefinition(this.Left, this.Right);
        }
