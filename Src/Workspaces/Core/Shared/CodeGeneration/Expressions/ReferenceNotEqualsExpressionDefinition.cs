...
{
    internal class ReferenceNotEqualsExpressionDefinition : BinaryExpressionDefinition
    {
        public ReferenceNotEqualsExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new ReferenceNotEqualsExpressionDefinition(this.Left, this.Right);
        }
