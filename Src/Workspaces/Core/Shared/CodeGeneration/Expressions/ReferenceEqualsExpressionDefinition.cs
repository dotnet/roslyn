...
{
    internal class ReferenceEqualsExpressionDefinition : BinaryExpressionDefinition
    {
        public ReferenceEqualsExpressionDefinition(CommonSyntaxNode left, CommonSyntaxNode right)
            : base(left, right)
        {
        }
        ...
        {
            return new ReferenceEqualsExpressionDefinition(this.Left, this.Right);
        }
