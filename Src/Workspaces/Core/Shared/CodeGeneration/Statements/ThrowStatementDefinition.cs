...
{
    internal class ThrowStatementDefinition : StatementDefinition
    {
        public CommonSyntaxNode ExpressionOpt { get; private set; }

        public ThrowStatementDefinition(CommonSyntaxNode expression)
        {
        ...
        {
            return new ThrowStatementDefinition(this.ExpressionOpt);
        }
