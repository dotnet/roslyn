...
namespace Microsoft.CodeAnalysis.FindSymbols.Finders
{
        ...
        where TSymbol : ISymbol
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var equivalentTypesWithDifferingAssemblies = SharedPools.Default<Dictionary<INamedTypeSymbol, INamedTypeSymbol>>().AllocateAndClear();
            try
            {
                ...
                if (equivalentTypesWithDifferingAssemblies.Any())
                {
                    // Step 3a) Ensure that all pairs of named types in equivalentTypesWithDifferingAssemblies are indeed equivalent types.
                    return VerifyForwardedTypes(equivalentTypesWithDifferingAssemblies, searchSymbol, symbolToMatch,
            ...
            {
                SharedPools.Default<Dictionary<INamedTypeSymbol, INamedTypeSymbol>>().ClearAndFree(equivalentTypesWithDifferingAssemblies);
            }
        }
