...
{
    internal abstract partial class AbstractCodeGenerator
    {
        protected static TSyntaxNode AddAnnotationsTo<TSyntaxNode>(ISymbol symbol, TSyntaxNode syntax)
        ...
        protected static TSyntaxNode AddCleanupAnnotationsTo<TSyntaxNode>(TSyntaxNode node) where TSyntaxNode : SyntaxNode
        {
            return (TSyntaxNode)node.WithAdditionalAnnotations(Formatter.Annotation);
        }

        protected static void CheckNodeType<TSyntaxNode1>(SyntaxNode node, string argumentName)
        ...
        protected static void GetNameAndInnermostNamespace(
        ...
        protected static bool IsSpecialType(ITypeSymbol type, SpecialType specialType)
        {
            return type != null && type.SpecialType == specialType;
        }

        protected static int GetPreferredIndex(int index, IList<bool> availableIndices, bool forward)
        {
        ...
        protected static bool TryGetDocumentationComment(ISymbol symbol, string commentToken, out string comment, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        protected static bool TypesMatch(ITypeSymbol type, object value)
        {
        ...
        protected static IEnumerable<ISymbol> GetMembers(INamedTypeSymbol namedType)
        {
        ...
        protected static T GetReuseableSyntaxNodeForSymbol<T>(ISymbol symbol, CodeGenerationOptions options)
            where T : SyntaxNode
        {
        ...
        protected static T GetReuseableSyntaxNodeForAttribute<T>(AttributeData attribute, CodeGenerationOptions options)
            where T : SyntaxNode
        {
