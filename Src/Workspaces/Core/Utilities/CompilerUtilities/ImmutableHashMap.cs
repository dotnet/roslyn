    ...
    internal sealed class ImmutableHashMap<TKey, TValue> : IImmutableDictionary<TKey, TValue>
    {
        ...
        public IEnumerable<TKey> Keys
        {
            get
            {
                ...
                var stack = new BCL.Stack<IEnumerator<Bucket>>();
...
#if DEBUG
            [ExcludeFromCodeCoverage]
            internal virtual int GetMaxDepth() { return 1; }
#endif
        }
...
#if DEBUG
            [ExcludeFromCodeCoverage]
            internal override int GetMaxDepth()
            {
                return this.buckets.Max(b => b.GetMaxDepth()) + 1;
            }
#endif
