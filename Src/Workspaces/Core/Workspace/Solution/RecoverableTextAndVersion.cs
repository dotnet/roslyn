...
namespace Microsoft.CodeAnalysis
{
    ...
    internal class RecoverableTextAndVersion : RecoverableCachedObjectSource<TextAndVersion>
    {
        ...
        protected override async Task<TextAndVersion> RecoverAsync(CancellationToken cancellationToken)
        {
            ...
            using (Logger.LogBlock(FeatureId.Recoverable, FunctionId.Recoverable_RecoverTextAsync, this.storedFilePath, cancellationToken))
            {
        ...
        {
            using (Logger.LogBlock(FeatureId.Recoverable, FunctionId.Recoverable_RecoverText, this.storedFilePath, cancellationToken))
            {
