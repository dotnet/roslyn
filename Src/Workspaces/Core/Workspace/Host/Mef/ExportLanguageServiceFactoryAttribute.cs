...
{
    /// <summary>
    /// Use this attribute to declare a <see cref="ILanguageServiceFactory"/> implementation for inclusion in a <see cref="MefHostServices"/>.
    /// </summary>
    [MetadataAttribute]
    ...
    public class ExportLanguageServiceFactoryAttribute : ExportAttribute
    {
        ...
        /// <summary>
        /// Declares a <see cref="ILanguageServiceFactory"/> implementation for inclusion in a <see cref="MefHostServices"/>.
        /// </summary>
