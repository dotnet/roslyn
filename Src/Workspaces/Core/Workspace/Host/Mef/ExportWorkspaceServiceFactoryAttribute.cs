...
{
    /// <summary>
    /// Use this attribute to declare a <see cref="IWorkspaceServiceFactory"/> implementation for inclusion in a <see cref="MefHostServices"/>.
    /// </summary>
    [MetadataAttribute]
    ...
    public class ExportWorkspaceServiceFactoryAttribute : ExportAttribute
    {
        ...
        /// <summary>
        /// Declares a <see cref="IWorkspaceServiceFactory"/> implementation for inclusion in a <see cref="MefHostServices"/>.
        /// </summary>
