...
namespace Microsoft.CodeAnalysis.WorkspaceServices
{
    ...
    internal class ExportWorkspaceServiceFactoryAttribute : ExportAttribute
    {
        public ExportWorkspaceServiceFactoryAttribute(Type serviceType, string workspaceKind)
