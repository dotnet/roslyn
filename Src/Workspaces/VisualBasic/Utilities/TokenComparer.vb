    ...
    Class TokenComparer
        ...
        Public Function Compare(token1 As SyntaxToken,
            ...
            If specialCaseSystem AndAlso
                token1.GetPreviousToken().VisualBasicKind = SyntaxKind.ImportsKeyword AndAlso
                token2.GetPreviousToken().VisualBasicKind = SyntaxKind.ImportsKeyword Then
        ...
        Private Function CompareWorker(x As SyntaxToken, y As SyntaxToken) As Integer
            ...
            Dim value = String.Compare(string1, string2, CultureInfo.InvariantCulture,
