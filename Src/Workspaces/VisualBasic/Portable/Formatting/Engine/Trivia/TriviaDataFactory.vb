...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    ...
    Partial Friend Class TriviaDataFactory
        ...
        Private Function CalculateSpaces(token1 As SyntaxToken, token2 As SyntaxToken) As Integer
            Dim initialColumn = If(token1.VBKind = 0, 0, Me.TreeInfo.GetOriginalColumn(Me.OptionSet.GetOption(FormattingOptions.TabSize, LanguageNames.VisualBasic), token1) + token1.Width)
