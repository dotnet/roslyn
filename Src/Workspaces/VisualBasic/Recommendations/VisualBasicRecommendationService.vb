...
Namespace Microsoft.CodeAnalysis.VisualBasic.Recommendations
    ...
    Friend Class VisualBasicRecommendationService
        ...
        Private Function GetSymbolsForMemberAccessExpression(
            ...
            ' Event symbols are valid only under AddRemoveHandler Statements.
            ' Also filter out implicitly declared members generated by the event declaration. See Visual Basic Language Specification Section 9.4
            symbols = symbols.Where(Function(s)
                                        If s.Kind = SymbolKind.Event Then
                                            Return TypeOf node.Parent Is AddRemoveHandlerStatementSyntax
                                        ElseIf s.Kind = SymbolKind.Field AndAlso s.IsImplicitlyDeclared Then
                                            Return Not TypeOf DirectCast(s, IFieldSymbol).AssociatedSymbol Is IEventSymbol
