    ...
    Partial Friend Class VisualBasicSimplificationService
        Private Class Expander
            ...
            Public Overrides Function VisitSimpleArgument(node As SimpleArgumentSyntax) As SyntaxNode
                ...
                If newSimpleArgument.Expression.VisualBasicKind = SyntaxKind.AddressOfExpression Then
                    Return newSimpleArgument
                End If
            ...
            Private Function VisitSimpleName(rewrittenSimpleName As SimpleNameSyntax, originalSimpleName As SimpleNameSyntax) As ExpressionSyntax
                ...
                '
                If originalSimpleName.VisualBasicKind = SyntaxKind.IdentifierName Then
                    ...
                    If aliasInfo IsNot Nothing Then
                        ...
                        If replacement.VisualBasicKind = SyntaxKind.QualifiedName Then
                ...
                If identifier <> rewrittenSimpleName.Identifier Then
                    Select Case newNode.VisualBasicKind
                ...
                If (TypeOf (parent) Is FieldInitializerSyntax) OrElse
                    ...
                    (TypeOf (parent) Is MemberAccessExpressionSyntax AndAlso parent.VisualBasicKind <> SyntaxKind.SimpleMemberAccessExpression) OrElse
                    (parent.VisualBasicKind = SyntaxKind.SimpleMemberAccessExpression AndAlso originalSimpleName.IsRightSideOfDot()) OrElse
                    (parent.VisualBasicKind = SyntaxKind.QualifiedName AndAlso originalSimpleName.IsRightSideOfQualifiedName()) Then
                ...
                If symbol.IsConstructor() AndAlso parent.VisualBasicKind = SyntaxKind.ObjectCreationExpression Then
                    symbol = symbol.ContainingType
                End If
            ...
            Private Function TryAddTypeArgumentToIdentifierName(
                ...
                If newNode.VisualBasicKind = SyntaxKind.IdentifierName AndAlso symbol.Kind = SymbolKind.Method Then
            ...
            Private Function FullyQualifyIdentifierName(
                ...
                Debug.Assert(Not replaceNode OrElse rewrittenNode.VisualBasicKind = SyntaxKind.IdentifierName)
