    ...
    Partial Friend Class VisualBasicEscapingReducer
        ...
        Private Shared Function TryUnescapeToken(identifier As SyntaxToken, semanticModel As SemanticModel, optionSet As OptionSet, cancellationToken As CancellationToken) As SyntaxToken
            ...
            If SyntaxFacts.GetContextualKeywordKind(unescapedIdentifier) = SyntaxKind.AwaitKeyword Then
                ...
                If enclosingSingleLineLambda IsNot Nothing AndAlso enclosingSingleLineLambda.Begin.Modifiers.Any(Function(modifier) modifier.VisualBasicKind = SyntaxKind.AsyncKeyword) Then
                    Return identifier
                End If

                Dim enclosingMethodBlock = parent.GetAncestor(Of MethodBlockBaseSyntax)()
                If enclosingMethodBlock IsNot Nothing AndAlso enclosingMethodBlock.Begin.Modifiers.Any(Function(modifier) modifier.VisualBasicKind = SyntaxKind.AsyncKeyword) Then
                    Return identifier
                End If
            End If
            ...
            If SyntaxFacts.GetContextualKeywordKind(unescapedIdentifier) = SyntaxKind.MidKeyword Then
                ...
                If enclosingStatement.VisualBasicKind <> SyntaxKind.MidAssignmentStatement Then
