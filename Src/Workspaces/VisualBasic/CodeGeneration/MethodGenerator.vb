    ...
    Friend Class MethodGenerator
        ...
        Private Shared Function GenerateHandlesClause(expressions As IList(Of SyntaxNode)) As HandlesClauseSyntax
            ...
            Dim items = From def In memberAccessExpressions
                        ...
                        Where token.VisualBasicKind = SyntaxKind.IdentifierToken OrElse
                              token.VisualBasicKind = SyntaxKind.MyBaseKeyword OrElse
                              token.VisualBasicKind = SyntaxKind.MyClassKeyword OrElse
                              token.VisualBasicKind = SyntaxKind.MeKeyword
                        Where TypeOf def.Name Is IdentifierNameSyntax
                        Let identifier = def.Name.Identifier.ValueText.ToIdentifierName()
                        Select SyntaxFactory.HandlesClauseItem(If(token.VisualBasicKind = SyntaxKind.IdentifierToken,
