    ...
    Friend Class VisualBasicCodeGenerationService
        ...
        Public Overrides Function AddParameters(Of TDeclarationNode As SyntaxNode)(
            ...
            If methodStatement IsNot Nothing Then
                Select Case methodStatement.VisualBasicKind
        ...
        Private Overloads Shared Function AddParametersToMethod(Of TDeclarationNode As SyntaxNode)(methodStatement As MethodBaseSyntax,
            ...
            If methodBlock IsNot Nothing Then
                Select Case methodBlock.VisualBasicKind
        ...
        Private Overloads Shared Function AddParameters(parameterList As ParameterListSyntax, parameters As IEnumerable(Of IParameterSymbol), options As CodeGenerationOptions) As ParameterListSyntax
            ...
            For Each parameter In parameters
                If nodesAndTokens.Count > 0 AndAlso nodesAndTokens.Last().VisualBasicKind() <> SyntaxKind.CommaToken Then
        ...
        Private Overloads Shared Function UpdateDeclarationAccessibility(modifiersList As SyntaxTokenList, newAccesibility As Accessibility, options As CodeGenerationOptions) As SyntaxTokenList
            ...
            AbstractVisualBasicCodeGenerator.AddAccessibilityModifiers(newAccesibility, newModifierTokens, CodeGenerationDestination.Unspecified, options, Accessibility.NotApplicable)
            If newModifierTokens.Count = 0 Then
                Return modifiersList
            End If

            Return SyntaxFactory.TokenList(GetUpdatedDeclarationAccessibilityModifiers(newModifierTokens, modifiersList, Function(modifier As SyntaxToken) SyntaxFacts.IsAccessibilityModifier(modifier.VisualBasicKind())))
        End Function
        ...
        Private Function UpdateAsClause(asClause As AsClauseSyntax, newType As ITypeSymbol) As AsClauseSyntax
            ...
            Select Case asClause.VisualBasicKind
                ...
                Case Else
                    ...
                    Select Case newExpression.VisualBasicKind
        ...
        Public Overrides Function UpdateDeclarationType(Of TDeclarationNode As SyntaxNode)(declaration As TDeclarationNode, newType As ITypeSymbol, options As CodeGenerationOptions, cancellationToken As CancellationToken) As TDeclarationNode
            ...
            Select Case syntaxNode.VisualBasicKind
