...
Namespace Microsoft.CodeAnalysis.VisualBasic.CodeGeneration
    Friend Class VisualBasicDeclarationComparer
        ...
        Public Function Compare(x As SyntaxNode, y As SyntaxNode) As Integer Implements IComparer(Of SyntaxNode).Compare
            ...
            If Not kindPrecedenceMap.TryGetValue(x.VisualBasicKind(), xPrecedence) OrElse
               Not kindPrecedenceMap.TryGetValue(y.VisualBasicKind(), yPrecedence) Then
            ...
            While node IsNot Nothing
                Select Case node.VisualBasicKind
                    ...
                    Case SyntaxKind.ModuleBlock,
                        ...
                        Return If(declaration.VisualBasicKind = SyntaxKind.FieldDeclaration, Accessibility.Private, Accessibility.Public)
        ...
        Private Shared Function EqualOperatorPrecedence(x As SyntaxToken, y As SyntaxToken, ByRef comparisonResult As Integer) As Boolean
            If NeitherNull(x, y, comparisonResult) Then
                ...
                operatorPrecedenceMap.TryGetValue(x.VisualBasicKind, xPrecedence)
                operatorPrecedenceMap.TryGetValue(y.VisualBasicKind, yPrecedence)
