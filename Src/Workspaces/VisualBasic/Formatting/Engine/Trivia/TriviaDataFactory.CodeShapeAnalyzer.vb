        ...
        Private Structure CodeShapeAnalyzer
            ...
            Public Shared Function ShouldFormatSingleLine(triviaList As TriviaList) As Boolean
                ...
                For Each trivia In triviaList
                    ...
                    Contract.ThrowIfTrue(trivia.VisualBasicKind = SyntaxKind.EndOfLineTrivia)
                    Contract.ThrowIfTrue(trivia.VisualBasicKind = SyntaxKind.SkippedTokensTrivia)
                    ...
                    If trivia.VisualBasicKind = SyntaxKind.RegionDirectiveTrivia OrElse trivia.VisualBasicKind = SyntaxKind.EndRegionDirectiveTrivia OrElse SyntaxFacts.IsPreprocessorDirective(trivia.VisualBasicKind) Then
                        Return False
                    End If
            ...
            Private Function OnComment(trivia As SyntaxTrivia, currentIndex As Integer) As Boolean
                If trivia.VisualBasicKind <> SyntaxKind.CommentTrivia AndAlso
                   trivia.VisualBasicKind <> SyntaxKind.DocumentationCommentTrivia Then
                    Return False
                End If
                ...
                If trivia.VisualBasicKind = SyntaxKind.DocumentationCommentTrivia AndAlso
            ...
            Private Function OnRegion(trivia As SyntaxTrivia, currentIndex As Integer) As Boolean
                If trivia.VisualBasicKind <> SyntaxKind.RegionDirectiveTrivia AndAlso
                   trivia.VisualBasicKind <> SyntaxKind.EndRegionDirectiveTrivia Then
                    Return False
                End If
            ...
            Private Function OnPreprocessor(trivia As SyntaxTrivia, currentIndex As Integer) As Boolean
                If Not SyntaxFacts.IsPreprocessorDirective(trivia.VisualBasicKind) Then
                    Return False
                End If
            ...
            Private Shared Function ShouldFormatDocumentationComment(indentation As Integer, tabSize As Integer, trivia As SyntaxTrivia) As Boolean
                ...
                For Each token In xmlComment.DescendantTokens()
                    For Each xmlTrivia In token.LeadingTrivia
                        If xmlTrivia.VisualBasicKind = SyntaxKind.DocumentationCommentExteriorTrivia Then
