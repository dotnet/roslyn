...
#If MEF Then
    <ExportCodeCleanupProvider(PredefinedCodeCleanupProviderNames.ReduceTokens, LanguageNames.VisualBasic)>
                ...
                If isSingle Then
                    ...
                    If valueText.Length > 4 Then
                        If valueText.Length = exponentIndex + 4 Then
                            ...
                            If valueText.ElementAt(exponentIndex + 2) = "0"c Then
            ...
            Private Shared Function GetDecimalLiteralValueString(value As Decimal) As String
                ...
                If parts.Length() > 1 Then
                    ...
                    If Not String.Equals(truncatedString, stringToTruncate, StringComparison.Ordinal) Then
                        ...
                        Dim fractionPartOpt As String = If(truncatedString.Any(), "." + truncatedString, "")
