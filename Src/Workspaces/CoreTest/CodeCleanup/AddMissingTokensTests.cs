...
End Class""";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_TwoQuote()
        {
            var code = @"[|Class Class1
    Dim f as Action = """"
End Class|]";
...
End Class";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_OneQuote2()
        {
            var code = @"[|Class Class1
    Dim f as Action = ""a
End Class|]";
...
End Class""";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_Normal()
        {
            var code = @"[|Class Class1
    Dim f as Action = ""test
End Class|]";
...
End Class""";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_Mixed()
        {
            var code = @"[|Class Class1
    Dim f as Action = """"""test """" test2   
End Class|]";
...
End Class""";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_MixedWithSkippedTokens()
        {
            var code = @"[|Class Class1
    Dim f as Action = """"test """" test2   
End Class|]";
...
End Class";
        ...
        [Fact]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_NoTrailingTriviaProblem()
        {
            var code = @"[|Class Class1
    Dim f as Action = "" test ' trivia
End Class|]";
...
End Class""";
        ...
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_AfterRegion()
        {
            var code = @"[|#Region ""Foo|]";
            var expected = @"#Region ""Foo""";
            Verify(code, expected);
        }
        ...
        [WorkItem(544225, "DevDiv")]
        [Trait(Traits.Feature, Traits.Features.AddMissingTokens)]
        public void StringLiterals_AfterConst()
        {
