...
| `.github/` | Active / Config | Repository automation and AI guidance. Agentic workflow sources live in `.github/workflows/`, reusable agent playbooks in `.github/agents/`, and pinned gh-aw dependencies in `.github/aw/`. |
