...
| `LanguageServer/` | ide | LSP server; canonical project loading and demand-driven candidate discovery live in `Microsoft.CodeAnalysis.LanguageServer/HostWorkspace/{LanguageServerProjectLoader,WorkspaceProjectDiscoveryService}*.cs`. |
