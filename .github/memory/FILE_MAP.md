...
| `Workspaces/` | ide | Solution/Project/Document model, host services, MSBuild loading, Remote (OOP). |
...
| `LanguageServer/` | ide | LSP server, including daemon-scoped host services and caches. |
