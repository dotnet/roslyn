...
| `.github/` | Active / Config | Repository automation and AI guidance. Agentic workflow sources live in `.github/workflows/`, helper scripts they call in `.github/workflows/scripts/`, source-driven publication regression checks in `.github/workflows/tests/`, reusable agent playbooks in `.github/agents/`, and pinned gh-aw dependencies in `.github/aw/`. |
