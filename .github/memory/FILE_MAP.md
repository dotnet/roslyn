...
| Path | Status | Purpose |
|------|--------|---------|
| `.github/` | Active | Repository automation, agent instructions and memory, skills, issue templates, and workflows. Agentic workflows use editable `.md` sources with generated `.lock.yml` files. |
