...
- `src/Tools/` - Compiler tooling (BuildBoss, format tools, analyzers) and `IdeBenchmarks/` performance benchmarks, including focused LSP dispatch/allocation benchmarks under `IdeBenchmarks/Lsp/`
