...
- **VisualStudio integration-test harness** (`src/VisualStudio/IntegrationTest/Harness/`): shared integration-test infrastructure; package versions needed only by the harness are scoped in its `Directory.Packages.props`
