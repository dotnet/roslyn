...
- **PROTOTYPE Comments**: Only used to track follow-up work in feature branches and are disallowed in main branch. Do not add PROTOTYPE comments without asking for permission. Use TODO2 comments instead if needed.
