...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-ImageName metalamacompiler-2025.2 -NoBuildImage test --configuration Debug --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-ImageName metalamacompiler-2025.2 -NoBuildImage test --configuration Release --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-ImageName metalamacompiler-2025.2 -NoBuildImage test --configuration Public --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
...
object PublicDeployment : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-ImageName metalamacompiler-2025.2 -NoBuildImage publish --configuration Public %Publish.Arguments% --timeout %Publish.Timeout%"
        }
    }
...
object DownstreamMerge : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-ImageName metalamacompiler-2025.2 -NoBuildImage tools git merge-downstream %DownstreamMerge.Arguments% --timeout %DownstreamMerge.Timeout%"
        }
    }
