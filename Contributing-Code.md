...
The Roslyn project is a member of the [.Net Foundation](https://github.com/orgs/dotnet)) and follow the same [developer guide](https://github.com/dotnet/corefx/wiki/Developer-Guide).  Contributors should ensure they are familiar with this when making submissions.  
